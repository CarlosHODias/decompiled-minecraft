...
/*  20 */     super(output, Registries.ITEM, lookupProvider, e -> e.builtInRegistryHolder().key());
/*     */   }
/*     */ 
/*     */   
...
/* 147 */     tag(ItemTags.VILLAGER_PICKS_UP).addTag(ItemTags.VILLAGER_PLANTABLE_SEEDS).add((Object[])new Item[] { Items.BREAD, Items.WHEAT, Items.BEETROOT });
...
/* 173 */       .add(Items.FISHING_ROD).add((Object[])new Item[] { Items.CARROT_ON_A_STICK, Items.WARPED_FUNGUS_ON_A_STICK
...
/* 196 */     tag(ItemTags.WOLF_FOOD).addTag(ItemTags.MEAT).add((Object[])new Item[] { Items.COD, Items.COOKED_COD, Items.SALMON, Items.COOKED_SALMON, Items.TROPICAL_FISH, Items.PUFFERFISH, Items.RABBIT_STEW });
...
/* 237 */       this.itemAppender = itemAppender;
/*     */     }
/*     */ 
/*     */     
/*     */     public TagAppender<Block, Block> add(Block element) {
/* 242 */       this.itemAppender.add(Objects.<Item>requireNonNull(element.asItem()));
/* 243 */       return this;
/*     */     }
/*     */ 
/*     */     
/*     */     public TagAppender<Block, Block> addOptional(Block element) {
/* 248 */       this.itemAppender.addOptional(Objects.<Item>requireNonNull(element.asItem()));
/* 249 */       return this;
/*     */     }
/*     */     
/*     */     private static TagKey<Item> blockTagToItemTag(TagKey<Block> blockTag) {
/* 253 */       return TagKey.create(Registries.ITEM, blockTag.location());
/*     */     }
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/tags/VanillaItemTagsProvider.class
