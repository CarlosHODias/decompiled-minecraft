...
/* 35 */     return new SmithingTrimRecipeBuilder(category, template, base, addition, pattern);
/*    */   }
/*    */   
...
/* 44 */     ensureValid(id);
/* 45 */     Advancement.Builder advancement = output.advancement()
/* 46 */       .addCriterion("has_the_recipe", RecipeUnlockedTrigger.unlocked(id))
/* 47 */       .rewards(AdvancementRewards.Builder.recipe(id))
/* 48 */       .requirements(AdvancementRequirements.Strategy.OR);
...
/* 51 */     output.accept(id, (Recipe<?>)recipe, advancement.build(id.identifier().withPrefix("recipes/" + this.category.getFolderName() + "/")));
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/recipes/SmithingTrimRecipeBuilder.class
