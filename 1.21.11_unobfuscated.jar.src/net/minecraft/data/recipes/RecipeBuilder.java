...
/* 26 */     save(output, ResourceKey.create(Registries.RECIPE, getDefaultRecipeId((ItemLike)getResult())));
/*    */   }
/*    */   
/*    */   default void save(RecipeOutput output, String id) {
/* 30 */     Identifier key = getDefaultRecipeId((ItemLike)getResult());
...
/* 39 */     return BuiltInRegistries.ITEM.getKey(itemLike.asItem());
/*    */   }
/*    */   
/*    */   static CraftingBookCategory determineBookCategory(RecipeCategory category) {
/* 43 */     switch (category) { case BUILDING_BLOCKS: case TOOLS: case COMBAT: case REDSTONE: default: break; }  return 
/*    */ 
/*    */ 
/*    */       
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/recipes/RecipeBuilder.class
