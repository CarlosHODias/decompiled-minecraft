...
/* 40 */     return new SingleItemRecipeBuilder(category, net.minecraft.world.item.crafting.StonecutterRecipe::new, ingredient, result, 1);
/*    */   }
/*    */   
...
/* 44 */     return new SingleItemRecipeBuilder(category, net.minecraft.world.item.crafting.StonecutterRecipe::new, ingredient, result, count);
/*    */   }
/*    */ 
/*    */   
...
/* 66 */     ensureValid(id);
/* 67 */     Advancement.Builder advancement = output.advancement()
/* 68 */       .addCriterion("has_the_recipe", RecipeUnlockedTrigger.unlocked(id))
/* 69 */       .rewards(AdvancementRewards.Builder.recipe(id))
/* 70 */       .requirements(AdvancementRequirements.Strategy.OR);
...
/*    */ 
/*    */     
/* 77 */     output.accept(id, (Recipe<?>)recipe, advancement.build(id.identifier().withPrefix("recipes/" + this.category.getFolderName() + "/")));
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/recipes/SingleItemRecipeBuilder.class
