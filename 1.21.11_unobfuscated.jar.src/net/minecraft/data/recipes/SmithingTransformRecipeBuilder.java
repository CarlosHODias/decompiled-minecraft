...
/* 38 */     return new SmithingTransformRecipeBuilder(template, base, addition, category, result);
/*    */   }
/*    */   
...
/* 47 */     save(output, ResourceKey.create(Registries.RECIPE, Identifier.parse(id)));
/*    */   }
/*    */   
/*    */   public void save(RecipeOutput output, ResourceKey<Recipe<?>> id) {
/* 51 */     ensureValid(id);
/* 52 */     Advancement.Builder advancement = output.advancement()
/* 53 */       .addCriterion("has_the_recipe", RecipeUnlockedTrigger.unlocked(id))
/* 54 */       .rewards(AdvancementRewards.Builder.recipe(id))
/* 55 */       .requirements(AdvancementRequirements.Strategy.OR);
/* 56 */     Objects.requireNonNull(advancement); this.criteria.forEach(advancement::addCriterion);
/* 57 */     SmithingTransformRecipe recipe = new SmithingTransformRecipe(
/* 58 */         Optional.of(this.template), this.base, 
/*    */         
/* 60 */         Optional.of(this.addition), new TransmuteResult(this.result));
/*    */ 
/*    */     
/* 63 */     output.accept(id, (Recipe<?>)recipe, advancement.build(id.identifier().withPrefix("recipes/" + this.category.getFolderName() + "/")));
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/recipes/SmithingTransformRecipeBuilder.class
