...
/*  36 */   private final Map<String, Criterion<?>> criteria = new LinkedHashMap<>();
...
/*  51 */     return new SimpleCookingRecipeBuilder(category, determineRecipeCategory(serializer, result), result, ingredient, experience, cookingTime, factory);
/*     */   }
/*     */   
...
/*  55 */     return new SimpleCookingRecipeBuilder(category, CookingBookCategory.FOOD, result, ingredient, experience, cookingTime, net.minecraft.world.item.crafting.CampfireCookingRecipe::new);
/*     */   }
/*     */   
...
/*  59 */     return new SimpleCookingRecipeBuilder(category, determineBlastingRecipeCategory(result), result, ingredient, experience, cookingTime, net.minecraft.world.item.crafting.BlastingRecipe::new);
/*     */   }
/*     */   
...
/*  63 */     return new SimpleCookingRecipeBuilder(category, determineSmeltingRecipeCategory(result), result, ingredient, experience, cookingTime, net.minecraft.world.item.crafting.SmeltingRecipe::new);
/*     */   }
/*     */   
...
/*  67 */     return new SimpleCookingRecipeBuilder(category, CookingBookCategory.FOOD, result, ingredient, experience, cookingTime, net.minecraft.world.item.crafting.SmokingRecipe::new);
/*     */   }
/*     */ 
/*     */   
...
/*  89 */     ensureValid(id);
/*  90 */     Advancement.Builder advancement = output.advancement()
/*  91 */       .addCriterion("has_the_recipe", RecipeUnlockedTrigger.unlocked(id))
/*  92 */       .rewards(AdvancementRewards.Builder.recipe(id))
/*  93 */       .requirements(AdvancementRequirements.Strategy.OR);
...
/*  96 */         Objects.<String>requireNonNullElse(this.group, ""), this.bookCategory, this.ingredient, new ItemStack((ItemLike)this.result), this.experience, this.cookingTime);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 103 */     output.accept(id, (Recipe<?>)recipe, advancement.build(id.identifier().withPrefix("recipes/" + this.category.getFolderName() + "/")));
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/recipes/SimpleCookingRecipeBuilder.class
