...
/*     */ 
/*     */     
/* 107 */     FeatureUtils.register(context, ORE_MAGMA, Feature.ORE, new OreConfiguration((RuleTest)blockMatchTest, 
/*     */           
/* 109 */           Blocks.MAGMA_BLOCK.defaultBlockState(), 33));
/*     */ 
/*     */     
/* 112 */     FeatureUtils.register(context, ORE_SOUL_SAND, Feature.ORE, new OreConfiguration((RuleTest)blockMatchTest, 
/*     */           
/* 114 */           Blocks.SOUL_SAND.defaultBlockState(), 12));
/*     */ 
/*     */     
/* 117 */     FeatureUtils.register(context, ORE_NETHER_GOLD, Feature.ORE, new OreConfiguration((RuleTest)blockMatchTest, 
/*     */           
/* 119 */           Blocks.NETHER_GOLD_ORE.defaultBlockState(), 10));
/*     */ 
/*     */     
/* 122 */     FeatureUtils.register(context, ORE_QUARTZ, Feature.ORE, new OreConfiguration((RuleTest)blockMatchTest, 
/*     */           
/* 124 */           Blocks.NETHER_QUARTZ_ORE.defaultBlockState(), 14));
/*     */ 
/*     */     
/* 127 */     FeatureUtils.register(context, ORE_GRAVEL_NETHER, Feature.ORE, new OreConfiguration((RuleTest)blockMatchTest, 
/*     */           
/* 129 */           Blocks.GRAVEL.defaultBlockState(), 33));
/*     */ 
/*     */     
/* 132 */     FeatureUtils.register(context, ORE_BLACKSTONE, Feature.ORE, new OreConfiguration((RuleTest)blockMatchTest, 
/*     */           
/* 134 */           Blocks.BLACKSTONE.defaultBlockState(), 33));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 140 */     FeatureUtils.register(context, ORE_DIRT, Feature.ORE, new OreConfiguration((RuleTest)tagMatchTest1, 
/*     */           
/* 142 */           Blocks.DIRT.defaultBlockState(), 33));
/*     */ 
/*     */ 
/*     */     
/* 146 */     FeatureUtils.register(context, ORE_GRAVEL, Feature.ORE, new OreConfiguration((RuleTest)tagMatchTest1, 
/*     */           
/* 148 */           Blocks.GRAVEL.defaultBlockState(), 33));
/*     */ 
/*     */ 
/*     */     
/* 152 */     FeatureUtils.register(context, ORE_GRANITE, Feature.ORE, new OreConfiguration((RuleTest)tagMatchTest1, 
/*     */           
/* 154 */           Blocks.GRANITE.defaultBlockState(), 64));
/*     */ 
/*     */ 
/*     */     
/* 158 */     FeatureUtils.register(context, ORE_DIORITE, Feature.ORE, new OreConfiguration((RuleTest)tagMatchTest1, 
/*     */           
/* 160 */           Blocks.DIORITE.defaultBlockState(), 64));
/*     */ 
/*     */ 
/*     */     
/* 164 */     FeatureUtils.register(context, ORE_ANDESITE, Feature.ORE, new OreConfiguration((RuleTest)tagMatchTest1, 
/*     */           
/* 166 */           Blocks.ANDESITE.defaultBlockState(), 64));
/*     */ 
/*     */ 
/*     */     
/* 170 */     FeatureUtils.register(context, ORE_TUFF, Feature.ORE, new OreConfiguration((RuleTest)tagMatchTest1, 
/*     */           
/* 172 */           Blocks.TUFF.defaultBlockState(), 64));
/*     */ 
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 259 */     FeatureUtils.register(context, ORE_ANCIENT_DEBRIS_LARGE, Feature.SCATTERED_ORE, new OreConfiguration((RuleTest)tagMatchTest4, 
/*     */           
/* 261 */           Blocks.ANCIENT_DEBRIS.defaultBlockState(), 3, 1.0F));
/*     */ 
/*     */ 
/*     */     
/* 265 */     FeatureUtils.register(context, ORE_ANCIENT_DEBRIS_SMALL, Feature.SCATTERED_ORE, new OreConfiguration((RuleTest)tagMatchTest4, 
/*     */           
/* 267 */           Blocks.ANCIENT_DEBRIS.defaultBlockState(), 2, 1.0F));
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 281 */     FeatureUtils.register(context, ORE_CLAY, Feature.ORE, new OreConfiguration((RuleTest)tagMatchTest1, 
/*     */           
/* 283 */           Blocks.CLAY.defaultBlockState(), 33));
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/worldgen/features/OreFeatures.class
