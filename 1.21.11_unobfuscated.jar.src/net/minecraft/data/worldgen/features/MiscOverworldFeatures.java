...
/*     */ 
/*     */     
/*  69 */     FeatureUtils.register(context, FOREST_ROCK, Feature.FOREST_ROCK, new BlockStateConfiguration(
/*  70 */           Blocks.MOSSY_COBBLESTONE.defaultBlockState()));
/*     */     
/*  72 */     FeatureUtils.register(context, ICEBERG_PACKED, Feature.ICEBERG, new BlockStateConfiguration(
/*  73 */           Blocks.PACKED_ICE.defaultBlockState()));
/*     */     
/*  75 */     FeatureUtils.register(context, ICEBERG_BLUE, Feature.ICEBERG, new BlockStateConfiguration(
/*  76 */           Blocks.BLUE_ICE.defaultBlockState()));
/*     */     
...
/* 117 */                     BlockPredicate.matchesFluids(Direction.UP.getUnitVec3i(), new Fluid[] { (Fluid)Fluids.WATER
/*     */                       
...
/*     */ 
/*     */     
/* 129 */     FeatureUtils.register(context, BONUS_CHEST, (Feature<net.minecraft.world.level.levelgen.feature.configurations.NoneFeatureConfiguration>)Feature.BONUS_CHEST);
...
/*     */ 
/*     */     
/* 135 */     FeatureUtils.register(context, SPRING_LAVA_OVERWORLD, Feature.SPRING, new SpringConfiguration(
/* 136 */           Fluids.LAVA.defaultFluidState(), true, 4, 1, 
/*     */ 
/*     */ 
/*     */           
...
/*     */     
/* 142 */     FeatureUtils.register(context, SPRING_LAVA_FROZEN, Feature.SPRING, new SpringConfiguration(
/* 143 */           Fluids.LAVA.defaultFluidState(), true, 4, 1, 
/*     */ 
/*     */ 
/*     */           
...
/*     */     
/* 149 */     FeatureUtils.register(context, SPRING_WATER, Feature.SPRING, new SpringConfiguration(
/* 150 */           Fluids.WATER.defaultFluidState(), true, 4, 1, 
/*     */ 
/*     */ 
/*     */           
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/worldgen/features/MiscOverworldFeatures.class
