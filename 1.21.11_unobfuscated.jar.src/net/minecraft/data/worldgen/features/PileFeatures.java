...
/* 23 */     FeatureUtils.register(context, PILE_HAY, Feature.BLOCK_PILE, new BlockPileConfiguration((BlockStateProvider)new RotatedBlockProvider(Blocks.HAY_BLOCK)));
/*    */ 
/*    */     
...
/*    */     
/* 32 */     FeatureUtils.register(context, PILE_ICE, Feature.BLOCK_PILE, new BlockPileConfiguration((BlockStateProvider)new WeightedStateProvider(
/*    */             
...
/*    */ 
/*    */     
/* 39 */     FeatureUtils.register(context, PILE_PUMPKIN, Feature.BLOCK_PILE, new BlockPileConfiguration((BlockStateProvider)new WeightedStateProvider(
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/worldgen/features/PileFeatures.class
