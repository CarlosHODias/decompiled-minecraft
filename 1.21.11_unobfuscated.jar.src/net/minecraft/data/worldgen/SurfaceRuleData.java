...
/*  61 */     return SurfaceRules.state(block.defaultBlockState());
/*     */   }
/*     */   
...
/*     */     
/* 268 */     return SurfaceRules.sequence((SurfaceRules.RuleSource[])builder.build().toArray(x$0 -> new SurfaceRules.RuleSource[x$0]));
/*     */   }
/*     */   
/*     */   public static SurfaceRules.RuleSource nether() {
/* 272 */     SurfaceRules.ConditionSource aboveNetherLavaLevel = SurfaceRules.yBlockCheck(VerticalAnchor.absolute(31), 0);
...
/* 348 */     return SurfaceRules.noiseCondition(Noises.SURFACE, threshold / 8.25D, Double.MAX_VALUE);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/worldgen/SurfaceRuleData.class
