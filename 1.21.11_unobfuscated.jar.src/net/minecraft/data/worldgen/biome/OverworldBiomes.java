...
/*   44 */       .setAttribute(EnvironmentAttributes.SKY_COLOR, calculateSkyColor(temperature))
...
/*  115 */       .setAttribute(EnvironmentAttributes.INCREASED_FIRE_BURNOUT, true)
/*  116 */       .build();
/*      */   }
/*      */   
...
/*  129 */       .setAttribute(EnvironmentAttributes.INCREASED_FIRE_BURNOUT, true)
/*  130 */       .build();
/*      */   }
/*      */   
...
/*  216 */       .setAttribute(EnvironmentAttributes.SNOW_GOLEM_MELTS, true)
...
/*  279 */       .setAttribute(EnvironmentAttributes.INCREASED_FIRE_BURNOUT, true)
/*  280 */       .setAttribute(EnvironmentAttributes.CAN_PILLAGER_PATROL_SPAWN, false)
...
/*  322 */       .setAttribute(EnvironmentAttributes.SNOW_GOLEM_MELTS, true)
...
/*  353 */       .setAttribute(EnvironmentAttributes.SNOW_GOLEM_MELTS, true)
...
/*  437 */       .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, -16509389)
...
/*  448 */     MobSpawnSettings.Builder mobs = new MobSpawnSettings.Builder()
/*  449 */       .addSpawn(MobCategory.WATER_AMBIENT, 15, new MobSpawnSettings.SpawnerData(EntityType.PUFFERFISH, 1, 3))
/*  450 */       .addSpawn(MobCategory.WATER_CREATURE, 5, new MobSpawnSettings.SpawnerData(EntityType.NAUTILUS, 1, 1));
/*  451 */     BiomeDefaultFeatures.warmOceanSpawns(mobs, 10, 4);
/*      */     
/*  453 */     BiomeGenerationSettings.Builder generation = baseOceanGeneration(placedFeatures, carvers)
/*  454 */       .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.WARM_OCEAN_VEGETATION)
/*  455 */       .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.SEAGRASS_WARM)
/*  456 */       .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.SEA_PICKLE);
/*      */     
/*  458 */     return baseOcean()
/*  459 */       .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, -16507085)
...
/*  470 */     MobSpawnSettings.Builder mobs = new MobSpawnSettings.Builder()
/*  471 */       .addSpawn(MobCategory.WATER_CREATURE, 1, new MobSpawnSettings.SpawnerData(EntityType.SQUID, 1, 4))
/*  472 */       .addSpawn(MobCategory.WATER_AMBIENT, 15, new MobSpawnSettings.SpawnerData(EntityType.SALMON, 1, 5))
/*  473 */       .addSpawn(MobCategory.CREATURE, 1, new MobSpawnSettings.SpawnerData(EntityType.POLAR_BEAR, 1, 2))
/*  474 */       .addSpawn(MobCategory.WATER_CREATURE, 2, new MobSpawnSettings.SpawnerData(EntityType.NAUTILUS, 1, 1));
...
/*      */     
/*  510 */     if (flower) {
/*  511 */       music = new BackgroundMusic((Holder)SoundEvents.MUSIC_BIOME_FLOWER_FOREST);
/*  512 */       generation.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.FLOWER_FOREST_FLOWERS);
/*      */     } else {
/*  514 */       music = new BackgroundMusic((Holder)SoundEvents.MUSIC_BIOME_FOREST);
...
/*      */     
/*  628 */     EnvironmentAttributeMap paleGardenAttributes = EnvironmentAttributeMap.builder()
/*  629 */       .set(EnvironmentAttributes.SKY_COLOR, -4605511)
/*  630 */       .set(EnvironmentAttributes.FOG_COLOR, -8292496)
/*  631 */       .set(EnvironmentAttributes.WATER_FOG_COLOR, -11179648)
/*  632 */       .set(EnvironmentAttributes.BACKGROUND_MUSIC, BackgroundMusic.EMPTY)
/*  633 */       .set(EnvironmentAttributes.MUSIC_VOLUME, 0.0F)
/*  634 */       .build();
/*  635 */     EnvironmentAttributeMap darkForestAttributes = EnvironmentAttributeMap.builder()
/*  636 */       .set(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic((Holder)SoundEvents.MUSIC_BIOME_FOREST))
/*  637 */       .build();
/*      */     
...
/*  678 */       .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, -14474473)
/*  679 */       .modifyAttribute(EnvironmentAttributes.WATER_FOG_END_DISTANCE, (AttributeModifier)FloatModifier.MULTIPLY, 0.85F)
/*  680 */       .setAttribute(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic((Holder)SoundEvents.MUSIC_BIOME_SWAMP))
/*  681 */       .setAttribute(EnvironmentAttributes.INCREASED_FIRE_BURNOUT, true)
...
/*  710 */       .setAttribute(EnvironmentAttributes.FOG_COLOR, -4138753)
/*  711 */       .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, -11699616)
/*  712 */       .modifyAttribute(EnvironmentAttributes.WATER_FOG_END_DISTANCE, (AttributeModifier)FloatModifier.MULTIPLY, 0.85F)
/*  713 */       .setAttribute(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic((Holder)SoundEvents.MUSIC_BIOME_SWAMP))
/*  714 */       .setAttribute(EnvironmentAttributes.INCREASED_FIRE_BURNOUT, true)
...
/*  728 */     MobSpawnSettings.Builder mobs = new MobSpawnSettings.Builder()
/*  729 */       .addSpawn(MobCategory.WATER_CREATURE, 2, new MobSpawnSettings.SpawnerData(EntityType.SQUID, 1, 4))
/*  730 */       .addSpawn(MobCategory.WATER_AMBIENT, 5, new MobSpawnSettings.SpawnerData(EntityType.SALMON, 1, 5));
...
/*      */     
/*  833 */     if (cherryGrove) {
/*  834 */       BiomeSpecialEffects.Builder effects = new BiomeSpecialEffects.Builder()
/*  835 */         .waterColor(6141935)
/*  836 */         .grassColorOverride(11983713)
/*  837 */         .foliageColorOverride(11983713);
/*      */       
/*  839 */       return baseBiome(0.5F, 0.8F)
/*  840 */         .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, -10635281)
...
/*  874 */       .setAttribute(EnvironmentAttributes.INCREASED_FIRE_BURNOUT, true)
...
/*  880 */     return basePeaks(placedFeatures, carvers)
...
/*  886 */     return basePeaks(placedFeatures, carvers)
...
/*  930 */       .setAttribute(EnvironmentAttributes.INCREASED_FIRE_BURNOUT, true)
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/worldgen/biome/OverworldBiomes.class
