...
/*     */ 
/*     */     
/*  81 */     PlacementUtils.register(context, MONSTER_ROOM, (Holder<ConfiguredFeature<?, ?>>)reference1, new PlacementModifier[] {
...
/*     */         });
/*  87 */     PlacementUtils.register(context, MONSTER_ROOM_DEEP, (Holder<ConfiguredFeature<?, ?>>)reference1, new PlacementModifier[] {
...
/*     */ 
/*     */     
/*  96 */     PlacementUtils.register(context, FOSSIL_UPPER, (Holder<ConfiguredFeature<?, ?>>)reference2, new PlacementModifier[] {
...
/*     */         });
/* 102 */     PlacementUtils.register(context, FOSSIL_LOWER, (Holder<ConfiguredFeature<?, ?>>)reference3, new PlacementModifier[] {
...
/*     */ 
/*     */     
/* 111 */     PlacementUtils.register(context, DRIPSTONE_CLUSTER, (Holder<ConfiguredFeature<?, ?>>)reference4, new PlacementModifier[] {
...
/*     */         });
/* 117 */     PlacementUtils.register(context, LARGE_DRIPSTONE, (Holder<ConfiguredFeature<?, ?>>)reference5, new PlacementModifier[] {
...
/*     */         });
/* 123 */     PlacementUtils.register(context, POINTED_DRIPSTONE, (Holder<ConfiguredFeature<?, ?>>)reference6, new PlacementModifier[] {
...
/*     */         });
/* 134 */     PlacementUtils.register(context, UNDERWATER_MAGMA, (Holder<ConfiguredFeature<?, ?>>)reference7, new PlacementModifier[] {
...
/*     */           
/* 138 */           (PlacementModifier)SurfaceRelativeThresholdFilter.of(Heightmap.Types.OCEAN_FLOOR_WG, Integer.MIN_VALUE, -2), 
/* 139 */           (PlacementModifier)BiomeFilter.biome()
/*     */         });
/* 141 */     PlacementUtils.register(context, GLOW_LICHEN, (Holder<ConfiguredFeature<?, ?>>)reference8, new PlacementModifier[] {
...
/* 145 */           (PlacementModifier)SurfaceRelativeThresholdFilter.of(Heightmap.Types.OCEAN_FLOOR_WG, Integer.MIN_VALUE, -13), 
/* 146 */           (PlacementModifier)BiomeFilter.biome()
/*     */         });
/* 148 */     PlacementUtils.register(context, ROOTED_AZALEA_TREE, (Holder<ConfiguredFeature<?, ?>>)reference9, new PlacementModifier[] {
...
/*     */         });
/* 156 */     PlacementUtils.register(context, CAVE_VINES, (Holder<ConfiguredFeature<?, ?>>)reference10, new PlacementModifier[] {
...
/*     */         });
/* 164 */     PlacementUtils.register(context, LUSH_CAVES_VEGETATION, (Holder<ConfiguredFeature<?, ?>>)reference11, new PlacementModifier[] {
...
/*     */         });
/* 172 */     PlacementUtils.register(context, LUSH_CAVES_CLAY, (Holder<ConfiguredFeature<?, ?>>)reference12, new PlacementModifier[] {
...
/*     */         });
/* 180 */     PlacementUtils.register(context, LUSH_CAVES_CEILING_VEGETATION, (Holder<ConfiguredFeature<?, ?>>)reference13, new PlacementModifier[] {
...
/*     */         });
/* 188 */     PlacementUtils.register(context, SPORE_BLOSSOM, (Holder<ConfiguredFeature<?, ?>>)reference14, new PlacementModifier[] {
...
/*     */         });
/* 196 */     PlacementUtils.register(context, CLASSIC_VINES, (Holder<ConfiguredFeature<?, ?>>)reference15, new PlacementModifier[] {
...
/*     */         });
/* 202 */     PlacementUtils.register(context, AMETHYST_GEODE, (Holder<ConfiguredFeature<?, ?>>)reference16, new PlacementModifier[] {
...
/*     */         });
/*     */     
/* 209 */     PlacementUtils.register(context, SCULK_PATCH_DEEP_DARK, (Holder<ConfiguredFeature<?, ?>>)reference17, new PlacementModifier[] {
...
/*     */         });
/*     */     
/* 216 */     PlacementUtils.register(context, SCULK_PATCH_ANCIENT_CITY, (Holder<ConfiguredFeature<?, ?>>)reference18, new PlacementModifier[0]);
/*     */     
/* 218 */     PlacementUtils.register(context, SCULK_VEIN, (Holder<ConfiguredFeature<?, ?>>)reference19, new PlacementModifier[] {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/worldgen/placement/CavePlacements.class
