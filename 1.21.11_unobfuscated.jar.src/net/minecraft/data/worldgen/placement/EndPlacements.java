...
/*    */     
/* 37 */     PlacementUtils.register(context, END_PLATFORM, (Holder<ConfiguredFeature<?, ?>>)reference1, new PlacementModifier[] {
/* 38 */           (PlacementModifier)FixedPlacement.of(new net.minecraft.core.BlockPos[] { net.minecraft.server.level.ServerLevel.END_SPAWN_POINT.below()
/* 39 */             }), (PlacementModifier)BiomeFilter.biome()
/*    */         });
/* 41 */     PlacementUtils.register(context, END_SPIKE, (Holder<ConfiguredFeature<?, ?>>)reference2, new PlacementModifier[] {
/* 42 */           (PlacementModifier)BiomeFilter.biome()
/*    */         });
/* 44 */     PlacementUtils.register(context, END_GATEWAY_RETURN, (Holder<ConfiguredFeature<?, ?>>)reference3, new PlacementModifier[] {
...
/*    */         });
/* 51 */     PlacementUtils.register(context, CHORUS_PLANT, (Holder<ConfiguredFeature<?, ?>>)reference4, new PlacementModifier[] {
...
/*    */         });
/* 57 */     PlacementUtils.register(context, END_ISLAND_DECORATED, (Holder<ConfiguredFeature<?, ?>>)reference5, new PlacementModifier[] {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/worldgen/placement/EndPlacements.class
