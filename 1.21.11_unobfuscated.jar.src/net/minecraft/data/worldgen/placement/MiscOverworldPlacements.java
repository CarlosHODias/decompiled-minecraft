...
/*     */     
/*  78 */     PlacementUtils.register(context, ICE_SPIKE, (Holder<ConfiguredFeature<?, ?>>)reference1, new PlacementModifier[] {
...
/*     */         });
/*  84 */     PlacementUtils.register(context, ICE_PATCH, (Holder<ConfiguredFeature<?, ?>>)reference2, new PlacementModifier[] {
...
/*     */         });
/*  92 */     PlacementUtils.register(context, FOREST_ROCK, (Holder<ConfiguredFeature<?, ?>>)reference3, new PlacementModifier[] {
...
/*     */         });
/*  98 */     PlacementUtils.register(context, ICEBERG_BLUE, (Holder<ConfiguredFeature<?, ?>>)reference5, new PlacementModifier[] {
...
/*     */         });
/* 103 */     PlacementUtils.register(context, ICEBERG_PACKED, (Holder<ConfiguredFeature<?, ?>>)reference4, new PlacementModifier[] {
...
/*     */         });
/* 108 */     PlacementUtils.register(context, BLUE_ICE, (Holder<ConfiguredFeature<?, ?>>)reference6, new PlacementModifier[] {
/* 109 */           (PlacementModifier)CountPlacement.of((IntProvider)net.minecraft.util.valueproviders.UniformInt.of(0, 19)), 
...
/*     */         });
/*     */     
/* 115 */     PlacementUtils.register(context, LAKE_LAVA_UNDERGROUND, (Holder<ConfiguredFeature<?, ?>>)reference7, new PlacementModifier[] {
...
/* 119 */           (PlacementModifier)EnvironmentScanPlacement.scanningFor(net.minecraft.core.Direction.DOWN, 
/*     */             
/* 121 */             BlockPredicate.allOf(
/* 122 */               BlockPredicate.not(BlockPredicate.ONLY_IN_AIR_PREDICATE), 
/* 123 */               BlockPredicate.insideWorld((net.minecraft.core.Vec3i)new net.minecraft.core.BlockPos(0, -5, 0))), 32), 
/*     */ 
/*     */ 
/*     */           
/* 127 */           (PlacementModifier)net.minecraft.world.level.levelgen.placement.SurfaceRelativeThresholdFilter.of(Heightmap.Types.OCEAN_FLOOR_WG, Integer.MIN_VALUE, -5), 
/* 128 */           (PlacementModifier)BiomeFilter.biome()
/*     */         });
/*     */     
/* 131 */     PlacementUtils.register(context, LAKE_LAVA_SURFACE, (Holder<ConfiguredFeature<?, ?>>)reference7, new PlacementModifier[] {
...
/*     */         });
/*     */     
/* 138 */     PlacementUtils.register(context, DISK_CLAY, (Holder<ConfiguredFeature<?, ?>>)reference8, new PlacementModifier[] {
...
/*     */         });
/* 144 */     PlacementUtils.register(context, DISK_GRAVEL, (Holder<ConfiguredFeature<?, ?>>)reference9, new PlacementModifier[] {
...
/*     */         });
/* 150 */     PlacementUtils.register(context, DISK_SAND, (Holder<ConfiguredFeature<?, ?>>)reference10, new PlacementModifier[] {
...
/*     */         });
/*     */     
/* 158 */     PlacementUtils.register(context, DISK_GRASS, (Holder<ConfiguredFeature<?, ?>>)reference11, new PlacementModifier[] {
...
/*     */         });
/*     */     
/* 167 */     PlacementUtils.register(context, FREEZE_TOP_LAYER, (Holder<ConfiguredFeature<?, ?>>)reference12, new PlacementModifier[] {
/* 168 */           (PlacementModifier)BiomeFilter.biome()
/*     */         });
/* 170 */     PlacementUtils.register(context, VOID_START_PLATFORM, (Holder<ConfiguredFeature<?, ?>>)reference13, new PlacementModifier[] {
/* 171 */           (PlacementModifier)BiomeFilter.biome()
/*     */         });
/*     */     
/* 174 */     PlacementUtils.register(context, DESERT_WELL, (Holder<ConfiguredFeature<?, ?>>)reference14, new PlacementModifier[] {
...
/*     */         });
/*     */     
/* 181 */     PlacementUtils.register(context, SPRING_LAVA, (Holder<ConfiguredFeature<?, ?>>)reference15, new PlacementModifier[] {
...
/*     */         });
/* 187 */     PlacementUtils.register(context, SPRING_LAVA_FROZEN, (Holder<ConfiguredFeature<?, ?>>)reference16, new PlacementModifier[] {
...
/*     */         });
/* 193 */     PlacementUtils.register(context, SPRING_WATER, (Holder<ConfiguredFeature<?, ?>>)reference17, new PlacementModifier[] {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/worldgen/placement/MiscOverworldPlacements.class
