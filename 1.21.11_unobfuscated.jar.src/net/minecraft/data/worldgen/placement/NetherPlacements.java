...
/*     */     
/*  69 */     PlacementUtils.register(context, DELTA, (Holder<ConfiguredFeature<?, ?>>)reference1, new PlacementModifier[] {
/*  70 */           (PlacementModifier)CountOnEveryLayerPlacement.of(40), 
/*  71 */           (PlacementModifier)BiomeFilter.biome()
/*     */         });
/*  73 */     PlacementUtils.register(context, SMALL_BASALT_COLUMNS, (Holder<ConfiguredFeature<?, ?>>)reference2, new PlacementModifier[] {
/*  74 */           (PlacementModifier)CountOnEveryLayerPlacement.of(4), 
/*  75 */           (PlacementModifier)BiomeFilter.biome()
/*     */         });
/*  77 */     PlacementUtils.register(context, LARGE_BASALT_COLUMNS, (Holder<ConfiguredFeature<?, ?>>)reference3, new PlacementModifier[] {
/*  78 */           (PlacementModifier)CountOnEveryLayerPlacement.of(2), 
/*  79 */           (PlacementModifier)BiomeFilter.biome()
/*     */         });
/*  81 */     PlacementUtils.register(context, BASALT_BLOBS, (Holder<ConfiguredFeature<?, ?>>)reference4, new PlacementModifier[] {
...
/*     */         });
/*  87 */     PlacementUtils.register(context, BLACKSTONE_BLOBS, (Holder<ConfiguredFeature<?, ?>>)reference5, new PlacementModifier[] {
...
/*     */         });
/*     */     
/*  94 */     PlacementUtils.register(context, GLOWSTONE_EXTRA, (Holder<ConfiguredFeature<?, ?>>)reference6, new PlacementModifier[] {
...
/*     */         });
/* 100 */     PlacementUtils.register(context, GLOWSTONE, (Holder<ConfiguredFeature<?, ?>>)reference6, new PlacementModifier[] {
...
/*     */         });
/*     */     
/* 107 */     PlacementUtils.register(context, CRIMSON_FOREST_VEGETATION, (Holder<ConfiguredFeature<?, ?>>)reference7, new PlacementModifier[] {
/* 108 */           (PlacementModifier)CountOnEveryLayerPlacement.of(6), 
/* 109 */           (PlacementModifier)BiomeFilter.biome()
/*     */         });
/* 111 */     PlacementUtils.register(context, WARPED_FOREST_VEGETATION, (Holder<ConfiguredFeature<?, ?>>)reference8, new PlacementModifier[] {
/* 112 */           (PlacementModifier)CountOnEveryLayerPlacement.of(5), 
/* 113 */           (PlacementModifier)BiomeFilter.biome()
/*     */         });
/* 115 */     PlacementUtils.register(context, NETHER_SPROUTS, (Holder<ConfiguredFeature<?, ?>>)reference9, new PlacementModifier[] {
/* 116 */           (PlacementModifier)CountOnEveryLayerPlacement.of(4), 
/* 117 */           (PlacementModifier)BiomeFilter.biome()
/*     */         });
/* 119 */     PlacementUtils.register(context, TWISTING_VINES, (Holder<ConfiguredFeature<?, ?>>)reference10, new PlacementModifier[] {
...
/*     */         });
/* 125 */     PlacementUtils.register(context, WEEPING_VINES, (Holder<ConfiguredFeature<?, ?>>)reference11, new PlacementModifier[] {
...
/*     */         });
/* 131 */     PlacementUtils.register(context, PATCH_CRIMSON_ROOTS, (Holder<ConfiguredFeature<?, ?>>)reference12, new PlacementModifier[] { PlacementUtils.FULL_RANGE, 
/*     */           
/* 133 */           (PlacementModifier)BiomeFilter.biome() });
/*     */ 
/*     */     
/* 136 */     PlacementUtils.register(context, BASALT_PILLAR, (Holder<ConfiguredFeature<?, ?>>)reference13, new PlacementModifier[] {
...
/*     */         });
/*     */     
/* 143 */     PlacementUtils.register(context, SPRING_DELTA, (Holder<ConfiguredFeature<?, ?>>)reference14, new PlacementModifier[] {
...
/*     */         });
/* 149 */     PlacementUtils.register(context, SPRING_CLOSED, (Holder<ConfiguredFeature<?, ?>>)reference15, new PlacementModifier[] {
...
/*     */         });
/* 155 */     PlacementUtils.register(context, SPRING_CLOSED_DOUBLE, (Holder<ConfiguredFeature<?, ?>>)reference15, new PlacementModifier[] {
...
/*     */         });
/* 161 */     PlacementUtils.register(context, SPRING_OPEN, (Holder<ConfiguredFeature<?, ?>>)reference16, new PlacementModifier[] {
...
/*     */ 
/*     */     
/* 169 */     List<PlacementModifier> firePlacement = (List)List.of(
...
/*     */     
/* 175 */     PlacementUtils.register(context, PATCH_SOUL_FIRE, (Holder<ConfiguredFeature<?, ?>>)reference17, firePlacement);
/*     */ 
/*     */     
/* 178 */     PlacementUtils.register(context, PATCH_FIRE, (Holder<ConfiguredFeature<?, ?>>)reference18, firePlacement);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/worldgen/placement/NetherPlacements.class
