...
/*    */     
/* 51 */     PlacementUtils.register(context, PILE_HAY_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference1, new PlacementModifier[0]);
/* 52 */     PlacementUtils.register(context, PILE_MELON_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference2, new PlacementModifier[0]);
/* 53 */     PlacementUtils.register(context, PILE_SNOW_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference3, new PlacementModifier[0]);
/* 54 */     PlacementUtils.register(context, PILE_ICE_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference4, new PlacementModifier[0]);
/* 55 */     PlacementUtils.register(context, PILE_PUMPKIN_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference5, new PlacementModifier[0]);
/*    */     
/* 57 */     PlacementUtils.register(context, OAK_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference6, new PlacementModifier[] { (PlacementModifier)PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING) });
/* 58 */     PlacementUtils.register(context, ACACIA_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference7, new PlacementModifier[] { (PlacementModifier)PlacementUtils.filteredByBlockSurvival(Blocks.ACACIA_SAPLING) });
/* 59 */     PlacementUtils.register(context, SPRUCE_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference8, new PlacementModifier[] { (PlacementModifier)PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING) });
/* 60 */     PlacementUtils.register(context, PINE_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference9, new PlacementModifier[] { (PlacementModifier)PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING) });
/*    */     
/* 62 */     PlacementUtils.register(context, PATCH_CACTUS_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference10, new PlacementModifier[0]);
/* 63 */     PlacementUtils.register(context, FLOWER_PLAIN_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference11, new PlacementModifier[0]);
/* 64 */     PlacementUtils.register(context, PATCH_TAIGA_GRASS_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference12, new PlacementModifier[0]);
/* 65 */     PlacementUtils.register(context, PATCH_BERRY_BUSH_VILLAGE, (Holder<ConfiguredFeature<?, ?>>)reference13, new PlacementModifier[0]);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/worldgen/placement/VillagePlacements.class
