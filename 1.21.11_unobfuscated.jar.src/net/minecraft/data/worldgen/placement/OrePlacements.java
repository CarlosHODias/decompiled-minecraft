...
/*  24 */     return (List)List.of(frequencyModifier, 
/*     */         
...
/*  33 */     return orePlacement((PlacementModifier)CountPlacement.of(count), heightRange);
/*     */   }
/*     */   
/*     */   private static List<PlacementModifier> rareOrePlacement(int rarity, PlacementModifier heightRange) {
/*  37 */     return orePlacement((PlacementModifier)RarityFilter.onAverageOnceEvery(rarity), heightRange);
/*     */   }
/*     */   
...
/*     */     
/* 116 */     PlacementUtils.register(context, ORE_MAGMA, (Holder<ConfiguredFeature<?, ?>>)reference1, 
...
/*     */     
/* 119 */     PlacementUtils.register(context, ORE_SOUL_SAND, (Holder<ConfiguredFeature<?, ?>>)reference2, 
...
/*     */     
/* 122 */     PlacementUtils.register(context, ORE_GOLD_DELTAS, (Holder<ConfiguredFeature<?, ?>>)reference3, 
/* 123 */         commonOrePlacement(20, PlacementUtils.RANGE_10_10));
/*     */     
/* 125 */     PlacementUtils.register(context, ORE_QUARTZ_DELTAS, (Holder<ConfiguredFeature<?, ?>>)reference4, 
/* 126 */         commonOrePlacement(32, PlacementUtils.RANGE_10_10));
/*     */     
/* 128 */     PlacementUtils.register(context, ORE_GOLD_NETHER, (Holder<ConfiguredFeature<?, ?>>)reference3, 
/* 129 */         commonOrePlacement(10, PlacementUtils.RANGE_10_10));
/*     */     
/* 131 */     PlacementUtils.register(context, ORE_QUARTZ_NETHER, (Holder<ConfiguredFeature<?, ?>>)reference4, 
/* 132 */         commonOrePlacement(16, PlacementUtils.RANGE_10_10));
/*     */     
/* 134 */     PlacementUtils.register(context, ORE_GRAVEL_NETHER, (Holder<ConfiguredFeature<?, ?>>)reference5, 
...
/*     */     
/* 137 */     PlacementUtils.register(context, ORE_BLACKSTONE, (Holder<ConfiguredFeature<?, ?>>)reference6, 
...
/*     */     
/* 140 */     PlacementUtils.register(context, ORE_DIRT, (Holder<ConfiguredFeature<?, ?>>)reference7, 
...
/*     */     
/* 143 */     PlacementUtils.register(context, ORE_GRAVEL, (Holder<ConfiguredFeature<?, ?>>)reference8, 
/* 144 */         commonOrePlacement(14, (PlacementModifier)HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.top())));
/*     */     
/* 146 */     PlacementUtils.register(context, ORE_GRANITE_UPPER, (Holder<ConfiguredFeature<?, ?>>)reference9, 
...
/*     */     
/* 149 */     PlacementUtils.register(context, ORE_GRANITE_LOWER, (Holder<ConfiguredFeature<?, ?>>)reference9, 
...
/*     */     
/* 152 */     PlacementUtils.register(context, ORE_DIORITE_UPPER, (Holder<ConfiguredFeature<?, ?>>)reference10, 
...
/*     */     
/* 155 */     PlacementUtils.register(context, ORE_DIORITE_LOWER, (Holder<ConfiguredFeature<?, ?>>)reference10, 
...
/*     */     
/* 158 */     PlacementUtils.register(context, ORE_ANDESITE_UPPER, (Holder<ConfiguredFeature<?, ?>>)reference11, 
...
/*     */     
/* 161 */     PlacementUtils.register(context, ORE_ANDESITE_LOWER, (Holder<ConfiguredFeature<?, ?>>)reference11, 
...
/*     */     
/* 164 */     PlacementUtils.register(context, ORE_TUFF, (Holder<ConfiguredFeature<?, ?>>)reference12, 
/* 165 */         commonOrePlacement(2, (PlacementModifier)HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(0))));
/*     */     
/* 167 */     PlacementUtils.register(context, ORE_COAL_UPPER, (Holder<ConfiguredFeature<?, ?>>)reference13, 
/* 168 */         commonOrePlacement(30, (PlacementModifier)HeightRangePlacement.uniform(VerticalAnchor.absolute(136), VerticalAnchor.top())));
/*     */     
/* 170 */     PlacementUtils.register(context, ORE_COAL_LOWER, (Holder<ConfiguredFeature<?, ?>>)reference14, 
...
/*     */     
/* 173 */     PlacementUtils.register(context, ORE_IRON_UPPER, (Holder<ConfiguredFeature<?, ?>>)reference15, 
...
/*     */     
/* 176 */     PlacementUtils.register(context, ORE_IRON_MIDDLE, (Holder<ConfiguredFeature<?, ?>>)reference15, 
...
/*     */     
/* 179 */     PlacementUtils.register(context, ORE_IRON_SMALL, (Holder<ConfiguredFeature<?, ?>>)reference16, 
...
/*     */     
/* 182 */     PlacementUtils.register(context, ORE_GOLD_EXTRA, (Holder<ConfiguredFeature<?, ?>>)reference17, 
...
/*     */     
/* 185 */     PlacementUtils.register(context, ORE_GOLD, (Holder<ConfiguredFeature<?, ?>>)reference18, 
...
/*     */     
/* 188 */     PlacementUtils.register(context, ORE_GOLD_LOWER, (Holder<ConfiguredFeature<?, ?>>)reference18, 
/* 189 */         orePlacement(
...
/*     */ 
/*     */     
/* 194 */     PlacementUtils.register(context, ORE_REDSTONE, (Holder<ConfiguredFeature<?, ?>>)reference19, 
/* 195 */         commonOrePlacement(4, (PlacementModifier)HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(15))));
/*     */     
/* 197 */     PlacementUtils.register(context, ORE_REDSTONE_LOWER, (Holder<ConfiguredFeature<?, ?>>)reference19, 
...
/*     */     
/* 200 */     PlacementUtils.register(context, ORE_DIAMOND, (Holder<ConfiguredFeature<?, ?>>)reference20, 
...
/*     */     
/* 203 */     PlacementUtils.register(context, ORE_DIAMOND_MEDIUM, (Holder<ConfiguredFeature<?, ?>>)reference21, 
...
/*     */     
/* 206 */     PlacementUtils.register(context, ORE_DIAMOND_LARGE, (Holder<ConfiguredFeature<?, ?>>)reference22, 
...
/*     */     
/* 209 */     PlacementUtils.register(context, ORE_DIAMOND_BURIED, (Holder<ConfiguredFeature<?, ?>>)reference23, 
...
/*     */     
/* 212 */     PlacementUtils.register(context, ORE_LAPIS, (Holder<ConfiguredFeature<?, ?>>)reference24, 
...
/*     */     
/* 215 */     PlacementUtils.register(context, ORE_LAPIS_BURIED, (Holder<ConfiguredFeature<?, ?>>)reference25, 
/* 216 */         commonOrePlacement(4, (PlacementModifier)HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(64))));
/*     */     
/* 218 */     PlacementUtils.register(context, ORE_INFESTED, (Holder<ConfiguredFeature<?, ?>>)reference26, 
...
/*     */     
/* 221 */     PlacementUtils.register(context, ORE_EMERALD, (Holder<ConfiguredFeature<?, ?>>)reference27, 
...
/*     */     
/* 224 */     PlacementUtils.register(context, ORE_ANCIENT_DEBRIS_LARGE, (Holder<ConfiguredFeature<?, ?>>)reference28, new PlacementModifier[] {
...
/*     */         });
/* 229 */     PlacementUtils.register(context, ORE_ANCIENT_DEBRIS_SMALL, (Holder<ConfiguredFeature<?, ?>>)reference29, new PlacementModifier[] {
/* 230 */           (PlacementModifier)InSquarePlacement.spread(), PlacementUtils.RANGE_8_8, 
/*     */           
/* 232 */           (PlacementModifier)BiomeFilter.biome()
/*     */         });
/* 234 */     PlacementUtils.register(context, ORE_COPPER, (Holder<ConfiguredFeature<?, ?>>)reference30, 
...
/*     */     
/* 237 */     PlacementUtils.register(context, ORE_COPPER_LARGE, (Holder<ConfiguredFeature<?, ?>>)reference31, 
...
/*     */     
/* 240 */     PlacementUtils.register(context, ORE_CLAY, (Holder<ConfiguredFeature<?, ?>>)reference32, 
/* 241 */         commonOrePlacement(46, PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT));
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/worldgen/placement/OrePlacements.class
