...
/*    */   
/* 31 */   public VanillaChargedCreeperExplosionLoot(HolderLookup.Provider registries) { this.registries = registries; } public final String toString() { // Byte code:
/*    */     //   0: aload_0
...
/* 31 */     //   0	7	0	this	Lnet/minecraft/data/loot/packs/VanillaChargedCreeperExplosionLoot; } public HolderLookup.Provider registries() { return this.registries; }
...
/*    */     // Local variable table:
/*    */     //   start	length	slot	name	descriptor
/*    */     //   0	7	0	this	Lnet/minecraft/data/loot/packs/VanillaChargedCreeperExplosionLoot; } public final boolean equals(Object o) { // Byte code:
/*    */     //   0: aload_0
/*    */     //   1: aload_1
...
/*    */     
/* 44 */     List<LootPoolEntryContainer.Builder<?>> alternatives = new ArrayList<>(ENTRIES.size());
/* 45 */     for (Entry entry : ENTRIES) {
/* 46 */       output.accept(entry.lootTable, LootTable.lootTable()
/* 47 */           .withPool(LootPool.lootPool()
/* 48 */             .setRolls((NumberProvider)ConstantValue.exactly(1.0F))
/* 49 */             .add((LootPoolEntryContainer.Builder)LootItem.lootTableItem((net.minecraft.world.level.ItemLike)entry.item))));
/*    */ 
/*    */       
/* 52 */       LootItemCondition.Builder predicate = LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, EntityPredicate.Builder.entity().entityType(EntityTypePredicate.of((HolderGetter)registryLookup, entry.entityType)));
...
/* 59 */           .add((LootPoolEntryContainer.Builder)net.minecraft.world.level.storage.loot.entries.AlternativesEntry.alternatives((LootPoolEntryContainer.Builder[])alternatives.toArray(x$0 -> new LootPoolEntryContainer.Builder[x$0])))));
/*    */   }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/loot/packs/VanillaChargedCreeperExplosionLoot.class
