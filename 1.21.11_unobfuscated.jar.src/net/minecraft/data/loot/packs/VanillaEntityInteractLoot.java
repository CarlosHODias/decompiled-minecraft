...
/* 17 */     //   0	7	0	this	Lnet/minecraft/data/loot/packs/VanillaEntityInteractLoot; } public HolderLookup.Provider registries() { return this.registries; }
...
/* 23 */           .setRolls((net.minecraft.world.level.storage.loot.providers.number.NumberProvider)ConstantValue.exactly(1.0F))
/* 24 */           .add((net.minecraft.world.level.storage.loot.entries.LootPoolEntryContainer.Builder)LootItem.lootTableItem((net.minecraft.world.level.ItemLike)Items.ARMADILLO_SCUTE))));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/loot/packs/VanillaEntityInteractLoot.class
