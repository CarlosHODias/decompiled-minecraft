...
/*    */   }
/*    */   
/*    */   private Entry(ResourceKey<LootTable> lootTable, EntityType<?> entityType, Item item) {
/* 64 */     this.lootTable = lootTable; this.entityType = entityType; this.item = item; } public ResourceKey<LootTable> lootTable() { return this.lootTable; } public EntityType<?> entityType() { return this.entityType; } public Item item() { return this.item; }
/*    */ 
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/loot/packs/VanillaChargedCreeperExplosionLoot$Entry.class
