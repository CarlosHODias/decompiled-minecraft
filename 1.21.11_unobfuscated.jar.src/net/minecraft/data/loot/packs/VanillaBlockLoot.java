...
/*  107 */     super(EXPLOSION_RESISTANT, FeatureFlags.REGISTRY.allFlags(), registries);
/*      */   }
/*      */ 
/*      */   
...
/*      */ 
/*      */     
/*  745 */     add(Blocks.STONE, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.COBBLESTONE));
/*  746 */     add(Blocks.DEEPSLATE, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.COBBLED_DEEPSLATE));
/*  747 */     add(Blocks.GRASS_BLOCK, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.DIRT));
/*  748 */     add(Blocks.PODZOL, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.DIRT));
/*  749 */     add(Blocks.MYCELIUM, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.DIRT));
/*  750 */     add(Blocks.TUBE_CORAL_BLOCK, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.DEAD_TUBE_CORAL_BLOCK));
/*  751 */     add(Blocks.BRAIN_CORAL_BLOCK, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.DEAD_BRAIN_CORAL_BLOCK));
/*  752 */     add(Blocks.BUBBLE_CORAL_BLOCK, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.DEAD_BUBBLE_CORAL_BLOCK));
/*  753 */     add(Blocks.FIRE_CORAL_BLOCK, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.DEAD_FIRE_CORAL_BLOCK));
/*  754 */     add(Blocks.HORN_CORAL_BLOCK, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.DEAD_HORN_CORAL_BLOCK));
/*  755 */     add(Blocks.CRIMSON_NYLIUM, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.NETHERRACK));
/*  756 */     add(Blocks.WARPED_NYLIUM, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.NETHERRACK));
/*      */ 
/*      */     
/*  759 */     add(Blocks.BOOKSHELF, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Items.BOOK, (NumberProvider)ConstantValue.exactly(3.0F)));
/*  760 */     add(Blocks.CLAY, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Items.CLAY_BALL, (NumberProvider)ConstantValue.exactly(4.0F)));
/*  761 */     add(Blocks.ENDER_CHEST, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Blocks.OBSIDIAN, (NumberProvider)ConstantValue.exactly(8.0F)));
/*  762 */     add(Blocks.SNOW_BLOCK, block -> createSingleItemTableWithSilkTouch(block, (ItemLike)Items.SNOWBALL, (NumberProvider)ConstantValue.exactly(4.0F)));
/*      */     
...
/*      */ 
/*      */     
/*  890 */     add(Blocks.BLACK_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  891 */     add(Blocks.BLUE_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  892 */     add(Blocks.BROWN_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  893 */     add(Blocks.CYAN_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  894 */     add(Blocks.GRAY_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  895 */     add(Blocks.GREEN_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  896 */     add(Blocks.LIGHT_BLUE_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  897 */     add(Blocks.LIGHT_GRAY_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  898 */     add(Blocks.LIME_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  899 */     add(Blocks.MAGENTA_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  900 */     add(Blocks.PURPLE_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  901 */     add(Blocks.ORANGE_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  902 */     add(Blocks.PINK_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  903 */     add(Blocks.RED_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  904 */     add(Blocks.WHITE_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*  905 */     add(Blocks.YELLOW_BED, block -> createSinglePropConditionTable(block, (Property)BedBlock.PART, (Comparable)BedPart.HEAD));
/*      */ 
/*      */     
/*  908 */     add(Blocks.LILAC, block -> createSinglePropConditionTable(block, (Property)DoublePlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER));
/*  909 */     add(Blocks.SUNFLOWER, block -> createSinglePropConditionTable(block, (Property)DoublePlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER));
/*  910 */     add(Blocks.PEONY, block -> createSinglePropConditionTable(block, (Property)DoublePlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER));
/*  911 */     add(Blocks.ROSE_BUSH, block -> createSinglePropConditionTable(block, (Property)DoublePlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER));
/*      */ 
/*      */     
...
/*      */ 
/*      */     
/*  922 */     add(Blocks.COCOA, block -> LootTable.lootTable().withPool(LootPool.lootPool().setRolls((NumberProvider)ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)applyExplosionDecay((ItemLike)block, (FunctionUserBuilder)LootItem.lootTableItem((ItemLike)Items.COCOA_BEANS).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)ConstantValue.exactly(3.0F)).when((LootItemCondition.Builder)LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty((Property)CocoaBlock.AGE, 2))))))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  932 */     add(Blocks.SEA_PICKLE, block -> LootTable.lootTable().withPool(LootPool.lootPool().setRolls((NumberProvider)ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)applyExplosionDecay((ItemLike)Blocks.SEA_PICKLE, LootItem.lootTableItem((ItemLike)block).apply(List.of(2, 3, 4), ())))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  940 */     add(Blocks.COMPOSTER, block -> LootTable.lootTable().withPool(LootPool.lootPool().add((LootPoolEntryContainer.Builder)applyExplosionDecay((ItemLike)block, (FunctionUserBuilder)LootItem.lootTableItem((ItemLike)Items.COMPOSTER)))).withPool(LootPool.lootPool().add((LootPoolEntryContainer.Builder)LootItem.lootTableItem((ItemLike)Items.BONE_MEAL)).when((LootItemCondition.Builder)LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty((Property)ComposterBlock.LEVEL, 8)))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/* 1054 */     add(Blocks.PLAYER_HEAD, block -> LootTable.lootTable().withPool((LootPool.Builder)applyExplosionCondition((ItemLike)block, (ConditionUserBuilder)LootPool.lootPool().setRolls((NumberProvider)ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)LootItem.lootTableItem((ItemLike)block).apply((LootItemFunction.Builder)CopyComponentsFunction.copyComponentsFromBlockEntity(LootContextParams.BLOCK_ENTITY).include(DataComponents.PROFILE).include(DataComponents.NOTE_BLOCK_SOUND).include(DataComponents.CUSTOM_NAME))))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 1132 */             .add((LootPoolEntryContainer.Builder)LootItem.lootTableItem((ItemLike)Items.CARROT).apply((LootItemFunction.Builder)ApplyBonusCount.addBonusBinomialDistributionCount((Holder)enchantments.getOrThrow(Enchantments.FORTUNE), 0.5714286F, 3))))));
/*      */ 
/*      */ 
/*      */     
...
/* 1143 */             .add((LootPoolEntryContainer.Builder)LootItem.lootTableItem((ItemLike)Items.POTATO).apply((LootItemFunction.Builder)ApplyBonusCount.addBonusBinomialDistributionCount((Holder)enchantments.getOrThrow(Enchantments.FORTUNE), 0.5714286F, 3))))
/*      */           
...
/*      */ 
/*      */     
/* 1151 */     add(Blocks.SWEET_BERRY_BUSH, block -> (LootTable.Builder)applyExplosionDecay((ItemLike)enchantments, (FunctionUserBuilder)LootTable.lootTable().withPool(LootPool.lootPool().when((LootItemCondition.Builder)LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.SWEET_BERRY_BUSH).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty((Property)SweetBerryBushBlock.AGE, 3))).add((LootPoolEntryContainer.Builder)LootItem.lootTableItem((ItemLike)Items.SWEET_BERRIES)).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)UniformGenerator.between(2.0F, 3.0F))).apply((LootItemFunction.Builder)ApplyBonusCount.addUniformBonusCount((Holder)enchantments.getOrThrow(Enchantments.FORTUNE)))).withPool(LootPool.lootPool().when((LootItemCondition.Builder)LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.SWEET_BERRY_BUSH).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty((Property)SweetBerryBushBlock.AGE, 2))).add((LootPoolEntryContainer.Builder)LootItem.lootTableItem((ItemLike)Items.SWEET_BERRIES)).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)UniformGenerator.between(1.0F, 2.0F))).apply((LootItemFunction.Builder)ApplyBonusCount.addUniformBonusCount((Holder)enchantments.getOrThrow(Enchantments.FORTUNE))))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 1169 */     add(Blocks.BROWN_MUSHROOM_BLOCK, block -> createMushroomBlockDrop(block, (ItemLike)Blocks.BROWN_MUSHROOM));
/* 1170 */     add(Blocks.RED_MUSHROOM_BLOCK, block -> createMushroomBlockDrop(block, (ItemLike)Blocks.RED_MUSHROOM));
/*      */ 
/*      */     
...
/*      */     
/* 1187 */     add(Blocks.NETHER_GOLD_ORE, block -> createSilkTouchDispatchTable(enchantments, (LootPoolEntryContainer.Builder)applyExplosionDecay((ItemLike)enchantments, (FunctionUserBuilder)LootItem.lootTableItem((ItemLike)Items.GOLD_NUGGET).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)UniformGenerator.between(2.0F, 6.0F))).apply((LootItemFunction.Builder)ApplyBonusCount.addOreBonusCount((Holder)enchantments.getOrThrow(Enchantments.FORTUNE))))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 1198 */     add(Blocks.COBWEB, block -> createSilkTouchOrShearsDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionCondition((ItemLike)block, (ConditionUserBuilder)LootItem.lootTableItem((ItemLike)Items.STRING))));
/*      */ 
/*      */ 
/*      */     
/* 1202 */     add(Blocks.DEAD_BUSH, block -> createShearsDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionDecay((ItemLike)block, (FunctionUserBuilder)LootItem.lootTableItem((ItemLike)Items.STICK).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)UniformGenerator.between(0.0F, 2.0F))))));
/*      */ 
/*      */     
...
/*      */ 
/*      */     
/* 1230 */     add(Blocks.CHORUS_FLOWER, block -> LootTable.lootTable().withPool(LootPool.lootPool().setRolls((NumberProvider)ConstantValue.exactly(1.0F)).add(((LootPoolSingletonContainer.Builder)applyExplosionCondition((ItemLike)block, (ConditionUserBuilder)LootItem.lootTableItem((ItemLike)block))).when(LootItemEntityPropertyCondition.entityPresent(LootContext.EntityTarget.THIS)))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/* 1240 */     add(Blocks.GLOWSTONE, block -> createSilkTouchDispatchTable(enchantments, (LootPoolEntryContainer.Builder)applyExplosionDecay((ItemLike)enchantments, (FunctionUserBuilder)LootItem.lootTableItem((ItemLike)Items.GLOWSTONE_DUST).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)UniformGenerator.between(2.0F, 4.0F))).apply((LootItemFunction.Builder)ApplyBonusCount.addUniformBonusCount((Holder)enchantments.getOrThrow(Enchantments.FORTUNE))).apply((LootItemFunction.Builder)LimitCount.limitCount(IntRange.range(1, 4))))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 1248 */     add(Blocks.MELON, block -> createSilkTouchDispatchTable(enchantments, (LootPoolEntryContainer.Builder)applyExplosionDecay((ItemLike)enchantments, (FunctionUserBuilder)LootItem.lootTableItem((ItemLike)Items.MELON_SLICE).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)UniformGenerator.between(3.0F, 7.0F))).apply((LootItemFunction.Builder)ApplyBonusCount.addUniformBonusCount((Holder)enchantments.getOrThrow(Enchantments.FORTUNE))).apply((LootItemFunction.Builder)LimitCount.limitCount(IntRange.upperBound(9))))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/* 1259 */     add(Blocks.SEA_LANTERN, block -> createSilkTouchDispatchTable(enchantments, (LootPoolEntryContainer.Builder)applyExplosionDecay((ItemLike)enchantments, (FunctionUserBuilder)LootItem.lootTableItem((ItemLike)Items.PRISMARINE_CRYSTALS).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)UniformGenerator.between(2.0F, 3.0F))).apply((LootItemFunction.Builder)ApplyBonusCount.addUniformBonusCount((Holder)enchantments.getOrThrow(Enchantments.FORTUNE))).apply((LootItemFunction.Builder)LimitCount.limitCount(IntRange.range(1, 5))))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 1267 */     add(Blocks.CREAKING_HEART, block -> createSilkTouchDispatchTable(enchantments, (LootPoolEntryContainer.Builder)applyExplosionDecay((ItemLike)enchantments, (FunctionUserBuilder)LootItem.lootTableItem((ItemLike)Items.RESIN_CLUMP).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)UniformGenerator.between(1.0F, 3.0F))).apply((LootItemFunction.Builder)ApplyBonusCount.addUniformBonusCount((Holder)enchantments.getOrThrow(Enchantments.FORTUNE))).apply((LootItemFunction.Builder)LimitCount.limitCount(IntRange.upperBound(9))))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 1275 */     add(Blocks.NETHER_WART, block -> LootTable.lootTable().withPool((LootPool.Builder)applyExplosionDecay((ItemLike)enchantments, (FunctionUserBuilder)LootPool.lootPool().setRolls((NumberProvider)ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)LootItem.lootTableItem((ItemLike)Items.NETHER_WART).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)UniformGenerator.between(2.0F, 4.0F)).when((LootItemCondition.Builder)LootItemBlockStatePropertyCondition.hasBlockStateProperties(enchantments).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty((Property)NetherWartBlock.AGE, 3)))).apply((LootItemFunction.Builder)ApplyBonusCount.addUniformBonusCount((Holder)enchantments.getOrThrow(Enchantments.FORTUNE)).when((LootItemCondition.Builder)LootItemBlockStatePropertyCondition.hasBlockStateProperties(enchantments).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty((Property)NetherWartBlock.AGE, 3))))))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 1305 */     add(Blocks.GRAVEL, block -> createSilkTouchDispatchTable(enchantments, (LootPoolEntryContainer.Builder)applyExplosionCondition((ItemLike)enchantments, (ConditionUserBuilder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem((ItemLike)Items.FLINT).when(BonusLevelTableCondition.bonusLevelFlatChance((Holder)enchantments.getOrThrow(Enchantments.FORTUNE), new float[] { 0.1F, 0.14285715F, 0.25F, 1.0F }))).otherwise((LootPoolEntryContainer.Builder)LootItem.lootTableItem((ItemLike)enchantments)))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 1312 */     add(Blocks.CAMPFIRE, block -> createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionCondition((ItemLike)block, (ConditionUserBuilder)LootItem.lootTableItem((ItemLike)Items.CHARCOAL).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)ConstantValue.exactly(2.0F))))));
/*      */ 
/*      */ 
/*      */     
/* 1316 */     add(Blocks.GILDED_BLACKSTONE, block -> createSilkTouchDispatchTable(enchantments, (LootPoolEntryContainer.Builder)applyExplosionCondition((ItemLike)enchantments, (ConditionUserBuilder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem((ItemLike)Items.GOLD_NUGGET).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)UniformGenerator.between(2.0F, 5.0F))).when(BonusLevelTableCondition.bonusLevelFlatChance((Holder)enchantments.getOrThrow(Enchantments.FORTUNE), new float[] { 0.1F, 0.14285715F, 0.25F, 1.0F }))).otherwise((LootPoolEntryContainer.Builder)LootItem.lootTableItem((ItemLike)enchantments)))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 1323 */     add(Blocks.SOUL_CAMPFIRE, block -> createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionCondition((ItemLike)block, (ConditionUserBuilder)LootItem.lootTableItem((ItemLike)Items.SOUL_SOIL).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)ConstantValue.exactly(1.0F))))));
/*      */ 
/*      */ 
/*      */     
/* 1327 */     add(Blocks.AMETHYST_CLUSTER, block -> createSilkTouchDispatchTable(enchantments, (LootPoolEntryContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem((ItemLike)Items.AMETHYST_SHARD).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)ConstantValue.exactly(4.0F))).apply((LootItemFunction.Builder)ApplyBonusCount.addOreBonusCount((Holder)enchantments.getOrThrow(Enchantments.FORTUNE))).when(MatchTool.toolMatches(ItemPredicate.Builder.item().of((HolderGetter)enchantments, ItemTags.CLUSTER_MAX_HARVESTABLES)))).otherwise((LootPoolEntryContainer.Builder)applyExplosionDecay((ItemLike)enchantments, (FunctionUserBuilder)LootItem.lootTableItem((ItemLike)Items.AMETHYST_SHARD).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)ConstantValue.exactly(2.0F)))))));
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 1465 */           .when((LootItemCondition.Builder)LootItemBlockStatePropertyCondition.hasBlockStateProperties(original).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty((Property)DecoratedPotBlock.CRACKED, true))))
/* 1466 */           .otherwise((LootPoolEntryContainer.Builder)LootItem.lootTableItem((ItemLike)original)
...
/* 1479 */           .add((LootPoolEntryContainer.Builder)AlternativesEntry.alternatives(PitcherCropBlock.AGE.getPossibleValues(), age -> {
/*      */                 LootItemBlockStatePropertyCondition.Builder isLowerPart = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.PITCHER_CROP).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty((Property)DoublePlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER)), isAge = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.PITCHER_CROP).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty((Property)PitcherCropBlock.AGE, age));
/*      */                 return (age == 4) ? ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem((ItemLike)Items.PITCHER_PLANT).when((LootItemCondition.Builder)isAge)).when((LootItemCondition.Builder)isLowerPart)).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)ConstantValue.exactly(1.0F))) : ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem((ItemLike)Items.PITCHER_POD).when((LootItemCondition.Builder)isAge)).when((LootItemCondition.Builder)isLowerPart)).apply((LootItemFunction.Builder)SetItemCountFunction.setCount((NumberProvider)ConstantValue.exactly(1.0F)));
/*      */               }))));
/*      */   }
/*      */ 
/*      */ 
...
/* 1508 */       .withPool((LootPool.Builder)applyExplosionCondition((ItemLike)block, (ConditionUserBuilder)LootPool.lootPool()
/* 1509 */           .setRolls((NumberProvider)ConstantValue.exactly(1.0F))
/* 1510 */           .add((LootPoolEntryContainer.Builder)LootItem.lootTableItem((ItemLike)block)
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/loot/packs/VanillaBlockLoot.class
