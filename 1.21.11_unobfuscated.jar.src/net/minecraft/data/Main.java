...
/*  77 */     ArgumentAcceptingOptionSpec argumentAcceptingOptionSpec1 = parser.accepts("output", "Output folder").withRequiredArg().defaultsTo("generated", (Object[])new String[0]);
...
/*     */     
/*  81 */     if (optionSet.has((OptionSpec)abstractOptionSpec) || !optionSet.hasOptions()) {
...
/*  87 */     boolean allOptions = optionSet.has((OptionSpec)optionSpecBuilder4);
/*  88 */     boolean server = (allOptions || optionSet.has((OptionSpec)optionSpecBuilder1));
/*  89 */     boolean dev = (allOptions || optionSet.has((OptionSpec)optionSpecBuilder2));
/*  90 */     boolean reports = (allOptions || optionSet.has((OptionSpec)optionSpecBuilder3));
/*  91 */     Collection<Path> input = optionSet.valuesOf((OptionSpec)argumentAcceptingOptionSpec2).stream().map(x$0 -> Paths.get(x$0, new String[0])).toList();
...
/*  99 */     return output -> (DataProvider)target.apply(output, registries);
/*     */   }
/*     */ 
/*     */   
...
/* 105 */     commonVanillaPack.addProvider(o -> new SnbtToNbt(o, input).addFilter((SnbtToNbt.Filter)new StructureUpdater()));
/*     */ 
/*     */     
/* 108 */     CompletableFuture<HolderLookup.Provider> vanillaRegistries = CompletableFuture.supplyAsync(VanillaRegistries::createLookup, (Executor)Util.backgroundExecutor());
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 126 */     TagsProvider<Block> vanillaBlockTagsProvider = serverVanillaPack.<TagsProvider<Block>>addProvider(bindRegistries(net.minecraft.data.tags.VanillaBlockTagsProvider::new, vanillaRegistries));
/* 127 */     TagsProvider<Item> vanillaItemTagsProvider = serverVanillaPack.<TagsProvider<Item>>addProvider(bindRegistries(net.minecraft.data.tags.VanillaItemTagsProvider::new, vanillaRegistries));
/* 128 */     TagsProvider<Biome> vanillaBiomeTagsProvider = serverVanillaPack.<TagsProvider<Biome>>addProvider(bindRegistries(net.minecraft.data.tags.BiomeTagsProvider::new, vanillaRegistries));
/* 129 */     TagsProvider<BannerPattern> vanillaBannerPatternTagsProvider = serverVanillaPack.<TagsProvider<BannerPattern>>addProvider(bindRegistries(net.minecraft.data.tags.BannerPatternTagsProvider::new, vanillaRegistries));
/* 130 */     TagsProvider<Structure> vanillaStructureTagsProvider = serverVanillaPack.<TagsProvider<Structure>>addProvider(bindRegistries(net.minecraft.data.tags.StructureTagsProvider::new, vanillaRegistries));
/*     */     
...
/* 169 */     tradeRebalancePack.addProvider(o -> PackMetadataGenerator.forFeaturePack(o, (Component)Component.translatable("dataPack.trade_rebalance.description"), FeatureFlagSet.of(FeatureFlags.TRADE_REBALANCE)));
...
/* 176 */     redstoneChangesPack.addProvider(o -> PackMetadataGenerator.forFeaturePack(o, (Component)Component.translatable("dataPack.redstone_experiments.description"), FeatureFlagSet.of(FeatureFlags.REDSTONE_EXPERIMENTS)));
/*     */ 
/*     */ 
/*     */     
/* 180 */     DataGenerator.PackGenerator minecartImprovementsPack = generator.getBuiltinDatapack(server, "minecart_improvements");
/* 181 */     minecartImprovementsPack.addProvider(o -> PackMetadataGenerator.forFeaturePack(o, (Component)Component.translatable("dataPack.minecart_improvements.description"), FeatureFlagSet.of(FeatureFlags.MINECART_IMPROVEMENTS)));
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/Main.class
