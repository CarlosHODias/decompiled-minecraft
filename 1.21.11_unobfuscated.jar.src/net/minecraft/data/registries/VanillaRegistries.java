...
/*  99 */     validateThatAllBiomeFeaturesHaveBiomeFilter((HolderGetter<PlacedFeature>)provider.lookupOrThrow(Registries.PLACED_FEATURE), (HolderLookup<Biome>)provider.lookupOrThrow(Registries.BIOME));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */           biomeFeatures.stream().flatMap(HolderSet::stream).forEach(());
/*     */         });
/*     */   }
/*     */ 
/*     */ 
...
/* 129 */     return value.placement().contains(BiomeFilter.biome());
/*     */   }
/*     */   
/*     */   public static HolderLookup.Provider createLookup() {
/* 133 */     RegistryAccess.Frozen staticRegistries = RegistryAccess.fromRegistryOfRegistries(BuiltInRegistries.REGISTRY);
/* 134 */     HolderLookup.Provider newRegistries = BUILDER.build((RegistryAccess)staticRegistries);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/data/registries/VanillaRegistries.class
