/*    */ package net.minecraft.gizmos;public final class CircleGizmo extends Record implements Gizmo { private final net.minecraft.world.phys.Vec3 pos; private final float radius;
...
/*    */   
/*  6 */   public CircleGizmo(net.minecraft.world.phys.Vec3 pos, float radius, GizmoStyle style) { this.pos = pos; this.radius = radius; this.style = style; } public final String toString() { // Byte code:
/*    */     //   0: aload_0
...
/*  6 */     //   0	7	0	this	Lnet/minecraft/gizmos/CircleGizmo; } public net.minecraft.world.phys.Vec3 pos() { return this.pos; } public final int hashCode() { // Byte code:
/*    */     //   0: aload_0
...
/*    */     }
/*    */     
/* 16 */     net.minecraft.world.phys.Vec3[] points = new net.minecraft.world.phys.Vec3[21];
/* 17 */     for (int i = 0; i < 20; i++) {
/* 18 */       float theta = i * 0.31415927F;
/* 19 */       net.minecraft.world.phys.Vec3 point = this.pos.add((float)(this.radius * Math.cos(theta)), 0.0D, (float)(this.radius * Math.sin(theta)));
/* 20 */       points[i] = point;
/*    */     } 
...
/* 31 */         primitives.addLine(points[j], points[j + 1], color, this.style.strokeWidth()); 
/*    */     } 
/*    */   } }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/gizmos/CircleGizmo.class
