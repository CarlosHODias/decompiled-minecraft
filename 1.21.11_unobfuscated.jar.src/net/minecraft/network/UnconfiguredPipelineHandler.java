...
/*  87 */     return setupInboundHandler((ChannelInboundHandler)new PacketDecoder<>(protocolInfo));
/*     */   }
/*     */   
...
/*  98 */     return setupOutboundHandler((ChannelOutboundHandler)new PacketEncoder<>(codecData));
/*     */   }
/*     */   
/*     */   private static OutboundConfigurationTask setupOutboundHandler(ChannelOutboundHandler newHandler) {
/* 102 */     return ctx -> ctx.pipeline().replace(ctx.name(), "encoder", (ChannelHandler)newHandler);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/UnconfiguredPipelineHandler.class
