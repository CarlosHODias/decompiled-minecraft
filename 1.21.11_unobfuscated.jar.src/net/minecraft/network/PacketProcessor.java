...
/*    */   
/* 16 */   private final Queue<ListenerAndPacket<?>> packetsToBeHandled = Queues.newConcurrentLinkedQueue();
...
/* 25 */     return (Thread.currentThread() == this.runningThread);
/*    */   }
/*    */   
...
/* 48 */       //   0	7	0	this	Lnet/minecraft/network/PacketProcessor$ListenerAndPacket<TT;>; } public T listener() { return this.listener; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */         try {
/* 55 */           this.packet.handle((PacketListener)this.listener);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/PacketProcessor.class
