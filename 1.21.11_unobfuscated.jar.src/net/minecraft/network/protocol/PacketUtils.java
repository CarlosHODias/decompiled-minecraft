...
/* 18 */     ensureRunningOnSameThread(packet, listener, level.getServer().packetProcessor());
/*    */   }
/*    */   
...
/* 23 */       packetProcessor.scheduleIfPossible((PacketListener)listener, packet);
...
/*    */ 
/*    */   
/*    */   public static <T extends PacketListener> void fillCrashReport(CrashReport report, T listener, Packet<T> packet) {
/* 40 */     if (packet != null) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/PacketUtils.class
