...
/*    */ 
/*    */ public final class ClientboundCustomQueryPacket extends Record implements net.minecraft.network.protocol.Packet<ClientLoginPacketListener> {
...
/* 12 */    public static final net.minecraft.network.codec.StreamCodec<FriendlyByteBuf, ClientboundCustomQueryPacket> STREAM_CODEC = net.minecraft.network.protocol.Packet.codec(ClientboundCustomQueryPacket::write, ClientboundCustomQueryPacket::new);
/*    */   
...
/* 28 */     return (CustomQueryPayload)readUnknownPayload(identifier, input);
/*    */   }
/*    */   
/*    */   private static net.minecraft.network.protocol.login.custom.DiscardedQueryPayload readUnknownPayload(Identifier identifier, FriendlyByteBuf input) {
...
/* 37 */     return new net.minecraft.network.protocol.login.custom.DiscardedQueryPayload(identifier);
/*    */   }
/*    */   
...
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ClientboundCustomQueryPacket> type() {
/* 48 */     return LoginPacketTypes.CLIENTBOUND_CUSTOM_QUERY;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientLoginPacketListener listener) {
/* 53 */     listener.handleCustomQuery(this);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/login/ClientboundCustomQueryPacket.class
