...
/* 16 */    public static final StreamCodec<net.minecraft.network.FriendlyByteBuf, ClientboundMoveMinecartPacket> STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.VAR_INT, ClientboundMoveMinecartPacket::entityId, 
/*    */       
/* 18 */       NewMinecartBehavior.MinecartStep.STREAM_CODEC.apply(ByteBufCodecs.list()), ClientboundMoveMinecartPacket::lerpSteps, ClientboundMoveMinecartPacket::new);
/*    */ 
/*    */ 
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ClientboundMoveMinecartPacket> type() {
/* 24 */     return GamePacketTypes.CLIENTBOUND_MOVE_MINECART_ALONG_TRACK;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientGamePacketListener listener) {
/* 29 */     listener.handleMinecartAlongTrack(this);
/*    */   }
/*    */   
/*    */   public net.minecraft.world.entity.Entity getEntity(Level level) {
/* 33 */     return level.getEntity(this.entityId);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundMoveMinecartPacket.class
