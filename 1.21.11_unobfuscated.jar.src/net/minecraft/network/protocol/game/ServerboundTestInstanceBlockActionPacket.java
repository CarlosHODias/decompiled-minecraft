...
/*    */ 
/*    */ public final class ServerboundTestInstanceBlockActionPacket extends Record implements net.minecraft.network.protocol.Packet<ServerGamePacketListener> {
...
/* 33 */     this(pos, action, new TestInstanceBlockEntity.Data(test, size, rotation, ignoreEntities, TestInstanceBlockEntity.Status.CLEARED, Optional.empty()));
/*    */   }
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ServerboundTestInstanceBlockActionPacket> type() {
/* 38 */     return GamePacketTypes.SERVERBOUND_TEST_INSTANCE_BLOCK_ACTION;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ServerGamePacketListener listener) {
/* 43 */     listener.handleTestInstanceBlockAction(this);
/*    */   }
/*    */   
/*    */   public enum Action {
/* 47 */     INIT(0),
...
/* 51 */     SAVE(4),
/* 52 */     EXPORT(5),
/* 53 */     RUN(6); private static final java.util.function.IntFunction<Action> BY_ID; public static final StreamCodec<io.netty.buffer.ByteBuf, Action> STREAM_CODEC; private final int id;
/*    */     static {
/* 55 */       BY_ID = ByIdMap.continuous(e -> e.id, (Object[])values(), ByIdMap.OutOfBoundsStrategy.ZERO);
/* 56 */       STREAM_CODEC = net.minecraft.network.codec.ByteBufCodecs.idMapper(BY_ID, e -> e.id);
/*    */     }
/*    */ 
/*    */     
/*    */     Action(int id) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ServerboundTestInstanceBlockActionPacket.class
