...
/*    */ 
/*    */ public final class ServerboundContainerSlotStateChangedPacket extends Record implements net.minecraft.network.protocol.Packet<ServerGamePacketListener> {
...
/*  9 */    public static final net.minecraft.network.codec.StreamCodec<net.minecraft.network.FriendlyByteBuf, ServerboundContainerSlotStateChangedPacket> STREAM_CODEC = net.minecraft.network.protocol.Packet.codec(ServerboundContainerSlotStateChangedPacket::write, ServerboundContainerSlotStateChangedPacket::new);
/*    */   
/*    */   private ServerboundContainerSlotStateChangedPacket(net.minecraft.network.FriendlyByteBuf input) {
/* 12 */     this(input.readVarInt(), input.readContainerId(), input.readBoolean());
/*    */   }
/*    */   
...
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ServerboundContainerSlotStateChangedPacket> type() {
/* 23 */     return GamePacketTypes.SERVERBOUND_CONTAINER_SLOT_STATE_CHANGED;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ServerGamePacketListener listener) {
/* 28 */     listener.handleContainerSlotStateChanged(this);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ServerboundContainerSlotStateChangedPacket.class
