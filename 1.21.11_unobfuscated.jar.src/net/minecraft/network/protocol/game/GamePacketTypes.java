...
/*     */   
/*     */   private static <T extends net.minecraft.network.protocol.Packet<ClientGamePacketListener>> PacketType<T> createClientbound(String id) {
/* 197 */     return new PacketType(PacketFlow.CLIENTBOUND, Identifier.withDefaultNamespace(id));
/*     */   }
/*     */   
/*     */   private static <T extends net.minecraft.network.protocol.Packet<ServerGamePacketListener>> PacketType<T> createServerbound(String id) {
/* 201 */     return new PacketType(PacketFlow.SERVERBOUND, Identifier.withDefaultNamespace(id));
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/GamePacketTypes.class
