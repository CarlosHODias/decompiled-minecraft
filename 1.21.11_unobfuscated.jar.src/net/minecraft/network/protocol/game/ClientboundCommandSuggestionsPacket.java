...
/*    */ 
/*    */ public final class ClientboundCommandSuggestionsPacket extends Record implements net.minecraft.network.protocol.Packet<ClientGamePacketListener> {
/*    */   private final int id;
/*    */   private final int start;
/*    */   private final int length;
/*    */   private final java.util.List<Entry> suggestions;
/*    */   
/* 18 */   public ClientboundCommandSuggestionsPacket(int id, int start, int length, java.util.List<Entry> suggestions) { this.id = id; this.start = start; this.length = length; this.suggestions = suggestions; } public final String toString() { // Byte code:
/*    */     //   0: aload_0
...
/* 18 */     //   0	7	0	this	Lnet/minecraft/network/protocol/game/ClientboundCommandSuggestionsPacket; } public int id() { return this.id; } public final int hashCode() { // Byte code:
/*    */     //   0: aload_0
...
/* 18 */     //   0	8	1	o	Ljava/lang/Object; } public int start() { return this.start; } public int length() { return this.length; } public java.util.List<Entry> suggestions() { return this.suggestions; }
/* 19 */    public static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, ClientboundCommandSuggestionsPacket> STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.VAR_INT, ClientboundCommandSuggestionsPacket::id, ByteBufCodecs.VAR_INT, ClientboundCommandSuggestionsPacket::start, ByteBufCodecs.VAR_INT, ClientboundCommandSuggestionsPacket::length, 
/*    */ 
/*    */ 
/*    */       
/* 23 */       Entry.STREAM_CODEC.apply(ByteBufCodecs.list()), ClientboundCommandSuggestionsPacket::suggestions, ClientboundCommandSuggestionsPacket::new);
/*    */ 
/*    */ 
/*    */   
...
/* 29 */         .map(suggestion -> new Entry(suggestion.getText(), Optional.<Message>ofNullable(suggestion.getTooltip()).map(net.minecraft.network.chat.ComponentUtils::fromMessage)))
/* 30 */         .toList());
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ClientboundCommandSuggestionsPacket> type() {
/* 36 */     return GamePacketTypes.CLIENTBOUND_COMMAND_SUGGESTIONS;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientGamePacketListener listener) {
/* 41 */     listener.handleCommandSuggestions(this);
/*    */   }
/*    */   
...
/* 53 */      public static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, Entry> STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.STRING_UTF8, Entry::text, net.minecraft.network.chat.ComponentSerialization.TRUSTED_OPTIONAL_STREAM_CODEC, Entry::tooltip, Entry::new); }
/*    */ 
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundCommandSuggestionsPacket.class
