...
/*    */ 
/*    */ public final class ClientboundTestInstanceBlockStatus extends Record implements net.minecraft.network.protocol.Packet<ClientGamePacketListener> {
...
/* 15 */    public static final StreamCodec<RegistryFriendlyByteBuf, ClientboundTestInstanceBlockStatus> STREAM_CODEC = StreamCodec.composite(net.minecraft.network.chat.ComponentSerialization.STREAM_CODEC, ClientboundTestInstanceBlockStatus::status, 
/*    */       
/* 17 */       net.minecraft.network.codec.ByteBufCodecs.optional(Vec3i.STREAM_CODEC), ClientboundTestInstanceBlockStatus::size, ClientboundTestInstanceBlockStatus::new);
/*    */ 
/*    */ 
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ClientboundTestInstanceBlockStatus> type() {
/* 23 */     return GamePacketTypes.CLIENTBOUND_TEST_INSTANCE_BLOCK_STATUS;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientGamePacketListener listener) {
/* 28 */     listener.handleTestInstanceBlockStatus(this);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundTestInstanceBlockStatus.class
