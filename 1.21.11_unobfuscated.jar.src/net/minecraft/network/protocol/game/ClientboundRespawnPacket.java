...
/*    */ 
/*    */ public final class ClientboundRespawnPacket extends Record implements net.minecraft.network.protocol.Packet<ClientGamePacketListener> {
...
/*    */ 
/*    */   
/* 13 */   public static final net.minecraft.network.codec.StreamCodec<RegistryFriendlyByteBuf, ClientboundRespawnPacket> STREAM_CODEC = net.minecraft.network.protocol.Packet.codec(ClientboundRespawnPacket::write, ClientboundRespawnPacket::new);
/*    */ 
/*    */   
...
/* 26 */     this(new CommonPlayerSpawnInfo(input), 
/*    */         
/* 28 */         input.readByte());
/*    */   }
/*    */ 
...
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ClientboundRespawnPacket> type() {
/* 39 */     return GamePacketTypes.CLIENTBOUND_RESPAWN;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientGamePacketListener listener) {
/* 44 */     listener.handleRespawn(this);
/*    */   }
/*    */   
/*    */   public boolean shouldKeep(byte mask) {
/* 48 */     return ((this.dataToKeep & mask) != 0);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundRespawnPacket.class
