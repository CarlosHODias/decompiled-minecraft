...
/*    */   }
/*    */   
/* 22 */   public ChunkBiomeData(net.minecraft.world.level.ChunkPos pos, byte[] buffer) { this.pos = pos; this.buffer = buffer; } public net.minecraft.world.level.ChunkPos pos() { return this.pos; } public byte[] buffer() { return this.buffer; }
/*    */ 
/*    */ 
/*    */   
...
/* 39 */     int total = 0;
/*    */     
/* 41 */     for (net.minecraft.world.level.chunk.LevelChunkSection section : chunk.getSections()) {
...
/* 49 */     return new FriendlyByteBuf(io.netty.buffer.Unpooled.wrappedBuffer(this.buffer));
/*    */   }
/*    */   
/*    */   private io.netty.buffer.ByteBuf getWriteBuffer() {
/* 53 */     io.netty.buffer.ByteBuf buffer = io.netty.buffer.Unpooled.wrappedBuffer(this.buffer);
/* 54 */     buffer.writerIndex(0);
/* 55 */     return buffer;
/*    */   }
/*    */   
/*    */   public static void extractChunkData(FriendlyByteBuf buffer, LevelChunk chunk) {
/* 59 */     for (net.minecraft.world.level.chunk.LevelChunkSection section : chunk.getSections()) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundChunksBiomesPacket$ChunkBiomeData.class
