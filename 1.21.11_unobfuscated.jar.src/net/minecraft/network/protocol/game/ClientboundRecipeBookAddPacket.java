...
/*    */ 
/*    */ public final class ClientboundRecipeBookAddPacket extends Record implements net.minecraft.network.protocol.Packet<ClientGamePacketListener> {
...
/*    */ 
/*    */   
/* 16 */   public static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, ClientboundRecipeBookAddPacket> STREAM_CODEC = StreamCodec.composite(
/* 17 */       Entry.STREAM_CODEC.apply(ByteBufCodecs.list()), ClientboundRecipeBookAddPacket::entries, ByteBufCodecs.BOOL, ClientboundRecipeBookAddPacket::replace, ClientboundRecipeBookAddPacket::new);
/*    */ 
/*    */ 
/*    */ 
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ClientboundRecipeBookAddPacket> type() {
/* 24 */     return GamePacketTypes.CLIENTBOUND_RECIPE_BOOK_ADD;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientGamePacketListener listener) {
/* 29 */     listener.handleRecipeBookAdd(this);
/*    */   }
...
/*    */ 
/*    */     
/* 39 */     public static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, Entry> STREAM_CODEC = StreamCodec.composite(RecipeDisplayEntry.STREAM_CODEC, Entry::contents, ByteBufCodecs.BYTE, Entry::flags, Entry::new);
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundRecipeBookAddPacket.class
