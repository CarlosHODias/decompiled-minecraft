...
/*  66 */     IntOpenHashSet intOpenHashSet = new IntOpenHashSet((IntCollection)IntSets.fromTo(0, entries.size()));
/*  67 */     while (!intOpenHashSet.isEmpty()) {
/*  68 */       boolean worked = intOpenHashSet.removeIf(index -> validator.test(entries.get(index), elementsToCheck));
/*  69 */       if (!worked) {
...
/*  82 */     Queue<CommandNode<S>> queue = new ArrayDeque<>();
/*  83 */     queue.add(root);
/*     */     
/*     */     CommandNode<S> node;
/*  86 */     while ((node = queue.poll()) != null) {
...
/*     */       }
/*     */     } 
/*  97 */     return (Object2IntMap<CommandNode<S>>)object2IntOpenHashMap;
/*     */   }
/*     */   
/*     */   private static <S> List<Entry> createEntries(Object2IntMap<CommandNode<S>> nodeToId, NodeInspector<S> inspector) {
/* 101 */     ObjectArrayList<Entry> result = new ObjectArrayList(nodeToId.size());
/* 102 */     result.size(nodeToId.size());
/* 103 */     for (ObjectIterator<Object2IntMap.Entry<CommandNode<S>>> objectIterator = Object2IntMaps.fastIterable(nodeToId).iterator(); objectIterator.hasNext(); ) { Object2IntMap.Entry<CommandNode<S>> entry = objectIterator.next();
/* 104 */       result.set(entry.getIntValue(), createEntry((CommandNode<S>)entry.getKey(), inspector, nodeToId)); }
/*     */     
/* 106 */     return (List<Entry>)result;
/*     */   }
/*     */   
...
/*     */ 
/*     */     
/*     */     private LiteralNodeStub(String id) {
/* 139 */       this.id = id; } public final String toString() { // Byte code:
/*     */       //   0: aload_0
...
/*     */       //   0	7	0	this	Lnet/minecraft/network/protocol/game/ClientboundCommandsPacket$LiteralNodeStub; } public final int hashCode() { // Byte code:
/*     */       //   0: aload_0
...
/*     */       // Local variable table:
/*     */       //   start	length	slot	name	descriptor
/*     */       //   0	7	0	this	Lnet/minecraft/network/protocol/game/ClientboundCommandsPacket$LiteralNodeStub; } public final boolean equals(Object o) { // Byte code:
/*     */       //   0: aload_0
/*     */       //   1: aload_1
...
/* 139 */       //   0	8	1	o	Ljava/lang/Object; } public String id() { return this.id; }
/*     */     
/*     */     public <S> ArgumentBuilder<S, ?> build(CommandBuildContext context, ClientboundCommandsPacket.NodeBuilder<S> builder) {
/* 142 */       return builder.createLiteral(this.id);
/*     */     }
/*     */ 
/*     */     
/*     */     public void write(FriendlyByteBuf output) {
/* 147 */       output.writeUtf(this.id);
/*     */     } }
/*     */   private static final class ArgumentNodeStub extends Record implements NodeStub { private final String id; private final ArgumentTypeInfo.Template<?> argumentType; private final Identifier suggestionId;
/*     */     
...
/* 172 */       serializeCap(output, argumentType.type(), argumentType);
/*     */     }
/*     */ 
/*     */     
...
/* 247 */     return GamePacketTypes.CLIENTBOUND_COMMANDS;
/*     */   }
/*     */ 
/*     */   
/*     */   public void handle(ClientGamePacketListener listener) {
/* 252 */     listener.handleCommands(this);
/*     */   }
/*     */   
/*     */   public <S> RootCommandNode<S> getRoot(CommandBuildContext context, NodeBuilder<S> builder) {
/* 256 */     return (RootCommandNode<S>)new NodeResolver<>(context, builder, this.entries).resolve(this.rootIndex);
/*     */   }
...
/* 303 */       ObjectArrayList<CommandNode<S>> nodes = new ObjectArrayList();
/* 304 */       nodes.size(entries.size());
/* 305 */       this.nodes = (List<CommandNode<S>>)nodes;
/*     */     }
/*     */     public CommandNode<S> resolve(int index) {
/*     */       CommandNode<S> result;
/* 309 */       CommandNode<S> currentNode = this.nodes.get(index);
/* 310 */       if (currentNode != null) {
/* 311 */         return currentNode;
/*     */       }
/*     */       
/* 314 */       ClientboundCommandsPacket.Entry entry = this.entries.get(index);
/*     */ 
/*     */       
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundCommandsPacket.class
