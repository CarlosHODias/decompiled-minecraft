...
/*    */     
/* 31 */     int i = 0;
/* 32 */     for (ShortIterator<Short> shortIterator = changes.iterator(); shortIterator.hasNext(); ) { short packedPos = (Short)shortIterator.next();
...
/* 48 */       this.states[i] = (BlockState)Block.BLOCK_STATE_REGISTRY.byId((int)(packedChange >>> 12L));
/*    */     } 
/*    */   }
/*    */   
...
/* 57 */       output.writeVarLong(Block.getId(this.states[i]) << 12L | this.positions[i]);
/*    */     }
/*    */   }
/*    */ 
/*    */   
/*    */   public PacketType<ClientboundSectionBlocksUpdatePacket> type() {
/* 63 */     return GamePacketTypes.CLIENTBOUND_SECTION_BLOCKS_UPDATE;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientGamePacketListener listener) {
/* 68 */     listener.handleChunkBlocksUpdate(this);
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundSectionBlocksUpdatePacket.class
