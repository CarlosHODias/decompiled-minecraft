...
/*    */ 
/*    */ public final class ServerboundSetTestBlockPacket extends Record implements net.minecraft.network.protocol.Packet<ServerGamePacketListener> {
...
/* 12 */    public static final net.minecraft.network.codec.StreamCodec<net.minecraft.network.FriendlyByteBuf, ServerboundSetTestBlockPacket> STREAM_CODEC = net.minecraft.network.codec.StreamCodec.composite(BlockPos.STREAM_CODEC, ServerboundSetTestBlockPacket::position, TestBlockMode.STREAM_CODEC, ServerboundSetTestBlockPacket::mode, net.minecraft.network.codec.ByteBufCodecs.STRING_UTF8, ServerboundSetTestBlockPacket::message, ServerboundSetTestBlockPacket::new);
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ServerboundSetTestBlockPacket> type() {
/* 21 */     return GamePacketTypes.SERVERBOUND_SET_TEST_BLOCK;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ServerGamePacketListener listener) {
/* 26 */     listener.handleSetTestBlock(this);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ServerboundSetTestBlockPacket.class
