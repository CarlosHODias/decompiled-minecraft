...
/* 52 */     this.text = text; this.tooltip = tooltip; } public String text() { return this.text; } public Optional<Component> tooltip() { return this.tooltip; }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundCommandSuggestionsPacket$Entry.class
