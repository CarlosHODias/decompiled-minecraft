...
/*    */     // Local variable table:
/*    */     //   start	length	slot	name	descriptor
/*    */     //   0	7	0	this	Lnet/minecraft/network/protocol/game/ClientboundChunksBiomesPacket; } public final boolean equals(Object o) {
/*    */     // Byte code:
/*    */     //   0: aload_0
/*    */     //   1: aload_1
...
/* 18 */   } public static final net.minecraft.network.codec.StreamCodec<FriendlyByteBuf, ClientboundChunksBiomesPacket> STREAM_CODEC = Packet.codec(ClientboundChunksBiomesPacket::write, ClientboundChunksBiomesPacket::new); private static final int TWO_MEGABYTES = 2097152;
...
/* 22 */       //   0	8	1	o	Ljava/lang/Object; } public ChunkPos pos() { return this.pos; } public byte[] buffer() { return this.buffer; }
/*    */ 
/*    */ 
/*    */     
...
/* 32 */       this(
/* 33 */           input.readChunkPos(), 
/* 34 */           input.readByteArray(2097152));
/*    */     }
/*    */ 
/*    */     
...
/* 49 */       return new FriendlyByteBuf(Unpooled.wrappedBuffer(this.buffer));
/*    */     }
/*    */     
...
/* 74 */     return new ClientboundChunksBiomesPacket(chunks.stream().map(ChunkBiomeData::new).toList());
/*    */   }
/*    */   
/*    */   private ClientboundChunksBiomesPacket(FriendlyByteBuf input) {
/* 78 */     this(input.readList(ChunkBiomeData::new));
/*    */   }
/*    */   
/*    */   private void write(FriendlyByteBuf output) {
/* 82 */     output.writeCollection(this.chunkBiomeData, (o, c) -> c.write(o));
/*    */   }
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ClientboundChunksBiomesPacket> type() {
/* 87 */     return GamePacketTypes.CLIENTBOUND_CHUNKS_BIOMES;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientGamePacketListener listener) {
/* 92 */     listener.handleChunksBiomes(this);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundChunksBiomesPacket.class
