...
/*  46 */       super(pos.x, pos.y, pos.z, yRot, xRot, onGround, horizontalCollision, true, true);
/*     */     }
/*     */     
/*     */     public PosRot(double x, double y, double z, float yRot, float xRot, boolean onGround, boolean horizontalCollision) {
/*  50 */       super(x, y, z, yRot, xRot, onGround, horizontalCollision, true, true);
/*     */     }
/*     */     
...
/*  76 */       return GamePacketTypes.SERVERBOUND_MOVE_PLAYER_POS_ROT;
/*     */     }
/*     */   }
/*     */   
...
/*  84 */       super(pos.x, pos.y, pos.z, 0.0F, 0.0F, onGround, horizontalCollision, true, false);
/*     */     }
/*     */     
/*     */     public Pos(double x, double y, double z, boolean onGround, boolean horizontalCollision) {
/*  88 */       super(x, y, z, 0.0F, 0.0F, onGround, horizontalCollision, true, false);
/*     */     }
/*     */     
...
/* 110 */       return GamePacketTypes.SERVERBOUND_MOVE_PLAYER_POS;
/*     */     }
/*     */   }
/*     */   
...
/* 118 */       super(0.0D, 0.0D, 0.0D, yRot, xRot, onGround, horizontalCollision, false, true);
/*     */     }
/*     */     
...
/* 138 */       return GamePacketTypes.SERVERBOUND_MOVE_PLAYER_ROT;
/*     */     }
/*     */   }
/*     */   
...
/* 146 */       super(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, onGround, horizontalCollision, false, false);
/*     */     }
/*     */     
...
/*     */     
/*     */     private void write(FriendlyByteBuf output) {
/* 157 */       output.writeByte(ServerboundMovePlayerPacket.packFlags(this.onGround, this.horizontalCollision));
/*     */     }
/*     */ 
/*     */     
/*     */     public PacketType<StatusOnly> type() {
/* 162 */       return GamePacketTypes.SERVERBOUND_MOVE_PLAYER_STATUS_ONLY;
/*     */     }
/*     */   }
/*     */   
...
/* 183 */     listener.handleMovePlayer(this);
/*     */   }
/*     */   
/*     */   public double getX(double fallback) {
/* 187 */     return this.hasPos ? this.x : fallback;
/*     */   }
/*     */   
/*     */   public double getY(double fallback) {
/* 191 */     return this.hasPos ? this.y : fallback;
/*     */   }
/*     */   
/*     */   public double getZ(double fallback) {
/* 195 */     return this.hasPos ? this.z : fallback;
/*     */   }
/*     */   
/*     */   public float getYRot(float fallback) {
/* 199 */     return this.hasRot ? this.yRot : fallback;
/*     */   }
/*     */   
/*     */   public float getXRot(float fallback) {
/* 203 */     return this.hasRot ? this.xRot : fallback;
/*     */   }
/*     */   
/*     */   public boolean isOnGround() {
/* 207 */     return this.onGround;
/*     */   }
/*     */   
/*     */   public boolean horizontalCollision() {
/* 211 */     return this.horizontalCollision;
/*     */   }
/*     */   
/*     */   public boolean hasPosition() {
/* 215 */     return this.hasPos;
/*     */   }
/*     */   
/*     */   public boolean hasRotation() {
/* 219 */     return this.hasRot;
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ServerboundMovePlayerPacket.class
