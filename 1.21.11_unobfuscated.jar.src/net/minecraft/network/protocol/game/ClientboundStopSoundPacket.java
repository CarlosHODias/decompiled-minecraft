...
/* 43 */         output.writeEnum((Enum)this.source);
/* 44 */         output.writeIdentifier(this.name);
/*    */       } else {
/* 46 */         output.writeByte(1);
/* 47 */         output.writeEnum((Enum)this.source);
/*    */       }
/*    */     
...
/* 61 */     return GamePacketTypes.CLIENTBOUND_STOP_SOUND;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientGamePacketListener listener) {
/* 66 */     listener.handleStopSoundEvent(this);
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundStopSoundPacket.class
