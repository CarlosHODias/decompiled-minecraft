...
/*    */ 
/*    */ public final class ClientboundEntityPositionSyncPacket extends Record implements net.minecraft.network.protocol.Packet<ClientGamePacketListener> {
...
/* 12 */    public static final net.minecraft.network.codec.StreamCodec<net.minecraft.network.FriendlyByteBuf, ClientboundEntityPositionSyncPacket> STREAM_CODEC = net.minecraft.network.codec.StreamCodec.composite(net.minecraft.network.codec.ByteBufCodecs.VAR_INT, ClientboundEntityPositionSyncPacket::id, PositionMoveRotation.STREAM_CODEC, ClientboundEntityPositionSyncPacket::values, net.minecraft.network.codec.ByteBufCodecs.BOOL, ClientboundEntityPositionSyncPacket::onGround, ClientboundEntityPositionSyncPacket::new);
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* 20 */     return new ClientboundEntityPositionSyncPacket(entity.getId(), new PositionMoveRotation(entity.trackingPosition(), entity.getDeltaMovement(), entity.getYRot(), entity.getXRot()), entity.onGround());
/*    */   }
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ClientboundEntityPositionSyncPacket> type() {
/* 25 */     return GamePacketTypes.CLIENTBOUND_ENTITY_POSITION_SYNC;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientGamePacketListener listener) {
/* 30 */     listener.handleEntityPositionSync(this);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundEntityPositionSyncPacket.class
