...
/*    */ 
/*    */ public final class ClientboundPlayerCombatKillPacket extends Record implements net.minecraft.network.protocol.Packet<ClientGamePacketListener> {
...
/* 12 */    public static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, ClientboundPlayerCombatKillPacket> STREAM_CODEC = StreamCodec.composite(net.minecraft.network.codec.ByteBufCodecs.VAR_INT, ClientboundPlayerCombatKillPacket::playerId, net.minecraft.network.chat.ComponentSerialization.TRUSTED_STREAM_CODEC, ClientboundPlayerCombatKillPacket::message, ClientboundPlayerCombatKillPacket::new);
/*    */ 
/*    */ 
/*    */ 
/*    */ 
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ClientboundPlayerCombatKillPacket> type() {
/* 20 */     return GamePacketTypes.CLIENTBOUND_PLAYER_COMBAT_KILL;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientGamePacketListener listener) {
/* 25 */     listener.handlePlayerCombatKill(this);
/*    */   }
/*    */ 
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/game/ClientboundPlayerCombatKillPacket.class
