...
/*    */ 
/*    */ 
/*    */ public final class ClientboundTransferPacket extends Record implements net.minecraft.network.protocol.Packet<ClientCommonPacketListener> {
...
/*    */ 
/*    */   
/* 12 */   public static final net.minecraft.network.codec.StreamCodec<net.minecraft.network.FriendlyByteBuf, ClientboundTransferPacket> STREAM_CODEC = net.minecraft.network.protocol.Packet.codec(ClientboundTransferPacket::write, ClientboundTransferPacket::new);
/*    */   
/*    */   private ClientboundTransferPacket(net.minecraft.network.FriendlyByteBuf input) {
/* 15 */     this(input.readUtf(), input.readVarInt());
/*    */   }
/*    */   
...
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ClientboundTransferPacket> type() {
/* 25 */     return CommonPacketTypes.CLIENTBOUND_TRANSFER;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientCommonPacketListener listener) {
/* 30 */     listener.handleTransfer(this);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/common/ClientboundTransferPacket.class
