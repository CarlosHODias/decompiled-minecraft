...
/*    */ 
/*    */ public final class ClientboundResourcePackPushPacket extends Record implements net.minecraft.network.protocol.Packet<ClientCommonPacketListener> {
...
/*    */ 
/*    */   
/* 25 */   public static final StreamCodec<io.netty.buffer.ByteBuf, ClientboundResourcePackPushPacket> STREAM_CODEC = StreamCodec.composite(net.minecraft.core.UUIDUtil.STREAM_CODEC, ClientboundResourcePackPushPacket::id, ByteBufCodecs.STRING_UTF8, ClientboundResourcePackPushPacket::url, 
/*    */ 
/*    */       
/* 28 */       ByteBufCodecs.stringUtf8(40), ClientboundResourcePackPushPacket::hash, ByteBufCodecs.BOOL, ClientboundResourcePackPushPacket::required, 
/*    */       
/* 30 */       net.minecraft.network.chat.ComponentSerialization.TRUSTED_CONTEXT_FREE_STREAM_CODEC.apply(ByteBufCodecs::optional), ClientboundResourcePackPushPacket::prompt, ClientboundResourcePackPushPacket::new);
/*    */ 
/*    */   
...
/*    */     this.prompt = prompt; } public net.minecraft.network.protocol.PacketType<ClientboundResourcePackPushPacket> type() {
/* 42 */     return CommonPacketTypes.CLIENTBOUND_RESOURCE_PACK_PUSH;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientCommonPacketListener listener) {
/* 47 */     listener.handleResourcePackPush(this);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/common/ClientboundResourcePackPushPacket.class
