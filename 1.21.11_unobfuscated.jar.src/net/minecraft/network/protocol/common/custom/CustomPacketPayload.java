...
/* 20 */     return StreamCodec.ofMember(writer, reader);
/*    */   }
...
/* 23 */       //   0	7	0	this	Lnet/minecraft/network/protocol/common/custom/CustomPacketPayload$Type<TT;>; } public Identifier id() { return this.id; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/*    */       //   0	7	0	this	Lnet/minecraft/network/protocol/common/custom/CustomPacketPayload$Type<TT;>; } public final boolean equals(Object o) {
/*    */       // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/* 27 */     return new Type<>(Identifier.withDefaultNamespace(id));
/*    */   }
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/*    */       //   0	7	0	this	Lnet/minecraft/network/protocol/common/custom/CustomPacketPayload$TypeAndCodec<TB;TT;>; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/* 30 */       //   0	8	0	this	Lnet/minecraft/network/protocol/common/custom/CustomPacketPayload$TypeAndCodec<TB;TT;>; } public CustomPacketPayload.Type<T> type() { return this.type; } public StreamCodec<B, T> codec() { return this.codec; }
/*    */      }
/*    */ 
/*    */ 
/*    */ 
...
/* 37 */     final Map<Identifier, StreamCodec<? super B, ? extends CustomPacketPayload>> idToType = (Map<Identifier, StreamCodec<? super B, ? extends CustomPacketPayload>>)types.stream().collect(Collectors.toUnmodifiableMap(t -> t.type().id(), TypeAndCodec::codec));
/*    */     
...
/* 41 */           StreamCodec<? super B, ? extends CustomPacketPayload> codec = (StreamCodec<? super B, ? extends CustomPacketPayload>)idToType.get(typeId);
/* 42 */           if (codec != null) {
/* 43 */             return codec;
/*    */           }
...
/* 51 */           StreamCodec<B, T> codec = (StreamCodec)findCodec(type.id);
/* 52 */           codec.encode(output, payload);
/*    */         }
/*    */ 
/*    */         
/*    */         public void encode(B output, CustomPacketPayload value) {
/* 57 */           writeCap(output, value.type(), value);
/*    */         }
/*    */ 
/*    */         
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/common/custom/CustomPacketPayload.class
