...
/*    */ 
/*    */   
/* 15 */   public static final net.minecraft.network.codec.StreamCodec<FriendlyByteBuf, ClientboundStoreCookiePacket> STREAM_CODEC = Packet.codec(ClientboundStoreCookiePacket::write, ClientboundStoreCookiePacket::new);
/*    */   
/*    */   private static final int MAX_PAYLOAD_SIZE = 5120;
/* 18 */   public static final net.minecraft.network.codec.StreamCodec<io.netty.buffer.ByteBuf, byte[]> PAYLOAD_STREAM_CODEC = net.minecraft.network.codec.ByteBufCodecs.byteArray(5120);
/*    */   
/*    */   private ClientboundStoreCookiePacket(FriendlyByteBuf input) {
/* 21 */     this(input.readIdentifier(), (byte[])PAYLOAD_STREAM_CODEC.decode(input));
/*    */   }
/*    */   
...
/*    */ 
/*    */   
/*    */   public net.minecraft.network.protocol.PacketType<ClientboundStoreCookiePacket> type() {
/* 31 */     return CommonPacketTypes.CLIENTBOUND_STORE_COOKIE;
/*    */   }
/*    */ 
/*    */   
/*    */   public void handle(ClientCommonPacketListener listener) {
/* 36 */     listener.handleStoreCookie(this);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/common/ClientboundStoreCookiePacket.class
