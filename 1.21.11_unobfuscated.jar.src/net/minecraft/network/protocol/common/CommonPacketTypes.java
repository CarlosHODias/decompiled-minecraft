...
/*    */   
/*    */   private static <T extends net.minecraft.network.protocol.Packet<ClientCommonPacketListener>> PacketType<T> createClientbound(String id) {
/* 31 */     return new PacketType(PacketFlow.CLIENTBOUND, Identifier.withDefaultNamespace(id));
/*    */   }
/*    */   
/*    */   private static <T extends net.minecraft.network.protocol.Packet<ServerCommonPacketListener>> PacketType<T> createServerbound(String id) {
/* 35 */     return new PacketType(PacketFlow.SERVERBOUND, Identifier.withDefaultNamespace(id));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/common/CommonPacketTypes.class
