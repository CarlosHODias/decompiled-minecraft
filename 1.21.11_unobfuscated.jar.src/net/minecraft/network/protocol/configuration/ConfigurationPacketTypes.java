...
/*    */   
/*    */   private static <T extends net.minecraft.network.protocol.Packet<ClientConfigurationPacketListener>> PacketType<T> createClientbound(String id) {
/* 21 */     return new PacketType(PacketFlow.CLIENTBOUND, Identifier.withDefaultNamespace(id));
/*    */   }
/*    */   
/*    */   private static <T extends net.minecraft.network.protocol.Packet<ServerConfigurationPacketListener>> PacketType<T> createServerbound(String id) {
/* 25 */     return new PacketType(PacketFlow.SERVERBOUND, Identifier.withDefaultNamespace(id));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/protocol/configuration/ConfigurationPacketTypes.class
