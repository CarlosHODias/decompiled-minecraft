...
/*    */     
/* 31 */     Map<DataComponentType<?>, Integer> setComponentHashes = new java.util.IdentityHashMap<>(split.added().size());
/* 32 */     split.added().forEach(e -> setComponentHashes.put(e.type(), hasher.apply(e)));
/*    */     
/* 34 */     return new HashedPatchMap(setComponentHashes, 
/*    */         
/* 36 */         split.removed());
/*    */   }
/*    */ 
...
/*    */     }
/*    */     
/* 50 */     for (TypedDataComponent<?> typedDataComponent : (Iterable<TypedDataComponent<?>>)split.added()) {
/* 51 */       Integer expectedHash = this.addedComponents.get(typedDataComponent.type());
/* 52 */       if (expectedHash == null) {
/* 53 */         return false;
/*    */       }
/* 55 */       Integer actualHash = hasher.apply(typedDataComponent);
...
/*    */   
/*    */   @FunctionalInterface
/*    */   public static interface HashGenerator extends java.util.function.Function<TypedDataComponent<?>, Integer> {}
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/HashedPatchMap.class
