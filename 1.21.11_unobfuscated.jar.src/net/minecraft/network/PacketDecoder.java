...
/* 21 */     this.protocolInfo = protocolInfo;
/*    */   }
/*    */   
...
/*    */     
/*    */     try {
/* 30 */       packet = (Packet<? super T>)this.protocolInfo.codec().decode(input);
...
/*    */     
/* 40 */     JvmProfiler.INSTANCE.onPacketReceived(
/* 41 */         this.protocolInfo.id(), packetId, 
/*    */         
/* 43 */         ctx.channel().remoteAddress(), readableBytes);
/*    */ 
/*    */ 
/*    */     
...
/* 54 */       LOGGER.debug(Connection.PACKET_RECEIVED_MARKER, " IN: [{}:{}] {} -> {} bytes", new Object[] { this.protocolInfo.id().id(), packetId, packet.getClass().getName(), readableBytes });
/*    */     }
/*    */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/PacketDecoder.class
