...
/*    */       }
/*    */     };
/*    */   public static final StreamCodec<RegistryFriendlyByteBuf, HashedStack> STREAM_CODEC;
/*    */   public static final class ActualItem extends Record implements HashedStack { private final Holder<Item> item; private final int count; private final HashedPatchMap components;
/*    */     
...
/*    */   
/*    */   static {
/* 56 */     STREAM_CODEC = ByteBufCodecs.optional(ActualItem.STREAM_CODEC).map(actualItem -> (HashedStack)DataFixUtils.orElse(actualItem, EMPTY), hashedStack -> {
/*    */           ActualItem actualItem = (ActualItem)hashedStack;
/*    */           return (hashedStack instanceof ActualItem) ? Optional.<ActualItem>of(actualItem) : Optional.empty();
/*    */         });
/*    */   }
...
/*    */     }
/*    */     
/* 66 */     return new ActualItem(
/* 67 */         itemStack.getItemHolder(), 
/* 68 */         itemStack.getCount(), 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/HashedStack.class
