...
/*  36 */     output.writeBytes(signature.bytes);
/*     */   }
/*     */   
/*     */   public boolean verify(SignatureValidator signature, SignatureUpdater updater) {
/*  40 */     return signature.validate(updater, this.bytes);
/*     */   }
/*     */   
...
/*  49 */     if (this != o) { if (o instanceof MessageSignature) { MessageSignature that = (MessageSignature)o; if (Arrays.equals(this.bytes, that.bytes)); }  return false; }
/*     */   
/*     */   }
/*     */   
/*     */   public int hashCode() {
...
/*  59 */     return java.util.Base64.getEncoder().encodeToString(this.bytes);
/*     */   }
/*     */   
...
/*     */   
/*     */   public int checksum() {
/*  76 */     return Arrays.hashCode(this.bytes);
/*     */   }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/chat/MessageSignature.class
