...
/*  20 */     //   0	8	1	o	Ljava/lang/Object; } public MessageSignature signature() { return this.signature; } public SignedMessageBody signedBody() { return this.signedBody; } public Component unsignedContent() { return this.unsignedContent; } public FilterMask filterMask() { return this.filterMask; } static {
/*  21 */     MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group((App)SignedMessageLink.CODEC.fieldOf("link").forGetter(PlayerChatMessage::link), (App)MessageSignature.CODEC.optionalFieldOf("signature").forGetter(()), (App)SignedMessageBody.MAP_CODEC.forGetter(PlayerChatMessage::signedBody), (App)ComponentSerialization.CODEC.optionalFieldOf("unsigned_content").forGetter(()), (App)FilterMask.CODEC.optionalFieldOf("filter_mask", FilterMask.PASS_THROUGH).forGetter(PlayerChatMessage::filterMask)).apply((com.mojang.datafixers.kinds.Applicative)i, ()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  29 */   private static final UUID SYSTEM_SENDER = net.minecraft.util.Util.NIL_UUID;
...
/*  34 */     return unsigned(SYSTEM_SENDER, content);
/*     */   }
/*     */   
...
/*  63 */     return filter(filtered ? this.filterMask : FilterMask.PASS_THROUGH);
/*     */   }
/*     */   
...
/*  73 */     output.update(com.google.common.primitives.Ints.toByteArray(1));
/*  74 */     link.updateSignature(output);
/*  75 */     body.updateSignature(output);
/*     */   }
/*     */   
/*     */   public boolean verify(net.minecraft.util.SignatureValidator signatureValidator) {
/*  79 */     return (this.signature != null && this.signature.verify(signatureValidator, output -> updateSignature(output, this.link, this.signedBody)));
/*     */   }
/*     */   
/*     */   public String signedContent() {
/*  83 */     return this.signedBody.content();
/*     */   }
/*     */   
/*     */   public Component decoratedContent() {
/*  87 */     return java.util.Objects.<Component>requireNonNullElseGet(this.unsignedContent, () -> Component.literal(signedContent()));
/*     */   }
/*     */   
/*     */   public Instant timeStamp() {
/*  91 */     return this.signedBody.timeStamp();
/*     */   }
/*     */   
/*     */   public long salt() {
/*  95 */     return this.signedBody.salt();
/*     */   }
/*     */   
/*     */   public boolean hasExpiredServer(Instant now) {
/*  99 */     return now.isAfter(timeStamp().plus(MESSAGE_EXPIRES_AFTER_SERVER));
/*     */   }
/*     */   
/*     */   public boolean hasExpiredClient(Instant now) {
/* 103 */     return now.isAfter(timeStamp().plus(MESSAGE_EXPIRES_AFTER_CLIENT));
/*     */   }
/*     */   
/*     */   public UUID sender() {
/* 107 */     return this.link.sender();
/*     */   }
/*     */   
/*     */   public boolean isSystem() {
/* 111 */     return sender().equals(SYSTEM_SENDER);
/*     */   }
/*     */   
/*     */   public boolean hasSignature() {
/* 115 */     return (this.signature != null);
/*     */   }
/*     */   
/*     */   public boolean hasSignatureFrom(UUID profileId) {
/* 119 */     return (hasSignature() && this.link.sender().equals(profileId));
/*     */   }
/*     */   
/*     */   public boolean isFullyFiltered() {
/* 123 */     return this.filterMask.isFullyFiltered();
/*     */   }
/*     */   
/*     */   public static String describeSigned(PlayerChatMessage message) {
/* 127 */     return "'" + message.signedBody.content() + "' @ " + String.valueOf(message.signedBody.timeStamp()) + "\n - From: " + 
/* 128 */       String.valueOf(message.link.sender()) + "/" + String.valueOf(message.link.sessionId()) + ", message #" + message.link.index() + "\n - Salt: " + 
/* 129 */       message.signedBody.salt() + "\n - Signature: " + 
/* 130 */       MessageSignature.describe(message.signature) + "\n - Last Seen: [\n" + (String)
/*     */       
/* 132 */       message.signedBody.lastSeen().entries().stream()
/* 133 */       .map(signature -> "     " + MessageSignature.describe(signature) + "\n")
/* 134 */       .collect(java.util.stream.Collectors.joining()) + " ]\n";
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/chat/PlayerChatMessage.class
