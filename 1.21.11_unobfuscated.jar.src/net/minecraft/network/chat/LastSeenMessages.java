...
/* 15 */     //   0	8	1	o	Ljava/lang/Object; } public static final com.mojang.serialization.Codec<LastSeenMessages> CODEC = MessageSignature.CODEC.listOf().xmap(LastSeenMessages::new, LastSeenMessages::entries);
/*    */ 
/*    */ 
/*    */ 
/*    */   
...
/* 25 */     output.update(com.google.common.primitives.Ints.toByteArray(this.entries.size()));
...
/* 32 */     return new Packed(this.entries.stream().map(entry -> entry.pack(cache)).toList());
/*    */   }
/*    */   
...
/* 49 */       this((List<MessageSignature.Packed>)input.readCollection(FriendlyByteBuf.limitValue(java.util.ArrayList::new, 20), MessageSignature.Packed::read));
/*    */     }
/*    */     
/*    */     public void write(FriendlyByteBuf output) {
/* 53 */       output.writeCollection(this.entries, MessageSignature.Packed::write);
/*    */     }
/*    */     
/*    */     public Optional<LastSeenMessages> unpack(MessageSignatureCache cache) {
/* 57 */       List<MessageSignature> unpacked = new java.util.ArrayList<>(this.entries.size());
/* 58 */       for (MessageSignature.Packed packed : this.entries) {
/* 59 */         Optional<MessageSignature> entry = packed.unpack(cache);
/* 60 */         if (entry.isEmpty()) {
/* 61 */           return Optional.empty();
/*    */         }
/* 63 */         unpacked.add(entry.get());
/*    */       } 
...
/* 74 */       this(input.readVarInt(), input.readFixedBitSet(20), input.readByte());
/*    */     }
/*    */     
/*    */     public void write(FriendlyByteBuf output) {
...
/* 84 */       return (this.checksum == 0 || this.checksum == lastSeen.computeChecksum());
/*    */     } }
/*    */ 
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/chat/LastSeenMessages.class
