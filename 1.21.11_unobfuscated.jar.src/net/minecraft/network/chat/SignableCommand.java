...
/* 14 */     //   0	7	0	this	Lnet/minecraft/network/chat/SignableCommand<TS;>; } public List<Argument<S>> arguments() { return this.arguments; }
...
/*    */     // Local variable type table:
/*    */     //   start	length	slot	name	signature
/* 16 */     //   0	8	0	this	Lnet/minecraft/network/chat/SignableCommand<TS;>; } public static <S> boolean hasSignableArguments(ParseResults<S> command) { return !of(command).arguments().isEmpty(); }
/*    */ 
/*    */   
...
/* 43 */     List<Argument<S>> arguments = new java.util.ArrayList<>();
/* 44 */     for (ParsedCommandNode<S> node : (Iterable<ParsedCommandNode<S>>)context.getNodes()) {
/* 45 */       CommandNode commandNode = node.getNode(); if (commandNode instanceof ArgumentCommandNode) { ArgumentCommandNode<S, ?> argument = (ArgumentCommandNode<S, ?>)commandNode; if (argument.getType() instanceof net.minecraft.commands.arguments.SignedArgument) {
/* 46 */           ParsedArgument<S, ?> parsed = (ParsedArgument<S, ?>)context.getArguments().get(argument.getName());
/* 47 */           if (parsed != null) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/chat/SignableCommand.class
