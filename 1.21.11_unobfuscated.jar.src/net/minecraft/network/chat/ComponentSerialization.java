...
/*  53 */           return ComponentSerialization.CODEC.decode(ops, input).flatMap(pair -> isTooLarge(ops, (Component)pair.getFirst()) ? DataResult.error(()) : DataResult.success(pair));
/*     */         }
/*     */ 
/*     */ 
/*     */ 
...
/*  63 */           return ComponentSerialization.CODEC.encodeStart(ops, input);
/*     */         }
/*     */         
...
/*  72 */           if (ops instanceof RegistryOps) { RegistryOps<T> registryOps = (RegistryOps<T>)ops;
/*  73 */             return (DynamicOps<JsonElement>)registryOps.withParent((DynamicOps)JsonOps.INSTANCE); }
/*     */           
/*  75 */           return (DynamicOps<JsonElement>)JsonOps.INSTANCE;
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 113 */       return this.fuzzy.encode(input, ops, prefix);
/*     */     }
/*     */ 
/*     */     
/*     */     public <T1> Stream<T1> keys(DynamicOps<T1> ops) {
/* 118 */       return Stream.<T1>concat(this.typed.keys(ops), this.fuzzy.keys(ops)).distinct();
/*     */     }
/*     */   }
/*     */   
...
/* 146 */       MapEncoder<T> encoder = (MapEncoder<T>)this.encoderGetter.apply(input);
...
/* 154 */       return this.codecs.stream().flatMap(c -> c.keys(ops)).distinct();
/*     */     }
/*     */ 
/*     */     
...
/* 165 */     MapCodec<T> compactCodec = new FuzzyCodec<>(
/* 166 */         types.values(), (Function)codecGetter);
/*     */ 
/*     */ 
/*     */     
/* 170 */     MapCodec<T> discriminatorCodec = types.codec((Codec)Codec.STRING).dispatchMap(typeFieldName, codecGetter, c -> c);
/*     */     
/* 172 */     MapCodec<T> contentsCodec = new StrictEither<>(typeFieldName, discriminatorCodec, compactCodec);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 185 */     ExtraCodecs.LateBoundIdMapper<String, MapCodec<? extends ComponentContents>> contentTypes = new ExtraCodecs.LateBoundIdMapper();
/*     */     
...
/* 200 */         Codec.either((Codec)Codec.STRING, 
/*     */           
/* 202 */           ExtraCodecs.nonEmptyList(topSerializer.listOf())), fullCodec)
/*     */ 
/*     */       
/* 205 */       .xmap(specialOrComponent -> (Component)specialOrComponent.map((), ()), component -> {
...
/* 226 */     contentTypes.put("nbt", net.minecraft.network.chat.contents.NbtContents.MAP_CODEC);
/* 227 */     contentTypes.put("object", ObjectContents.MAP_CODEC);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/chat/ComponentSerialization.class
