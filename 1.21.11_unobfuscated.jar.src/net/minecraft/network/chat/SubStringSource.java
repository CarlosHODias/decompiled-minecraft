...
/* 20 */     this.charStyles = (List<Style>)ImmutableList.copyOf(charStyles);
...
/*    */     
/* 35 */     Style currentRunStyle = this.charStyles.get(start);
/* 36 */     int currentRunStart = start;
/* 37 */     for (int i = 1; i < length; i++) {
/* 38 */       int actualIndex = start + i;
/* 39 */       Style charStyle = this.charStyles.get(actualIndex);
...
/* 57 */     return create(text, ch -> ch, s -> s);
/*    */   }
/*    */   
...
/*    */     
/* 64 */     text.visit((style, contents) -> { StringDecomposer.iterateFormatted(contents, style, ()); return Optional.empty(); }, Style.EMPTY);
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/*    */ 
/*    */     
/* 76 */     return new SubStringSource(shaper.apply(plainText.toString()), charStyles, reverseCharModifier);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/chat/SubStringSource.class
