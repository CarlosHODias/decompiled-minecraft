...
/* 18 */     //   0	8	1	o	Ljava/lang/Object; } public Instant timeStamp() { return this.timeStamp; } public long salt() { return this.salt; } public LastSeenMessages lastSeen() { return this.lastSeen; } static {
/* 19 */     MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group((App)Codec.STRING.fieldOf("content").forGetter(SignedMessageBody::content), (App)net.minecraft.util.ExtraCodecs.INSTANT_ISO8601.fieldOf("time_stamp").forGetter(SignedMessageBody::timeStamp), (App)Codec.LONG.fieldOf("salt").forGetter(SignedMessageBody::salt), (App)LastSeenMessages.CODEC.optionalFieldOf("last_seen", LastSeenMessages.EMPTY).forGetter(SignedMessageBody::lastSeen)).apply((com.mojang.datafixers.kinds.Applicative)i, SignedMessageBody::new));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 27 */     return new SignedMessageBody(content, Instant.now(), 0L, LastSeenMessages.EMPTY);
/*    */   }
/*    */   
/*    */   public void updateSignature(SignatureUpdater.Output output) throws java.security.SignatureException {
/* 31 */     output.update(com.google.common.primitives.Longs.toByteArray(this.salt));
/* 32 */     output.update(com.google.common.primitives.Longs.toByteArray(this.timeStamp.getEpochSecond()));
/* 33 */     byte[] contentBytes = this.content.getBytes(java.nio.charset.StandardCharsets.UTF_8);
/* 34 */     output.update(com.google.common.primitives.Ints.toByteArray(contentBytes.length));
/* 35 */     output.update(contentBytes);
/* 36 */     this.lastSeen.updateSignature(output);
/*    */   }
/*    */   
/*    */   public Packed pack(MessageSignatureCache cache) {
/* 40 */     return new Packed(this.content, this.timeStamp, this.salt, this.lastSeen.pack(cache));
/*    */   }
...
/* 45 */       this(input.readUtf(256), input.readInstant(), input.readLong(), new LastSeenMessages.Packed(input));
/*    */     }
/*    */     
...
/*    */     }
/*    */     
/*    */     public java.util.Optional<SignedMessageBody> unpack(MessageSignatureCache cache) {
/* 56 */       return this.lastSeen.unpack(cache).map(lastSeen -> new SignedMessageBody(this.content, this.timeStamp, this.salt, lastSeen));
/*    */     } }
/*    */ 
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/chat/SignedMessageBody.class
