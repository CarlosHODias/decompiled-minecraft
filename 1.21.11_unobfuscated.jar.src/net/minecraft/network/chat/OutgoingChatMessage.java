...
/* 17 */     public Player(PlayerChatMessage message) { this.message = message; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       //   0	8	1	o	Ljava/lang/Object; } public Component content() {
...
/*    */     
/* 32 */     public Disguised(Component content) { this.content = content; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/*    */     
/*    */     public void sendToPlayer(ServerPlayer player, boolean filtered, ChatType.Bound chatType) {
/* 40 */       player.connection.sendDisguisedChatMessage(this.content, chatType);
/*    */     } }
/*    */ 
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/chat/OutgoingChatMessage.class
