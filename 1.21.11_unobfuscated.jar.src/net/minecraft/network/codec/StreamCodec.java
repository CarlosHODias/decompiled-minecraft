...
/*  26 */           return (V)decoder.decode((I)input);
/*     */         }
/*     */ 
/*     */         
/*     */         public void encode(B output, V value) {
/*  31 */           encoder.encode(output, value);
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/*     */       {
/*     */         public V decode(B input) {
/*  43 */           return (V)decoder.decode((I)input);
/*     */         }
/*     */ 
/*     */         
/*     */         public void encode(B output, V value) {
/*  48 */           encoder.encode(value, output);
/*     */         }
/*     */       };
/*     */   }
/*     */   
...
/*  75 */     return operation.apply(this);
/*     */   }
/*     */   
...
/*  87 */           StreamCodec.this.encode(output, from.apply(value));
/*     */         }
/*     */       };
/*     */   }
/*     */   
...
/*  96 */           B wrappedStream = operation.apply(input);
/*  97 */           return StreamCodec.this.decode(wrappedStream);
/*     */         }
/*     */ 
/*     */         
/*     */         public void encode(O output, V value) {
/* 102 */           B wrappedStream = operation.apply(output);
...
/* 112 */           V key = StreamCodec.this.decode(input);
/* 113 */           StreamCodec<? super B, ? extends U> valueCodec = codec.apply(key);
/* 114 */           return valueCodec.decode(input);
/*     */         }
/*     */ 
/*     */         
/*     */         public void encode(B output, U value) {
/* 119 */           V key = type.apply(value);
/*     */           
/* 121 */           StreamCodec<B, U> valueCodec = codec.apply(key);
...
/* 137 */           return constructor.apply(v1);
/*     */         }
/*     */ 
/*     */         
/*     */         public void encode(B output, C value) {
/* 142 */           codec1.encode(output, getter1.apply(value));
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 156 */           T2 v2 = codec2.decode(input);
/* 157 */           return constructor.apply(v1, v2);
/*     */         }
/*     */ 
/*     */         
/*     */         public void encode(B output, C value) {
...
/* 178 */           T2 v2 = codec2.decode(input);
/* 179 */           T3 v3 = codec3.decode(input);
...
/* 203 */           T2 v2 = codec2.decode(input);
/* 204 */           T3 v3 = codec3.decode(input);
/* 205 */           T4 v4 = codec4.decode(input);
...
/* 231 */           T2 v2 = codec2.decode(input);
/* 232 */           T3 v3 = codec3.decode(input);
/* 233 */           T4 v4 = codec4.decode(input);
/* 234 */           T5 v5 = codec5.decode(input);
...
/* 262 */           T2 v2 = codec2.decode(input);
/* 263 */           T3 v3 = codec3.decode(input);
/* 264 */           T4 v4 = codec4.decode(input);
/* 265 */           T5 v5 = codec5.decode(input);
/* 266 */           T6 v6 = codec6.decode(input);
...
/* 296 */           T2 v2 = codec2.decode(input);
/* 297 */           T3 v3 = codec3.decode(input);
/* 298 */           T4 v4 = codec4.decode(input);
/* 299 */           T5 v5 = codec5.decode(input);
/* 300 */           T6 v6 = codec6.decode(input);
/* 301 */           T7 v7 = codec7.decode(input);
...
/* 333 */           T2 v2 = codec2.decode(input);
/* 334 */           T3 v3 = codec3.decode(input);
/* 335 */           T4 v4 = codec4.decode(input);
/* 336 */           T5 v5 = codec5.decode(input);
/* 337 */           T6 v6 = codec6.decode(input);
/* 338 */           T7 v7 = codec7.decode(input);
/* 339 */           T8 v8 = codec8.decode(input);
...
/* 373 */           T2 v2 = codec2.decode(input);
/* 374 */           T3 v3 = codec3.decode(input);
/* 375 */           T4 v4 = codec4.decode(input);
/* 376 */           T5 v5 = codec5.decode(input);
/* 377 */           T6 v6 = codec6.decode(input);
/* 378 */           T7 v7 = codec7.decode(input);
/* 379 */           T8 v8 = codec8.decode(input);
/* 380 */           T9 v9 = codec9.decode(input);
...
/* 416 */           T2 v2 = codec2.decode(input);
/* 417 */           T3 v3 = codec3.decode(input);
/* 418 */           T4 v4 = codec4.decode(input);
/* 419 */           T5 v5 = codec5.decode(input);
/* 420 */           T6 v6 = codec6.decode(input);
/* 421 */           T7 v7 = codec7.decode(input);
/* 422 */           T8 v8 = codec8.decode(input);
/* 423 */           T9 v9 = codec9.decode(input);
/* 424 */           T10 v10 = codec10.decode(input);
...
/* 462 */           T2 v2 = codec2.decode(input);
/* 463 */           T3 v3 = codec3.decode(input);
/* 464 */           T4 v4 = codec4.decode(input);
/* 465 */           T5 v5 = codec5.decode(input);
/* 466 */           T6 v6 = codec6.decode(input);
/* 467 */           T7 v7 = codec7.decode(input);
/* 468 */           T8 v8 = codec8.decode(input);
/* 469 */           T9 v9 = codec9.decode(input);
/* 470 */           T10 v10 = codec10.decode(input);
/* 471 */           T11 v11 = codec11.decode(input);
...
/* 511 */           T2 v2 = codec2.decode(input);
/* 512 */           T3 v3 = codec3.decode(input);
/* 513 */           T4 v4 = codec4.decode(input);
/* 514 */           T5 v5 = codec5.decode(input);
/* 515 */           T6 v6 = codec6.decode(input);
/* 516 */           T7 v7 = codec7.decode(input);
/* 517 */           T8 v8 = codec8.decode(input);
/* 518 */           T9 v9 = codec9.decode(input);
/* 519 */           T10 v10 = codec10.decode(input);
/* 520 */           T11 v11 = codec11.decode(input);
/* 521 */           T12 v12 = codec12.decode(input);
...
/* 544 */     return new StreamCodec<B, T>() { private final Supplier<StreamCodec<B, T>> inner; {
/* 545 */           this.inner = (Supplier<StreamCodec<B, T>>)Suppliers.memoize(() -> (StreamCodec)factory.apply(this));
/*     */         }
/*     */         
/*     */         public T decode(B input) {
/* 549 */           return ((StreamCodec<B, T>)this.inner.get()).decode(input);
/*     */         }
/*     */ 
/*     */         
/*     */         public void encode(B output, T value) {
/* 554 */           ((StreamCodec<B, T>)this.inner.get()).encode(output, value);
/*     */         } }
/*     */       ;
/*     */   }
/*     */ 
...
/* 565 */     return (StreamCodec)this;
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/codec/StreamCodec.class
