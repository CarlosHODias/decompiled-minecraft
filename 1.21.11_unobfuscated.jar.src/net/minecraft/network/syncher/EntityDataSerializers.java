...
/*  73 */         return value.copy();
/*     */       }
/*     */     };
/*     */   
/*  77 */   public static final EntityDataSerializer<BlockState> BLOCK_STATE = EntityDataSerializer.forValueType(ByteBufCodecs.idMapper((IdMap)Block.BLOCK_STATE_REGISTRY));
/*     */   
...
/*  83 */           VarInt.write(output, Block.getId(value.get()));
/*     */         } else {
...
/*     */ 
/*     */   
/* 100 */   public static final EntityDataSerializer<Optional<BlockState>> OPTIONAL_BLOCK_STATE = EntityDataSerializer.forValueType((StreamCodec)OPTIONAL_BLOCK_STATE_CODEC);
/*     */   
...
/* 131 */         VarInt.write(output, value.orElse(-1) + 1);
/*     */       }
/*     */     };
/*     */   
/* 135 */   public static final EntityDataSerializer<OptionalInt> OPTIONAL_UNSIGNED_INT = EntityDataSerializer.forValueType((StreamCodec)OPTIONAL_UNSIGNED_INT_CODEC);
/*     */   
...
/* 216 */     SERIALIZERS.add(serializer);
/*     */   }
/*     */   
/*     */   public static EntityDataSerializer<?> getSerializer(int id) {
/* 220 */     return (EntityDataSerializer)SERIALIZERS.byId(id);
/*     */   }
/*     */   
/*     */   public static int getSerializedId(EntityDataSerializer<?> serializer) {
/* 224 */     return SERIALIZERS.getId(serializer);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/syncher/EntityDataSerializers.class
