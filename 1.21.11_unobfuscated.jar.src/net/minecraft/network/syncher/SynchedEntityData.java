...
/*  53 */     return (DataItem)this.itemsById[accessor.id()];
/*     */   }
/*     */   
/*     */   public <T> T get(EntityDataAccessor<T> accessor) {
/*  57 */     return getItem(accessor).getValue();
/*     */   }
/*     */   
/*     */   public <T> void set(EntityDataAccessor<T> accessor, T value) {
/*  61 */     set(accessor, value, false);
/*     */   }
/*     */   
...
/*     */     
/*  85 */     List<DataValue<?>> result = new ArrayList<>();
...
/* 124 */       throw new IllegalStateException(String.format(Locale.ROOT, "Invalid entity data item type for field %d on entity %s: old=%s(%s), new=%s(%s)", new Object[] { dataItem.accessor.id(), this.entity, dataItem.value, dataItem.value.getClass(), item.value, item.value.getClass() }));
/*     */     }
...
/*     */       // Local variable type table:
/*     */       //   start	length	slot	name	signature
/* 129 */       //   0	8	0	this	Lnet/minecraft/network/syncher/SynchedEntityData$DataValue<TT;>; } public EntityDataSerializer<T> serializer() { return this.serializer; } public T value() { return this.value; }
...
/* 156 */       return new DataValue<>(id, serializer, (T)serializer.codec().decode(input));
/*     */     } }
/*     */ 
/*     */   
...
/* 207 */       this.itemsById = (SynchedEntityData.DataItem<?>[])new SynchedEntityData.DataItem[SynchedEntityData.ID_REGISTRY.getCount(entity.getClass())];
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/network/syncher/SynchedEntityData.class
