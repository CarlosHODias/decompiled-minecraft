...
/* 26 */         .requires((java.util.function.Predicate)Commands.hasPermission(Commands.LEVEL_ADMINS)))
/* 27 */         .then(
/* 28 */           Commands.argument("targets", (com.mojang.brigadier.arguments.ArgumentType)GameProfileArgument.gameProfile())
/* 29 */           .suggests((c, p) -> {
/*    */               PlayerList list = ((CommandSourceStack)c.getSource()).getServer().getPlayerList();
/*    */               
/*    */               return SharedSuggestionProvider.suggest(list.getPlayers().stream().filter(()).map(()), p);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/OpCommand.class
