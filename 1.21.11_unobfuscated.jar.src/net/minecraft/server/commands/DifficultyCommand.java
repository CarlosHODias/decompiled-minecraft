...
/*    */   static {
/* 16 */     ERROR_ALREADY_DIFFICULT = new DynamicCommandExceptionType(difficulty -> Component.translatableEscape("commands.difficulty.failure", new Object[] { difficulty }));
...
/*    */     }
/*    */     
/* 25 */     dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)
/*    */         
/* 27 */         command.requires((java.util.function.Predicate)Commands.hasPermission(Commands.LEVEL_GAMEMASTERS)))
/* 28 */         .executes(c -> {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/DifficultyCommand.class
