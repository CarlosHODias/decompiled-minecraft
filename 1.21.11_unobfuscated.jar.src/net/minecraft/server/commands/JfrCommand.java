...
/* 24 */     DUMP_FAILED = new DynamicCommandExceptionType(message -> Component.translatableEscape("commands.jfr.dump.failed", new Object[] { message }));
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/* 32 */         .requires((java.util.function.Predicate)Commands.hasPermission(Commands.LEVEL_OWNERS)))
...
/* 50 */       Path clipboardPath = (!source.getServer().isPublished() || net.minecraft.SharedConstants.IS_RUNNING_IN_IDE) ? savedRecording.toAbsolutePath() : savedRecording;
/*    */       
/* 52 */       MutableComponent mutableComponent = Component.literal(savedRecording.toString()).withStyle(ChatFormatting.UNDERLINE)
/* 53 */         .withStyle(style -> style.withClickEvent((ClickEvent)new ClickEvent.CopyToClipboard(clipboardPath.toString())).withHoverEvent((HoverEvent)new HoverEvent.ShowText((Component)Component.translatable("chat.copy.click"))));
/*    */ 
/*    */       
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/JfrCommand.class
