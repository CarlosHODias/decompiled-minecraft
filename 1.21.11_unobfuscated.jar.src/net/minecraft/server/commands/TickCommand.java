...
/*  34 */             .suggests((c, b) -> SharedSuggestionProvider.suggest(new String[] { DEFAULT_TICKRATE
/*  35 */                 }, b)).executes(c -> setTickingRate((CommandSourceStack)c.getSource(), FloatArgumentType.getFloat(c, "rate"))))))
...
/*  41 */             .suggests((c, b) -> SharedSuggestionProvider.suggest(new String[] { "1t", "1s"
/*  42 */                 }, b)).executes(c -> step((CommandSourceStack)c.getSource(), IntegerArgumentType.getInteger(c, "time"))))))
...
/*  47 */             .suggests((c, b) -> SharedSuggestionProvider.suggest(new String[] { "60s", "1d", "3d"
/*  48 */                 }, b)).executes(c -> sprint((CommandSourceStack)c.getSource(), IntegerArgumentType.getInteger(c, "time"))))))
...
/*  54 */     return String.format(Locale.ROOT, "%.1f", new Object[] { (float)nanos / (float)TimeUtil.NANOSECONDS_PER_MILLISECOND });
/*     */   }
/*     */   
...
/*  60 */     String tickRateString = String.format(Locale.ROOT, "%.1f", new Object[] { rate });
...
/*  70 */     String tickRateString = String.format(Locale.ROOT, "%.1f", new Object[] { tickRate });
...
/*     */     
/*  94 */     source.sendSuccess(() -> Component.translatable("commands.tick.query.percentiles", new Object[] { p50, p95, p99, samples.length }), false);
...
/* 129 */     if (success) {
/* 130 */       source.sendSuccess(() -> Component.translatable("commands.tick.step.success", new Object[] { advance }), true);
/*     */     } else {
/* 132 */       source.sendFailure((Component)Component.translatable("commands.tick.step.fail"));
/*     */     } 
/* 134 */     return 1;
/*     */   }
/*     */   
...
/* 142 */       return 1;
/*     */     } 
/* 144 */     source.sendFailure((Component)Component.translatable("commands.tick.step.stop.fail"));
/* 145 */     return 0;
/*     */   }
/*     */   
...
/* 153 */       return 1;
/*     */     } 
/* 155 */     source.sendFailure((Component)Component.translatable("commands.tick.sprint.stop.fail"));
/* 156 */     return 0;
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/TickCommand.class
