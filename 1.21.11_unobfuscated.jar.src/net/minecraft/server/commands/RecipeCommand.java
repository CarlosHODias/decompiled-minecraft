...
/* 74 */       source.sendSuccess(() -> Component.translatable("commands.recipe.give.success.single", new Object[] { recipes.size(), ((ServerPlayer)players.iterator().next()).getDisplayName() }), true);
/*    */     } else {
/* 76 */       source.sendSuccess(() -> Component.translatable("commands.recipe.give.success.multiple", new Object[] { recipes.size(), players.size() }), true);
/*    */     } 
/*    */     
/* 79 */     return success;
/*    */   }
...
/* 94 */       source.sendSuccess(() -> Component.translatable("commands.recipe.take.success.single", new Object[] { recipes.size(), ((ServerPlayer)players.iterator().next()).getDisplayName() }), true);
/*    */     } else {
/* 96 */       source.sendSuccess(() -> Component.translatable("commands.recipe.take.success.multiple", new Object[] { recipes.size(), players.size() }), true);
/*    */     } 
/*    */     
/* 99 */     return success;
/*    */   }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/RecipeCommand.class
