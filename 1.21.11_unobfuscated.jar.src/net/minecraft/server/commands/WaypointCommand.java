...
/* 103 */     source.sendSuccess(() -> Component.translatable("commands.waypoint.modify.color", new Object[] { Component.literal(HexFormat.of().withUpperCase().toHexDigits(ARGB.color(0, color), 6)).withColor(color) }), false);
/* 104 */     return 0;
/*     */   }
/*     */   
...
/*     */     
/* 136 */     source.sendSuccess(() -> Component.translatable("commands.waypoint.list.success", new Object[] { waypoints.size(), dimension, waypointNames }), false);
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/WaypointCommand.class
