...
/*  36 */     ERROR_CANT_REMOVE = new DynamicCommandExceptionType(s -> Component.translatableEscape("commands.schedule.cleared.failure", new Object[] { s }));
/*  37 */   } private static final DynamicCommandExceptionType ERROR_CANT_REMOVE; private static final SimpleCommandExceptionType ERROR_MACRO = new SimpleCommandExceptionType((Message)Component.translatableEscape("commands.schedule.macro", new Object[0])); private static final SuggestionProvider<CommandSourceStack> SUGGEST_SCHEDULE;
/*     */   static {
/*  39 */     SUGGEST_SCHEDULE = ((c, p) -> SharedSuggestionProvider.suggest(((CommandSourceStack)c.getSource()).getServer().getWorldData().overworldData().getScheduledEvents().getEventsIds(), p));
/*     */   }
...
/*  50 */             .then((
/*  51 */               (RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("time", (ArgumentType)net.minecraft.commands.arguments.TimeArgument.time())
...
/*     */       }
/*  93 */       queue.schedule(scheduleId, tickTime, (TimerCallback)new FunctionCallback(callbackId));
/*  94 */       source.sendSuccess(() -> Component.translatable("commands.schedule.created.function", new Object[] { Component.translationArg(callbackId), time, tickTime }), true);
/*     */     } else {
/*  96 */       String scheduleId = "#" + String.valueOf(callbackId);
/*  97 */       if (replace) {
/*  98 */         queue.remove(scheduleId);
/*     */       }
/* 100 */       queue.schedule(scheduleId, tickTime, (TimerCallback)new FunctionTagCallback(callbackId));
/* 101 */       source.sendSuccess(() -> Component.translatable("commands.schedule.created.tag", new Object[] { Component.translationArg(callbackId), time, tickTime }), true);
/*     */     } 
/*     */     
/* 104 */     return Math.floorMod(tickTime, Integer.MAX_VALUE);
/*     */   }
/*     */   
...
/*     */     }
/* 112 */     source.sendSuccess(() -> Component.translatable("commands.schedule.cleared.success", new Object[] { count, id }), true);
/* 113 */     return count;
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/ScheduleCommand.class
