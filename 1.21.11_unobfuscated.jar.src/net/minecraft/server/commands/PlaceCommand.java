...
/*  63 */     ERROR_TEMPLATE_INVALID = new DynamicCommandExceptionType(value -> Component.translatableEscape("commands.place.template.invalid", new Object[] { value }));
...
/*     */   static {
/*  66 */     SUGGEST_TEMPLATES = ((context, builder) -> {
...
/*  79 */             .executes(c -> placeFeature((CommandSourceStack)c.getSource(), ResourceKeyArgument.getConfiguredFeature(c, "feature"), BlockPos.containing((Position)((CommandSourceStack)c.getSource()).getPosition()))))
/*  80 */             .then(
...
/*  94 */                 .executes(c -> placeJigsaw((CommandSourceStack)c.getSource(), (Holder<StructureTemplatePool>)ResourceKeyArgument.getStructureTemplatePool(c, "pool"), IdentifierArgument.getId(c, "target"), IntegerArgumentType.getInteger(c, "max_depth"), BlockPos.containing((Position)((CommandSourceStack)c.getSource()).getPosition()))))
/*  95 */                 .then(
/*  96 */                   Commands.argument("position", (ArgumentType)BlockPosArgument.blockPos())
/*  97 */                   .executes(c -> placeJigsaw((CommandSourceStack)c.getSource(), (Holder<StructureTemplatePool>)ResourceKeyArgument.getStructureTemplatePool(c, "pool"), IdentifierArgument.getId(c, "target"), IntegerArgumentType.getInteger(c, "max_depth"), BlockPosArgument.getLoadedBlockPos(c, "position")))))))))
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 107 */             .executes(c -> placeStructure((CommandSourceStack)c.getSource(), ResourceKeyArgument.getStructure(c, "structure"), BlockPos.containing((Position)((CommandSourceStack)c.getSource()).getPosition()))))
/* 108 */             .then(
...
/* 119 */             .executes(c -> placeTemplate((CommandSourceStack)c.getSource(), IdentifierArgument.getId(c, "template"), BlockPos.containing((Position)((CommandSourceStack)c.getSource()).getPosition()), Rotation.NONE, Mirror.NONE, 1.0F, 0, false)))
/* 120 */             .then((
...
/*     */     
/* 156 */     if (!feature.place((WorldGenLevel)level, level.getChunkSource().getGenerator(), level.getRandom(), pos)) {
/* 157 */       throw ERROR_FEATURE_FAILED.create();
/*     */     }
/* 159 */     String id = featureHolder.key().identifier().toString();
/* 160 */     source.sendSuccess(() -> Component.translatable("commands.place.feature.success", new Object[] { id, pos.getX(), pos.getY(), pos.getZ() }), true);
/* 161 */     return 1;
/*     */   }
/*     */   
...
/*     */     }
/* 171 */     source.sendSuccess(() -> Component.translatable("commands.place.jigsaw.success", new Object[] { pos.getX(), pos.getY(), pos.getZ() }), true);
/* 172 */     return 1;
/*     */   }
/*     */   
...
/*     */     
/* 180 */     StructureStart start = structure.generate((Holder)structureHolder, level.dimension(), source.registryAccess(), chunkGenerator, chunkGenerator.getBiomeSource(), level.getChunkSource().randomState(), level.getStructureManager(), level.getSeed(), new ChunkPos(pos), 0, (LevelHeightAccessor)level, b -> true);
...
/* 189 */     ChunkPos.rangeClosed(chunkMin, chunkMax).forEach(c -> start.placeInChunk((WorldGenLevel)level, level.structureManager(), chunkGenerator, level.getRandom(), new BoundingBox(c.getMinBlockX(), level.getMinY(), c.getMinBlockZ(), c.getMaxBlockX(), level.getMaxY() + 1, c.getMaxBlockZ()), c));
/*     */ 
/*     */ 
/*     */     
/* 193 */     String id = structureHolder.key().identifier().toString();
/* 194 */     source.sendSuccess(() -> Component.translatable("commands.place.structure.success", new Object[] { id, pos.getX(), pos.getY(), pos.getZ() }), true);
/* 195 */     return 1;
/*     */   }
...
/*     */     }
/* 210 */     StructureTemplate structureTemplate = maybeStructureTemplate.get();
...
/* 215 */       placeSettings.clearProcessors().addProcessor((StructureProcessor)new BlockRotProcessor(integrity)).setRandom(StructureBlockEntity.createRandom(seed));
/*     */     }
/*     */     
/* 218 */     boolean placed = structureTemplate.placeInWorld((ServerLevelAccessor)level, pos, pos, placeSettings, StructureBlockEntity.createRandom(seed), 0x2 | (strict ? 816 : 0));
/* 219 */     if (!placed) {
/* 220 */       throw ERROR_TEMPLATE_FAILED.create();
/*     */     }
/* 222 */     source.sendSuccess(() -> Component.translatable("commands.place.template.success", new Object[] { Component.translationArg(template), pos.getX(), pos.getY(), pos.getZ() }), true);
/* 223 */     return 1;
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/PlaceCommand.class
