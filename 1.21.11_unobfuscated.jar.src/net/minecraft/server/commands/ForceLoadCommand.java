...
/*     */   
/*     */   static {
/*  28 */     ERROR_TOO_MANY_CHUNKS = new Dynamic2CommandExceptionType((max, amount) -> Component.translatableEscape("commands.forceload.toobig", new Object[] { max, amount }));
/*  29 */     ERROR_NOT_TICKING = new Dynamic2CommandExceptionType((pos, dimension) -> Component.translatableEscape("commands.forceload.query.failure", new Object[] { pos, dimension }));
...
/*  36 */         .requires((java.util.function.Predicate)Commands.hasPermission(Commands.LEVEL_GAMEMASTERS)))
/*  37 */         .then(
...
/*     */     
/*  90 */     if (chunkCount > 0) {
/*  91 */       String chunkList = com.google.common.base.Joiner.on(", ").join(forcedChunks.stream().sorted().map(ChunkPos::new).map(ChunkPos::toString).iterator());
/*     */       
/*  93 */       if (chunkCount == 1) {
...
/*     */       } else {
/*  96 */         source.sendSuccess(() -> Component.translatable("commands.forceload.list.multiple", new Object[] { chunkCount, Component.translationArg(dimension.identifier()), chunkList }), false);
/*     */       } 
/*     */     } else {
/*  99 */       source.sendFailure((Component)Component.translatable("commands.forceload.added.none", new Object[] { Component.translationArg(dimension.identifier()) }));
/*     */     } 
...
/*     */ 
/*     */       
/* 124 */       throw net.minecraft.commands.arguments.coordinates.BlockPosArgument.ERROR_OUT_OF_WORLD.create();
/*     */     }
/*     */     
...
/* 135 */       throw ERROR_TOO_MANY_CHUNKS.create(256, chunkCount);
/*     */     }
/*     */     
...
/* 164 */       source.sendSuccess(() -> Component.translatable("commands.forceload." + (add ? "added" : "removed") + ".multiple", new Object[] { changedChunks, Component.translationArg(dimension.identifier()), Component.translationArg(min), Component.translationArg(max) }), true);
/*     */     } 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/ForceLoadCommand.class
