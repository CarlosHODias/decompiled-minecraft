...
/* 67 */       source.sendSuccess(() -> Component.translatable("commands.banip.info", new Object[] { players.size(), EntitySelector.joinNames(players) }), true);
/*    */     }
/*    */     
/* 70 */     for (ServerPlayer player : players) {
/* 71 */       player.connection.disconnect((Component)Component.translatable("multiplayer.disconnect.ip_banned"));
/*    */     }
/*    */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/BanIpCommands.class
