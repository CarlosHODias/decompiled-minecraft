...
/*    */   
/*    */   static {
/* 20 */     ERROR_NOT_RIDING = new DynamicCommandExceptionType(entity -> Component.translatableEscape("commands.ride.not_riding", new Object[] { entity }));
/* 21 */     ERROR_ALREADY_RIDING = new Dynamic2CommandExceptionType((entity, vehicle) -> Component.translatableEscape("commands.ride.already_riding", new Object[] { entity, vehicle }));
/* 22 */     ERROR_MOUNT_FAILED = new Dynamic2CommandExceptionType((entity, vehicle) -> Component.translatableEscape("commands.ride.mount.failure.generic", new Object[] { entity, vehicle }));
...
/* 30 */         .requires((java.util.function.Predicate)Commands.hasPermission(Commands.LEVEL_GAMEMASTERS)))
/* 31 */         .then((
/* 32 */           (com.mojang.brigadier.builder.RequiredArgumentBuilder)Commands.argument("target", (com.mojang.brigadier.arguments.ArgumentType)EntityArgument.entity())
/* 33 */           .then(
/* 34 */             Commands.literal("mount")
/* 35 */             .then(
/* 36 */               Commands.argument("vehicle", (com.mojang.brigadier.arguments.ArgumentType)EntityArgument.entity())
...
/*    */     }
/* 53 */     if (vehicle.getType() == net.minecraft.world.entity.EntityType.PLAYER) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/RideCommand.class
