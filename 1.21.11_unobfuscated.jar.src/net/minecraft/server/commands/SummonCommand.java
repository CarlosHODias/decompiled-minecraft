...
/* 44 */         .then((
/* 45 */           (RequiredArgumentBuilder)Commands.argument("entity", (ArgumentType)ResourceArgument.resource(context, Registries.ENTITY_TYPE))
...
/* 61 */     BlockPos blockPos = BlockPos.containing((Position)pos);
...
/* 74 */     Entity entity = EntityType.loadEntityRecursive(entityTag, (Level)level, EntitySpawnReason.COMMAND, e -> {
...
/* 83 */       mob.finalizeSpawn((ServerLevelAccessor)source.getLevel(), source.getLevel().getCurrentDifficultyAt(entity.blockPosition()), EntitySpawnReason.COMMAND, null); }
/*    */ 
/*    */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/SummonCommand.class
