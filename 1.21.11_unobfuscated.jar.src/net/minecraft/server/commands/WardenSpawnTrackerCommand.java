...
/* 25 */           .executes(c -> resetTracker((CommandSourceStack)c.getSource(), (Collection<? extends Player>)ImmutableList.of(((CommandSourceStack)c.getSource()).getPlayerOrException())))))
/*    */         
/* 27 */         .then(
/* 28 */           Commands.literal("set")
/* 29 */           .then(
/* 30 */             Commands.argument("warning_level", (ArgumentType)IntegerArgumentType.integer(0, 4))
/* 31 */             .executes(c -> setWarningLevel((CommandSourceStack)c.getSource(), (Collection<? extends Player>)ImmutableList.of(((CommandSourceStack)c.getSource()).getPlayerOrException()), IntegerArgumentType.getInteger(c, "warning_level"))))));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/*    */     } else {
/* 45 */       source.sendSuccess(() -> Component.translatable("commands.warden_spawn_tracker.set.success.multiple", new Object[] { players.size() }), true);
/*    */     } 
/*    */     
...
/*    */     } else {
/* 59 */       source.sendSuccess(() -> Component.translatable("commands.warden_spawn_tracker.clear.success.multiple", new Object[] { players.size() }), true);
/*    */     } 
/*    */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/WardenSpawnTrackerCommand.class
