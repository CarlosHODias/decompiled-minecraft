...
/*  33 */   private static final SimpleCommandExceptionType ERROR_TOO_BIG = new SimpleCommandExceptionType((Message)Component.translatable("commands.worldborder.set.failed.big", new Object[] { 5.9999968E7D }));
/*  34 */   private static final SimpleCommandExceptionType ERROR_TOO_FAR_OUT = new SimpleCommandExceptionType((Message)Component.translatable("commands.worldborder.set.failed.far", new Object[] { 2.9999984E7D }));
...
/* 120 */     source.sendSuccess(() -> Component.translatable("commands.worldborder.damage.buffer.success", new Object[] { String.format(Locale.ROOT, "%.2f", new Object[] { distance }) }), true);
...
/* 130 */     source.sendSuccess(() -> Component.translatable("commands.worldborder.damage.amount.success", new Object[] { String.format(Locale.ROOT, "%.2f", new Object[] { damagePerBlock }) }), true);
...
/* 150 */     source.sendSuccess(() -> Component.translatable("commands.worldborder.warning.distance.success", new Object[] { distance }), true);
/* 151 */     return distance;
/*     */   }
/*     */   
/*     */   private static int getSize(CommandSourceStack source) {
/* 155 */     double size = source.getLevel().getWorldBorder().getSize();
/* 156 */     source.sendSuccess(() -> Component.translatable("commands.worldborder.get", new Object[] { String.format(Locale.ROOT, "%.0f", new Object[] { size }) }), false);
...
/* 171 */     source.sendSuccess(() -> Component.translatable("commands.worldborder.center.success", new Object[] { String.format(Locale.ROOT, "%.2f", new Object[] { center.x }), String.format(Locale.ROOT, "%.2f", new Object[] { center.y }) }), true);
/*     */     
/* 173 */     return 0;
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/* 191 */     String formattedDistance = String.format(Locale.ROOT, "%.1f", new Object[] { distance });
/* 192 */     if (ticks > 0L) {
...
/* 208 */     return String.format(Locale.ROOT, "%.2f", new Object[] { ticks / 20.0D });
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/WorldBorderCommand.class
