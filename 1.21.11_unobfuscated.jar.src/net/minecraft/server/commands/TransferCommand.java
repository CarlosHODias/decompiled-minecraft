...
/* 53 */       player.connection.send((Packet)new ClientboundTransferPacket(hostname, port));
/*    */     }
/* 55 */     if (players.size() == 1) {
/* 56 */       source.sendSuccess(() -> Component.translatable("commands.transfer.success.single", new Object[] { ((ServerPlayer)players.iterator().next()).getDisplayName(), hostname, port }), true);
/*    */     } else {
/* 58 */       source.sendSuccess(() -> Component.translatable("commands.transfer.success.multiple", new Object[] { players.size(), hostname, port }), true);
/*    */     } 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/TransferCommand.class
