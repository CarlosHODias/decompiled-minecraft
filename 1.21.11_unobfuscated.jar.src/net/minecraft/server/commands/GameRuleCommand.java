...
/* 18 */     final LiteralArgumentBuilder<CommandSourceStack> base = (LiteralArgumentBuilder<CommandSourceStack>)Commands.literal("gamerule")
...
/* 26 */             ((LiteralArgumentBuilder)
/* 27 */               base.then((ArgumentBuilder)GameRuleCommand.buildRuleArguments(gameRule, unqualified)))
/* 28 */               .then((ArgumentBuilder)GameRuleCommand.buildRuleArguments(gameRule, qualified));
/*    */           }
/*    */         });
/*    */     
...
/* 36 */     return (LiteralArgumentBuilder<CommandSourceStack>)((LiteralArgumentBuilder)
/* 37 */       ruleLiteral.executes(c -> queryRule((CommandSourceStack)c.getSource(), gameRule)))
/* 38 */       .then(
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/GameRuleCommand.class
