...
/*    */   
/*    */   static {
/* 32 */     ERROR_NOT_LIVING_ENTITY = new DynamicCommandExceptionType(target -> Component.translatableEscape("commands.enchant.failed.entity", new Object[] { target }));
/* 33 */     ERROR_NO_ITEM = new DynamicCommandExceptionType(target -> Component.translatableEscape("commands.enchant.failed.itemless", new Object[] { target }));
/* 34 */     ERROR_INCOMPATIBLE = new DynamicCommandExceptionType(item -> Component.translatableEscape("commands.enchant.failed.incompatible", new Object[] { item }));
/* 35 */     ERROR_LEVEL_TOO_HIGH = new Dynamic2CommandExceptionType((level, max) -> Component.translatableEscape("commands.enchant.failed.level", new Object[] { level, max }));
...
/* 41 */         .requires((java.util.function.Predicate)Commands.hasPermission(Commands.LEVEL_GAMEMASTERS)))
/* 42 */         .then(
/* 43 */           Commands.argument("targets", (ArgumentType)EntityArgument.entities())
/* 44 */           .then((
/* 45 */             (com.mojang.brigadier.builder.RequiredArgumentBuilder)Commands.argument("enchantment", (ArgumentType)ResourceArgument.resource(context, Registries.ENCHANTMENT))
/* 46 */             .executes(c -> enchant((CommandSourceStack)c.getSource(), EntityArgument.getEntities(c, "targets"), (Holder<Enchantment>)ResourceArgument.getEnchantment(c, "enchantment"), 1)))
/* 47 */             .then(
/* 48 */               Commands.argument("level", (ArgumentType)IntegerArgumentType.integer(0))
/* 49 */               .executes(c -> enchant((CommandSourceStack)c.getSource(), EntityArgument.getEntities(c, "targets"), (Holder<Enchantment>)ResourceArgument.getEnchantment(c, "enchantment"), IntegerArgumentType.getInteger(c, "level")))))));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 59 */       throw ERROR_LEVEL_TOO_HIGH.create(level, enchantment.getMaxLevel());
/*    */     }
/*    */     
/* 62 */     int success = 0;
/*    */     
...
/*    */     } else {
/* 87 */       source.sendSuccess(() -> Component.translatable("commands.enchant.success.multiple", new Object[] { Enchantment.getFullname(enchantmentHolder, level), targets.size() }), true);
/*    */     } 
/*    */     
/* 90 */     return success;
/*    */   }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/EnchantCommand.class
