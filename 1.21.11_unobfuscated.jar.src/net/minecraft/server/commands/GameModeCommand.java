...
/*    */     } else {
/* 47 */       if ((Boolean)source.getLevel().getGameRules().get(GameRules.SEND_COMMAND_FEEDBACK)) {
/* 48 */         target.sendSystemMessage((Component)Component.translatable("gameMode.changed", new Object[] { mutableComponent }));
/*    */       }
/*    */       
...
/* 66 */     setGameMode(player.createCommandSourceStack(), player, type);
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/GameModeCommand.class
