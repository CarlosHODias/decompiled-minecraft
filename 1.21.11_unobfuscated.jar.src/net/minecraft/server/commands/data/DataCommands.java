...
/*  49 */     ERROR_GET_NOT_NUMBER = new DynamicCommandExceptionType(path -> Component.translatableEscape("commands.data.get.invalid", new Object[] { path }));
/*  50 */     ERROR_GET_NON_EXISTENT = new DynamicCommandExceptionType(path -> Component.translatableEscape("commands.data.get.unknown", new Object[] { path }));
...
/*  52 */     ERROR_EXPECTED_OBJECT = new DynamicCommandExceptionType(node -> Component.translatableEscape("commands.data.modify.expected_object", new Object[] { node }));
/*  53 */     ERROR_EXPECTED_VALUE = new DynamicCommandExceptionType(node -> Component.translatableEscape("commands.data.modify.expected_value", new Object[] { node }));
/*  54 */     ERROR_INVALID_SUBSTRING = new Dynamic2CommandExceptionType((start, end) -> Component.translatableEscape("commands.data.modify.invalid_substring", new Object[] { start, end }));
/*     */   }
...
/*     */   static {
/*  58 */     TARGET_PROVIDERS = (List<DataProvider>)ALL_PROVIDERS.stream().map(f -> (DataProvider)f.apply("target")).collect(ImmutableList.toImmutableList());
/*  59 */     SOURCE_PROVIDERS = (List<DataProvider>)ALL_PROVIDERS.stream().map(f -> (DataProvider)f.apply("source")).collect(ImmutableList.toImmutableList());
/*     */   }
/*     */   public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
/*  62 */     LiteralArgumentBuilder<CommandSourceStack> root = (LiteralArgumentBuilder<CommandSourceStack>)Commands.literal("data").requires((Predicate)Commands.hasPermission(Commands.LEVEL_GAMEMASTERS));
/*     */     
/*  64 */     for (DataProvider targetProvider : TARGET_PROVIDERS) {
/*  65 */       ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)
/*  66 */         root.then(
/*  67 */           targetProvider.wrap((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("merge"), p -> p.then(Commands.argument("nbt", (ArgumentType)CompoundTagArgument.compoundTag()).executes(())))))
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/*  74 */         .then(
/*  75 */           targetProvider.wrap((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("get"), p -> p.executes(()).then(((RequiredArgumentBuilder)Commands.argument("path", (ArgumentType)NbtPathArgument.nbtPath()).executes(())).then(Commands.argument("scale", (ArgumentType)DoubleArgumentType.doubleArg()).executes(()))))))
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/*  87 */         .then(
/*  88 */           targetProvider.wrap((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("remove"), p -> p.then(Commands.argument("path", (ArgumentType)NbtPathArgument.nbtPath()).executes(())))))
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/*  95 */         .then(
/*  96 */           decorateModification((parent, rest) -> parent.then(Commands.literal("insert").then(Commands.argument("index", (ArgumentType)IntegerArgumentType.integer()).then(rest.create(())))).then(Commands.literal("prepend").then(rest.create(()))).then(Commands.literal("append").then(rest.create(()))).then(Commands.literal("set").then(rest.create(()))).then(Commands.literal("merge").then(rest.create(())))));
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 193 */     List<Tag> result = new ArrayList<>(source.size());
...
/*     */     
/* 204 */     for (Iterator<DataProvider> iterator = TARGET_PROVIDERS.iterator(); iterator.hasNext(); ) { DataProvider targetProvider = iterator.next();
/* 205 */       targetProvider.wrap((ArgumentBuilder)modify, t -> {
...
/*     */               nodeSupplier.accept(requiredArgumentBuilder, ());
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */             
/*     */             return t.then((ArgumentBuilder)requiredArgumentBuilder);
/*     */           }); }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 249 */     return (ArgumentBuilder)modify;
/*     */   }
/*     */   
...
/* 254 */       throw ERROR_INVALID_SUBSTRING.create(start, end);
/*     */     }
...
/* 272 */     return (index >= 0) ? index : (length + index);
/*     */   }
/*     */   
...
/* 277 */     return (List)Collections.singletonList(source.getData());
/*     */   }
/*     */   
...
/* 283 */     return sourcePath.get((Tag)source.getData());
/*     */   }
/*     */   
...
/*     */     
/* 307 */     int count = path.remove((Tag)result);
/*     */     
/* 309 */     if (count == 0) {
...
/* 319 */     Collection<Tag> tags = path.get((Tag)accessor.getData());
/* 320 */     Iterator<Tag> iterator = tags.iterator();
/* 321 */     Tag result = iterator.next();
...
/* 354 */     source.sendSuccess(() -> accessor.getPrintSuccess((Tag)data), false);
/* 355 */     return 1;
/*     */   }
/*     */   
...
/*     */     
/* 361 */     if (NbtPathArgument.NbtPath.isTooDeep((Tag)nbt, 0)) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/data/DataCommands.class
