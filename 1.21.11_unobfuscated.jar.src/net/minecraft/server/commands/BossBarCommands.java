...
/*     */   
/*     */   static {
/*  39 */     ERROR_ALREADY_EXISTS = new DynamicCommandExceptionType(id -> Component.translatableEscape("commands.bossbar.create.failed", new Object[] { id }));
/*  40 */     ERROR_DOESNT_EXIST = new DynamicCommandExceptionType(id -> Component.translatableEscape("commands.bossbar.unknown", new Object[] { id }));
...
/*  49 */     SUGGEST_BOSS_BAR = ((c, b) -> SharedSuggestionProvider.suggestResource(((CommandSourceStack)c.getSource()).getServer().getCustomBossEvents().getIds(), b));
/*     */   }
...
/*  54 */         .requires((java.util.function.Predicate)Commands.hasPermission(Commands.LEVEL_GAMEMASTERS)))
/*  55 */         .then(
/*  56 */           Commands.literal("add")
/*  57 */           .then(
/*  58 */             Commands.argument("id", (ArgumentType)IdentifierArgument.id())
/*  59 */             .then(
/*  60 */               Commands.argument("name", (ArgumentType)ComponentArgument.textComponent(context))
...
/*  84 */               .then(
/*  85 */                 Commands.argument("name", (ArgumentType)ComponentArgument.textComponent(context))
...
/* 201 */     source.sendSuccess(() -> Component.translatable("commands.bossbar.get.value", new Object[] { bossBar.getDisplayName(), bossBar.getValue() }), true);
/* 202 */     return bossBar.getValue();
/*     */   }
/*     */   
/*     */   private static int getMax(CommandSourceStack source, CustomBossEvent bossBar) {
/* 206 */     source.sendSuccess(() -> Component.translatable("commands.bossbar.get.max", new Object[] { bossBar.getDisplayName(), bossBar.getMax() }), true);
...
/*     */     } else {
/* 224 */       source.sendSuccess(() -> Component.translatable("commands.bossbar.get.players.some", new Object[] { bossBar.getDisplayName(), bossBar.getPlayers().size(), ComponentUtils.formatList(bossBar.getPlayers(), Player::getDisplayName) }), true);
/*     */     } 
...
/* 251 */     source.sendSuccess(() -> Component.translatable("commands.bossbar.set.value.success", new Object[] { bossBar.getDisplayName(), value }), true);
/* 252 */     return value;
/*     */   }
/*     */   
...
/* 260 */     source.sendSuccess(() -> Component.translatable("commands.bossbar.set.max.success", new Object[] { bossBar.getDisplayName(), value }), true);
/* 261 */     return value;
/*     */   }
/*     */   
...
/*     */     }
/* 287 */     bossBar.setName((Component)mutableComponent);
...
/*     */     } else {
/* 300 */       source.sendSuccess(() -> Component.translatable("commands.bossbar.set.players.success.some", new Object[] { bossBar.getDisplayName(), targets.size(), ComponentUtils.formatList(targets, Player::getDisplayName) }), true);
/*     */     } 
...
/*     */     } else {
/* 310 */       source.sendSuccess(() -> Component.translatable("commands.bossbar.list.bars.some", new Object[] { events.size(), ComponentUtils.formatList(events, CustomBossEvent::getDisplayName) }), false);
/*     */     } 
...
/*     */     }
/* 320 */     CustomBossEvent event = events.create(id, (Component)ComponentUtils.updateForEntity(source, name, null, 0));
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/BossBarCommands.class
