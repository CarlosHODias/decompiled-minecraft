...
/* 27 */     ERROR_ALREADY_PUBLISHED = new DynamicCommandExceptionType(port -> Component.translatableEscape("commands.publish.alreadyPublished", new Object[] { port }));
/*    */   }
...
/* 51 */       throw ERROR_ALREADY_PUBLISHED.create(source.getServer().getPort());
/*    */     }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/PublishCommand.class
