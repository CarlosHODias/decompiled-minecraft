...
/*  31 */         .requires((java.util.function.Predicate)Commands.hasPermission(Commands.LEVEL_GAMEMASTERS)))
/*  32 */         .then((
...
/*     */     } else {
/*  81 */       source.sendSuccess(() -> Component.translatable("commands.tag.add.success.multiple", new Object[] { name, targets.size() }), true);
/*     */     } 
/*     */     
/*  84 */     return count;
/*     */   }
...
/*     */     } else {
/* 103 */       source.sendSuccess(() -> Component.translatable("commands.tag.remove.success.multiple", new Object[] { name, targets.size() }), true);
/*     */     } 
/*     */     
/* 106 */     return count;
/*     */   }
...
/* 117 */       Entity entity = targets.iterator().next();
/*     */       
/* 119 */       if (tags.isEmpty()) {
/* 120 */         source.sendSuccess(() -> Component.translatable("commands.tag.list.single.empty", new Object[] { entity.getDisplayName() }), false);
/*     */       } else {
/* 122 */         source.sendSuccess(() -> Component.translatable("commands.tag.list.single.success", new Object[] { entity.getDisplayName(), tags.size(), ComponentUtils.formatList(tags) }), false);
/*     */       }
/*     */     
/* 125 */     } else if (tags.isEmpty()) {
/* 126 */       source.sendSuccess(() -> Component.translatable("commands.tag.list.multiple.empty", new Object[] { targets.size() }), false);
/*     */     } else {
/* 128 */       source.sendSuccess(() -> Component.translatable("commands.tag.list.multiple.success", new Object[] { targets.size(), tags.size(), ComponentUtils.formatList(tags) }), false);
/*     */     } 
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/TagCommand.class
