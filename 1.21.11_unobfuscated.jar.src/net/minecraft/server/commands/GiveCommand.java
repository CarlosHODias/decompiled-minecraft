...
/* 37 */           .then((
/* 38 */             (RequiredArgumentBuilder)Commands.argument("item", (ArgumentType)ItemArgument.item(context))
...
/* 54 */       source.sendFailure((Component)Component.translatable("commands.give.failed.toomanyitems", new Object[] { maxAllowedCount, displayItemStack.getDisplayName() }));
/* 55 */       return 0;
/*    */     } 
...
/* 67 */           ItemEntity itemEntity = player.drop(itemStack, false);
/* 68 */           if (itemEntity != null) {
/* 69 */             itemEntity.setNoPickUpDelay();
/* 70 */             itemEntity.setTarget(player.getUUID());
/*    */           } 
/*    */           continue;
/*    */         } 
...
/* 85 */       source.sendSuccess(() -> Component.translatable("commands.give.success.single", new Object[] { count, displayItemStack.getDisplayName(), ((ServerPlayer)players.iterator().next()).getDisplayName() }), true);
/*    */     } else {
/* 87 */       source.sendSuccess(() -> Component.translatable("commands.give.success.single", new Object[] { count, displayItemStack.getDisplayName(), players.size() }), true);
/*    */     } 
/*    */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/GiveCommand.class
