...
/*  57 */             .then(
/*  58 */               Commands.argument("dialog", (ArgumentType)ResourceOrIdArgument.dialog(context))
...
/*  67 */     Set<String> result = new HashSet<>();
/*  68 */     for (Connection connection : (Iterable<Connection>)server.getConnection().getConnections()) {
...
/*  84 */     for (Connection connection : (Iterable<Connection>)server.getConnection().getConnections()) {
...
/* 100 */       return 1;
/*     */     } 
/* 102 */     source.sendFailure((Component)Component.literal("Can't find player to unconfig"));
/* 103 */     return 0;
/*     */   }
/*     */ 
/*     */   
...
/* 111 */       listener.send((Packet)new ClientboundShowDialogPacket(dialog));
/* 112 */       return 1;
/*     */     } 
/* 114 */     source.sendFailure((Component)Component.literal("Can't find player to talk to"));
/* 115 */     return 0;
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/DebugConfigCommand.class
