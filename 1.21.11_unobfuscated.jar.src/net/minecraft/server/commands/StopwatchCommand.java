...
/*     */   
/*     */   static {
/*  24 */     ERROR_ALREADY_EXISTS = new DynamicCommandExceptionType(id -> Component.translatableEscape("commands.stopwatch.already_exists", new Object[] { id }));
/*  25 */     ERROR_DOES_NOT_EXIST = new DynamicCommandExceptionType(id -> Component.translatableEscape("commands.stopwatch.does_not_exist", new Object[] { id }));
/*  26 */     SUGGEST_STOPWATCHES = ((c, p) -> SharedSuggestionProvider.suggestResource(((CommandSourceStack)c.getSource()).getServer().getStopwatches().ids(), p));
/*     */   }
/*     */   public static final DynamicCommandExceptionType ERROR_DOES_NOT_EXIST; public static final com.mojang.brigadier.suggestion.SuggestionProvider<CommandSourceStack> SUGGEST_STOPWATCHES;
...
/*  32 */         .requires((java.util.function.Predicate)Commands.hasPermission(Commands.LEVEL_GAMEMASTERS)))
/*  33 */         .then(
...
/*  42 */           .then((
/*  43 */             (com.mojang.brigadier.builder.RequiredArgumentBuilder)Commands.argument("id", (ArgumentType)IdentifierArgument.id())
...
/*  91 */     source.sendSuccess(() -> Component.translatable("commands.stopwatch.query", new Object[] { Component.translationArg(id), elapsedSeconds }), true);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/StopwatchCommand.class
