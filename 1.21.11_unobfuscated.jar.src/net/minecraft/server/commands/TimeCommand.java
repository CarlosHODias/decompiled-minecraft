...
/* 65 */     return (int)(level.getDayTime() % 24000L);
/*    */   }
/*    */   
/*    */   private static int queryTime(CommandSourceStack source, int time) {
/* 69 */     source.sendSuccess(() -> Component.translatable("commands.time.query", new Object[] { time }), false);
/* 70 */     return time;
/*    */   }
/*    */   
/*    */   public static int setTime(CommandSourceStack source, int time) {
/* 74 */     for (ServerLevel level : (Iterable<ServerLevel>)source.getServer().getAllLevels()) {
/* 75 */       level.setDayTime(time);
/*    */     }
/* 77 */     source.getServer().forceTimeSynchronization();
/* 78 */     source.sendSuccess(() -> Component.translatable("commands.time.set", new Object[] { time }), true);
/* 79 */     return getDayTime(source.getLevel());
/*    */   }
/*    */   
/*    */   public static int addTime(CommandSourceStack source, int time) {
/* 83 */     for (ServerLevel level : (Iterable<ServerLevel>)source.getServer().getAllLevels()) {
...
/* 88 */     source.sendSuccess(() -> Component.translatable("commands.time.set", new Object[] { newTime }), true);
/* 89 */     return newTime;
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/TimeCommand.class
