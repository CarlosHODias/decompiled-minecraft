...
/*  96 */         .redirect((CommandNode)teleport));
/*     */   }
/*     */ 
/*     */   
...
/*     */     } else {
/* 110 */       source.sendSuccess(() -> Component.translatable("commands.teleport.success.entity.multiple", new Object[] { entities.size(), destination.getDisplayName() }), true);
/*     */     } 
/*     */     
...
/*     */     } else {
/* 132 */       source.sendSuccess(() -> Component.translatable("commands.teleport.success.location.multiple", new Object[] { entities.size(), formatDouble(pos.x), formatDouble(pos.y), formatDouble(pos.z) }), true);
/*     */     } 
/*     */     
...
/* 140 */     Set<Relative> pos = sameDimension ? Relative.position(destination.isXRelative(), destination.isYRelative(), destination.isZRelative()) : Set.<Relative>of();
...
/* 146 */     return String.format(Locale.ROOT, "%f", new Object[] { value });
/*     */   }
/*     */   
/*     */   private static void performTeleport(CommandSourceStack source, Entity victim, ServerLevel level, double x, double y, double z, Set<Relative> relatives, float yRot, float xRot, LookAt lookAt) throws CommandSyntaxException {
/*     */     // Byte code:
/*     */     //   0: dload_3
/*     */     //   1: dload #5
/*     */     //   3: dload #7
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/TeleportCommand.class
