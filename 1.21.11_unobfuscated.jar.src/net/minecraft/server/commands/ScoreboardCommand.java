...
/*  73 */     ERROR_NO_VALUE = new Dynamic2CommandExceptionType((objective, target) -> Component.translatableEscape("commands.scoreboard.players.get.null", new Object[] { objective, target }));
/*     */   }
...
/*  91 */                 .executes(c -> addObjective((CommandSourceStack)c.getSource(), StringArgumentType.getString(c, "objective"), ObjectiveCriteriaArgument.getCriteria(c, "criteria"), (Component)Component.literal(StringArgumentType.getString(c, "objective")))))
/*  92 */                 .then(
/*  93 */                   Commands.argument("displayName", (ArgumentType)ComponentArgument.textComponent(context))
...
/* 105 */                 .then(
/* 106 */                   Commands.argument("displayName", (ArgumentType)ComponentArgument.textComponent(context))
...
/*     */               
/* 117 */               .then(
/* 118 */                 addNumberFormats(context, (ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("numberformat"), (c, numberFormat) -> setObjectiveFormat((CommandSourceStack)c.getSource(), ObjectiveArgument.getObjective(c, "objective"), numberFormat))))))
/*     */ 
/*     */ 
/*     */           
/* 122 */           .then(
...
/* 238 */                   .then(
/* 239 */                     Commands.argument("name", (ArgumentType)ComponentArgument.textComponent(context))
...
/* 251 */                 .then(
/* 252 */                   addNumberFormats(context, (ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("objective", (ArgumentType)ObjectiveArgument.objective()), (c, format) -> setScoreNumberFormat((CommandSourceStack)c.getSource(), ScoreHolderArgument.getNamesWithDefaultWildcard(c, "targets"), ObjectiveArgument.getObjective(c, "objective"), format)))))))
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 293 */         .executes(c -> callback.run(c, (NumberFormat)BlankFormat.INSTANCE)))
/*     */       
/* 295 */       .then(
/* 296 */         Commands.literal("fixed")
/* 297 */         .then(
/* 298 */           Commands.argument("contents", (ArgumentType)ComponentArgument.textComponent(context))
/* 299 */           .executes(c -> {
/*     */               Component contents = ComponentArgument.getResolvedComponent(c, "contents");
/*     */ 
/*     */ 
/*     */               
/*     */               return callback.run(c, (NumberFormat)new FixedFormat(contents));
/* 305 */             }))).then(
/* 306 */         Commands.literal("styled")
/* 307 */         .then(
/* 308 */           Commands.argument("style", (ArgumentType)StyleArgument.style(context))
/* 309 */           .executes(c -> {
/*     */               Style style = StyleArgument.getStyle(c, "style");
/*     */ 
/*     */ 
/*     */               
/*     */               return callback.run(c, (NumberFormat)new StyledFormat(style));
/* 315 */             }))).executes(c -> callback.run(c, null));
/*     */   }
/*     */   
/*     */   private static LiteralArgumentBuilder<CommandSourceStack> createRenderTypeModify() {
/* 319 */     LiteralArgumentBuilder<CommandSourceStack> result = Commands.literal("rendertype");
/*     */     
...
/*     */     
/* 333 */     for (Objective objective : (Iterable<Objective>)serverScoreboard.getObjectives()) {
...
/*     */     }
/*     */     
/* 361 */     source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.get.success", new Object[] { target.getFeedbackDisplayName(), score.value(), objective.getFormattedDisplayName() }), false);
/*     */     
/* 363 */     return score.value();
/*     */   }
/*     */   
/*     */   private static Component getFirstTargetName(Collection<ScoreHolder> names) {
/* 367 */     return ((ScoreHolder)names.iterator().next()).getFeedbackDisplayName();
/*     */   }
/*     */   
...
/* 385 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.operation.success.single", new Object[] { targetObjective.getFormattedDisplayName(), getFirstTargetName(targets), finalResult }), true);
/*     */     } else {
/* 387 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.operation.success.multiple", new Object[] { targetObjective.getFormattedDisplayName(), targets.size() }), true);
/*     */     } 
/*     */     
/* 390 */     return result;
/*     */   }
...
/*     */     } else {
/* 416 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.enable.success.multiple", new Object[] { objective.getFormattedDisplayName(), names.size() }), true);
/*     */     } 
/*     */     
/* 419 */     return count;
/*     */   }
...
/*     */     } else {
/* 432 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.reset.all.multiple", new Object[] { names.size() }), true);
/*     */     } 
/*     */     
...
/*     */     } else {
/* 448 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.reset.specific.multiple", new Object[] { objective.getFormattedDisplayName(), names.size() }), true);
/*     */     } 
/*     */     
...
/*     */     
/* 461 */     if (names.size() == 1) {
/* 462 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.set.success.single", new Object[] { objective.getFormattedDisplayName(), getFirstTargetName(names), value }), true);
/*     */     } else {
/* 464 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.set.success.multiple", new Object[] { objective.getFormattedDisplayName(), names.size(), value }), true);
/*     */     } 
/*     */     
...
/*     */       } else {
/* 481 */         source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.display.name.clear.success.multiple", new Object[] { names.size(), objective.getFormattedDisplayName() }), true);
/*     */       }
/*     */     
...
/*     */     } else {
/* 487 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.display.name.set.success.multiple", new Object[] { display, names.size(), objective.getFormattedDisplayName() }), true);
/*     */     } 
/*     */ 
/*     */     
...
/*     */       } else {
/* 505 */         source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.display.numberFormat.clear.success.multiple", new Object[] { names.size(), objective.getFormattedDisplayName() }), true);
/*     */       }
/*     */     
...
/*     */     } else {
/* 511 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.display.numberFormat.set.success.multiple", new Object[] { names.size(), objective.getFormattedDisplayName() }), true);
/*     */     } 
/*     */ 
/*     */     
...
/* 530 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.add.success.single", new Object[] { value, objective.getFormattedDisplayName(), getFirstTargetName(names), finalResult }), true);
/*     */     } else {
/* 532 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.add.success.multiple", new Object[] { value, objective.getFormattedDisplayName(), names.size() }), true);
/*     */     } 
/*     */     
/* 535 */     return result;
/*     */   }
...
/* 550 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.remove.success.single", new Object[] { value, objective.getFormattedDisplayName(), getFirstTargetName(names), finalResult }), true);
/*     */     } else {
/* 552 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.remove.success.multiple", new Object[] { value, objective.getFormattedDisplayName(), names.size() }), true);
/*     */     } 
/*     */     
/* 555 */     return result;
/*     */   }
...
/*     */     } else {
/* 564 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.list.success", new Object[] { entities.size(), ComponentUtils.formatList(entities, ScoreHolder::getFeedbackDisplayName) }), false);
/*     */     } 
/*     */     
...
/*     */     } else {
/* 576 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.players.list.entity.success", new Object[] { entity.getFeedbackDisplayName(), scores.size() }), false);
/*     */       
/* 578 */       Object2IntMaps.fastForEach(scores, entry -> source.sendSuccess((), false));
/*     */     } 
/*     */ 
/*     */ 
/*     */     
...
/*     */     } else {
/* 681 */       source.sendSuccess(() -> Component.translatable("commands.scoreboard.objectives.list.success", new Object[] { objectives.size(), ComponentUtils.formatList(objectives, Objective::getFormattedDisplayName) }), false);
/*     */     } 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/ScoreboardCommand.class
