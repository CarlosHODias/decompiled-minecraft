...
/*  99 */       source.sendFailure((Component)Component.literal("Chase server is already running. Stop it using /chase stop"));
/* 100 */       return true;
/*     */     } 
/* 102 */     if (chaseClient != null) {
/* 103 */       source.sendFailure((Component)Component.literal("You are already chasing someone. Stop it using /chase stop"));
/* 104 */       return true;
/*     */     } 
/* 106 */     return false;
/*     */   }
...
/* 120 */       source.sendFailure((Component)Component.literal("Failed to start chase server on port " + port));
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/ChaseCommand.class
