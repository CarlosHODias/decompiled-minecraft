...
/* 28 */   private static final Style SUGGEST_STYLE = Style.EMPTY.withHoverEvent((HoverEvent)new HoverEvent.ShowText((Component)Component.translatable("chat.type.team.hover")))
...
/* 36 */         .then(
/* 37 */           Commands.argument("message", (com.mojang.brigadier.arguments.ArgumentType)MessageArgument.message())
/* 38 */           .executes(c -> {
...
/*    */               }
/*    */               
/*    */               List<ServerPlayer> receivers = source.getServer().getPlayerList().getPlayers().stream().filter(()).toList();
/*    */               
...
/*    */             })));
/*    */     
/* 60 */     dispatcher.register((LiteralArgumentBuilder)Commands.literal("tm").redirect((CommandNode)msg));
/*    */   }
/*    */   
...
/* 65 */     ChatType.Bound incomingChatType = ChatType.bind(ChatType.TEAM_MSG_COMMAND_INCOMING, source).withTargetName((Component)mutableComponent);
/* 66 */     ChatType.Bound outgoingChatType = ChatType.bind(ChatType.TEAM_MSG_COMMAND_OUTGOING, source).withTargetName((Component)mutableComponent);
...
/*    */       
/* 77 */       wasFullyFiltered |= (filtered && message.isFullyFiltered()) ? true : false;
/*    */     } 
/*    */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/TeamMsgCommand.class
