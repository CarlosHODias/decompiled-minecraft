...
/*    */     
/* 13 */     public LookAtEntity(Entity entity, net.minecraft.commands.arguments.EntityAnchorArgument.Anchor anchor) { this.entity = entity; this.anchor = anchor; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 13 */       //   0	8	1	o	Ljava/lang/Object; } public net.minecraft.commands.arguments.EntityAnchorArgument.Anchor anchor() { return this.anchor; }
/*    */     
/*    */     public void perform(CommandSourceStack source, Entity target) {
/* 16 */       if (target instanceof net.minecraft.server.level.ServerPlayer) { net.minecraft.server.level.ServerPlayer targetPlayer = (net.minecraft.server.level.ServerPlayer)target;
...
/*    */     
/*    */     } }
/*    */   public static final class LookAtPosition extends Record implements LookAt { private final net.minecraft.world.phys.Vec3 position;
/*    */     
/* 24 */     public LookAtPosition(net.minecraft.world.phys.Vec3 position) { this.position = position; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 24 */       //   0	8	1	o	Ljava/lang/Object; } public net.minecraft.world.phys.Vec3 position() { return this.position; }
/*    */     
/*    */     public void perform(CommandSourceStack source, Entity target) {
/* 27 */       target.lookAt(source.getAnchor(), this.position);
/*    */     } }
/*    */ 
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/LookAt.class
