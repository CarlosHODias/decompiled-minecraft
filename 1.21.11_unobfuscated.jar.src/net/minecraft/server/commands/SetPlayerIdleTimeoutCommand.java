...
/* 27 */     if (time > 0) {
/* 28 */       source.sendSuccess(() -> Component.translatable("commands.setidletimeout.success", new Object[] { time }), true);
/*    */     } else {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/SetPlayerIdleTimeoutCommand.class
