...
/*  44 */           .executes(c -> clearEffects((CommandSourceStack)c.getSource(), (Collection<? extends Entity>)ImmutableList.of(((CommandSourceStack)c.getSource()).getEntityOrException()))))
/*  45 */           .then((
...
/*  48 */             .then(
/*  49 */               Commands.argument("effect", (ArgumentType)ResourceArgument.resource(context, Registries.MOB_EFFECT))
/*  50 */               .executes(c -> clearEffect((CommandSourceStack)c.getSource(), EntityArgument.getEntities(c, "targets"), (Holder<MobEffect>)ResourceArgument.getMobEffect(c, "effect")))))))
/*     */ 
/*     */ 
/*     */         
/*  54 */         .then(
...
/*  58 */             .then((
/*  59 */               (RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("effect", (ArgumentType)ResourceArgument.resource(context, Registries.MOB_EFFECT))
/*  60 */               .executes(c -> giveEffect((CommandSourceStack)c.getSource(), EntityArgument.getEntities(c, "targets"), (Holder<MobEffect>)ResourceArgument.getMobEffect(c, "effect"), null, 0, true)))
/*  61 */               .then((
/*  62 */                 (RequiredArgumentBuilder)Commands.argument("seconds", (ArgumentType)IntegerArgumentType.integer(1, 1000000))
/*  63 */                 .executes(c -> giveEffect((CommandSourceStack)c.getSource(), EntityArgument.getEntities(c, "targets"), (Holder<MobEffect>)ResourceArgument.getMobEffect(c, "effect"), IntegerArgumentType.getInteger(c, "seconds"), 0, true)))
/*  64 */                 .then((
/*  65 */                   (RequiredArgumentBuilder)Commands.argument("amplifier", (ArgumentType)IntegerArgumentType.integer(0, 255))
/*  66 */                   .executes(c -> giveEffect((CommandSourceStack)c.getSource(), EntityArgument.getEntities(c, "targets"), (Holder<MobEffect>)ResourceArgument.getMobEffect(c, "effect"), IntegerArgumentType.getInteger(c, "seconds"), IntegerArgumentType.getInteger(c, "amplifier"), true)))
/*  67 */                   .then(
/*  68 */                     Commands.argument("hideParticles", (ArgumentType)BoolArgumentType.bool())
/*  69 */                     .executes(c -> giveEffect((CommandSourceStack)c.getSource(), EntityArgument.getEntities(c, "targets"), (Holder<MobEffect>)ResourceArgument.getMobEffect(c, "effect"), IntegerArgumentType.getInteger(c, "seconds"), IntegerArgumentType.getInteger(c, "amplifier"), !BoolArgumentType.getBool(c, "hideParticles")))))))
/*     */ 
/*     */ 
/*     */               
/*  73 */               .then((
/*  74 */                 (LiteralArgumentBuilder)Commands.literal("infinite")
/*  75 */                 .executes(c -> giveEffect((CommandSourceStack)c.getSource(), EntityArgument.getEntities(c, "targets"), (Holder<MobEffect>)ResourceArgument.getMobEffect(c, "effect"), -1, 0, true)))
/*  76 */                 .then((
/*  77 */                   (RequiredArgumentBuilder)Commands.argument("amplifier", (ArgumentType)IntegerArgumentType.integer(0, 255))
/*  78 */                   .executes(c -> giveEffect((CommandSourceStack)c.getSource(), EntityArgument.getEntities(c, "targets"), (Holder<MobEffect>)ResourceArgument.getMobEffect(c, "effect"), -1, IntegerArgumentType.getInteger(c, "amplifier"), true)))
/*  79 */                   .then(
/*  80 */                     Commands.argument("hideParticles", (ArgumentType)BoolArgumentType.bool())
/*  81 */                     .executes(c -> giveEffect((CommandSourceStack)c.getSource(), EntityArgument.getEntities(c, "targets"), (Holder<MobEffect>)ResourceArgument.getMobEffect(c, "effect"), -1, IntegerArgumentType.getInteger(c, "amplifier"), !BoolArgumentType.getBool(c, "hideParticles"))))))))));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  98 */         duration = seconds;
/*  99 */       } else if (seconds == -1) {
/* 100 */         duration = -1;
/*     */       } else {
/* 102 */         duration = seconds * 20;
/*     */       }
/*     */     
...
/* 126 */       source.sendSuccess(() -> Component.translatable("commands.effect.give.success.single", new Object[] { effect.getDisplayName(), ((Entity)entities.iterator().next()).getDisplayName(), duration / 20 }), true);
/*     */     } else {
/* 128 */       source.sendSuccess(() -> Component.translatable("commands.effect.give.success.multiple", new Object[] { effect.getDisplayName(), entities.size(), duration / 20 }), true);
/*     */     } 
/*     */     
/* 131 */     return count;
/*     */   }
...
/*     */     } else {
/* 152 */       source.sendSuccess(() -> Component.translatable("commands.effect.clear.everything.success.multiple", new Object[] { entities.size() }), true);
/*     */     } 
/*     */     
/* 155 */     return count;
/*     */   }
...
/*     */     } else {
/* 177 */       source.sendSuccess(() -> Component.translatable("commands.effect.clear.specific.success.multiple", new Object[] { effect.getDisplayName(), entities.size() }), true);
/*     */     } 
/*     */     
/* 180 */     return count;
/*     */   }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/EffectCommands.class
