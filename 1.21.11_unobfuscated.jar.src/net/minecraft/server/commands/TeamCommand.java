...
/*  67 */             .then(
/*  68 */               Commands.argument("displayName", (ArgumentType)ComponentArgument.textComponent(context))
...
/*  91 */             .executes(c -> joinTeam((CommandSourceStack)c.getSource(), TeamArgument.getTeam(c, "team"), (Collection)Collections.singleton(((CommandSourceStack)c.getSource()).getEntityOrException()))))
/*  92 */             .then(
...
/* 113 */               .then(
/* 114 */                 Commands.argument("displayName", (ArgumentType)ComponentArgument.textComponent(context))
...
/* 162 */               .then(
/* 163 */                 Commands.argument("prefix", (ArgumentType)ComponentArgument.textComponent(context))
...
/* 169 */               .then(
/* 170 */                 Commands.argument("suffix", (ArgumentType)ComponentArgument.textComponent(context))
...
/* 180 */     return ((ScoreHolder)members.iterator().next()).getFeedbackDisplayName();
/*     */   }
/*     */   
...
/*     */     } else {
/* 193 */       source.sendSuccess(() -> Component.translatable("commands.team.leave.success.multiple", new Object[] { members.size() }), true);
/*     */     } 
/*     */     
...
/*     */     } else {
/* 209 */       source.sendSuccess(() -> Component.translatable("commands.team.join.success.multiple", new Object[] { members.size(), team.getFormattedDisplayName() }), true);
/*     */     } 
/*     */     
...
/*     */     }
/*     */     
/* 303 */     source.sendSuccess(() -> Component.translatable("commands.team.empty.success", new Object[] { members.size(), team.getFormattedDisplayName() }), true);
/*     */     
...
/* 316 */     return createTeam(source, name, (Component)Component.literal(name));
/*     */   }
/*     */   
...
/*     */     } else {
/* 338 */       source.sendSuccess(() -> Component.translatable("commands.team.list.members.success", new Object[] { team.getFormattedDisplayName(), members.size(), ComponentUtils.formatList(members) }), false);
/*     */     } 
...
/*     */     } else {
/* 348 */       source.sendSuccess(() -> Component.translatable("commands.team.list.teams.success", new Object[] { teams.size(), ComponentUtils.formatList(teams, PlayerTeam::getFormattedDisplayName) }), false);
/*     */     } 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/TeamCommand.class
