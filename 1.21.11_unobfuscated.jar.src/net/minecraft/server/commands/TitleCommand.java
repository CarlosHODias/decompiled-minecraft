...
/*  47 */             .then(
/*  48 */               Commands.argument("title", (ArgumentType)ComponentArgument.textComponent(context))
...
/*  54 */             .then(
/*  55 */               Commands.argument("title", (ArgumentType)ComponentArgument.textComponent(context))
...
/*  61 */             .then(
/*  62 */               Commands.argument("title", (ArgumentType)ComponentArgument.textComponent(context))
...
/*  86 */       player.connection.send((Packet)packet);
/*     */     }
/*     */     
...
/*     */     } else {
/*  92 */       source.sendSuccess(() -> Component.translatable("commands.title.cleared.multiple", new Object[] { targets.size() }), true);
/*     */     } 
/*     */     
...
/* 101 */       player.connection.send((Packet)packet);
/*     */     }
/*     */     
...
/*     */     } else {
/* 107 */       source.sendSuccess(() -> Component.translatable("commands.title.reset.multiple", new Object[] { targets.size() }), true);
/*     */     } 
/*     */     
...
/* 115 */       player.connection.send(factory.apply(ComponentUtils.updateForEntity(source, title, (Entity)player, 0)));
/*     */     }
/*     */     
...
/*     */     } else {
/* 121 */       source.sendSuccess(() -> Component.translatable("commands.title.show." + type + ".multiple", new Object[] { targets.size() }), true);
/*     */     } 
/*     */     
...
/* 130 */       player.connection.send((Packet)packet);
/*     */     }
/*     */     
...
/*     */     } else {
/* 136 */       source.sendSuccess(() -> Component.translatable("commands.title.times.multiple", new Object[] { targets.size() }), true);
/*     */     } 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/commands/TitleCommand.class
