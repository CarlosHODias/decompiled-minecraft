...
/*  21 */     return new Positioned(center, radius);
/*     */   }
/*     */   
...
/*  55 */     return contains(pos.x, pos.z);
/*     */   }
/*     */   
/*     */   default boolean contains(int x, int z) {
/*  59 */     return contains(x, z, true);
/*     */   }
/*     */   
...
/*  67 */     return contains(chunkX, chunkZ, false);
/*     */   }
/*     */   
/*     */   static boolean isInViewDistance(int centerX, int centerZ, int viewDistance, int chunkX, int chunkZ) {
/*  71 */     return isWithinDistance(centerX, centerZ, viewDistance, chunkX, chunkZ, false);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */      private int minX() {
/*  89 */       return this.center.x - this.viewDistance - 1;
/*     */     }
/*     */     
/*     */     private int minZ() {
/*  93 */       return this.center.z - this.viewDistance - 1;
/*     */     }
/*     */     
/*     */     private int maxX() {
/*  97 */       return this.center.x + this.viewDistance + 1;
/*     */     }
/*     */     
/*     */     private int maxZ() {
/* 101 */       return this.center.z + this.viewDistance + 1;
/*     */     }
/*     */     
/*     */     @VisibleForTesting
...
/*     */     
/*     */     public boolean contains(int chunkX, int chunkZ, boolean includeNeighbors) {
/* 114 */       return ChunkTrackingView.isWithinDistance(this.center.x, this.center.z, this.viewDistance, chunkX, chunkZ, includeNeighbors);
/*     */     }
/*     */ 
/*     */     
/*     */     public void forEach(Consumer<ChunkPos> consumer) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/level/ChunkTrackingView.class
