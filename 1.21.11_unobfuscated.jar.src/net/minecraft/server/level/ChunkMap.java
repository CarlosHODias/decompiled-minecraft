...
/*  138 */   private volatile Long2ObjectLinkedOpenHashMap<ChunkHolder> visibleChunkMap = this.updatingChunkMap.clone();
/*      */ 
/*      */ 
/*      */   
...
/*  157 */   private final LongSet toDrop = (LongSet)new LongOpenHashSet();
/*      */   
...
/*  169 */   private final Int2ObjectMap<TrackedEntity> entityMap = (Int2ObjectMap<TrackedEntity>)new Int2ObjectOpenHashMap();
/*      */   
/*  171 */   private final Long2ByteMap chunkTypeCache = (Long2ByteMap)new Long2ByteOpenHashMap();
/*  172 */   private final Long2LongMap nextChunkSaveTime = (Long2LongMap)new Long2LongOpenHashMap();
/*      */   
/*  174 */   private final LongSet chunksToEagerlySave = (LongSet)new LongLinkedOpenHashSet();
...
/*  196 */     super(new RegionStorageInfo(
/*  197 */           levelStorage.getLevelId(), level.dimension(), "chunk"), 
/*  198 */         levelStorage.getDimensionPath(level.dimension()).resolve("region"), dataFixer, syncWrites, DataFixTypes.CHUNK, 
/*      */ 
/*      */ 
/*      */         
...
/*  210 */       this.randomState = RandomState.create((NoiseGeneratorSettings)noiseGenerator.generatorSettings().value(), (HolderGetter)registryAccess.lookupOrThrow(Registries.NOISE), levelSeed); }
/*      */     
/*      */     else
/*      */     
/*  214 */     { this.randomState = RandomState.create(NoiseGeneratorSettings.dummy(), (HolderGetter)registryAccess.lookupOrThrow(Registries.NOISE), levelSeed); }
/*      */     
/*  216 */     this.chunkGeneratorState = generator.createState((HolderLookup)registryAccess.lookupOrThrow(Registries.STRUCTURE_SET), this.randomState, levelSeed);
...
/*      */     
/*  223 */     this.worldgenTaskDispatcher = new ChunkTaskDispatcher((TaskScheduler<Runnable>)worldgen, executor);
/*  224 */     this.lightTaskDispatcher = new ChunkTaskDispatcher((TaskScheduler<Runnable>)light, executor);
/*      */     
...
/*      */     
/*  228 */     this.distanceManager = new DistanceManager(ticketStorage, executor, (Executor)mainThreadExecutor);
/*  229 */     this.ticketStorage = ticketStorage;
/*  230 */     this.poiManager = new PoiManager(new RegionStorageInfo(levelStorage.getLevelId(), level.dimension(), "poi"), storageFolder.resolve("poi"), dataFixer, syncWrites, registryAccess, (ChunkIOErrorReporter)level.getServer(), (LevelHeightAccessor)level);
/*      */     
/*  232 */     setServerViewDistance(serverViewDistance);
/*      */     
/*  234 */     this.worldGenContext = new WorldGenContext(level, generator, structureManager, this.lightEngine, (Executor)mainThreadExecutor, this::setChunkUnsaved);
/*      */   }
/*      */   
/*      */   private void setChunkUnsaved(ChunkPos chunkPos) {
/*  238 */     this.chunksToEagerlySave.add(chunkPos.toLong());
/*      */   }
/*      */   
/*      */   protected ChunkGenerator generator() {
/*  242 */     return this.worldGenContext.generator();
/*      */   }
/*      */   
/*      */   protected ChunkGeneratorStructureState generatorState() {
/*  246 */     return this.chunkGeneratorState;
/*      */   }
/*      */   
/*      */   protected RandomState randomState() {
/*  250 */     return this.randomState;
/*      */   }
/*      */   
/*      */   public boolean isChunkTracked(ServerPlayer player, int chunkX, int chunkZ) {
/*  254 */     return (player.getChunkTrackingView().contains(chunkX, chunkZ) && !player.connection.chunkSender.isPending(ChunkPos.asLong(chunkX, chunkZ)));
/*      */   }
/*      */ 
/*      */   
...
/*  276 */     return this.lightEngine;
/*      */   }
/*      */   
/*      */   public ChunkHolder getUpdatingChunkIfPresent(long key) {
/*  280 */     return (ChunkHolder)this.updatingChunkMap.get(key);
/*      */   }
/*      */   
/*      */   protected ChunkHolder getVisibleChunkIfPresent(long key) {
/*  284 */     return (ChunkHolder)this.visibleChunkMap.get(key);
/*      */   }
/*      */   
...
/*  322 */     if (range == 0) {
/*  323 */       ChunkStatus status = distanceToStatus.apply(0);
...
/*  328 */     List<CompletableFuture<ChunkResult<ChunkAccess>>> deps = new ArrayList<>(chunkCount);
...
/*      */         }
/*  338 */         ChunkStatus depStatus = distanceToStatus.apply(distance);
...
/*      */           for (ChunkResult<ChunkAccess> chunkResult : (Iterable<ChunkResult<ChunkAccess>>)chunkResults) {
/*      */             if (chunkResult == null) {
...
/*      */ 
/*      */     
/*      */     Consumer<ChunkHolder> addToDebug = holder -> holder.getAllFutures().forEach(());
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*      */       } else {
/*  411 */         chunk = new ChunkHolder(new ChunkPos(node), level, (LevelHeightAccessor)this.level, this.lightEngine, this::onLevelChange, this);
/*      */       } 
...
/*  438 */     if (flushStorage) {
/*  439 */       List<ChunkHolder> chunksToSave = this.visibleChunkMap.values().stream()
/*  440 */         .filter(ChunkHolder::wasAccessibleSinceLastSave)
/*  441 */         .peek(ChunkHolder::refreshAccessibility)
/*  442 */         .toList();
/*      */ 
/*      */       
...
/*  465 */       for (ObjectIterator<ChunkHolder> objectIterator = this.visibleChunkMap.values().iterator(); objectIterator.hasNext(); ) { ChunkHolder chunk = objectIterator.next();
...
/*  485 */       !this.updatingChunkMap.isEmpty() || 
/*  486 */       this.poiManager.hasWork() || 
/*  487 */       !this.toDrop.isEmpty() || 
/*  488 */       !this.unloadQueue.isEmpty() || 
/*  489 */       this.worldgenTaskDispatcher.hasWork() || 
/*  490 */       this.lightTaskDispatcher.hasWork() || 
/*  491 */       this.distanceManager.hasTickets());
/*      */   }
/*      */   
...
/*  511 */     while ((minimalNumberOfChunksToProcess > 0 || haveTime.getAsBoolean()) && (unloadTask = this.unloadQueue.poll()) != null) {
...
/*  525 */     while (eagerlySavedCount < 20 && 
/*      */       
/*  527 */       this.activeChunkWrites.get() < 128 && 
/*  528 */       haveTime.getAsBoolean() && 
/*  529 */       iterator.hasNext()) {
/*      */       
...
/*  595 */     CompletableFuture<Optional<SerializableChunkData>> chunkDataFuture = readChunk(pos)
/*  596 */       .thenApplyAsync(chunkData -> pos.map(()), 
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */           
/*      */           if (pos.isPresent()) {
/*      */             ProtoChunk protoChunk = ((SerializableChunkData)pos.get()).read(this.level, this.poiManager, storageInfo(), pos);
/*      */             markPosition(pos, protoChunk.getPersistedStatus().getChunkType());
/*      */             return protoChunk;
/*      */           } 
/*      */           return createEmptyChunk(pos);
/*  615 */         }, (Executor)this.mainThreadExecutor).exceptionallyAsync(throwable -> handleChunkLoadFailure(pos, pos), (Executor)this.mainThreadExecutor);
/*      */   }
/*      */   
...
/*  620 */     ReportedException reportedException = (ReportedException)unwrapped; Throwable cause = (unwrapped instanceof ReportedException) ? reportedException.getCause() : unwrapped;
...
/*  637 */     return (ChunkAccess)new ProtoChunk(pos, UpgradeData.EMPTY, (LevelHeightAccessor)this.level, this.level.palettedContainerFactory(), null);
/*      */   }
/*      */   
/*      */   private void markPositionReplaceable(ChunkPos pos) {
/*  641 */     this.chunkTypeCache.put(pos.toLong(), (byte)-1);
/*      */   }
/*      */   
/*      */   private byte markPosition(ChunkPos pos, ChunkType type) {
/*  645 */     return this.chunkTypeCache.put(pos.toLong(), (byte)((type == ChunkType.PROTOCHUNK) ? -1 : 1));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  665 */     chunkHolder.decreaseGenerationRefCount();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  691 */       category.setDetail("Location", String.format(Locale.ROOT, "%d,%d", new Object[] { pos.x, pos.z }));
/*  692 */       category.setDetail("Position hash", ChunkPos.asLong(pos.x, pos.z));
...
/*      */     
/*  736 */     return future.thenApplyAsync(listResult -> chunk.map(()), (Executor)this.mainThreadExecutor);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  822 */       Objects.requireNonNull(data); CompletableFuture<CompoundTag> encodedData = CompletableFuture.supplyAsync(data::write, (Executor)Util.backgroundExecutor());
...
/*      */     
/*      */     try {
/*  846 */       currentTag = ((Optional<CompoundTag>)readChunk(pos).join()).orElse(null);
...
/*  873 */     return Mth.clamp(player.requestedViewDistance(), 2, this.serverViewDistance);
/*      */   }
/*      */   
...
/*  884 */     player.connection.chunkSender.markChunkPendingToSend(chunk);
/*      */   }
/*      */   
/*      */   private static void dropChunk(ServerPlayer player, ChunkPos pos) {
/*  888 */     player.connection.chunkSender.dropChunk(player, pos);
/*      */   }
/*      */   
...
/*      */   
/*      */   public int size() {
/*  900 */     return this.visibleChunkMap.size();
/*      */   }
/*      */   
/*      */   public DistanceManager getDistanceManager() {
/*  904 */     return this.distanceManager;
/*      */   }
/*      */   
/*      */   void dumpChunks(Writer output) throws IOException {
/*  908 */     CsvOutput csvOutput = CsvOutput.builder()
/*  909 */       .addColumn("x")
/*  910 */       .addColumn("z")
/*  911 */       .addColumn("level")
/*  912 */       .addColumn("in_memory")
/*  913 */       .addColumn("status")
/*  914 */       .addColumn("full_status")
/*  915 */       .addColumn("accessible_ready")
/*  916 */       .addColumn("ticking_ready")
/*  917 */       .addColumn("entity_ticking_ready")
/*  918 */       .addColumn("ticket")
/*  919 */       .addColumn("spawning")
/*  920 */       .addColumn("block_entity_count")
/*  921 */       .addColumn("ticking_ticket")
/*  922 */       .addColumn("ticking_level")
/*  923 */       .addColumn("block_ticks")
/*  924 */       .addColumn("fluid_ticks")
/*  925 */       .build(output);
/*      */     
/*  927 */     for (ObjectBidirectionalIterator<Long2ObjectMap.Entry<ChunkHolder>> objectBidirectionalIterator = this.visibleChunkMap.long2ObjectEntrySet().iterator(); objectBidirectionalIterator.hasNext(); ) { Long2ObjectMap.Entry<ChunkHolder> entry = objectBidirectionalIterator.next();
...
/*  932 */       Optional<LevelChunk> fullChunk = chunk.flatMap(chunkAccess -> (chunkAccess instanceof LevelChunk) ? Optional.<LevelChunk>of((LevelChunk)chunkAccess) : Optional.empty());
/*  933 */       csvOutput.writeRow(new Object[] { pos.x, 
/*  934 */             pos.z, 
/*      */             
/*  936 */             holder.getTicketLevel(), 
/*  937 */             chunk.isPresent(), 
/*  938 */             chunk.map(ChunkAccess::getPersistedStatus).orElse(null), 
/*  939 */             fullChunk.map(LevelChunk::getFullStatus).orElse(null), 
/*  940 */             printFuture(holder.getFullChunkFuture()), 
/*  941 */             printFuture(holder.getTickingChunkFuture()), 
/*  942 */             printFuture(holder.getEntityTickingChunkFuture()), 
/*  943 */             this.ticketStorage.getTicketDebugString(posKey, false), 
/*  944 */             anyPlayerCloseEnoughForSpawning(pos), 
/*  945 */             fullChunk.<Integer>map(c -> c.getBlockEntities().size()).orElse(0), 
/*  946 */             this.ticketStorage.getTicketDebugString(posKey, true), 
/*  947 */             this.distanceManager.getChunkLevel(posKey, true), 
/*  948 */             fullChunk.<Integer>map(levelChunk -> levelChunk.getBlockTicks().count()).orElse(0), 
/*  949 */             fullChunk.<Integer>map(levelChunk -> levelChunk.getFluidTicks().count()).orElse(0) }); }
/*      */   
/*      */   }
/*      */ 
/*      */   
...
/*      */     try {
/*  956 */       ChunkResult<LevelChunk> result = future.getNow(null);
/*  957 */       if (result != null) {
...
/*  970 */     return read(pos).thenApplyAsync(chunkTag -> chunkTag.map(this::upgradeChunkTag), Util.backgroundExecutor().forName("upgradeChunk"));
/*      */   }
/*      */   
/*      */   private CompoundTag upgradeChunkTag(CompoundTag tag) {
/*  974 */     return upgradeChunkTag(tag, -1, getChunkDataFixContextTag(this.level.dimension(), generator().getTypeNameForDataFixer()));
/*      */   }
/*      */   
...
/*      */           ChunkHolder holder = (ChunkHolder)this.visibleChunkMap.get(tickingChunkConsumer);
/*      */           if (holder == null) {
/*      */             return;
/*      */           }
...
/* 1027 */     Vec3 target = new Vec3((Vec3i)pos);
...
/*      */       }
/*      */     } 
/* 1059 */     return (List<ServerPlayer>)builder.build();
/*      */   }
/*      */   
...
/* 1089 */     return (player.isSpectator() && !((Boolean)this.level.getGameRules().get(GameRules.SPECTATORS_GENERATE_CHUNKS)));
/*      */   }
/*      */   
...
/*      */       
/* 1099 */       if (!ignored) {
/* 1100 */         this.distanceManager.addPlayer(SectionPos.of((EntityAccess)player), player);
/*      */       }
...
/* 1115 */     SectionPos pos = SectionPos.of((EntityAccess)player);
/* 1116 */     player.setLastSectionPos(pos);
/*      */   }
/*      */   
/*      */   public void move(ServerPlayer player) {
/* 1120 */     for (ObjectIterator<TrackedEntity> objectIterator = this.entityMap.values().iterator(); objectIterator.hasNext(); ) { TrackedEntity trackedEntity = objectIterator.next();
...
/* 1129 */     SectionPos newSection = SectionPos.of((EntityAccess)player);
/*      */     
...
/*      */       }
/*      */     } 
/* 1196 */     return (List<ServerPlayer>)result.build();
/*      */   }
/*      */ 
/*      */   
...
/* 1219 */       for (ObjectIterator<TrackedEntity> objectIterator = this.entityMap.values().iterator(); objectIterator.hasNext(); ) { TrackedEntity e = objectIterator.next();
...
/* 1230 */       for (ObjectIterator<TrackedEntity> objectIterator = this.entityMap.values().iterator(); objectIterator.hasNext(); ) { TrackedEntity trackedEntity1 = objectIterator.next();
/* 1231 */         trackedEntity1.removePlayer(player); }
/*      */        }
/*      */     
...
/*      */     
/* 1249 */     for (ObjectIterator<TrackedEntity> objectIterator = this.entityMap.values().iterator(); objectIterator.hasNext(); ) { TrackedEntity trackedEntity = objectIterator.next();
/* 1250 */       SectionPos oldPos = trackedEntity.lastSectionPos;
/* 1251 */       SectionPos newPos = SectionPos.of((EntityAccess)trackedEntity.entity);
...
/* 1267 */       for (ObjectIterator<TrackedEntity> objectIterator1 = this.entityMap.values().iterator(); objectIterator1.hasNext(); ) { TrackedEntity trackedEntity = objectIterator1.next();
...
/* 1303 */     for (ObjectIterator<TrackedEntity> objectIterator = this.entityMap.values().iterator(); objectIterator.hasNext(); ) { TrackedEntity entity = objectIterator.next();
...
/* 1311 */     Map<ServerPlayer, List<LevelChunk>> chunksForPlayers = new HashMap<>();
...
/* 1321 */         ((List<LevelChunk>)chunksForPlayers.computeIfAbsent(player, p -> new ArrayList())).add(chunk);
/*      */       }
/*      */     } 
/*      */     
/* 1325 */     chunksForPlayers.forEach((player, chunkList) -> player.connection.send((Packet)ClientboundChunksBiomesPacket.forChunks(chunkList)));
/*      */   }
/*      */   
/*      */   protected PoiManager getPoiManager() {
/* 1329 */     return this.poiManager;
/*      */   }
/*      */   
/*      */   public String getStorageName() {
/* 1333 */     return this.storageName;
/*      */   }
/*      */   
/*      */   void onFullChunkStatusChange(ChunkPos pos, FullChunkStatus status) {
/* 1337 */     this.chunkStatusListener.onChunkStatusChange(pos, status);
/*      */   }
/*      */   
...
/* 1351 */     for (ObjectIterator<ChunkHolder> objectIterator = this.visibleChunkMap.values().iterator(); objectIterator.hasNext(); ) { ChunkHolder chunkHolder = objectIterator.next();
...
/* 1361 */       super(ticketStorage, executor, mainThreadExecutor);
/*      */     }
/*      */ 
/*      */     
/*      */     protected boolean isChunkToRemove(long node) {
/* 1366 */       return ChunkMap.this.toDrop.contains(node);
/*      */     }
/*      */ 
/*      */     
/*      */     protected ChunkHolder getChunk(long node) {
/* 1371 */       return ChunkMap.this.getUpdatingChunkIfPresent(node);
/*      */     }
/*      */ 
/*      */     
/*      */     protected ChunkHolder updateChunkScheduling(long node, int level, ChunkHolder chunk, int oldLevel) {
/* 1376 */       return ChunkMap.this.updateChunkScheduling(node, level, chunk, oldLevel);
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1388 */     private final Set<ServerPlayerConnection> seenBy = Sets.newIdentityHashSet();
/*      */     
...
/* 1394 */       this.lastSectionPos = SectionPos.of((EntityAccess)entity);
/*      */     }
/*      */ 
/*      */     
...
/* 1421 */       Entity entity = this.entity; if (entity instanceof ServerPlayer) { ServerPlayer player = (ServerPlayer)entity;
...
/* 1477 */       return ChunkMap.this.level.getServer().getScaledTrackingDistance(range);
/*      */     }
/*      */     
/*      */     private int getEffectiveRange() {
/* 1481 */       int effectiveRange = this.range;
/* 1482 */       for (Entity passenger : (Iterable<Entity>)this.entity.getIndirectPassengers()) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/level/ChunkMap.class
