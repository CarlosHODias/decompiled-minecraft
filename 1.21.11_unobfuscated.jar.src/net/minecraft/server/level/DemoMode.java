...
/*     */         } else {
/*  51 */           this.player.sendSystemMessage((Component)Component.translatable("demo.day." + day));
/*     */         } 
/*     */       }
/*  54 */     } else if (day == 1L) {
/*  55 */       if (time == 100L) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/level/DemoMode.class
