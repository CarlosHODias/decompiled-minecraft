...
/*  22 */     super(Mth.createInsecureUUID(), name, color, overlay);
/*     */   }
/*     */ 
/*     */   
...
/*  85 */     if (this.visible) {
/*  86 */       ClientboundBossEventPacket packet = factory.apply(this);
/*  87 */       for (ServerPlayer player : this.players) {
/*  88 */         player.connection.send((Packet)packet);
/*     */       }
/*     */     } 
/*     */   }
/*     */   
...
/*  95 */       player.connection.send((Packet)ClientboundBossEventPacket.createAddPacket(this));
/*     */     }
/*     */   }
/*     */   
/*     */   public void removePlayer(ServerPlayer player) {
/* 100 */     if (this.players.remove(player) && this.visible) {
/* 101 */       player.connection.send((Packet)ClientboundBossEventPacket.createRemovePacket(getId()));
/*     */     }
/*     */   }
/*     */   
/*     */   public void removeAllPlayers() {
/* 106 */     if (!this.players.isEmpty()) {
/* 107 */       for (ServerPlayer player : (Iterable<ServerPlayer>)Lists.newArrayList(this.players)) {
...
/* 122 */         player.connection.send(visible ? (Packet)ClientboundBossEventPacket.createAddPacket(this) : (Packet)ClientboundBossEventPacket.createRemovePacket(getId()));
/*     */       }
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/level/ServerBossEvent.class
