...
/*     */ 
/*     */       
/*  37 */       List<Registry.PendingTags<?>> staticLayerTags = TagLoader.loadTagsForExistingRegistries((ResourceManager)resources, (RegistryAccess)initialLayers.getLayer(RegistryLayer.STATIC));
/*     */ 
/*     */       
...
/*  42 */       RegistryAccess.Frozen loadedWorldgenRegistries = RegistryDataLoader.load((ResourceManager)resources, worldgenContextRegistries, RegistryDataLoader.WORLDGEN_REGISTRIES);
/*     */ 
/*     */       
/*  45 */       List<HolderLookup.RegistryLookup<?>> dimensionContextRegistries = Stream.<HolderLookup.RegistryLookup<?>>concat(worldgenContextRegistries.stream(), loadedWorldgenRegistries.listRegistries()).toList();
/*  46 */       RegistryAccess.Frozen initialWorldgenDimensions = RegistryDataLoader.load((ResourceManager)resources, dimensionContextRegistries, RegistryDataLoader.DIMENSION_REGISTRIES);
/*     */       
...
/*  52 */       DataLoadOutput<D> worldDataAndRegistries = worldDataSupplier.get(new DataLoadContext((ResourceManager)resources, worldDataConfiguration, dimensionContextProvider, initialWorldgenDimensions));
/*     */ 
/*     */       
...
/*     */       
/*  57 */       return ReloadableServerResources.loadResources((ResourceManager)resources, resourcesLoadContext, staticLayerTags, worldDataConfiguration.enabledFeatures(), config.commandSelection(), config.functionCompilationPermissions(), backgroundExecutor, mainThreadExecutor)
...
/*     */       // Local variable type table:
/*     */       //   start	length	slot	name	signature
/*  74 */       //   0	8	0	this	Lnet/minecraft/server/WorldLoader$DataLoadOutput<TD;>; } public D cookie() { return this.cookie; } public RegistryAccess.Frozen finalDimensions() { return this.finalDimensions; }
/*     */      }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/WorldLoader.class
