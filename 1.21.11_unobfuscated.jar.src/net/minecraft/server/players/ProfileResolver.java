...
/* 27 */     return (Optional<GameProfile>)nameOrId.map(this::fetchByName, this::fetchById);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 45 */             return Optional.<ProfileResult>ofNullable(result).map(ProfileResult::profile);
/*    */           }
/*    */         });
/*    */     
...
/* 65 */         return (Optional<GameProfile>)this.profileCacheByName.getUnchecked(name);
/*    */       }
...
/* 72 */       return (Optional<GameProfile>)this.profileCacheById.getUnchecked(id);
/*    */     }
/*    */   }
/*    */   
...
/*    */       return Optional.<ProfileResult>ofNullable(result).map(ProfileResult::profile);
/*    */     }
/*    */   }
/*    */   
/*    */   class null extends CacheLoader<String, Optional<GameProfile>> {
/*    */     public Optional<GameProfile> load(String name) {
/*    */       return nameToIdCache.get(name).flatMap(nameAndId -> (Optional)ProfileResolver.Cached.this.profileCacheById.getUnchecked(nameAndId.id()));
/*    */     }
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/players/ProfileResolver.class
