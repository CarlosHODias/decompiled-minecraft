...
/*  91 */     this.resolveOfflineUsers = value;
/*     */   }
/*     */ 
/*     */   
/*     */   public void add(NameAndId nameAndId) {
/*  96 */     addInternal(nameAndId);
/*     */   }
/*     */   
...
/* 118 */     GameProfileInfo profileInfo = this.profilesByName.get(userName);
/*     */     
...
/* 138 */         result = Optional.of(addInternal(profile.get()).nameAndId());
/*     */         
/* 140 */         needsSave = false;
/*     */       } else {
...
/* 154 */     GameProfileInfo profileInfo = this.profilesByUUID.get(id);
...
/*     */     
/* 189 */     String toSave = this.gson.toJson((JsonElement)entryList); 
...
/* 198 */     return ImmutableList.copyOf(this.profilesByUUID.values()).stream().sorted(Comparator.comparing(GameProfileInfo::lastAccess).reversed()).limit(limit);
/*     */   }
/*     */   
...
/* 248 */       this.lastAccess = currentOperation;
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/players/CachedUserNameToIdResolver.class
