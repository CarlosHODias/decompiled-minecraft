...
/* 17 */     return new ServerOpListEntry(object);
/*    */   }
/*    */ 
/*    */   
/*    */   public String[] getUserList() {
/* 22 */     return (String[])getEntries().stream().map(StoredUserEntry::getUser).filter(Objects::nonNull).map(NameAndId::name).toArray(x$0 -> new String[x$0]);
/*    */   }
/*    */ 
/*    */   
...
/* 38 */     ServerOpListEntry entry = get(user);
...
/* 60 */     ServerOpListEntry entry = get(user);
/*    */     
/* 62 */     if (entry != null) {
...
/* 71 */     return user.id().toString();
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/players/ServerOpList.class
