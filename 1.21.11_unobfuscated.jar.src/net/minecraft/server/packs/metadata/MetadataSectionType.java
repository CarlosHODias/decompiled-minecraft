...
/*    */   
/*  7 */   public MetadataSectionType(String name, com.mojang.serialization.Codec<T> codec) { this.name = name; this.codec = codec; } public final String toString() { // Byte code:
/*    */     //   0: aload_0
...
/*    */     // Local variable type table:
/*    */     //   start	length	slot	name	signature
/*  7 */     //   0	8	0	this	Lnet/minecraft/server/packs/metadata/MetadataSectionType<TT;>; } public com.mojang.serialization.Codec<T> codec() { return this.codec; }
/*    */ 
/*    */ 
/*    */ 
/*    */   
/*    */   public WithValue<T> withValue(T value) {
/* 13 */     return new WithValue<>(this, value);
/*    */   }
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/* 16 */       //   0	8	0	this	Lnet/minecraft/server/packs/metadata/MetadataSectionType$WithValue<TT;>; } public MetadataSectionType<T> type() { return this.type; } public T value() { return this.value; }
/*    */ 
/*    */ 
/*    */ 
/*    */     
/*    */     public <U> java.util.Optional<U> unwrapToType(MetadataSectionType<U> type) {
/* 22 */       return (type == this.type) ? java.util.Optional.<U>of((U)this.value) : java.util.Optional.<U>empty();
/*    */     } }
/*    */ 
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/packs/metadata/MetadataSectionType.class
