...
/* 23 */     result.startTasks(taskExecutor, mainThreadExecutor, resourceManager, listeners, (currentReload, previousStep, listener, parentTaskExecutor, parentReloadExecutor) -> { AtomicLong preparationNanos = new AtomicLong(), preparationCount = new AtomicLong(), reloadNanos = new AtomicLong(), reloadCount = new AtomicLong(); CompletableFuture<Void> reload = listener.reload(currentReload, profiledExecutor(parentTaskExecutor, preparationNanos, preparationCount, listener.getName()), previousStep, profiledExecutor(parentReloadExecutor, reloadNanos, reloadCount, listener.getName())); return reload.thenApplyAsync((), mainThreadExecutor); }, initialTask);
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* 68 */     LOGGER.info("Resource reload finished after {} ms", this.total.elapsed(TimeUnit.MILLISECONDS));
...
/* 77 */       LOGGER.info("{} took approximately {} tasks/{} ms ({} tasks/{} ms preparing, {} tasks/{} ms applying)", new Object[] { name, totalCount, 
/*    */             
/* 79 */             totalTime, prepCount, 
/* 80 */             prepTime, reloadCount, 
/* 81 */             reloadTime });
/*    */ 
/*    */       
...
/*    */     } 
/*    */     
/* 87 */     LOGGER.info("Total blocking time: {} ms", blockingTime);
/* 88 */     return result;
/*    */   }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/packs/resources/ProfiledReloadInstance.class
