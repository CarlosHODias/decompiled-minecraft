...
/*     */     
/*  29 */     Map<String, FallbackResourceManager> namespacedManagers = new HashMap<>();
/*     */     
...
/*  43 */           FallbackResourceManager fallbackResourceManager = namespacedManagers.get(namespace);
...
/*  78 */     ResourceManager pack = this.namespacedManagers.get(location.getNamespace());
/*     */     
/*  80 */     if (pack != null) {
...
/*  89 */     ResourceManager pack = this.namespacedManagers.get(location.getNamespace());
/*     */     
/*  91 */     if (pack != null) {
...
/*     */     
/* 102 */     Map<Identifier, Resource> result = new TreeMap<>();
/*     */ 
/*     */     
...
/*     */     
/* 116 */     Map<Identifier, List<Resource>> result = new TreeMap<>();
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/packs/resources/MultiPackResourceManager.class
