...
/* 31 */     this((DynamicOps<JsonElement>)registries.createSerializationContext((DynamicOps)JsonOps.INSTANCE), codec, FileToIdConverter.registry(registryKey));
/*    */   }
/*    */   
/*    */   protected SimpleJsonResourceReloadListener(Codec<T> codec, FileToIdConverter lister) {
/* 35 */     this((DynamicOps<JsonElement>)JsonOps.INSTANCE, codec, lister);
/*    */   }
/*    */   
...
/* 46 */     Map<Identifier, T> result = new HashMap<>();
...
/* 52 */     scanDirectory(manager, FileToIdConverter.registry(registryKey), ops, codec, result);
/*    */   }
/*    */   
...
/* 56 */     for (Map.Entry<Identifier, Resource> entry : (Iterable<Map.Entry<Identifier, Resource>>)lister.listMatchingResources(manager).entrySet()) {
/* 57 */       Identifier location = entry.getKey();
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/packs/resources/SimpleJsonResourceReloadListener.class
