...
/*     */       
/*  56 */       Set<Path> emptyDirectoryCandidates = new HashSet<>();
/*  57 */       for (int i = 0; i < toRemove; i++) {
/*  58 */         PathAndPriority entry = filesWithDirOrder.get(i);
...
/* 112 */     List<PathAndPriority> result = new ArrayList<>();
/*     */ 
/*     */     
/* 115 */     Object2IntOpenHashMap<Path> parentCounts = new Object2IntOpenHashMap();
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/packs/DownloadCacheCleaner.class
