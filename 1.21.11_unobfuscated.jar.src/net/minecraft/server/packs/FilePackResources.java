...
/*  37 */     return String.format(Locale.ROOT, "%s/%s/%s", new Object[] { type.getDirectory(), location.getNamespace(), location.getPath() });
/*     */   }
/*     */ 
/*     */   
/*     */   public IoSupplier<InputStream> getRootResource(String... path) {
/*  42 */     return getResource(String.join("/", (CharSequence[])path));
/*     */   }
/*     */ 
/*     */   
/*     */   public IoSupplier<InputStream> getResource(PackType type, Identifier location) {
/*  47 */     return getResource(getPathFromLocation(type, location));
/*     */   }
/*     */   
...
/*  86 */       ZipEntry zipEntry = entries.nextElement();
/*     */       
...
/* 132 */       ZipEntry zipEntry = entries.nextElement();
...
/*     */       }
/*     */       
/* 222 */       List<PackResources> overlayResources = new ArrayList<>(overlays.size());
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/packs/FilePackResources.class
