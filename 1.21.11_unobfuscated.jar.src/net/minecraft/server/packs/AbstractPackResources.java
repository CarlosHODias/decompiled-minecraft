...
/* 33 */     try { T t = (T)getMetadataFromStream((MetadataSectionType)metadataSerializer, resource, this.location);
/* 34 */       if (resource != null) resource.close();  return t; }
...
/*    */     }
/*    */     
/* 50 */     return serializer.codec().parse((DynamicOps)JsonOps.INSTANCE, metadata.get(serializer.name()))
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/packs/AbstractPackResources.class
