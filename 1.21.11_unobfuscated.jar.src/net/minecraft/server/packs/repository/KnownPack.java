...
/* 12 */    public static final StreamCodec<io.netty.buffer.ByteBuf, KnownPack> STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.STRING_UTF8, KnownPack::namespace, ByteBufCodecs.STRING_UTF8, KnownPack::id, ByteBufCodecs.STRING_UTF8, KnownPack::version, KnownPack::new);
/*    */ 
/*    */ 
/*    */   
...
/* 22 */     return new KnownPack("minecraft", id, net.minecraft.SharedConstants.getCurrentVersion().id());
/*    */   }
/*    */   
/*    */   public boolean isVanilla() {
/* 26 */     return this.namespace.equals("minecraft");
/*    */   }
/*    */ 
/*    */   
/*    */   public String toString() {
/* 31 */     return this.namespace + ":" + this.namespace + ":" + this.id;
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/packs/repository/KnownPack.class
