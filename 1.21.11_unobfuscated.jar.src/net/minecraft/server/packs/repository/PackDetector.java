...
/* 47 */         return null;
/*    */       }
/* 49 */       return createDirectoryPack(targetContext);
/* 50 */     }  if (attributes.isRegularFile() && targetContext.getFileName().toString().endsWith(".zip")) {
/* 51 */       return createZipPack(targetContext);
/*    */     }
/* 53 */     return null;
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/packs/repository/PackDetector.class
