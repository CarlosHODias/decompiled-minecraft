...
/*  88 */     this.finalizers.add(finalizer);
/*     */   }
/*     */   
/*     */   private JComponent buildInfoPanel() {
/*  92 */     JPanel panel = new JPanel(new BorderLayout());
/*  93 */     StatsComponent comp = new StatsComponent((MinecraftServer)this.server);
...
/* 102 */     JList<?> playerList = new PlayerListComponent((MinecraftServer)this.server);
...
/*     */             print(chatArea, scrollPane, line);
/*     */           }
/*     */         });
...
/*     */     
/* 179 */     if (shouldScroll)
/* 180 */       scrollBar.setValue(Integer.MAX_VALUE); 
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/gui/MinecraftServerGui.class
