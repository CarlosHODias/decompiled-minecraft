...
/*     */ 
/*     */ public class CustomBossEvent extends net.minecraft.server.level.ServerBossEvent {
...
/*  79 */     return (Component)net.minecraft.network.chat.ComponentUtils.wrapInSquareBrackets(getName()).withStyle(s -> s.withColor(getColor().getFormatting()).withHoverEvent((HoverEvent)new HoverEvent.ShowText((Component)Component.literal(getTextId().toString()))).withInsertion(getTextId().toString()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */       for (ServerPlayer player : (Iterable<ServerPlayer>)getPlayers()) {
...
/* 143 */     java.util.Objects.requireNonNull(event); packed.players.forEach(event::addOfflinePlayer);
/* 144 */     return event;
/*     */   }
/*     */   
/*     */   public Packed pack() {
/* 148 */     return new Packed(getName(), isVisible(), getValue(), getMax(), getColor(), getOverlay(), shouldDarkenScreen(), shouldPlayBossMusic(), shouldCreateWorldFog(), Set.copyOf(this.players));
/*     */   }
/*     */   
...
/* 158 */     super.removePlayer(player);
/*     */   }
/*     */   public static final class Packed extends Record { private final Component name; private final boolean visible; private final int value; private final int max; private final BossEvent.BossBarColor color; private final BossEvent.BossBarOverlay overlay; private final boolean darkenScreen; private final boolean playBossMusic; private final boolean createWorldFog; private final Set<UUID> players; public static final Codec<Packed> CODEC;
/* 161 */     public Packed(Component name, boolean visible, int value, int max, BossEvent.BossBarColor color, BossEvent.BossBarOverlay overlay, boolean darkenScreen, boolean playBossMusic, boolean createWorldFog, Set<UUID> players) { this.name = name; this.visible = visible; this.value = value; this.max = max; this.color = color; this.overlay = overlay; this.darkenScreen = darkenScreen; this.playBossMusic = playBossMusic; this.createWorldFog = createWorldFog; this.players = players; } public final String toString() { // Byte code:
/*     */       //   0: aload_0
...
/* 161 */       //   0	7	0	this	Lnet/minecraft/server/bossevents/CustomBossEvent$Packed; } public Component name() { return this.name; } public final int hashCode() { // Byte code:
/*     */       //   0: aload_0
...
/* 161 */       //   0	8	1	o	Ljava/lang/Object; } public boolean visible() { return this.visible; } public int value() { return this.value; } public int max() { return this.max; } public BossEvent.BossBarColor color() { return this.color; } public BossEvent.BossBarOverlay overlay() { return this.overlay; } public boolean darkenScreen() { return this.darkenScreen; } public boolean playBossMusic() { return this.playBossMusic; } public boolean createWorldFog() { return this.createWorldFog; } public Set<UUID> players() { return this.players; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*     */     static {
/* 173 */       CODEC = RecordCodecBuilder.create(i -> i.group((App)ComponentSerialization.CODEC.fieldOf("Name").forGetter(Packed::name), (App)Codec.BOOL.optionalFieldOf("Visible", false).forGetter(Packed::visible), (App)Codec.INT.optionalFieldOf("Value", 0).forGetter(Packed::value), (App)Codec.INT.optionalFieldOf("Max", 100).forGetter(Packed::max), (App)BossEvent.BossBarColor.CODEC.optionalFieldOf("Color", BossEvent.BossBarColor.WHITE).forGetter(Packed::color), (App)BossEvent.BossBarOverlay.CODEC.optionalFieldOf("Overlay", BossEvent.BossBarOverlay.PROGRESS).forGetter(Packed::overlay), (App)Codec.BOOL.optionalFieldOf("DarkenScreen", false).forGetter(Packed::darkenScreen), (App)Codec.BOOL.optionalFieldOf("PlayBossMusic", false).forGetter(Packed::playBossMusic), (App)Codec.BOOL.optionalFieldOf("CreateWorldFog", false).forGetter(Packed::createWorldFog), (App)UUIDUtil.CODEC_SET.optionalFieldOf("Players", Set.of()).forGetter(Packed::players)).apply((Applicative)i, Packed::new));
/*     */     } }
/*     */ 
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/bossevents/CustomBossEvent.class
