...
/* 16 */     //   0	7	0	this	Lnet/minecraft/server/ServerLinks; } public List<Entry> entries() { return this.entries; }
...
/* 17 */     //   0	8	1	o	Ljava/lang/Object; } public static final ServerLinks EMPTY = new ServerLinks(List.of());
/*    */   
/* 19 */   public static final StreamCodec<ByteBuf, Either<KnownLinkType, Component>> TYPE_STREAM_CODEC = ByteBufCodecs.either(KnownLinkType.STREAM_CODEC, net.minecraft.network.chat.ComponentSerialization.TRUSTED_CONTEXT_FREE_STREAM_CODEC);
/*    */ 
/*    */ 
/*    */ 
/*    */   
...
/* 27 */     return this.entries.isEmpty();
/*    */   }
/*    */   
/*    */   public java.util.Optional<Entry> findKnownType(KnownLinkType type) {
/* 31 */     return this.entries.stream().filter(e -> (Boolean)e.type.map((), ())).findFirst();
/*    */   }
/*    */   
/*    */   public List<UntrustedEntry> untrust() {
/* 35 */     return this.entries.stream().map(e -> new UntrustedEntry(e.type, e.link.toString())).toList();
/*    */   }
...
/*    */ 
/*    */     
/*    */     public static Entry knownType(ServerLinks.KnownLinkType type, URI link) {
/* 54 */       return new Entry(Either.left(type), link);
/*    */     }
/*    */     
/*    */     public static Entry custom(Component displayName, URI link) {
/* 58 */       return new Entry(Either.right(displayName), link);
/*    */     }
/*    */     
/*    */     public Component displayName() {
/* 62 */       return (Component)this.type.map(ServerLinks.KnownLinkType::displayName, r -> r);
/*    */     }
/*    */   }
/*    */   
...
/*    */     
/*    */     static {
/* 79 */       BY_ID = ByIdMap.continuous(e -> e.id, (Object[])values(), ByIdMap.OutOfBoundsStrategy.ZERO);
/*    */       
...
/* 92 */       return (Component)Component.translatable("known_server_link." + this.name);
/*    */     }
/*    */     
/*    */     public ServerLinks.Entry create(URI link) {
/* 96 */       return ServerLinks.Entry.knownType(this, link);
/*    */     }
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/ServerLinks.class
