...
/*     */               try {
/*  82 */                 sendCmdResponse(requestid, this.serverInterface.runCommand(command));
/*  83 */               } catch (Exception e) {
/*  84 */                 sendCmdResponse(requestid, "Error executing: " + command + " (" + e.getMessage() + ")");
/*     */               }  continue;
/*     */             } 
/*  87 */             sendAuthFailure();
/*     */             continue;
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/rcon/thread/RconClient.class
