...
/*  33 */     this.clients.removeIf(client -> !client.isRunning());
/*     */   }
/*     */ 
/*     */   
/*     */   public void run() {
...
/*  73 */       LOGGER.warn("Invalid rcon port {} found in server.properties, rcon disabled!", port);
/*  74 */       return null;
/*     */     } 
/*     */     
...
/*  89 */         return null;
/*     */       }
/*  91 */       LOGGER.info("RCON running on {}:{}", serverIp, port);
/*  92 */       return result;
/*  93 */     } catch (IOException e) {
/*  94 */       LOGGER.warn("Unable to initialise RCON on {}:{}", new Object[] { serverIp, port, e });
/*     */ 
/*     */       
/*  97 */       return null;
/*     */     } 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/rcon/thread/RconThread.class
