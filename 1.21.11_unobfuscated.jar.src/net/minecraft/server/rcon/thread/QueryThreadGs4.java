...
/*  85 */       LOGGER.warn("Invalid query port {} found in server.properties (queries disabled)", port);
/*  86 */       return null;
/*     */     } 
/*     */     
...
/*  97 */     this.socket.send(new DatagramPacket(data, data.length, src.getSocketAddress()));
/*     */   }
...
/* 104 */     LOGGER.debug("Packet len {} [{}]", len, socketAddress);
...
/* 214 */     return ((RequestChallenge)this.validChallenges.get(src)).getIdentBytes();
/*     */   }
/*     */   
...
/* 225 */     return (((RequestChallenge)this.validChallenges.get(sockAddr)).getChallenge() == PktUtils.intFromNetworkByteArray(data, 7, src.getLength()));
/*     */   }
/*     */   
...
/*     */     
/* 246 */     this.validChallenges.values().removeIf(challenge -> challenge.before(now));
/*     */   }
/*     */ 
/*     */   
/*     */   public void run() {
/* 251 */     LOGGER.info("Query running on {}:{}", this.serverIp, this.port);
...
/*     */       } 
/*     */     } finally {
/* 276 */       LOGGER.debug("closeSocket: {}:{}", this.serverIp, this.port);
...
/* 315 */       LOGGER.warn("Unable to initialise query system on {}:{}", new Object[] { this.serverIp, this.port, e });
/*     */       
/* 317 */       return false;
/*     */     } 
/*     */   }
...
/* 337 */       this.challengeBytes = String.format(Locale.ROOT, "\t%s%d\000", new Object[] { this.ident, this.challenge }).getBytes(StandardCharsets.UTF_8);
/*     */     }
/*     */     private final byte[] challengeBytes; private final String ident;
/*     */     public Boolean before(long time) {
/* 341 */       return (this.time < time);
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/rcon/thread/QueryThreadGs4.class
