...
/*    */ 
/*    */           
/* 49 */           LOGGER.warn("Waited {} seconds attempting force stop!", waited); continue;
/* 50 */         }  if (this.thread.isAlive()) {
/* 51 */           LOGGER.warn("Thread {} ({}) failed to exit after {} second(s)", new Object[] { this, this.thread.getState(), waited, new Exception("Stack:") });
/*    */           
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/rcon/thread/GenericThread.class
