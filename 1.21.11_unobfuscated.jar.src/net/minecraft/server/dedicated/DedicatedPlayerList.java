...
/*  17 */     super(server, registries, playerDataStorage, (NotificationService)server.notificationManager());
/*     */     
...
/* 105 */     return (!isUsingWhitelist() || isOp(nameAndId) || getWhiteList().isWhiteListed(nameAndId));
/*     */   }
/*     */ 
/*     */   
...
/* 115 */     return getOps().canBypassPlayerLimit(nameAndId);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/dedicated/DedicatedPlayerList.class
