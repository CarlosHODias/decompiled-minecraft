...
/* 30 */     return ResourceKey.create(Registries.DIALOG, Identifier.withDefaultNamespace(id));
/*    */   }
/*    */   
...
/*    */             
/* 58 */             List.of(), 
/* 59 */             List.of()), (HolderSet<Dialog>)
/*    */           
/* 61 */           dialogs.getOrThrow(DialogTags.PAUSE_SCREEN_ADDITIONS), 
...
/*    */             
/* 74 */             List.of(), 
/* 75 */             List.of()), (HolderSet<Dialog>)
/*    */           
/* 77 */           dialogs.getOrThrow(DialogTags.QUICK_ACTIONS), 
/* 78 */           Optional.of(DEFAULT_BACK_BUTTON), 1, 310));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/dialog/Dialogs.class
