...
/*     */           String id = descriptionGetter.apply(t);
/*     */           if (!language.has(id)) {
/*     */             output.add(id);
/*     */           }
/*     */         });
...
/* 103 */     Set<String> missing = new TreeSet<>();
/* 104 */     checkTranslations((Iterable<?>)BuiltInRegistries.ATTRIBUTE, Attribute::getDescriptionId, missing);
/* 105 */     checkTranslations((Iterable<?>)BuiltInRegistries.ENTITY_TYPE, EntityType::getDescriptionId, missing);
/* 106 */     checkTranslations((Iterable<?>)BuiltInRegistries.MOB_EFFECT, MobEffect::getDescriptionId, missing);
/* 107 */     checkTranslations((Iterable<?>)BuiltInRegistries.ITEM, Item::getDescriptionId, missing);
/* 108 */     checkTranslations((Iterable<?>)BuiltInRegistries.BLOCK, BlockBehaviour::getDescriptionId, missing);
/* 109 */     checkTranslations((Iterable<?>)BuiltInRegistries.CUSTOM_STAT, id -> "stat." + id.toString().replace(':', '.'), missing);
/*     */     
...
/*     */     try {
/* 123 */       String resolvedLocation = location.get();
...
/* 154 */     STDOUT.println(string);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/Bootstrap.class
