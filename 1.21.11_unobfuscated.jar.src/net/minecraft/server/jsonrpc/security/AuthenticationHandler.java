...
/*  38 */     this.allowedOrigins = Sets.newHashSet((Object[])allowedOrigins.split(","));
/*     */   }
/*     */ 
/*     */   
...
/*  48 */         context.channel().attr(AUTHENTICATED_KEY).set(true);
...
/*  54 */         context.channel().attr(AUTHENTICATED_KEY).set(false);
...
/*  74 */         response.headers().set((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_PROTOCOL, "minecraft-v1");
/*     */       } }
/*     */     
...
/* 106 */     String originHeader = request.headers().get((CharSequence)HttpHeaderNames.ORIGIN);
/*     */     
...
/* 116 */     String authHeader = request.headers().get((CharSequence)HttpHeaderNames.AUTHORIZATION);
/*     */     
...
/* 126 */     String authHeader = request.headers().get((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_PROTOCOL);
/*     */     
...
/*     */     
/* 156 */     DefaultFullHttpResponse response = new DefaultFullHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.UNAUTHORIZED, 
/*     */ 
/*     */         
/* 159 */         Unpooled.wrappedBuffer(content));
/*     */ 
/*     */     
/* 162 */     response.headers().set((CharSequence)HttpHeaderNames.CONTENT_TYPE, "application/json");
/* 163 */     response.headers().set((CharSequence)HttpHeaderNames.CONTENT_LENGTH, content.length);
/* 164 */     response.headers().set((CharSequence)HttpHeaderNames.CONNECTION, "close");
/*     */     
...
/* 185 */       return new SecurityCheckResult(true, null, tokenSentInSecWebsocketProtocol);
/*     */     }
/*     */     
/*     */     public static SecurityCheckResult denied(String reason) {
/* 189 */       return new SecurityCheckResult(false, reason, false);
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/jsonrpc/security/AuthenticationHandler.class
