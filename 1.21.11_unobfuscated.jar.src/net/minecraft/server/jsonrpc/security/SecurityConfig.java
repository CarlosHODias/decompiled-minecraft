...
/*    */ public final class SecurityConfig extends Record { private final String secretKey; private static final String SECRET_KEY_CHARS = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"; public final String toString() {
/*    */     // Byte code:
/*    */     //   0: aload_0
...
/*    */   }
/*  5 */   public SecurityConfig(String secretKey) { this.secretKey = secretKey; } public String secretKey() { return this.secretKey; } public final int hashCode() {
/*    */     // Byte code:
/*    */     //   0: aload_0
...
/* 18 */     java.security.SecureRandom random = new java.security.SecureRandom();
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/jsonrpc/security/SecurityConfig.class
