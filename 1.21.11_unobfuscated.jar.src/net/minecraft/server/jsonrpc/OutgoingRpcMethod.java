...
/*     */     } }
/*     */   
/*     */   public static final class ParmeterlessNotification extends Record implements OutgoingRpcMethod<Void, Void> { private final MethodInfo<Void, Void> info; private final OutgoingRpcMethod.Attributes attributes;
/*  41 */     public ParmeterlessNotification(MethodInfo<Void, Void> info, OutgoingRpcMethod.Attributes attributes) { this.info = info; this.attributes = attributes; } public final String toString() { // Byte code:
/*     */       //   0: aload_0
...
/*     */       // Local variable table:
/*     */       //   start	length	slot	name	descriptor
/*  41 */       //   0	7	0	this	Lnet/minecraft/server/jsonrpc/OutgoingRpcMethod$ParmeterlessNotification; } public MethodInfo<Void, Void> info() { return this.info; } public final int hashCode() { // Byte code:
/*     */       //   0: aload_0
...
/*     */       // Local variable table:
/*     */       //   start	length	slot	name	descriptor
/*     */       //   0	7	0	this	Lnet/minecraft/server/jsonrpc/OutgoingRpcMethod$ParmeterlessNotification; } public final boolean equals(Object o) { // Byte code:
/*     */       //   0: aload_0
/*     */       //   1: aload_1
...
/*  41 */       //   0	8	1	o	Ljava/lang/Object; } public OutgoingRpcMethod.Attributes attributes() { return this.attributes; }
/*     */      }
/*     */   
...
/*     */       }
/*  56 */       return (JsonElement)((ParamInfo)this.info.params().get()).schema().codec().encodeStart((DynamicOps)JsonOps.INSTANCE, params).getOrThrow();
/*     */     } }
...
/*     */       }
/*  69 */       return (Result)((ResultInfo)this.info.result().get()).schema().codec().parse((DynamicOps)JsonOps.INSTANCE, result).getOrThrow();
/*     */     } }
...
/*     */       }
/*  82 */       return (JsonElement)((ParamInfo)this.info.params().get()).schema().codec().encodeStart((DynamicOps)JsonOps.INSTANCE, params).getOrThrow();
/*     */     }
/*     */ 
/*     */     
/*     */     public Result decodeResult(JsonElement result) {
...
/*     */       }
/*  90 */       return (Result)((ResultInfo)this.info.result().get()).schema().codec().parse((DynamicOps)JsonOps.INSTANCE, result).getOrThrow();
/*     */     } }
/*     */   @FunctionalInterface
...
/*     */   
/*  95 */   public static class OutgoingRpcMethodBuilder<Params, Result> { public static final OutgoingRpcMethod.Attributes DEFAULT_ATTRIBUTES = new OutgoingRpcMethod.Attributes(true);
...
/* 130 */       return register(Identifier.withDefaultNamespace("notification/" + key));
/*     */     }
/*     */     
/*     */     private Holder.Reference<OutgoingRpcMethod<Params, Result>> register(Identifier id) {
/* 134 */       return Registry.registerForHolder(BuiltInRegistries.OUTGOING_RPC_METHOD, id, build());
/*     */     } }
/*     */ 
/*     */   
/*     */   static OutgoingRpcMethodBuilder<Void, Void> notification() {
/* 139 */     return new OutgoingRpcMethodBuilder<>(ParmeterlessNotification::new);
/*     */   }
/*     */   
/*     */   static <Params> OutgoingRpcMethodBuilder<Params, Void> notificationWithParams() {
/* 143 */     return new OutgoingRpcMethodBuilder<>(Notification::new);
/*     */   }
/*     */   
/*     */   static <Result> OutgoingRpcMethodBuilder<Void, Result> request() {
/* 147 */     return new OutgoingRpcMethodBuilder<>(ParameterlessMethod::new);
/*     */   }
/*     */   
/*     */   static <Params, Result> OutgoingRpcMethodBuilder<Params, Result> requestWithParams() {
/* 151 */     return new OutgoingRpcMethodBuilder<>(Method::new);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/jsonrpc/OutgoingRpcMethod.class
