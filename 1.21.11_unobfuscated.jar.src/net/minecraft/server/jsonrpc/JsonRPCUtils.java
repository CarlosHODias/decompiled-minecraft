...
/*    */       }
/* 37 */       request.add("params", (JsonElement)jsonArray);
/*    */     } 
/* 39 */     return request;
/*    */   }
/*    */   
...
/* 47 */     error.addProperty("code", errorCode);
/* 48 */     error.addProperty("message", message);
/* 49 */     if (data != null && !data.isBlank()) {
/* 50 */       error.addProperty("data", data);
/*    */     }
/* 52 */     errorResponse.add("error", (JsonElement)error);
/* 53 */     return errorResponse;
/*    */   }
/*    */   
/*    */   public static JsonElement getRequestId(JsonObject jsonObject) {
/* 57 */     return jsonObject.get("id");
/*    */   }
/*    */   
/*    */   public static String getMethodName(JsonObject jsonObject) {
/* 61 */     return GsonHelper.getAsString(jsonObject, "method", null);
/*    */   }
/*    */   
/*    */   public static JsonElement getParams(JsonObject jsonObject) {
/* 65 */     return jsonObject.get("params");
/*    */   }
/*    */   
/*    */   public static JsonElement getResult(JsonObject jsonObject) {
/* 69 */     return jsonObject.get("result");
/*    */   }
/*    */   
/*    */   public static JsonObject getError(JsonObject jsonObject) {
/* 73 */     return GsonHelper.getAsJsonObject(jsonObject, "error", null);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/jsonrpc/JsonRPCUtils.class
