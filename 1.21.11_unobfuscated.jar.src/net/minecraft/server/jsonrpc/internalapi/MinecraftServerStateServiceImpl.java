...
/* 30 */     this.jsonrpcLogger.log(clientInfo, "Save everything. SuppressLogs: {}, flush: {}, force: {}", new Object[] { suppressLogs, flush, force });
...
/* 36 */     this.jsonrpcLogger.log(clientInfo, "Halt server. WaitForShutdown: {}", new Object[] { waitForShutdown });
...
/* 49 */     this.jsonrpcLogger.log(clientInfo, "Send system message to '{}' players (overlay: {}): '{}'", new Object[] { playerNames.size(), overlay, message.getString() });
/*    */     
...
/* 62 */     this.jsonrpcLogger.log(clientInfo, "Broadcast system message (overlay: {}): '{}'", new Object[] { overlay, message.getString() });
/*    */     
/* 64 */     for (ServerPlayer player : (Iterable<ServerPlayer>)this.server.getPlayerList().getPlayers()) {
/* 65 */       if (overlay) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/jsonrpc/internalapi/MinecraftServerStateServiceImpl.class
