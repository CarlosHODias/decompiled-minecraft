...
/* 13 */   private final Queue<LongEntry> latestEntries = (Queue<LongEntry>)new ArrayListDeque();
/*    */   
...
/*    */     
/* 26 */     this.latestEntries.add(new LongEntry(now, location, (Class)throwable.getClass(), message));
/* 27 */     while (this.latestEntries.size() > 8) {
/* 28 */       this.latestEntries.remove();
/*    */     }
/*    */     
/* 31 */     ShortEntry key = new ShortEntry(location, (Class)throwable.getClass());
...
/* 61 */       for (ObjectIterator<Object2IntMap.Entry<ShortEntry>> objectIterator = Object2IntMaps.fastIterable((Object2IntMap)this.entryCounts).iterator(); objectIterator.hasNext(); ) { Object2IntMap.Entry<ShortEntry> e = objectIterator.next();
/*    */         
/* 63 */         result.append("\t\t\t")
...
/*    */ 
/*    */   
/*    */   private static final class ShortEntry extends Record {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/SuppressedExceptionCollector.class
