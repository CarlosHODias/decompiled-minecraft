...
/*  39 */   private final CopyOnWriteArrayList<Socket> clientSockets = new CopyOnWriteArrayList<>();
/*     */   
...
/*     */           } 
/*     */         } 
/*  88 */         List<Socket> closed = (List<Socket>)this.clientSockets.stream().filter(Socket::isClosed).collect(Collectors.toList());
...
/* 111 */           LOGGER.info("Remote control server is listening for connections on port {}", this.serverPort);
/* 112 */           Socket clientSocket = this.serverSocket.accept();
/* 113 */           LOGGER.info("Remote control server received client connection on port {}", clientSocket.getPort());
...
/* 135 */       return null;
/*     */     }
/* 137 */     ServerPlayer player = players.get(0);
...
/* 145 */     private PlayerPosition(String dimensionName, double x, double y, double z, float yRot, float xRot) { this.dimensionName = dimensionName; this.x = x; this.y = y; this.z = z; this.yRot = yRot; this.xRot = xRot; } public final String toString() { // Byte code:
/*     */       //   0: aload_0
...
/* 145 */       //   0	7	0	this	Lnet/minecraft/server/chase/ChaseServer$PlayerPosition; } public String dimensionName() { return this.dimensionName; } public final int hashCode() { // Byte code:
/*     */       //   0: aload_0
...
/* 145 */       //   0	8	1	o	Ljava/lang/Object; } public double x() { return this.x; } public double y() { return this.y; } public double z() { return this.z; } public float yRot() { return this.yRot; } public float xRot() { return this.xRot; }
/*     */      private String format() {
/* 147 */       return String.format(Locale.ROOT, "t %s %.2f %.2f %.2f %.2f %.2f\n", new Object[] { this.dimensionName, this.x, this.y, this.z, this.yRot, this.xRot });
/*     */     } }
/*     */ 
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/chase/ChaseServer.class
