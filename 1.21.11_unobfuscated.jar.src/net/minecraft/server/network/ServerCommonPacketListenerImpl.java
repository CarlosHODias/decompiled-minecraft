...
/* 104 */     PacketUtils.ensureRunningOnSameThread((Packet)packet, (PacketListener)this, this.server.packetProcessor());
/* 105 */     this.server.handleCustomClickAction(packet.id(), packet.payload());
/*     */   }
/*     */ 
/*     */   
/*     */   public void handleResourcePackResponse(ServerboundResourcePackPacket packet) {
/* 110 */     PacketUtils.ensureRunningOnSameThread((Packet)packet, (PacketListener)this, this.server.packetProcessor());
...
/* 179 */     disconnect(new DisconnectionDetails(reason));
/*     */   }
/*     */   
/*     */   public void disconnect(DisconnectionDetails details) {
/* 183 */     this.connection.send((Packet)new ClientboundDisconnectPacket(details.reason()), PacketSendListener.thenRun(() -> this.connection.disconnect(details)));
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/network/ServerCommonPacketListenerImpl.class
