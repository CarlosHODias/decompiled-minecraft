...
/*  60 */   private volatile State state = State.HELLO;
/*     */   private int tick;
/*     */   private String requestedUsername;
/*     */   private GameProfile authenticatedProfile;
/*  64 */   private final String serverId = "";
...
/*  80 */       verifyLoginAndFinishConnectionSetup(Objects.<GameProfile>requireNonNull(this.authenticatedProfile));
/*     */     }
/*     */     
/*  83 */     if (this.state == State.WAITING_FOR_DUPE_DISCONNECT && 
/*  84 */       !isPlayerAlreadyInWorld(Objects.<GameProfile>requireNonNull(this.authenticatedProfile))) {
/*  85 */       finishLoginAndWaitForClient(this.authenticatedProfile);
/*     */     }
/*     */ 
/*     */     
/*  89 */     if (this.tick++ == 600) {
/*  90 */       disconnect((Component)Component.translatable("multiplayer.disconnect.slow_login"));
/*     */     }
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isAcceptingMessages() {
/*  96 */     return this.connection.isConnected();
/*     */   }
/*     */   
/*     */   public void disconnect(Component component) {
/*     */     try {
/* 101 */       LOGGER.info("Disconnecting {}: {}", getUserName(), component.getString());
/* 102 */       this.connection.send((Packet)new ClientboundLoginDisconnectPacket(component));
...
/* 110 */     return (this.server.getPlayerList().getPlayer(gameProfile.id()) != null);
/*     */   }
/*     */ 
/*     */   
/*     */   public void onDisconnect(DisconnectionDetails details) {
/* 115 */     LOGGER.info("{} lost connection: {}", getUserName(), details.reason().getString());
/*     */   }
/*     */   
...
/* 141 */       this.connection.send((Packet)new ClientboundHelloPacket("", this.server.getKeyPair().getPublic().getEncoded(), this.challenge, true));
/*     */     } else {
...
/* 160 */         this.connection.send((Packet)new ClientboundLoginCompressionPacket(this.server.getCompressionThreshold()), PacketSendListener.thenRun(() -> this.connection.setupCompression(this.server.getCompressionThreshold(), true)));
/*     */       }
/*     */ 
/*     */       
...
/*     */     
/* 177 */     this.connection.send((Packet)new ClientboundLoginFinishedPacket(gameProfile));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       {
/*     */         public void run() {
/* 208 */           String name = Objects.<String>requireNonNull(ServerLoginPacketListenerImpl.this.requestedUsername, "Player name not initialized");
/*     */           try {
...
/*     */             } else {
/* 221 */               ServerLoginPacketListenerImpl.this.disconnect((Component)Component.translatable("multiplayer.disconnect.unverified_username"));
...
/*     */             } else {
/* 229 */               ServerLoginPacketListenerImpl.this.disconnect((Component)Component.translatable("multiplayer.disconnect.authservers_down"));
...
/*     */         }
/*     */       };
/* 240 */     thread.setUncaughtExceptionHandler((Thread.UncaughtExceptionHandler)new DefaultUncaughtExceptionHandler(LOGGER));
/* 241 */     thread.start();
/*     */   }
/*     */ 
/*     */ 
...
/* 247 */     disconnect(ServerCommonPacketListenerImpl.DISCONNECT_UNEXPECTED_QUERY);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 255 */     CommonListenerCookie cookie = CommonListenerCookie.createInitial(Objects.<GameProfile>requireNonNull(this.authenticatedProfile), this.transferred);
...
/* 257 */     this.connection.setupInboundProtocol(ConfigurationProtocols.SERVERBOUND, (PacketListener)configPacketListener);
...
/* 264 */     connectionDetails.setDetail("Login phase", () -> this.state.toString());
/*     */   }
/*     */ 
/*     */   
/*     */   public void handleCookieResponse(ServerboundCookieResponsePacket packet) {
/* 269 */     disconnect(ServerCommonPacketListenerImpl.DISCONNECT_UNEXPECTED_QUERY);
/*     */   }
/*     */   
/*     */   private enum State {
/* 273 */     HELLO,
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/network/ServerLoginPacketListenerImpl.class
