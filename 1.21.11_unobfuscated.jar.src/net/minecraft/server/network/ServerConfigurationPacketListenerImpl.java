...
/*     */ 
/*     */ public class ServerConfigurationPacketListenerImpl extends ServerCommonPacketListenerImpl implements ServerConfigurationPacketListener, net.minecraft.network.TickablePacketListener {
...
/*  85 */     send((Packet<?>)new net.minecraft.network.protocol.common.ClientboundCustomPayloadPacket((CustomPacketPayload)new BrandPayload(this.server.getServerModName())));
/*     */     
...
/*  94 */     send((Packet<?>)new ClientboundUpdateEnabledFeaturesPacket(net.minecraft.world.flag.FeatureFlags.REGISTRY.toNames(this.server.getWorldData().enabledFeatures())));
/*     */     
...
/* 131 */     this.clientInformation = packet.information();
/*     */   }
/*     */ 
/*     */   
...
/* 145 */     PacketUtils.ensureRunningOnSameThread((Packet)packet, (PacketListener)this, this.server.packetProcessor());
...
/* 160 */     PacketUtils.ensureRunningOnSameThread((Packet)packet, (PacketListener)this, this.server.packetProcessor());
...
/*     */     }
/*     */     
/* 215 */     ConfigurationTask task = this.configurationTasks.poll();
/* 216 */     if (task != null) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/server/network/ServerConfigurationPacketListenerImpl.class
