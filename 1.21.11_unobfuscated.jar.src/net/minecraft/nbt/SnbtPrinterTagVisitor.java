...
/*     */   static {
/*  21 */     KEY_ORDER = (Map<String, List<String>>)Util.make(Maps.newHashMap(), map -> {
...
/*  85 */     this.result = StringTag.quoteAndEscape(tag.value());
/*     */   }
/*     */ 
/*     */   
...
/* 100 */     this.result = String.valueOf(tag.value());
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 253 */     List<String> order = KEY_ORDER.get(pathString());
/* 254 */     if (order != null) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/nbt/SnbtPrinterTagVisitor.class
