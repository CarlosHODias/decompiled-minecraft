...
/*     */       
/*  38 */       try { CompoundTag compoundTag = readCompressed((InputStream)fastBufferedInputStream, accounter);
...
/*     */           throw throwable; }
/*  43 */      } private static DataInputStream createDecompressorStream(InputStream in) throws IOException { return new DataInputStream((InputStream)new FastBufferedInputStream(new GZIPInputStream(in))); }
/*     */ 
/*     */   
/*     */   private static DataOutputStream createCompressorStream(OutputStream out) throws IOException {
/*  47 */     return new DataOutputStream(new BufferedOutputStream(new GZIPOutputStream(out)));
/*     */   }
/*     */   
...
/*     */       
/*  61 */       try { parseCompressed((InputStream)fastBufferedInputStream, output, accounter);
...
/* 119 */     writeUnnamedTagWithFallback(tag, output);
/*     */   }
/*     */   
...
/* 174 */     writeUnnamedTag(tag, (DataOutput)new StringFallbackDataOutput(output));
/*     */   }
/*     */   
/*     */   @VisibleForTesting
...
/*     */     try {
/* 192 */       return (Tag)TagTypes.getType(type).load(input, accounter);
...
/* 196 */       category.setDetail("Tag type", type);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/nbt/NbtIo.class
