...
/*  72 */     this.result.append(quote).append((Component)mutableComponent).append(quote);
/*     */   }
/*     */ 
/*     */   
/*     */   public void visitByte(ByteTag tag) {
/*  77 */     this.result.append((Component)Component.literal(String.valueOf(tag.value())).withStyle(SYNTAX_HIGHLIGHTING_NUMBER)).append(BYTE_TYPE);
/*     */   }
/*     */ 
/*     */   
/*     */   public void visitShort(ShortTag tag) {
/*  82 */     this.result.append((Component)Component.literal(String.valueOf(tag.value())).withStyle(SYNTAX_HIGHLIGHTING_NUMBER)).append(SHORT_TYPE);
/*     */   }
/*     */ 
/*     */   
/*     */   public void visitInt(IntTag tag) {
/*  87 */     this.result.append((Component)Component.literal(String.valueOf(tag.value())).withStyle(SYNTAX_HIGHLIGHTING_NUMBER));
/*     */   }
/*     */ 
/*     */   
/*     */   public void visitLong(LongTag tag) {
/*  92 */     this.result.append((Component)Component.literal(String.valueOf(tag.value())).withStyle(SYNTAX_HIGHLIGHTING_NUMBER)).append(LONG_TYPE);
/*     */   }
/*     */ 
/*     */   
/*     */   public void visitFloat(FloatTag tag) {
/*  97 */     this.result.append((Component)Component.literal(String.valueOf(tag.value())).withStyle(SYNTAX_HIGHLIGHTING_NUMBER)).append(FLOAT_TYPE);
/*     */   }
/*     */ 
/*     */   
/*     */   public void visitDouble(DoubleTag tag) {
/* 102 */     this.result.append((Component)Component.literal(String.valueOf(tag.value())).withStyle(SYNTAX_HIGHLIGHTING_NUMBER)).append(DOUBLE_TYPE);
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 113 */       this.result.append(" ").append((Component)line).append(BYTE_ARRAY_TYPE);
/*     */       
...
/* 133 */       this.result.append(" ").append((Component)Component.literal(String.valueOf(data[i])).withStyle(SYNTAX_HIGHLIGHTING_NUMBER));
...
/* 168 */       return false;
/*     */     }
/* 170 */     for (Tag element : (Iterable<Tag>)list) {
...
/* 190 */       for (int j = 0; j < tag.size(); j++) {
/* 191 */         if (j != 0) {
/* 192 */           this.result.append(SPACED_ELEMENT_SEPARATOR);
/*     */         }
/* 194 */         appendSubTag(tag.get(j), false);
/*     */       } 
...
/* 279 */       return (Component)Component.literal(input).withStyle(SYNTAX_HIGHLIGHTING_KEY);
/*     */     }
/*     */     
...
/* 285 */     return (Component)Component.literal(quote).append((Component)mutableComponent).append(quote);
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/nbt/TextComponentTagVisitor.class
