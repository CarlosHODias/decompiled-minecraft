...
/*    */ {
/* 24 */   private static final DelayedException<CommandSyntaxException> ERROR_EXPECTED_STRING_UUID = DelayedException.create(new SimpleCommandExceptionType((Message)Component.translatable("snbt.parser.expected_string_uuid")));
/* 25 */   private static final DelayedException<CommandSyntaxException> ERROR_EXPECTED_NUMBER_OR_BOOLEAN = DelayedException.create(new SimpleCommandExceptionType((Message)Component.translatable("snbt.parser.expected_number_or_boolean")));
/*    */   
...
/* 37 */             return null;
/*    */           } 
/* 39 */           return (T)ops.createBoolean(result);
/*    */         }
/*    */         
...
/*    */           
/*    */           try {
/* 65 */             uuid = UUID.fromString(arg.get());
...
/*    */ 
/*    */   
/* 75 */   public static final SuggestionSupplier<StringReader> BUILTIN_IDS = new SuggestionSupplier<StringReader>() { private final Set<String> keys; {
/* 76 */         this
/*    */ 
/*    */           
/* 79 */           .keys = (Set<String>)Stream.concat(Stream.of((Object[])new String[] { "false", "true" }), SnbtOperations.BUILTIN_OPERATIONS.keySet().stream().map(SnbtOperations.BuiltinKey::id)).collect(Collectors.toSet());
/*    */       }
/*    */       
...
/*    */     private final String id; private final int argCount;
...
/*    */     }
/* 91 */     public BuiltinKey(String id, int argCount) { this.id = id; this.argCount = argCount; } public final boolean equals(Object o) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/* 91 */       //   0	8	1	o	Ljava/lang/Object; } public String id() { return this.id; } public int argCount() { return this.argCount; }
/*    */     
/*    */     public String toString() {
/* 94 */       return this.id + "/" + this.id;
/*    */     }
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/nbt/SnbtOperations.class
