...
/* 12 */    private static final java.util.HexFormat FORMAT = java.util.HexFormat.of().withUpperCase().withPrefix("0x");
/*    */   
...
/*    */   
/*    */   public static PngInfo fromStream(java.io.InputStream inputStream) throws IOException {
...
/* 43 */     return fromStream(new java.io.ByteArrayInputStream(bytes));
/*    */   }
/*    */   
/*    */   public static void validateHeader(ByteBuffer buffer) throws IOException {
/* 47 */     java.nio.ByteOrder order = buffer.order();
/* 48 */     buffer.order(java.nio.ByteOrder.BIG_ENDIAN);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/PngInfo.class
