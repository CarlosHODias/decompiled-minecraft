...
/*     */   static {
/*  46 */     PUBLIC_KEY_CODEC = Codec.STRING.comapFlatMap(rsaString -> {
/*     */           try {
...
/*  54 */     PRIVATE_KEY_CODEC = Codec.STRING.comapFlatMap(rsaString -> {
/*     */           try {
...
/*     */     try {
/*  64 */       KeyGenerator keyGenerator = KeyGenerator.getInstance("AES");
...
/*     */     try {
/*  74 */       KeyPairGenerator generator = KeyPairGenerator.getInstance("RSA");
...
/*     */     try {
/*  85 */       return digestData(new byte[][] {
/*  86 */             serverId.getBytes("ISO_8859_1"), 
/*  87 */             sharedKey.getEncoded(), 
/*  88 */             publicKey.getEncoded()
/*     */           });
...
/*     */     } 
/*     */     try {
/* 112 */       return byteArrayToKey.apply(Base64.getMimeDecoder().decode(input));
...
/* 119 */     return rsaStringToKey(rsaString, "-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", Crypt::byteToPrivateKey);
/*     */   }
/*     */   
/*     */   public static PublicKey stringToRsaPublicKey(String rsaString) throws CryptException {
/* 123 */     return rsaStringToKey(rsaString, "-----BEGIN RSA PUBLIC KEY-----", "-----END RSA PUBLIC KEY-----", Crypt::byteToPublicKey);
/*     */   }
/*     */   
...
/* 219 */       this(input.readLong(), input.readByteArray());
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/Crypt.class
