...
/* 27 */     this(valueStreamCodec, 0);
/*    */   }
/*    */   
/*    */   public Update<T> packUpdate(T value) {
/* 31 */     return new Update<>(this, Optional.ofNullable(value));
/*    */   }
/*    */   
/*    */   public Update<T> emptyUpdate() {
/* 35 */     return new Update<>(this, Optional.empty());
/*    */   }
/*    */   
/*    */   public Event<T> packEvent(T value) {
/* 39 */     return new Event<>(this, value);
/*    */   }
/*    */ 
/*    */   
/*    */   public String toString() {
/* 44 */     return Util.getRegisteredName(BuiltInRegistries.DEBUG_SUBSCRIPTION, this);
/*    */   }
/*    */   
/*    */   public StreamCodec<? super RegistryFriendlyByteBuf, T> valueStreamCodec() {
/* 48 */     return this.valueStreamCodec;
/*    */   }
/*    */   
/*    */   public int expireAfterTicks() {
/* 52 */     return this.expireAfterTicks;
/*    */   }
...
/* 63 */       return ByteBufCodecs.optional(Objects.<StreamCodec>requireNonNull(subscription.valueStreamCodec))
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/* 68 */       //   0	8	0	this	Lnet/minecraft/util/debug/DebugSubscription$Event<TT;>; } public DebugSubscription<T> subscription() { return this.subscription; } public T value() { return this.value; }
/*    */ 
/*    */ 
/*    */     
...
/* 76 */       return ((StreamCodec)Objects.<StreamCodec>requireNonNull(subscription.valueStreamCodec)).map(value -> new Event(subscription, value), Event::value);
/*    */     } }
/*    */ 
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/debug/DebugSubscription.class
