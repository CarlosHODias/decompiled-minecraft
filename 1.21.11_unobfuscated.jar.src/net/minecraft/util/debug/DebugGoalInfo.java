...
/*    */   private final java.util.List<DebugGoal> goals;
/*    */   
/*  9 */   public DebugGoalInfo(java.util.List<DebugGoal> goals) { this.goals = goals; } public final String toString() { // Byte code:
/*    */     //   0: aload_0
...
/*  9 */     //   0	7	0	this	Lnet/minecraft/util/debug/DebugGoalInfo; } public java.util.List<DebugGoal> goals() { return this.goals; }
...
/* 10 */     //   0	8	1	o	Ljava/lang/Object; } public static final StreamCodec<io.netty.buffer.ByteBuf, DebugGoalInfo> STREAM_CODEC = StreamCodec.composite(
/* 11 */       DebugGoal.STREAM_CODEC.apply(ByteBufCodecs.list()), DebugGoalInfo::goals, DebugGoalInfo::new);
...
/* 16 */      public static final StreamCodec<io.netty.buffer.ByteBuf, DebugGoal> STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.VAR_INT, DebugGoal::priority, ByteBufCodecs.BOOL, DebugGoal::isRunning, 
/*    */ 
/*    */         
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/debug/DebugGoalInfo.class
