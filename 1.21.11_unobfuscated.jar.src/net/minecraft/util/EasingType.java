...
/*  12 */   public static final ExtraCodecs.LateBoundIdMapper<String, EasingType> SIMPLE_REGISTRY = new ExtraCodecs.LateBoundIdMapper<>(); public static final Codec<EasingType> CODEC;
/*     */   static {
/*  14 */     CODEC = Codec.either(SIMPLE_REGISTRY.codec((Codec<String>)Codec.STRING), CubicBezier.CODEC).xmap(Either::unwrap, easing -> {
/*     */           CubicBezier bezier = (CubicBezier)easing;
/*     */           return (easing instanceof CubicBezier) ? Either.right(bezier) : Either.left(easing);
/*     */         });
/*     */   }
/*  19 */   public static final EasingType CONSTANT = registerSimple("constant", x -> 0.0F); public static final EasingType LINEAR; static {
/*  20 */     LINEAR = registerSimple("linear", x -> x);
/*     */   }
...
/*  61 */     return new CubicBezier(new CubicBezierControls(x1, y1, x2, y2));
/*     */   }
/*     */   
/*     */   static EasingType symmetricCubicBezier(float x1, float y1) {
/*  65 */     return cubicBezier(x1, y1, 1.0F - x1, 1.0F - y1);
/*     */   }
/*     */   float apply(float paramFloat);
/*     */   public static final class CubicBezier implements EasingType { public static final Codec<CubicBezier> CODEC; private static final int NEWTON_RAPHSON_ITERATIONS = 4; private final EasingType.CubicBezierControls controls; private final CubicCurve xCurve; private final CubicCurve yCurve;
/*     */     
/*     */     static {
/*  71 */       CODEC = RecordCodecBuilder.create(i -> i.group((App)EasingType.CubicBezierControls.CODEC.fieldOf("cubic_bezier").forGetter(())).apply((Applicative)i, CubicBezier::new));
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*  90 */       return new CubicCurve(3.0F * v1 - 3.0F * v2 + 1.0F, -6.0F * v1 + 3.0F * v2, 3.0F * v1);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 113 */       if (obj instanceof CubicBezier) { CubicBezier bezier = (CubicBezier)obj; if (this.controls.equals(bezier.controls)); }  return false;
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
/* 118 */       return this.controls.hashCode();
/*     */     }
/*     */ 
/*     */     
/*     */     public String toString() {
/* 123 */       return "CubicBezier(" + this.controls.x1 + ", " + this.controls.y1 + ", " + this.controls.x2 + ", " + this.controls.y2 + ")";
/*     */     }
...
/* 128 */         return ((this.a * t + this.b) * t + this.c) * t;
/*     */       }
/*     */       
/*     */       public float sampleGradient(float t) {
/* 132 */         return (3.0F * this.a * t + 2.0F * this.b) * t + this.c; } } } private static final class CubicCurve extends Record { private final float a; private final float b; private final float c; private CubicCurve(float a, float b, float c) { this.a = a; this.b = b; this.c = c; } public final String toString() { // Byte code:
/*     */       //   0: aload_0
/*     */       //   1: <illegal opcode> toString : (Lnet/minecraft/util/EasingType$CubicBezier$CubicCurve;)Ljava/lang/String;
/*     */       //   6: areturn
/*     */       // Line number table:
...
/*     */       // Local variable table:
/*     */       //   start	length	slot	name	descriptor
/* 132 */       //   0	7	0	this	Lnet/minecraft/util/EasingType$CubicBezier$CubicCurve; } public float sampleGradient(float t) { return (3.0F * this.a * t + 2.0F * this.b) * t + this.c; }
...
/*     */       //   start	length	slot	name	descriptor
/*     */       //   0	8	0	this	Lnet/minecraft/util/EasingType$CubicBezier$CubicCurve;
/*     */       //   0	8	1	o	Ljava/lang/Object; } public float a() { return this.a; } public float b() { return this.b; } public float c() { return this.c; } public float sample(float t) { return ((this.a * t + this.b) * t + this.c) * t; } }
/*     */    public static final class CubicBezierControls extends Record
/*     */   {
/* 137 */     private final float x1; private final float y1; private final float x2; private final float y2; public static final Codec<CubicBezierControls> CODEC; public CubicBezierControls(float x1, float y1, float x2, float y2) { this.x1 = x1; this.y1 = y1; this.x2 = x2; this.y2 = y2; } public final String toString() { // Byte code:
/*     */       //   0: aload_0
...
/*     */     
/*     */     static {
/* 144 */       CODEC = Codec.FLOAT.listOf(4, 4).xmap(floats -> new CubicBezierControls((Float)floats.get(0), (Float)floats.get(1), (Float)floats.get(2), (Float)floats.get(3)), controls -> List.of(controls.x1, controls.y1, controls.x2, controls.y2)).validate(CubicBezierControls::validate);
/*     */     }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/EasingType.class
