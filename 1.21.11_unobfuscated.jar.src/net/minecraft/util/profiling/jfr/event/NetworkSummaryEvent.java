...
/* 23 */   public static final EventType TYPE = EventType.getEventType((Class)NetworkSummaryEvent.class);
/*    */   
/*    */   @Name("remoteAddress")
...
/*    */   {
/* 63 */     private final AtomicLong sentBytes = new AtomicLong();
/* 64 */     private final AtomicInteger sentPackets = new AtomicInteger();
/* 65 */     private final AtomicLong receivedBytes = new AtomicLong();
/* 66 */     private final AtomicInteger receivedPackets = new AtomicInteger();
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/profiling/jfr/event/NetworkSummaryEvent.class
