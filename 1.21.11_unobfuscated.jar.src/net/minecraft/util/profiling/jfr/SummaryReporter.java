...
/* 23 */     this.onDeregistration = onDeregistration;
/*    */   }
...
/* 59 */       LOGGER.info(message.get());
/*    */     } else {
/* 61 */       Bootstrap.realStdoutPrintln(message.get());
/*    */     } 
/*    */   }
/*    */ 
/*    */ 
...
/* 73 */       LOGGER.warn(message.get(), t);
/*    */     } else {
/* 75 */       Bootstrap.realStdoutPrintln(message.get());
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/profiling/jfr/SummaryReporter.class
