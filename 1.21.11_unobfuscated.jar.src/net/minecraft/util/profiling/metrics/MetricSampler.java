...
/*  40 */     return new MetricSampler(name, category, sampler, null, null);
/*     */   }
/*     */   
/*     */   public static <T> MetricSampler create(String metricName, MetricCategory category, T context, ToDoubleFunction<T> sampler) {
/*  44 */     return builder(metricName, category, sampler, context).build();
/*     */   }
/*     */   
...
/*     */     } 
/* 114 */     return new SamplerResult(firstTick, lastTick, (Int2DoubleMap)int2DoubleOpenHashMap);
/*     */   }
/*     */   
...
/* 154 */       return this.recording.get(tick);
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/profiling/metrics/MetricSampler.class
