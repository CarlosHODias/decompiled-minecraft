...
/*  65 */     return new ActiveMetricsRecorder(metricsSamplerProvider, timeSource, ioExecutor, metricsPersister, onProfilingEnd, onReportFinished);
/*     */   }
/*     */ 
/*     */   
...
/* 110 */         ((List<RecordedDeviation>)this.deviationsBySampler.computeIfAbsent(sampler, ignored -> Lists.newArrayList())).add(recordedDeviation);
/*     */       } 
/*     */     } 
/*     */     
...
/* 143 */     HashSet<MetricSampler> metricSamplers = new HashSet<>(this.thisTickSamplers);
...
/* 162 */     globalOnReportFinished = onFinished;
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/profiling/metrics/profiling/ActiveMetricsRecorder.class
