...
/* 105 */     this.chartedPaths.add(Pair.of(this.path, category));
/*     */   }
/*     */ 
/*     */   
/*     */   public void pop() {
...
/* 130 */       LOGGER.warn("Something's taking too long! '{}' took aprox {} ms", LogUtils.defer(() -> ProfileResults.demanglePath(this.path)), LogUtils.defer(() -> time / 1000000.0D));
/*     */     }
/*     */     
...
/* 151 */       this.currentEntry = this.entries.computeIfAbsent(this.path, key -> new PathEntry());
/*     */     }
/*     */     
...
/* 159 */     (getCurrentEntry()).counters.addTo(name, amount);
/*     */   }
/*     */ 
/*     */   
/*     */   public void incrementCounter(Supplier<String> name, int amount) {
/* 164 */     (getCurrentEntry()).counters.addTo(name.get(), amount);
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*     */   public PathEntry getEntry(String path) {
/* 174 */     return this.entries.get(path);
/*     */   }
/*     */ 
/*     */   
...
/* 183 */     private long maxDuration = Long.MIN_VALUE;
/* 184 */     private long minDuration = Long.MAX_VALUE;
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/profiling/ActiveProfiler.class
