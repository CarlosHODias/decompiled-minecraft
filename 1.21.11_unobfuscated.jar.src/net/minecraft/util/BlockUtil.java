...
/*     */ 
/*     */     
/*  83 */     int negativeDelta1 = getLimit(test, pos.set((Vec3i)center), negativeDirection1, limit1);
/*  84 */     int positiveDelta1 = getLimit(test, pos.set((Vec3i)center), positiveDirection1, limit1);
/*     */     
/*  86 */     int centerIndex1 = negativeDelta1;
/*  87 */     IntBounds[] boundsByAxis1 = new IntBounds[centerIndex1 + 1 + positiveDelta1];
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 103 */     boundsByAxis1[centerIndex1] = new IntBounds(
/* 104 */         getLimit(test, pos.set((Vec3i)center), negativeDirection2, limit2), 
/* 105 */         getLimit(test, pos.set((Vec3i)center), positiveDirection2, limit2));
/*     */ 
/*     */     
/* 108 */     int centerIndex2 = (boundsByAxis1[centerIndex1]).min;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 129 */       IntBounds lastBounds = boundsByAxis1[centerIndex1 - i - 1];
/* 130 */       boundsByAxis1[centerIndex1 - i] = new IntBounds(
/* 131 */           getLimit(test, pos.set((Vec3i)center).move(negativeDirection1, i), negativeDirection2, lastBounds.min), 
/* 132 */           getLimit(test, pos.set((Vec3i)center).move(negativeDirection1, i), positiveDirection2, lastBounds.max));
/*     */     } 
/*     */ 
/*     */     
/* 136 */     for (int j = 1; j <= positiveDelta1; j++) {
/* 137 */       IntBounds lastBounds = boundsByAxis1[centerIndex1 + j - 1];
/* 138 */       boundsByAxis1[centerIndex1 + j] = new IntBounds(
/* 139 */           getLimit(test, pos.set((Vec3i)center).move(positiveDirection1, j), negativeDirection2, lastBounds.min), 
/* 140 */           getLimit(test, pos.set((Vec3i)center).move(positiveDirection1, j), positiveDirection2, lastBounds.max));
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/* 161 */     int sizeAxis2 = 0;
/*     */     
/* 163 */     int[] columns = new int[boundsByAxis1.length];
/*     */     
/* 165 */     for (int i2 = centerIndex2; i2 >= 0; i2--) {
/* 166 */       for (int i1 = 0; i1 < boundsByAxis1.length; i1++) {
/* 167 */         IntBounds bounds2 = boundsByAxis1[i1];
...
/* 177 */       int newSizeAxis2 = (Integer)rectangle.getSecond();
/*     */       
...
/*     */     } 
/*     */     
/* 187 */     return new FoundRectangle(
/* 188 */         center.relative(axis1, minAxis1 - centerIndex1).relative(axis2, minAxis2 - centerIndex2), sizeAxis1, sizeAxis2);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     } 
/*     */     
/* 234 */     return new Pair(new IntBounds(maxStart, maxEnd - 1), maxHeight);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 247 */       forwardState = level.getBlockState((BlockPos)forwardPos);
/* 248 */     } while (forwardState.is(bodyBlock));
/*     */     
/* 250 */     if (forwardState.is(headBlock)) {
/* 251 */       return (Optional)Optional.of(forwardPos);
/*     */     }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/BlockUtil.class
