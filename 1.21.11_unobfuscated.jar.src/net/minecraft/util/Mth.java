...
/*     */   
/*     */   static {
/*  45 */     SIN = Util.<float[]>make(new float[65536], sin -> {
/*     */           for (int i = 0; i < sin.length; i++)
/*     */             sin[i] = (float)Math.sin(i / 10430.378350470453D); 
/*     */         });
/*     */   }
...
/*  54 */     return SIN[(int)((long)(i * 10430.378350470453D) & 0xFFFFL)];
/*     */   }
/*     */   
/*     */   public static float cos(double i) {
/*  58 */     return SIN[(int)((long)(i * 10430.378350470453D + 16384.0D) & 0xFFFFL)];
/*     */   }
/*     */   
/*     */   public static float sqrt(float x) {
/*  62 */     return (float)Math.sqrt(x);
/*     */   }
/*     */   
...
/* 104 */     return Math.min(Math.max(value, min), max);
/*     */   }
/*     */   
...
/* 150 */     return Math.max(Math.abs(a), Math.abs(b));
/*     */   }
/*     */   
/*     */   public static float absMax(float a, float b) {
/* 154 */     return Math.max(Math.abs(a), Math.abs(b));
/*     */   }
/*     */   
/*     */   public static double absMax(double a, double b) {
/* 158 */     return Math.max(Math.abs(a), Math.abs(b));
/*     */   }
/*     */   
/*     */   public static int chessboardDistance(int x0, int z0, int x1, int z1) {
/* 162 */     return absMax(x1 - x0, z1 - z0);
/*     */   }
/*     */   
/*     */   public static int floorDiv(int a, int b) {
/* 166 */     return Math.floorDiv(a, b);
/*     */   }
/*     */   
...
/* 218 */     return (byte)floor(angle * 256.0F / 360.0F);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 289 */     return wrapDegrees(toAngle - fromAngle);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 297 */     return abs(degreesDifference(angleA, angleB));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 327 */     return NumberUtils.toInt(input, def);
/*     */   }
/*     */ 
/*     */   
...
/* 350 */     return (input != 0 && (input & input - 1) == 0);
/*     */   }
/*     */ 
/*     */   
...
/* 360 */     return MULTIPLY_DE_BRUIJN_BIT_POSITION[(int)(input * 125613361L >> 27L) & 0x1F];
/*     */   }
/*     */   
/*     */   public static int log2(int input) {
/* 364 */     return ceillog2(input) - (isPowerOfTwo(input) ? 0 : 1);
/*     */   }
/*     */   
/*     */   public static float frac(float num) {
/* 368 */     return num - floor(num);
/*     */   }
/*     */   
/*     */   public static double frac(double num) {
/* 372 */     return num - lfloor(num);
/*     */   }
/*     */   
/*     */   @Deprecated
/*     */   public static long getSeed(Vec3i vec) {
/* 377 */     return getSeed(vec.getX(), vec.getY(), vec.getZ());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 394 */     long least = random.nextLong() & 0x3FFFFFFFFFFFFFFFL | Long.MIN_VALUE;
...
/* 520 */     return Math.invsqrt(x);
/*     */   }
/*     */   
/*     */   public static double invSqrt(double x) {
/* 524 */     return Math.invsqrt(x);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 537 */     i = 6910469410427058090L - (i >> 1L);
/* 538 */     x = Double.longBitsToDouble(i);
/* 539 */     x *= 1.5D - xhalf * x * x;
/* 540 */     return x;
/*     */   }
/*     */   
...
/* 546 */     float y = Float.intBitsToFloat(i);
/* 547 */     y = 0.6666667F * y + 1.0F / 3.0F * y * y * x;
/* 548 */     y = 0.6666667F * y + 1.0F / 3.0F * y * y * x;
/* 549 */     return y;
/*     */   }
/*     */ 
/*     */ 
...
/* 570 */     return hsvToArgb(hue, saturation, value, 0);
/*     */   }
...
/* 665 */     return p0 + floor(alpha1 * (p1 - p0));
/*     */   }
/*     */ 
/*     */   
...
/* 709 */     return 0.5F * (2.0F * p1 + (p2 - p0) * alpha + (2.0F * p0 - 5.0F * p1 + 4.0F * p2 - p3) * alpha * alpha + (3.0F * p1 - p0 - 3.0F * p2 + p3) * alpha * alpha * alpha);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 722 */     return x * x * x * (x * (x * 6.0D - 15.0D) + 10.0D);
/*     */   }
/*     */ 
/*     */   
/*     */   public static double smoothstepDerivative(double x) {
/* 727 */     return 30.0D * x * x * (x - 1.0D) * (x - 1.0D);
/*     */   }
/*     */   
...
/* 738 */     return from + a * wrapDegrees(to - from);
/*     */   }
/*     */   
/*     */   public static double rotLerp(double a, double from, double to) {
/* 742 */     return from + a * wrapDegrees(to - from);
/*     */   }
/*     */   
...
/* 765 */     return (Math.abs(index % period - period * 0.5F) - period * 0.25F) / period * 0.25F;
/*     */   }
/*     */   
...
/* 793 */     return clampedLerp(inverseLerp(value, fromMin, fromMax), toMin, toMax);
/*     */   }
/*     */   
/*     */   public static float clampedMap(float value, float fromMin, float fromMax, float toMin, float toMax) {
/* 797 */     return clampedLerp(inverseLerp(value, fromMin, fromMax), toMin, toMax);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 804 */     return lerp(inverseLerp(value, fromMin, fromMax), toMin, toMax);
/*     */   }
/*     */   
/*     */   public static float map(float value, float fromMin, float fromMax, float toMin, float toMax) {
/* 808 */     return lerp(inverseLerp(value, fromMin, fromMax), toMin, toMax);
/*     */   }
/*     */   
/*     */   public static double wobble(double coord) {
/* 812 */     return coord + (2.0D * RandomSource.create(floor(coord * 3000.0D)).nextDouble() - 1.0D) * 1.0E-7D / 2.0D;
/*     */   }
/*     */   
/*     */   public static int roundToward(int input, int multiple) {
/* 816 */     return positiveCeilDiv(input, multiple) * multiple;
/*     */   }
/*     */   
/*     */   public static int positiveCeilDiv(int input, int divisor) {
/* 820 */     return -Math.floorDiv(-input, divisor);
/*     */   }
/*     */   
/*     */   public static int randomBetweenInclusive(RandomSource random, int min, int maxInclusive) {
/* 824 */     return random.nextInt(maxInclusive - min + 1) + min;
/*     */   }
/*     */   
/*     */   public static float randomBetween(RandomSource random, float min, float maxExclusive) {
/* 828 */     return random.nextFloat() * (maxExclusive - min) + min;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 835 */     return mean + (float)random.nextGaussian() * deviation;
/*     */   }
/*     */   
...
/* 843 */     return Math.sqrt(lengthSquared(x, y));
/*     */   }
/*     */   
/*     */   public static float length(float x, float y) {
/* 847 */     return (float)Math.sqrt(lengthSquared(x, y));
/*     */   }
/*     */   
/*     */   public static double lengthSquared(double x, double y, double z) {
/* 851 */     return x * x + y * y + z * z;
/*     */   }
/*     */   
/*     */   public static double length(double x, double y, double z) {
/* 855 */     return Math.sqrt(lengthSquared(x, y, z));
/*     */   }
/*     */   
/*     */   public static float lengthSquared(float x, float y, float z) {
/* 859 */     return x * x + y * y + z * z;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 866 */     return floor(value / quantizeResolution) * quantizeResolution;
/*     */   }
/*     */   
/*     */   public static IntStream outFromOrigin(int origin, int lowerBound, int upperBound) {
/* 870 */     return outFromOrigin(origin, lowerBound, upperBound, 1);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 879 */       throw new IllegalArgumentException(String.format(Locale.ROOT, "upperBound %d expected to be > lowerBound %d", new Object[] { upperBound, lowerBound }));
/*     */     }
/*     */     
/* 882 */     if (stepSize < 1) {
/* 883 */       throw new IllegalArgumentException(String.format(Locale.ROOT, "step size expected to be >= 1, was %d", new Object[] { stepSize }));
/*     */     }
/*     */     
...
/* 912 */     return fraction.getNumerator() * factor / fraction.getDenominator();
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/Mth.class
