...
/*  80 */     return iterateFormatted(string, 0, style, output);
/*     */   }
/*     */   
/*     */   public static boolean iterateFormatted(String string, int offset, Style style, FormattedCharSink output) {
/*  84 */     return iterateFormatted(string, offset, style, style, output);
/*     */   }
/*     */   
...
/* 128 */     return component.visit((style, contents) -> iterateFormatted(contents, 0, style, output) ? Optional.empty() : STOP_ITERATION, rootStyle).isEmpty();
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/StringDecomposer.class
