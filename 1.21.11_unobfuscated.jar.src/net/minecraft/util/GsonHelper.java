...
/* 147 */       return (Holder<Item>)BuiltInRegistries.ITEM.get(Identifier.parse(itemName))
...
/* 471 */       return convertToObject(object.get(name), name, context, clazz);
/*     */     }
...
/* 480 */       return convertToObject(object.get(name), name, context, clazz);
/*     */     }
/* 482 */     return def;
/*     */   }
/*     */ 
...
/* 537 */     T result = fromNullableJson(gson, reader, type);
/* 538 */     if (result == null) {
...
/*     */   }
/*     */   
/*     */   public static <T> T fromNullableJson(Gson gson, String string, TypeToken<T> type) {
/* 545 */     return fromNullableJson(gson, new StringReader(string), type);
/*     */   }
/*     */   
/*     */   public static <T> T fromJson(Gson gson, String string, Class<T> type) {
/* 549 */     return fromJson(gson, new StringReader(string), type);
/*     */   }
/*     */   
/*     */   public static JsonObject parse(String string) {
/* 553 */     return parse(new StringReader(string));
/*     */   }
/*     */   
/*     */   public static JsonObject parse(Reader reader) {
/* 557 */     return fromJson(GSON, reader, JsonObject.class);
/*     */   }
/*     */   
/*     */   public static JsonArray parseArray(String string) {
/* 561 */     return parseArray(new StringReader(string));
/*     */   }
/*     */   
/*     */   public static JsonArray parseArray(Reader reader) {
/* 565 */     return fromJson(GSON, reader, JsonArray.class);
/*     */   }
/*     */   
...
/* 596 */       out.beginArray();
/* 597 */       for (JsonElement e : (Iterable<JsonElement>)value.getAsJsonArray()) {
...
/* 604 */         out.name(e.getKey());
/* 605 */         writeValue(out, e.getValue(), keyComparator);
/*     */       } 
/* 607 */       out.endObject();
/*     */     } else {
...
/* 615 */       return elements;
/*     */     }
/* 617 */     List<Map.Entry<String, JsonElement>> sorted = new ArrayList<>(elements);
/* 618 */     sorted.sort((Comparator)Map.Entry.comparingByKey(keyComparator));
/* 619 */     return sorted;
/*     */   }
/*     */   
...
/* 651 */       return accountChars(csq.length());
/*     */     }
/*     */ 
/*     */     
/*     */     public Appendable append(CharSequence csq, int start, int end) {
/* 656 */       return accountChars(end - start);
/*     */     }
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/GsonHelper.class
