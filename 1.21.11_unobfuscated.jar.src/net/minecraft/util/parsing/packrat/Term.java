...
/*  10 */     return new Marker<>(name, value);
/*     */   }
...
/*     */       // Local variable type table:
/*     */       //   start	length	slot	name	signature
/*  13 */       //   0	8	0	this	Lnet/minecraft/util/parsing/packrat/Term$Marker<TS;TT;>; } public T value() { return this.value; }
/*     */     
...
/*  23 */     return new Sequence<>(terms);
/*     */   }
/*     */   public static final class Sequence<S> extends Record implements Term<S> { private final Term<S>[] elements;
/*  26 */     public Sequence(Term<S>[] elements) { this.elements = elements; } public final String toString() { // Byte code:
/*     */       //   0: aload_0
...
/*  42 */     return new Alternative<>(terms);
/*     */   }
/*     */   public static final class Alternative<S> extends Record implements Term<S> { private final Term<S>[] elements;
/*  45 */     public Alternative(Term<S>[] elements) { this.elements = elements; } public final String toString() { // Byte code:
/*     */       //   0: aload_0
...
/*  88 */     return repeated(element, listName, 0);
/*     */   }
/*     */   
/*     */   static <S, T> Term<S> repeated(NamedRule<S, T> element, Atom<List<T>> listName, int minRepetitions) {
/*  92 */     return new Repeated<>(element, listName, minRepetitions);
/*     */   }
...
/*     */      public boolean parse(ParseState<S> state, Scope scope, Control control) {
/*     */       int entryMark;
/*  98 */       int mark = state.mark();
/*  99 */       List<T> elements = new ArrayList<>(this.minRepetitions);
/*     */       
/*     */       while (true) {
/* 102 */         entryMark = state.mark();
/* 103 */         T parsedElement = state.parse(this.element);
...
/* 122 */     return repeatedWithTrailingSeparator(element, listName, separator, 0);
/*     */   }
/*     */   
...
/* 126 */     return new RepeatedWithSeparator<>(element, listName, separator, minRepetitions, true);
/*     */   }
/*     */   
/*     */   static <S, T> Term<S> repeatedWithoutTrailingSeparator(NamedRule<S, T> element, Atom<List<T>> listName, Term<S> separator) {
/* 130 */     return repeatedWithoutTrailingSeparator(element, listName, separator, 0);
/*     */   }
/*     */   
...
/* 134 */     return new RepeatedWithSeparator<>(element, listName, separator, minRepetitions, false);
/*     */   }
/*     */   public static final class RepeatedWithSeparator<S, T> extends Record implements Term<S> { private final NamedRule<S, T> element; private final Atom<List<T>> listName; private final Term<S> separator;
...
/* 144 */       List<T> elements = new ArrayList<>(this.minRepetitions);
/*     */       
/*     */       boolean first = true;
/*     */       while (true) {
...
/* 157 */         T parsedElement = state.parse(this.element);
...
/* 192 */     return new LookAhead<>(term, true);
/*     */   }
/*     */   
/*     */   static <S> Term<S> negativeLookahead(Term<S> term) {
/* 196 */     return new LookAhead<>(term, false);
/*     */   }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/parsing/packrat/Term.class
