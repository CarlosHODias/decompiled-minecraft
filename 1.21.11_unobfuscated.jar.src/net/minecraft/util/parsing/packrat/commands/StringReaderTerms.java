...
/* 18 */     return new TerminalWord(value);
/*    */   }
/*    */   
...
/*    */   }
/*    */   
/*    */   public static abstract class TerminalCharacters implements Term<StringReader> {
/*    */     private final DelayedException<CommandSyntaxException> error;
/*    */     private final SuggestionSupplier<StringReader> suggestions;
/*    */     
/*    */     public TerminalCharacters(CharList values) {
/* 55 */       String joinedValues = values.intStream().<CharSequence>mapToObj(Character::toString).collect(Collectors.joining("|"));
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/parsing/packrat/commands/StringReaderTerms.class
