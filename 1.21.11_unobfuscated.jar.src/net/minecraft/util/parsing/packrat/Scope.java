...
/*  84 */     this.stack[this.topEntryKeyIndex + 1] = this.topMarkerKeyIndex;
...
/*  95 */     return (Integer)this.stack[markerKeyIndex + 1];
/*     */   }
/*     */   
...
/* 193 */     return (valueIndex != -1) ? (T)this.stack[valueIndex] : null;
/*     */   }
/*     */ 
/*     */   
...
/* 208 */     return (valueIndex != -1) ? (T)this.stack[valueIndex] : fallback;
/*     */   }
/*     */ 
/*     */   
/*     */   @SafeVarargs
/*     */   public final <T> T getAny(Atom<? extends T>... names) {
/* 214 */     int valueIndex = valueIndexForAny((Atom<?>[])names);
/* 215 */     return (valueIndex != -1) ? (T)this.stack[valueIndex] : null;
/*     */   }
/*     */ 
/*     */   
/*     */   @SafeVarargs
/*     */   public final <T> T getAnyOrThrow(Atom<? extends T>... names) {
/* 221 */     int valueIndex = valueIndexForAny((Atom<?>[])names);
/* 222 */     if (valueIndex == -1) {
...
/* 251 */     HashMap<Atom<?>, Object> result = new HashMap<>();
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/parsing/packrat/Scope.class
