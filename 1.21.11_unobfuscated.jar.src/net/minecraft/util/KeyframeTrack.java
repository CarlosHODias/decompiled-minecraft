...
/*    */   }
/*    */   public static <T> com.mojang.serialization.MapCodec<KeyframeTrack<T>> mapCodec(Codec<T> valueCodec) {
/* 26 */     Codec<List<Keyframe<T>>> keyframesCodec = Keyframe.<T>codec(valueCodec).listOf().validate(KeyframeTrack::validateKeyframes);
/* 27 */     return RecordCodecBuilder.mapCodec(i -> i.group((App)keyframesCodec.fieldOf("keyframes").forGetter(KeyframeTrack::keyframes), (App)EasingType.CODEC.optionalFieldOf("ease", EasingType.LINEAR).forGetter(KeyframeTrack::easingType)).apply((Applicative)i, KeyframeTrack::new));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/*    */     }
/* 37 */     if (!com.google.common.collect.Comparators.isInOrder(keyframes, java.util.Comparator.comparingInt(Keyframe::ticks))) {
...
/*    */   }
/*    */   
/*    */   public KeyframeTrackSampler<T> bakeSampler(java.util.Optional<Integer> periodTicks, net.minecraft.world.attribute.LerpFunction<T> lerp) {
/* 68 */     return new KeyframeTrackSampler<>(this, periodTicks, lerp);
/*    */   }
/*    */   
...
/* 86 */       List<Keyframe<T>> keyframes = (List<Keyframe<T>>)KeyframeTrack.<T>validateKeyframes((List<Keyframe<T>>)this.keyframes.build()).getOrThrow();
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/KeyframeTrack.class
