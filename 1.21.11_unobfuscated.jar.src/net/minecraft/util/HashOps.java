...
/*  58 */   private static final byte[] EMPTY_PAYLOAD = new byte[] { 1 };
/*  59 */   private static final byte[] FALSE_PAYLOAD = new byte[] { 13, 0 };
/*  60 */   private static final byte[] TRUE_PAYLOAD = new byte[] { 13, 1 };
/*     */   
/*  62 */   public static final byte[] EMPTY_MAP_PAYLOAD = new byte[] { 2, 3 };
/*  63 */   public static final byte[] EMPTY_LIST_PAYLOAD = new byte[] { 4, 5 };
/*     */   
...
/*     */   
/*  69 */   private static final Comparator<Map.Entry<HashCode, HashCode>> MAP_ENTRY_ORDER = Map.Entry.<HashCode, HashCode>comparingByKey(HASH_COMPARATOR)
/*  70 */     .thenComparing((Comparator)Map.Entry.comparingByValue(HASH_COMPARATOR));
/*     */   
/*  72 */   private static final Comparator<Pair<HashCode, HashCode>> MAPLIKE_ENTRY_ORDER = Comparator.<Pair<HashCode, HashCode>, HashCode>comparing(Pair::getFirst, HASH_COMPARATOR)
...
/* 103 */     return this.emptyMap;
/*     */   }
/*     */ 
/*     */   
/*     */   public HashCode emptyList() {
/* 108 */     return this.emptyList;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 127 */     return this.hashFunction.newHasher(2).putByte((byte)6).putByte(value).hash();
/*     */   }
/*     */ 
/*     */   
/*     */   public HashCode createShort(short value) {
/* 132 */     return this.hashFunction.newHasher(3).putByte((byte)7).putShort(value).hash();
/*     */   }
/*     */ 
/*     */   
/*     */   public HashCode createInt(int value) {
/* 137 */     return this.hashFunction.newHasher(5).putByte((byte)8).putInt(value).hash();
/*     */   }
/*     */ 
/*     */   
/*     */   public HashCode createLong(long value) {
/* 142 */     return this.hashFunction.newHasher(9).putByte((byte)9).putLong(value).hash();
/*     */   }
/*     */ 
/*     */   
/*     */   public HashCode createFloat(float value) {
/* 147 */     return this.hashFunction.newHasher(5).putByte((byte)10).putFloat(value).hash();
/*     */   }
/*     */ 
/*     */   
/*     */   public HashCode createDouble(double value) {
/* 152 */     return this.hashFunction.newHasher(9).putByte((byte)11).putDouble(value).hash();
/*     */   }
/*     */ 
/*     */   
/*     */   public HashCode createString(String value) {
/* 157 */     return this.hashFunction.newHasher().putByte((byte)12).putInt(value.length()).putUnencodedChars(value).hash();
/*     */   }
/*     */ 
/*     */   
/*     */   public HashCode createBoolean(boolean value) {
/* 162 */     return value ? this.trueHash : this.falseHash;
/*     */   }
/*     */   
...
/* 181 */     return hashMap(this.hashFunction.newHasher(), map).hash();
/*     */   }
/*     */ 
/*     */   
/*     */   public HashCode createMap(Map<HashCode, HashCode> map) {
/* 186 */     return hashMap(this.hashFunction.newHasher(), map).hash();
/*     */   }
/*     */ 
/*     */   
...
/* 233 */     return (RecordBuilder<HashCode>)new MapHashBuilder();
/*     */   }
/*     */   
...
/* 261 */     return new ListHashBuilder();
/*     */   }
/*     */   
...
/* 271 */       return HashOps.this.hashFunction.newHasher().putByte((byte)4);
/*     */     }
/*     */ 
/*     */     
/*     */     protected Hasher append(Hasher hasher, HashCode value) {
/* 276 */       return hasher.putBytes(value.asBytes());
/*     */     }
/*     */ 
/*     */     
...
/* 289 */     return "Hash " + String.valueOf(this.hashFunction);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 296 */     throw new UnsupportedOperationException("Can't convert from this type");
/*     */   }
/*     */ 
/*     */   
...
/* 321 */     return (DataResult)UNSUPPORTED_OPERATION_ERROR;
/*     */   }
/*     */ 
/*     */   
...
/* 350 */     return value.equals(this.empty);
/*     */   }
/*     */ 
/*     */   
...
/* 431 */     return unsupported();
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/HashOps.class
