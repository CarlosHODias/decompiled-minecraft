...
/*    */   }
/*    */   
/*    */   public static ModCheck identify(String expectedBrand, java.util.function.Supplier<String> actualBrand, String component, Class<?> canaryClass) {
/* 28 */     String mod = actualBrand.get();
...
/* 43 */     return new ModCheck((Confidence)org.apache.commons.lang3.ObjectUtils.max((Comparable[])new Confidence[] { this.confidence, other.confidence }), this.description + "; " + this.description);
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/ModCheck.class
