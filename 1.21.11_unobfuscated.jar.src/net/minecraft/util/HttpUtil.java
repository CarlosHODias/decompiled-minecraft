...
/*     */       
/*  82 */       java.util.Objects.requireNonNull(connection); headers.forEach(connection::setRequestProperty);
/*     */       
...
/*     */       } 
/* 106 */       Path tmpPath = Files.createTempFile(targetDir, "download", ".tmp", (FileAttribute<?>[])new FileAttribute[0]);
/*     */       try {
/* 108 */         HashCode actualHash = downloadAndHash(hashFunction, maxSize, listener, input, tmpPath);
/* 109 */         Path actualPath = cachedFilePath(targetDir, actualHash);
/*     */ 
/*     */         
/* 112 */         if (!checkExistingFile(actualPath, hashFunction, actualHash)) {
/* 113 */           Files.move(tmpPath, actualPath, new CopyOption[] { StandardCopyOption.REPLACE_EXISTING });
/*     */         } else {
/*     */           
/* 116 */           updateModificationTime(actualPath);
/*     */         } 
/* 118 */         listener.requestFinished(true);
/* 119 */         return actualPath;
/*     */       } finally {
/* 121 */         Files.deleteIfExists(tmpPath);
/*     */       }
/*     */     
...
/* 173 */     return targetDir.resolve(requestedHash.toString());
/*     */   }
/*     */   
...
/*     */           throw throwable; }
/* 204 */      } public static int getAvailablePort() { try { ServerSocket server = new ServerSocket(0); 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/HttpUtil.class
