...
/*    */       return;
/*    */     } 
/* 32 */     Deque<T> queue = (Deque<T>)this.queuesByPriority.computeIfAbsent(priority, order -> Queues.newArrayDeque());
...
/*    */     }
/*    */     
/* 47 */     T result = this.highestPrioQueue.removeFirst();
/*    */     
/* 49 */     if (result == null) {
...
/*    */     
/* 64 */     for (ObjectIterator<Int2ObjectMap.Entry<Deque<T>>> objectIterator = Int2ObjectMaps.fastIterable(this.queuesByPriority).iterator(); objectIterator.hasNext(); ) { Int2ObjectMap.Entry<Deque<T>> entry = objectIterator.next();
/* 65 */       Deque<T> queue = (Deque<T>)entry.getValue();
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/SequencedPriorityIterator.class
