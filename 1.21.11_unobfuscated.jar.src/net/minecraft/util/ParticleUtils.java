...
/*  28 */       spawnParticleOnFace(level, pos, face, particle, speedSupplier.get(), stepFactor);
/*     */     }
/*     */   }
/*     */   
/*     */   private static Vec3 getRandomSpeedRanges(RandomSource random) {
/*  33 */     return new Vec3(Mth.nextDouble(random, -0.5D, 0.5D), Mth.nextDouble(random, -0.5D, 0.5D), Mth.nextDouble(random, -0.5D, 0.5D));
/*     */   }
/*     */   
...
/*  37 */     Vec3 centerOfBlock = Vec3.atCenterOf((Vec3i)pos);
/*     */     
...
/*  57 */     Vec3 centerOfBlock = Vec3.atCenterOf((Vec3i)pos);
...
/*  82 */     double spreadHeight = blockState.isAir() ? 1.0D : blockState.getShape((BlockGetter)level, pos).max(Direction.Axis.Y);
...
/*     */       
/* 117 */       level.addParticle((ParticleOptions)particle, x, y, z, xd, yd, zd);
/*     */     } 
/*     */     
/* 120 */     for (int j = 0; j < count / 1.5F; j++) {
/* 121 */       double x = center.x + 3.5D * Math.cos(j) + level.getRandom().nextGaussian() / 2.0D;
/* 122 */       double y = center.y;
/* 123 */       double z = center.z + 3.5D * Math.sin(j) + level.getRandom().nextGaussian() / 2.0D;
/*     */       
...
/*     */       
/* 129 */       level.addParticle((ParticleOptions)particle, x, y, z, xd, yd, zd);
/*     */     } 
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/ParticleUtils.class
