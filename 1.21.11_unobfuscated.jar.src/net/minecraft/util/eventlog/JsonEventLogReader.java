...
/* 29 */             return (T)codec.parse((DynamicOps)JsonOps.INSTANCE, json).getOrThrow(IOException::new);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/eventlog/JsonEventLogReader.class
