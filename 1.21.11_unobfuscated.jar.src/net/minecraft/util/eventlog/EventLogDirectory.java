...
/*  50 */     Files.createDirectories(root, (FileAttribute<?>[])new FileAttribute[0]);
...
/*  56 */     try { FileList fileList = new FileList(
/*  57 */           list.filter(x$0 -> Files.isRegularFile(x$0, new java.nio.file.LinkOption[0]))
/*  58 */           .map(this::parseFile)
...
/*     */       catch (Throwable throwable1) { throwable.addSuppressed(throwable1); }
/*     */        throw throwable; }
/* 115 */      } public RawFile createNewFile(LocalDate date) throws IOException { int index = 1;
/*     */     
/* 117 */     Set<FileId> files = listFiles().ids();
/*     */     while (true) {
/* 119 */       FileId id = new FileId(date, index++);
/* 120 */       if (!files.contains(id)) {
/* 121 */         RawFile file = new RawFile(this.root.resolve(id.toFileName(this.extension)), id);
/* 122 */         Files.createFile(file.path(), (FileAttribute<?>[])new FileAttribute[0]);
/* 123 */         return file;
/*     */       } 
/*     */     }  }
/*     */   
...
/* 130 */       this.files = new ArrayList<>(files);
/*     */     }
/*     */     
...
/* 153 */         EventLogDirectory.File file = iterator.next();
/*     */         try {
...
/* 187 */       this.path = path; this.id = id; } public final String toString() { // Byte code:
/*     */       //   0: aload_0
...
/* 189 */       return FileChannel.open(this.path, new OpenOption[] { StandardOpenOption.WRITE, StandardOpenOption.READ });
/*     */     }
/*     */ 
/*     */     
/*     */     public Reader openReader() throws IOException {
/* 194 */       return Files.exists(this.path, new java.nio.file.LinkOption[0]) ? Files.newBufferedReader(this.path) : null;
/*     */     }
/*     */ 
/*     */     
...
/*     */       // Local variable table:
/*     */       //   start	length	slot	name	descriptor
/* 205 */       //   0	7	0	this	Lnet/minecraft/util/eventlog/EventLogDirectory$CompressedFile; } public Path path() { return this.path; } public final int hashCode() { // Byte code:
/*     */       //   0: aload_0
...
/* 205 */       //   0	8	1	o	Ljava/lang/Object; } public EventLogDirectory.FileId id() { return this.id; }
/*     */     
/*     */     public Reader openReader() throws IOException {
...
/* 244 */       return DATE_FORMATTER.format(this.date) + "-" + DATE_FORMATTER.format(this.date);
/*     */     }
/*     */     
/*     */     public String toFileName(String extension) {
/* 248 */       return String.valueOf(this) + String.valueOf(this);
/*     */     } }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/eventlog/EventLogDirectory.class
