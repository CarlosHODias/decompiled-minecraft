...
/* 62 */     return String.format(Locale.ROOT, "StaticCache2D[%d, %d, %d, %d]", new Object[] { this.minX, this.minZ, this.minX + this.sizeX, this.minZ + this.sizeZ });
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/StaticCache2D.class
