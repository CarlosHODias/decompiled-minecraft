...
/*     */     
/*  51 */     schema.register(map, "minecraft:area_effect_cloud", name -> DSL.optionalFields("Particle", References.PARTICLE.in(schema)));
/*     */ 
/*     */     
/*  54 */     registerMob(schema, map, "minecraft:armor_stand");
/*  55 */     schema.register(map, "minecraft:arrow", name -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(schema)));
/*     */ 
/*     */     
...
/*  62 */     schema.register(map, "minecraft:chest_minecart", name -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema), "Items", DSL.list(References.ITEM_STACK.in(schema))));
/*     */ 
/*     */ 
/*     */     
/*  66 */     registerMob(schema, map, "minecraft:chicken");
/*  67 */     schema.register(map, "minecraft:commandblock_minecart", name -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema), "LastOutput", References.TEXT_COMPONENT.in(schema)));
/*     */ 
/*     */ 
/*     */     
/*  71 */     registerMob(schema, map, "minecraft:cow");
/*  72 */     registerMob(schema, map, "minecraft:creeper");
/*  73 */     schema.register(map, "minecraft:donkey", name -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema)));
/*     */ 
/*     */ 
/*     */     
...
/*  82 */     schema.register(map, "minecraft:enderman", name -> DSL.optionalFields("carried", References.BLOCK_NAME.in(schema)));
/*     */ 
/*     */     
...
/*  88 */     schema.register(map, "minecraft:falling_block", name -> DSL.optionalFields("Block", References.BLOCK_NAME.in(schema), "TileEntityData", References.BLOCK_ENTITY.in(schema)));
/*     */ 
/*     */ 
/*     */     
/*  92 */     registerThrowableProjectile(schema, map, "minecraft:fireball");
/*  93 */     schema.register(map, "minecraft:fireworks_rocket", name -> DSL.optionalFields("FireworksItem", References.ITEM_STACK.in(schema)));
/*     */ 
/*     */     
/*  96 */     schema.register(map, "minecraft:furnace_minecart", name -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema)));
/*     */ 
/*     */     
...
/* 102 */     schema.register(map, "minecraft:hopper_minecart", name -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema), "Items", DSL.list(References.ITEM_STACK.in(schema))));
/*     */ 
/*     */ 
/*     */     
/* 106 */     schema.register(map, "minecraft:horse", name -> DSL.optionalFields("ArmorItem", References.ITEM_STACK.in(schema), "SaddleItem", References.ITEM_STACK.in(schema)));
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 111 */     registerMob(schema, map, "minecraft:husk");
/* 112 */     schema.register(map, "minecraft:item", name -> DSL.optionalFields("Item", References.ITEM_STACK.in(schema)));
/*     */ 
/*     */     
/* 115 */     schema.register(map, "minecraft:item_frame", name -> DSL.optionalFields("Item", References.ITEM_STACK.in(schema)));
/*     */ 
/*     */     
/* 118 */     schema.registerSimple(map, "minecraft:leash_knot");
/* 119 */     registerMob(schema, map, "minecraft:magma_cube");
/* 120 */     schema.register(map, "minecraft:minecart", name -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema)));
/*     */ 
/*     */     
/* 123 */     registerMob(schema, map, "minecraft:mooshroom");
/* 124 */     schema.register(map, "minecraft:mule", name -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema)));
/*     */ 
/*     */ 
/*     */     
...
/* 133 */     schema.register(map, "minecraft:potion", name -> DSL.optionalFields("Potion", References.ITEM_STACK.in(schema), "inTile", References.BLOCK_NAME.in(schema)));
/*     */ 
/*     */ 
/*     */     
...
/* 143 */     schema.register(map, "minecraft:skeleton_horse", name -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(schema)));
/*     */ 
/*     */     
...
/* 150 */     schema.register(map, "minecraft:spawner_minecart", name -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema), References.UNTAGGED_SPAWNER.in(schema)));
/*     */ 
/*     */ 
/*     */     
/* 154 */     schema.register(map, "minecraft:spectral_arrow", name -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(schema)));
/*     */ 
/*     */     
...
/* 161 */     schema.register(map, "minecraft:tnt_minecart", name -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema)));
/*     */ 
/*     */     
/* 164 */     schema.register(map, "minecraft:villager", name -> DSL.optionalFields("Inventory", DSL.list(References.ITEM_STACK.in(schema)), "Offers", DSL.optionalFields("Recipes", DSL.list(References.VILLAGER_TRADE.in(schema)))));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 179 */     schema.register(map, "minecraft:zombie_horse", name -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(schema)));
/*     */ 
/*     */     
/* 182 */     registerMob(schema, map, "minecraft:zombie_pigman");
/* 183 */     schema.register(map, "minecraft:zombie_villager", name -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(References.VILLAGER_TRADE.in(schema)))));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 193 */     schema.register(map, "minecraft:llama", name -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema), "DecorItem", References.ITEM_STACK.in(schema)));
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/* 208 */     schema.registerType(true, References.ENTITY, () -> DSL.and(References.ENTITY_EQUIPMENT.in(schema), DSL.optionalFields("CustomName", DSL.constType(DSL.string()), (TypeTemplate)DSL.taggedChoiceLazy("id", namespacedString(), entityTypes))));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 215 */     schema.registerType(true, References.ITEM_STACK, () -> DSL.hook(DSL.optionalFields("id", References.ITEM_NAME.in(schema), "tag", V99.itemStackTag(schema)), ADD_NAMES, Hook.HookFunction.IDENTITY));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 221 */   private static final Map<String, String> ITEM_TO_ENTITY = (Map<String, String>)ImmutableMap.builder()
...
/* 339 */         return V99.addNames(new Dynamic(ops, value), V704.ITEM_TO_BLOCKENTITY, V705.ITEM_TO_ENTITY);
/*     */       }
/*     */     };
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/schemas/V705.class
