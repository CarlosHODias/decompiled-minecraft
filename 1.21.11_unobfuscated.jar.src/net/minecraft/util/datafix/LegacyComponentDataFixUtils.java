...
/* 31 */     return new Dynamic(ops, ops.createString(EMPTY_CONTENTS));
/*    */   }
/*    */   
...
/* 37 */     return GsonHelper.toStableString((JsonElement)result);
/*    */   }
/*    */   
...
/* 43 */     return GsonHelper.toStableString((JsonElement)result);
/*    */   }
/*    */   
...
/* 73 */     return component.asString().result()
/* 74 */       .filter(string -> {
/*    */           try {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/LegacyComponentDataFixUtils.class
