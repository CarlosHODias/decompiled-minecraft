...
/* 20 */     this.itemIdFinder = (Supplier<ItemIdFinder>)Suppliers.memoize(() -> {
/*    */           Type<?> potionType = getInputSchema().getChoiceType(References.ENTITY, "minecraft:potion"), patchedPotionType = ExtraDataFixUtils.patchSubType(potionType, getInputSchema().getType(References.ENTITY), getOutputSchema().getType(References.ENTITY));
...
/* 45 */       return entity.getOptionalTyped(this.itemFinder)
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/ThrownPotionSplitFix.class
