...
/*     */   }
/*     */   static {
/*  26 */     ID_TO_ENTITY = (String[])DataFixUtils.make(new String[256], map -> {
/*     */           map[1] = "Item";
/*     */           map[2] = "XPOrb";
/*     */           map[7] = "ThrownEgg";
/*     */           map[8] = "LeashKnot";
...
/*     */             Optional<? extends Typed<?>> tagOptional = input.getOptionalTyped(tagFinder), entityTreeOptional = tagOptional.flatMap(()), entityOptional = entityTreeOptional.flatMap(());
/*     */             Optional<String> oldId = entityOptional.flatMap(());
/*     */             Typed<?> output = input;
...
/*     */               Dynamic<?> entityTag = (Dynamic)DataFixUtils.orElse(tag.getOptionalTyped(entityTagFinder).map(()), rest.emptyMap());
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/ItemSpawnEggFix.class
