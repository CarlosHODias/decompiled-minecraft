...
/*     */   static {
/*  29 */     MAP = (Map<String, String>)DataFixUtils.make(Maps.newHashMap(), map -> {
...
/*     */         });
/* 353 */     IDS = (Set<String>)MAP.keySet().stream().map(k -> k.substring(0, k.indexOf('.'))).collect(Collectors.toSet());
/*     */   }
...
/* 446 */       String newName = MAP.get(name + "." + name);
/* 447 */       return (newName == null) ? MAP.get(name + ".0") : newName;
/*     */     } 
/* 449 */     return null;
/*     */   }
/*     */ }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/ItemStackTheFlatteningFix.class
