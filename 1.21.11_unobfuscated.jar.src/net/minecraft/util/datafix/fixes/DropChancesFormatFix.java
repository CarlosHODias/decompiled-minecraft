...
/* 52 */       String slot = slotNames.get(i);
/* 53 */       float chance = (Float)chances.get(i);
/* 54 */       if (chance != 0.085F) {
...
/* 62 */     return value.asStream()
/* 63 */       .map(dynamic -> dynamic.asFloat(0.085F))
/* 64 */       .toList();
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/DropChancesFormatFix.class
