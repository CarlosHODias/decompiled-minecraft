...
/*  43 */           DSL.or(
/*  44 */             DSL.string(), 
/*  45 */             (Type)DSL.list(rawTextComponentType)), 
/*     */           
/*  47 */           DSL.and(
/*  48 */             DSL.optional((Type)DSL.field("extra", (Type)DSL.list(rawTextComponentType))), 
/*  49 */             DSL.optional((Type)DSL.field("separator", rawTextComponentType)), 
/*  50 */             DSL.optional((Type)DSL.field("hoverEvent", hoverEventType)), 
...
/*     */     {
/*  90 */       return fixShowTextHover(hoverEventType, oldHoverEvent);
/*     */     }
/*  92 */     return createPlaceholderHover(hoverEventType, oldHoverEvent);
/*     */   }
/*     */ 
/*     */   
...
/* 102 */     JsonElement oldJson = (JsonElement)oldHoverEvent.convert((DynamicOps)JsonOps.INSTANCE).getValue();
/* 103 */     Dynamic<?> placeholderHoverEvent = new Dynamic((DynamicOps)JavaOps.INSTANCE, Map.of("action", "show_text", "contents", 
/*     */           
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/LegacyHoverEventFix.class
