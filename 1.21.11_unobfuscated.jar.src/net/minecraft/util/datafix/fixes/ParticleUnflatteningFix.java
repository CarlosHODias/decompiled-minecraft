...
/*     */     }
/*     */     
/*  44 */     String particleDescription = maybeString.get();
...
/*  48 */     switch (id) { case "minecraft:item":
...
/*  52 */       case "minecraft:dust": if (parts.length > 1);
/*     */       case "minecraft:dust_color_transition":
/*  54 */         if (parts.length > 1);
/*  55 */       case "minecraft:sculk_charge": if (parts.length > 1);
/*  56 */       case "minecraft:vibration": if (parts.length > 1);
/*  57 */       case "minecraft:shriek": if (parts.length > 1);
/*  58 */       default: break; }  return result;
/*     */   }
/*     */ 
/*     */   
...
/* 101 */         blockState = blockState.set("Properties", 
/* 102 */             result.createMap(properties));
/*     */       }
/*     */     } 
/*     */     
...
/*     */     try {
/* 111 */       Map<Dynamic<T>, Dynamic<T>> result = new HashMap<>();
...
/* 148 */     Objects.requireNonNull(result); return result.createList(Stream.<Float>of(new Float[] { x, y, z }).map(result::createFloat));
/*     */   }
/*     */   
...
/*     */       
/* 176 */       return 
/* 177 */         result.set("from_color", from)
/* 178 */         .set("to_color", to)
...
/* 210 */       Dynamic<T> positionSource = result.createMap(Map.of(
/* 211 */             result.createString("type"), result.createString("minecraft:block"), 
/* 212 */             result.createString("pos"), blockPos));
/*     */ 
/*     */       
/* 215 */       return 
/* 216 */         result.set("destination", positionSource)
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/ParticleUnflatteningFix.class
