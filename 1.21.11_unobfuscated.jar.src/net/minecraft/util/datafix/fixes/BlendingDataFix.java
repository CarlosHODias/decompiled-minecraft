...
/*    */     
/* 31 */     return fixTypeEverywhereTyped(this.name, chunkType, chunk -> chunk.update(DSL.remainderFinder(), ()));
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/*    */         
/* 50 */         Dynamic<?> belowZeroRetrogen = belowZeroRetrogenOpt.get();
...
/* 62 */     return chunkTag.set("blending_data", chunkTag.createMap(Map.of(
/* 63 */             chunkTag.createString("min_section"), chunkTag.createInt(SectionPos.blockToSectionCoord(minY)), 
/* 64 */             chunkTag.createString("max_section"), chunkTag.createInt(SectionPos.blockToSectionCoord(minY + height)))));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/BlendingDataFix.class
