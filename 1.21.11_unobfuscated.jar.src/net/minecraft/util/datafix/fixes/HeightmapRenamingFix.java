...
/* 22 */     return fixTypeEverywhereTyped("HeightmapRenamingFix", inputType, input -> levelF.updateTyped(levelF, ()));
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/*    */     }
/*    */     
/* 33 */     Dynamic<?> heightmapsTag = heightmaps.get();
/*    */     
...
/* 38 */       heightmapsTag = heightmapsTag.set("WORLD_SURFACE_WG", liquid.get());
/*    */     } 
/*    */     
...
/* 44 */       heightmapsTag = heightmapsTag.set("OCEAN_FLOOR_WG", solid.get());
/* 45 */       heightmapsTag = heightmapsTag.set("OCEAN_FLOOR", solid.get());
/*    */     } 
/*    */     
...
/* 51 */       heightmapsTag = heightmapsTag.set("LIGHT_BLOCKING", light.get());
/*    */     } 
/*    */     
...
/* 57 */       heightmapsTag = heightmapsTag.set("MOTION_BLOCKING", rain.get());
/* 58 */       heightmapsTag = heightmapsTag.set("MOTION_BLOCKING_NO_LEAVES", rain.get());
/*    */     } 
/*    */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/HeightmapRenamingFix.class
