...
/* 50 */     SubFixer<T> typedFixer = (SubFixer)fixer;
...
/* 55 */     return Util.writeAndReadTypedOrThrow(typed, outputType, input -> input.set("item", createItemStack(input, getArrowType(input))));
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   private static String getArrowType(Dynamic<?> input) {
/* 61 */     return input.get("Potion").asString("minecraft:empty").equals("minecraft:empty") ? "minecraft:arrow" : "minecraft:tipped_arrow";
/*    */   }
/*    */   
/*    */   private static <T> Typed<T> fixSpectralArrow(Typed<?> typed, Type<T> outputType) {
/* 65 */     return Util.writeAndReadTypedOrThrow(typed, outputType, input -> input.set("item", createItemStack(input, "minecraft:spectral_arrow")));
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   private static Dynamic<?> createItemStack(Dynamic<?> input, String itemName) {
/* 71 */     return input.createMap((Map)ImmutableMap.of(
/* 72 */           input.createString("id"), input.createString(itemName), 
/* 73 */           input.createString("Count"), input.createInt(1)));
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   private static <T> Typed<T> castUnchecked(Typed<?> input, Type<T> outputType) {
/* 79 */     return new Typed(outputType, input.getOps(), input.getValue());
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/FixProjectileStoredItem.class
