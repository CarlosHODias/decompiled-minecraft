...
/* 23 */     return entity.update(DSL.remainderFinder(), this::fixValue);
/*    */   }
/*    */   
/*    */   private Dynamic<?> fixValue(Dynamic<?> tag) {
/* 27 */     return tag.update("attributes", attributes -> tag.createList(tag.asStream().map(())));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/EntityAttributeBaseValueFix.class
