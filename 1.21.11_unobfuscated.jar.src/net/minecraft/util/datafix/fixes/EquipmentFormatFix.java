...
/*  41 */           DSL.optional((Type)DSL.field("ArmorItems", (Type)DSL.list(oldItemStackType))), 
/*  42 */           DSL.optional((Type)DSL.field("HandItems", (Type)DSL.list(oldItemStackType))), 
/*  43 */           DSL.optional((Type)DSL.field("body_armor_item", oldItemStackType)), 
/*  44 */           DSL.optional((Type)DSL.field("saddle", oldItemStackType))));
/*     */ 
/*     */     
...
/*  49 */               DSL.optional((Type)DSL.field("mainhand", newItemStackType)), 
/*  50 */               DSL.optional((Type)DSL.field("offhand", newItemStackType)), 
/*  51 */               DSL.optional((Type)DSL.field("feet", newItemStackType)), 
/*  52 */               DSL.and(
/*  53 */                 DSL.optional((Type)DSL.field("legs", newItemStackType)), 
/*  54 */                 DSL.optional((Type)DSL.field("chest", newItemStackType)), 
/*  55 */                 DSL.optional((Type)DSL.field("head", newItemStackType)), 
/*  56 */                 DSL.and(
/*  57 */                   DSL.optional((Type)DSL.field("body", newItemStackType)), 
/*  58 */                   DSL.optional((Type)DSL.field("saddle", newItemStackType)), 
...
/*     */           Predicate<ItemStackOld> isPlaceholder = ();
/*     */           return ();
/*     */         });
/*     */   }
/*     */ 
...
/*     */     }
/* 143 */     ItemStack item = items.get(index);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/EquipmentFormatFix.class
