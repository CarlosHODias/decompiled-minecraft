...
/* 30 */         fixTypeEverywhereTyped(this.name + " (ItemStack)", itemStackType, itemStack -> tagF.updateTyped(tagF, this::fixItemStackTag)), new TypeRewriteRule[] {
/*    */ 
/*    */           
...
/* 39 */     Objects.requireNonNull(name); return (Dynamic)DataFixUtils.orElse(name.asString().result().map(this.renames).map(name::createString), name);
/*    */   }
/*    */   
/*    */   private Typed<?> fixItemStackTag(Typed<?> itemStack) {
/* 43 */     return itemStack.update(DSL.remainderFinder(), tag -> tag.update("AttributeModifiers", ()));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 51 */     return entity.update(DSL.remainderFinder(), tag -> tag.update("Attributes", ()));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/AttributesRenameLegacy.class
