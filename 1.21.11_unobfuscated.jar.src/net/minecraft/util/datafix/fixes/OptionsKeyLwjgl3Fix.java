...
/*     */ 
/*     */ public class OptionsKeyLwjgl3Fix extends com.mojang.datafixers.DataFix {
/*     */   public static final String KEY_UNKNOWN = "key.unknown";
/*     */   
/*     */   public OptionsKeyLwjgl3Fix(Schema outputSchema, boolean changesType) {
/*  17 */     super(outputSchema, changesType);
/*     */   }
/*     */   private static final Int2ObjectMap<String> MAP;
/*     */   static {
/*  21 */     MAP = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), map -> {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/OptionsKeyLwjgl3Fix.class
