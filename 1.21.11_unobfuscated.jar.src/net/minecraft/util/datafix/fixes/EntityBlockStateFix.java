...
/*  34 */     super(outputSchema, changesType);
/*     */   }
/*     */   static {
/*  37 */     MAP = (Map<String, Integer>)DataFixUtils.make(Maps.newHashMap(), map -> {
...
/* 295 */     Integer result = MAP.get(name);
/* 296 */     return (result == null) ? 0 : result;
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/*     */     Function<Typed<?>, Typed<?>> minecartUpdater = input -> updateBlockToBlockState(input, "DisplayTile", "DisplayData", "DisplayState");
/*     */     
/*     */     Function<Typed<?>, Typed<?>> arrowUpdater = input -> updateBlockToBlockState(input, "inTile", "inData", "inBlockState");
...
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:falling_block", this::updateFallingBlock);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:enderman", ());
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:arrow", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:spectral_arrow", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:egg", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:ender_pearl", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:fireball", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:potion", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:small_fireball", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:snowball", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:wither_skull", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:xp_bottle", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:commandblock_minecart", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:minecart", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:chest_minecart", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:furnace_minecart", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:tnt_minecart", arrowUpdater);
/*     */           arrowUpdater = updateEntity(arrowUpdater, "minecraft:hopper_minecart", arrowUpdater);
/*     */           return updateEntity(arrowUpdater, "minecraft:spawner_minecart", arrowUpdater);
/*     */         });
/*     */   }
/*     */ 
/*     */   
/*     */   private Typed<?> updateFallingBlock(Typed<?> input) {
/* 339 */     Type<Either<Pair<String, Either<Integer, String>>, Unit>> oldType = DSL.optional((Type)DSL.field("Block", DSL.named(References.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), NamespacedSchema.namespacedString()))));
/* 340 */     Type<Either<Pair<String, Dynamic<?>>, Unit>> newType = DSL.optional((Type)DSL.field("BlockState", DSL.named(References.BLOCK_STATE.typeName(), DSL.remainderType())));
/*     */     
/* 342 */     Dynamic<?> tag = (Dynamic)input.get(DSL.remainderFinder());
/*     */     
/* 344 */     return input.update(oldType.finder(), newType, tile -> {
/*     */           int block = (Integer)tile.map((), ()), data = tag.get("Data").asInt(0) & 0xF;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 364 */     return input.update(tagType1.finder(), (Type)tagType2, tile -> {
/*     */           int block = (Integer)((Either)tile.getSecond()).map((), EntityBlockStateFix::getBlockId), data = tag.get(dataName).asInt(0) & 0xF;
/*     */ 
/*     */           
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/EntityBlockStateFix.class
