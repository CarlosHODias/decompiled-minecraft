...
/* 104 */     super(outputSchema, changesType);
/*     */   }
/*     */ 
/*     */   
...
/* 114 */     return structure.update("Children", children -> structure.createList(structure.asStream().map(())));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 122 */       Pair<String, ImmutableMap<String, String>> data = (Pair<String, ImmutableMap<String, String>>)RENAMES.get(id);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/ChunkStructuresTemplateRenameFix.class
