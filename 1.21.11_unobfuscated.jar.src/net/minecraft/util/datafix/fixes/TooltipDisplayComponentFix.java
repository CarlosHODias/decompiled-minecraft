...
/*  59 */     Set<String> hiddenTooltips = new HashSet<>();
...
/*     */           return remainder.set("minecraft:tooltip_display", remainder.createMap(Map.of(remainder.createString("hide_tooltip"), remainder.createBoolean(hideTooltip), remainder.createString("hidden_components"), remainder.createList(hiddenTooltips.stream().map(remainder::createString)))));
/*     */         });
/*     */   }
/*     */ 
/*     */ 
...
/*  99 */     return fixRemainderComponent(remainder, componentId, hiddenTooltips, UnaryOperator.identity());
/*     */   }
/*     */   
...
/* 103 */     return fixRemainderComponent(remainder, componentId, hiddenTooltips, component -> (Dynamic)DataFixUtils.orElse(component.get(fieldName).result(), component));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 119 */     return typedComponents.updateTyped(componentFinder, newType, typedComponent -> Util.writeAndReadTypedOrThrow(typedComponent, newType, ()));
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/TooltipDisplayComponentFix.class
