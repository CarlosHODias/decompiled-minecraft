...
/* 14 */     super(outputSchema, true, "Trial Spawner config tag fixer", References.BLOCK_ENTITY, "minecraft:trial_spawner");
/*    */   }
/*    */   
...
/*    */ 
/*    */     
/* 30 */     Map<Dynamic<T>, Dynamic<T>> map = new HashMap<>(keysToMove.size());
...
/* 34 */         map.put(input.createString(key), maybeValueForKey.get());
...
/* 43 */     return moveToConfigTag(input);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/TrialSpawnerConfigFix.class
