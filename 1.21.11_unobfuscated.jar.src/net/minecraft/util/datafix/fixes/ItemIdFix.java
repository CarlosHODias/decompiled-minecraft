...
/*     */   }
/*     */   static {
/*  25 */     ITEM_NAMES = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), map -> {
...
/* 345 */     return (String)ITEM_NAMES.get(id);
/*     */   }
/*     */ 
/*     */   
...
/* 353 */     return fixTypeEverywhereTyped("ItemIdFix", getInputSchema().getType(References.ITEM_STACK), getOutputSchema().getType(References.ITEM_STACK), itemStack -> itemStack.update(id, newItemType, ()));
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/ItemIdFix.class
