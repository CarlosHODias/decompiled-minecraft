...
/* 38 */     return fixTypeEverywhereTyped(this.name, getInputSchema().getType(this.type), getOutputSchema().getType(this.type), input -> input.update(DSL.remainderFinder(), ()));
/*    */   }
/*    */ 
/*    */   
/*    */   private Dynamic<?> addField(Dynamic<?> dynamic, int pathIndex) {
/* 43 */     if (pathIndex >= this.path.length) {
/* 44 */       return dynamic.set(this.fieldName, this.fieldGenerator.apply(dynamic));
/*    */     }
/*    */     
...
/*    */     }
/*    */     
/* 52 */     return addField(field.get(), pathIndex + 1);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/AddFieldFix.class
