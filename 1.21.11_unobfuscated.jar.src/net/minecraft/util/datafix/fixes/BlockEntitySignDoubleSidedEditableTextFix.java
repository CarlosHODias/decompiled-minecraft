...
/* 23 */     super(outputSchema, true, name, References.BLOCK_ENTITY, entityName);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/*    */     
/* 43 */     Dynamic<T> text = tag.emptyMap()
/* 44 */       .set("messages", tag.createList(lines.stream()))
/* 45 */       .set("color", tag.get("Color").result().orElse(tag.createString("black")))
/* 46 */       .set("has_glowing_text", tag.get("GlowingText").result().orElse(tag.createBoolean(false)));
/*    */     
...
/* 60 */     return Stream.of((Optional<Dynamic<T>>[])new Optional[] {
/* 61 */           tag.get(linePrefix + "1").result(), 
/* 62 */           tag.get(linePrefix + "2").result(), 
/* 63 */           tag.get(linePrefix + "3").result(), 
/* 64 */           tag.get(linePrefix + "4").result()
/*    */         });
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/BlockEntitySignDoubleSidedEditableTextFix.class
