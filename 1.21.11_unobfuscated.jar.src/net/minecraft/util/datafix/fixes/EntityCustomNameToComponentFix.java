...
/*    */     
/* 35 */     return fixTypeEverywhereTyped("EntityCustomNameToComponentFix", entityType, newEntityType, entity -> fixEntity(entity, newEntityType, idF, customNameF, newCustomNameType));
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/*    */     }
/*    */     
/* 51 */     String id = entity.getOptional(idF).orElse("");
/* 52 */     Dynamic<?> component = fixCustomName(entity.getOps(), customName.get(), id);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/EntityCustomNameToComponentFix.class
