...
/*  26 */     super(outputSchema, false, "TrialSpawnerConfigInRegistryFix", References.BLOCK_ENTITY, "minecraft:trial_spawner");
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/*  40 */     Identifier registryLocation = VanillaTrialChambers.CONFIGS_TO_KEY.get(Pair.of(normalConfig.get(), ominousConfig.get()));
/*     */     
...
/*     */     
/*  46 */     return 
/*  47 */       input.set("normal_config", input.createString(registryLocation.withSuffix("/normal").toString()))
...
/*     */           Dynamic<?> result = fixTag(input.convert((DynamicOps)NbtOps.INSTANCE));
...
/* 176 */       return new Dynamic((DynamicOps)NbtOps.INSTANCE, normalTag);
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/TrialSpawnerConfigInRegistryFix.class
