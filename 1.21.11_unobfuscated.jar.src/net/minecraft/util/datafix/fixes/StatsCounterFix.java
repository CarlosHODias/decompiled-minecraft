...
/*     */       // Local variable table:
/*     */       //   start	length	slot	name	descriptor
/* 199 */       //   0	7	0	this	Lnet/minecraft/util/datafix/fixes/StatsCounterFix$StatType; } public String typeKey() { return this.typeKey; } public final boolean equals(Object o) {
/*     */       // Byte code:
/*     */       //   0: aload_0
/*     */       //   1: aload_1
...
/*     */     }
/*     */     
/* 206 */     String customKey = CUSTOM_MAP.get(key);
...
/*     */     } 
/*     */     
/* 222 */     String itemKey = ITEM_KEYS.get(prefix);
/* 223 */     if (itemKey != null) {
...
/*     */     } 
/*     */     
/* 230 */     String entityKey = ENTITY_KEYS.get(prefix);
/* 231 */     if (entityKey != null) {
/* 232 */       String oldEntity = key.substring(splitIndex + 1).replace('.', ':');
/* 233 */       String newKey = ENTITIES.getOrDefault(oldEntity, oldEntity);
...
/*     */           if (map.isPresent()) {
/*     */             for (Map.Entry<? extends Dynamic<?>, ? extends Dynamic<?>> entry : (Iterable<Map.Entry<? extends Dynamic<?>, ? extends Dynamic<?>>>)((Map)map.get()).entrySet()) {
...
/*     */                 if (statType != null) {
/*     */                   Dynamic<?> newTypeKey = tag.createString(statType.type()), element = stats.computeIfAbsent(newTypeKey, ());
...
/*     */           Dynamic<?> tag = (Dynamic)input.get(DSL.remainderFinder()), updatedTag = tag.update("CriteriaName", ());
...
/*     */ 
/*     */   
/*     */   private static String upgradeItem(String name) {
/* 296 */     return ItemStackTheFlatteningFix.updateItem(name, 0);
/*     */   }
/*     */   
/*     */   private static String upgradeBlock(String name) {
/* 300 */     return BlockStateData.upgradeBlock(name);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/StatsCounterFix.class
