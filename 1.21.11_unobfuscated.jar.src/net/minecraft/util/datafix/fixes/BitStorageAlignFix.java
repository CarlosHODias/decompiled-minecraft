...
/*  44 */     OpticFinder<java.util.List<Pair<String, Dynamic<?>>>> paletteFinder = DSL.fieldFinder("Palette", (Type)DSL.list(blockStateType));
/*     */     
/*  46 */     return fixTypeEverywhereTyped("BitStorageAlignFix", chunkType, getOutputSchema().getType(References.CHUNK), chunk -> paletteFinder.updateTyped(levelFinder, ()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  54 */     return level.update(DSL.remainderFinder(), tag -> tag.update("Heightmaps", ()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   private static Typed<?> updateSections(OpticFinder<?> sectionsFinder, OpticFinder<?> sectionFinder, OpticFinder<java.util.List<Pair<String, Dynamic<?>>>> paletteFinder, Typed<?> level) {
/*  66 */     return level.updateTyped(sectionsFinder, sections -> sections.updateTyped(sectionFinder, ()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/BitStorageAlignFix.class
