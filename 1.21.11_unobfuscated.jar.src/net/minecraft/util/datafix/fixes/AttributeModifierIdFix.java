...
/*  82 */         fixTypeEverywhereTyped("AttributeIdFix (ItemStack)", itemStackType, itemStack -> itemStack.updateTyped(componentsFinder, ())), new TypeRewriteRule[] {
/*     */ 
/*     */           
...
/*  92 */     return fixModifiers((Stream)modifiers);
/*     */   }
/*     */   
...
/*     */           
/*     */           String name = modifier.get("name").asString(""), idFromUUID = (uuid != null) ? ID_MAP.get(uuid) : null, idFromName = NAME_MAP.get(name);
/*     */           
/*     */           if (idFromUUID != null) {
...
/*     */             } else {
/*     */               double amount = preExisting.get("amount").asDouble(0.0D), added = modifier.get("amount").asDouble(0.0D);
...
/* 128 */     return 
/* 129 */       modifier.renameField("UUID", "uuid")
/* 130 */       .renameField("Name", "name")
/* 131 */       .renameField("Amount", "amount")
/* 132 */       .renameAndFixField("Operation", "operation", operation -> { switch (operation.asInt(0)) { case 0:
/*     */             
/*     */             case 1:
/*     */             
/*     */             case 2:
...
/*     */             default:
/*     */               break; }
/*     */            return operation.createString("invalid");
/* 141 */         }); } private static Dynamic<?> fixItemStackComponents(Dynamic<?> components) { return components.update("minecraft:attribute_modifiers", attributeModifiers -> attributeModifiers.update("modifiers", ())); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 152 */     return 
/* 153 */       attribute.renameField("Name", "id")
/* 154 */       .renameField("Base", "base")
/* 155 */       .renameAndFixField("Modifiers", "modifiers", modifiers -> {
/*     */           Objects.requireNonNull(attribute);
/*     */           return DataFixUtils.orElse(modifiers.asStreamOpt().result().map(()).map(AttributeModifierIdFix::fixModifiersTypeWrapper).map(attribute::createList), modifiers);
/*     */         });
/*     */   }
/*     */ 
/*     */ 
...
/* 164 */     return entity.update(DSL.remainderFinder(), tag -> tag.renameAndFixField("Attributes", "attributes", ()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 176 */       return null;
/*     */     }
/* 178 */     return new UUID(intArray[0] << 32L | intArray[1] & 0xFFFFFFFFL, intArray[2] << 32L | intArray[3] & 0xFFFFFFFFL);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/util/datafix/fixes/AttributeModifierIdFix.class
