...
/*  29 */     this.items = NonNullList.of(ItemStack.EMPTY, (Object[])itemstacks);
/*     */   }
/*     */   
...
/*  54 */     List<ItemStack> itemsRemoved = (List<ItemStack>)this.items.stream().filter(item -> !item.isEmpty()).collect(Collectors.toList());
/*  55 */     clearContent();
...
/*  61 */     ItemStack result = ContainerHelper.removeItem((List<ItemStack>)this.items, slot, count);
...
/*  73 */     ItemStack removed = new ItemStack((ItemLike)itemType, 0);
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/SimpleContainer.class
