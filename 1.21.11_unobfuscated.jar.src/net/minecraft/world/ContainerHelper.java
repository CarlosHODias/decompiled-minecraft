...
/*    */     }
/*    */     
/* 27 */     return itemStacks.set(slot, ItemStack.EMPTY);
/*    */   }
/*    */   
/*    */   public static void saveAllItems(ValueOutput output, NonNullList<ItemStack> itemStacks) {
/* 31 */     saveAllItems(output, itemStacks, true);
/*    */   }
/*    */   
...
/* 48 */     for (ItemStackWithSlot item : (Iterable<ItemStackWithSlot>)input.listOrEmpty("Items", ItemStackWithSlot.CODEC)) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/ContainerHelper.class
