...
/*    */   }
/*    */   
/*    */   public ItemContext(boolean wasItemInteraction, ItemStack heldItemTransformedTo) {
/* 75 */     this.wasItemInteraction = wasItemInteraction; this.heldItemTransformedTo = heldItemTransformedTo; } public boolean wasItemInteraction() { return this.wasItemInteraction; } public ItemStack heldItemTransformedTo() { return this.heldItemTransformedTo; }
/* 76 */    static ItemContext NONE = new ItemContext(false, null);
/* 77 */   static ItemContext DEFAULT = new ItemContext(true, null);
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/InteractionResult$ItemContext.class
