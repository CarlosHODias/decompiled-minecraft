...
/* 24 */     super(category, color, (ParticleOptions)ParticleTypes.ITEM_COBWEB);
...
/* 31 */       mob instanceof net.minecraft.world.entity.player.Player || (Boolean)level.getGameRules().get(GameRules.MOB_GRIEFING))) {
...
/* 40 */     for (BlockPos blockPos : (Iterable<BlockPos>)BlockPos.randomInCube(random, 15, pos, 1)) {
...
/*    */       }
/*    */       
/* 47 */       if (level.getBlockState(blockPos).canBeReplaced() && level.getBlockState(below).isFaceSturdy((BlockGetter)level, below, Direction.UP)) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/effect/WeavingMobEffect.class
