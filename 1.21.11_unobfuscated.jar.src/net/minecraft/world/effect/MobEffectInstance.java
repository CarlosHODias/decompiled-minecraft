...
/*  28 */   private static final Logger LOGGER = LogUtils.getLogger(); public static final int INFINITE_DURATION = -1;
/*     */   public static final int MIN_AMPLIFIER = 0;
/*     */   public static final int MAX_AMPLIFIER = 255;
/*     */   public static final Codec<MobEffectInstance> CODEC;
/*     */   
/*     */   static {
/*  34 */     CODEC = RecordCodecBuilder.create(i -> i.group((App)MobEffect.CODEC.fieldOf("id").forGetter(MobEffectInstance::getEffect), (App)Details.MAP_CODEC.forGetter(MobEffectInstance::asDetails)).apply((Applicative)i, MobEffectInstance::new));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  54 */   private final BlendState blendState = new BlendState();
/*     */   
...
/*  73 */     this(effect, duration, amplifier, ambient, visible, showIcon, null);
/*     */   }
/*     */   
...
/*     */         
/*  94 */         details.duration(), 
/*  95 */         details.amplifier(), 
/*  96 */         details.ambient(), 
/*  97 */         details.showParticles(), 
/*  98 */         details.showIcon(), 
/*  99 */         details.hiddenEffect().<MobEffectInstance>map(hidden -> new MobEffectInstance(effect, hidden)).orElse(null));
/*     */   }
/*     */ 
/*     */   
/*     */   private Details asDetails() {
/* 104 */     return new Details(getAmplifier(), getDuration(), isAmbient(), isVisible(), showIcon(), Optional.<MobEffectInstance>ofNullable(this.hiddenEffect).map(MobEffectInstance::asDetails));
/*     */   }
/*     */   
/*     */   public float getBlendFactor(LivingEntity livingEntity, float partialTickTime) {
/* 108 */     return this.blendState.getFactor(livingEntity, partialTickTime);
/*     */   }
/*     */   
/*     */   public ParticleOptions getParticleOptions() {
/* 112 */     return ((MobEffect)this.effect.value()).createParticleOptions(this);
/*     */   }
/*     */   
...
/* 167 */     return (!isInfiniteDuration() && (this.duration < other.duration || other.isInfiniteDuration()));
/*     */   }
/*     */   
/*     */   public boolean isInfiniteDuration() {
/* 171 */     return (this.duration == -1);
/*     */   }
/*     */   
/*     */   public boolean endsWithin(int ticks) {
/* 175 */     return (!isInfiniteDuration() && this.duration <= ticks);
/*     */   }
/*     */   
...
/* 200 */     return this.amplifier;
/*     */   }
/*     */   
/*     */   public boolean isAmbient() {
/* 204 */     return this.ambient;
/*     */   }
/*     */   
/*     */   public boolean isVisible() {
/* 208 */     return this.visible;
/*     */   }
/*     */   
/*     */   public boolean showIcon() {
/* 212 */     return this.showIcon;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 244 */     return (isInfiniteDuration() || this.duration > 0);
/*     */   }
/*     */   
...
/* 264 */     ((MobEffect)this.effect.value()).onEffectStarted(mob, this.amplifier);
/*     */   }
/*     */   
/*     */   public void onMobRemoved(ServerLevel level, LivingEntity mob, Entity.RemovalReason reason) {
/* 268 */     ((MobEffect)this.effect.value()).onMobRemoved(level, mob, this.amplifier, reason);
/*     */   }
/*     */   
/*     */   public void onMobHurt(ServerLevel level, LivingEntity mob, DamageSource source, float damage) {
/* 272 */     ((MobEffect)this.effect.value()).onMobHurt(level, mob, this.amplifier, source, damage);
/*     */   }
/*     */   
/*     */   public String getDescriptionId() {
/* 276 */     return ((MobEffect)this.effect.value()).getDescriptionId();
/*     */   }
/*     */ 
/*     */   
...
/*     */   
/*     */   public int hashCode() {
/* 317 */     int result = this.effect.hashCode();
...
/* 322 */     result = 31 * result + (this.showIcon ? 1 : 0);
/* 323 */     return result;
/*     */   }
/*     */ 
/*     */   
...
/* 332 */         .compare(isAmbient(), o.isAmbient())
...
/* 345 */     ((MobEffect)this.effect.value()).onEffectAdded(livingEntity, this.amplifier);
/*     */   }
...
/*     */ 
/*     */     
/*     */     public static final StreamCodec<ByteBuf, Details> STREAM_CODEC;
/*     */ 
/*     */ 
/*     */ 
/*     */     
/*     */     static {
/* 359 */       STREAM_CODEC = StreamCodec.recursive(subCodec -> StreamCodec.composite(ByteBufCodecs.VAR_INT, Details::amplifier, ByteBufCodecs.VAR_INT, Details::duration, ByteBufCodecs.BOOL, Details::ambient, ByteBufCodecs.BOOL, Details::showParticles, ByteBufCodecs.BOOL, Details::showIcon, subCodec.apply(ByteBufCodecs::optional), Details::hiddenEffect, Details::new));
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 370 */       return new Details(amplifier, duration, ambient, showParticles, (Boolean)showIcon.orElse(showParticles), hiddenEffect);
/*     */     } }
/*     */ 
/*     */   
/*     */   public boolean is(Holder<MobEffect> effect) {
/* 375 */     return this.effect.equals(effect);
/*     */   }
/*     */   
/*     */   public void copyBlendState(MobEffectInstance instance) {
/* 379 */     this.blendState.copyFrom(instance.blendState);
/*     */   }
/*     */   
/*     */   public void skipBlending() {
/* 383 */     this.blendState.setImmediate(this);
/*     */   }
/*     */   
...
/* 420 */       return !instance.endsWithin(((MobEffect)instance.getEffect().value()).getBlendOutAdvanceTicks());
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/effect/MobEffectInstance.class
