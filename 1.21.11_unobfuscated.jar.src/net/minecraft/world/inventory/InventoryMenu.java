...
/*     */ 
/*     */   
/*  49 */   private static final EquipmentSlot[] SLOT_IDS = new EquipmentSlot[] { EquipmentSlot.HEAD, EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET };
/*     */ 
/*     */   
...
/*  69 */       Identifier emptyIcon = TEXTURE_EMPTY_SLOTS.get(slot);
/*  70 */       addSlot(new ArmorSlot((Container)inventory, (LivingEntity)owner, slot, 39 - i, 8, 8 + i * 18, emptyIcon));
/*     */     } 
/*     */     
/*  73 */     addStandardInventorySlots((Container)inventory, 8, 84);
/*     */     
/*  75 */     addSlot(new Slot(this, (Container)inventory, 40, 77, 62)
/*     */         {
...
/*  84 */             return InventoryMenu.EMPTY_ARMOR_SLOT_SHIELD;
/*     */           }
/*     */         });
/*     */   }
/*     */   
/*     */   public static boolean isHotbarSlot(int slot) {
/*  90 */     return ((slot >= 36 && slot < 45) || slot == 45);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  97 */     Level level = this.owner.level(); if (level instanceof ServerLevel) { ServerLevel serverLevel = (ServerLevel)level;
/*  98 */       CraftingMenu.slotChangedCraftingGrid(this, serverLevel, this.owner, this.craftSlots, this.resultSlots, null); }
/*     */   
/*     */   }
/*     */ 
/*     */   
...
/* 185 */     return (target.container != this.resultSlots && super.canTakeItemForPickAll(carried, target));
/*     */   }
/*     */ 
/*     */   
/*     */   public Slot getResultSlot() {
/* 190 */     return (Slot)this.slots.get(0);
/*     */   }
/*     */ 
/*     */   
/*     */   public List<Slot> getInputGridSlots() {
/* 195 */     return this.slots.subList(1, 5);
/*     */   }
/*     */   
/*     */   public CraftingContainer getCraftSlots() {
/* 199 */     return this.craftSlots;
/*     */   }
/*     */ 
/*     */   
/*     */   public RecipeBookType getRecipeBookType() {
/* 204 */     return RecipeBookType.CRAFTING;
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/InventoryMenu.class
