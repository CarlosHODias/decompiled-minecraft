...
/*  44 */     this(containerId, inventory, (Container)new SimpleContainer(5), new SimpleContainerData(2));
/*     */   }
/*     */   
...
/*     */     
/*  64 */     addStandardInventorySlots((Container)inventory, 8, 84);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean stillValid(Player player) {
/*  69 */     return this.brewingStand.stillValid(player);
/*     */   }
/*     */ 
/*     */   
...
/* 134 */       super(container, slot, x, y);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean mayPlace(ItemStack itemStack) {
/* 139 */       return mayPlaceItem(itemStack);
/*     */     }
/*     */ 
/*     */     
...
/* 151 */         CriteriaTriggers.BREWED_POTION.trigger(serverPlayer, potion.get()); }
/*     */       
/* 153 */       super.onTake(player, carried);
/*     */     }
/*     */     
/*     */     public static boolean mayPlaceItem(ItemStack itemStack) {
/* 157 */       return (itemStack.is(Items.POTION) || itemStack.is(Items.SPLASH_POTION) || itemStack.is(Items.LINGERING_POTION) || itemStack.is(Items.GLASS_BOTTLE));
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public boolean mayPlace(ItemStack itemStack) {
/* 176 */       return this.potionBrewing.isIngredient(itemStack);
/*     */     }
/*     */   }
/*     */   
/*     */   private static class FuelSlot extends Slot {
/*     */     public FuelSlot(Container container, int slot, int x, int y) {
/* 182 */       super(container, slot, x, y);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean mayPlace(ItemStack itemStack) {
/* 187 */       return mayPlaceItem(itemStack);
/*     */     }
/*     */     
/*     */     public static boolean mayPlaceItem(ItemStack itemStack) {
/* 191 */       return itemStack.is(ItemTags.BREWING_FUEL);
/*     */     }
/*     */ 
/*     */     
/*     */     public Identifier getNoItemIcon() {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/BrewingStandMenu.class
