...
/*  67 */     this(containerId, inventory, ContainerLevelAccess.NULL);
/*     */   }
/*     */   
...
/*  86 */     return state.is(BlockTags.ANVIL);
/*     */   }
/*     */ 
/*     */   
/*     */   protected boolean mayPickup(Player player, boolean hasItem) {
/*  91 */     return ((player.hasInfiniteMaterials() || player.experienceLevel >= this.cost.get()) && this.cost.get() > 0);
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 161 */     tax += (Integer)input.getOrDefault(DataComponents.REPAIR_COST, 0) + (Integer)addition.getOrDefault(DataComponents.REPAIR_COST, 0);
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/* 217 */         for (Object2IntMap.Entry<Holder<Enchantment>> entry : (Iterable<Object2IntMap.Entry<Holder<Enchantment>>>)additionalEnchantments.entrySet()) {
/* 218 */           Holder<Enchantment> enchantmentHolder = (Holder<Enchantment>)entry.getKey();
...
/*     */           }
/*     */           
/* 229 */           for (Holder<Enchantment> other : (Iterable<Holder<Enchantment>>)enchantments.keySet()) {
...
/* 320 */       int baseCost = (Integer)result.getOrDefault(DataComponents.REPAIR_COST, 0);
/* 321 */       if (baseCost < (Integer)addition.getOrDefault(DataComponents.REPAIR_COST, 0)) {
/* 322 */         baseCost = (Integer)addition.getOrDefault(DataComponents.REPAIR_COST, 0);
/*     */       }
/*     */       
...
/*     */       }
/*     */       
/* 329 */       result.set(DataComponents.REPAIR_COST, baseCost);
...
/* 343 */     return (int)Math.min(baseCost * 2L + 1L, 2147483647L);
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/AnvilMenu.class
