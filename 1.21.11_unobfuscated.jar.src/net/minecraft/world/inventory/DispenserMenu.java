...
/* 21 */     this(containerId, inventory, (Container)new SimpleContainer(9));
/*    */   }
/*    */   
...
/* 28 */     dispenser.startOpen((ContainerUser)inventory.player);
/*    */     
/* 30 */     add3x3GridSlots(dispenser, 62, 17);
/*    */     
/* 32 */     addStandardInventorySlots((Container)inventory, 8, 84);
/*    */   }
/*    */   
...
/* 46 */     return this.dispenser.stillValid(player);
/*    */   }
/*    */ 
/*    */   
...
/* 84 */     this.dispenser.stopOpen((ContainerUser)player);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/DispenserMenu.class
