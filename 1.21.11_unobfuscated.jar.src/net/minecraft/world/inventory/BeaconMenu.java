...
/*     */   
/*  30 */   private final Container beacon = (Container)new SimpleContainer(this, 1)
/*     */     {
...
/*  47 */     this(containerId, inventory, new SimpleContainerData(3), ContainerLevelAccess.NULL);
/*     */   }
/*     */   
...
/*  79 */     return stillValid(this.access, player, Blocks.BEACON);
/*     */   }
/*     */ 
/*     */   
...
/* 133 */     return this.beaconData.get(0);
/*     */   }
/*     */   
/*     */   public static int encodeEffect(Holder<MobEffect> mobEffect) {
/* 137 */     return (mobEffect == null) ? 0 : (BuiltInRegistries.MOB_EFFECT.asHolderIdMap().getId(mobEffect) + 1);
/*     */   }
/*     */   
/*     */   public static Holder<MobEffect> decodeEffect(int id) {
/* 141 */     return (id == 0) ? null : (Holder<MobEffect>)BuiltInRegistries.MOB_EFFECT.asHolderIdMap().byId(id - 1);
/*     */   }
/*     */   
/*     */   public Holder<MobEffect> getPrimaryEffect() {
/* 145 */     return decodeEffect(this.beaconData.get(1));
/*     */   }
/*     */   
/*     */   public Holder<MobEffect> getSecondaryEffect() {
/* 149 */     return decodeEffect(this.beaconData.get(2));
/*     */   }
/*     */   
...
/* 154 */       this.beaconData.set(1, encodeEffect(primary.orElse(null)));
/* 155 */       this.beaconData.set(2, encodeEffect(secondary.orElse(null)));
...
/* 162 */     return !this.beacon.getItem(0).isEmpty();
/*     */   }
/*     */   
/*     */   private static class PaymentSlot extends Slot {
/*     */     public PaymentSlot(Container container, int slot, int x, int y) {
/* 167 */       super(container, slot, x, y);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean mayPlace(ItemStack itemStack) {
/* 172 */       return itemStack.is(ItemTags.BEACON_PAYMENT_ITEMS);
/*     */     }
/*     */ 
/*     */     
/*     */     public int getMaxStackSize() {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/BeaconMenu.class
