...
/* 29 */     return addSlot(new ResultSlot(player, this.craftSlots, this.resultSlots, 0, x, y));
/*    */   }
/*    */   
...
/* 42 */     RecipeHolder<CraftingRecipe> typedRecipe = (RecipeHolder)recipe;
...
/* 61 */               return ((CraftingRecipe)recipe.value()).matches((RecipeInput)AbstractCraftingMenu.this.craftSlots.asCraftInput(), AbstractCraftingMenu.this.owner().level());
/*    */             }
/*    */           }, 
/*    */ 
/*    */ 
...
/*    */   
/*    */   public void fillCraftSlotsStackedContents(StackedItemContents stackedContents) {
/* 98 */     this.craftSlots.fillStackedContents(stackedContents);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/AbstractCraftingMenu.class
