...
/*     */   
/*  48 */   private final Container inputContainer = (Container)new SimpleContainer(3)
/*     */     {
/*     */       public void setChanged() {
/*  51 */         super.setChanged();
/*  52 */         LoomMenu.this.slotsChanged((Container)this);
/*  53 */         LoomMenu.this.slotUpdateListener.run();
/*     */       }
/*     */     };
/*     */   
/*  57 */   private final Container outputContainer = (Container)new SimpleContainer(1)
/*     */     {
/*     */       public void setChanged() {
/*  60 */         super.setChanged();
...
/*  66 */     this(containerId, inventory, ContainerLevelAccess.NULL);
/*     */   }
/*     */   
...
/*     */         });
/*     */     
/* 121 */     addStandardInventorySlots((Container)inventory, 8, 84);
/*     */     
/* 123 */     addDataSlot(this.selectedBannerPatternIndex);
/*     */     
/* 125 */     this.patternGetter = (HolderGetter<BannerPattern>)inventory.player.registryAccess().lookupOrThrow(Registries.BANNER_PATTERN);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean stillValid(Player player) {
/* 130 */     return stillValid(this.access, player, Blocks.LOOM);
/*     */   }
/*     */ 
/*     */   
...
/* 137 */       setupResultSlot(this.selectablePatterns.get(buttonId));
/* 138 */       return true;
/*     */     } 
/* 140 */     return false;
/*     */   }
...
/* 145 */       return (List<Holder<BannerPattern>>)this.patternGetter.get(BannerPatternTags.NO_ITEM_REQUIRED).map(ImmutableList::copyOf).orElse(ImmutableList.of());
/*     */     }
/* 147 */     TagKey<BannerPattern> providedPatterns = (TagKey<BannerPattern>)patternStack.get(DataComponents.PROVIDES_BANNER_PATTERNS);
/* 148 */     if (providedPatterns != null) {
/* 149 */       return (List<Holder<BannerPattern>>)this.patternGetter.get(providedPatterns).map(ImmutableList::copyOf).orElse(ImmutableList.of());
/*     */     }
/* 151 */     return List.of();
/*     */   }
/*     */   
/*     */   private boolean isValidPatternIndex(int selectedPattern) {
/* 155 */     return (selectedPattern >= 0 && selectedPattern < this.selectablePatterns.size());
/*     */   }
/*     */   
...
/* 179 */       patternToDisplay = this.selectablePatterns.get(0);
/* 180 */     } else if (!validPatternIndex) {
/* 181 */       this.selectedBannerPatternIndex.set(-1);
/* 182 */       patternToDisplay = null;
/*     */     } else {
/* 184 */       Holder<BannerPattern> selectedValue = previousSelectablePatterns.get(selectedPattern);
...
/* 211 */     return this.selectablePatterns;
/*     */   }
/*     */   
/*     */   public int getSelectedBannerPatternIndex() {
/* 215 */     return this.selectedBannerPatternIndex.get();
/*     */   }
/*     */   
/*     */   public void registerUpdateListener(Runnable slotUpdateListener) {
/* 219 */     this.slotUpdateListener = slotUpdateListener;
/*     */   }
/*     */ 
/*     */   
...
/* 290 */       result.update(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY, layers -> new BannerPatternLayers.Builder().addAll(layers).add(pattern, patternColor).build());
/*     */     } 
/*     */ 
/*     */     
...
/* 300 */     return this.bannerSlot;
/*     */   }
/*     */   
/*     */   public Slot getDyeSlot() {
/* 304 */     return this.dyeSlot;
/*     */   }
/*     */   
/*     */   public Slot getPatternSlot() {
/* 308 */     return this.patternSlot;
/*     */   }
/*     */   
/*     */   public Slot getResultSlot() {
/* 312 */     return this.resultSlot;
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/LoomMenu.class
