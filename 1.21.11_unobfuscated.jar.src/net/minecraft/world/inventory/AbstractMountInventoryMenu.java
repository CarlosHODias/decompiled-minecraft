...
/* 20 */     this.mount = mount;
/* 21 */     mountInventory.startOpen((ContainerUser)playerInventory.player);
/*    */   }
/*    */ 
/*    */   
...
/* 28 */     return (!hasInventoryChanged(this.mountContainer) && this.mountContainer.stillValid(player) && this.mount.isAlive() && player.isWithinEntityInteractionRange((Entity)this.mount, 4.0D));
/*    */   }
/*    */ 
/*    */   
/*    */   public void removed(Player player) {
/* 33 */     super.removed(player);
/* 34 */     this.mountContainer.stopOpen((ContainerUser)player);
/*    */   }
/*    */ 
/*    */   
...
/* 86 */     return inventoryColumns * 3;
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/AbstractMountInventoryMenu.class
