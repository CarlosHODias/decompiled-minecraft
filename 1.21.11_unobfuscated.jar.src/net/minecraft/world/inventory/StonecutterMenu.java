...
/*     */     };
/*     */   
/*  42 */   public final Container container = (Container)new SimpleContainer(1)
/*     */     {
/*     */       public void setChanged() {
/*  45 */         super.setChanged();
/*  46 */         StonecutterMenu.this.slotsChanged((Container)this);
...
/*  94 */             return List.of(
/*  95 */                 StonecutterMenu.this.inputSlot.getItem());
/*     */           }
/*     */         });
/*     */ 
/*     */     
/* 100 */     addStandardInventorySlots((Container)inventory, 8, 84);
/*     */     
/* 102 */     addDataSlot(this.selectedRecipeIndex);
/*     */   }
/*     */   
/*     */   public int getSelectedRecipeIndex() {
/* 106 */     return this.selectedRecipeIndex.get();
/*     */   }
/*     */   
/*     */   public SelectableRecipe.SingleInputSet<StonecutterRecipe> getVisibleRecipes() {
/* 110 */     return this.recipesForInput;
/*     */   }
/*     */   
/*     */   public int getNumberOfVisibleRecipes() {
/* 114 */     return this.recipesForInput.size();
/*     */   }
/*     */   
/*     */   public boolean hasInputItem() {
/* 118 */     return (this.inputSlot.hasItem() && !this.recipesForInput.isEmpty());
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean stillValid(Player player) {
/* 123 */     return stillValid(this.access, player, Blocks.STONECUTTER);
/*     */   }
/*     */ 
/*     */   
...
/* 141 */     return (buttonId >= 0 && buttonId < this.recipesForInput.size());
/*     */   }
/*     */ 
/*     */   
...
/* 170 */       SelectableRecipe.SingleInputEntry<StonecutterRecipe> entry = this.recipesForInput.entries().get(index);
...
/* 191 */     return MenuType.STONECUTTER;
/*     */   }
/*     */   
/*     */   public void registerUpdateListener(Runnable slotUpdateListener) {
/* 195 */     this.slotUpdateListener = slotUpdateListener;
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean canTakeItemForPickAll(ItemStack carried, Slot target) {
/* 200 */     return (target.container != this.resultContainer && super.canTakeItemForPickAll(carried, target));
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/StonecutterMenu.class
