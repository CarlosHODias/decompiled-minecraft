...
/* 30 */     if (recipe.value().isSpecial() || !((Boolean)player.level().getGameRules().get(GameRules.LIMITED_CRAFTING)) || player.getRecipeBook().contains(recipe.id())) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/RecipeCraftingHolder.class
