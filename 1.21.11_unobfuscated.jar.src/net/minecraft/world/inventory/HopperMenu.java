...
/* 16 */     this(containerId, inventory, (Container)new SimpleContainer(5));
/*    */   }
/*    */   
...
/*    */     
/* 24 */     hopper.startOpen((ContainerUser)inventory.player);
/*    */     
/* 26 */     for (int x = 0; x < 5; x++) {
/* 27 */       addSlot(new Slot(hopper, x, 44 + x * 18, 20));
/*    */     }
/*    */     
/* 30 */     addStandardInventorySlots((Container)inventory, 8, 51);
/*    */   }
/*    */ 
/*    */   
/*    */   public boolean stillValid(Player player) {
/* 35 */     return this.hopper.stillValid(player);
/*    */   }
/*    */ 
/*    */   
...
/* 67 */     this.hopper.stopOpen((ContainerUser)player);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/HopperMenu.class
