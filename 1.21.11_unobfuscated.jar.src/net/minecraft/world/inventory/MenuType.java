...
/* 34 */     LECTERN = register("lectern", (containerId, inventory) -> new LecternMenu(containerId));
...
/* 46 */     return (MenuType<T>)Registry.register(BuiltInRegistries.MENU, name, new MenuType<>(constructor, FeatureFlags.VANILLA_SET));
/*    */   }
/*    */   
...
/* 50 */     return (MenuType<T>)Registry.register(BuiltInRegistries.MENU, name, new MenuType<>(constructor, FeatureFlags.REGISTRY.subset(flags)));
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/* 61 */     return this.constructor.create(containerId, inventory);
/*    */   }
/*    */ 
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/MenuType.class
