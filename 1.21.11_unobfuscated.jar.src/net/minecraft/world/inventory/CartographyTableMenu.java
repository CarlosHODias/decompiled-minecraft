...
/*     */   
/*  29 */   public final Container container = (Container)new SimpleContainer(2)
/*     */     {
/*     */       public void setChanged() {
/*  32 */         CartographyTableMenu.this.slotsChanged((Container)this);
/*  33 */         super.setChanged();
/*     */       }
...
/*  46 */     this(containerId, inventory, ContainerLevelAccess.NULL);
/*     */   }
/*     */   
...
/*     */         });
/*     */     
/*  94 */     addStandardInventorySlots((Container)inventory, 8, 84);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean stillValid(Player player) {
/*  99 */     return stillValid(this.access, player, Blocks.CARTOGRAPHY_TABLE);
/*     */   }
/*     */ 
/*     */   
...
/*     */           ItemStack result;
/*     */           MapItemSavedData mapData = MapItem.getSavedData(mapStack, resultStack);
/*     */           if (mapData == null) {
/*     */             return;
/*     */           }
/*     */           if (mapStack.is(Items.PAPER) && !mapData.locked && mapData.scale < 4) {
/*     */             result = mapStack.copyWithCount(1);
/*     */             result.set(DataComponents.MAP_POST_PROCESSING, MapPostProcessing.SCALE);
/*     */             broadcastChanges();
/*     */           } else if (mapStack.is(Items.GLASS_PANE) && !mapData.locked) {
/*     */             result = mapStack.copyWithCount(1);
/*     */             result.set(DataComponents.MAP_POST_PROCESSING, MapPostProcessing.LOCK);
/*     */             broadcastChanges();
/*     */           } else if (mapStack.is(Items.MAP)) {
...
/*     */             return;
/*     */           } 
/*     */           if (!ItemStack.matches(result, additionalStack)) {
...
/* 150 */     return (target.container != this.resultContainer && super.canTakeItemForPickAll(carried, target));
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/inventory/CartographyTableMenu.class
