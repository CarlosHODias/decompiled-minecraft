...
/*     */   
/*     */   public Packed pack() {
/*  39 */     return new Packed(this.name, this.criteria, this.displayName, this.renderType, this.displayAutoUpdate, 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  66 */     return this.displayAutoUpdate;
/*     */   }
/*     */   
/*     */   public NumberFormat numberFormat() {
/*  70 */     return this.numberFormat;
/*     */   }
/*     */   
/*     */   public NumberFormat numberFormatOrDefault(NumberFormat _default) {
/*  74 */     return java.util.Objects.<NumberFormat>requireNonNullElse(this.numberFormat, _default);
/*     */   }
/*     */   
/*     */   private Component createFormattedDisplayName() {
/*  78 */     return (Component)ComponentUtils.wrapInSquareBrackets((Component)
/*  79 */         this.displayName.copy().withStyle(s -> s.withHoverEvent((HoverEvent)new HoverEvent.ShowText((Component)Component.literal(this.name)))));
/*     */   }
/*     */ 
/*     */   
/*     */   public Component getFormattedDisplayName() {
/*  84 */     return this.formattedDisplayName;
/*     */   }
/*     */   
...
/* 112 */       //   0	7	0	this	Lnet/minecraft/world/scores/Objective$Packed; } public String name() { return this.name; } public final int hashCode() { // Byte code:
/*     */       //   0: aload_0
...
/*     */     
/*     */     static {
/* 120 */       CODEC = RecordCodecBuilder.create(i -> i.group((App)Codec.STRING.fieldOf("Name").forGetter(Packed::name), (App)ObjectiveCriteria.CODEC.optionalFieldOf("CriteriaName", ObjectiveCriteria.DUMMY).forGetter(Packed::criteria), (App)ComponentSerialization.CODEC.fieldOf("DisplayName").forGetter(Packed::displayName), (App)ObjectiveCriteria.RenderType.CODEC.optionalFieldOf("RenderType", ObjectiveCriteria.RenderType.INTEGER).forGetter(Packed::renderType), (App)Codec.BOOL.optionalFieldOf("display_auto_update", false).forGetter(Packed::displayAutoUpdate), (App)NumberFormatTypes.CODEC.optionalFieldOf("format").forGetter(Packed::numberFormat)).apply((Applicative)i, Packed::new));
/*     */     } }
/*     */ 
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/scores/Objective.class
