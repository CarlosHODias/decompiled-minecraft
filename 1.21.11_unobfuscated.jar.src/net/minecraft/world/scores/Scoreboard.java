...
/*  44 */     return (Objective)this.objectivesByName.get(name);
/*     */   }
/*     */   
...
/*     */     
/*  54 */     ((List<Objective>)this.objectivesByCriteria.computeIfAbsent(criteria, k -> Lists.newArrayList())).add(objective);
...
/*  61 */     ((List)this.objectivesByCriteria.getOrDefault(criteria, Collections.emptyList())).forEach(o -> operation.accept(getOrCreatePlayerScore(operation, name, true)));
/*     */   }
/*     */   
/*     */   private PlayerScores getOrCreatePlayerInfo(String name) {
/*  65 */     return this.playerScores.computeIfAbsent(name, k -> new PlayerScores());
/*     */   }
/*     */   
/*     */   public ScoreAccess getOrCreatePlayerScore(ScoreHolder holder, Objective objective) {
/*  69 */     return getOrCreatePlayerScore(holder, objective, false);
/*     */   }
/*     */   
...
/* 163 */     PlayerScores playerScore = this.playerScores.get(name.getScoreboardName());
...
/* 171 */     List<PlayerScoreEntry> result = new ArrayList<>();
/*     */     
...
/* 183 */     return (Collection<Objective>)this.objectivesByName.values();
/*     */   }
/*     */   
/*     */   public Collection<String> getObjectiveNames() {
/* 187 */     return (Collection<String>)this.objectivesByName.keySet();
/*     */   }
/*     */   
/*     */   public Collection<ScoreHolder> getTrackedPlayers() {
/* 191 */     return this.playerScores.keySet().stream().map(ScoreHolder::forNameOnly).toList();
/*     */   }
/*     */   
/*     */   public void resetAllPlayerScores(ScoreHolder player) {
/* 195 */     PlayerScores removed = this.playerScores.remove(player.getScoreboardName());
/* 196 */     if (removed != null) {
...
/* 202 */     PlayerScores scores = this.playerScores.get(player.getScoreboardName());
/* 203 */     if (scores != null) {
/* 204 */       boolean hasRemoved = scores.remove(objective);
/* 205 */       if (!scores.hasScores()) {
/* 206 */         PlayerScores removedPlayer = this.playerScores.remove(player.getScoreboardName());
...
/* 217 */     PlayerScores scores = this.playerScores.get(player.getScoreboardName());
...
/*     */     } 
/*     */     
/* 230 */     List<Objective> objectives = (List<Objective>)this.objectivesByCriteria.get(objective.getCriteria());
...
/* 243 */     this.displayObjectives.put(slot, objective);
/*     */   }
/*     */   
/*     */   public Objective getDisplayObjective(DisplaySlot slot) {
/* 247 */     return this.displayObjectives.get(slot);
/*     */   }
/*     */   
/*     */   public PlayerTeam getPlayerTeam(String name) {
/* 251 */     return (PlayerTeam)this.teamsByName.get(name);
/*     */   }
/*     */   
...
/* 310 */     return (Collection<String>)this.teamsByName.keySet();
/*     */   }
/*     */   
/*     */   public Collection<PlayerTeam> getPlayerTeams() {
/* 314 */     return (Collection<PlayerTeam>)this.teamsByName.values();
/*     */   }
/*     */   
/*     */   public PlayerTeam getPlayersTeam(String name) {
/* 318 */     return (PlayerTeam)this.teamsByPlayer.get(name);
/*     */   }
/*     */ 
/*     */   
...
/*     */       return;
/*     */     }
/* 355 */     resetAllPlayerScores((ScoreHolder)entity);
/* 356 */     removePlayerFromTeam(entity.getScoreboardName());
/*     */   }
/*     */   
/*     */   protected List<PackedScore> packPlayerScores() {
/* 360 */     return this.playerScores.entrySet().stream()
/* 361 */       .flatMap(playerEntry -> {
/*     */           String player = (String)playerEntry.getKey();
/*     */ 
/*     */           
/*     */           return ((PlayerScores)playerEntry.getValue()).listRawScores().entrySet().stream().map(());
/* 366 */         }).toList();
/*     */   }
/*     */   
...
/* 379 */     return getPlayerTeams().stream().map(PlayerTeam::pack).toList();
/*     */   }
/*     */   
...
/* 401 */     return getObjectives().stream().map(Objective::pack).toList();
/*     */   }
/*     */   
/*     */   protected void loadObjective(Objective.Packed objective) {
/* 405 */     addObjective(objective.name(), objective.criteria(), objective.displayName(), objective.renderType(), objective.displayAutoUpdate(), objective.numberFormat().orElse(null));
/*     */   }
/*     */   
/*     */   protected Map<DisplaySlot, String> packDisplaySlots() {
/* 409 */     Map<DisplaySlot, String> displaySlots = new EnumMap<>(DisplaySlot.class);
...
/*     */   }
/*     */   public static final class PackedScore extends Record { private final String owner; private final String objective; private final Score.Packed score; public static final Codec<PackedScore> CODEC;
...
/* 419 */       //   0	8	1	o	Ljava/lang/Object; } public String objective() { return this.objective; } public Score.Packed score() { return this.score; } static {
/* 420 */       CODEC = RecordCodecBuilder.create(i -> i.group((App)Codec.STRING.fieldOf("Name").forGetter(PackedScore::owner), (App)Codec.STRING.fieldOf("Objective").forGetter(PackedScore::objective), (App)Score.Packed.MAP_CODEC.forGetter(PackedScore::score)).apply((Applicative)i, PackedScore::new));
/*     */     } }
/*     */ 
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/scores/Scoreboard.class
