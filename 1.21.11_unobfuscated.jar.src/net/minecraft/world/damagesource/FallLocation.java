...
/* 13 */     //   0	8	1	o	Ljava/lang/Object; } public static final FallLocation GENERIC = new FallLocation("generic");
...
/* 23 */     if (blockState.is(Blocks.LADDER) || blockState.is(net.minecraft.tags.BlockTags.TRAPDOORS))
/* 24 */       return LADDER; 
...
/* 40 */       BlockState blockState = mob.level().getBlockState(lastClimbablePos.get());
...
/* 50 */     return "death.fell.accident." + this.id;
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/damagesource/FallLocation.class
