...
/*  44 */     byteBuf.writeEither(this.identifier, (StreamEncoder)UUIDUtil.STREAM_CODEC, FriendlyByteBuf::writeUtf);
...
/*     */     
/*  55 */     Either<UUID, String> identifier = byteBuf.readEither((StreamDecoder)UUIDUtil.STREAM_CODEC, FriendlyByteBuf::readUtf);
...
/* 120 */       super(identifier, icon, TrackedWaypoint.Type.EMPTY);
/*     */     }
/*     */     
/*     */     private EmptyWaypoint(UUID identifier) {
/* 124 */       super(Either.left(identifier), Waypoint.Icon.NULL, TrackedWaypoint.Type.EMPTY);
/*     */     }
/*     */ 
/*     */     
...
/* 185 */       java.util.Objects.requireNonNull(level); return this.identifier.left().map(level::getEntity).map(e -> (partialTick.blockPosition().distManhattan(this.vector) > 3) ? null : partialTick.getEyePosition(partialTick.apply(partialTick)))
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*     */     public double distanceSquared(Entity fromEntity) {
/* 226 */       return fromEntity.distanceToSqr(Vec3.atCenterOf(this.vector));
/*     */     }
/*     */   }
/*     */   
...
/* 263 */       return Vec3.atCenterOf((Vec3i)this.chunkPos.getMiddleBlockPosition((int)positionY));
/*     */     }
/*     */ 
/*     */     
/*     */     public double yawAngleToCamera(Level level, TrackedWaypoint.Camera camera, PartialTickSupplier partialTickSupplier) {
...
/*     */     
/*     */     public double distanceSquared(Entity fromEntity) {
/* 288 */       return fromEntity.distanceToSqr(Vec3.atCenterOf((Vec3i)this.chunkPos.getMiddleBlockPosition(fromEntity.getBlockY())));
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*     */     public void writeContents(ByteBuf buf) {
/* 316 */       buf.writeFloat(this.angle);
/*     */     }
/*     */ 
/*     */     
/*     */     public double yawAngleToCamera(Level level, TrackedWaypoint.Camera camera, PartialTickSupplier partialTickSupplier) {
/* 321 */       return Mth.degreesDifference(camera.yaw(), this.angle * 57.295776F);
/*     */     }
/*     */ 
/*     */     
/*     */     public TrackedWaypoint.PitchDirection pitchDirectionToCamera(Level level, TrackedWaypoint.Projector projector, PartialTickSupplier partialTickSupplier) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/waypoints/TrackedWaypoint.class
