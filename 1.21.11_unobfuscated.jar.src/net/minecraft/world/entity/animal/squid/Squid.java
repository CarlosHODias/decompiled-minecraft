...
/*  73 */     return SoundEvents.SQUID_AMBIENT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getHurtSound(DamageSource source) {
/*  78 */     return SoundEvents.SQUID_HURT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/*  83 */     return SoundEvents.SQUID_DEATH;
/*     */   }
/*     */   
/*     */   protected SoundEvent getSquirtSound() {
/*  87 */     return SoundEvents.SQUID_SQUIRT;
/*     */   }
/*     */ 
/*     */   
...
/* 102 */     return Entity.MovementEmission.EVENTS;
/*     */   }
/*     */ 
/*     */   
/*     */   public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob partner) {
/* 107 */     return (AgeableMob)EntityType.SQUID.create((Level)level, EntitySpawnReason.BREEDING);
/*     */   }
/*     */ 
/*     */   
...
/*     */         }
/* 134 */         level().broadcastEntityEvent((Entity)this, (byte)19);
/*     */       } 
/*     */     }
/*     */     
/* 138 */     if (isInWater()) {
...
/* 197 */     Vec3 v = vec.xRot(this.xBodyRotO * 0.017453292F);
/* 198 */     v = v.yRot(-this.yBodyRotO * 0.017453292F);
/* 199 */     return v;
/*     */   }
/*     */   
...
/* 214 */     return (ParticleOptions)ParticleTypes.SQUID_INK;
/*     */   }
/*     */ 
/*     */   
/*     */   public void travel(Vec3 input) {
/* 219 */     move(MoverType.SELF, getDeltaMovement());
/*     */   }
/*     */ 
/*     */   
...
/* 232 */     return (this.movementVector.lengthSqr() > 9.999999747378752E-6D);
/*     */   }
/*     */ 
/*     */   
/*     */   public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, EntitySpawnReason spawnReason, SpawnGroupData groupData) {
/* 237 */     SpawnGroupData spawnGroupData = Objects.<SpawnGroupData>requireNonNullElseGet(groupData, () -> new AgeableMob.AgeableMobGroupData(0.05F));
...
/* 281 */         return (Squid.this.distanceToSqr((Entity)entity) < 100.0D);
/*     */       }
/*     */       
/* 284 */       return false;
/*     */     }
...
/* 337 */         Squid.this.level().addParticle((ParticleOptions)ParticleTypes.BUBBLE, Squid.this.getX(), Squid.this.getY(), Squid.this.getZ(), 0.0D, 0.0D, 0.0D); 
/*     */     }
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/squid/Squid.class
