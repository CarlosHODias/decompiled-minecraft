...
/*     */   
/*  74 */   private static final TargetingConditions SWIM_WITH_PLAYER_TARGETING = TargetingConditions.forNonCombat().range(10.0D).ignoreLineOfSight(); public static final int TOTAL_AIR_SUPPLY = 4800; private static final int TOTAL_MOISTNESS_LEVEL = 2400;
/*     */   public static final Predicate<ItemEntity> ALLOWED_ITEMS;
/*     */   
/*     */   static {
/*  78 */     ALLOWED_ITEMS = (e -> (!e.hasPickUpDelay() && e.isAlive() && e.isInWater()));
/*     */   }
/*     */   
...
/*  86 */     super(type, level);
/*     */     
/*  88 */     this.moveControl = (MoveControl)new SmoothSwimmingMoveControl((Mob)this, 85, 10, 0.02F, 0.1F, true);
/*  89 */     this.lookControl = (LookControl)new SmoothSwimmingLookControl((Mob)this, 10);
/*     */     
...
/*  97 */     setXRot(0.0F);
/*     */     
/*  99 */     SpawnGroupData spawnGroupData = java.util.Objects.<SpawnGroupData>requireNonNullElseGet(groupData, () -> new AgeableMob.AgeableMobGroupData(0.1F));
/*     */     
/* 101 */     return super.finalizeSpawn(level, difficulty, spawnReason, spawnGroupData);
/*     */   }
/*     */ 
/*     */   
/*     */   public Dolphin getBreedOffspring(ServerLevel level, AgeableMob partner) {
/* 106 */     return (Dolphin)EntityType.DOLPHIN.create((Level)level, EntitySpawnReason.BREEDING);
/*     */   }
/*     */ 
/*     */   
/*     */   public float getAgeScale() {
/* 111 */     return isBaby() ? 0.65F : 1.0F;
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 121 */     return (Boolean)this.entityData.get(GOT_FISH);
/*     */   }
/*     */   
/*     */   public void setGotFish(boolean gotFish) {
/* 125 */     this.entityData.set(GOT_FISH, gotFish);
/*     */   }
/*     */   
/*     */   public int getMoistnessLevel() {
/* 129 */     return (Integer)this.entityData.get(MOISTNESS_LEVEL);
/*     */   }
/*     */   
/*     */   public void setMoisntessLevel(int level) {
/* 133 */     this.entityData.set(MOISTNESS_LEVEL, level);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void defineSynchedData(SynchedEntityData.Builder entityData) {
/* 138 */     super.defineSynchedData(entityData);
/* 139 */     entityData.define(GOT_FISH, false);
/* 140 */     entityData.define(MOISTNESS_LEVEL, 2400);
/*     */   }
/*     */ 
/*     */   
...
/* 160 */     this.goalSelector.addGoal(0, (Goal)new BreathAirGoal((PathfinderMob)this));
/* 161 */     this.goalSelector.addGoal(0, (Goal)new TryFindWaterGoal((PathfinderMob)this));
...
/* 164 */     this.goalSelector.addGoal(4, (Goal)new RandomSwimmingGoal((PathfinderMob)this, 1.0D, 10));
/* 165 */     this.goalSelector.addGoal(4, (Goal)new RandomLookAroundGoal((Mob)this));
/* 166 */     this.goalSelector.addGoal(5, (Goal)new LookAtPlayerGoal((Mob)this, Player.class, 6.0F));
/* 167 */     this.goalSelector.addGoal(5, (Goal)new DolphinJumpGoal(this, 10));
/* 168 */     this.goalSelector.addGoal(6, (Goal)new MeleeAttackGoal((PathfinderMob)this, 1.2000000476837158D, true));
/* 169 */     this.goalSelector.addGoal(8, new PlayWithItemsGoal());
/* 170 */     this.goalSelector.addGoal(8, (Goal)new FollowBoatGoal((PathfinderMob)this));
/* 171 */     this.goalSelector.addGoal(9, (Goal)new AvoidEntityGoal((PathfinderMob)this, Guardian.class, 8.0F, 1.0D, 1.0D));
/*     */     
/* 173 */     this.targetSelector.addGoal(1, (Goal)new HurtByTargetGoal((PathfinderMob)this, new Class<?>[] { Guardian.class }).setAlertOthers(new Class<?>[0]));
/*     */   }
/*     */   
...
/* 185 */     return (PathNavigation)new WaterBoundPathNavigation((Mob)this, level);
/*     */   }
/*     */ 
/*     */   
/*     */   public void playAttackSound() {
/* 190 */     playSound(SoundEvents.DOLPHIN_ATTACK, 1.0F, 1.0F);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean canAttack(LivingEntity target) {
/* 195 */     return (!isBaby() && super.canAttack(target));
/*     */   }
/*     */ 
/*     */   
...
/* 225 */     return (slot == EquipmentSlot.MAINHAND && canPickUpLoot());
/*     */   }
/*     */ 
/*     */   
...
/* 236 */         take((Entity)entity, itemStack.getCount());
/* 237 */         entity.discard();
/*     */       } 
/*     */     } 
/*     */   }
...
/*     */       
/* 261 */       if (onGround()) {
/* 262 */         setDeltaMovement(getDeltaMovement().add(((
/* 263 */               this.random.nextFloat() * 2.0F - 1.0F) * 0.2F), 0.5D, ((
/*     */               
/* 265 */               this.random.nextFloat() * 2.0F - 1.0F) * 0.2F)));
/*     */         
...
/* 279 */         level().addParticle((ParticleOptions)ParticleTypes.DOLPHIN, getX() - viewVector.x * multiplier + c, getY() - viewVector.y, getZ() - viewVector.z * multiplier + s, 0.0D, 0.0D, 0.0D);
/* 280 */         level().addParticle((ParticleOptions)ParticleTypes.DOLPHIN, getX() - viewVector.x * multiplier - c, getY() - viewVector.y, getZ() - viewVector.z * multiplier - s, 0.0D, 0.0D, 0.0D);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/* 287 */     if (id == 38) {
/* 288 */       addParticlesAroundSelf((ParticleOptions)ParticleTypes.HAPPY_VILLAGER);
/*     */     } else {
...
/*     */       
/* 312 */       if (isBaby()) {
/* 313 */         itemStack.consume(1, (LivingEntity)player);
/*     */         
/* 315 */         ageUp(getSpeedUpSecondsWhenFeeding(-this.age), true);
/*     */       } else {
/* 317 */         setGotFish(true);
/*     */         
/* 319 */         itemStack.consume(1, (LivingEntity)player);
/*     */       } 
/*     */       
/* 322 */       return (InteractionResult)InteractionResult.SUCCESS;
/*     */     } 
/*     */     
...
/* 330 */     return SoundEvents.DOLPHIN_HURT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/* 335 */     return SoundEvents.DOLPHIN_DEATH;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getAmbientSound() {
/* 340 */     return isInWater() ? SoundEvents.DOLPHIN_AMBIENT_WATER : SoundEvents.DOLPHIN_AMBIENT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getSwimSplashSound() {
/* 345 */     return SoundEvents.DOLPHIN_SPLASH;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getSwimSound() {
/* 350 */     return SoundEvents.DOLPHIN_SWIM;
/*     */   }
/*     */   
/*     */   protected boolean closeToNextPos() {
/* 354 */     BlockPos target = getNavigation().getTargetPos();
/* 355 */     if (target != null) {
/* 356 */       return target.closerToCenterThan((Position)position(), 12.0D);
/*     */     }
/* 358 */     return false;
/*     */   }
/*     */ 
...
/*     */       
/* 432 */       thrownItem.setThrower((Entity)Dolphin.this);
/*     */       
/* 434 */       float pow = 0.3F;
...
/*     */ 
/*     */       
/* 443 */       Dolphin.this.level().addFreshEntity((Entity)thrownItem);
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*     */     public boolean canUse() {
/* 460 */       this.player = getServerLevel((Entity)this.dolphin).getNearestPlayer(Dolphin.SWIM_WITH_PLAYER_TARGETING, (LivingEntity)this.dolphin);
...
/* 469 */       return (this.player != null && this.player.isSwimming() && this.dolphin.distanceToSqr((Entity)this.player) < 256.0D);
/*     */     }
/*     */ 
/*     */     
/*     */     public void start() {
/* 474 */       this.player.addEffect(new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 100), (Entity)this.dolphin);
/*     */     }
/*     */ 
/*     */     
/*     */     public void stop() {
...
/*     */     
/*     */     public void tick() {
/* 485 */       this.dolphin.getLookControl().setLookAt((Entity)this.player, (this.dolphin.getMaxHeadYRot() + 20), this.dolphin.getMaxHeadXRot());
/* 486 */       if (this.dolphin.distanceToSqr((Entity)this.player) < 6.25D) {
/* 487 */         this.dolphin.getNavigation().stop();
/*     */       } else {
/* 489 */         this.dolphin.getNavigation().moveTo((Entity)this.player, this.speedModifier);
/*     */       } 
/*     */       
/* 492 */       if (this.player.isSwimming() && (this.player.level()).random.nextInt(6) == 0)
/* 493 */         this.player.addEffect(new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 100), (Entity)this.dolphin); 
/*     */     }
/*     */   }
/*     */   
...
/* 521 */         return false;
/*     */       }
/* 523 */       return (!BlockPos.containing(treasurePos.getX(), this.dolphin.getY(), treasurePos.getZ()).closerToCenterThan((Position)this.dolphin.position(), 4.0D) && !this.stuck && this.dolphin.getAirSupply() >= 100);
/*     */     }
/*     */ 
/*     */     
/*     */     public void start() {
...
/*     */         return;
/*     */       } 
/* 546 */       level.broadcastEntityEvent((Entity)this.dolphin, (byte)38);
/*     */     }
/*     */ 
/*     */     
/*     */     public void stop() {
/* 551 */       BlockPos treasurePos = this.dolphin.treasurePos;
/* 552 */       if (treasurePos == null || BlockPos.containing(treasurePos.getX(), this.dolphin.getY(), treasurePos.getZ()).closerToCenterThan((Position)this.dolphin.position(), 4.0D) || this.stuck) {
...
/* 566 */         Vec3 treasurePos = Vec3.atCenterOf((Vec3i)this.dolphin.treasurePos);
/* 567 */         Vec3 nextPos = DefaultRandomPos.getPosTowards((PathfinderMob)this.dolphin, 16, 1, treasurePos, 0.39269909262657166D);
/* 568 */         if (nextPos == null) {
/* 569 */           nextPos = DefaultRandomPos.getPosTowards((PathfinderMob)this.dolphin, 8, 4, treasurePos, 1.5707963705062866D);
/*     */         }
/*     */         
/* 572 */         if (nextPos != null) {
/* 573 */           BlockPos next = BlockPos.containing((Position)nextPos);
/* 574 */           if (!level.getFluidState(next).is(FluidTags.WATER) || !level.getBlockState(next).isPathfindable(PathComputationType.WATER)) {
/* 575 */             nextPos = DefaultRandomPos.getPosTowards((PathfinderMob)this.dolphin, 8, 5, treasurePos, 1.5707963705062866D);
/*     */           }
/*     */         } 
/*     */         
/* 579 */         if (nextPos == null) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/dolphin/Dolphin.class
