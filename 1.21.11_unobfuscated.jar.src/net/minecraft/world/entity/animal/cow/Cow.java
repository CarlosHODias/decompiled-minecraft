...
/* 52 */     Cow baby = (Cow)EntityType.COW.create((Level)level, EntitySpawnReason.BREEDING);
...
/* 66 */     this.entityData.set(DATA_VARIANT_ID, variant);
/*    */   }
/*    */   
/*    */   public Holder<CowVariant> getVariant() {
/* 70 */     return (Holder<CowVariant>)this.entityData.get(DATA_VARIANT_ID);
/*    */   }
/*    */ 
/*    */   
...
/* 91 */       setVariant((Holder<CowVariant>)castComponentValue(DataComponents.COW_VARIANT, value));
/* 92 */       return true;
/*    */     } 
/*    */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/cow/Cow.class
