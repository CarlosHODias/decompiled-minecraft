...
/*  32 */   private static final net.minecraft.network.syncher.EntityDataAccessor<Boolean> DATA_ID_CHEST = SynchedEntityData.defineId(AbstractChestedHorse.class, EntityDataSerializers.BOOLEAN);
/*     */   
...
/*  38 */     super((EntityType)type, level);
/*     */     
...
/*  50 */     java.util.Objects.requireNonNull(random); getAttribute(Attributes.MAX_HEALTH).setBaseValue(generateMaxHealth(random::nextInt));
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/*  57 */     entityData.define(DATA_ID_CHEST, false);
/*     */   }
/*     */   
...
/*  67 */     return (Boolean)this.entityData.get(DATA_ID_CHEST);
/*     */   }
/*     */   
/*     */   public void setChest(boolean flag) {
/*  71 */     this.entityData.set(DATA_ID_CHEST, flag);
/*     */   }
/*     */ 
/*     */   
/*     */   public EntityDimensions getDefaultDimensions(Pose pose) {
/*  76 */     return isBaby() ? this.babyDimensions : super.getDefaultDimensions(pose);
/*     */   }
/*     */ 
/*     */   
...
/*  82 */     if (hasChest()) {
/*  83 */       spawnAtLocation(level, (ItemLike)Blocks.CHEST);
/*  84 */       setChest(false);
/*     */     } 
/*     */   }
/*     */ 
...
/*     */     
/* 114 */     if (hasChest()) {
/* 115 */       for (ItemStackWithSlot item : (Iterable<ItemStackWithSlot>)input.listOrEmpty("Items", ItemStackWithSlot.CODEC)) {
...
/* 129 */             return AbstractChestedHorse.this.hasChest() ? new ItemStack((ItemLike)Items.CHEST) : ItemStack.EMPTY;
/*     */           }
/*     */ 
/*     */           
...
/* 168 */       if (!isTamed()) {
/* 169 */         makeMad();
/* 170 */         return (InteractionResult)InteractionResult.SUCCESS;
/*     */       } 
/*     */       
/* 173 */       if (!hasChest() && itemStack.is(Items.CHEST)) {
/* 174 */         equipChest(player, itemStack);
/* 175 */         return (InteractionResult)InteractionResult.SUCCESS;
/*     */       } 
/*     */     } 
...
/* 184 */     itemStack.consume(1, (LivingEntity)player);
/* 185 */     createInventory();
/*     */   }
/*     */ 
/*     */   
/*     */   public Vec3[] getQuadLeashOffsets() {
/* 190 */     return Leashable.createQuadLeashOffsets((Entity)this, 0.04D, 0.41D, 0.18D, 0.73D);
/*     */   }
/*     */   
/*     */   protected void playChestEquipsSound() {
/* 194 */     playSound(SoundEvents.DONKEY_CHEST, 1.0F, (this.random.nextFloat() - this.random.nextFloat()) * 0.2F + 1.0F);
/*     */   }
/*     */ 
/*     */   
/*     */   public int getInventoryColumns() {
/* 199 */     return hasChest() ? 5 : 0;
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/equine/AbstractChestedHorse.class
