...
/*  40 */     LightningBolt bolt = (LightningBolt)EntityType.LIGHTNING_BOLT.create((Level)level, EntitySpawnReason.TRIGGERED);
/*  41 */     if (bolt == null) {
/*     */       return;
/*     */     }
/*  44 */     bolt.snapTo(this.horse.getX(), this.horse.getY(), this.horse.getZ());
/*  45 */     bolt.setVisualOnly(true);
/*  46 */     level.addFreshEntity((Entity)bolt);
...
/*     */     
/*  53 */     level.addFreshEntityWithPassengers((Entity)skeleton);
/*     */     
...
/*  72 */     if (horse != null) {
/*  73 */       horse.finalizeSpawn((ServerLevelAccessor)this.horse.level(), difficulty, EntitySpawnReason.TRIGGERED, null);
...
/*  85 */     if (skeleton != null) {
/*  86 */       skeleton.finalizeSpawn((ServerLevelAccessor)horse.level(), difficulty, EntitySpawnReason.TRIGGERED, null);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/equine/SkeletonTrapGoal.class
