...
/*     */ 
/*     */   
/*  83 */   protected static final ImmutableList<MemoryModuleType<?>> MEMORY_TYPES = ImmutableList.of(MemoryModuleType.LOOK_TARGET, MemoryModuleType.NEAREST_LIVING_ENTITIES, MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES, MemoryModuleType.WALK_TARGET, MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryModuleType.PATH, MemoryModuleType.BREED_TARGET, MemoryModuleType.LONG_JUMP_COOLDOWN_TICKS, MemoryModuleType.LONG_JUMP_MID_JUMP, MemoryModuleType.ATTACK_TARGET, MemoryModuleType.TEMPTING_PLAYER, MemoryModuleType.TEMPTATION_COOLDOWN_TICKS, (Object[])new MemoryModuleType[] { MemoryModuleType.IS_TEMPTED, MemoryModuleType.HURT_BY, MemoryModuleType.HURT_BY_ENTITY, MemoryModuleType.NEAREST_ATTACKABLE, MemoryModuleType.IS_IN_WATER, MemoryModuleType.IS_PREGNANT, MemoryModuleType.IS_PANICKING, MemoryModuleType.UNREACHABLE_TONGUE_TARGETS });
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 119 */     this.lookControl = new FrogLookControl((Mob)this);
/*     */     
/* 121 */     setPathfindingMalus(PathType.WATER, 4.0F);
/* 122 */     setPathfindingMalus(PathType.TRAPDOOR, -1.0F);
/* 123 */     this.moveControl = (MoveControl)new SmoothSwimmingMoveControl((Mob)this, 85, 10, 0.02F, 0.1F, true);
/*     */   }
/*     */ 
/*     */   
/*     */   protected Brain.Provider<Frog> brainProvider() {
/* 128 */     return Brain.provider((Collection)MEMORY_TYPES, (Collection)SENSOR_TYPES);
/*     */   }
/*     */ 
/*     */   
/*     */   protected Brain<?> makeBrain(Dynamic<?> input) {
/* 133 */     return FrogAi.makeBrain(brainProvider().makeBrain(input));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public Brain<Frog> getBrain() {
/* 139 */     return super.getBrain();
/*     */   }
/*     */ 
/*     */   
...
/* 151 */     this.entityData.set(DATA_TONGUE_TARGET_ID, OptionalInt.empty());
/*     */   }
/*     */ 
/*     */   
/*     */   public Optional<Entity> getTongueTarget() {
/* 156 */     Objects.requireNonNull(level()); return ((OptionalInt)this.entityData.get(DATA_TONGUE_TARGET_ID)).stream().<Entity>mapToObj(level()::getEntity)
/* 157 */       .filter(Objects::nonNull)
/* 158 */       .findFirst();
/*     */   }
/*     */   
/*     */   public void setTongueTarget(Entity target) {
/* 162 */     this.entityData.set(DATA_TONGUE_TARGET_ID, OptionalInt.of(target.getId()));
/*     */   }
/*     */ 
/*     */   
...
/* 176 */     return (Holder<FrogVariant>)this.entityData.get(DATA_VARIANT_ID);
/*     */   }
/*     */   
/*     */   private void setVariant(Holder<FrogVariant> variant) {
/* 180 */     this.entityData.set(DATA_VARIANT_ID, variant);
/*     */   }
/*     */ 
/*     */   
...
/* 201 */       setVariant((Holder<FrogVariant>)castComponentValue(DataComponents.FROG_VARIANT, value));
/* 202 */       return true;
/*     */     } 
/*     */     
...
/* 224 */     getBrain().tick(level, (LivingEntity)this);
/* 225 */     profiler.pop();
/*     */     
...
/* 282 */     level().playSound(null, (Entity)this, SoundEvents.FROG_EAT, SoundSource.NEUTRAL, 2.0F, 1.0F);
/*     */   }
/*     */ 
/*     */   
/*     */   public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob partner) {
/* 287 */     Frog frog = (Frog)EntityType.FROG.create((Level)level, EntitySpawnReason.BREEDING);
/* 288 */     if (frog != null) {
/* 289 */       FrogAi.initMemories(frog, level.getRandom());
/*     */     }
/*     */     
/* 292 */     return (AgeableMob)frog;
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 330 */       return Frog.this.getTongueTarget().isEmpty();
/*     */     }
/*     */   }
/*     */   
...
/* 344 */     return SoundEvents.FROG_AMBIENT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getHurtSound(DamageSource source) {
/* 349 */     return SoundEvents.FROG_HURT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/* 354 */     return SoundEvents.FROG_DEATH;
/*     */   }
/*     */ 
/*     */   
/*     */   protected void playStepSound(BlockPos pos, BlockState blockState) {
/* 359 */     playSound(SoundEvents.FROG_STEP, 0.15F, 1.0F);
/*     */   }
/*     */ 
/*     */   
...
/* 369 */     return super.calculateFallDamage(fallDistance, damageModifier) - 5;
/*     */   }
/*     */ 
/*     */   
...
/* 389 */     return (PathNavigation)new FrogPathNavigation(this, level);
/*     */   }
/*     */ 
/*     */   
/*     */   public LivingEntity getTarget() {
/* 394 */     return getTargetFromBrain();
/*     */   }
/*     */   
/*     */   private static class FrogPathNavigation extends AmphibiousPathNavigation {
/*     */     FrogPathNavigation(Frog mob, Level level) {
/* 399 */       super((Mob)mob, level);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean canCutCorner(PathType pathType) {
/* 404 */       return (pathType != PathType.WATER_BORDER && super.canCutCorner(pathType));
/*     */     }
/*     */ 
/*     */     
...
/* 418 */       super(prefersShallowSwimming);
/*     */     }
/*     */ 
/*     */     
...
/*     */       
/* 433 */       BlockState belowState = context.getBlockState((BlockPos)this.belowPos);
...
/* 444 */     return itemStack.is(ItemTags.FROG_FOOD);
/*     */   }
/*     */   
...
/* 449 */       isBrightEnoughToSpawn((BlockAndTintGetter)level, pos));
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/frog/Frog.class
