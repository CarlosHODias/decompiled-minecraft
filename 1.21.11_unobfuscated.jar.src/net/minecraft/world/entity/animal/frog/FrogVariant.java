...
/*    */ 
/*    */ public final class FrogVariant extends Record implements net.minecraft.world.entity.variant.PriorityProvider<SpawnContext, SpawnCondition> {
/*    */   private final ClientAsset.ResourceTexture assetInfo;
/*    */   private final SpawnPrioritySelectors spawnConditions;
/*    */   public static final Codec<FrogVariant> DIRECT_CODEC;
/*    */   public static final Codec<FrogVariant> NETWORK_CODEC;
/*    */   
...
/*    */   
/*    */   static {
/* 23 */     DIRECT_CODEC = RecordCodecBuilder.create(i -> i.group((App)ClientAsset.ResourceTexture.DEFAULT_FIELD_CODEC.forGetter(FrogVariant::assetInfo), (App)SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(FrogVariant::spawnConditions)).apply((Applicative)i, FrogVariant::new));
/*    */ 
/*    */ 
/*    */ 
/*    */ 
/*    */     
/* 29 */     NETWORK_CODEC = RecordCodecBuilder.create(i -> i.group((App)ClientAsset.ResourceTexture.DEFAULT_FIELD_CODEC.forGetter(FrogVariant::assetInfo)).apply((Applicative)i, FrogVariant::new));
/*    */   }
/*    */ 
/*    */   
/* 33 */   public static final Codec<Holder<FrogVariant>> CODEC = (Codec<Holder<FrogVariant>>)net.minecraft.resources.RegistryFixedCodec.create(net.minecraft.core.registries.Registries.FROG_VARIANT);
/* 34 */   public static final net.minecraft.network.codec.StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, Holder<FrogVariant>> STREAM_CODEC = net.minecraft.network.codec.ByteBufCodecs.holderRegistry(net.minecraft.core.registries.Registries.FROG_VARIANT);
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/frog/FrogVariant.class
