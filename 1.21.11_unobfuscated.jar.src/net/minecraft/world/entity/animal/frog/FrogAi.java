...
/*  65 */     body.getBrain().setMemory(MemoryModuleType.LONG_JUMP_COOLDOWN_TICKS, TIME_BETWEEN_LONG_JUMPS.sample(random));
/*     */   }
/*     */   
...
/*     */     
/*  76 */     brain.setCoreActivities((Set)ImmutableSet.of(Activity.CORE));
...
/*  83 */     brain.addActivity(Activity.CORE, 0, ImmutableList.of(new AnimalPanic(2.0F), new LookAtTargetSink(45, 90), new net.minecraft.world.entity.ai.behavior.MoveToTargetSink(), new CountDownCooldownTicks(MemoryModuleType.TEMPTATION_COOLDOWN_TICKS), new CountDownCooldownTicks(MemoryModuleType.LONG_JUMP_COOLDOWN_TICKS)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  94 */           Pair.of(0, SetEntityLookTargetSometimes.create(EntityType.PLAYER, 6.0F, UniformInt.of(30, 60))), 
/*  95 */           Pair.of(0, new AnimalMakeLove(EntityType.FROG)), 
/*  96 */           Pair.of(1, new FollowTemptation(s -> 1.25F)), 
/*  97 */           Pair.of(2, StartAttacking.create((level, body) -> canAttack(body), (level, body) -> body.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE))), 
/*  98 */           Pair.of(3, TryFindLand.create(6, 1.0F)), 
/*  99 */           Pair.of(4, new RunOne(
/* 100 */               (Map)ImmutableMap.of(MemoryModuleType.WALK_TARGET, MemoryStatus.VALUE_ABSENT), 
/*     */ 
/*     */               
/* 103 */               (List)ImmutableList.of(
/* 104 */                 Pair.of(RandomStroll.stroll(1.0F), 1), 
/* 105 */                 Pair.of(SetWalkTargetFromLookTarget.create(1.0F, 3), 1), 
/* 106 */                 Pair.of(new Croak(), 3), 
/* 107 */                 Pair.of(BehaviorBuilder.triggerIf(Entity::onGround), 2))))), 
/*     */ 
/*     */         
...
/* 118 */           Pair.of(0, SetEntityLookTargetSometimes.create(EntityType.PLAYER, 6.0F, UniformInt.of(30, 60))), 
/* 119 */           Pair.of(1, new FollowTemptation(s -> 1.25F)), 
/* 120 */           Pair.of(2, StartAttacking.create((level, body) -> canAttack(body), (level, body) -> body.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE))), 
/* 121 */           Pair.of(3, TryFindLand.create(8, 1.5F)), 
/* 122 */           Pair.of(5, new GateBehavior(
...
/* 130 */                 Pair.of(RandomStroll.swim(0.75F), 1), 
/* 131 */                 Pair.of(RandomStroll.stroll(1.0F, true), 1), 
/* 132 */                 Pair.of(SetWalkTargetFromLookTarget.create(1.0F, 3), 1), 
/* 133 */                 Pair.of(BehaviorBuilder.triggerIf(Entity::isInWater), 5))))), 
/*     */ 
/*     */         
...
/* 144 */           Pair.of(0, SetEntityLookTargetSometimes.create(EntityType.PLAYER, 6.0F, UniformInt.of(30, 60))), 
/* 145 */           Pair.of(1, StartAttacking.create((level, body) -> canAttack(body), (level, body) -> body.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE))), 
/* 146 */           Pair.of(2, TryFindLandNearWater.create(8, 1.0F)), 
/* 147 */           Pair.of(3, TryLaySpawnOnWaterNearLand.create(Blocks.FROGSPAWN)), 
/* 148 */           Pair.of(4, new RunOne(
/* 149 */               (List)ImmutableList.of(
/* 150 */                 Pair.of(RandomStroll.stroll(1.0F), 2), 
/* 151 */                 Pair.of(SetWalkTargetFromLookTarget.create(1.0F, 3), 1), 
/* 152 */                 Pair.of(new Croak(), 2), 
/* 153 */                 Pair.of(BehaviorBuilder.triggerIf(Entity::onGround), 1))))), 
/*     */ 
/*     */         
...
/* 164 */           Pair.of(0, new LongJumpMidJump(TIME_BETWEEN_LONG_JUMPS, SoundEvents.FROG_STEP)), 
/* 165 */           Pair.of(1, new LongJumpToPreferredBlock(TIME_BETWEEN_LONG_JUMPS, 2, 4, 3.5714288F, frog -> SoundEvents.FROG_LONG_JUMP, BlockTags.FROG_PREFER_JUMP_TO, 0.5F, FrogAi::isAcceptableLandingSpot))), 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 184 */     brain.addActivityAndRemoveMemoryWhenStopped(Activity.TONGUE, 0, ImmutableList.of(
...
/* 201 */       return true;
/*     */     }
/* 203 */     PathfindingContext context = new PathfindingContext((net.minecraft.world.level.CollisionGetter)body.level(), (Mob)body);
...
/* 207 */       return true;
/*     */     }
/* 209 */     return LongJumpToRandomPos.defaultAcceptableLandingSpot((Mob)body, targetPos);
/*     */   }
/*     */   
/*     */   private static boolean canAttack(Frog e) {
/* 213 */     return !net.minecraft.world.entity.ai.behavior.BehaviorUtils.isBreeding((LivingEntity)e);
/*     */   }
/*     */   
/*     */   public static void updateActivity(Frog body) {
/* 217 */     body.getBrain().setActiveActivityToFirstValid((List)ImmutableList.of(Activity.TONGUE, Activity.LAY_SPAWN, Activity.LONG_JUMP, Activity.SWIM, Activity.IDLE));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 227 */     return i -> i.is(ItemTags.FROG_FOOD);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/frog/FrogAi.class
