...
/*  47 */     super((Map)ImmutableMap.of(MemoryModuleType.WALK_TARGET, MemoryStatus.VALUE_ABSENT, MemoryModuleType.LOOK_TARGET, MemoryStatus.REGISTERED, MemoryModuleType.ATTACK_TARGET, MemoryStatus.VALUE_PRESENT, MemoryModuleType.IS_PANICKING, MemoryStatus.VALUE_ABSENT), 100);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     LivingEntity target = body.getBrain().getMemory(MemoryModuleType.ATTACK_TARGET).get();
/*     */     
...
/*     */     } 
/*  67 */     return (canPathfindToTarget && 
/*  68 */       body.getPose() != Pose.CROAKING && 
...
/*  81 */     LivingEntity target = body.getBrain().getMemory(MemoryModuleType.ATTACK_TARGET).get();
/*     */     
/*  83 */     BehaviorUtils.lookAtEntity((LivingEntity)body, target);
/*  84 */     body.setTongueTarget((Entity)target);
/*     */     
...
/*  99 */     level.playSound(null, (Entity)body, this.eatSound, SoundSource.NEUTRAL, 2.0F, 1.0F);
/*     */     
/* 101 */     Optional<Entity> tongueTarget = body.getTongueTarget();
/* 102 */     if (tongueTarget.isPresent()) {
/* 103 */       Entity target = tongueTarget.get();
...
/* 116 */     LivingEntity target = body.getBrain().getMemory(MemoryModuleType.ATTACK_TARGET).get();
/* 117 */     body.setTongueTarget((Entity)target);
/*     */     
/* 119 */     switch (this.state.ordinal()) {
/*     */       case 0:
/* 121 */         if (target.distanceTo((Entity)body) < 1.75F) {
/* 122 */           level.playSound(null, (Entity)body, this.tongueSound, SoundSource.NEUTRAL, 2.0F, 1.0F);
...
/* 155 */     Path path = body.getNavigation().createPath((Entity)target, 0);
/* 156 */     return (path != null && path.getDistToTarget() < 1.75F);
/*     */   }
/*     */   
/*     */   private void addUnreachableTargetToMemory(Frog body, LivingEntity entity) {
/* 160 */     List<UUID> unreachableTargets = body.getBrain().getMemory(MemoryModuleType.UNREACHABLE_TONGUE_TARGETS).orElseGet(java.util.ArrayList::new);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/frog/ShootTongue.class
