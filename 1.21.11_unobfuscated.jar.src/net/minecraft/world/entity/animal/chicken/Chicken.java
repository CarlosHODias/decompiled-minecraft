...
/*  82 */     this.goalSelector.addGoal(0, (Goal)new FloatGoal((Mob)this));
/*  83 */     this.goalSelector.addGoal(1, (Goal)new PanicGoal((PathfinderMob)this, 1.4D));
/*  84 */     this.goalSelector.addGoal(2, (Goal)new BreedGoal(this, 1.0D));
/*  85 */     this.goalSelector.addGoal(3, (Goal)new TemptGoal((PathfinderMob)this, 1.0D, i -> i.is(ItemTags.CHICKEN_FOOD), false));
/*  86 */     this.goalSelector.addGoal(4, (Goal)new FollowParentGoal(this, 1.1D));
/*  87 */     this.goalSelector.addGoal(5, (Goal)new WaterAvoidingRandomStrollGoal((PathfinderMob)this, 1.0D));
/*  88 */     this.goalSelector.addGoal(6, (Goal)new LookAtPlayerGoal((Mob)this, Player.class, 6.0F));
/*  89 */     this.goalSelector.addGoal(7, (Goal)new RandomLookAroundGoal((Mob)this));
/*     */   }
/*     */ 
/*     */   
/*     */   public EntityDimensions getDefaultDimensions(Pose pose) {
/*  94 */     return isBaby() ? BABY_DIMENSIONS : super.getDefaultDimensions(pose);
/*     */   }
/*     */   
...
/*     */     
/* 125 */     Level level = level(); if (level instanceof ServerLevel) { ServerLevel serverLevel = (ServerLevel)level; if (isAlive() && !isBaby() && !isChickenJockey() && --this.eggTime <= 0) {
/* 126 */         if (dropFromGiftLootTable(serverLevel, BuiltInLootTables.CHICKEN_LAY, this::spawnAtLocation)) {
/* 127 */           playSound(SoundEvents.CHICKEN_EGG, 1.0F, (this.random.nextFloat() - this.random.nextFloat()) * 0.2F + 1.0F);
/* 128 */           gameEvent((Holder)GameEvent.ENTITY_PLACE);
/*     */         } 
...
/* 136 */     return (this.flyDist > this.nextFlap);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void onFlap() {
/* 141 */     this.nextFlap = this.flyDist + this.flapSpeed / 2.0F;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getAmbientSound() {
/* 146 */     return SoundEvents.CHICKEN_AMBIENT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getHurtSound(DamageSource source) {
/* 151 */     return SoundEvents.CHICKEN_HURT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/* 156 */     return SoundEvents.CHICKEN_DEATH;
/*     */   }
/*     */ 
/*     */   
/*     */   protected void playStepSound(BlockPos pos, BlockState blockState) {
/* 161 */     playSound(SoundEvents.CHICKEN_STEP, 0.15F, 1.0F);
/*     */   }
/*     */ 
/*     */   
/*     */   public Chicken getBreedOffspring(ServerLevel level, AgeableMob partner) {
/* 166 */     Chicken baby = (Chicken)EntityType.CHICKEN.create((Level)level, EntitySpawnReason.BREEDING);
...
/* 181 */     return itemStack.is(ItemTags.CHICKEN_FOOD);
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 203 */     input.getInt("EggLayTime").ifPresent(time -> this.eggTime = time);
...
/* 216 */     this.entityData.set(DATA_VARIANT_ID, variant);
/*     */   }
/*     */   
/*     */   public Holder<ChickenVariant> getVariant() {
/* 220 */     return (Holder<ChickenVariant>)this.entityData.get(DATA_VARIANT_ID);
/*     */   }
/*     */ 
/*     */   
...
/* 241 */       Optional<Holder<ChickenVariant>> variant = ((EitherHolder)castComponentValue(DataComponents.CHICKEN_VARIANT, value)).unwrap((HolderLookup.Provider)registryAccess());
/* 242 */       if (variant.isPresent()) {
/* 243 */         setVariant(variant.get());
/* 244 */         return true;
/*     */       } 
/* 246 */       return false;
/*     */     } 
...
/* 266 */     return this.isChickenJockey;
/*     */   }
/*     */   
/*     */   public void setChickenJockey(boolean isChickenJockey) {
/* 270 */     this.isChickenJockey = isChickenJockey;
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/chicken/Chicken.class
