...
/*  75 */     return (Boolean)this.entityData.get(DATA_TRUSTING);
/*     */   }
/*     */   
/*     */   private void setTrusting(boolean trusting) {
/*  79 */     this.entityData.set(DATA_TRUSTING, trusting);
/*     */     
...
/*     */     
/* 102 */     entityData.define(DATA_TRUSTING, false);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void registerGoals() {
/* 107 */     this.temptGoal = new OcelotTemptGoal(this, 0.6D, i -> i.is(ItemTags.OCELOT_FOOD), true);
/* 108 */     this.goalSelector.addGoal(1, (Goal)new FloatGoal((Mob)this));
/* 109 */     this.goalSelector.addGoal(3, (Goal)this.temptGoal);
/* 110 */     this.goalSelector.addGoal(7, (Goal)new LeapAtTargetGoal((Mob)this, 0.3F));
/* 111 */     this.goalSelector.addGoal(8, (Goal)new OcelotAttackGoal((Mob)this));
/* 112 */     this.goalSelector.addGoal(9, (Goal)new BreedGoal(this, 0.8D));
/* 113 */     this.goalSelector.addGoal(10, (Goal)new WaterAvoidingRandomStrollGoal((PathfinderMob)this, 0.8D, 1.0000001E-5F));
/* 114 */     this.goalSelector.addGoal(11, (Goal)new LookAtPlayerGoal((Mob)this, Player.class, 10.0F));
/*     */     
/* 116 */     this.targetSelector.addGoal(1, (Goal)new NearestAttackableTargetGoal((Mob)this, Chicken.class, false));
/* 117 */     this.targetSelector.addGoal(1, (Goal)new NearestAttackableTargetGoal((Mob)this, Turtle.class, 10, false, false, Turtle.BABY_ON_LAND_SELECTOR));
/*     */   }
/*     */ 
/*     */   
...
/* 142 */     return (!isTrusting() && this.tickCount > 2400);
/*     */   }
/*     */   
...
/* 154 */     return SoundEvents.OCELOT_AMBIENT;
/*     */   }
/*     */ 
/*     */   
...
/* 164 */     return SoundEvents.OCELOT_HURT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/* 169 */     return SoundEvents.OCELOT_DEATH;
/*     */   }
/*     */ 
/*     */   
/*     */   public InteractionResult mobInteract(Player player, InteractionHand hand) {
/* 174 */     ItemStack itemStack = player.getItemInHand(hand);
/* 175 */     if ((this.temptGoal == null || this.temptGoal.isRunning()) && !isTrusting() && isFood(itemStack) && player.distanceToSqr((Entity)this) < 9.0D) {
...
/* 182 */           level().broadcastEntityEvent((Entity)this, (byte)41);
/*     */         } else {
/* 184 */           spawnTrustingParticles(false);
/* 185 */           level().broadcastEntityEvent((Entity)this, (byte)40);
/*     */         } 
/*     */       }
/*     */       
/* 189 */       return (InteractionResult)InteractionResult.SUCCESS;
/*     */     } 
/*     */     
...
/* 215 */       level().addParticle((ParticleOptions)simpleParticleType, getRandomX(1.0D), getRandomY() + 0.5D, getRandomZ(1.0D), xa, ya, za);
/*     */     } 
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/* 224 */     this.goalSelector.removeGoal((Goal)this.ocelotAvoidPlayersGoal);
/*     */     
/* 226 */     if (!isTrusting()) {
/* 227 */       this.goalSelector.addGoal(4, (Goal)this.ocelotAvoidPlayersGoal);
/*     */     }
/*     */   }
/*     */ 
/*     */   
/*     */   public Ocelot getBreedOffspring(ServerLevel level, AgeableMob partner) {
/* 233 */     return (Ocelot)EntityType.OCELOT.create((Level)level, EntitySpawnReason.BREEDING);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isFood(ItemStack itemStack) {
/* 238 */     return itemStack.is(ItemTags.OCELOT_FOOD);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 244 */     return (random.nextInt(3) != 0);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean checkSpawnObstruction(LevelReader level) {
/* 249 */     if (level.isUnobstructed((Entity)this) && !level.containsAnyLiquid(getBoundingBox())) {
...
/*     */     }
/*     */     
/* 270 */     return super.finalizeSpawn(level, difficulty, spawnReason, (SpawnGroupData)ageableMobGroupData);
/*     */   }
/*     */ 
/*     */   
/*     */   public Vec3 getLeashOffset() {
/* 275 */     return new Vec3(0.0D, (0.5F * getEyeHeight()), (getBbWidth() * 0.4F));
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isSteppingCarefully() {
/* 280 */     return (isCrouching() || super.isSteppingCarefully());
/*     */   }
/*     */   
...
/* 287 */       super((PathfinderMob)ocelot, avoidClass, maxDist, walkSpeedModifier, sprintSpeedModifier, EntitySelector.NO_CREATIVE_OR_SPECTATOR);
...
/* 306 */       super((PathfinderMob)ocelot, speedModifier, items, canScare);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/feline/Ocelot.class
