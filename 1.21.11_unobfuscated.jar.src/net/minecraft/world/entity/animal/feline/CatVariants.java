...
/* 33 */     return ResourceKey.create(Registries.CAT_VARIANT, Identifier.withDefaultNamespace(name));
/*    */   }
/*    */   
...
/* 51 */           List.of(new PriorityProvider.Selector((PriorityProvider.SelectorCondition)new StructureCheck((HolderSet)
/*    */                 
/* 53 */                 structures.getOrThrow(StructureTags.CATS_SPAWN_AS_BLACK)), 1), new PriorityProvider.Selector((PriorityProvider.SelectorCondition)new MoonBrightnessCheck(
/*    */                 
...
/* 61 */     register(context, name, texture, SpawnPrioritySelectors.fallback(0));
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/feline/CatVariants.class
