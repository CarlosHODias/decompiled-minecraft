...
/* 128 */   public final BinaryAnimator movingAnimator = new BinaryAnimator(10, EasingType.IN_OUT_SINE);
/*     */   private static final int REGEN_BUFF_BASE_DURATION = 100;
/*     */   
/* 131 */   public enum Variant implements StringRepresentable { LUCY(0, "lucy", true),
/* 132 */     WILD(1, "wild", true),
/* 133 */     GOLD(2, "gold", true),
/* 134 */     CYAN(3, "cyan", true),
/* 135 */     BLUE(4, "blue", false);
/*     */     
/* 137 */     public static final Variant DEFAULT = LUCY;
/*     */     
/* 139 */     private static final IntFunction<Variant> BY_ID = ByIdMap.continuous(Variant::getId, (Object[])values(), ByIdMap.OutOfBoundsStrategy.ZERO);
/*     */     
/* 141 */     public static final StreamCodec<ByteBuf, Variant> STREAM_CODEC = ByteBufCodecs.idMapper(BY_ID, Variant::getId);
/*     */     
/* 143 */     public static final Codec<Variant> CODEC = (Codec<Variant>)StringRepresentable.fromEnum(Variant::values);
/*     */     @Deprecated
/* 145 */     public static final Codec<Variant> LEGACY_CODEC = Codec.INT.xmap(BY_ID::apply, Variant::getId); static { Objects.requireNonNull(BY_ID); }
/*     */     
...
/* 175 */       return getSpawnVariant(random, true);
/*     */     }
/*     */     
/*     */     public static Variant getRareSpawnVariant(RandomSource random) {
/* 179 */       return getSpawnVariant(random, false);
/*     */     }
/*     */     
/*     */     private static Variant getSpawnVariant(RandomSource random, boolean common) {
/* 183 */       Variant[] validVariants = (Variant[])Arrays.<Variant>stream(values()).filter(v -> (v.common == common)).toArray(x$0 -> new Variant[x$0]);
/* 184 */       return (Variant)Util.getRandom((Object[])validVariants, random);
/*     */     } }
/*     */ 
/*     */ 
/*     */ 
...
/* 194 */     this.moveControl = (MoveControl)new AxolotlMoveControl(this);
/* 195 */     this.lookControl = (LookControl)new AxolotlLookControl(this, 20);
/*     */   }
/*     */ 
/*     */   
...
/* 206 */     entityData.define(DATA_VARIANT, 0);
/* 207 */     entityData.define(DATA_PLAYING_DEAD, false);
/* 208 */     entityData.define(FROM_BUCKET, false);
/*     */   }
/*     */ 
/*     */   
...
/* 221 */     setVariant(input.read("Variant", Variant.LEGACY_CODEC).orElse(Variant.DEFAULT));
...
/*     */     } else {
/*     */       
/* 248 */       axolotlGroupData = new AxolotlGroupData(new Variant[] { Variant.getCommonSpawnVariant(random), Variant.getCommonSpawnVariant(random) });
/*     */     } 
/*     */     
/* 251 */     setVariant(axolotlGroupData.getVariant(random));
/* 252 */     if (isBaby) {
/* 253 */       setAge(-24000);
/*     */     }
/*     */     
/* 256 */     return super.finalizeSpawn(level, difficulty, spawnReason, (SpawnGroupData)axolotlGroupData);
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 288 */     boolean isMoving = (this.walkAnimation.isMoving() || 
/* 289 */       getXRot() != this.xRotO || 
/* 290 */       getYRot() != this.yRotO);
...
/* 318 */     return Variant.byId((Integer)this.entityData.get(DATA_VARIANT));
/*     */   }
/*     */   
/*     */   private void setVariant(Variant variant) {
/* 322 */     this.entityData.set(DATA_VARIANT, variant.getId());
/*     */   }
/*     */ 
/*     */   
...
/* 351 */     return (random.nextInt(1200) == 0);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean checkSpawnObstruction(LevelReader level) {
/* 356 */     return level.isUnobstructed((Entity)this);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 366 */     this.entityData.set(DATA_PLAYING_DEAD, playingDead);
/*     */   }
/*     */   
/*     */   public boolean isPlayingDead() {
/* 370 */     return (Boolean)this.entityData.get(DATA_PLAYING_DEAD);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean fromBucket() {
/* 375 */     return (Boolean)this.entityData.get(FROM_BUCKET);
/*     */   }
/*     */ 
/*     */   
/*     */   public void setFromBucket(boolean fromBucket) {
/* 380 */     this.entityData.set(FROM_BUCKET, fromBucket);
/*     */   }
/*     */ 
/*     */   
/*     */   public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob partner) {
/* 385 */     Axolotl baby = (Axolotl)EntityType.AXOLOTL.create((Level)level, EntitySpawnReason.BREEDING);
/* 386 */     if (baby != null) {
/*     */       Variant variant;
...
/*     */     } 
/* 396 */     return (AgeableMob)baby;
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isFood(ItemStack itemStack) {
/* 401 */     return itemStack.is(ItemTags.AXOLOTL_FOOD);
/*     */   }
/*     */ 
/*     */   
...
/* 413 */     getBrain().tick(level, (LivingEntity)this);
/* 414 */     profiler.pop();
/*     */     
...
/* 422 */       setPlayingDead((playDeadTicks.isPresent() && (Integer)playDeadTicks.get() > 0));
/*     */     } 
/*     */   }
/*     */   
...
/* 436 */     return (PathNavigation)new AmphibiousPathNavigation((Mob)this, level);
/*     */   }
/*     */ 
/*     */   
/*     */   public void playAttackSound() {
/* 441 */     playSound(SoundEvents.AXOLOTL_ATTACK, 1.0F, 1.0F);
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 451 */       isInWater() && (
/* 452 */       source.getEntity() != null || source.getDirectEntity() != null) && 
/* 453 */       !isPlayingDead()) {
/* 454 */       this.brain.setMemory(MemoryModuleType.PLAY_DEAD_TICKS, 200);
/*     */     }
/*     */     
...
/* 472 */     return Bucketable.bucketMobPickup(player, hand, (LivingEntity)this).orElse(super.mobInteract(player, hand));
/*     */   }
/*     */ 
/*     */   
/*     */   public void saveToBucketTag(ItemStack bucket) {
/* 477 */     Bucketable.saveDefaultDataToBucketTag((Mob)this, bucket);
/* 478 */     bucket.copyFrom(DataComponents.AXOLOTL_VARIANT, (DataComponentGetter)this);
/*     */     
...
/* 492 */     Bucketable.loadDefaultDataFromBucketTag((Mob)this, tag);
/*     */     
/* 494 */     setAge(tag.getIntOr("Age", 0));
/* 495 */     tag.getLong("HuntingCooldown").ifPresentOrElse(huntingCooldown -> getBrain().setMemoryWithExpiry(MemoryModuleType.HAS_HUNTING_COOLDOWN, true, tag.getLongOr("HuntingCooldown", 0L)), () -> getBrain().setMemory(MemoryModuleType.HAS_HUNTING_COOLDOWN, Optional.empty()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 503 */     return new ItemStack((ItemLike)Items.AXOLOTL_BUCKET);
/*     */   }
/*     */ 
/*     */   
/*     */   public SoundEvent getPickupSound() {
/* 508 */     return SoundEvents.BUCKET_FILL_AXOLOTL;
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean canBeSeenAsEnemy() {
/* 513 */     return (!isPlayingDead() && super.canBeSeenAsEnemy());
/*     */   }
/*     */   
...
/* 542 */       player.addEffect(new MobEffectInstance(MobEffects.REGENERATION, regenDuration, 0), (Entity)this);
/*     */     } 
/*     */ 
/*     */     
...
/* 551 */     return (super.requiresCustomPersistence() || fromBucket());
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getHurtSound(DamageSource source) {
/* 556 */     return SoundEvents.AXOLOTL_HURT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/* 561 */     return SoundEvents.AXOLOTL_DEATH;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getAmbientSound() {
/* 566 */     return isInWater() ? SoundEvents.AXOLOTL_IDLE_WATER : SoundEvents.AXOLOTL_IDLE_AIR;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getSwimSplashSound() {
/* 571 */     return SoundEvents.AXOLOTL_SPLASH;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getSwimSound() {
/* 576 */     return SoundEvents.AXOLOTL_SWIM;
/*     */   }
/*     */ 
/*     */   
/*     */   protected Brain.Provider<Axolotl> brainProvider() {
/* 581 */     return Brain.provider((Collection)MEMORY_TYPES, (Collection)SENSOR_TYPES);
/*     */   }
/*     */ 
/*     */   
/*     */   protected Brain<?> makeBrain(Dynamic<?> input) {
/* 586 */     return AxolotlAi.makeBrain(brainProvider().makeBrain(input));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public Brain<Axolotl> getBrain() {
/* 592 */     return super.getBrain();
/*     */   }
/*     */ 
/*     */   
...
/* 606 */       player.setItemInHand(hand, ItemUtils.createFilledResult(itemStack, player, new ItemStack((ItemLike)Items.WATER_BUCKET)));
/*     */     } else {
...
/* 614 */     return (!fromBucket() && !hasCustomName());
/*     */   }
/*     */ 
/*     */   
/*     */   public LivingEntity getTarget() {
/* 619 */     return getTargetFromBrain();
/*     */   }
/*     */   
...
/* 623 */     return level.getBlockState(pos.below()).is(BlockTags.AXOLOTLS_SPAWNABLE_ON);
/*     */   }
/*     */   
...
/* 630 */       super((Mob)axolotl, 85, 10, 0.1F, 0.5F, false);
...
/* 644 */       super((Mob)axolotl, maxYRotFromCenter);
/*     */     }
/*     */ 
/*     */     
/*     */     public void tick() {
...
/* 664 */       return this.types[random.nextInt(this.types.length)];
/*     */     }
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/axolotl/Axolotl.class
