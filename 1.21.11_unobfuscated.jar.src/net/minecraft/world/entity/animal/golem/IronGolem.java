...
/*  66 */     super((EntityType)type, level);
/*     */   }
/*     */ 
/*     */   
...
/*  82 */     this.targetSelector.addGoal(3, (Goal)new NearestAttackableTargetGoal((Mob)this, Mob.class, 5, false, false, (target, level) -> (target instanceof net.minecraft.world.entity.monster.Enemy && !(target instanceof net.minecraft.world.entity.monster.Creeper))));
...
/*  89 */     entityData.define(DATA_FLAGS_ID, (byte)0);
/*     */   }
/*     */   
...
/* 170 */     this.persistentAngerEndTime = endTime;
/*     */   }
/*     */ 
/*     */   
...
/* 180 */     this.persistentAngerTarget = persistentAngerTarget;
/*     */   }
/*     */ 
/*     */   
...
/* 195 */     level.broadcastEntityEvent((Entity)this, (byte)4);
...
/*     */     
/* 282 */     itemStack.consume(1, (LivingEntity)player);
...
/* 296 */     return (((Byte)this.entityData.get(DATA_FLAGS_ID) & 0x1) != 0);
/*     */   }
/*     */   
/*     */   public void setPlayerCreated(boolean value) {
/* 300 */     byte current = (Byte)this.entityData.get(DATA_FLAGS_ID);
/* 301 */     if (value) {
/* 302 */       this.entityData.set(DATA_FLAGS_ID, (byte)(current | 0x1));
/*     */     } else {
/* 304 */       this.entityData.set(DATA_FLAGS_ID, (byte)(current & 0xFFFFFFFE));
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 320 */     if (below.entityCanStandOn((BlockGetter)level, belowPos, (Entity)this)) {
/* 321 */       for (int i = 1; i < 3; i++) {
/* 322 */         BlockPos abovePos = pos.above(i);
/* 323 */         BlockState above = level.getBlockState(abovePos);
/* 324 */         if (!NaturalSpawner.isValidEmptySpawnBlock((BlockGetter)level, abovePos, above, above.getFluidState(), EntityType.IRON_GOLEM)) {
/* 325 */           return false;
/*     */         }
/*     */       } 
/* 328 */       return (NaturalSpawner.isValidEmptySpawnBlock((BlockGetter)level, pos, level.getBlockState(pos), Fluids.EMPTY.defaultFluidState(), EntityType.IRON_GOLEM) && 
/* 329 */         level.isUnobstructed((Entity)this));
/*     */     } 
/* 331 */     return false;
/*     */   }
/*     */ 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/golem/IronGolem.class
