...
/*  73 */     this.eatBlockGoal = new EatBlockGoal((Mob)this);
...
/*  76 */     this.goalSelector.addGoal(2, (Goal)new BreedGoal(this, 1.0D));
/*  77 */     this.goalSelector.addGoal(3, (Goal)new TemptGoal((PathfinderMob)this, 1.1D, i -> i.is(ItemTags.SHEEP_FOOD), false));
/*  78 */     this.goalSelector.addGoal(4, (Goal)new FollowParentGoal(this, 1.1D));
/*  79 */     this.goalSelector.addGoal(5, (Goal)this.eatBlockGoal);
...
/*  87 */     return itemStack.is(ItemTags.SHEEP_FOOD);
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/* 115 */     entityData.define(DATA_WOOL_ID, (byte)0);
/*     */   }
/*     */ 
/*     */   
...
/* 155 */       Level level = level(); if (level instanceof ServerLevel) { ServerLevel serverLevel = (ServerLevel)level; if (readyForShearing()) {
/* 156 */           shear(serverLevel, SoundSource.PLAYERS, itemStack);
/* 157 */           gameEvent((Holder)GameEvent.SHEAR, (Entity)player);
/* 158 */           itemStack.hurtAndBreak(1, (LivingEntity)player, hand.asEquipmentSlot());
/* 159 */           return (InteractionResult)InteractionResult.SUCCESS_SERVER;
/*     */         }  }
...
/* 169 */     level.playSound(null, (Entity)this, SoundEvents.SHEEP_SHEAR, soundSource, 1.0F, 1.0F);
/*     */     
/* 171 */     dropFromShearingLootTable(level, BuiltInLootTables.SHEAR_SHEEP, tool, (l, drop) -> {
/*     */           for (int i = 0; i < drop.getCount(); i++) {
/*     */             ItemEntity entity = spawnAtLocation(l, drop.copyWithCount(1), 1.0F);
/*     */ 
/*     */ 
/*     */             
/*     */             if (entity != null) {
...
/* 189 */     return (isAlive() && !isSheared() && !isBaby());
/*     */   }
/*     */ 
/*     */   
...
/* 203 */     setColor(input.read("Color", DyeColor.LEGACY_ID_CODEC).orElse(DEFAULT_COLOR));
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getAmbientSound() {
/* 208 */     return SoundEvents.SHEEP_AMBIENT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getHurtSound(DamageSource source) {
/* 213 */     return SoundEvents.SHEEP_HURT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/* 218 */     return SoundEvents.SHEEP_DEATH;
/*     */   }
/*     */ 
/*     */   
/*     */   protected void playStepSound(BlockPos pos, BlockState blockState) {
/* 223 */     playSound(SoundEvents.SHEEP_STEP, 0.15F, 1.0F);
/*     */   }
/*     */   
/*     */   public DyeColor getColor() {
/* 227 */     return DyeColor.byId((Byte)this.entityData.get(DATA_WOOL_ID) & 0xF);
/*     */   }
/*     */   
/*     */   public void setColor(DyeColor color) {
/* 231 */     byte current = (Byte)this.entityData.get(DATA_WOOL_ID);
/* 232 */     this.entityData.set(DATA_WOOL_ID, (byte)(current & 0xF0 | color.getId() & 0xF));
/*     */   }
/*     */ 
/*     */   
...
/* 261 */     return (((Byte)this.entityData.get(DATA_WOOL_ID) & 0x10) != 0);
/*     */   }
/*     */   
/*     */   public void setSheared(boolean value) {
/* 265 */     byte current = (Byte)this.entityData.get(DATA_WOOL_ID);
/* 266 */     if (value) {
/* 267 */       this.entityData.set(DATA_WOOL_ID, (byte)(current | 0x10));
/*     */     } else {
/* 269 */       this.entityData.set(DATA_WOOL_ID, (byte)(current & 0xFFFFFFEF));
/*     */     } 
/*     */   }
/*     */   
...
/* 280 */     Sheep sheep = (Sheep)EntityType.SHEEP.create((Level)level, EntitySpawnReason.BREEDING);
/*     */     
/* 282 */     if (sheep != null) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/sheep/Sheep.class
