...
/*  67 */   private int leashHolderTime = 0; public static final int FAST_HEALING_TICKS = 20; public static final int SLOW_HEALING_TICKS = 600; public static final int MAX_PASSANGERS = 4; private static final int STILL_TIMEOUT_ON_LOAD_GRACE_PERIOD = 60; private static final int MAX_STILL_TIMEOUT = 10;
...
/*  77 */     super(type, level);
/*  78 */     this.moveControl = (MoveControl)new Ghast.GhastMoveControl((Mob)this, true, this::isOnStillTimeout);
...
/*  86 */         (serverLevel.getChunkSource()).chunkMap.sendToTrackingPlayers((Entity)this, (Packet)ClientboundEntityPositionSyncPacket.of((Entity)this)); }
/*     */        }
...
/*  93 */     return (PathNavigation)new BabyFlyingPathNavigation(this, level);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void registerGoals() {
/*  98 */     this.goalSelector.addGoal(3, (Goal)new HappyGhastFloatGoal());
/*  99 */     this.goalSelector.addGoal(4, (Goal)new TemptGoal.ForNonPathfinders((Mob)this, 1.0D, itemStack -> (isWearingBodyArmor() || isBaby()) ? itemStack.is(ItemTags.HAPPY_GHAST_FOOD) : itemStack.is(ItemTags.HAPPY_GHAST_TEMPT_ITEMS), false, 7.0D));
/* 100 */     this.goalSelector.addGoal(5, (Goal)new Ghast.RandomFloatAroundGoal((Mob)this, 16));
/*     */   }
/*     */   
/*     */   private void adultGhastSetup() {
/* 104 */     this.moveControl = (MoveControl)new Ghast.GhastMoveControl((Mob)this, true, this::isOnStillTimeout);
...
/* 109 */       registerGoals();
/* 110 */       this.brain.stopAll(serverLevel, (LivingEntity)this);
/* 111 */       this.brain.clearMemories(); }
/*     */   
/*     */   }
/*     */   
/*     */   private void babyGhastSetup() {
/* 116 */     this.moveControl = (MoveControl)new FlyingMoveControl((Mob)this, 180, true);
/* 117 */     this.lookControl = new LookControl((Mob)this);
...
/* 145 */     return Math.min(scale, 1.0F);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 207 */     return SoundSource.NEUTRAL;
/*     */   }
/*     */ 
/*     */   
...
/* 222 */     return isBaby() ? SoundEvents.GHASTLING_AMBIENT : SoundEvents.HAPPY_GHAST_AMBIENT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getHurtSound(DamageSource source) {
/* 227 */     return isBaby() ? SoundEvents.GHASTLING_HURT : SoundEvents.HAPPY_GHAST_HURT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/* 232 */     return isBaby() ? SoundEvents.GHASTLING_DEATH : SoundEvents.HAPPY_GHAST_DEATH;
/*     */   }
/*     */ 
/*     */   
/*     */   protected float getSoundVolume() {
/* 237 */     return isBaby() ? 1.0F : 4.0F;
/*     */   }
/*     */ 
/*     */   
...
/* 247 */     return (AgeableMob)EntityType.HAPPY_GHAST.create((Level)level, EntitySpawnReason.BREEDING);
/*     */   }
/*     */ 
/*     */   
...
/* 257 */     return isBaby() ? 0.2375F : 1.0F;
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isFood(ItemStack itemStack) {
/* 262 */     return itemStack.is(ItemTags.HAPPY_GHAST_FOOD);
/*     */   }
/*     */ 
/*     */   
...
/* 275 */     return (slot == EquipmentSlot.BODY);
/*     */   }
/*     */ 
/*     */   
...
/* 287 */       InteractionResult interactionResult = itemStack.interactLivingEntity(player, (LivingEntity)this, hand);
...
/* 295 */       return (InteractionResult)InteractionResult.SUCCESS;
/*     */     } 
...
/* 304 */       player.startRiding((Entity)this);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 340 */     return (getPassengers().size() < 4);
/*     */   }
/*     */ 
/*     */   
/*     */   public LivingEntity getControllingPassenger() {
/* 345 */     Entity firstPassenger = getFirstPassenger();
/* 346 */     if (isWearingBodyArmor() && !isOnStillTimeout() && firstPassenger instanceof Player) { Player player = (Player)firstPassenger;
/* 347 */       return (LivingEntity)player; }
/*     */     
...
/* 377 */     return new Vec2(controller.getXRot() * 0.5F, controller.getYRot());
/*     */   }
/*     */ 
/*     */   
/*     */   protected void tickRidden(Player controller, Vec3 riddenInput) {
/* 382 */     super.tickRidden(controller, riddenInput);
/* 383 */     Vec2 rotation = getRiddenRotation((LivingEntity)controller);
...
/* 398 */     return HappyGhastAi.brainProvider();
/*     */   }
/*     */ 
/*     */   
/*     */   protected Brain<?> makeBrain(Dynamic<?> input) {
/* 403 */     return HappyGhastAi.makeBrain(brainProvider().makeBrain(input));
/*     */   }
/*     */ 
/*     */   
...
/* 411 */       this.brain.tick(level, (LivingEntity)this);
/* 412 */       profiler.pop();
/*     */       
...
/* 468 */     if (hasHome() && getHomePosition().closerThan((Vec3i)blockPosition(), (radius + 16)) && radius == getHomeRadius()) {
/*     */       return;
/*     */     }
...
/* 475 */     Level level = level(); if (level instanceof ServerLevel) { ServerLevel serverLevel = (ServerLevel)level; if (isAlive() && this.deathTime == 0 && getMaxHealth() != getHealth()) {
/*     */ 
/*     */ 
/*     */         
/* 479 */         boolean isFastHealing = (isInClouds() || serverLevel.precipitationAt(blockPosition()) != Biome.Precipitation.NONE);
...
/* 488 */     entityData.define(IS_LEASH_HOLDER, false);
/* 489 */     entityData.define(STAYS_STILL, false);
/*     */   }
/*     */   
/*     */   private void setLeashHolder(boolean isLeashHolder) {
/* 493 */     this.entityData.set(IS_LEASH_HOLDER, isLeashHolder);
/*     */   }
/*     */   
/*     */   public boolean isLeashHolder() {
/* 497 */     return (Boolean)this.entityData.get(IS_LEASH_HOLDER);
/*     */   }
/*     */   
/*     */   private void syncStayStillFlag() {
/* 501 */     this.entityData.set(STAYS_STILL, (this.serverStillTimeout > 0));
/*     */   }
/*     */   
/*     */   public boolean staysStill() {
/* 505 */     return (Boolean)this.entityData.get(STAYS_STILL);
/*     */   }
/*     */ 
/*     */   
...
/* 515 */     return Leashable.createQuadLeashOffsets((Entity)this, -0.03125D, 0.4375D, 0.46875D, 0.03125D);
/*     */   }
/*     */ 
/*     */   
/*     */   public Vec3 getLeashOffset() {
/* 520 */     return Vec3.ZERO;
/*     */   }
/*     */ 
/*     */   
...
/* 570 */       return isClearForMovementBetween(this.mob, startPos, stopPos, false);
/*     */     }
/*     */   }
/*     */   
/*     */   private class HappyGhastFloatGoal extends FloatGoal {
/*     */     public HappyGhastFloatGoal() {
/* 576 */       super((Mob)HappyGhast.this);
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public boolean canUse() {
/* 582 */       return (!HappyGhast.this.isOnStillTimeout() && super.canUse());
/*     */     }
/*     */   }
/*     */   
/*     */   private class HappyGhastLookControl extends LookControl {
/*     */     private HappyGhastLookControl() {
/* 588 */       super((Mob)HappyGhast.this);
/*     */     }
/*     */ 
/*     */     
/*     */     public void tick() {
...
/* 627 */     return (staysStill() || this.serverStillTimeout > 0);
/*     */   }
/*     */   
/*     */   private boolean scanPlayerAboveGhast() {
/* 631 */     AABB happyGhastBb = getBoundingBox();
/* 632 */     AABB ghastDetectionBox = new AABB(happyGhastBb.minX - 1.0D, happyGhastBb.maxY - 9.999999747378752E-6D, happyGhastBb.minZ - 1.0D, happyGhastBb.maxX + 1.0D, happyGhastBb.maxY + 
/*     */ 
/*     */ 
/*     */ 
/*     */         
/* 637 */         happyGhastBb.getYsize() / 2.0D, happyGhastBb.maxZ + 1.0D);
/*     */ 
/*     */     
/* 640 */     for (Player player : (Iterable<Player>)level().players()) {
...
/* 699 */     return new Vec3(getX(), (getBoundingBox()).maxY, getZ());
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/happyghast/HappyGhast.class
