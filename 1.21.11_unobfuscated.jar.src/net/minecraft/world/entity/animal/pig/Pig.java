...
/*  74 */     this.goalSelector.addGoal(0, (Goal)new FloatGoal((Mob)this));
/*  75 */     this.goalSelector.addGoal(1, (Goal)new PanicGoal((PathfinderMob)this, 1.25D));
/*  76 */     this.goalSelector.addGoal(3, (Goal)new BreedGoal(this, 1.0D));
/*  77 */     this.goalSelector.addGoal(4, (Goal)new TemptGoal((PathfinderMob)this, 1.2D, i -> i.is(Items.CARROT_ON_A_STICK), false));
/*  78 */     this.goalSelector.addGoal(4, (Goal)new TemptGoal((PathfinderMob)this, 1.2D, i -> i.is(ItemTags.PIG_FOOD), false));
/*  79 */     this.goalSelector.addGoal(5, (Goal)new FollowParentGoal(this, 1.1D));
/*  80 */     this.goalSelector.addGoal(6, (Goal)new WaterAvoidingRandomStrollGoal((PathfinderMob)this, 1.0D));
/*  81 */     this.goalSelector.addGoal(7, (Goal)new LookAtPlayerGoal((Mob)this, Player.class, 6.0F));
...
/* 110 */     entityData.define(DATA_BOOST_TIME, 0);
...
/* 128 */     return SoundEvents.PIG_AMBIENT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getHurtSound(DamageSource source) {
/* 133 */     return SoundEvents.PIG_HURT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/* 138 */     return SoundEvents.PIG_DEATH;
/*     */   }
/*     */ 
/*     */   
/*     */   protected void playStepSound(BlockPos pos, BlockState blockState) {
/* 143 */     playSound(SoundEvents.PIG_STEP, 0.15F, 1.0F);
/*     */   }
/*     */ 
/*     */   
...
/* 152 */         player.startRiding((Entity)this);
/*     */       }
/* 154 */       return (InteractionResult)InteractionResult.SUCCESS;
/*     */     } 
/*     */     
...
/* 161 */         return itemStack.interactLivingEntity(player, (LivingEntity)this, hand);
/*     */       }
/* 163 */       return (InteractionResult)InteractionResult.PASS;
/*     */     } 
...
/* 178 */     return (slot == EquipmentSlot.SADDLE || super.canDispenserEquipIntoSlot(slot));
/*     */   }
/*     */ 
/*     */   
...
/* 184 */       return (Holder<SoundEvent>)SoundEvents.PIG_SADDLE;
/*     */     }
...
/* 192 */       ZombifiedPiglin zombifiedPiglin = (ZombifiedPiglin)convertTo(EntityType.ZOMBIFIED_PIGLIN, ConversionParams.single((Mob)this, false, true), zp -> {
/*     */             level.populateDefaultEquipmentSlots(getRandom(), level.getCurrentDifficultyAt(blockPosition()));
/*     */             
...
/* 215 */     return new Vec3(0.0D, 0.0D, 1.0D);
/*     */   }
/*     */ 
/*     */   
/*     */   protected float getRiddenSpeed(Player controller) {
/* 220 */     return (float)(getAttributeValue(Attributes.MOVEMENT_SPEED) * 0.225D * this.steering.boostFactor());
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean boost() {
/* 225 */     return this.steering.boost(getRandom());
/*     */   }
/*     */ 
/*     */   
/*     */   public Pig getBreedOffspring(ServerLevel level, AgeableMob partner) {
/* 230 */     Pig baby = (Pig)EntityType.PIG.create((Level)level, EntitySpawnReason.BREEDING);
...
/* 239 */     return itemStack.is(ItemTags.PIG_FOOD);
/*     */   }
/*     */ 
/*     */   
/*     */   public Vec3 getLeashOffset() {
/* 244 */     return new Vec3(0.0D, (0.6F * getEyeHeight()), (getBbWidth() * 0.4F));
/*     */   }
/*     */   
/*     */   private void setVariant(Holder<PigVariant> variant) {
/* 248 */     this.entityData.set(DATA_VARIANT_ID, variant);
/*     */   }
/*     */   
/*     */   public Holder<PigVariant> getVariant() {
/* 252 */     return (Holder<PigVariant>)this.entityData.get(DATA_VARIANT_ID);
/*     */   }
/*     */ 
/*     */   
...
/* 273 */       setVariant((Holder<PigVariant>)castComponentValue(DataComponents.PIG_VARIANT, value));
/* 274 */       return true;
/*     */     } 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/pig/Pig.class
