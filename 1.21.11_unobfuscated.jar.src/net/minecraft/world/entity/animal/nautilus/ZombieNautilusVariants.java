...
/* 22 */     return ResourceKey.create(Registries.ZOMBIE_NAUTILUS_VARIANT, id);
/*    */   }
/*    */   
...
/* 32 */     register(context, name, modelType, textureName, SpawnPrioritySelectors.single((SpawnCondition)new BiomeCheck((HolderSet)named), 1));
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/nautilus/ZombieNautilusVariants.class
