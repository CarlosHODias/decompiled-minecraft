...
/*  22 */     super((EntityType)type, level);
/*     */   }
/*     */ 
/*     */   
/*     */   protected Brain.Provider<Nautilus> brainProvider() {
/*  27 */     return NautilusAi.brainProvider();
/*     */   }
/*     */ 
/*     */   
/*     */   protected Brain<?> makeBrain(Dynamic<?> input) {
/*  32 */     return NautilusAi.makeBrain(brainProvider().makeBrain(input));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public Brain<Nautilus> getBrain() {
/*  38 */     return super.getBrain();
/*     */   }
/*     */ 
/*     */   
/*     */   public Nautilus getBreedOffspring(ServerLevel level, AgeableMob partner) {
/*  43 */     Nautilus baby = (Nautilus)EntityType.NAUTILUS.create((Level)level, EntitySpawnReason.BREEDING);
/*  44 */     if (baby != null && 
/*  45 */       isTame()) {
...
/*  57 */     getBrain().tick(level, (LivingEntity)this);
/*  58 */     profiler.pop();
/*     */     
...
/*  92 */     return isUnderWater() ? SoundEvents.NAUTILUS_DASH : SoundEvents.NAUTILUS_DASH_ON_LAND;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDashReadySound() {
/*  97 */     return isUnderWater() ? SoundEvents.NAUTILUS_DASH_READY : SoundEvents.NAUTILUS_DASH_READY_ON_LAND;
/*     */   }
/*     */ 
/*     */   
...
/* 108 */     return isBaby() ? SoundEvents.BABY_NAUTILUS_SWIM : SoundEvents.NAUTILUS_SWIM;
/*     */   }
/*     */ 
/*     */   
...
/* 139 */     return !isAggravated();
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/nautilus/Nautilus.class
