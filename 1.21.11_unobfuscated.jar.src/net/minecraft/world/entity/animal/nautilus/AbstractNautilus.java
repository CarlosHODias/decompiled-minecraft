...
/*     */   extends TamableAnimal implements PlayerRideableJumping, HasCustomInventoryScreen {
...
/* 110 */     return (isTame() || isBaby()) ? itemStack.is(ItemTags.NAUTILUS_FOOD) : itemStack.is(ItemTags.NAUTILUS_TAMING_ITEMS);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 117 */       player.setItemInHand(hand, ItemUtils.createFilledResult(itemStack, player, new ItemStack((ItemLike)Items.WATER_BUCKET)));
/*     */     } else {
...
/* 139 */     return (PathNavigation)new WaterBoundPathNavigation((Mob)this, level);
/*     */   }
/*     */ 
/*     */   
...
/* 150 */     return (pos.getY() >= minSpawnLevel && 
/* 151 */       pos.getY() <= seaLevel - 5 && 
/* 152 */       level.getFluidState(pos.below()).is(FluidTags.WATER) && 
/* 153 */       level.getBlockState(pos.above()).is(Blocks.WATER));
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean checkSpawnObstruction(LevelReader level) {
/* 158 */     return level.isUnobstructed((Entity)this);
/*     */   }
/*     */ 
/*     */   
...
/* 171 */     return (slot == EquipmentSlot.BODY || slot == EquipmentSlot.SADDLE || super.canDispenserEquipIntoSlot(slot));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 184 */     if (isSaddled() && firstPassenger instanceof Player) { Player player = (Player)firstPassenger;
/* 185 */       return (LivingEntity)player; }
/*     */     
...
/* 213 */     return new Vec2(controller.getXRot() * 0.5F, controller.getYRot());
/*     */   }
/*     */ 
/*     */   
/*     */   protected void tickRidden(Player controller, Vec3 riddenInput) {
/* 218 */     super.tickRidden(controller, riddenInput);
/* 219 */     Vec2 rotation = getRiddenRotation((LivingEntity)controller);
...
/* 250 */       player.startRiding((Entity)this);
/* 251 */       if (!isVehicle()) {
/* 252 */         clearHome();
/*     */       }
/*     */     } 
...
/* 271 */     if (hasHome() && getHomePosition().closerThan((Vec3i)blockPosition(), (radius + 8)) && radius == getHomeRadius()) {
/*     */       return;
/*     */     }
...
/* 308 */       level().addParticle((ParticleOptions)ParticleTypes.BUBBLE, getX() - mouthDirectionVector.x * 1.1D, getY() - mouthDirectionVector.y + 0.25D, getZ() - mouthDirectionVector.z * 1.1D, dx, dy, dz);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 352 */     entityData.define(DASH, false);
/*     */   }
/*     */   
/*     */   public boolean isDashing() {
/* 356 */     return (Boolean)this.entityData.get(DASH);
/*     */   }
/*     */   
/*     */   public void setDashing(boolean isDashing) {
/* 360 */     this.entityData.set(DASH, isDashing);
/*     */   }
/*     */   
...
/*     */       } 
/*     */       
/* 445 */       InteractionResult interactionResult = itemStack.interactLivingEntity(player, (LivingEntity)this, hand);
...
/* 530 */     if (!level().isClientSide() && (!isVehicle() || hasPassenger((Entity)player)) && isTame()) {
/* 531 */       player.openNautilusInventory(this, (Container)this.inventory);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 545 */     return (this.inventory != oldInventory);
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/animal/nautilus/AbstractNautilus.class
