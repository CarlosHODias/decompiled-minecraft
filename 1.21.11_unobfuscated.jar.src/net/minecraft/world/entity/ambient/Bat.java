...
/*  49 */     super((EntityType)type, level);
/*     */     
...
/*  65 */     entityData.define(DATA_ID_FLAGS, (byte)0);
/*     */   }
/*     */ 
/*     */   
...
/* 118 */     return (((Byte)this.entityData.get(DATA_ID_FLAGS) & 0x1) != 0);
/*     */   }
/*     */   
/*     */   public void setResting(boolean value) {
/* 122 */     byte current = (Byte)this.entityData.get(DATA_ID_FLAGS);
/* 123 */     if (value) {
/* 124 */       this.entityData.set(DATA_ID_FLAGS, (byte)(current | 0x1));
/*     */     } else {
/* 126 */       this.entityData.set(DATA_ID_FLAGS, (byte)(current & 0xFFFFFFFE));
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 151 */       if (level.getBlockState(above).isRedstoneConductor((BlockGetter)level, pos)) {
/* 152 */         if (this.random.nextInt(200) == 0) {
/* 153 */           this.yHeadRot = this.random.nextInt(360);
/*     */         }
/*     */         
/* 156 */         if (level.getNearestPlayer(BAT_RESTING_TARGETING, (LivingEntity)this) != null) {
...
/*     */       
/* 194 */       if (this.random.nextInt(100) == 0 && level.getBlockState(above).isRedstoneConductor((BlockGetter)level, above)) {
/* 195 */         setResting(true);
/*     */       }
/*     */     } 
/*     */   }
...
/* 231 */     this.entityData.set(DATA_ID_FLAGS, input.getByteOr("BatFlags", (byte)0));
/*     */   }
/*     */ 
/*     */   
/*     */   protected void addAdditionalSaveData(ValueOutput output) {
/* 236 */     super.addAdditionalSaveData(output);
/* 237 */     output.putByte("BatFlags", (Byte)this.entityData.get(DATA_ID_FLAGS));
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ambient/Bat.class
