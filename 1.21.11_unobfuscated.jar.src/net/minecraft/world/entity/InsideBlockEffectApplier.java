...
/*  53 */       this.beforeEffectsInStep = Util.makeEnumMap(InsideBlockEffectType.class, type -> new ArrayList());
/*  54 */       this.afterEffectsInStep = Util.makeEnumMap(InsideBlockEffectType.class, type -> new ArrayList());
/*     */       
...
/*  81 */         List<Consumer<Entity>> beforeEffects = this.beforeEffectsInStep.get(type);
...
/*     */         }
/*     */         
/*  89 */         List<Consumer<Entity>> afterEffects = this.afterEffectsInStep.get(type);
...
/*     */     
/*     */     public void apply(InsideBlockEffectType type) {
/*  97 */       this.effectsInStep.add(type);
/*     */     }
/*     */ 
/*     */     
/*     */     public void runBefore(InsideBlockEffectType type, Consumer<Entity> effect) {
/* 102 */       ((List<Consumer<Entity>>)this.beforeEffectsInStep.get(type)).add(effect);
/*     */     }
/*     */ 
/*     */     
/*     */     public void runAfter(InsideBlockEffectType type, Consumer<Entity> effect) {
/* 107 */       ((List<Consumer<Entity>>)this.afterEffectsInStep.get(type)).add(effect);
/*     */     }
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/InsideBlockEffectApplier.class
