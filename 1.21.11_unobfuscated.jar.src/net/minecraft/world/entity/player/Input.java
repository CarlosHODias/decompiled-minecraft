...
/*    */ public final class Input extends Record { private final boolean forward; private final boolean backward; private final boolean left; private final boolean right; private final boolean jump;
...
/*    */ 
/*    */   
/* 14 */   public static final net.minecraft.network.codec.StreamCodec<net.minecraft.network.FriendlyByteBuf, Input> STREAM_CODEC = new net.minecraft.network.codec.StreamCodec<net.minecraft.network.FriendlyByteBuf, Input>()
/*    */     {
/*    */       public void encode(net.minecraft.network.FriendlyByteBuf output, Input value)
/*    */       {
/* 18 */         byte flags = 0;
...
/*    */ 
/*    */       
/*    */       public Input decode(net.minecraft.network.FriendlyByteBuf input) {
/* 31 */         byte flags = input.readByte();
/* 32 */         boolean forward = ((flags & 0x1) != 0);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/player/Input.class
