...
/*  41 */         EquipmentSlot.FEET.getIndex(36), EquipmentSlot.FEET, 
/*  42 */         EquipmentSlot.LEGS.getIndex(36), EquipmentSlot.LEGS, 
/*  43 */         EquipmentSlot.CHEST.getIndex(36), EquipmentSlot.CHEST, 
/*  44 */         EquipmentSlot.HEAD.getIndex(36), EquipmentSlot.HEAD, 40, 
/*  45 */         EquipmentSlot.OFFHAND, 41, 
/*  46 */         EquipmentSlot.BODY, 42, 
/*  47 */         EquipmentSlot.SADDLE)); public static final int SLOT_OFFHAND = 40; public static final int SLOT_BODY_ARMOR = 41;
...
/*  80 */     return (ItemStack)this.items.set(this.selected, itemStack);
/*     */   }
/*     */   
...
/*  93 */       ItemStack.isSameItemSameComponents(slotItemStack, newItemStack) && 
/*  94 */       slotItemStack.isStackable() && 
/*  95 */       slotItemStack.getCount() < getMaxStackSize(slotItemStack));
/*     */   }
/*     */ 
/*     */   
...
/* 114 */       if (freeSlot != -1) {
/* 115 */         this.items.set(freeSlot, this.items.get(this.selected));
/*     */       }
/*     */     } 
/*     */     
...
/* 127 */     this.items.set(this.selected, this.items.get(slot));
/* 128 */     this.items.set(slot, tmp);
/*     */   }
/*     */   
/*     */   public static boolean isHotbarSlot(int slot) {
/* 132 */     return (slot >= 0 && slot < 9);
/*     */   }
/*     */   
...
/* 153 */       if (!inventoryItemStack.isEmpty() && 
/* 154 */         inventoryItemStack.is(item) && 
/* 155 */         isUsableForCrafting(inventoryItemStack) && (
/* 156 */         existingItem.isEmpty() || ItemStack.isSameItemSameComponents(existingItem, inventoryItemStack)))
/*     */       {
/* 158 */         return i;
/*     */       }
/*     */     } 
...
/* 176 */       int index = (this.selected + i) % 9;
/*     */       
...
/* 253 */         itemStack.inventoryTick(this.player.level(), (Entity)this.player, (i == this.selected) ? EquipmentSlot.MAINHAND : null);
/*     */       }
/*     */     } 
/*     */   }
/*     */   
/*     */   public boolean add(ItemStack itemStack) {
/* 259 */     return add(-1, itemStack);
/*     */   }
/*     */   
...
/*     */       
/* 303 */       category.setDetail("Item ID", Item.getId(itemStack.getItem()));
/* 304 */       category.setDetail("Item data", itemStack.getDamageValue());
...
/* 312 */     placeItemBackInInventory(itemStack, true);
/*     */   }
/*     */   
...
/*     */       
/* 329 */       if (add(slot, itemStack.split(slotHasSpaceFor)) && shouldSendSetSlotPacket) { Player player = this.player; if (player instanceof ServerPlayer) { ServerPlayer serverPlayer = (ServerPlayer)player;
/* 330 */           serverPlayer.connection.send((Packet)createInventoryUpdatePacket(slot)); }
/*     */          }
/*     */     
/*     */     } 
/*     */   }
/*     */   public ClientboundSetPlayerInventoryPacket createInventoryUpdatePacket(int slot) {
/* 336 */     return new ClientboundSetPlayerInventoryPacket(slot, getItem(slot).copy());
/*     */   }
/*     */ 
/*     */   
/*     */   public ItemStack removeItem(int slot, int count) {
/* 341 */     if (slot < this.items.size()) {
/* 342 */       return ContainerHelper.removeItem((List)this.items, slot, count);
/*     */     }
...
/*     */       }
/*     */     } 
/* 428 */     for (ObjectIterator<EquipmentSlot> objectIterator = EQUIPMENT_SLOT_MAPPING.values().iterator(); objectIterator.hasNext(); ) { EquipmentSlot slot = objectIterator.next();
...
/* 479 */     for (ItemStack itemStack : (Iterable<ItemStack>)this) {
...
/* 488 */     for (ItemStack itemStack : (Iterable<ItemStack>)this) {
...
/* 497 */     for (ItemStack stack : (Iterable<ItemStack>)this) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/player/Inventory.class
