...
/*    */ 
/*    */   
/*    */   public static PlayerSkin insecure(ClientAsset.Texture body, ClientAsset.Texture cape, ClientAsset.Texture elytra, PlayerModelType model) {
/* 28 */     return new PlayerSkin(body, cape, elytra, model, false);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/*    */     
/* 42 */     return insecure(
/* 43 */         (ClientAsset.Texture)com.mojang.datafixers.DataFixUtils.orElse(patch.body, this.body), 
/* 44 */         (ClientAsset.Texture)com.mojang.datafixers.DataFixUtils.orElse(patch.cape, this.cape), 
/* 45 */         (ClientAsset.Texture)com.mojang.datafixers.DataFixUtils.orElse(patch.elytra, this.elytra), 
/* 46 */         patch.model.orElse(this.model));
/*    */   }
...
/* 58 */         Optional.empty(), 
/* 59 */         Optional.empty(), 
/* 60 */         Optional.empty()); public static final com.mojang.serialization.MapCodec<Patch> MAP_CODEC;
/*    */     
/*    */     static {
/* 63 */       MAP_CODEC = com.mojang.serialization.codecs.RecordCodecBuilder.mapCodec(i -> i.group((App)ClientAsset.ResourceTexture.CODEC.optionalFieldOf("texture").forGetter(Patch::body), (App)ClientAsset.ResourceTexture.CODEC.optionalFieldOf("cape").forGetter(Patch::cape), (App)ClientAsset.ResourceTexture.CODEC.optionalFieldOf("elytra").forGetter(Patch::elytra), (App)PlayerModelType.CODEC.optionalFieldOf("model").forGetter(Patch::model)).apply((com.mojang.datafixers.kinds.Applicative)i, Patch::create));
/*    */     }
/*    */ 
/*    */ 
/*    */ 
/*    */ 
/*    */     
/* 70 */     public static final net.minecraft.network.codec.StreamCodec<io.netty.buffer.ByteBuf, Patch> STREAM_CODEC = net.minecraft.network.codec.StreamCodec.composite(
/* 71 */         ClientAsset.ResourceTexture.STREAM_CODEC.apply(net.minecraft.network.codec.ByteBufCodecs::optional), Patch::body, 
/* 72 */         ClientAsset.ResourceTexture.STREAM_CODEC.apply(net.minecraft.network.codec.ByteBufCodecs::optional), Patch::cape, 
/* 73 */         ClientAsset.ResourceTexture.STREAM_CODEC.apply(net.minecraft.network.codec.ByteBufCodecs::optional), Patch::elytra, 
/* 74 */         PlayerModelType.STREAM_CODEC.apply(net.minecraft.network.codec.ByteBufCodecs::optional), Patch::model, Patch::create);
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/player/PlayerSkin.class
