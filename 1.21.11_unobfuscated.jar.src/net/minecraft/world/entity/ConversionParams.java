...
/*    */   
/*  6 */   public ConversionParams(ConversionType type, boolean keepEquipment, boolean preserveCanPickUpLoot, net.minecraft.world.scores.PlayerTeam team) { this.type = type; this.keepEquipment = keepEquipment; this.preserveCanPickUpLoot = preserveCanPickUpLoot; this.team = team; } public final String toString() { // Byte code:
/*    */     //   0: aload_0
...
/*  6 */     //   0	8	1	o	Ljava/lang/Object; } public boolean keepEquipment() { return this.keepEquipment; } public boolean preserveCanPickUpLoot() { return this.preserveCanPickUpLoot; } public net.minecraft.world.scores.PlayerTeam team() { return this.team; }
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* 19 */     return new ConversionParams(ConversionType.SINGLE, keepEquipment, preserveCanPickUpLoot, mob.getTeam());
/*    */   }
/*    */   
/*    */   @FunctionalInterface
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ConversionParams.class
