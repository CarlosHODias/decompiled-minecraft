...
/*  82 */     entityData.define(DATA_RADIUS, 3.0F);
/*  83 */     entityData.define(DATA_WAITING, false);
/*  84 */     entityData.define(DATA_PARTICLE, DEFAULT_PARTICLE);
/*     */   }
/*     */   
/*     */   public void setRadius(float radius) {
/*  88 */     if (!level().isClientSide()) {
/*  89 */       getEntityData().set(DATA_RADIUS, Mth.clamp(radius, 0.0F, 32.0F));
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 103 */     return (Float)getEntityData().get(DATA_RADIUS);
/*     */   }
/*     */   
...
/* 117 */     this.potionDurationScale = scale;
/*     */   }
/*     */   
...
/* 130 */     setPotionContents(this.potionContents.withEffectAdded(effect));
/*     */   }
/*     */   
...
/* 138 */     getEntityData().set(DATA_WAITING, waiting);
/*     */   }
/*     */   
/*     */   public boolean isWaiting() {
/* 142 */     return (Boolean)getEntityData().get(DATA_WAITING);
/*     */   }
/*     */   
...
/* 191 */           level().addAlwaysVisibleParticle((ParticleOptions)DEFAULT_PARTICLE, x, y, z, 0.0D, 0.0D, 0.0D);
/*     */         } else {
...
/* 231 */       this.victims.entrySet().removeIf(entry -> (this.tickCount >= (Integer)entry.getValue()));
/*     */       
/* 233 */       if (!this.potionContents.hasEffects()) {
/* 234 */         this.victims.clear();
/*     */       } else {
/* 236 */         List<MobEffectInstance> allEffects = new ArrayList<>();
...
/* 249 */               this.victims.put(entity, this.tickCount + this.reapplicationDelay);
...
/* 284 */     this.radiusOnUse = radiusOnUse;
/*     */   }
/*     */   
...
/* 292 */     this.radiusPerTick = radiusPerTick;
/*     */   }
/*     */   
...
/* 300 */     this.durationOnUse = durationOnUse;
/*     */   }
/*     */   
...
/* 312 */     this.owner = EntityReference.of(owner);
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 332 */     setCustomParticle(input.read("custom_particle", ParticleTypes.CODEC).orElse(null));
/* 333 */     setPotionContents(input.read("potion_contents", PotionContents.CODEC).orElse(PotionContents.EMPTY));
/*     */     
...
/* 387 */       return castComponentValue((DataComponentType)type, this.potionContents);
/*     */     }
/* 389 */     if (type == DataComponents.POTION_DURATION_SCALE) {
/* 390 */       return castComponentValue((DataComponentType)type, this.potionDurationScale);
/*     */     }
/*     */     
/* 393 */     return super.get(type);
/*     */   }
/*     */ 
/*     */   
...
/* 406 */       setPotionContents(castComponentValue(DataComponents.POTION_CONTENTS, value));
/* 407 */       return true;
/*     */     } 
/* 409 */     if (type == DataComponents.POTION_DURATION_SCALE) {
/* 410 */       setPotionDurationScale((Float)castComponentValue(DataComponents.POTION_DURATION_SCALE, value));
/* 411 */       return true;
/*     */     } 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/AreaEffectCloud.class
