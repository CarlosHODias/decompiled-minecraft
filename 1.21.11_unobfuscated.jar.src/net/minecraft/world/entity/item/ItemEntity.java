...
/*  72 */     this(level, x, y, z, itemStack, level.random.nextDouble() * 0.2D - 0.1D, 0.2D, level.random.nextDouble() * 0.2D - 0.1D);
/*     */   }
/*     */   
...
/* 107 */     entityData.define(DATA_ITEM, ItemStack.EMPTY);
/*     */   }
/*     */ 
/*     */   
...
/* 316 */       return false;
/*     */     }
/* 318 */     if (!((Boolean)level.getGameRules().get(GameRules.MOB_GRIEFING)) && source.getEntity() instanceof net.minecraft.world.entity.Mob) {
/* 319 */       return false;
/*     */     }
...
/* 326 */     gameEvent((Holder)GameEvent.ENTITY_DAMAGE, source.getEntity());
...
/* 359 */     this.target = input.read("Owner", UUIDUtil.CODEC).orElse(null);
/* 360 */     this.thrower = EntityReference.read(input, "Thrower");
/* 361 */     setItem(input.read("Item", ItemStack.CODEC).orElse(ItemStack.EMPTY));
...
/* 419 */     getEntityData().set(DATA_ITEM, itemStack);
/*     */   }
/*     */ 
/*     */   
...
/* 438 */     this.thrower = EntityReference.of((UniquelyIdentifyable)thrower);
/*     */   }
/*     */   
/*     */   public int getAge() {
/* 442 */     return this.age;
...
/* 480 */     return ageInTicks / 20.0F + bobOffset;
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/item/ItemEntity.class
