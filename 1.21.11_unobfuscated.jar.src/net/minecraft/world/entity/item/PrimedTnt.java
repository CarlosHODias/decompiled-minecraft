...
/*  86 */     this.yo = y;
/*  87 */     this.zo = z;
/*  88 */     this.owner = EntityReference.of((UniquelyIdentifyable)owner);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void defineSynchedData(SynchedEntityData.Builder entityData) {
/*  93 */     entityData.define(DATA_FUSE_ID, 80);
...
/* 141 */     Level level = level(); if (level instanceof ServerLevel) { ServerLevel serverLevel = (ServerLevel)level; if ((Boolean)serverLevel.getGameRules().get(GameRules.TNT_EXPLODES)) {
...
/* 159 */     setBlockState(input.read("block_state", BlockState.CODEC).orElse(DEFAULT_BLOCK_STATE));
...
/* 178 */     this.entityData.set(DATA_FUSE_ID, time);
/*     */   }
/*     */   
/*     */   public int getFuse() {
/* 182 */     return (Integer)this.entityData.get(DATA_FUSE_ID);
/*     */   }
/*     */   
/*     */   public void setBlockState(BlockState blockState) {
/* 186 */     this.entityData.set(DATA_BLOCK_STATE_ID, blockState);
/*     */   }
/*     */   
...
/* 194 */     this.usedPortal = usedPortal;
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/item/PrimedTnt.class
