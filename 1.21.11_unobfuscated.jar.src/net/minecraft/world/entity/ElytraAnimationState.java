...
/*    */   }
/*    */   public void tick() {
/*    */     float targetXRot, targetZRot, targetYRot;
...
/* 57 */     return Mth.lerp(partialTicks, this.rotXOld, this.rotX);
/*    */   }
/*    */   
/*    */   public float getRotY(float partialTicks) {
/* 61 */     return Mth.lerp(partialTicks, this.rotYOld, this.rotY);
/*    */   }
/*    */   
/*    */   public float getRotZ(float partialTicks) {
/* 65 */     return Mth.lerp(partialTicks, this.rotZOld, this.rotZ);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ElytraAnimationState.class
