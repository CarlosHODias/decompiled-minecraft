...
/* 120 */     register(context, id, width, height, true);
/*     */   }
/*     */   
...
/* 124 */     context.register(id, new PaintingVariant(width, height, 
/*     */ 
/*     */           
/* 127 */           id.identifier(), 
/* 128 */           (Optional)Optional.of(Component.translatable(id.identifier().toLanguageKey("painting", "title")).withStyle(ChatFormatting.YELLOW)), 
/* 129 */           hasAuthor ? (Optional)Optional.of(Component.translatable(id.identifier().toLanguageKey("painting", "author")).withStyle(ChatFormatting.GRAY)) : Optional.<Component>empty()));
/*     */   }
/*     */ 
/*     */   
/*     */   private static ResourceKey<PaintingVariant> create(String name) {
/* 134 */     return ResourceKey.create(Registries.PAINTING_VARIANT, Identifier.withDefaultNamespace(name));
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/decoration/painting/PaintingVariants.class
