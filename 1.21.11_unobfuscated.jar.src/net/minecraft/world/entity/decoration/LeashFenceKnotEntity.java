...
/*  34 */     super((EntityType)type, level);
/*     */   }
/*     */   
...
/*  87 */     List<Leashable> playerLeashable = Leashable.leashableLeashedTo((Entity)player);
/*     */     
...
/* 100 */         if (mob.canHaveALeashAttachedTo((Entity)player)) {
/* 101 */           mob.setLeashedTo((Entity)player, true);
/* 102 */           anyDropped = true;
/*     */         } 
/*     */       } 
/*     */     } 
...
/* 108 */       gameEvent((Holder)GameEvent.BLOCK_ATTACH, (Entity)player);
...
/* 135 */     for (LeashFenceKnotEntity leashFenceKnotEntity : knots) {
/* 136 */       if (leashFenceKnotEntity.getPos().equals(pos)) {
/* 137 */         return leashFenceKnotEntity;
/*     */       }
/*     */     } 
/*     */     
...
/* 157 */     return getPosition(partialTickTime).add(0.0D, 0.2D, 0.0D);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/decoration/LeashFenceKnotEntity.class
