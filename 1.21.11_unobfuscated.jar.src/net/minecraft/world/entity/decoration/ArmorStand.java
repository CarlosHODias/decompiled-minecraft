...
/*  87 */   public static final EntityDataAccessor<Rotations> DATA_RIGHT_LEG_POSE = SynchedEntityData.defineId(ArmorStand.class, EntityDataSerializers.ROTATIONS); private static final Predicate<Entity> RIDABLE_MINECARTS; private static final boolean DEFAULT_INVISIBLE = false; private static final int DEFAULT_DISABLED_SLOTS = 0; private static final boolean DEFAULT_SMALL = false; private static final boolean DEFAULT_SHOW_ARMS = false; private static final boolean DEFAULT_NO_BASE_PLATE = false; private static final boolean DEFAULT_MARKER = false;
/*     */   static {
/*  89 */     RIDABLE_MINECARTS = (entity -> {
...
/* 126 */     return (!isMarker() && !isNoGravity());
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isEffectiveAi() {
/* 131 */     return (super.isEffectiveAi() && hasPhysics());
/*     */   }
/*     */ 
/*     */   
/*     */   protected void defineSynchedData(SynchedEntityData.Builder entityData) {
/* 136 */     super.defineSynchedData(entityData);
/* 137 */     entityData.define(DATA_CLIENT_FLAGS, (byte)0);
...
/* 148 */     return (slot != EquipmentSlot.BODY && slot != EquipmentSlot.SADDLE && !isDisabled(slot));
/*     */   }
/*     */ 
/*     */   
...
/* 199 */     List<Entity> entities = level().getEntities((Entity)this, getBoundingBox(), RIDABLE_MINECARTS);
/* 200 */     for (Entity entity : entities) {
/* 201 */       if (distanceToSqr(entity) <= 0.2D) {
/* 202 */         entity.push((Entity)this);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 211 */       return (InteractionResult)InteractionResult.PASS;
/*     */     }
/* 213 */     if (player.isSpectator()) {
/* 214 */       return (InteractionResult)InteractionResult.SUCCESS;
/*     */     }
/*     */     
/* 217 */     if (player.level().isClientSide()) {
/* 218 */       return (InteractionResult)InteractionResult.SUCCESS_SERVER;
/*     */     }
/*     */     
...
/* 226 */         return (InteractionResult)InteractionResult.SUCCESS_SERVER;
/*     */       }
/*     */     } else {
/* 229 */       if (isDisabled(itemInHandSlot)) {
/* 230 */         return (InteractionResult)InteractionResult.FAIL;
/*     */       }
/* 232 */       if (itemInHandSlot.getType() == EquipmentSlot.Type.HAND && !showArms()) {
/* 233 */         return (InteractionResult)InteractionResult.FAIL;
/*     */       }
/* 235 */       if (swapItem(player, itemInHandSlot, itemStack, hand)) {
/* 236 */         return (InteractionResult)InteractionResult.SUCCESS_SERVER;
/*     */       }
/*     */     } 
/* 239 */     return (InteractionResult)InteractionResult.PASS;
/*     */   }
/*     */   
...
/* 248 */     if (clickYPosition >= 0.1D) if (clickYPosition < 0.1D + (small ? 0.8D : 0.45D) && hasItemInSlot(feet))
...
/*     */ 
/*     */         
/* 260 */         return slotClicked; }   if (clickYPosition >= 0.9D + (small ? 0.3D : 0.0D)) if (clickYPosition < 0.9D + (small ? 1.0D : 0.7D) && hasItemInSlot(EquipmentSlot.CHEST)) { slotClicked = EquipmentSlot.CHEST; return slotClicked; }   if (clickYPosition >= 0.4D) if (clickYPosition < 0.4D + (small ? 1.0D : 0.8D) && hasItemInSlot(EquipmentSlot.LEGS)) { slotClicked = EquipmentSlot.LEGS; return slotClicked; }   if (clickYPosition >= 1.6D && hasItemInSlot(EquipmentSlot.HEAD)) { slotClicked = EquipmentSlot.HEAD; } else if (!hasItemInSlot(EquipmentSlot.MAINHAND) && hasItemInSlot(EquipmentSlot.OFFHAND)) { slotClicked = EquipmentSlot.OFFHAND; }  return slotClicked;
/*     */   }
/*     */   
/*     */   private boolean isDisabled(EquipmentSlot slot) {
/* 264 */     return ((this.disabledSlots & 1 << slot.getFilterBit(0)) != 0 || (slot.getType() == EquipmentSlot.Type.HAND && !showArms()));
/*     */   }
/*     */   
...
/* 299 */       return false;
/*     */     }
/* 301 */     if (!((Boolean)level.getGameRules().get(GameRules.MOB_GRIEFING)) && source.getEntity() instanceof net.minecraft.world.entity.Mob) {
/* 302 */       return false;
/*     */     }
...
/* 348 */       kill(level);
/*     */     } else {
/* 350 */       level.broadcastEntityEvent((Entity)this, (byte)32);
/* 351 */       gameEvent((Holder)GameEvent.ENTITY_DAMAGE, source.getEntity());
...
/* 381 */       ((ServerLevel)level()).sendParticles((ParticleOptions)new BlockParticleOption(ParticleTypes.BLOCK, Blocks.OAK_PLANKS.defaultBlockState()), getX(), getY(0.6666666666666666D), getZ(), 10, (getBbWidth() / 4.0F), (getBbHeight() / 4.0F), (getBbWidth() / 4.0F), 0.05D);
/*     */     }
/*     */   }
/*     */   
...
/* 393 */       gameEvent((Holder)GameEvent.ENTITY_DAMAGE, source.getEntity());
/*     */     } 
/*     */   }
/*     */   
/*     */   private void brokenByPlayer(ServerLevel level, DamageSource source) {
/* 398 */     ItemStack result = new ItemStack((ItemLike)Items.ARMOR_STAND);
...
/*     */     
/* 408 */     for (EquipmentSlot slot : (Iterable<EquipmentSlot>)EquipmentSlot.VALUES) {
...
/* 417 */     level().playSound(null, getX(), getY(), getZ(), SoundEvents.ARMOR_STAND_BREAK, getSoundSource(), 1.0F, 1.0F);
/*     */   }
/*     */ 
/*     */   
...
/* 448 */     setInvisible(this.invisible);
/*     */   }
/*     */ 
/*     */   
...
/* 466 */     gameEvent((Holder)GameEvent.ENTITY_DIE);
/*     */   }
/*     */ 
/*     */   
...
/* 491 */     this.entityData.set(DATA_CLIENT_FLAGS, setBit((Byte)this.entityData.get(DATA_CLIENT_FLAGS), 1, value));
/*     */   }
/*     */   
/*     */   public boolean isSmall() {
/* 495 */     return (((Byte)this.entityData.get(DATA_CLIENT_FLAGS) & 0x1) != 0);
/*     */   }
/*     */   
/*     */   public void setShowArms(boolean value) {
/* 499 */     this.entityData.set(DATA_CLIENT_FLAGS, setBit((Byte)this.entityData.get(DATA_CLIENT_FLAGS), 4, value));
/*     */   }
/*     */   
/*     */   public boolean showArms() {
/* 503 */     return (((Byte)this.entityData.get(DATA_CLIENT_FLAGS) & 0x4) != 0);
/*     */   }
/*     */   
/*     */   public void setNoBasePlate(boolean value) {
/* 507 */     this.entityData.set(DATA_CLIENT_FLAGS, setBit((Byte)this.entityData.get(DATA_CLIENT_FLAGS), 8, value));
/*     */   }
/*     */   
/*     */   public boolean showBasePlate() {
/* 511 */     return (((Byte)this.entityData.get(DATA_CLIENT_FLAGS) & 0x8) == 0);
/*     */   }
/*     */   
/*     */   private void setMarker(boolean value) {
/* 515 */     this.entityData.set(DATA_CLIENT_FLAGS, setBit((Byte)this.entityData.get(DATA_CLIENT_FLAGS), 16, value));
/*     */   }
/*     */   
/*     */   public boolean isMarker() {
/* 519 */     return (((Byte)this.entityData.get(DATA_CLIENT_FLAGS) & 0x10) != 0);
/*     */   }
/*     */   
...
/* 532 */     this.entityData.set(DATA_HEAD_POSE, headPose);
/*     */   }
/*     */   
/*     */   public void setBodyPose(Rotations bodyPose) {
/* 536 */     this.entityData.set(DATA_BODY_POSE, bodyPose);
/*     */   }
/*     */   
/*     */   public void setLeftArmPose(Rotations leftArmPose) {
/* 540 */     this.entityData.set(DATA_LEFT_ARM_POSE, leftArmPose);
/*     */   }
/*     */   
/*     */   public void setRightArmPose(Rotations rightArmPose) {
/* 544 */     this.entityData.set(DATA_RIGHT_ARM_POSE, rightArmPose);
/*     */   }
/*     */   
/*     */   public void setLeftLegPose(Rotations leftLegPose) {
/* 548 */     this.entityData.set(DATA_LEFT_LEG_POSE, leftLegPose);
/*     */   }
/*     */   
/*     */   public void setRightLegPose(Rotations rightLegPose) {
/* 552 */     this.entityData.set(DATA_RIGHT_LEG_POSE, rightLegPose);
/*     */   }
/*     */   
/*     */   public Rotations getHeadPose() {
/* 556 */     return (Rotations)this.entityData.get(DATA_HEAD_POSE);
/*     */   }
/*     */   
/*     */   public Rotations getBodyPose() {
/* 560 */     return (Rotations)this.entityData.get(DATA_BODY_POSE);
/*     */   }
/*     */   
/*     */   public Rotations getLeftArmPose() {
/* 564 */     return (Rotations)this.entityData.get(DATA_LEFT_ARM_POSE);
/*     */   }
/*     */   
/*     */   public Rotations getRightArmPose() {
/* 568 */     return (Rotations)this.entityData.get(DATA_RIGHT_ARM_POSE);
/*     */   }
/*     */   
/*     */   public Rotations getLeftLegPose() {
/* 572 */     return (Rotations)this.entityData.get(DATA_LEFT_LEG_POSE);
/*     */   }
/*     */   
/*     */   public Rotations getRightLegPose() {
/* 576 */     return (Rotations)this.entityData.get(DATA_RIGHT_LEG_POSE);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isPickable() {
/* 581 */     return (super.isPickable() && !isMarker());
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean skipAttackInteraction(Entity source) {
/* 586 */     if (source instanceof Player) { Player playerSource = (Player)source; if (!level().mayInteract((Entity)playerSource, blockPosition())); }  return false;
/*     */   }
/*     */ 
/*     */   
/*     */   public HumanoidArm getMainArm() {
/* 591 */     return HumanoidArm.RIGHT;
/*     */   }
/*     */ 
/*     */   
/*     */   public LivingEntity.Fallsounds getFallSounds() {
/* 596 */     return new LivingEntity.Fallsounds(SoundEvents.ARMOR_STAND_FALL, SoundEvents.ARMOR_STAND_FALL);
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getHurtSound(DamageSource source) {
/* 601 */     return SoundEvents.ARMOR_STAND_HIT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/* 606 */     return SoundEvents.ARMOR_STAND_BREAK;
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 634 */     return getDimensionsMarker(isMarker());
/*     */   }
/*     */   
...
/* 651 */       for (BlockPos pos : (Iterable<BlockPos>)BlockPos.betweenClosed(BlockPos.containing(box.minX, box.minY, box.minZ), BlockPos.containing(box.maxX, box.maxY, box.maxZ))) {
...
/* 654 */           return Vec3.atCenterOf((Vec3i)pos);
/*     */         }
/*     */         
...
/*     */       } 
/*     */       
/* 663 */       return Vec3.atCenterOf((Vec3i)probePos);
/*     */     } 
/*     */     
...
/* 671 */     return new ItemStack((ItemLike)Items.ARMOR_STAND);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean canBeSeenByAnyone() {
/* 676 */     return (!isInvisible() && !isMarker());
/*     */   }
/*     */   
...
/*     */     
/*     */     static {
/* 716 */       CODEC = RecordCodecBuilder.create(i -> i.group((App)Rotations.CODEC.optionalFieldOf("Head", ArmorStand.DEFAULT_HEAD_POSE).forGetter(ArmorStandPose::head), (App)Rotations.CODEC.optionalFieldOf("Body", ArmorStand.DEFAULT_BODY_POSE).forGetter(ArmorStandPose::body), (App)Rotations.CODEC.optionalFieldOf("LeftArm", ArmorStand.DEFAULT_LEFT_ARM_POSE).forGetter(ArmorStandPose::leftArm), (App)Rotations.CODEC.optionalFieldOf("RightArm", ArmorStand.DEFAULT_RIGHT_ARM_POSE).forGetter(ArmorStandPose::rightArm), (App)Rotations.CODEC.optionalFieldOf("LeftLeg", ArmorStand.DEFAULT_LEFT_LEG_POSE).forGetter(ArmorStandPose::leftLeg), (App)Rotations.CODEC.optionalFieldOf("RightLeg", ArmorStand.DEFAULT_RIGHT_LEG_POSE).forGetter(ArmorStandPose::rightLeg)).apply((Applicative)i, ArmorStandPose::new));
/*     */     } }
/*     */ 
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/decoration/ArmorStand.class
