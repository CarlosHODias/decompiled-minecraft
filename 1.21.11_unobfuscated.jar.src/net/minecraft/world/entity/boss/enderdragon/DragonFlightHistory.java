...
/* 11 */   private final Sample[] samples = new Sample[64];
/* 12 */   private int head = -1;
/*    */   
/*    */   public DragonFlightHistory() {
/* 15 */     Arrays.fill((Object[])this.samples, new Sample(0.0D, 0.0F));
/*    */   }
/*    */   
...
/* 25 */     if (this.head < 0) {
/* 26 */       Arrays.fill((Object[])this.samples, sample);
/*    */     }
/*    */     
/* 29 */     if (++this.head == 64) {
/* 30 */       this.head = 0;
...
/* 36 */     return this.samples[this.head - delay & 0x3F];
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/boss/enderdragon/DragonFlightHistory.class
