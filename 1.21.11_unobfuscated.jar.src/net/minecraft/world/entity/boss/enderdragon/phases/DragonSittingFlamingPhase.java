...
/*  44 */           this.dragon.level().addParticle((ParticleOptions)PowerParticleOption.create(ParticleTypes.DRAGON_BREATH, 1.0F), px, py, pz, -look.x * 0.07999999821186066D * j, -look.y * 0.6000000238418579D, -look.z * 0.07999999821186066D * j);
/*     */         }
...
/*  70 */       while (level.isEmptyBlock((BlockPos)pos)) {
/*  71 */         y--;
/*  72 */         if (y < 0.0D) {
/*  73 */           y = initialY;
/*     */           break;
...
/*     */       } 
/*  78 */       y = (Mth.floor(y) + 1);
/*  79 */       this.flame = new AreaEffectCloud((Level)level, x, y, z);
...
/*  86 */       level.addFreshEntity((Entity)this.flame);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/boss/enderdragon/phases/DragonSittingFlamingPhase.class
