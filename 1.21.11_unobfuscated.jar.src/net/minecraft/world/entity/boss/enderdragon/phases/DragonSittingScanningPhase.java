...
/* 30 */     Player player = level.getNearestPlayer(this.scanTargeting, (LivingEntity)this.dragon, this.dragon.getX(), this.dragon.getY(), this.dragon.getZ());
/*    */     
/* 32 */     if (player != null) {
...
/* 58 */       player = level.getNearestPlayer(CHARGE_TARGETING, (LivingEntity)this.dragon, this.dragon.getX(), this.dragon.getY(), this.dragon.getZ());
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/boss/enderdragon/phases/DragonSittingScanningPhase.class
