...
/*     */         return;
/*     */       } 
/*  65 */       Player playerNearestToEgg = level.getNearestPlayer(NEW_TARGET_TARGETING, (LivingEntity)this.dragon, egg.getX(), egg.getY(), egg.getZ());
/*  66 */       if (playerNearestToEgg != null) {
/*  67 */         distSqr = egg.distToCenterSqr((Position)playerNearestToEgg.position()) / 512.0D;
/*     */       } else {
/*  69 */         distSqr = 64.0D;
/*     */       } 
...
/* 118 */     ((DragonStrafePlayerPhase)this.dragon.getPhaseManager().<DragonStrafePlayerPhase>getPhase(EnderDragonPhase.STRAFE_PLAYER)).setTarget((LivingEntity)playerNearestToEgg);
/*     */   }
/*     */   
...
/* 140 */     if (player != null && this.dragon.canAttack((LivingEntity)player))
/* 141 */       strafePlayer(player); 
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/boss/enderdragon/phases/DragonHoldingPatternPhase.class
