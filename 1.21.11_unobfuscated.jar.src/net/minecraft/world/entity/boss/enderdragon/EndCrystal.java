...
/*  50 */     entityData.define(DATA_SHOW_BOTTOM, true);
/*     */   }
/*     */ 
/*     */   
/*     */   public void tick() {
...
/*  62 */         level().setBlockAndUpdate(pos, BaseFireBlock.getState((BlockGetter)level(), pos));
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/*  75 */     setBeamTarget(input.read("beam_target", BlockPos.CODEC).orElse(null));
...
/* 130 */     getEntityData().set(DATA_BEAM_TARGET, Optional.ofNullable(target));
/*     */   }
/*     */   
...
/* 138 */     getEntityData().set(DATA_SHOW_BOTTOM, showBottom);
/*     */   }
/*     */   
/*     */   public boolean showsBottom() {
/* 142 */     return (Boolean)getEntityData().get(DATA_SHOW_BOTTOM);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean shouldRenderAtSqrDistance(double distance) {
/* 147 */     return (super.shouldRenderAtSqrDistance(distance) || getBeamTarget() != null);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/boss/enderdragon/EndCrystal.class
