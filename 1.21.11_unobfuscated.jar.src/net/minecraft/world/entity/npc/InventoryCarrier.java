...
/* 28 */       mob.take((Entity)itemEntity, count - remainder.getCount());
...
/* 38 */     input.list("Inventory", ItemStack.CODEC).ifPresent(list -> getInventory().fromItemList(list));
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   default void writeInventoryToTag(ValueOutput output) {
/* 44 */     getInventory().storeAsItemList(output.list("Inventory", ItemStack.CODEC));
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/npc/InventoryCarrier.class
