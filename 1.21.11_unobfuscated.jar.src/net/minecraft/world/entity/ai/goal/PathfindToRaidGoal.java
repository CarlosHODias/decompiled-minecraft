...
/* 31 */       !this.mob.hasControllingPassenger() && 
/* 32 */       this.mob.hasActiveRaid() && 
...
/* 54 */         Vec3 posTowards = DefaultRandomPos.getPosTowards((PathfinderMob)this.mob, 15, 4, Vec3.atBottomCenterOf((Vec3i)raid.getCenter()), 1.5707963705062866D);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/PathfindToRaidGoal.class
