...
/*    */         continue;
/*    */       }
/* 36 */       double distSqr = this.animal.distanceToSqr((Entity)parent);
...
/* 60 */       return false;
/*    */     }
/* 62 */     double distSqr = this.animal.distanceToSqr((Entity)this.parent);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/FollowParentGoal.class
