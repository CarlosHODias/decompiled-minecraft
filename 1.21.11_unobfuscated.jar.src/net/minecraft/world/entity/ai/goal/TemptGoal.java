...
/*  64 */     return (this.items.test(player.getMainHandItem()) || this.items.test(player.getOffhandItem()));
/*     */   }
/*     */ 
/*     */   
...
/* 123 */     this.mob.getNavigation().moveTo((Entity)player, this.speedModifier);
/*     */   }
/*     */   
...
/* 132 */       super(mob, speedModifier, items, canScare, stopDistance);
/*     */     }
/*     */ 
/*     */     
/*     */     protected void stopNavigation() {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/TemptGoal.class
