...
/*     */     
/*  44 */     if (!GoalUtils.hasGroundPathNavigation((Mob)mob)) {
...
/*     */           if (!level.isVillage(level)) {
/*     */             return Double.NEGATIVE_INFINITY;
/*     */           }
/*     */           Optional<BlockPos> newPoiPos = level.getPoiManager().find((), this::hasNotVisited, level, 10, PoiManager.Occupancy.IS_OCCUPIED);
/*     */           return (Double)newPoiPos.<Double>map(()).orElse(Double.NEGATIVE_INFINITY);
/*     */         });
/*  74 */     if (landPos == null) {
/*  75 */       return false;
/*     */     }
/*  77 */     Optional<BlockPos> target = level.getPoiManager().find(e -> e.is(PoiTypeTags.VILLAGE), this::hasNotVisited, BlockPos.containing((Position)landPos), 10, PoiManager.Occupancy.IS_OCCUPIED);
...
/*  88 */       Vec3 partialStep = DefaultRandomPos.getPosTowards(this.mob, 10, 7, Vec3.atBottomCenterOf((Vec3i)this.poiPos), 1.5707963705062866D);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/MoveThroughVillageGoal.class
