...
/*  53 */     int durationTicks = (Integer)Optional.<KineticWeapon>ofNullable((KineticWeapon)this.mob.getMainHandItem().get(DataComponents.KINETIC_WEAPON)).map(KineticWeapon::computeDamageUseDuration).orElse(0);
...
/*     */     
/*  93 */     this.mob.lookAt((Entity)target, 30.0F, 30.0F);
/*  94 */     this.mob.getLookControl().setLookAt((Entity)target, 30.0F, 30.0F);
/*     */     
/*  96 */     if (this.state.notEngagedYet()) {
/*  97 */       if (targetDistSqr > this.approachDistanceSq) {
/*  98 */         this.mob.getNavigation().moveTo((Entity)target, speedModifier * this.speedModifierWhenRepositioning);
/*     */         return;
/*     */       } 
...
/* 108 */       this.state.awayPos = LandRandomPos.getPosAway((PathfinderMob)this.mob, Math.max(0.0D, (9 + mountDistance) - distance), Math.max(1.0D, (11 + mountDistance) - distance), 7, target.position());
...
/*     */       } 
/*     */     } else {
/* 126 */       this.mob.getNavigation().moveTo((Entity)target, speedModifier * this.speedModifierWhenCharging);
/*     */       
/* 128 */       if (targetDistSqr < this.targetInRangeRadiusSq || this.mob.getNavigation().isDone()) {
/* 129 */         double distance = Math.sqrt(targetDistSqr);
/* 130 */         this.state.awayPos = LandRandomPos.getPosAway((PathfinderMob)this.mob, (6 + mountDistance) - distance, (7 + mountDistance) - distance, 7, target.position());
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/* 152 */       this.engageTime = spearDownTime;
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/SpearUseGoal.class
