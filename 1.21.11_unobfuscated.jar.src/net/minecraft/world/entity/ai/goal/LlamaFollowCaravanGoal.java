...
/*     */     }
/*     */     
/*  34 */     List<Entity> llamas = this.llama.level().getEntities((Entity)this.llama, this.llama.getBoundingBox().inflate(9.0D, 4.0D, 9.0D), e -> {
...
/*     */       }
/*     */       
/*  48 */       double distSquare = this.llama.distanceToSqr((Entity)candidate);
...
/*     */         }
/*     */         
/*  70 */         double distSquare = this.llama.distanceToSqr((Entity)candidate);
...
/*     */     }
/*     */     
/* 102 */     double distSqr = this.llama.distanceToSqr((Entity)this.llama.getCaravanHead());
...
/* 137 */     double distanceTo = this.llama.distanceTo((Entity)follows);
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/LlamaFollowCaravanGoal.class
