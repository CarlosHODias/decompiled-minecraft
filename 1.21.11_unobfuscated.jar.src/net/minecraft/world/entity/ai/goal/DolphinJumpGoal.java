...
/*  53 */     return (this.dolphin.level().getBlockState(dolphinPos.offset(stepX * currentStep, 1, stepZ * currentStep)).isAir() && 
/*  54 */       this.dolphin.level().getBlockState(dolphinPos.offset(stepX * currentStep, 2, stepZ * currentStep)).isAir());
/*     */   }
/*     */ 
/*     */   
...
/*  72 */     this.dolphin.setDeltaMovement(this.dolphin.getDeltaMovement().add(
/*  73 */           direction.getStepX() * 0.6D, 0.7D, 
/*     */           
/*  75 */           direction.getStepZ() * 0.6D));
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/DolphinJumpGoal.class
