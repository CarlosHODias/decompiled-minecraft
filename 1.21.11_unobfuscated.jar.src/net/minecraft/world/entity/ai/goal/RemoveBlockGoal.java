...
/*  34 */     this.removerMob = (Mob)mob;
/*     */   }
/*     */   private int ticksSinceReachedGoal; private static final int WAIT_AFTER_BLOCK_FOUND = 20;
/*     */   
/*     */   public boolean canUse() {
/*  39 */     if (!((Boolean)getServerLevel((Entity)this.removerMob).getGameRules().get(GameRules.MOB_GRIEFING))) {
/*  40 */       return false;
/*     */     }
/*     */     
...
/*     */     
/*  82 */     BlockPos eatPos = getPosWithBlock(mobPos, (BlockGetter)level);
/*     */     
...
/*  91 */           double v = 0.08D;
/*  92 */           ((ServerLevel)level).sendParticles((ParticleOptions)new ItemParticleOption(ParticleTypes.ITEM, new ItemStack((ItemLike)Items.EGG)), 
/*     */               
/*  94 */               eatPos.getX() + 0.5D, 
/*  95 */               eatPos.getY() + 0.7D, 
/*  96 */               eatPos.getZ() + 0.5D, 3, (
/*     */               
/*  98 */               random.nextFloat() - 0.5D) * 0.08D, (
/*  99 */               random.nextFloat() - 0.5D) * 0.08D, (
/* 100 */               random.nextFloat() - 0.5D) * 0.08D, 0.15000000596046448D);
/*     */         } 
/*     */       } 
/*     */ 
/*     */ 
...
/* 122 */             ((ServerLevel)level).sendParticles((ParticleOptions)ParticleTypes.POOF, eatPos.getX() + 0.5D, eatPos.getY(), eatPos.getZ() + 0.5D, 1, xa, ya, za, 0.15000000596046448D);
/*     */           } 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/RemoveBlockGoal.class
