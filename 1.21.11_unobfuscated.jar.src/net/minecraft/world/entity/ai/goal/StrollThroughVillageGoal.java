...
/* 51 */     this.wantedPos = (landPos == null) ? null : BlockPos.containing((Position)landPos);
...
/* 68 */       Vec3 longDistanceTarget = Vec3.atBottomCenterOf((Vec3i)this.wantedPos);
/*    */ 
/*    */       
...
/* 77 */       BlockPos pathTarget = BlockPos.containing((Position)moveTarget);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/StrollThroughVillageGoal.class
