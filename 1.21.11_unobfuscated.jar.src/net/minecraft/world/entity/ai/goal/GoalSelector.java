...
/*     */ {
/*  14 */   private static final WrappedGoal NO_GOAL = new WrappedGoal(Integer.MAX_VALUE, new Goal()
/*     */       {
...
/*  35 */     this.availableGoals.add(new WrappedGoal(prio, goal));
/*     */   }
/*     */   
/*     */   public void removeAllGoals(Predicate<Goal> predicate) {
/*  39 */     this.availableGoals.removeIf(goal -> predicate.test(goal.getGoal()));
/*     */   }
/*     */   
...
/*  88 */         WrappedGoal currentGoal = this.lockedFlags.getOrDefault(flag, NO_GOAL);
/*  89 */         currentGoal.stop();
...
/* 116 */     this.disabledFlags.add(flag);
/*     */   }
/*     */   
/*     */   public void enableControlFlag(Goal.Flag flag) {
/* 120 */     this.disabledFlags.remove(flag);
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/GoalSelector.class
