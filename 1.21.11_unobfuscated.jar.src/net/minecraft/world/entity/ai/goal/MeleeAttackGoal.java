...
/*  52 */       return false;
/*     */     }
/*  54 */     this.path = this.mob.getNavigation().createPath((Entity)target, 0);
...
/*     */       return;
/*     */     }
/* 116 */     this.mob.getLookControl().setLookAt((Entity)target, 30.0F, 30.0F);
/* 117 */     this.ticksUntilNextPathRecalculation = Math.max(this.ticksUntilNextPathRecalculation - 1, 0);
/*     */     
/* 119 */     if ((this.followingTargetEvenIfNotSeen || this.mob.getSensing().hasLineOfSight((Entity)target)) && 
...
/*     */       
/* 127 */       double targetDistanceSqr = this.mob.distanceToSqr((Entity)target);
...
/*     */       } 
/*     */       
/* 134 */       if (!this.mob.getNavigation().moveTo((Entity)target, this.speedModifier)) {
...
/* 151 */       this.mob.doHurtTarget(getServerLevel((Entity)this.mob), (Entity)target);
/*     */     } 
/*     */   }
/*     */   
...
/* 164 */     return (isTimeToAttack() && this.mob.isWithinMeleeAttackRange(target) && this.mob.getSensing().hasLineOfSight((Entity)target));
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/MeleeAttackGoal.class
