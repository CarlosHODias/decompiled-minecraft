...
/*     */     }
/*     */     
/*  45 */     if (lastHurtByMob.getType() == EntityType.PLAYER && (Boolean)getServerLevel((Entity)this.mob).getGameRules().get(GameRules.UNIVERSAL_ANGER))
/*     */     {
/*  47 */       return false;
/*     */     }
/*     */     
...
/*     */         continue;
/*     */       }
/*  94 */       if (other.isAlliedTo((Entity)this.mob.getLastHurtByMob())) {
/*     */         continue;
/*     */       }
...
/* 115 */     other.setTarget(hurtByMob);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/target/HurtByTargetGoal.class
