...
/* 39 */     return ((Boolean)getServerLevel((Entity)this.mob).getGameRules().get(GameRules.UNIVERSAL_ANGER) && wasHurtByPlayer());
/*    */   }
/*    */   
/*    */   private boolean wasHurtByPlayer() {
/* 43 */     return (this.mob.getLastHurtByMob() != null && 
/* 44 */       this.mob.getLastHurtByMob().getType() == EntityType.PLAYER && 
/* 45 */       this.mob.getLastHurtByMobTimestamp() > this.lastHurtByPlayerTimestamp);
/*    */   }
/*    */ 
/*    */   
/*    */   public void start() {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/target/ResetUniversalAngerTargetGoal.class
