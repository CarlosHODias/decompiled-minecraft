...
/*  27 */   protected int unseenMemoryTicks = 60;
/*     */   
/*     */   public TargetGoal(Mob mob, boolean mustSee) {
/*  30 */     this(mob, mustSee, false);
/*     */   }
/*     */   
...
/*  59 */     if (this.mob.distanceToSqr((Entity)target) > within * within) {
/*  60 */       return false;
/*     */     }
/*  62 */     if (this.mustSee) {
/*  63 */       if (this.mob.getSensing().hasLineOfSight((Entity)target)) {
...
/*  76 */     return this.mob.getAttributeValue(Attributes.FOLLOW_RANGE);
/*     */   }
/*     */ 
/*     */   
/*     */   public void start() {
...
/*  94 */       return false;
/*     */     }
/*  96 */     if (!targetConditions.test(getServerLevel((Entity)this.mob), (LivingEntity)this.mob, target)) {
/*  97 */       return false;
/*     */     }
...
/* 120 */     Path path = this.mob.getNavigation().createPath((Entity)target, 0);
/* 121 */     if (path == null) {
/* 122 */       return false;
/*     */     }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/target/TargetGoal.class
