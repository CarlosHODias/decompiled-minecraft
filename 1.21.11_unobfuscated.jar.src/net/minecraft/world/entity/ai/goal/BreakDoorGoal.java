...
/* 37 */       return false;
/*    */     }
/* 39 */     if (!((Boolean)getServerLevel((Entity)this.mob).getGameRules().get(GameRules.MOB_GRIEFING))) {
/* 40 */       return false;
/*    */     }
...
/* 88 */     return this.validDifficulties.test(difficulty);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/BreakDoorGoal.class
