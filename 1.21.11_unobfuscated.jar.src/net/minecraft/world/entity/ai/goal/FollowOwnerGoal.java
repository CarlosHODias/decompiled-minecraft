...
/* 43 */       return false;
/*    */     }
/* 45 */     if (this.tamable.distanceToSqr((Entity)owner) < (this.startDistance * this.startDistance)) {
/* 46 */       return false;
/*    */     }
/* 48 */     this.owner = owner;
/* 49 */     return true;
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/goal/FollowOwnerGoal.class
