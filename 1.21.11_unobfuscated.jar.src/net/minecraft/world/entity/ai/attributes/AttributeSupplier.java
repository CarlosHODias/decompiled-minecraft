...
/* 19 */     AttributeInstance instance = this.instances.get(attribute);
/* 20 */     if (instance == null) {
...
/* 27 */     return getAttributeInstance(attribute).getValue();
/*    */   }
/*    */   
/*    */   public double getBaseValue(Holder<Attribute> attribute) {
/* 31 */     return getAttributeInstance(attribute).getBaseValue();
/*    */   }
/*    */   
...
/* 43 */     AttributeInstance template = this.instances.get(attribute);
/* 44 */     if (template == null) {
/* 45 */       return null;
/*    */     }
...
/* 57 */     return this.instances.containsKey(attribute);
/*    */   }
/*    */   
/*    */   public boolean hasModifier(Holder<Attribute> attribute, Identifier modifier) {
/* 61 */     AttributeInstance attributeInstance = this.instances.get(attribute);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/attributes/AttributeSupplier.class
