...
/*  79 */     for (Player player : (Iterable<Player>)level.players()) {
...
/*     */     
/*     */     try {
/* 112 */       zombie = new Zombie((Level)level);
/* 113 */       zombie.finalizeSpawn((ServerLevelAccessor)level, level.getCurrentDifficultyAt(zombie.blockPosition()), EntitySpawnReason.EVENT, null);
...
/* 119 */     level.addFreshEntityWithPassengers((net.minecraft.world.entity.Entity)zombie);
/*     */   }
/*     */ 
/*     */   
...
/*     */       {
/*     */         
/* 133 */         if (Monster.checkMonsterSpawnRules(EntityType.ZOMBIE, (ServerLevelAccessor)level, EntitySpawnReason.EVENT, offset, level.random))
/* 134 */           return Vec3.atBottomCenterOf((Vec3i)offset); 
/*     */       }
/*     */     } 
/* 137 */     return null;
/*     */   }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/village/VillageSiege.class
