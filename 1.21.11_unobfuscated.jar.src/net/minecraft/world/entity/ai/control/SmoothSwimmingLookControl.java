...
/*    */       
/* 21 */       getYRotD().ifPresent(yRotD -> this.mob.yHeadRot = rotateTowards(this.mob.yHeadRot, yRotD + 20.0F, this.yMaxRotSpeed));
/* 22 */       getXRotD().ifPresent(xRotD -> this.mob.setXRot(rotateTowards(this.mob.getXRot(), xRotD + 10.0F, this.xMaxRotAngle)));
/*    */     } else {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/control/SmoothSwimmingLookControl.class
