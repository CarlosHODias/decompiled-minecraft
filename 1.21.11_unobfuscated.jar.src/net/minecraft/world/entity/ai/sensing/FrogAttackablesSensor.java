...
/*    */     {
/* 22 */       return mob.closerThan((Entity)body, 10.0D);
/*    */     }
/* 24 */     return false;
/*    */   }
/*    */   
/*    */   private boolean isUnreachableAttackTarget(LivingEntity body, LivingEntity mob) {
/* 28 */     List<UUID> unreachableAttackTargets = body.getBrain().getMemory(MemoryModuleType.UNREACHABLE_TONGUE_TARGETS).orElseGet(java.util.ArrayList::new);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/sensing/FrogAttackablesSensor.class
