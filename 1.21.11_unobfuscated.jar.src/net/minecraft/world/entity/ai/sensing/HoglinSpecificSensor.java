...
/*    */ 
/*    */     
/* 51 */     NearestVisibleLivingEntities visibleLivingEntities = brain.getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES).orElse(NearestVisibleLivingEntities.empty());
/* 52 */     for (LivingEntity entity : (Iterable<LivingEntity>)visibleLivingEntities.findAll(entity -> (!entity.isBaby() && (entity instanceof Piglin || entity instanceof Hoglin)))) {
...
/* 67 */     brain.setMemory(MemoryModuleType.VISIBLE_ADULT_PIGLIN_COUNT, adultPiglinCount);
/* 68 */     brain.setMemory(MemoryModuleType.VISIBLE_ADULT_HOGLIN_COUNT, adultHoglins.size());
/*    */   }
/*    */   
/*    */   private Optional<BlockPos> findNearestRepellent(ServerLevel level, Hoglin body) {
/* 72 */     return BlockPos.findClosestMatch(
/* 73 */         body.blockPosition(), 8, 4, pos -> level.getBlockState(pos).is(BlockTags.HOGLIN_REPELLENTS));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/sensing/HoglinSpecificSensor.class
