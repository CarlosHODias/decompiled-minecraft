...
/*    */ 
/*    */     
/* 36 */     Objects.requireNonNull(body); Optional<ItemEntity> nearestVisibleLovedItem = items.stream().filter(itemEntity -> body.wantsToPickUp(level, itemEntity.getItem())).filter(itemEntity -> itemEntity.closerThan((Entity)body, 32.0D)).filter(body::hasLineOfSight)
/* 37 */       .findFirst();
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/sensing/NearestItemSensor.class
