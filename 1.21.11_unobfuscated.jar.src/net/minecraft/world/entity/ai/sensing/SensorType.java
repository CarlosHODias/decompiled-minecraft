...
/*    */   
/*    */   public U create() {
/* 47 */     return this.factory.get();
/*    */   }
/*    */   
/*    */   private static <U extends Sensor<?>> SensorType<U> register(String name, Supplier<U> factory) {
/* 51 */     return (SensorType<U>)Registry.register((Registry)BuiltInRegistries.SENSOR_TYPE, Identifier.withDefaultNamespace(name), new SensorType<>(factory));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/sensing/SensorType.class
