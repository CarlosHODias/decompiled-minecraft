...
/*    */       return;
/*    */     }
/* 46 */     boolean mobPresent = ((List)livingEntitiesMemory.get()).stream().anyMatch(entity -> this.mobTest.test((T)body, body));
/*    */     
/* 48 */     if (mobPresent) {
/* 49 */       mobDetected(body);
/*    */     }
...
/* 54 */     body.getBrain().setMemoryWithExpiry(this.toSet, true, this.memoryTimeToLive);
/*    */   }
/*    */   
/*    */   public void clearMemory(T body) {
/* 58 */     body.getBrain().eraseMemory(this.toSet);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/sensing/MobSensor.class
