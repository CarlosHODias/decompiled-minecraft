...
/*  50 */     return (body.isInLove() && findValidBreedPartner(body).isPresent());
/*     */   }
/*     */ 
/*     */   
/*     */   protected void start(ServerLevel level, Animal body, long timestamp) {
/*  55 */     Animal partner = findValidBreedPartner(body).get();
/*     */     
...
/*     */     
/*  60 */     BehaviorUtils.lockGazeAndWalkToEachOther((LivingEntity)body, (LivingEntity)partner, this.speedModifier, this.closeEnoughDistance);
/*     */     
...
/*     */     
/*  73 */     return (partner.isAlive() && 
/*  74 */       body.canMate(partner) && 
/*  75 */       BehaviorUtils.entityIsVisible(body.getBrain(), (LivingEntity)partner) && timestamp <= this.spawnChildAtTime && 
/*     */       
...
/*     */     
/*  84 */     BehaviorUtils.lockGazeAndWalkToEachOther((LivingEntity)body, (LivingEntity)partner, this.speedModifier, this.closeEnoughDistance);
/*  85 */     if (!body.closerThan((Entity)partner, 3.0D)) {
/*     */       return;
/*     */     }
...
/* 104 */     return body.getBrain().getMemory(MemoryModuleType.BREED_TARGET).get();
/*     */   }
/*     */   
/*     */   private boolean hasBreedTargetOfRightType(Animal body) {
/* 108 */     Brain<?> brain = body.getBrain();
/* 109 */     return (brain.hasMemoryValue(MemoryModuleType.BREED_TARGET) && ((AgeableMob)
/* 110 */       brain.getMemory(MemoryModuleType.BREED_TARGET).get()).getType() == this.partnerType);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */     Objects.requireNonNull(Animal.class); return ((NearestVisibleLivingEntities)body.getBrain().getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES).get()).findClosest(entity -> { // Byte code:
/*     */           //   0: aload_2
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/behavior/AnimalMakeLove.class
