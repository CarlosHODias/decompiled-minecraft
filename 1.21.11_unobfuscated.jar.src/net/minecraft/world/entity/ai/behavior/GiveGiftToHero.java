...
/*  30 */   private static final Map<ResourceKey<VillagerProfession>, ResourceKey<LootTable>> GIFTS = (Map<ResourceKey<VillagerProfession>, ResourceKey<LootTable>>)ImmutableMap.builder()
...
/*  53 */     super(
/*  54 */         (Map<MemoryModuleType<?>, MemoryStatus>)ImmutableMap.of(MemoryModuleType.WALK_TARGET, MemoryStatus.REGISTERED, MemoryModuleType.LOOK_TARGET, MemoryStatus.REGISTERED, MemoryModuleType.INTERACTION_TARGET, MemoryStatus.REGISTERED, MemoryModuleType.NEAREST_VISIBLE_PLAYER, MemoryStatus.VALUE_PRESENT), timeout);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  82 */     Player player = getNearestTargetableHero(body).get();
/*  83 */     body.getBrain().setMemory(MemoryModuleType.INTERACTION_TARGET, player);
/*  84 */     BehaviorUtils.lookAtEntity((LivingEntity)body, (LivingEntity)player);
/*     */   }
/*     */ 
/*     */   
/*     */   protected boolean canStillUse(ServerLevel level, Villager body, long timestamp) {
/*  89 */     return (isHeroVisible(body) && !this.giftGivenDuringThisRun);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void tick(ServerLevel level, Villager villager, long timestamp) {
/*  94 */     Player player = getNearestTargetableHero(villager).get();
/*  95 */     BehaviorUtils.lookAtEntity((LivingEntity)villager, (LivingEntity)player);
/*     */     
/*  97 */     if (isWithinThrowingDistance(villager, player)) {
/*  98 */       if (timestamp - this.timeSinceStart > 20L) {
/*  99 */         throwGift(level, villager, (LivingEntity)player);
/* 100 */         this.giftGivenDuringThisRun = true;
/*     */       } 
/*     */     } else {
/* 103 */       BehaviorUtils.setWalkAndLookTargetMemories((LivingEntity)villager, (Entity)player, 0.5F, 5);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 116 */     villager.dropFromGiftLootTable(level, getLootTableToThrow(villager), (l, itemStack) -> BehaviorUtils.throwItem((LivingEntity)villager, itemStack, target.position()));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */     }
/* 129 */     return GIFTS.getOrDefault(profession.get(), BuiltInLootTables.UNEMPLOYED_GIFT);
/*     */   }
/*     */   
/*     */   private boolean isHeroVisible(Villager body) {
/* 133 */     return getNearestTargetableHero(body).isPresent();
/*     */   }
/*     */   
...
/* 142 */     return player.hasEffect(MobEffects.HERO_OF_THE_VILLAGE);
/*     */   }
/*     */   
...
/* 148 */     return villagerPos.closerThan((Vec3i)playerPos, 5.0D);
/*     */   }
/*     */   
/*     */   private static int calculateTimeUntilNextGift(ServerLevel level) {
/* 152 */     return 600 + level.random.nextInt(6001);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/behavior/GiveGiftToHero.class
