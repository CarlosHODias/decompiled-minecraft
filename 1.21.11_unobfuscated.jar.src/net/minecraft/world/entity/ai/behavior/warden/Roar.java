...
/* 35 */     LivingEntity target = body.getBrain().getMemory(MemoryModuleType.ROAR_TARGET).get();
/* 36 */     BehaviorUtils.lookAtEntity((LivingEntity)body, target);
/* 37 */     body.setPose(Pose.ROARING);
/* 38 */     body.increaseAngerAt((Entity)target, 20, false);
/*    */   }
/*    */ 
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/behavior/warden/Roar.class
