...
/*  33 */     super(
/*  34 */         (Map<MemoryModuleType<?>, MemoryStatus>)ImmutableMap.of(MemoryModuleType.INTERACTION_TARGET, MemoryStatus.VALUE_PRESENT), minDuration, maxDuration);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/*  49 */     LivingEntity target = brain.getMemory(MemoryModuleType.INTERACTION_TARGET).get();
/*  50 */     return (target.getType() == EntityType.PLAYER && 
/*  51 */       body.isAlive() && 
/*  52 */       target.isAlive() && 
/*  53 */       !body.isBaby() && 
/*  54 */       body.distanceToSqr((Entity)target) <= 17.0D);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean canStillUse(ServerLevel level, Villager body, long timestamp) {
/*  59 */     return (checkExtraStartConditions(level, body) && this.lookTime > 0 && 
/*     */       
/*  61 */       body.getBrain().getMemory(MemoryModuleType.INTERACTION_TARGET).isPresent());
/*     */   }
/*     */ 
/*     */   
...
/* 117 */     displayAsHeldItem(villager, this.displayItems.get(0));
/*     */   }
/*     */   
/*     */   private void updateDisplayItems(Villager villager) {
/* 121 */     for (MerchantOffer offer : (Iterable<MerchantOffer>)villager.getOffers()) {
...
/* 129 */     return (ItemStack.isSameItem(this.playerItemStack, offer.getCostA()) || ItemStack.isSameItem(this.playerItemStack, offer.getCostB()));
/*     */   }
/*     */   
...
/*     */     
/* 145 */     LivingEntity target = brain.getMemory(MemoryModuleType.INTERACTION_TARGET).get();
/*     */     
/* 147 */     brain.setMemory(MemoryModuleType.LOOK_TARGET, new EntityTracker((Entity)target, true));
/* 148 */     return target;
/*     */   }
/*     */   
...
/*     */       }
/* 158 */       displayAsHeldItem(villager, this.displayItems.get(this.displayIndex));
/*     */     } 
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/behavior/ShowTradesToPlayer.class
