...
/* 22 */     return BehaviorBuilder.create(i -> i.group((App)i.present(MemoryModuleType.JOB_SITE), (App)i.present(MemoryModuleType.NEAREST_LIVING_ENTITIES)).apply((Applicative)i, ()));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 56 */     return (jobSite.isPresent() && 
/* 57 */       pos.equals(jobSite.get()) && 
...
/* 62 */     return ((VillagerProfession)profession.value()).heldJobSite().test(poiType);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/behavior/PoiCompetitorScan.class
