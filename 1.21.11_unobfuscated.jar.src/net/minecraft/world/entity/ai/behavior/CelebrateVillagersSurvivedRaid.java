...
/* 27 */     super((Map<MemoryModuleType<?>, MemoryStatus>)ImmutableMap.of(), minDuration, maxDuration);
/*    */   }
...
/* 34 */     return (this.currentRaid != null && this.currentRaid.isVictory() && MoveToSkySeeingSpot.hasNoBlocksAbove(level, (LivingEntity)body, testPos));
/*    */   }
/*    */ 
/*    */   
...
/*    */     }
/*    */     
/* 56 */     if (random.nextInt(200) == 0 && MoveToSkySeeingSpot.hasNoBlocksAbove(level, (LivingEntity)body, body.blockPosition())) {
/* 57 */       DyeColor color = (DyeColor)Util.getRandom((Object[])DyeColor.values(), random);
/* 58 */       int flightDuration = random.nextInt(3);
/* 59 */       ItemStack firework = getFirework(color, flightDuration);
/*    */       
/* 61 */       Projectile.spawnProjectile((Projectile)new FireworkRocketEntity(body.level(), (Entity)body, body.getX(), body.getEyeY(), body.getZ(), firework), level, firework);
/*    */     } 
/*    */   }
/*    */   
/*    */   private ItemStack getFirework(DyeColor color, int flightDuration) {
/* 66 */     ItemStack rocket = new ItemStack((net.minecraft.world.level.ItemLike)Items.FIREWORK_ROCKET);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/behavior/CelebrateVillagersSurvivedRaid.class
