...
/* 26 */     return (getTarget(mob) != null && mob.getMainHandItem().has(DataComponents.KINETIC_WEAPON));
/*    */   }
/*    */ 
/*    */   
/*    */   protected boolean checkExtraStartConditions(ServerLevel level, PathfinderMob body) {
/* 31 */     return (ableToAttack(body) && !body.isUsingItem());
/*    */   }
/*    */ 
/*    */   
...
/* 43 */     return mob.getBrain().getMemory(MemoryModuleType.ATTACK_TARGET).orElse(null);
/*    */   }
/*    */ 
/*    */   
/*    */   protected boolean canStillUse(ServerLevel level, PathfinderMob body, long timestamp) {
/* 48 */     return (ableToAttack(body) && farEnough(body));
/*    */   }
/*    */ 
/*    */   
...
/*    */     
/* 66 */     mob.getBrain().setMemory(MemoryModuleType.LOOK_TARGET, new EntityTracker((Entity)target, true));
/* 67 */     mob.getNavigation().moveTo((Entity)target, speedModifier * this.speedModifierWhenRepositioning);
/*    */   }
/*    */ 
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/behavior/SpearApproach.class
