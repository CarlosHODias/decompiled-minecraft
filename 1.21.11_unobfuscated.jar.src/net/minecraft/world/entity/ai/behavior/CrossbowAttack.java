...
/*  36 */     super((Map<MemoryModuleType<?>, MemoryStatus>)ImmutableMap.of(MemoryModuleType.LOOK_TARGET, MemoryStatus.REGISTERED, MemoryModuleType.ATTACK_TARGET, MemoryStatus.VALUE_PRESENT), 1200);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  44 */     LivingEntity attackTarget = getAttackTarget((LivingEntity)body);
/*  45 */     return (body.isHolding(Items.CROSSBOW) && BehaviorUtils.canSee((LivingEntity)body, attackTarget) && BehaviorUtils.isWithinAttackRange((Mob)body, attackTarget, 0));
/*     */   }
/*     */ 
/*     */   
/*     */   protected boolean canStillUse(ServerLevel level, E body, long timestamp) {
/*  50 */     return (body.getBrain().hasMemoryValue(MemoryModuleType.ATTACK_TARGET) && checkExtraStartConditions(level, body));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   protected void tick(ServerLevel level, E body, long timestamp) {
/*  56 */     LivingEntity target = getAttackTarget((LivingEntity)body);
/*  57 */     lookAtTarget((Mob)body, target);
...
/*  75 */       body.startUsingItem(ProjectileUtil.getWeaponHoldingHand((LivingEntity)body, Items.CROSSBOW));
...
/*  84 */       if (pullTime >= CrossbowItem.getChargeDuration(useItem, (LivingEntity)body)) {
...
/* 102 */     body.getBrain().setMemory(MemoryModuleType.LOOK_TARGET, new EntityTracker((Entity)target, true));
/*     */   }
/*     */   
/*     */   private static LivingEntity getAttackTarget(LivingEntity body) {
/* 106 */     return body.getBrain().getMemory(MemoryModuleType.ATTACK_TARGET).get();
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/behavior/CrossbowAttack.class
