...
/* 23 */     return BehaviorBuilder.create(i -> i.group((App)i.present(MemoryModuleType.POTENTIAL_JOB_SITE), (App)i.absent(MemoryModuleType.JOB_SITE), (App)i.present(MemoryModuleType.NEAREST_LIVING_ENTITIES), (App)i.registered(MemoryModuleType.WALK_TARGET), (App)i.registered(MemoryModuleType.LOOK_TARGET)).apply((Applicative)i, ()));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 80 */         return canReachPos((PathfinderMob)nearbyVillager, poiPos, (PoiType)type.value());
/*    */       }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/behavior/YieldJobSite.class
