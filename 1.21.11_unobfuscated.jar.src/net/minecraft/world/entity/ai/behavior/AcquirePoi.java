...
/*  39 */     return create(poiType, memoryToAcquire, memoryToAcquire, onlyIfAdult, onPoiAcquisitionEvent, validPoi);
/*     */   }
/*     */   
...
/*  43 */     return create(poiType, memoryToAcquire, memoryToAcquire, onlyIfAdult, onPoiAcquisitionEvent, (l, p) -> true);
/*     */   }
/*     */   
...
/*     */     
/*  54 */     OneShot<PathfinderMob> acquirePoi = BehaviorBuilder.create(i -> i.group((App)i.absent(memoryToAcquire)).apply((Applicative)i, ()));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 121 */     return BehaviorBuilder.create(i -> i.group((App)i.absent(memoryToValidate)).apply((Applicative)i, ()));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 128 */       return null;
/*     */     }
/* 130 */     Set<BlockPos> targets = new HashSet<>();
/* 131 */     int maxRange = 1;
...
/* 163 */       return (timestamp - this.previousAttemptTimestamp < 400L);
/*     */     }
/*     */     
/*     */     public boolean shouldRetry(long timestamp) {
/* 167 */       return (timestamp >= this.nextScheduledAttemptTimestamp);
/*     */     }
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/ai/behavior/AcquirePoi.class
