...
/* 28 */     super(EntityType.DRAGON_FIREBALL, mob, direction, level);
/*    */   }
/*    */ 
/*    */   
...
/*    */       }
/* 45 */       cloud.setCustomParticle((ParticleOptions)PowerParticleOption.create(ParticleTypes.DRAGON_BREATH, 1.0F));
...
/* 54 */           double dist = distanceToSqr((Entity)entity);
/* 55 */           if (dist < 16.0D) {
...
/* 63 */       level().addFreshEntity((Entity)cloud);
/*    */       
/* 65 */       discard();
/*    */     } 
/*    */   }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/projectile/hurtingprojectile/DragonFireball.class
