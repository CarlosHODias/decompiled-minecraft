...
/*     */       
/*  33 */       Optional.empty(), 
/*  34 */       BuiltInRegistries.BLOCK.get(BlockTags.BLOCKS_WIND_CHARGE_EXPLOSIONS).map(Function.identity()));
/*     */   
...
/*     */     { return; }
/*     */     
/*  92 */     Entity entity1 = getOwner(); LivingEntity livingEntity1 = (LivingEntity)entity1, owner = (entity1 instanceof LivingEntity) ? livingEntity1 : null;
...
/*     */     }
/*     */     
/*  99 */     DamageSource source = damageSources().windCharge((Entity)this, owner);
/* 100 */     if (entity.hurtServer(serverLevel, source, 1.0F) && 
/* 101 */       entity instanceof LivingEntity) { LivingEntity mob = (LivingEntity)entity;
/* 102 */       EnchantmentHelper.doPostAttackEffects(serverLevel, (Entity)mob, source); }
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/projectile/hurtingprojectile/windcharge/AbstractWindCharge.class
