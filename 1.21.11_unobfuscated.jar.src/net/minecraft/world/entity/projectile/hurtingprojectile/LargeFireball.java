...
/* 35 */       boolean grief = (Boolean)serverLevel.getGameRules().get(GameRules.MOB_GRIEFING);
/* 36 */       level().explode((Entity)this, getX(), getY(), getZ(), this.explosionPower, grief, Level.ExplosionInteraction.MOB);
/* 37 */       discard(); }
/*    */   
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/projectile/hurtingprojectile/LargeFireball.class
