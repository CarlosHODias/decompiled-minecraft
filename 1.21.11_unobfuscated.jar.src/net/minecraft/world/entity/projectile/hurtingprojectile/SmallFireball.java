...
/* 21 */     super((EntityType)type, level);
/*    */   }
/*    */   
/*    */   public SmallFireball(Level level, LivingEntity mob, Vec3 direction) {
/* 25 */     super(EntityType.SMALL_FIREBALL, mob, direction, level);
/*    */   }
/*    */   
/*    */   public SmallFireball(Level level, double x, double y, double z, Vec3 direction) {
/* 29 */     super(EntityType.SMALL_FIREBALL, x, y, z, direction, level);
/*    */   }
/*    */   
...
/* 60 */     if (!(owner instanceof net.minecraft.world.entity.Mob) || (Boolean)serverLevel.getGameRules().get(GameRules.MOB_GRIEFING)) {
/* 61 */       BlockPos pos = hitResult.getBlockPos().relative(hitResult.getDirection());
/* 62 */       if (level().isEmptyBlock(pos)) {
/* 63 */         level().setBlockAndUpdate(pos, BaseFireBlock.getState((BlockGetter)level(), pos));
/*    */       }
/*    */     } 
/*    */   }
/*    */ 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/projectile/hurtingprojectile/SmallFireball.class
