...
/*  47 */     return (Float)getPickupItemStackOrigin().getOrDefault(DataComponents.POTION_DURATION_SCALE, 1.0F);
/*     */   }
/*     */   
...
/*  63 */     this.entityData.set(ID_EFFECT_COLOR, potionContents.equals(PotionContents.EMPTY) ? -1 : potionContents.getColor());
/*     */   }
/*     */   
/*     */   public void addEffect(MobEffectInstance effect) {
/*  67 */     setPotionContents(getPotionContents().withEffectAdded(effect));
/*     */   }
/*     */ 
/*     */   
/*     */   protected void defineSynchedData(SynchedEntityData.Builder entityData) {
/*  72 */     super.defineSynchedData(entityData);
/*  73 */     entityData.define(ID_EFFECT_COLOR, -1);
/*     */   }
/*     */ 
/*     */   
/*     */   public void tick() {
...
/* 104 */       level().addParticle((ParticleOptions)ColorParticleOption.create(ParticleTypes.ENTITY_EFFECT, colorValue), getRandomX(0.5D), getRandomY(), getRandomZ(0.5D), 0.0D, 0.0D, 0.0D);
/*     */     }
/*     */   }
/*     */   
/*     */   public int getColor() {
/* 109 */     return (Integer)this.entityData.get(ID_EFFECT_COLOR);
/*     */   }
/*     */ 
/*     */   
...
/* 138 */           level().addParticle((ParticleOptions)ColorParticleOption.create(ParticleTypes.ENTITY_EFFECT, red, green, blue), getRandomX(0.5D), getRandomY(), getRandomZ(0.5D), 0.0D, 0.0D, 0.0D);
/*     */         }
/*     */       } 
/*     */     } else {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/projectile/arrow/Arrow.class
