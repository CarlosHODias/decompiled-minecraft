...
/* 29 */     super(EntityType.SPLASH_POTION, level, owner, itemStack);
/*    */   }
/*    */   
/*    */   public ThrownSplashPotion(Level level, double x, double y, double z, ItemStack itemStack) {
/* 33 */     super(EntityType.SPLASH_POTION, level, x, y, z, itemStack);
/*    */   }
/*    */ 
/*    */   
...
/* 44 */     float durationScale = (Float)potionItem.getOrDefault(DataComponents.POTION_DURATION_SCALE, 1.0F);
/*    */     
...
/*    */     
/* 51 */     float margin = ProjectileUtil.computeMargin((Entity)this);
/*    */     
...
/* 66 */               ((MobEffect)effect.value()).applyInstantenousEffect(level, (Entity)this, getOwner(), entity, effectInstance.getAmplifier(), scale); continue;
/*    */             } 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/projectile/throwableitemprojectile/ThrownSplashPotion.class
