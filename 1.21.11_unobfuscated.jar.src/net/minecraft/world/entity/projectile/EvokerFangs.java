...
/*  54 */     this.owner = EntityReference.of((UniquelyIdentifyable)owner);
/*     */   }
/*     */ 
/*     */   
...
/*  89 */             level().addParticle((ParticleOptions)ParticleTypes.CRIT, x, y + 1.0D, z, xd, yd, zd);
/*     */           }
/*     */         
/*     */         }
/*     */       } 
...
/*     */     } else {
/* 121 */       if (currentOwner.isAlliedTo((Entity)entity)) {
/*     */         return;
/*     */       }
/* 124 */       DamageSource damageSource = damageSources().indirectMagic(this, (Entity)currentOwner);
...
/* 126 */           EnchantmentHelper.doPostAttackEffects(serverLevel, (Entity)entity, damageSource);
/*     */         } }
/*     */     
/*     */     } 
/*     */   }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/projectile/EvokerFangs.class
