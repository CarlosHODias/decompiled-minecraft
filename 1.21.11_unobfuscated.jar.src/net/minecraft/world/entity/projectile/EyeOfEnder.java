...
/*  59 */     entityData.define(DATA_ITEM_STACK, getDefaultItem());
/*     */   }
/*     */ 
/*     */   
...
/* 126 */         level().addParticle((ParticleOptions)ParticleTypes.BUBBLE, origin.x, origin.y, origin.z, movement.x, movement.y, movement.z);
/*     */       }
/*     */     } else {
/* 129 */       level().addParticle((ParticleOptions)ParticleTypes.PORTAL, origin.x + 
/* 130 */           this.random.nextDouble() * 0.6D - 0.3D, origin.y - 0.5D, origin.z + 
/*     */           
/* 132 */           this.random.nextDouble() * 0.6D - 0.3D, movement.x, movement.y, movement.z);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 154 */     output.store("Item", ItemStack.CODEC, getItem());
/*     */   }
/*     */ 
/*     */   
/*     */   protected void readAdditionalSaveData(ValueInput input) {
/* 159 */     setItem(input.read("Item", ItemStack.CODEC).orElse(getDefaultItem()));
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/projectile/EyeOfEnder.class
