...
/*  41 */     setPersistentAngerEndTime(level().getGameTime() + remainingTime);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  73 */       setPersistentAngerEndTime((Long)endTime.get());
/*     */     }
/*     */     else {
/*     */       
/*  77 */       Optional<Integer> angerTime = input.getInt("AngerTime");
/*  78 */       if (angerTime.isPresent()) {
/*  79 */         setTimeToRemainAngry((Integer)angerTime.get());
/*     */       } else {
...
/* 150 */     return ((Boolean)level.getGameRules().get(GameRules.UNIVERSAL_ANGER) && isAngry() && getPersistentAngerTarget() == null);
/*     */   }
/*     */   
...
/* 163 */     if (!((Boolean)level.getGameRules().get(GameRules.FORGIVE_DEAD_PLAYERS))) {
/*     */       return;
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/NeutralMob.class
