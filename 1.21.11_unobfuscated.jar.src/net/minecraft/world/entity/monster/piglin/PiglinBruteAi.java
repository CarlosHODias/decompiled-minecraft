...
/*     */     
/*  59 */     brain.setCoreActivities((Set)ImmutableSet.of(Activity.CORE));
...
/*  90 */     brain.addActivityAndRemoveMemoryWhenStopped(Activity.FIGHT, 10, ImmutableList.of(
...
/*  99 */           Pair.of(SetEntityLookTarget.create(EntityType.PLAYER, 8.0F), 1), 
/* 100 */           Pair.of(SetEntityLookTarget.create(EntityType.PIGLIN, 8.0F), 1), 
/* 101 */           Pair.of(SetEntityLookTarget.create(EntityType.PIGLIN_BRUTE, 8.0F), 1), 
/* 102 */           Pair.of(SetEntityLookTarget.create(8.0F), 1), 
/* 103 */           Pair.of(new DoNothing(30, 60), 1)));
/*     */   }
/*     */ 
/*     */   
/*     */   private static RunOne<PiglinBrute> createIdleMovementBehaviors() {
/* 108 */     return new RunOne((List)ImmutableList.of(
/* 109 */           Pair.of(RandomStroll.stroll(0.6F), 2), 
/* 110 */           Pair.of(InteractWith.of(EntityType.PIGLIN, 8, MemoryModuleType.INTERACTION_TARGET, 0.6F, 2), 2), 
/* 111 */           Pair.of(InteractWith.of(EntityType.PIGLIN_BRUTE, 8, MemoryModuleType.INTERACTION_TARGET, 0.6F, 2), 2), 
/* 112 */           Pair.of(StrollToPoi.create(MemoryModuleType.HOME, 0.6F, 2, 100), 2), 
/* 113 */           Pair.of(StrollAroundPoi.create(MemoryModuleType.HOME, 0.6F, 5), 2), 
...
/*     */ 
/*     */     
/* 123 */     Activity oldActivity = brain.getActiveNonCoreActivity().orElse(null);
/*     */ 
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 132 */     Activity newActivity = brain.getActiveNonCoreActivity().orElse(null);
...
/* 143 */     return findNearestValidAttackTarget(level, body)
...
/* 149 */     Optional<LivingEntity> angryAt = BehaviorUtils.getLivingEntityFromUUIDMemory((LivingEntity)body, MemoryModuleType.ANGRY_AT);
/* 150 */     if (angryAt.isPresent() && Sensor.isEntityAttackableIgnoringLineOfSight(level, (LivingEntity)body, angryAt.get())) {
/* 151 */       return angryAt;
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/piglin/PiglinBruteAi.class
