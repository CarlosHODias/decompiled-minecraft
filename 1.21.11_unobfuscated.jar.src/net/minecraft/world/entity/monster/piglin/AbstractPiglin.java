...
/*  49 */     getEntityData().set(DATA_IMMUNE_TO_ZOMBIFICATION, isImmuneToZombification);
/*     */   }
/*     */   
/*     */   protected boolean isImmuneToZombification() {
/*  53 */     return (Boolean)getEntityData().get(DATA_IMMUNE_TO_ZOMBIFICATION);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void defineSynchedData(SynchedEntityData.Builder entityData) {
/*  58 */     super.defineSynchedData(entityData);
/*  59 */     entityData.define(DATA_IMMUNE_TO_ZOMBIFICATION, false);
/*     */   }
/*     */ 
/*     */   
...
/*  98 */     this.timeInOverworld = timeInOverworld;
/*     */   }
/*     */   
/*     */   public boolean isConverting() {
/* 102 */     return (!isImmuneToZombification() && !isNoAi() && (Boolean)level().environmentAttributes().getValue(EnvironmentAttributes.PIGLINS_ZOMBIFY, position()));
/*     */   }
/*     */   
/*     */   protected void finishConversion(ServerLevel level) {
/* 106 */     convertTo(EntityType.ZOMBIFIED_PIGLIN, 
/*     */         
/* 108 */         ConversionParams.single((Mob)this, true, true), zombified -> zombified.addEffect(new MobEffectInstance(MobEffects.NAUSEA, 200, 0)));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/piglin/AbstractPiglin.class
