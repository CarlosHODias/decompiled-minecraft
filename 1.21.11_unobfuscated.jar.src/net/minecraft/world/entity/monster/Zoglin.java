...
/*  98 */     super((EntityType)type, level);
/*  99 */     this.xpReward = 5;
/*     */   }
/*     */ 
/*     */   
...
/* 121 */     brain.addActivity(Activity.CORE, 0, ImmutableList.of(new LookAtTargetSink(45, 90), new MoveToTargetSink()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 132 */               Pair.of(RandomStroll.stroll(0.4F), 2), 
/* 133 */               Pair.of(SetWalkTargetFromLookTarget.create(0.4F, 3), 2), 
/* 134 */               Pair.of(new DoNothing(30, 60), 1)))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   private static void initFightActivity(Brain<Zoglin> brain) {
/* 140 */     brain.addActivityAndRemoveMemoryWhenStopped(Activity.FIGHT, 10, ImmutableList.of(
...
/* 149 */     return ((NearestVisibleLivingEntities)getBrain().getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES).orElse(NearestVisibleLivingEntities.empty())).findClosest(target -> isTargetable(level, level));
/*     */   }
/*     */   
/*     */   private boolean isTargetable(ServerLevel level, LivingEntity livingEntity) {
/* 153 */     EntityType<?> type = livingEntity.getType();
/* 154 */     return (type != EntityType.ZOGLIN && type != EntityType.CREEPER && Sensor.isEntityAttackable(level, (LivingEntity)this, livingEntity));
/*     */   }
/*     */ 
/*     */   
/*     */   protected void defineSynchedData(SynchedEntityData.Builder entityData) {
/* 159 */     super.defineSynchedData(entityData);
/* 160 */     entityData.define(DATA_BABY_ID, false);
/*     */   }
/*     */ 
/*     */   
...
/* 199 */     level.broadcastEntityEvent((Entity)this, (byte)4);
/*     */     
/* 201 */     makeSound(SoundEvents.ZOGLIN_ATTACK);
/* 202 */     return HoglinBase.hurtAndThrowTarget(level, (LivingEntity)this, entity);
/*     */   }
/*     */ 
/*     */   
...
/* 212 */     if (!isBaby()) {
/* 213 */       HoglinBase.throwTarget((LivingEntity)this, defender);
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/* 223 */     if (canAttack(attacker) && !BehaviorUtils.isOtherTargetMuchFurtherAwayThanCurrentAttackTarget((LivingEntity)this, attacker, 4.0D)) {
...
/* 241 */     Activity oldActivity = this.brain.getActiveNonCoreActivity().orElse(null);
/*     */ 
/*     */     
/* 244 */     this.brain.setActiveActivityToFirstValid((List)ImmutableList.of(Activity.FIGHT, Activity.IDLE));
/*     */     
/* 246 */     Activity newActivity = this.brain.getActiveNonCoreActivity().orElse(null);
...
/* 260 */     getBrain().tick(level, (LivingEntity)this);
/* 261 */     profiler.pop();
/*     */     
/* 263 */     updateActivity();
/*     */   }
...
/* 268 */     getEntityData().set(DATA_BABY_ID, baby);
...
/* 276 */     return (Boolean)getEntityData().get(DATA_BABY_ID);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/Zoglin.class
