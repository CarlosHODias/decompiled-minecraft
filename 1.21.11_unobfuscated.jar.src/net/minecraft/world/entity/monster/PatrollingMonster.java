...
/*     */     
/*  60 */     this.patrolTarget = input.read("patrol_target", BlockPos.CODEC).orElse(null);
/*     */     
...
/*     */     }
/*     */     
/*  97 */     return checkAnyLightMonsterSpawnRules((EntityType)type, level, spawnReason, pos, random);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean removeWhenFarAway(double distSqr) {
/* 102 */     return (!this.patrolling || distSqr > 16384.0D);
/*     */   }
/*     */   
...
/* 182 */         } else if (!patrolLeader || !this.mob.getPatrolTarget().closerToCenterThan((Position)this.mob.position(), 10.0D)) {
/* 183 */           Vec3 longDistanceTarget = Vec3.atBottomCenterOf((Vec3i)this.mob.getPatrolTarget());
/*     */ 
/*     */           
...
/* 192 */           BlockPos pathTarget = BlockPos.containing((Position)moveTarget);
...
/* 211 */       return this.mob.level().getEntitiesOfClass(PatrollingMonster.class, this.mob.getBoundingBox().inflate(16.0D), mob -> (mob.canJoinPatrol() && !mob.is((Entity)this.mob)));
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/PatrollingMonster.class
