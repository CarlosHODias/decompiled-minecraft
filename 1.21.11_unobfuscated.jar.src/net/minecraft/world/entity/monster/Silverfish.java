...
/*  39 */     super((EntityType)type, level);
/*     */   }
/*     */ 
/*     */   
...
/* 125 */     if (!checkAnyLightMonsterSpawnRules((EntityType)type, level, spawnReason, pos, random)) {
/* 126 */       return false;
/*     */     }
/*     */     
...
/* 142 */       this.silverfish = silverfish;
/*     */     }
/*     */     
...
/*     */ 
/*     */         
/* 167 */         for (int yOff = 0; yOff <= 5 && yOff >= -5; yOff = ((yOff <= 0) ? 1 : 0) - yOff) {
/* 168 */           for (int xOff = 0; xOff <= 10 && xOff >= -10; xOff = ((xOff <= 0) ? 1 : 0) - xOff) {
/* 169 */             for (int zOff = 0; zOff <= 10 && zOff >= -10; zOff = ((zOff <= 0) ? 1 : 0) - zOff) {
...
/* 175 */                 if ((Boolean)getServerLevel(level).getGameRules().get(GameRules.MOB_GRIEFING)) {
/* 176 */                   level.destroyBlock(testPos, true, (Entity)this.silverfish);
/*     */                 } else {
...
/* 211 */       if ((Boolean)getServerLevel((Entity)this.mob).getGameRules().get(GameRules.MOB_GRIEFING) && random.nextInt(reducedTickDelay(10)) == 0) {
...
/* 243 */       BlockState blockState = level.getBlockState(pos);
/*     */       
/* 245 */       if (InfestedBlock.isCompatibleHostBlock(blockState)) {
/* 246 */         level.setBlock(pos, InfestedBlock.infestedStateByHost(blockState), 3);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/Silverfish.class
