...
/* 113 */     this.timeInOverworld = timeInOverworld;
/*     */   }
/*     */ 
/*     */   
...
/* 140 */     return HoglinBase.hurtAndThrowTarget(level, (LivingEntity)this, livingEntity);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void blockedByItem(LivingEntity defender) {
/* 145 */     if (isAdult()) {
/* 146 */       HoglinBase.throwTarget((LivingEntity)this, defender);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 166 */     return HoglinAi.makeBrain(brainProvider().makeBrain(input));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 179 */     getBrain().tick(level, (LivingEntity)this);
/* 180 */     profiler.pop();
/*     */     
...
/* 216 */     return !level.getBlockState(pos.below()).is(Blocks.NETHER_WART_BLOCK);
/*     */   }
/*     */ 
/*     */   
...
/* 282 */     convertTo(EntityType.ZOGLIN, ConversionParams.single((Mob)this, true, false), zoglin -> zoglin.addEffect(new MobEffectInstance(MobEffects.NAUSEA, 200, 0)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 289 */     return itemStack.is(ItemTags.HOGLIN_FOOD);
/*     */   }
/*     */   
...
/* 299 */     entityData.define(DATA_IMMUNE_TO_ZOMBIFICATION, false);
/*     */   }
/*     */ 
/*     */   
...
/* 319 */     getEntityData().set(DATA_IMMUNE_TO_ZOMBIFICATION, isImmuneToZombification);
/*     */   }
/*     */   
/*     */   private boolean isImmuneToZombification() {
/* 323 */     return (Boolean)getEntityData().get(DATA_IMMUNE_TO_ZOMBIFICATION);
/*     */   }
/*     */   
/*     */   public boolean isConverting() {
/* 327 */     return (!isImmuneToZombification() && !isNoAi() && (Boolean)level().environmentAttributes().getValue(EnvironmentAttributes.PIGLINS_ZOMBIFY, position()));
/*     */   }
/*     */   
/*     */   private void setCannotBeHunted(boolean cannotBeHunted) {
/* 331 */     this.cannotBeHunted = cannotBeHunted;
/*     */   }
/*     */   
...
/* 340 */     Hoglin offspring = (Hoglin)EntityType.HOGLIN.create((Level)level, EntitySpawnReason.BREEDING);
/* 341 */     if (offspring != null) {
/* 342 */       offspring.setPersistenceRequired();
/*     */     }
/* 344 */     return (AgeableMob)offspring;
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/hoglin/Hoglin.class
