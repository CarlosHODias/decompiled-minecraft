...
/*    */     float actualDamage;
/* 19 */     float attackDamage = (float)body.getAttributeValue(Attributes.ATTACK_DAMAGE);
...
/* 28 */     if (wasHurt) {
/* 29 */       EnchantmentHelper.doPostAttackEffects(level, (Entity)target, damageSource);
/* 30 */       if (!body.isBaby()) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/hoglin/HoglinBase.class
