...
/*     */   
/*     */   static {
/*  53 */     DOOR_BREAKING_PREDICATE = (d -> (d == Difficulty.NORMAL || d == Difficulty.HARD));
/*     */   }
/*     */   private static final Predicate<Difficulty> DOOR_BREAKING_PREDICATE; private static final boolean DEFAULT_JOHNNY = false;
/*     */   private boolean isJohnny = false;
/*     */   
/*     */   public Vindicator(EntityType<? extends Vindicator> type, Level level) {
/*  59 */     super((EntityType)type, level);
/*     */   }
/*     */ 
/*     */   
...
/*  84 */     if (!isNoAi() && net.minecraft.world.entity.ai.util.GoalUtils.hasGroundPathNavigation((Mob)this)) {
...
/* 175 */     ItemStack axe = new ItemStack((ItemLike)Items.IRON_AXE);
/* 176 */     Raid raid = getCurrentRaid();
/*     */     
/* 178 */     boolean shouldEnchant = (this.random.nextFloat() <= raid.getEnchantOdds());
/* 179 */     if (shouldEnchant) {
/* 180 */       ResourceKey<EnchantmentProvider> provider = (wave > raid.getNumGroups(Difficulty.NORMAL)) ? 
/* 181 */         VanillaEnchantmentProviders.RAID_VINDICATOR_POST_WAVE_5 : 
/* 182 */         VanillaEnchantmentProviders.RAID_VINDICATOR;
...
/* 216 */       super((Mob)mob, LivingEntity.class, 0, true, true, (target, level) -> target.attackable());
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean canUse() {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/illager/Vindicator.class
