...
/*     */     
/*  39 */     entityData.define(DATA_SPELL_CASTING_ID, (byte)0);
/*     */   }
/*     */ 
/*     */   
...
/*  68 */       return ((Byte)this.entityData.get(DATA_SPELL_CASTING_ID) > 0);
/*     */     }
...
/*  75 */     this.entityData.set(DATA_SPELL_CASTING_ID, (byte)spell.id);
/*     */   }
/*     */   
...
/*     */     }
/*  82 */     return IllagerSpell.byId((Byte)this.entityData.get(DATA_SPELL_CASTING_ID));
/*     */   }
/*     */ 
/*     */   
...
/* 111 */       level().addParticle((ParticleOptions)ColorParticleOption.create(ParticleTypes.ENTITY_EFFECT, red, green, blue), getX() + cos * handDistance, getY() + handHeight, getZ() + sin * handDistance, 0.0D, 0.0D, 0.0D);
/* 112 */       level().addParticle((ParticleOptions)ColorParticleOption.create(ParticleTypes.ENTITY_EFFECT, red, green, blue), getX() - cos * handDistance, getY() + handHeight, getZ() - sin * handDistance, 0.0D, 0.0D, 0.0D);
/*     */     } 
/*     */   }
/*     */   
/*     */   protected int getSpellCastingTime() {
/* 117 */     return this.spellCastingTickCount;
/*     */   }
/*     */   
...
/* 124 */       setFlags(EnumSet.of(Goal.Flag.MOVE, Goal.Flag.LOOK));
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean canUse() {
/* 129 */       return (SpellcasterIllager.this.getSpellCastingTime() > 0);
/*     */     }
/*     */ 
/*     */     
/*     */     public void start() {
...
/* 147 */         SpellcasterIllager.this.getLookControl().setLookAt((Entity)SpellcasterIllager.this.getTarget(), SpellcasterIllager.this.getMaxHeadYRot(), SpellcasterIllager.this.getMaxHeadXRot()); 
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*     */     static {
/* 223 */       BY_ID = ByIdMap.continuous(e -> e.id, (Object[])values(), ByIdMap.OutOfBoundsStrategy.ZERO);
/*     */     }
/*     */     
...
/* 234 */       return BY_ID.apply(id);
/*     */     }
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/illager/SpellcasterIllager.class
