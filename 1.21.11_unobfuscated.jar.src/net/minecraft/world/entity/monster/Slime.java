...
/*     */ 
/*     */     
/*  84 */     this.targetSelector.addGoal(1, (Goal)new NearestAttackableTargetGoal(this, Player.class, 10, true, false, (target, level) -> (Math.abs(target.getY() - getY()) <= 4.0D)));
...
/*     */   
/*     */   public int getSize() {
/* 118 */     return (Integer)this.entityData.get(ID_SIZE);
/*     */   }
/*     */ 
/*     */   
...
/*     */               xd.setSize(halfSize, true);
/*     */               xd.snapTo(getX() + halfSize, getY() + 0.5D, getZ() + xd, this.random.nextFloat() * 360.0F, 0.0F);
/*     */             });
/*     */       } 
/*     */     } 
...
/* 234 */     if (entity instanceof IronGolem && isDealsDamage()) {
...
/* 242 */       dealDamage((LivingEntity)player);
/*     */     }
/*     */   }
/*     */   
...
/* 248 */       if (isAlive() && 
/* 249 */         isWithinMeleeAttackRange(target) && hasLineOfSight((Entity)target)) {
/* 250 */         DamageSource damageSource = damageSources().mobAttack((LivingEntity)this);
/* 251 */         if (target.hurtServer(serverLevel, damageSource, getAttackDamage())) {
/* 252 */           playSound(SoundEvents.SLIME_ATTACK, 1.0F, (this.random.nextFloat() - this.random.nextFloat()) * 0.2F + 1.0F);
/* 253 */           EnchantmentHelper.doPostAttackEffects(serverLevel, (Entity)target, damageSource);
/*     */         } 
/*     */       }  }
/*     */   
/*     */   }
...
/* 262 */     return new Vec3(0.0D, dimensions.height() - 0.015625D * getSize() * scale, 0.0D);
/*     */   }
/*     */   
...
/* 308 */         float surfaceSlimeSpawnChance = (Float)level.environmentAttributes().getValue(EnvironmentAttributes.SURFACE_SLIME_SPAWN_CHANCE, pos);
...
/* 428 */     return super.getDefaultDimensions(pose).scale(getSize());
/*     */   }
/*     */   
...
/* 488 */       if (target != null) {
/* 489 */         this.slime.lookAt((Entity)target, 10.0F, 10.0F);
/*     */       }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/Slime.class
