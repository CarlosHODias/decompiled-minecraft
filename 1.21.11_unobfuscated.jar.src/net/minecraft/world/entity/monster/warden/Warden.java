...
/* 135 */     this.dynamicGameEventListener = new DynamicGameEventListener((GameEventListener)new VibrationSystem.Listener(this));
/*     */     
/* 137 */     this.xpReward = 5;
...
/* 150 */     return (Packet<ClientGamePacketListener>)new ClientboundAddEntityPacket((Entity)this, serverEntity, hasPose(Pose.EMERGING) ? 1 : 0);
/*     */   }
/*     */ 
/*     */   
...
/* 163 */     return (super.checkSpawnObstruction(level) && level.noCollision((Entity)this, getType().getDimensions().makeBoundingBox(position())));
/*     */   }
/*     */ 
/*     */   
...
/* 180 */     return (hasPose(Pose.DIGGING) || hasPose(Pose.EMERGING));
/*     */   }
/*     */ 
/*     */   
...
/* 196 */     return this.moveDist + 0.55F;
/*     */   }
/*     */   
...
/* 231 */     return SoundEvents.WARDEN_HURT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/* 236 */     return SoundEvents.WARDEN_DEATH;
/*     */   }
/*     */ 
/*     */   
/*     */   protected void playStepSound(BlockPos pos, BlockState blockState) {
/* 241 */     playSound(SoundEvents.WARDEN_STEP, 10.0F, 1.0F);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean doHurtTarget(ServerLevel level, Entity target) {
/* 246 */     level.broadcastEntityEvent((Entity)this, (byte)4);
/* 247 */     playSound(SoundEvents.WARDEN_ATTACK_IMPACT, 10.0F, getVoicePitch());
/*     */     
/* 249 */     SonicBoom.setCooldown((LivingEntity)this, 40);
/*     */     
...
/*     */     
/* 258 */     entityData.define(CLIENT_ANGER_LEVEL, 0);
/*     */   }
/*     */   
/*     */   public int getClientAngerLevel() {
/* 262 */     return (Integer)this.entityData.get(CLIENT_ANGER_LEVEL);
/*     */   }
/*     */   
/*     */   private void syncClientAngerLevel() {
/* 266 */     this.entityData.set(CLIENT_ANGER_LEVEL, getActiveAnger());
/*     */   }
/*     */ 
/*     */   
/*     */   public void tick() {
/* 271 */     Level level = level(); if (level instanceof ServerLevel) { ServerLevel serverLevel = (ServerLevel)level;
/* 272 */       VibrationSystem.Ticker.tick((Level)serverLevel, this.vibrationData, this.vibrationUser);
/*     */       
/* 274 */       if (isPersistenceRequired() || requiresCustomPersistence()) {
/* 275 */         WardenAi.setDigCooldown((LivingEntity)this);
/*     */       } }
/*     */ 
/*     */     
/* 279 */     super.tick();
...
/* 312 */     getBrain().tick(level, (LivingEntity)this);
/* 313 */     profiler.pop();
/*     */     
/* 315 */     super.customServerAiStep(level);
/*     */     
/* 317 */     if ((this.tickCount + getId()) % 120 == 0) {
/* 318 */       applyDarknessAround(level, position(), (Entity)this, 20);
/*     */     }
/*     */     
...
/* 350 */     return Mth.lerp(a, this.tendrilAnimationO, this.tendrilAnimation) / 10.0F;
/*     */   }
/*     */   
/*     */   public float getHeartAnimation(float a) {
/* 354 */     return Mth.lerp(a, this.heartAnimationO, this.heartAnimation) / 10.0F;
/*     */   }
/*     */   
...
/*     */           
/* 368 */           level().addParticle((ParticleOptions)new BlockParticleOption(ParticleTypes.BLOCK, stateBelow), xx, yy, zz, 0.0D, 0.0D, 0.0D);
/*     */         } 
/*     */       }
/*     */     } 
/*     */   }
...
/* 390 */     return isDiggingOrEmerging();
/*     */   }
/*     */ 
/*     */   
/*     */   protected Brain<?> makeBrain(Dynamic<?> input) {
/* 395 */     return WardenAi.makeBrain(this, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public Brain<Warden> getBrain() {
/* 401 */     return super.getBrain();
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 442 */     this
/* 443 */       .angerManagement = input.read("anger", AngerManagement.codec(this::canTargetEntity)).orElseGet(() -> new AngerManagement(this::canTargetEntity, Collections.emptyList()));
/* 444 */     syncClientAngerLevel();
/*     */     
/* 446 */     this.vibrationData = input.read("listener", VibrationSystem.Data.CODEC).orElseGet(net.minecraft.world.level.gameevent.vibrations.VibrationSystem.Data::new);
/*     */   }
/*     */   
...
/* 456 */     return AngerLevel.byAnger(getActiveAnger());
/*     */   }
/*     */   
/*     */   private int getActiveAnger() {
/* 460 */     return this.angerManagement.getActiveAnger((Entity)getTarget());
/*     */   }
/*     */   
/*     */   public void clearAnger(Entity entity) {
/* 464 */     this.angerManagement.clearAnger(entity);
/*     */   }
/*     */   
/*     */   public void increaseAngerAt(Entity entity) {
/* 468 */     increaseAngerAt(entity, 35, true);
/*     */   }
/*     */   
/*     */   @VisibleForTesting
/*     */   public void increaseAngerAt(Entity entity, int amount, boolean playSound) {
/* 473 */     if (!isNoAi() && canTargetEntity(entity)) {
/* 474 */       WardenAi.setDigCooldown((LivingEntity)this);
/*     */       
...
/* 531 */         LivingEntity livingAttacker = (LivingEntity)attacker;
/* 532 */         if (source.isDirect() || closerThan((Entity)livingAttacker, 5.0D))
/*     */         {
...
/* 544 */     SonicBoom.setCooldown((LivingEntity)this, 200);
/*     */   }
/*     */ 
/*     */   
...
/* 560 */     return (!isDiggingOrEmerging() && super.isPushable());
/*     */   }
/*     */ 
/*     */   
...
/* 576 */     return this.angerManagement;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 584 */     return (PathNavigation)new GroundPathNavigation(this, (Mob)this, level)
/*     */       {
/*     */         protected PathFinder createPathFinder(int maxVisitedNodes) {
/* 587 */           this.nodeEvaluator = (NodeEvaluator)new WalkNodeEvaluator();
...
/* 603 */     return this.vibrationData;
/*     */   }
/*     */ 
/*     */   
/*     */   public VibrationSystem.User getVibrationUser() {
/* 608 */     return this.vibrationUser;
/*     */   }
/*     */   
/*     */   private class VibrationUser implements VibrationSystem.User {
/*     */     private static final int GAME_EVENT_LISTENER_RANGE = 16;
/* 613 */     private final PositionSource positionSource = (PositionSource)new EntityPositionSource((Entity)Warden.this, Warden.this.getEyeHeight());
/*     */ 
/*     */     
...
/* 622 */       return this.positionSource;
/*     */     }
/*     */ 
/*     */     
/*     */     public TagKey<GameEvent> getListenableEvents() {
/* 627 */       return GameEventTags.WARDEN_CAN_LISTEN;
/*     */     }
/*     */ 
/*     */     
...
/* 637 */       if (Warden.this.isNoAi() || 
/* 638 */         Warden.this.isDeadOrDying() || 
/* 639 */         Warden.this.getBrain().hasMemoryValue(MemoryModuleType.VIBRATION_COOLDOWN) || 
/* 640 */         Warden.this.isDiggingOrEmerging() || 
/* 641 */         !level.getWorldBorder().isWithinBounds(pos))
/*     */       {
/* 643 */         return false;
/*     */       }
/*     */       
/* 646 */       Entity entity = context.sourceEntity(); if (entity instanceof LivingEntity) { LivingEntity livingEntity = (LivingEntity)entity; if (Warden.this.canTargetEntity((Entity)livingEntity)); return false; }
/*     */     
/*     */     }
/*     */     
...
/*     */       
/* 657 */       level.broadcastEntityEvent((Entity)Warden.this, (byte)61);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/warden/Warden.class
