...
/*  61 */     super((EntityType)type, level);
/*     */     
...
/*  72 */     return (this.tickCount % TICKS_PER_FLAP == 0);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 104 */     this.goalSelector.addGoal(9, (Goal)new LookAtPlayerGoal((Mob)this, Player.class, 3.0F, 1.0F));
/* 105 */     this.goalSelector.addGoal(10, (Goal)new LookAtPlayerGoal((Mob)this, Mob.class, 8.0F));
/*     */     
/* 107 */     this.targetSelector.addGoal(1, (Goal)new HurtByTargetGoal(this, new Class<?>[] { Raider.class }).setAlertOthers(new Class<?>[0]));
/* 108 */     this.targetSelector.addGoal(2, (Goal)new VexCopyOwnerTargetGoal(this));
/* 109 */     this.targetSelector.addGoal(3, (Goal)new NearestAttackableTargetGoal((Mob)this, Player.class, true));
/*     */   }
/*     */   
...
/*     */     
/* 122 */     entityData.define(DATA_FLAGS_ID, (byte)0);
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 129 */     this.boundOrigin = input.read("bound_pos", BlockPos.CODEC).orElse(null);
/*     */     
/* 131 */     input.getInt("life_ticks").ifPresentOrElse(this::setLimitedLife, () -> this.hasLimitedLife = false);
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/*     */   
/*     */   public Mob getOwner() {
/* 160 */     return (Mob)EntityReference.get(this.owner, level(), Mob.class);
/*     */   }
/*     */   
/*     */   public BlockPos getBoundOrigin() {
/* 164 */     return this.boundOrigin;
/*     */   }
/*     */   
/*     */   public void setBoundOrigin(BlockPos boundOrigin) {
/* 168 */     this.boundOrigin = boundOrigin;
/*     */   }
/*     */   
/*     */   private boolean getVexFlag(int flag) {
/* 172 */     int flags = (Byte)this.entityData.get(DATA_FLAGS_ID);
/* 173 */     return ((flags & flag) != 0);
/*     */   }
/*     */   
/*     */   private void setVexFlag(int flag, boolean value) {
/* 177 */     int flags = (Byte)this.entityData.get(DATA_FLAGS_ID);
/* 178 */     if (value) {
/* 179 */       flags |= flag;
/*     */     } else {
/* 181 */       flags &= flag ^ 0xFFFFFFFF;
/*     */     } 
/* 183 */     this.entityData.set(DATA_FLAGS_ID, (byte)(flags & 0xFF));
/*     */   }
/*     */   
/*     */   public boolean isCharging() {
/* 187 */     return getVexFlag(1);
/*     */   }
/*     */   
/*     */   public void setIsCharging(boolean value) {
/* 191 */     setVexFlag(1, value);
/*     */   }
/*     */   
/*     */   public void setOwner(Mob owner) {
/* 195 */     this.owner = EntityReference.of((UniquelyIdentifyable)owner);
/*     */   }
/*     */   
...
/* 205 */     return SoundEvents.VEX_AMBIENT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/* 210 */     return SoundEvents.VEX_DEATH;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getHurtSound(DamageSource source) {
/* 215 */     return SoundEvents.VEX_HURT;
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */       
/* 235 */       Vec3 delta = new Vec3(this.wantedX - 
/* 236 */           Vex.this.getX(), this.wantedY - 
/* 237 */           Vex.this.getY(), this.wantedZ - 
/* 238 */           Vex.this.getZ());
/*     */ 
/*     */       
...
/* 265 */       setFlags(EnumSet.of(Goal.Flag.MOVE));
/*     */     }
/*     */ 
/*     */     
...
/* 272 */         return (Vex.this.distanceToSqr((Entity)target) > 4.0D);
/*     */       }
/* 274 */       return false;
/*     */     }
/*     */ 
...
/* 279 */       return (Vex.this.getMoveControl().hasWanted() && Vex.this.isCharging() && Vex.this.getTarget() != null && Vex.this.getTarget().isAlive());
/*     */     }
/*     */ 
/*     */     
/*     */     public void start() {
...
/*     */     
/*     */     public void stop() {
/* 295 */       Vex.this.setIsCharging(false);
/*     */     }
/*     */ 
/*     */     
...
/* 310 */         Vex.this.doHurtTarget(getServerLevel(Vex.this.level()), (Entity)attackTarget);
/* 311 */         Vex.this.setIsCharging(false);
/*     */       } else {
/* 313 */         double distance = Vex.this.distanceToSqr((Entity)attackTarget);
...
/* 324 */       setFlags(EnumSet.of(Goal.Flag.MOVE));
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean canUse() {
/* 329 */       return (!Vex.this.getMoveControl().hasWanted() && Vex.this.random.nextInt(reducedTickDelay(7)) == 0);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean canContinueToUse() {
...
/* 369 */     setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)Items.IRON_SWORD));
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/Vex.class
