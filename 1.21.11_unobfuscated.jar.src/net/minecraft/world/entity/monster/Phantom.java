...
/*  80 */     return new PhantomBodyRotationControl(this);
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/*  96 */     entityData.define(ID_SIZE, 0);
/*     */   }
/*     */   
/*     */   public void setPhantomSize(int size) {
/* 100 */     this.entityData.set(ID_SIZE, Mth.clamp(size, 0, 64));
/*     */   }
/*     */   
...
/* 109 */     return (Integer)this.entityData.get(ID_SIZE);
/*     */   }
/*     */ 
/*     */   
...
/* 141 */       level().addParticle((ParticleOptions)ParticleTypes.MYCELIUM, getX() + c, getY() + h, getZ() + s, 0.0D, 0.0D, 0.0D);
/* 142 */       level().addParticle((ParticleOptions)ParticleTypes.MYCELIUM, getX() - c, getY() + h, getZ() - s, 0.0D, 0.0D, 0.0D);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 173 */     this.anchorPoint = input.read("anchor_pos", BlockPos.CODEC).orElse(null);
...
/* 192 */     return SoundSource.HOSTILE;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getAmbientSound() {
/* 197 */     return SoundEvents.PHANTOM_AMBIENT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getHurtSound(DamageSource source) {
/* 202 */     return SoundEvents.PHANTOM_HURT;
/*     */   }
/*     */ 
/*     */   
/*     */   protected SoundEvent getDeathSound() {
/* 207 */     return SoundEvents.PHANTOM_DEATH;
/*     */   }
/*     */ 
/*     */   
...
/* 229 */     return targetConditions.test(level, (LivingEntity)this, target);
/*     */   }
/*     */   
...
/*     */ 
/*     */       
/* 248 */       double tdx = Phantom.this.moveTargetPoint.x - Phantom.this.getX();
/* 249 */       double tdy = Phantom.this.moveTargetPoint.y - Phantom.this.getY();
/* 250 */       double tdz = Phantom.this.moveTargetPoint.z - Phantom.this.getZ();
...
/* 317 */       return (Phantom.this.moveTargetPoint.distanceToSqr(Phantom.this.getX(), Phantom.this.getY(), Phantom.this.getZ()) < 4.0D);
/*     */     }
/*     */   }
/*     */   
...
/* 329 */       return (Phantom.this.getTarget() == null || Phantom.this.attackPhase == Phantom.AttackPhase.CIRCLE);
/*     */     }
/*     */ 
/*     */     
/*     */     public void start() {
...
/*     */       }
/*     */       
/* 360 */       if (Phantom.this.moveTargetPoint.y < Phantom.this.getY() && !Phantom.this.level().isEmptyBlock(Phantom.this.blockPosition().below(1))) {
/* 361 */         this.height = Math.max(1.0F, this.height);
/* 362 */         selectNext();
/*     */       } 
/*     */       
/* 365 */       if (Phantom.this.moveTargetPoint.y > Phantom.this.getY() && !Phantom.this.level().isEmptyBlock(Phantom.this.blockPosition().above(1))) {
...
/* 376 */       Phantom.this.moveTargetPoint = Vec3.atLowerCornerOf((Vec3i)Phantom.this.anchorPoint).add((this.distance * Mth.cos(this.angle)), (-4.0F + this.height), (this.distance * Mth.sin(this.angle)));
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*     */     public boolean canUse() {
/* 388 */       return (Phantom.this.getTarget() != null && Phantom.this.attackPhase == Phantom.AttackPhase.SWOOP);
/*     */     }
/*     */ 
/*     */     
...
/* 439 */         Phantom.this.doHurtTarget(getServerLevel(Phantom.this.level()), (Entity)target);
...
/* 503 */       this.attackTargeting = TargetingConditions.forCombat().range(64.0D);
/*     */       
/* 505 */       this.nextScanTick = reducedTickDelay(20);
/*     */     }
...
/* 516 */       List<Player> players = level.getNearbyPlayers(this.attackTargeting, (LivingEntity)Phantom.this, Phantom.this.getBoundingBox().inflate(16.0D, 64.0D, 16.0D));
/* 517 */       if (!players.isEmpty()) {
/*     */         
/* 519 */         players.sort(Comparator.comparing(Entity::getY).reversed());
/* 520 */         for (Player player : players) {
/* 521 */           if (Phantom.this.canAttack(level, (LivingEntity)player, TargetingConditions.DEFAULT)) {
/* 522 */             Phantom.this.setTarget((LivingEntity)player);
/* 523 */             return true;
/*     */           } 
/*     */         } 
/*     */       } 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/Phantom.class
