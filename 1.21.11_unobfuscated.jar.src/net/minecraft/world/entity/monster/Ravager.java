...
/*     */   
/*     */   static {
/*  51 */     ROAR_TARGET_WITH_GRIEFING = (entity -> (!(entity instanceof Ravager) && entity.isAlive()));
/*     */     
/*  53 */     ROAR_TARGET_WITHOUT_GRIEFING = (entity -> (ROAR_TARGET_WITH_GRIEFING.test(entity) && !entity.getType().equals(EntityType.ARMOR_STAND)));
/*     */     
/*  55 */     ROAR_TARGET_ON_CLIENT = (e -> (!(e instanceof Ravager) && e.isAlive() && e.isLocalInstanceAuthoritative()));
/*     */   }
...
/*  94 */     this.targetSelector.addGoal(4, (Goal)new NearestAttackableTargetGoal((Mob)this, AbstractVillager.class, true, (target, level) -> !target.isBaby()));
/*  95 */     this.targetSelector.addGoal(4, (Goal)new NearestAttackableTargetGoal((Mob)this, IronGolem.class, true));
/*     */   }
/*     */ 
/*     */   
/*     */   protected void updateControlFlags() {
/* 100 */     boolean noController = (!(getControllingPassenger() instanceof Mob) || getControllingPassenger().getType().is(EntityTypeTags.RAIDERS));
...
/* 164 */       if (this.horizontalCollision && (Boolean)serverLevel.getGameRules().get(GameRules.MOB_GRIEFING)) {
/*     */         boolean destroyedBlock = false;
/* 166 */         AABB bb = getBoundingBox().inflate(0.2D);
/* 167 */         for (BlockPos pos : (Iterable<BlockPos>)BlockPos.betweenClosed(Mth.floor(bb.minX), Mth.floor(bb.minY), Mth.floor(bb.minZ), Mth.floor(bb.maxX), Mth.floor(bb.maxY), Mth.floor(bb.maxZ))) {
...
/* 171 */             destroyedBlock = (serverLevel.destroyBlock(pos, true, (Entity)this) || destroyedBlock);
/*     */           }
/*     */         } 
/*     */         
...
/*     */       
/* 208 */       level().addParticle((ParticleOptions)ColorParticleOption.create(ParticleTypes.ENTITY_EFFECT, 0.49803922F, 0.5137255F, 0.57254905F), headX, headY, headZ, 0.0D, 0.0D, 0.0D);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/*     */         
/* 233 */         defender.push((Entity)this);
/*     */       } else {
/* 235 */         strongKnockback((Entity)defender);
/*     */       } 
...
/* 243 */         Predicate<Entity> targetSelector = (Boolean)serverLevel.getGameRules().get(GameRules.MOB_GRIEFING) ? ROAR_TARGET_WITH_GRIEFING : ROAR_TARGET_WITHOUT_GRIEFING;
...
/* 247 */             entity.hurtServer(serverLevel, damageSources().mobAttack((LivingEntity)this), 6.0F);
/*     */           }
/*     */           
/* 250 */           if (!(entity instanceof Player)) {
/* 251 */             strongKnockback((Entity)entity);
/*     */           }
/*     */         } 
/*     */         
...
/* 266 */       strongKnockback((Entity)entity);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 298 */       level().addParticle((ParticleOptions)ParticleTypes.POOF, center.x, center.y, center.z, velocityX, velocityY, velocityZ);
/*     */     } 
/*     */   }
/*     */   
...
/* 317 */     level.broadcastEntityEvent((Entity)this, (byte)4);
...
/* 345 */     return !level.containsAnyLiquid(getBoundingBox());
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/Ravager.class
