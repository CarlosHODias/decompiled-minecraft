...
/*  39 */   static final List<SensorType<? extends Sensor<? super Breeze>>> SENSOR_TYPES = (List<SensorType<? extends Sensor<? super Breeze>>>)ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.HURT_BY, SensorType.NEAREST_PLAYERS, SensorType.BREEZE_ATTACK_ENTITY_SENSOR);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  46 */   static final List<MemoryModuleType<?>> MEMORY_TYPES = (List<MemoryModuleType<?>>)ImmutableList.of(MemoryModuleType.LOOK_TARGET, MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES, MemoryModuleType.NEAREST_ATTACKABLE, MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryModuleType.ATTACK_TARGET, MemoryModuleType.WALK_TARGET, MemoryModuleType.BREEZE_JUMP_COOLDOWN, MemoryModuleType.BREEZE_JUMP_INHALING, MemoryModuleType.BREEZE_SHOOT, MemoryModuleType.BREEZE_SHOOT_CHARGING, MemoryModuleType.BREEZE_SHOOT_RECOVERING, MemoryModuleType.BREEZE_SHOOT_COOLDOWN, (Object[])new MemoryModuleType[] { MemoryModuleType.BREEZE_JUMP_TARGET, MemoryModuleType.BREEZE_LEAVING_WATER, MemoryModuleType.HURT_BY, MemoryModuleType.HURT_BY_ENTITY, MemoryModuleType.PATH });
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  79 */     brain.addActivity(Activity.CORE, 0, ImmutableList.of(new Swim(0.8F), new LookAtTargetSink(45, 90)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  87 */           Pair.of(0, StartAttacking.create((level, breeze) -> breeze.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE))), 
/*  88 */           Pair.of(1, StartAttacking.create((level, breeze) -> breeze.getHurtBy())), 
/*  89 */           Pair.of(2, new SlideToTargetSink(20, 40)), 
/*  90 */           Pair.of(3, new RunOne((List)ImmutableList.of(
/*  91 */                 Pair.of(new DoNothing(20, 100), 1), 
/*  92 */                 Pair.of(RandomStroll.stroll(0.6F), 2))))));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 100 */     Objects.requireNonNull(Sensor.wasEntityAttackableLastNTicks((LivingEntity)body, 100).negate()); brain.addActivityWithConditions(Activity.FIGHT, ImmutableList.of(Pair.of(0, StopAttackingIfTargetInvalid.create(Sensor.wasEntityAttackableLastNTicks((LivingEntity)body, 100).negate()::test)), 
/* 101 */           Pair.of(1, new Shoot()), 
/* 102 */           Pair.of(2, new LongJump()), 
/* 103 */           Pair.of(3, new ShootWhenStuck()), 
/* 104 */           Pair.of(4, new Slide())), 
/* 105 */         (Set)ImmutableSet.of(
...
/* 113 */     body.getBrain().setActiveActivityToFirstValid((List)ImmutableList.of(Activity.FIGHT, Activity.IDLE));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 123 */       super(minTimeout, maxTimeout);
/*     */     }
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/breeze/BreezeAi.class
