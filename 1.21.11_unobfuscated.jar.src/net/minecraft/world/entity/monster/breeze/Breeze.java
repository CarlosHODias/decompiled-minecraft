...
/*     */   static {
/*  72 */     PROJECTILE_DEFLECTION = ((projectile, entity, random) -> {
...
/*  86 */     return BreezeAi.makeBrain(this, brainProvider().makeBrain(input));
/*     */   }
/*     */ 
/*     */   
...
/* 166 */       level().addParticle((ParticleOptions)new BlockParticleOption(ParticleTypes.BLOCK, ground), centered.x, centered.y, centered.z, 0.0D, 0.0D, 0.0D);
/*     */     }
/*     */   }
/*     */   
...
/* 185 */       level().addParticle((ParticleOptions)new BlockParticleOption(ParticleTypes.BLOCK, ground), position.x, position.y, position.z, 0.0D, 0.0D, 0.0D);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 204 */     level().playLocalSound((Entity)this, SoundEvents.BREEZE_WHIRL, getSoundSource(), volume, pitch);
/*     */   }
/*     */ 
/*     */   
...
/* 252 */     getBrain().tick(level, (LivingEntity)this);
/*     */     
...
/* 263 */     return (targetType == EntityType.PLAYER || targetType == EntityType.IRON_GOLEM);
/*     */   }
/*     */ 
/*     */   
...
/* 283 */     return (source.getEntity() instanceof Breeze || super.isInvulnerableTo(level, source));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 314 */     registration.register(DebugSubscriptions.BREEZES, () -> new DebugBreezeInfo(getBrain().getMemory(MemoryModuleType.ATTACK_TARGET).map(Entity::getId), getBrain().getMemory(MemoryModuleType.BREEZE_JUMP_TARGET)));
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/breeze/Breeze.class
