...
/* 29 */       return false;
/*    */     }
/* 31 */     return (breeze.level().clip(new ClipContext(from, target, ClipContext.Block.COLLIDER, ClipContext.Fluid.NONE, (Entity)breeze)).getType() == HitResult.Type.MISS);
/*    */   }
/*    */   
/*    */   private static double getMaxLineOfSightTestRange(Breeze breeze) {
/* 35 */     return Math.max(50.0D, breeze.getAttributeValue(Attributes.FOLLOW_RANGE));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/monster/breeze/BreezeUtil.class
