...
/*  60 */     Data previous = DATA_BY_TYPE.put(type, new Data(heightmap, placementType, spawnPredicate));
/*  61 */     if (previous != null) {
...
/*  82 */     register(EntityType.CAMEL, SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, net.minecraft.world.entity.animal.camel.Camel::checkCamelSpawnRules);
...
/*  93 */     register(EntityType.GHAST, SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, net.minecraft.world.entity.monster.Ghast::checkGhastSpawnRules);
...
/*  96 */     register(EntityType.GLOW_SQUID, SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, net.minecraft.world.entity.animal.squid.GlowSquid::checkGlowSquidSpawnRules);
/*  97 */     register(EntityType.GOAT, SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, net.minecraft.world.entity.animal.goat.Goat::checkGoatSpawnRules);
...
/* 121 */     register(EntityType.STRAY, SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, net.minecraft.world.entity.monster.skeleton.Stray::checkStraySpawnRules);
...
/* 134 */     register(EntityType.ZOMBIFIED_PIGLIN, SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, net.minecraft.world.entity.monster.zombie.ZombifiedPiglin::checkZombifiedPiglinSpawnRules);
...
/* 155 */     Data data = DATA_BY_TYPE.get(type);
...
/* 160 */     return getPlacementType(type).isSpawnPositionOk(level, blockPos, type);
/*     */   }
/*     */   
/*     */   public static Heightmap.Types getHeightmapType(EntityType<?> type) {
/* 164 */     Data data = DATA_BY_TYPE.get(type);
...
/* 170 */     Data data = DATA_BY_TYPE.get(type);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/SpawnPlacements.class
