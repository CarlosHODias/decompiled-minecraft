...
/* 52 */     entityData.define(DATA_PLAYER_MODE_CUSTOMISATION, (byte)0);
/*    */   }
/*    */ 
/*    */   
...
/* 61 */     this.entityData.set(DATA_PLAYER_MAIN_HAND, mainArm);
/*    */   }
/*    */   
/*    */   public boolean isModelPartShown(PlayerModelPart part) {
/* 65 */     return (((Byte)getEntityData().get(DATA_PLAYER_MODE_CUSTOMISATION) & part.getMask()) == part.getMask());
/*    */   }
/*    */ 
/*    */   
/*    */   public EntityDimensions getDefaultDimensions(Pose pose) {
/* 70 */     return POSES.getOrDefault(pose, STANDING_DIMENSIONS);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/entity/Avatar.class
