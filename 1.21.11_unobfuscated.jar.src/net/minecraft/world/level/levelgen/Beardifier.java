...
/*     */   
/*     */   static {
/*  26 */     BEARD_KERNEL = (float[])Util.make(new float[13824], kernel -> {
...
/*  37 */       //   0	8	1	o	Ljava/lang/Object; } public Rigid(BoundingBox box, TerrainAdjustment terrainAdjustment, int groundLevelDelta) { this.box = box; this.terrainAdjustment = terrainAdjustment; this.groundLevelDelta = groundLevelDelta; }
...
/*     */     
/*  55 */     List<Rigid> rigids = new ArrayList<>();
/*  56 */     List<JigsawJunction> junctions = new ArrayList<>();
/*     */     
...
/*  63 */       for (StructurePiece piece : (Iterable<StructurePiece>)start.getPieces()) {
...
/*     */           } 
/*     */           
/*  75 */           for (JigsawJunction junction : (Iterable<JigsawJunction>)poolPiece.getJunctions()) {
...
/* 182 */     return Double.NEGATIVE_INFINITY;
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 218 */     return (xi >= 0 && xi < 24);
/*     */   }
/*     */ 
/*     */   
/*     */   private static double computeBeardContribution(int dx, int dy, int dz) {
/* 223 */     return computeBeardContribution(dx, dy + 0.5D, dz);
/*     */   }
/*     */   
/*     */   private static double computeBeardContribution(int dx, double dy, int dz) {
/* 227 */     double distanceSqr = Mth.lengthSquared(dx, dy, dz);
/* 228 */     double pieceWeight = Math.pow(Math.E, -distanceSqr / 16.0D);
/*     */     
/* 230 */     return pieceWeight;
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/Beardifier.class
