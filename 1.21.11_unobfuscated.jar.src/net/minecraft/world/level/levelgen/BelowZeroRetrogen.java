...
/*     */   static {
/*  30 */     BITSET_CODEC = Codec.LONG_STREAM.xmap(longStream -> BitSet.valueOf(longStream.toArray()), bitSet -> LongStream.of(bitSet.toLongArray()));
/*  31 */     NON_EMPTY_CHUNK_STATUS = BuiltInRegistries.CHUNK_STATUS.byNameCodec().comapFlatMap(status -> (status == ChunkStatus.EMPTY) ? DataResult.error(()) : DataResult.success(status), 
/*     */         
/*  33 */         java.util.function.Function.identity());
/*     */ 
/*     */     
/*  36 */     CODEC = RecordCodecBuilder.create(i -> i.group((App)NON_EMPTY_CHUNK_STATUS.fieldOf("target_status").forGetter(BelowZeroRetrogen::targetStatus), (App)BITSET_CODEC.lenientOptionalFieldOf("missing_bedrock").forGetter(())).apply((Applicative)i, BelowZeroRetrogen::new));
/*     */   }
/*     */   
...
/*  59 */     this.missingBedrock = missingBedrock.orElse(EMPTY);
/*     */   }
/*     */   
...
/*  94 */     return this.missingBedrock.get((z & 0xF) * 16 + (x & 0xF));
/*     */   }
/*     */ 
/*     */   
...
/*     */     }
/*     */     
/* 103 */     java.util.Objects.requireNonNull(RETAINED_RETROGEN_BIOMES); Predicate<ResourceKey<Biome>> retainedBiomes = RETAINED_RETROGEN_BIOMES::contains;
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/BelowZeroRetrogen.class
