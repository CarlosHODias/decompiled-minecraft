...
/*     */ {
/*     */   static Aquifer create(NoiseChunk noiseChunk, ChunkPos pos, NoiseRouter router, PositionalRandomFactory positionalRandomFactory, int minBlockY, int yBlockSize, FluidPicker fluidRule) {
/*  57 */     return new NoiseBasedAquifer(noiseChunk, pos, router, positionalRandomFactory, minBlockY, yBlockSize, fluidRule);
/*     */   }
/*     */   
...
/* 275 */             if (existingLocation != Long.MAX_VALUE) {
...
/* 343 */           Aquifer.FluidStatus fluidStatus = getAquiferStatus(closestIndex2);
/* 344 */           this.shouldScheduleFluidUpdate = !closestStatus1.equals(fluidStatus);
/*     */         } else {
...
/*     */ 
/*     */       
/* 372 */       MutableDouble barrierNoiseValue = new MutableDouble(Double.NaN);
...
/* 623 */       return preliminarySurfaceLevel + 8;
...
/*     */       double partiallyFloodedness, fullyFloodidness;
...
/*     */       } else {
/* 636 */         int distanceBelowSurface = lowestPreliminarySurface + 8 - y;
/*     */ 
/*     */ 
/*     */ 
/*     */         
/* 641 */         int floodednessMaxDepth = 64;
/* 642 */         double floodednessFactor = surfaceAtCenterIsUnderGlobalFluidLevel ? Mth.clampedMap(distanceBelowSurface, 0.0D, 64.0D, 1.0D, 0.0D) : 0.0D;
/*     */ 
/*     */ 
/*     */ 
/*     */         
...
/*     */     }
/*     */   } public static final class FluidStatus extends Record { private final int fluidLevel; private final BlockState fluidType; public final String toString() {
/*     */       // Byte code:
/*     */       //   0: aload_0
...
/* 743 */       return (blockY < this.fluidLevel) ? this.fluidType : Blocks.AIR.defaultBlockState();
/*     */     } }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/Aquifer.class
