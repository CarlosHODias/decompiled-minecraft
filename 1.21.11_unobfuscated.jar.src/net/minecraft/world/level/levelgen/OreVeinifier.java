...
/*     */         
/*     */         VeinType veinType = (oreVeininessNoiseValue > 0.0D) ? VeinType.COPPER : VeinType.IRON;
/*     */         
/*     */         double veininessRidged = Math.abs(oreVeininessNoiseValue);
/*     */         
/*     */         int distanceFromTop = veinType.maxY - posY, distanceFromBottom = posY - veinType.minY;
/*     */         
...
/*     */         
/*     */         double edgeRoundoff = Mth.clampedMap(distanceFromEdge, 0.0D, 20.0D, -0.2D, 0.0D);
/*     */         
/*     */         if (veininessRidged + edgeRoundoff < 0.4000000059604645D) {
/*     */           return defaultState;
/*     */         }
/*     */         
...
/*     */           return defaultState;
/*     */         }
/*     */         double richness = Mth.clampedMap(veininessRidged, 0.4000000059604645D, 0.6000000238418579D, 0.10000000149011612D, 0.30000001192092896D);
/*  77 */         return (positionalRandom.nextFloat() < richness && veinGap.compute(context) > -0.30000001192092896D) ? ((positionalRandom.nextFloat() < 0.02F) ? veinType.rawOreBlock : veinType.ore) : (SharedConstants.DEBUG_ORE_VEINS ? Blocks.OAK_BUTTON.defaultBlockState() : veinType.filler);
/*     */       };
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/OreVeinifier.class
