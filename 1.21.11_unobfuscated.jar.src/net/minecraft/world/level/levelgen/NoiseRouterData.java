...
/* 141 */     return ResourceKey.create(Registries.DENSITY_FUNCTION, Identifier.withDefaultNamespace(name));
/*     */   }
/*     */   
...
/*     */     
/* 154 */     DensityFunction shiftX = registerAndWrap(context, SHIFT_X, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftA((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.SHIFT)))));
/* 155 */     DensityFunction shiftZ = registerAndWrap(context, SHIFT_Z, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftB((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.SHIFT)))));
/*     */     
...
/*     */     
/* 161 */     Holder.Reference reference1 = context.register(CONTINENTS, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, (Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.CONTINENTALNESS))));
/* 162 */     Holder.Reference reference2 = context.register(EROSION, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, (Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.EROSION))));
/* 163 */     DensityFunction ridge = registerAndWrap(context, RIDGES, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, (Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.RIDGE))));
/* 164 */     context.register(RIDGES_FOLDED, peaksAndValleys(ridge));
/*     */     
/* 166 */     DensityFunction jaggedNoise = DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.JAGGED), 1500.0D, 0.0D);
/*     */     
/* 168 */     registerTerrainNoises(context, functions, jaggedNoise, (Holder<DensityFunction>)reference1, (Holder<DensityFunction>)reference2, OFFSET, FACTOR, JAGGEDNESS, DEPTH, SLOPED_CHEESE, false);
/*     */     
/* 170 */     Holder.Reference reference3 = context.register(CONTINENTS_LARGE, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, (Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.CONTINENTALNESS_LARGE))));
/* 171 */     Holder.Reference reference4 = context.register(EROSION_LARGE, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, (Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.EROSION_LARGE))));
/*     */     
/* 173 */     registerTerrainNoises(context, functions, jaggedNoise, (Holder<DensityFunction>)reference3, (Holder<DensityFunction>)reference4, OFFSET_LARGE, FACTOR_LARGE, JAGGEDNESS_LARGE, DEPTH_LARGE, SLOPED_CHEESE_LARGE, false);
/* 174 */     registerTerrainNoises(context, functions, jaggedNoise, (Holder<DensityFunction>)reference1, (Holder<DensityFunction>)reference2, OFFSET_AMPLIFIED, FACTOR_AMPLIFIED, JAGGEDNESS_AMPLIFIED, DEPTH_AMPLIFIED, SLOPED_CHEESE_AMPLIFIED, true);
/*     */     
...
/* 179 */     context.register(SPAGHETTI_2D_THICKNESS_MODULATOR, DensityFunctions.cacheOnce(DensityFunctions.mappedNoise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.SPAGHETTI_2D_THICKNESS), 2.0D, 1.0D, -0.6D, -1.3D)));
...
/* 183 */     return (Holder<? extends DensityFunction>)context.register(PILLARS, pillars(noises));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 201 */     DensityFunctions.Spline.Coordinate weirdness = new DensityFunctions.Spline.Coordinate((Holder<DensityFunction>)functions.getOrThrow(RIDGES));
/* 202 */     DensityFunctions.Spline.Coordinate ridges = new DensityFunctions.Spline.Coordinate((Holder<DensityFunction>)functions.getOrThrow(RIDGES_FOLDED));
/*     */ 
/*     */     
...
/* 225 */     return DensityFunctions.add(DensityFunctions.yClampedGradient(-64, 320, 1.5D, -1.5D), offset);
/*     */   }
/*     */   
...
/* 229 */     return new DensityFunctions.HolderHolder((Holder<DensityFunction>)context.register(name, value));
/*     */   }
/*     */   
/*     */   private static DensityFunction getFunction(HolderGetter<DensityFunction> functions, ResourceKey<DensityFunction> name) {
/* 233 */     return new DensityFunctions.HolderHolder((Holder<DensityFunction>)functions.getOrThrow(name));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 243 */     return DensityFunctions.mul(DensityFunctions.add(DensityFunctions.add(weirdness.abs(), DensityFunctions.constant(-0.6666666666666666D)).abs(), DensityFunctions.constant(-0.3333333333333333D)), DensityFunctions.constant(-3.0D));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 250 */     return -(Math.abs(Math.abs(weirdness) - 0.6666667F) - 0.33333334F) * 3.0F;
/*     */   }
/*     */   
/*     */   private static DensityFunction spaghettiRoughnessFunction(HolderGetter<NormalNoise.NoiseParameters> noises) {
/* 254 */     DensityFunction spaghettiRoughnessNoise = DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.SPAGHETTI_ROUGHNESS));
/*     */     
/* 256 */     DensityFunction spaghettiRoughnessModulator = DensityFunctions.mappedNoise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.SPAGHETTI_ROUGHNESS_MODULATOR), 0.0D, -0.1D);
/*     */     
...
/* 265 */     DensityFunction spaghetti3DRarityModulator = DensityFunctions.cacheOnce(DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.SPAGHETTI_3D_RARITY), 2.0D, 1.0D));
/*     */ 
/*     */     
/* 268 */     DensityFunction spaghetti3DThicknessModulator = DensityFunctions.mappedNoise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.SPAGHETTI_3D_THICKNESS), -0.065D, -0.088D);
/*     */     
/* 270 */     DensityFunction spaghetti3DCave1 = DensityFunctions.weirdScaledSampler(spaghetti3DRarityModulator, (Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.SPAGHETTI_3D_1), DensityFunctions.WeirdScaledSampler.RarityValueMapper.TYPE1);
/* 271 */     DensityFunction spaghetti3DCave2 = DensityFunctions.weirdScaledSampler(spaghetti3DRarityModulator, (Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.SPAGHETTI_3D_2), DensityFunctions.WeirdScaledSampler.RarityValueMapper.TYPE1);
/*     */ 
/*     */     
/* 274 */     DensityFunction spaghetti3DFunction = DensityFunctions.add(
/* 275 */         DensityFunctions.max(spaghetti3DCave1, spaghetti3DCave2), spaghetti3DThicknessModulator)
/*     */       
/* 277 */       .clamp(-1.0D, 1.0D);
/*     */     
/* 279 */     DensityFunction spaghettiRoughnessFunction = getFunction(functions, SPAGHETTI_ROUGHNESS_FUNCTION);
/*     */     
/* 281 */     DensityFunction bigEntranceNoiseSource = DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.CAVE_ENTRANCE), 0.75D, 0.5D);
/*     */     
...
/*     */     
/* 303 */     DensityFunction noodleToggle = yLimitedInterpolatable(y, DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.NOODLE), 1.0D, 1.0D), -60, 320, -1);
/*     */ 
/*     */ 
/*     */     
/* 307 */     DensityFunction noodleThickness = yLimitedInterpolatable(y, DensityFunctions.mappedNoise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.NOODLE_THICKNESS), 1.0D, 1.0D, -0.05D, -0.1D), -60, 320, 0);
/*     */     
/* 309 */     double noodleRidgeFrequency = 2.6666666666666665D;
/* 310 */     DensityFunction noodleRidgeA = yLimitedInterpolatable(y, DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.NOODLE_RIDGE_A), 2.6666666666666665D, 2.6666666666666665D), -60, 320, 0);
/* 311 */     DensityFunction noodleRidgeB = yLimitedInterpolatable(y, DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.NOODLE_RIDGE_B), 2.6666666666666665D, 2.6666666666666665D), -60, 320, 0);
/*     */     
...
/*     */     
/* 338 */     DensityFunction pillarNoiseSource = DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.PILLAR), 25.0D, 0.3D);
/*     */ 
/*     */ 
/*     */     
/* 342 */     DensityFunction pillarRarenessModulator = DensityFunctions.mappedNoise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.PILLAR_RARENESS), 0.0D, -2.0D);
/*     */ 
/*     */ 
/*     */     
/* 346 */     DensityFunction pillarThicknessModulator = DensityFunctions.mappedNoise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.PILLAR_THICKNESS), 0.0D, 1.1D);
/*     */     
...
/*     */ 
/*     */     
/* 353 */     return DensityFunctions.cacheOnce(DensityFunctions.mul(pillarsWithRareness, 
/*     */ 
/*     */           
/* 356 */           pillarThicknessModulator.cube()));
/*     */   }
/*     */ 
/*     */   
...
/* 361 */     DensityFunction spaghetti2DRarityModulator = DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.SPAGHETTI_2D_MODULATOR), 2.0D, 1.0D);
/* 362 */     DensityFunction spaghetti2DCave = DensityFunctions.weirdScaledSampler(spaghetti2DRarityModulator, (Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.SPAGHETTI_2D), DensityFunctions.WeirdScaledSampler.RarityValueMapper.TYPE2);
/*     */     
/* 364 */     DensityFunction spaghetti2DElevationModulator = DensityFunctions.mappedNoise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.SPAGHETTI_2D_ELEVATION), 0.0D, Math.floorDiv(-64, 8), 8.0D);
/*     */     
/* 366 */     DensityFunction spaghetti2DThicknessModulator = getFunction(functions, SPAGHETTI_2D_THICKNESS_MODULATOR);
/*     */     
/* 368 */     DensityFunction slopedSpaghetti = DensityFunctions.add(spaghetti2DElevationModulator, 
/*     */         
/* 370 */         DensityFunctions.yClampedGradient(-64, 320, 8.0D, -40.0D))
/* 371 */       .abs();
/*     */     
...
/*     */     
/* 387 */     DensityFunction layerNoiseSource = DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.CAVE_LAYER), 8.0D);
/*     */     
/* 389 */     DensityFunction layerizedCavernsFunction = DensityFunctions.mul(DensityFunctions.constant(4.0D), layerNoiseSource.square());
/*     */     
/* 391 */     DensityFunction cheese = DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.CAVE_CHEESE), 0.6666666666666666D);
/*     */     
...
/* 425 */     DensityFunction barrierNoise = DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.AQUIFER_BARRIER), 0.5D);
/* 426 */     DensityFunction fluidLevelFloodednessNoise = DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.AQUIFER_FLUID_LEVEL_FLOODEDNESS), 0.67D);
/* 427 */     DensityFunction fluidLevelSpreadNoise = DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.AQUIFER_FLUID_LEVEL_SPREAD), 0.7142857142857143D);
/* 428 */     DensityFunction lavaNoise = DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.AQUIFER_LAVA));
/*     */     
/* 430 */     DensityFunction shiftX = getFunction(functions, SHIFT_X);
/* 431 */     DensityFunction shiftZ = getFunction(functions, SHIFT_Z);
/*     */ 
/*     */     
/* 434 */     DensityFunction temperature = DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, (Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(largeBiomes ? Noises.TEMPERATURE_LARGE : Noises.TEMPERATURE));
/* 435 */     DensityFunction vegetation = DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, (Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(largeBiomes ? Noises.VEGETATION_LARGE : Noises.VEGETATION));
/*     */     
...
/*     */     
/* 455 */     int veinMinY = Stream.<OreVeinifier.VeinType>of(OreVeinifier.VeinType.values()).mapToInt(t -> t.minY).min().orElse(-DimensionType.MIN_Y * 2);
/* 456 */     int veinMaxY = Stream.<OreVeinifier.VeinType>of(OreVeinifier.VeinType.values()).mapToInt(t -> t.maxY).max().orElse(-DimensionType.MIN_Y * 2);
/*     */ 
/*     */     
/* 459 */     DensityFunction veinToggle = yLimitedInterpolatable(y, DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.ORE_VEININESS), 1.5D, 1.5D), veinMinY, veinMaxY, 0);
/*     */     
/* 461 */     float oreRidgeFrequency = 4.0F;
/*     */ 
/*     */     
/* 464 */     DensityFunction veinA = yLimitedInterpolatable(y, DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.ORE_VEIN_A), 4.0D, 4.0D), veinMinY, veinMaxY, 0).abs();
/* 465 */     DensityFunction veinB = yLimitedInterpolatable(y, DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.ORE_VEIN_B), 4.0D, 4.0D), veinMinY, veinMaxY, 0).abs();
/*     */     
...
/*     */     
/* 469 */     DensityFunction veinGap = DensityFunctions.noise((Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.ORE_GAP));
/*     */ 
/*     */ 
/*     */     
...
/*     */     
/* 496 */     DensityFunction temperature = DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, (Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.TEMPERATURE));
/* 497 */     DensityFunction vegetation = DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, (Holder<NormalNoise.NoiseParameters>)noises.getOrThrow(Noises.VEGETATION));
/*     */     
...
/* 551 */     return slide(caves, minY, height, 72, -184, -23.4375D, 4, 32, -0.234375D);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 565 */     return noNewCaves(functions, noises, slideNetherLike(functions, 0, 128));
/*     */   }
/*     */   
...
/* 569 */     return noNewCaves(functions, noises, slideNetherLike(functions, -64, 192));
/*     */   }
/*     */   
...
/* 573 */     return noNewCaves(functions, noises, slideEndLike(getFunction(functions, BASE_3D_NOISE_END), 0, 256));
/*     */   }
/*     */   
/*     */   private static DensityFunction slideEnd(DensityFunction caves) {
/* 577 */     return slideEndLike(caves, 0, 128);
/*     */   }
/*     */   
...
/* 643 */             DensityFunctions.constant(0.2734375D), 
/* 644 */             cachedFactor.invert()), 
/*     */           
...
/* 665 */     return DensityFunctions.interpolated(DensityFunctions.rangeChoice(y, minYInclusive, (maxYInclusive + 1), whenInRange, DensityFunctions.constant(whenOutOfRange)));
/*     */   }
/*     */   
...
/* 669 */     DensityFunction noiseValue = caves;
/*     */     
...
/*     */ 
/*     */     
/* 685 */     noiseValue = DensityFunctions.lerp(bottomFactor, bottomTarget, noiseValue);
/*     */     
/* 687 */     return noiseValue;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/NoiseRouterData.class
