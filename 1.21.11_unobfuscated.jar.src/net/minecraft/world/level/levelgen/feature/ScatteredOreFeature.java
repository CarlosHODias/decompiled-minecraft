...
/*    */       
/* 37 */       BlockState blockState = level.getBlockState((BlockPos)targetPos);
/* 38 */       for (OreConfiguration.TargetBlockState targetState : (Iterable<OreConfiguration.TargetBlockState>)config.targetStates) {
...
/* 40 */           level.setBlock((BlockPos)targetPos, targetState.state, 2);
/*    */           break;
/*    */         } 
/*    */       } 
/*    */     } 
...
/* 52 */     targetPos.setWithOffset((Vec3i)origin, xd, yd, zd);
/*    */   }
/*    */   
/*    */   private int getRandomPlacementInOneAxisRelativeToOrigin(RandomSource random, int maxDistanceFromOrigin) {
/* 56 */     return Math.round((random.nextFloat() - random.nextFloat()) * maxDistanceFromOrigin);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/ScatteredOreFeature.class
