...
/*     */           {
/*     */             
/*  52 */             generateIcebergBlock((LevelAccessor)level, random, origin, overWaterHeight, xo, yOff, zo, radius, a, isEllipse, shapeEllipseC, shapeAngle, snowOnTop, mainBlockState);
/*     */           }
/*     */         } 
/*     */       } 
/*     */     } 
/*     */     
/*  58 */     smooth((LevelAccessor)level, origin, width, overWaterHeight, isEllipse, shapeEllipseA);
/*     */ 
/*     */     
/*  61 */     for (int i = -a; i < a; i++) {
...
/*     */           {
/*     */             
/*  69 */             generateIcebergBlock((LevelAccessor)level, random, origin, underWaterHeight, i, yOff, zo, radius, newA, isEllipse, shapeEllipseC, shapeAngle, snowOnTop, mainBlockState);
/*     */           }
/*     */         } 
/*     */       } 
/*     */     } 
...
/*  76 */     if (doCutOut) {
/*  77 */       generateCutOut(random, (LevelAccessor)level, width, overWaterHeight, origin, isEllipse, shapeEllipseA, shapeAngle, shapeEllipseC);
/*     */     }
/*     */     
/*  80 */     return true;
/*     */   }
...
/*     */     } 
/*     */     
/* 108 */     for (int i = -1; i > -height + random.nextInt(5); i--) {
/* 109 */       int radius = heightDependentRadiusSteep(random, -i, height, width);
/* 110 */       carve(radius, i, globalOrigin, level, true, angle, localOrigin, shapeEllipseA, shapeEllipseC);
/*     */     } 
/*     */   }
/*     */   
...
/* 125 */             if (underWater) {
/* 126 */               setBlock((LevelWriter)level, pos, Blocks.WATER.defaultBlockState());
/*     */             } else {
/* 128 */               setBlock((LevelWriter)level, pos, Blocks.AIR.defaultBlockState());
...
/* 139 */       setBlock((LevelWriter)level, pos.above(), Blocks.AIR.defaultBlockState());
/*     */     }
/*     */   }
/*     */   
...
/* 161 */         setBlock((LevelWriter)level, pos, Blocks.SNOW_BLOCK.defaultBlockState());
/*     */       } else {
/* 163 */         setBlock((LevelWriter)level, pos, mainBlockState);
/*     */       } 
/*     */     } 
/*     */   }
/*     */   
...
/* 183 */     return Math.pow(((xo - origin.getX()) * Math.cos(angle) - (zo - origin.getZ()) * Math.sin(angle)) / a, 2.0D) + Math.pow(((xo - origin.getX()) * Math.sin(angle) + (zo - origin.getZ()) * Math.cos(angle)) / c, 2.0D) - 1.0D;
/*     */   }
/*     */   
...
/* 211 */     return (state.is(Blocks.PACKED_ICE) || state.is(Blocks.SNOW_BLOCK) || state.is(Blocks.BLUE_ICE));
/*     */   }
/*     */   
/*     */   private boolean belowIsAir(BlockGetter level, BlockPos pos) {
/* 215 */     return level.getBlockState(pos.below()).isAir();
/*     */   }
/*     */   
...
/* 229 */             if (belowIsAir((BlockGetter)level, pos)) {
/* 230 */               setBlock((LevelWriter)level, pos, Blocks.AIR.defaultBlockState());
/* 231 */               setBlock((LevelWriter)level, pos.above(), Blocks.AIR.defaultBlockState());
/*     */ 
/*     */             
/*     */             }
...
/*     */ 
/*     */               
/* 238 */               BlockState[] sides = { level.getBlockState(pos.west()), 
/* 239 */                   level.getBlockState(pos.east()), 
/* 240 */                   level.getBlockState(pos.north()), 
/* 241 */                   level.getBlockState(pos.south()) };
/*     */               
/* 243 */               int counter = 0;
...
/*     */               } 
/* 249 */               if (counter >= 3)
/* 250 */                 setBlock((LevelWriter)level, pos, Blocks.AIR.defaultBlockState()); 
/*     */             }  
/*     */         } 
/*     */       } 
/*     */     } 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/IcebergFeature.class
