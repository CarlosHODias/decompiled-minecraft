...
/*    */   static {
/* 19 */     CODEC = RecordCodecBuilder.mapCodec(i -> trunkPlacerParts(i).apply((Applicative)i, DarkOakTrunkPlacer::new));
/*    */   } public static final com.mojang.serialization.MapCodec<DarkOakTrunkPlacer> CODEC;
...
/* 62 */       if (net.minecraft.world.level.levelgen.feature.TreeFeature.isAirOrLeaves(level, blockPos)) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/trunkplacers/DarkOakTrunkPlacer.class
