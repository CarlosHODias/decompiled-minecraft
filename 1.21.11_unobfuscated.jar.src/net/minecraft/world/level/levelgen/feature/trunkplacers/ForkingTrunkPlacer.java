...
/*    */   static {
/* 19 */     CODEC = RecordCodecBuilder.mapCodec(i -> trunkPlacerParts(i).apply((Applicative)i, ForkingTrunkPlacer::new));
/*    */   } public static final com.mojang.serialization.MapCodec<ForkingTrunkPlacer> CODEC;
/*    */   public ForkingTrunkPlacer(int baseHeight, int heightRandA, int heightRandB) {
/* 22 */     super(baseHeight, heightRandA, heightRandB);
/*    */   }
/*    */ 
/*    */   
...
/* 49 */         leanSteps--;
/*    */       } 
/* 51 */       if (placeLog(level, trunkSetter, random, (BlockPos)logPos.set(tx, yy, tz), config)) {
...
/* 68 */       for (int i = branchPos; i < treeHeight && branchSteps > 0; i++, branchSteps--) {
/* 69 */         if (i >= 1) {
/*    */ 
/*    */           
/* 72 */           int yy = origin.getY() + i;
/* 73 */           tx += branchDirection.getStepX();
/* 74 */           tz += branchDirection.getStepZ();
/* 75 */           if (placeLog(level, trunkSetter, random, (BlockPos)logPos.set(tx, yy, tz), config))
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/trunkplacers/ForkingTrunkPlacer.class
