...
/*    */   static {
/* 17 */     CODEC = RecordCodecBuilder.mapCodec(i -> trunkPlacerParts(i).apply((Applicative)i, GiantTrunkPlacer::new));
/*    */   } public static final com.mojang.serialization.MapCodec<GiantTrunkPlacer> CODEC;
...
/*    */     } 
/*    */     
/* 48 */     return (List<FoliagePlacer.FoliageAttachment>)com.google.common.collect.ImmutableList.of(new FoliagePlacer.FoliageAttachment(origin.above(treeHeight), 0, true));
/*    */   }
/*    */   
...
/* 52 */     trunkPos.setWithOffset((Vec3i)treePos, x, y, z);
/* 53 */     placeLogIfFree(level, trunkSetter, random, trunkPos, config);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/trunkplacers/GiantTrunkPlacer.class
