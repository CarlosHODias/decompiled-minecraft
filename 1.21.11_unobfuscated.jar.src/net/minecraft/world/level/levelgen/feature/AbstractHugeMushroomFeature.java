...
/* 20 */       blockPos.set((Vec3i)origin).move(net.minecraft.core.Direction.UP, dy);
...
/* 26 */     BlockState currentState = level.getBlockState((BlockPos)blockPos);
/* 27 */     if (currentState.isAir() || currentState.is(BlockTags.REPLACEABLE_BY_MUSHROOMS)) {
/* 28 */       setBlock((LevelWriter)level, (BlockPos)blockPos, newState);
/*    */     }
/*    */   }
/*    */   
...
/* 55 */           BlockState state = level.getBlockState((BlockPos)blockPos.setWithOffset((Vec3i)origin, dx, dy, dz));
...
/* 70 */     HugeMushroomFeatureConfiguration config = context.config();
/* 71 */     int treeHeight = getTreeHeight(random);
/*    */     
/* 73 */     BlockPos.MutableBlockPos blockPos = new BlockPos.MutableBlockPos();
/* 74 */     if (!isValidPosition((LevelAccessor)level, origin, treeHeight, blockPos, config)) {
/* 75 */       return false;
/*    */     }
/*    */     
/* 78 */     makeCap((LevelAccessor)level, random, origin, treeHeight, blockPos, config);
/* 79 */     placeTrunk((LevelAccessor)level, random, origin, config, treeHeight, blockPos);
/* 80 */     return true;
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/AbstractHugeMushroomFeature.class
