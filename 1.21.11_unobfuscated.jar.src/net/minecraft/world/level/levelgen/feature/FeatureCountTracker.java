...
/*    */     try {
/* 46 */       ((LevelData)data.get(level)).featureData().computeInt(new FeatureData(feature, topFeature), (f, old) -> (old == null) ? 1 : (old + 1));
...
/*    */           String prefix = (running ? "running" : "dead") + " " + (running ? "running" : "dead");
/*    */           int chunks = featureCounts.chunksWithFeatures().intValue();
/*    */           LOGGER.debug("{} total_chunks: {}", prefix, chunks);
/*    */           featureCounts.featureData().forEach(());
/*    */         });
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/FeatureCountTracker.class
