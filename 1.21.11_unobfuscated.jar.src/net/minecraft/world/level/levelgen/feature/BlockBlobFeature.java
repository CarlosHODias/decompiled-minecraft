...
/* 21 */     BlockStateConfiguration config = context.config();
...
/*    */       
/* 42 */       for (BlockPos blockPos : (Iterable<BlockPos>)BlockPos.betweenClosed(origin.offset(-xr, -yr, -zr), origin.offset(xr, yr, zr))) {
/* 43 */         if (blockPos.distSqr((Vec3i)origin) <= (tr * tr)) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/BlockBlobFeature.class
