...
/* 24 */     BlockPileConfiguration config = context.config();
...
/*    */     
/* 32 */     for (BlockPos blockPos : (Iterable<BlockPos>)BlockPos.betweenClosed(origin.offset(-xr, 0, -zr), origin.offset(xr, 1, zr))) {
...
/* 36 */         tryPlaceBlock((LevelAccessor)level, blockPos, random, config); continue;
/* 37 */       }  if (random.nextFloat() < 0.031D) {
/* 38 */         tryPlaceBlock((LevelAccessor)level, blockPos, random, config);
/*    */       }
/*    */     } 
/*    */     
/* 42 */     return true;
...
/*    */     }
/*    */     
/* 52 */     return belowState.isFaceSturdy((BlockGetter)level, below, Direction.UP);
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/BlockPileFeature.class
