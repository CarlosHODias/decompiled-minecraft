...
/* 33 */       int inwayLenth; Direction segmentDirection; BlockPos.MutableBlockPos mutPos = origin.mutable();
...
/* 47 */         segmentDirection = (Direction)Util.getRandom((Object[])segmentPossibleDirections, random);
/* 48 */         inwayLenth = random.nextInt(3) + 3;
/*    */       } 
/*    */       
/* 51 */       for (int i = 0; i < sidewayLength && 
/* 52 */         placeCoralBlock(level, random, (BlockPos)mutPos, state); i++)
/*    */       {
/*    */         
...
/*    */       
/* 60 */       for (int j = 0; j < inwayLenth; j++) {
/* 61 */         mutPos.move(clawDirection);
/* 62 */         if (!placeCoralBlock(level, random, (BlockPos)mutPos, state)) {
/*    */           break;
/*    */         }
/*    */         
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/CoralClawFeature.class
