...
/*  28 */     OreConfiguration config = context.config();
...
/*     */       }
/*     */     } 
/* 108 */     BulkSectionAccess sectionGetter = new BulkSectionAccess((LevelAccessor)level); 
/* 109 */     try { for (int j = 0; j < size; j++) {
/* 110 */         double r = data[j * 4 + 3];
/* 111 */         if (r >= 0.0D) {
/*     */ 
/*     */ 
/*     */           
/* 115 */           double xx = data[j * 4 + 0];
/* 116 */           double yy = data[j * 4 + 1];
/* 117 */           double zz = data[j * 4 + 2];
/*     */ 
/*     */           
...
/* 147 */                         if (level.ensureCanWrite((BlockPos)orePos)) {
/*     */ 
/*     */                           
/* 150 */                           LevelChunkSection section = sectionGetter.getSection((BlockPos)orePos);
/* 151 */                           if (section != null) {
/*     */ 
/*     */                             
...
/* 159 */                             for (OreConfiguration.TargetBlockState targetState : (Iterable<OreConfiguration.TargetBlockState>)config.targetStates) {
...
/* 183 */       return true;
/*     */     }
/* 185 */     return !isAdjacentToAir(blockGetter, (BlockPos)orePos);
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/OreFeature.class
