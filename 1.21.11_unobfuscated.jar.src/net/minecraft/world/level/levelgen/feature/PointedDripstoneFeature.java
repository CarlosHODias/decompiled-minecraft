...
/* 23 */     PointedDripstoneConfiguration config = context.config();
/* 24 */     Optional<Direction> tipDirection = getTipDirection((LevelAccessor)worldGenLevel, pos, random);
/*    */     
...
/*    */     
/* 32 */     createPatchOfDripstoneBlocks((LevelAccessor)worldGenLevel, random, rootPos, config);
/*    */     
/* 34 */     int height = (random.nextFloat() < config.chanceOfTallerDripstone && DripstoneUtils.isEmptyOrWater(worldGenLevel.getBlockState(pos.relative(tipDirection.get())))) ? 2 : 1;
/*    */     
/* 36 */     DripstoneUtils.growPointedDripstone((LevelAccessor)worldGenLevel, pos, tipDirection.get(), height, false);
/* 37 */     return true;
/*    */   }
/*    */   
...
/*    */     
/* 59 */     for (Direction direction : (Iterable<Direction>)Direction.Plane.HORIZONTAL) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/PointedDripstoneFeature.class
