...
/*  35 */     LargeDripstoneConfiguration config = context.config();
/*  36 */     RandomSource random = context.random();
/*     */     
/*  38 */     if (!DripstoneUtils.isEmptyOrWater((LevelAccessor)level, origin)) {
/*  39 */       return false;
/*     */     }
/*     */ 
/*     */     
/*  43 */     Optional<Column> column = Column.scan((LevelSimulatedReader)level, origin, config.floorToCeilingSearchRange, DripstoneUtils::isEmptyOrWater, DripstoneUtils::isDripstoneBaseOrLava);
...
/*  92 */     return new LargeDripstone(root, pointingUp, radius, bluntness.sample(random), heightScale.sample(random));
/*     */   }
/*     */   
...
/* 100 */       BlockPos windAdjustedPos = wind.offset((BlockPos)pos);
/* 101 */       if (DripstoneUtils.isEmptyOrWater((LevelAccessor)level, windAdjustedPos) || level.getBlockState(windAdjustedPos).is(Blocks.DRIPSTONE_BLOCK)) {
...
/* 148 */           if (level.getBlockState((BlockPos)newRoot).is(Blocks.LAVA)) {
/* 149 */             return false;
/*     */           }
/* 151 */           if (DripstoneUtils.isCircleMostlyEmbeddedInStone(level, wind.offset((BlockPos)newRoot), this.radius)) {
/* 152 */             this.root = (BlockPos)newRoot;
/* 153 */             return true;
/*     */           } 
...
/* 163 */       return (int)DripstoneUtils.getDripstoneHeight(checkRadius, this.radius, this.scale, this.bluntness);
/*     */     }
/*     */     
...
/*     */ 
/*     */                 
/* 191 */                 BlockPos windAdjustedPos = wind.offset((BlockPos)pos);
/* 192 */                 if (DripstoneUtils.isEmptyOrWaterOrLava((LevelAccessor)level, windAdjustedPos)) {
...
/* 209 */       return (this.radius >= config.minRadiusForWind && this.bluntness >= config.minBluntnessForWind);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/LargeDripstoneFeature.class
