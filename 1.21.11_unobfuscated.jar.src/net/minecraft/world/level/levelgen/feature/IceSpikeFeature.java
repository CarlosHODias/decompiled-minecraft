...
/*     */       
/*  42 */       for (int i = -newWidth; i <= newWidth; i++) {
/*  43 */         float dx = Mth.abs(i) - 0.25F;
/*  44 */         for (int zo = -newWidth; zo <= newWidth; zo++) {
/*  45 */           float dz = Mth.abs(zo) - 0.25F;
/*  46 */           if ((i == 0 && zo == 0) || dx * dx + dz * dz <= scale * scale)
/*     */           {
/*     */             
/*  49 */             if ((i != -newWidth && i != newWidth && zo != -newWidth && zo != newWidth) || 
/*  50 */               random.nextFloat() <= 0.75F) {
/*     */ 
/*     */ 
/*     */ 
/*     */               
/*  55 */               BlockState state = level.getBlockState(origin.offset(i, yOff, zo));
/*     */               
/*  57 */               if (state.isAir() || isDirt(state) || state.is(Blocks.SNOW_BLOCK) || state.is(Blocks.ICE)) {
/*  58 */                 setBlock((LevelWriter)level, origin.offset(i, yOff, zo), Blocks.PACKED_ICE.defaultBlockState());
/*     */               }
/*     */               
/*  61 */               if (yOff != 0 && newWidth > 1) {
/*  62 */                 state = level.getBlockState(origin.offset(i, -yOff, zo));
/*     */                 
/*  64 */                 if (state.isAir() || isDirt(state) || state.is(Blocks.SNOW_BLOCK) || state.is(Blocks.ICE))
/*  65 */                   setBlock((LevelWriter)level, origin.offset(i, -yOff, zo), Blocks.PACKED_ICE.defaultBlockState()); 
/*     */               } 
/*     */             }  } 
/*     */         } 
/*     */       } 
...
/*  88 */             setBlock((LevelWriter)level, iceBlock, Blocks.PACKED_ICE.defaultBlockState());
/*     */ 
/*     */ 
/*     */             
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/IceSpikeFeature.class
