...
/* 17 */     LayerConfiguration config = context.config();
...
/* 26 */         pos.set(x, y, z);
/*    */         
/* 28 */         if (level.getBlockState((BlockPos)pos).isAir()) {
/* 29 */           level.setBlock((BlockPos)pos, config.state, 2);
/*    */         }
/*    */       } 
/*    */     } 
/* 33 */     return true;
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/FillLayerFeature.class
