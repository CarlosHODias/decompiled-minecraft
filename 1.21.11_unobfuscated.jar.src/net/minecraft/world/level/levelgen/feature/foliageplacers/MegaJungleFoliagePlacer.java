...
/*    */   static {
/* 13 */     CODEC = RecordCodecBuilder.mapCodec(i -> foliagePlacerParts(i).and((App)Codec.intRange(0, 16).fieldOf("height").forGetter(())).apply((com.mojang.datafixers.kinds.Applicative)i, MegaJungleFoliagePlacer::new));
/*    */   }
/*    */   
/*    */   public static final com.mojang.serialization.MapCodec<MegaJungleFoliagePlacer> CODEC;
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/foliageplacers/MegaJungleFoliagePlacer.class
