...
/*    */   static {
/* 14 */     CODEC = RecordCodecBuilder.mapCodec(i -> foliagePlacerParts(i).and((App)IntProvider.codec(0, 24).fieldOf("crown_height").forGetter(())).apply((Applicative)i, MegaPineFoliagePlacer::new));
/*    */   }
/*    */   
/*    */   public static final com.mojang.serialization.MapCodec<MegaPineFoliagePlacer> CODEC;
...
/* 36 */       int jaggedRadius; int yo = foliagePos.getY() - yy;
/* 37 */       int smoothRadius = leafRadius + foliageAttachment.radiusOffset() + net.minecraft.util.Mth.floor(yo / foliageHeight * 3.5F);
/*    */       
/* 39 */       if (yo > 0 && smoothRadius == prevRadius && (yy & 0x1) == 0) {
...
/* 52 */     return this.crownHeight.sample(random);
/*    */   }
/*    */ 
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/foliageplacers/MegaPineFoliagePlacer.class
