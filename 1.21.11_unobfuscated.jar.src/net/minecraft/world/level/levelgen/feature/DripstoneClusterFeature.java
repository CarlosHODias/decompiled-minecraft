...
/*  37 */     DripstoneClusterConfiguration config = context.config();
/*  38 */     RandomSource random = context.random();
/*     */     
/*  40 */     if (!DripstoneUtils.isEmptyOrWater((LevelAccessor)level, origin)) {
/*  41 */       return false;
/*     */     }
/*     */ 
/*     */     
...
/*     */     Column column;
/*     */     int stalactiteHeight, stalagmiteHeight, actualStalactiteHeight, actualStalagmiteHeight;
/*  67 */     Optional<Column> baseColumn = Column.scan((LevelSimulatedReader)level, pos, config.floorToCeilingSearchRange, DripstoneUtils::isEmptyOrWater, DripstoneUtils::isNeitherEmptyNorWater);
...
/*  97 */     if (ceiling.isPresent() && wantStalactite && !isLava((LevelReader)level, pos.atY(ceiling.getAsInt()))) {
/*  98 */       int maxHeightForThisColumn; int ceilingThickness = config.dripstoneBlockLayerThickness.sample(random);
/*  99 */       replaceBlocksWithDripstoneBlocks(level, pos.atY(ceiling.getAsInt()), ceilingThickness, Direction.UP);
/*     */       
...
/* 114 */     if (floor.isPresent() && wantStalagmite && !isLava((LevelReader)level, pos.atY(floor.getAsInt()))) {
/* 115 */       int floorThickness = config.dripstoneBlockLayerThickness.sample(random);
/* 116 */       replaceBlocksWithDripstoneBlocks(level, pos.atY(floor.getAsInt()), floorThickness, Direction.DOWN);
/*     */       
...
/*     */     } 
/*     */     
/* 147 */     boolean mergeTips = (random.nextBoolean() && actualStalactiteHeight > 0 && actualStalagmiteHeight > 0 && 
/*     */ 
/*     */       
/* 150 */       column.getHeight().isPresent() && actualStalactiteHeight + actualStalagmiteHeight == 
/* 151 */       column.getHeight().getAsInt());
/*     */     
/* 153 */     if (ceiling.isPresent()) {
/* 154 */       DripstoneUtils.growPointedDripstone((LevelAccessor)level, pos.atY(ceiling.getAsInt() - 1), Direction.DOWN, actualStalactiteHeight, mergeTips);
/*     */     }
/* 156 */     if (floor.isPresent()) {
/* 157 */       DripstoneUtils.growPointedDripstone((LevelAccessor)level, pos.atY(floor.getAsInt() + 1), Direction.UP, actualStalagmiteHeight, mergeTips);
/*     */     }
/*     */   }
/*     */   
/*     */   private boolean isLava(LevelReader level, BlockPos pos) {
/* 162 */     return level.getBlockState(pos).is(Blocks.LAVA);
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/* 186 */     for (Direction direction : (Iterable<Direction>)Direction.Plane.HORIZONTAL) {
/* 187 */       if (!canBeAdjacentToWater((LevelAccessor)level, pos.relative(direction))) {
/* 188 */         return false;
/*     */       }
/*     */     } 
/* 191 */     return canBeAdjacentToWater((LevelAccessor)level, pos.below());
/*     */   }
/*     */   
...
/* 202 */       if (!DripstoneUtils.placeDripstoneBlockIfPossible((LevelAccessor)level, (BlockPos)pos)) {
/*     */         return;
/*     */       }
...
/* 221 */     return ClampedNormalFloat.sample(random, mean, deviation, min, maxExclusive);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/feature/DripstoneClusterFeature.class
