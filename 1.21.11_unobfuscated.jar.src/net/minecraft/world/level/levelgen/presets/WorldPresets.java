...
/*     */       
/*  66 */       this.overworldDimensionType = (Holder<DimensionType>)dimensionTypes.getOrThrow(BuiltinDimensionTypes.OVERWORLD);
/*     */       
...
/*     */       
/*  73 */       this.netherStem = new LevelStem((Holder)reference1, (ChunkGenerator)new NoiseBasedChunkGenerator((BiomeSource)MultiNoiseBiomeSource.createFromPreset((Holder)netherBiomePreset), (Holder)reference2));
/*     */       
...
/*     */       
/*  78 */       this.endStem = new LevelStem((Holder)reference3, (ChunkGenerator)new NoiseBasedChunkGenerator((BiomeSource)TheEndBiomeSource.create(this.biomes), (Holder)reference4));
/*     */     }
/*     */     
/*     */     private LevelStem makeOverworld(ChunkGenerator generator) {
/*  82 */       return new LevelStem(this.overworldDimensionType, generator);
/*     */     }
/*     */     
/*     */     private LevelStem makeNoiseBasedOverworld(BiomeSource overworldBiomeSource, Holder<NoiseGeneratorSettings> noiseSettings) {
/*  86 */       return makeOverworld((ChunkGenerator)new NoiseBasedChunkGenerator(overworldBiomeSource, noiseSettings));
/*     */     }
/*     */     
...
/* 100 */       this.context.register(debug, createPresetWithCustomOverworld(overworld));
/*     */     }
/*     */     
...
/* 105 */       registerCustomOverworldPreset(WorldPresets.NORMAL, makeNoiseBasedOverworld(biomeSource, (Holder<NoiseGeneratorSettings>)reference1));
/*     */       
/* 107 */       Holder.Reference reference2 = this.noiseSettings.getOrThrow(NoiseGeneratorSettings.LARGE_BIOMES);
/* 108 */       registerCustomOverworldPreset(WorldPresets.LARGE_BIOMES, makeNoiseBasedOverworld(biomeSource, (Holder<NoiseGeneratorSettings>)reference2));
/*     */       
/* 110 */       Holder.Reference reference3 = this.noiseSettings.getOrThrow(NoiseGeneratorSettings.AMPLIFIED);
/* 111 */       registerCustomOverworldPreset(WorldPresets.AMPLIFIED, makeNoiseBasedOverworld(biomeSource, (Holder<NoiseGeneratorSettings>)reference3));
/*     */     }
/*     */     
...
/* 116 */       registerOverworlds((BiomeSource)MultiNoiseBiomeSource.createFromPreset((Holder)overworldPreset));
/*     */       
...
/* 120 */       registerCustomOverworldPreset(WorldPresets.SINGLE_BIOME_SURFACE, makeNoiseBasedOverworld((BiomeSource)new FixedBiomeSource((Holder)plains), (Holder<NoiseGeneratorSettings>)reference));
/*     */       
...
/*     */       
/* 124 */       registerCustomOverworldPreset(WorldPresets.DEBUG, makeOverworld((ChunkGenerator)new DebugLevelSource(plains)));
/*     */     }
/*     */   }
/*     */   
/*     */   public static void bootstrap(BootstrapContext<WorldPreset> context) {
/* 129 */     new Bootstrap(context).bootstrap();
/*     */   }
/*     */   
/*     */   private static ResourceKey<WorldPreset> register(String name) {
/* 133 */     return ResourceKey.create(Registries.WORLD_PRESET, Identifier.withDefaultNamespace(name));
/*     */   }
/*     */   
...
/* 148 */     return ((WorldPreset)registries.lookupOrThrow(Registries.WORLD_PRESET).getOrThrow(NORMAL).value()).createWorldDimensions();
/*     */   }
/*     */   
/*     */   public static LevelStem getNormalOverworld(HolderLookup.Provider registries) {
/* 152 */     return ((WorldPreset)registries.lookupOrThrow(Registries.WORLD_PRESET).getOrThrow(NORMAL).value()).overworld().orElseThrow();
/*     */   }
/*     */   
/*     */   public static WorldDimensions createFlatWorldDimensions(HolderLookup.Provider registries) {
/* 156 */     return ((WorldPreset)registries.lookupOrThrow(Registries.WORLD_PRESET).getOrThrow(FLAT).value()).createWorldDimensions();
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/presets/WorldPresets.class
