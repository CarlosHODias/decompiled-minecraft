...
/*  29 */     return create((NoiseGeneratorSettings)holders.lookupOrThrow(Registries.NOISE_SETTINGS).getOrThrow(noiseSettings).value(), holders.lookupOrThrow(Registries.NOISE), seed);
/*     */   }
/*     */   
...
/*  33 */     return new RandomState(settings, noises, seed);
/*     */   }
/*     */   
...
/*  51 */         return new LegacyRandomSource(seed + seedOffset);
/*     */       }
/*     */ 
/*     */       
...
/*     */           } 
/*     */         } 
/*  71 */         NormalNoise instantiate = RandomState.this.getOrCreateNoise(noiseData.unwrapKey().orElseThrow());
...
/*  78 */           return (DensityFunction)noise.withNewRandom(terrainRandom); }
/*     */         
...
/*  88 */         return this.wrapped.computeIfAbsent(function, this::wrapNew);
/*     */       }
/*     */     };
/*     */     
...
/* 109 */           return this.wrapped.computeIfAbsent(input, this::wrapNew);
/*     */         } }
/*     */       ;
/*     */     
/* 113 */     this
...
/* 125 */     return this.noiseIntances.computeIfAbsent(noise, key -> Noises.instantiate(this.noises, this.random, noise));
/*     */   }
/*     */   
/*     */   public PositionalRandomFactory getOrCreateRandomFactory(Identifier name) {
/* 129 */     return this.positionalRandoms.computeIfAbsent(name, key -> this.random.fromHashOf(name).forkPositional());
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/RandomState.class
