...
/*  23 */   public static final Codec<StructurePlacement> CODEC = net.minecraft.core.registries.BuiltInRegistries.STRUCTURE_PLACEMENT.byNameCodec().dispatch(StructurePlacement::type, StructurePlacementType::codec); private static final int HIGHLY_ARBITRARY_RANDOM_SALT = 10387320; private final Vec3i locateOffset; private final FrequencyReductionMethod frequencyReductionMethod; private final float frequency;
/*     */   private final int salt;
/*     */   private final Optional<ExclusionZone> exclusionZone;
/*     */   
/*  27 */   protected static <S extends StructurePlacement> com.mojang.datafixers.Products.P5<RecordCodecBuilder.Mu<S>, Vec3i, FrequencyReductionMethod, Float, Integer, Optional<ExclusionZone>> placementCodec(RecordCodecBuilder.Instance<S> i) { return i.group(
/*  28 */         (App)Vec3i.offsetCodec(16).optionalFieldOf("locate_offset", Vec3i.ZERO).forGetter(StructurePlacement::locateOffset), (App)
/*  29 */         FrequencyReductionMethod.CODEC.optionalFieldOf("frequency_reduction_method", FrequencyReductionMethod.DEFAULT).forGetter(StructurePlacement::frequencyReductionMethod), 
/*  30 */         (App)Codec.floatRange(0.0F, 1.0F).optionalFieldOf("frequency", 1.0F).forGetter(StructurePlacement::frequency), (App)
/*  31 */         ExtraCodecs.NON_NEGATIVE_INT.fieldOf("salt").forGetter(StructurePlacement::salt), (App)
/*  32 */         ExclusionZone.CODEC.optionalFieldOf("exclusion_zone").forGetter(StructurePlacement::exclusionZone)); }
/*     */   
/*     */   @FunctionalInterface
...
/*  40 */       //   0	8	1	o	Ljava/lang/Object; } public ExclusionZone(Holder<StructureSet> otherSet, int chunkCount) { this.otherSet = otherSet; this.chunkCount = chunkCount; } static {
/*  41 */       CODEC = RecordCodecBuilder.create(i -> i.group((App)RegistryFileCodec.create(Registries.STRUCTURE_SET, StructureSet.DIRECT_CODEC, false).fieldOf("other_set").forGetter(ExclusionZone::otherSet), (App)Codec.intRange(1, 16).fieldOf("chunk_count").forGetter(ExclusionZone::chunkCount)).apply((Applicative)i, ExclusionZone::new));
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*  48 */       return state.hasStructureChunkInRange(this.otherSet, sourceX, sourceZ, this.chunkCount);
/*     */     } }
/*     */ 
/*     */ 
/*     */ 
...
/* 111 */     return new BlockPos(chunkPos.getMinBlockX(), 0, chunkPos.getMinBlockZ()).offset(locateOffset());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 122 */     WorldgenRandom random = new WorldgenRandom((RandomSource)new LegacyRandomSource(0L));
...
/* 128 */     WorldgenRandom random = new WorldgenRandom((RandomSource)new LegacyRandomSource(0L));
...
/* 135 */     WorldgenRandom random = new WorldgenRandom((RandomSource)new LegacyRandomSource(0L));
...
/*     */ 
/*     */     
/* 145 */     WorldgenRandom random = new WorldgenRandom((RandomSource)new LegacyRandomSource(0L));
...
/*     */ 
/*     */     
/* 159 */     public static final Codec<FrequencyReductionMethod> CODEC = (Codec<FrequencyReductionMethod>)StringRepresentable.fromEnum(FrequencyReductionMethod::values);
/*     */     
...
/* 170 */       return this.reducer.shouldGenerate(seed, salt, sourceX, sourceZ, probability);
/*     */     }
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/structure/placement/StructurePlacement.class
