...
/*  77 */     Object2IntMap<Structure> cachedResult = (Object2IntMap<Structure>)this.loadedChunks.get(posKey);
...
/*     */ 
/*     */     
/*  99 */     boolean isFeatureChunk = ((Long2BooleanMap)this.featureChecks.computeIfAbsent(structure, k -> new Long2BooleanOpenHashMap())).computeIfAbsent(posKey, k -> canCreateStructure(pos, pos));
/*     */ 
/*     */ 
/*     */     
...
/* 113 */     Objects.requireNonNull(structure.biomes()); return structure.findValidGenerationPoint(new Structure.GenerationContext(this.registryAccess, this.chunkGenerator, this.biomeSource, this.randomState, this.structureTemplateManager, this.seed, pos, this.heightAccessor, structure.biomes()::contains)).isPresent();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */     
/*     */     try {
/* 127 */       this.storageAccess.scanChunk(pos, (StreamTagVisitor)collectFields).join();
...
/* 168 */     Optional<CompoundTag> maybeStartsTag = chunkTag.getCompound("structures")
/* 169 */       .flatMap(tag -> tag.getCompound("starts"));
/* 170 */     if (maybeStartsTag.isEmpty()) {
/* 171 */       return null;
/*     */     }
/*     */     
/* 174 */     CompoundTag startsTag = maybeStartsTag.get();
...
/* 203 */     return map.isEmpty() ? Object2IntMaps.emptyMap() : map;
/*     */   }
/*     */   
...
/*     */           }
/*     */         });
/* 221 */     storeFullResults(posKey, (Object2IntMap<Structure>)object2IntOpenHashMap);
/*     */   }
/*     */   
...
/*     */           object2IntOpenHashMap.computeInt(structure, ());
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/structure/StructureCheck.class
