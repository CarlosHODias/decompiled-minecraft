...
/* 55 */         pos.set(x, 64, z);
/* 56 */         if (chunkBB.isInside((Vec3i)pos)) {
/* 57 */           total += level.getHeightmapPos(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (BlockPos)pos).getY();
/* 58 */           count++;
/*    */         } 
/*    */       } 
/*    */     } 
...
/*    */         
/* 83 */         pos.set(x, 0, z);
/* 84 */         lowestGroundHeight = Math.min(lowestGroundHeight, level.getHeightmapPos(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (BlockPos)pos).getY());
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/structure/ScatteredFeaturePiece.class
