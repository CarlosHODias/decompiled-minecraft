...
/*    */   
/*    */   static {
/* 20 */     CODEC = TagKey.hashedCodec(Registries.BLOCK).xmap(ProtectedBlockProcessor::new, e -> e.cannotReplace).fieldOf("value");
/*    */   }
/*    */   public ProtectedBlockProcessor(TagKey<Block> cannotReplace) {
/* 23 */     this.cannotReplace = cannotReplace;
/*    */   }
/*    */ 
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/structure/templatesystem/ProtectedBlockProcessor.class
