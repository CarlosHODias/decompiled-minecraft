...
/*     */     
/*     */     default StructurePiece load(StructurePieceSerializationContext context, CompoundTag tag) {
/* 101 */       return load(context.structureTemplateManager(), tag);
/*     */     }
/*     */   }
/*     */ 
/*     */   
/*     */   private static StructurePieceType setFullContextPieceId(StructurePieceType type, String id) {
/* 107 */     return (StructurePieceType)Registry.register(BuiltInRegistries.STRUCTURE_PIECE, id.toLowerCase(Locale.ROOT), type);
/*     */   }
/*     */   
/*     */   private static StructurePieceType setPieceId(ContextlessType type, String id) {
/* 111 */     return setFullContextPieceId(type, id);
/*     */   }
/*     */   
/*     */   private static StructurePieceType setTemplatePieceId(StructureTemplateType type, String id) {
/* 115 */     return setFullContextPieceId(type, id);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/structure/pieces/StructurePieceType.class
