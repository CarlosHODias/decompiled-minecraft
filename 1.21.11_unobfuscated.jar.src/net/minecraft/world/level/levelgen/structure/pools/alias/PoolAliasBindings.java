...
/* 18 */     return (MapCodec<? extends PoolAliasBinding>)Registry.register(registry, "direct", DirectPoolAlias.CODEC);
/*    */   }
/*    */   
...
/* 25 */       .forEach(path -> Pools.register(context, path, new StructureTemplatePool(emptyPool, List.of(Pair.of(StructurePoolElement.single(path), 1)), StructureTemplatePool.Projection.RIGID)));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/structure/pools/alias/PoolAliasBindings.class
