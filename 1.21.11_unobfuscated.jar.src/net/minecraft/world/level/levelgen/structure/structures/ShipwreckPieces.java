...
/*  80 */     Identifier identifier = (Identifier)Util.getRandom(isBeached ? (Object[])STRUCTURE_LOCATION_BEACHED : (Object[])STRUCTURE_LOCATION_OCEAN, random);
/*  81 */     ShipwreckPiece piece = new ShipwreckPiece(structureTemplateManager, identifier, position, rotation, isBeached);
/*  82 */     structurePieceAccessor.addPiece((StructurePiece)piece);
/*  83 */     return piece;
/*     */   }
/*     */   
...
/*  96 */       super(StructurePieceType.SHIPWRECK_PIECE, tag, structureTemplateManager, location -> makeSettings(tag.read("Rot", Rotation.LEGACY_CODEC).orElseThrow()));
/*     */       
...
/* 109 */       return new StructurePlaceSettings().setRotation(rotation).setMirror(Mirror.NONE).setRotationPivot(ShipwreckPieces.PIVOT).addProcessor((StructureProcessor)BlockIgnoreProcessor.STRUCTURE_AND_AIR);
/*     */     }
/*     */ 
/*     */     
...
/* 114 */       ResourceKey<LootTable> lootTable = ShipwreckPieces.MARKERS_TO_LOOT.get(markerId);
/* 115 */       if (lootTable != null) {
/* 116 */         RandomizableContainer.setBlockEntityLootTable((BlockGetter)level, random, position.below(), lootTable);
/*     */       }
/*     */     }
/*     */ 
/*     */     
...
/* 137 */         for (BlockPos p : (Iterable<BlockPos>)BlockPos.betweenClosed(this.templatePosition, corner)) {
...
/* 157 */       return minY - this.template.getSize().getY() / 2 - random.nextInt(3);
/*     */     }
/*     */     
/*     */     public void adjustPositionHeight(int newHeight) {
/* 161 */       this.templatePosition = new BlockPos(this.templatePosition.getX(), newHeight, this.templatePosition.getZ());
/*     */     }
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/structure/structures/ShipwreckPieces.class
