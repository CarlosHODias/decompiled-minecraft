...
/* 23 */     z = (z ^ z >>> 30L) * -4658895280553007687L;
/* 24 */     z = (z ^ z >>> 27L) * -7723592293110705685L;
/* 25 */     return z ^ z >>> 31L;
/*    */   }
/*    */   
...
/* 35 */     return upgradeSeedTo128bitUnmixed(legacySeed).mixed();
/*    */   }
/*    */   
...
/* 50 */     return SEED_UNIQUIFIER.updateAndGet(current -> current * 1181783497276652981L) ^ System.nanoTime();
/*    */   }
...
/* 55 */       return new Seed128bit(this.seedLo ^ lo, this.seedHi ^ hi);
/*    */     }
/*    */     
/*    */     public Seed128bit xor(Seed128bit other) {
/* 59 */       return xor(other.seedLo, other.seedHi);
/*    */     }
/*    */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/RandomSupport.class
