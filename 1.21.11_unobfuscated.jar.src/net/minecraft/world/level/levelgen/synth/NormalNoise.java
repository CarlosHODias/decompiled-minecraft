...
/*  40 */     return new NormalNoise(random, parameters, false);
/*     */   }
/*     */   
/*     */   public static NormalNoise create(RandomSource random, int firstOctave, double... amplitudes) {
/*  44 */     return create(random, new NoiseParameters(firstOctave, (DoubleList)new DoubleArrayList(amplitudes)));
/*     */   }
/*     */   
/*     */   public static NormalNoise create(RandomSource random, NoiseParameters parameters) {
/*  48 */     return new NormalNoise(random, parameters, true);
/*     */   }
/*     */   
...
/*  91 */     return 0.1D * (1.0D + 1.0D / (octaveSpan + 1));
/*     */   }
/*     */   
...
/* 112 */     sb.append("}");
/*     */   }
/*     */   public static final class NoiseParameters extends Record { private final int firstOctave; private final DoubleList amplitudes; public static final Codec<NoiseParameters> DIRECT_CODEC;
...
/* 115 */       //   0	8	1	o	Ljava/lang/Object; } public DoubleList amplitudes() { return this.amplitudes; } static {
/* 116 */       DIRECT_CODEC = RecordCodecBuilder.create(i -> i.group((App)Codec.INT.fieldOf("firstOctave").forGetter(NoiseParameters::firstOctave), (App)Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(NoiseParameters::amplitudes)).apply((Applicative)i, NoiseParameters::new));
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 124 */       this(firstOctave, (DoubleList)new DoubleArrayList(amplitudes));
/*     */     }
/*     */     
/*     */     public NoiseParameters(int firstOctave, double firstAmplitude, double... amplitudes) {
/* 128 */       this(firstOctave, (DoubleList)Util.make(new DoubleArrayList(amplitudes), list -> list.add(0, firstAmplitude)));
/*     */     } }
/*     */ 
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/synth/NormalNoise.class
