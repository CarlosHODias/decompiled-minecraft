...
/*  28 */       int offset = random.nextInt(256 - j);
/*  29 */       byte tmp = this.p[j];
/*  30 */       this.p[j] = this.p[j + offset];
/*  31 */       this.p[j + offset] = tmp;
/*     */     } 
/*     */   }
/*     */ 
/*     */   
/*     */   public double noise(double _x, double _y, double _z) {
/*  37 */     return noise(_x, _y, _z, 0.0D, 0.0D);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  96 */     return SimplexNoise.dot(SimplexNoise.GRADIENT[hash & 0xF], x, y, z);
/*     */   }
/*     */   
/*     */   private int p(int x) {
/* 100 */     return this.p[x & 0xFF] & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 249 */     NoiseUtils.parityNoiseOctaveConfigString(sb, this.xo, this.yo, this.zo, this.p);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/synth/ImprovedNoise.class
