...
/* 18 */     this(random, (IntSortedSet)new IntRBTreeSet(octaveSet));
/*    */   }
/*    */   
...
/* 53 */       WorldgenRandom worldgenRandom = new WorldgenRandom((RandomSource)new LegacyRandomSource(positiveOctaveSeed));
/* 54 */       for (int j = zeroOctaveIndex - 1; j >= 0; j--) {
/* 55 */         if (j < octaves && octaveSet.contains(zeroOctaveIndex - j)) {
/* 56 */           this.noiseLevels[j] = new SimplexNoise((RandomSource)worldgenRandom);
/*    */         } else {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/synth/PerlinSimplexNoise.class
