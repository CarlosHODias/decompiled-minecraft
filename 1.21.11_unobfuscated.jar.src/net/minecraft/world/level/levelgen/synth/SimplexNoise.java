...
/*  45 */       int offset = random.nextInt(256 - j);
/*  46 */       int tmp = this.p[j];
/*  47 */       this.p[j] = this.p[offset + j];
/*  48 */       this.p[offset + j] = tmp;
/*     */     } 
/*     */   }
/*     */   
/*     */   private int p(int x) {
/*  53 */     return this.p[x & 0xFF];
/*     */   }
/*     */   
/*     */   protected static double dot(int[] g, double x, double y, double z) {
/*  57 */     return g[0] * x + g[1] * y + g[2] * z;
/*     */   }
/*     */   
/*     */   private double getCornerNoise3D(int index, double x, double y, double z, double base) {
/*     */     double n0;
/*  62 */     double t0 = base - x * x - y * y - z * z;
/*  63 */     if (t0 < 0.0D) {
/*  64 */       n0 = 0.0D;
/*     */     } else {
/*  66 */       t0 *= t0;
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/synth/SimplexNoise.class
