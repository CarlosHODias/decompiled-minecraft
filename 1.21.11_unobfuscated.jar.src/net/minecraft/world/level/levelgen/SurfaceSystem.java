...
/*  91 */           return protoChunk.getBlockState((BlockPos)columnPos.setY(blockY));
/*     */         }
/*     */ 
/*     */         
...
/*  98 */             protoChunk.setBlockState((BlockPos)columnPos.setY(blockY), state);
...
/* 112 */     SurfaceRules.SurfaceRule rule = ruleSource.apply(context);
/*     */     
...
/*     */         
/* 124 */         Holder<Biome> surfaceBiome = biomeManager.getBiome((BlockPos)blockPos.set(blockX, useLegacyRandom ? 0 : startingHeight, blockZ));
/*     */ 
/*     */         
/* 127 */         if (surfaceBiome.is(Biomes.ERODED_BADLANDS)) {
/* 128 */           erodedBadlandsExtension(column, blockX, blockZ, startingHeight, (LevelHeightAccessor)protoChunk);
/*     */         }
...
/* 210 */     return this.surfaceSecondaryNoise.getValue(blockX, 0.0D, blockZ);
/*     */   }
/*     */ 
/*     */   
/*     */   private boolean isStone(BlockState state) {
/* 215 */     return (!state.isAir() && state.getFluidState().isEmpty());
/*     */   }
/*     */   
/*     */   public int getSeaLevel() {
/* 219 */     return this.seaLevel;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 227 */     SurfaceRules.Context context = new SurfaceRules.Context(this, carvingContext.randomState(), chunk, noiseChunk, biomeGetter, carvingContext.registryAccess().lookupOrThrow(Registries.BIOME), (WorldGenerationContext)carvingContext);
/* 228 */     SurfaceRules.SurfaceRule rule = ruleSource.apply(context);
/*     */     
...
/*     */     } 
/*     */     
/* 270 */     for (int i = startY; i >= protoChunk.getMinY() && 
/* 271 */       column.getBlock(i).isAir(); i--)
/*     */     {
/*     */       
/* 274 */       column.setBlock(i, this.defaultBlock);
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/* 293 */     if (surfaceBiome.shouldMeltFrozenOceanIcebergSlightly((BlockPos)blockPos.set(blockX, this.seaLevel, blockZ), this.seaLevel)) {
/* 294 */       top -= 2.0D;
/*     */     }
/*     */     
/* 297 */     if (top > 2.0D) {
...
/* 328 */     Arrays.fill((Object[])clayBands, TERRACOTTA);
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 348 */     int whiteBandCount = random.nextIntBetweenInclusive(9, 15);
/* 349 */     for (int j = 0, start = 0; j < whiteBandCount && start < clayBands.length; j++, start += random.nextInt(16) + 4) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/levelgen/SurfaceSystem.class
