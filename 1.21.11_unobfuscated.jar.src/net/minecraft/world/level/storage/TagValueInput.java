...
/*  41 */     return new TagValueInput(problemReporter, new ValueInputContextHelper(holders, (DynamicOps<Tag>)NbtOps.INSTANCE), tag);
/*     */   }
/*     */   
...
/*  45 */     return new CompoundListWrapper(problemReporter, new ValueInputContextHelper(holders, (DynamicOps<Tag>)NbtOps.INSTANCE), tags);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/*  97 */     if (tag instanceof NumericTag) { NumericTag numericTag = (NumericTag)tag;
/*  98 */       return numericTag; }
/*     */ 
/*     */     
...
/* 107 */     CompoundTag compound = getOptionalTypedTag(name, CompoundTag.TYPE);
/* 108 */     return (compound != null) ? Optional.<ValueInput>of(wrapChild(name, compound)) : Optional.<ValueInput>empty();
/*     */   }
/*     */ 
/*     */   
/*     */   public ValueInput childOrEmpty(String name) {
/* 113 */     CompoundTag compound = getOptionalTypedTag(name, CompoundTag.TYPE);
...
/* 119 */     ListTag list = getOptionalTypedTag(name, ListTag.TYPE);
/* 120 */     return (list != null) ? Optional.<ValueInput.ValueInputList>of(wrapList(name, this.context, list)) : Optional.<ValueInput.ValueInputList>empty();
/*     */   }
/*     */ 
/*     */   
/*     */   public ValueInput.ValueInputList childrenListOrEmpty(String name) {
/* 125 */     ListTag list = getOptionalTypedTag(name, ListTag.TYPE);
...
/* 131 */     ListTag list = getOptionalTypedTag(name, ListTag.TYPE);
/* 132 */     return (list != null) ? Optional.<ValueInput.TypedInputList<T>>of(wrapTypedList(name, list, codec)) : Optional.<ValueInput.TypedInputList<T>>empty();
/*     */   }
/*     */ 
/*     */   
/*     */   public <T> ValueInput.TypedInputList<T> listOrEmpty(String name, Codec<T> codec) {
/* 137 */     ListTag list = getOptionalTypedTag(name, ListTag.TYPE);
/* 138 */     return (list != null) ? wrapTypedList(name, list, codec) : this.context.<T>emptyTypedList();
/*     */   }
/*     */ 
/*     */   
...
/* 162 */     return (numericTag != null) ? Optional.<Integer>of(numericTag.intValue()) : Optional.<Integer>empty();
/*     */   }
/*     */ 
/*     */   
...
/* 180 */     return (numericTag != null) ? Optional.<Long>of(numericTag.longValue()) : Optional.<Long>empty();
/*     */   }
/*     */ 
/*     */   
...
/* 197 */     StringTag tag = getOptionalTypedTag(name, StringTag.TYPE);
/* 198 */     return (tag != null) ? Optional.<String>of(tag.value()) : Optional.<String>empty();
/*     */   }
/*     */ 
/*     */   
/*     */   public String getStringOr(String name, String defaultValue) {
/* 203 */     StringTag tag = getOptionalTypedTag(name, StringTag.TYPE);
/* 204 */     return (tag != null) ? tag.value() : defaultValue;
/*     */   }
/*     */ 
/*     */   
/*     */   public Optional<int[]> getIntArray(String name) {
/* 209 */     IntArrayTag tag = getOptionalTypedTag(name, IntArrayTag.TYPE);
/* 210 */     return (tag != null) ? (Optional)Optional.<int[]>of(tag.getAsIntArray()) : (Optional)Optional.<int[]>empty();
/*     */   }
/*     */ 
/*     */   
/*     */   public HolderLookup.Provider lookup() {
/* 215 */     return this.context.lookup();
/*     */   }
/*     */   
/*     */   private ValueInput wrapChild(String name, CompoundTag compoundTag) {
/* 219 */     return compoundTag.isEmpty() ? 
/* 220 */       this.context.empty() : 
/* 221 */       new TagValueInput(this.problemReporter.forChild((ProblemReporter.PathElement)new ProblemReporter.FieldPathElement(name)), this.context, compoundTag);
/*     */   }
/*     */   
...
/* 225 */     return compoundTag.isEmpty() ? context.empty() : new TagValueInput(problemReporter, context, compoundTag);
/*     */   }
/*     */   
/*     */   private ValueInput.ValueInputList wrapList(String name, ValueInputContextHelper context, ListTag list) {
/* 229 */     return list.isEmpty() ? context.emptyList() : new ListWrapper(this.problemReporter, name, context, list);
/*     */   }
/*     */   
/*     */   private <T> ValueInput.TypedInputList<T> wrapTypedList(String name, ListTag list, Codec<T> codec) {
/* 233 */     return list.isEmpty() ? this.context.<T>emptyTypedList() : new TypedListWrapper<>(this.problemReporter, name, this.context, codec, list);
/*     */   }
/*     */   
...
/* 251 */       return this.list.isEmpty();
/*     */     }
/*     */     
/*     */     private ProblemReporter reporterForChild(int index) {
/* 255 */       return this.problemReporter.forChild((ProblemReporter.PathElement)new ProblemReporter.IndexedFieldPathElement(this.name, index));
/*     */     }
/*     */     
/*     */     private void reportIndexUnwrapProblem(int index, Tag value) {
/* 259 */       this.problemReporter.report(new TagValueInput.UnexpectedListElementTypeProblem(this.name, index, CompoundTag.TYPE, value.getType()));
/*     */     }
/*     */ 
/*     */     
...
/*     */               
/*     */               return TagValueInput.wrapChild(reporterForChild((int)index), this.context, compoundTag);
/*     */             } 
/*     */             reportIndexUnwrapProblem((int)index, value);
/*     */             return null;
...
/* 278 */       return (Iterator<ValueInput>)new AbstractIterator<ValueInput>()
/*     */         {
/*     */           private int index;
/*     */           
/*     */           protected ValueInput computeNext() {
/* 283 */             while (iterator.hasNext()) {
/* 284 */               Tag value = iterator.next();
...
/*     */     
/*     */     public boolean isEmpty() {
/* 315 */       return this.list.isEmpty();
/*     */     }
/*     */     
/*     */     private void reportIndexUnwrapProblem(int index, Tag value, DataResult.Error<?> error) {
/* 319 */       this.problemReporter.report(new TagValueInput.DecodeFromListFailedProblem(this.name, index, value, error));
/*     */     }
/*     */ 
/*     */     
...
/* 338 */       return (Iterator<T>)new AbstractIterator<T>()
/*     */         {
...
/* 374 */       return TagValueInput.wrapChild(this.problemReporter.forChild((ProblemReporter.PathElement)new ProblemReporter.IndexedPathElement(index)), this.context, compoundTag);
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean isEmpty() {
/* 379 */       return this.list.isEmpty();
/*     */     }
/*     */ 
/*     */     
/*     */     public Stream<ValueInput> stream() {
/* 384 */       return Streams.mapWithIndex(this.list.stream(), (value, index) -> wrapChild((int)index, value));
/*     */     }
/*     */     
/*     */     public Iterator<ValueInput> iterator()
/*     */     {
/* 389 */       final ListIterator<CompoundTag> iterator = this.list.listIterator();
/* 390 */       return (Iterator<ValueInput>)new AbstractIterator<ValueInput>()
/*     */         {
/*     */           protected ValueInput computeNext() {
/* 393 */             if (iterator.hasNext()) {
/* 394 */               int index = iterator.nextIndex();
/* 395 */               CompoundTag value = iterator.next();
/* 396 */               return TagValueInput.CompoundListWrapper.this.wrapChild(index, value);
/*     */             } 
/* 398 */             return (ValueInput)endOfData(); } }; } } class null extends AbstractIterator<ValueInput> { protected ValueInput computeNext() { if (iterator.hasNext()) { int index = iterator.nextIndex(); CompoundTag value = iterator.next(); return TagValueInput.CompoundListWrapper.this.wrapChild(index, value); }  return (ValueInput)endOfData(); }
/*     */      }
...
/* 407 */       return "Failed to decode value '" + String.valueOf(this.tag) + "' from field '" + this.name + "': " + this.error.message();
/*     */     } }
/*     */   public static final class DecodeFromListFailedProblem extends Record implements ProblemReporter.Problem { private final String name; private final int index; private final Tag tag; private final DataResult.Error<?> error;
/*     */     
...
/*     */     
/*     */     public String description() {
/* 414 */       return "Failed to decode value '" + String.valueOf(this.tag) + "' from field '" + this.name + "' at index " + this.index + "': " + this.error.message();
/*     */     } }
...
/*     */     
/*     */     public String description() {
/* 421 */       return "Failed to decode from map: " + this.error.message();
/*     */     } }
/*     */   public static final class UnexpectedTypeProblem extends Record implements ProblemReporter.Problem { private final String name; private final TagType<?> expected; private final TagType<?> actual;
/*     */     
...
/*     */     
/*     */     public String description() {
/* 428 */       return "Expected field '" + this.name + "' to contain value of type " + this.expected.getName() + ", but got " + this.actual.getName();
/*     */     } }
/*     */   public static final class UnexpectedNonNumberProblem extends Record implements ProblemReporter.Problem { private final String name; private final TagType<?> actual;
/*     */     
...
/*     */     
/*     */     public String description() {
/* 435 */       return "Expected field '" + this.name + "' to contain number, but got " + this.actual.getName();
/*     */     } }
/*     */   public static final class UnexpectedListElementTypeProblem extends Record implements ProblemReporter.Problem { private final String name; private final int index; private final TagType<?> expected; private final TagType<?> actual;
/*     */     
...
/*     */     
/*     */     public String description() {
/* 442 */       return "Expected list '" + this.name + "' to contain at index " + this.index + " value of type " + this.expected.getName() + ", but got " + this.actual.getName();
/*     */     } }
/*     */ 
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/storage/TagValueInput.class
