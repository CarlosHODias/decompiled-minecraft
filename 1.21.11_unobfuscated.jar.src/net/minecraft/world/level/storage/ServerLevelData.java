...
/* 33 */     category.setDetail("Level game mode", () -> String.format(Locale.ROOT, "Game mode: %s (ID %d). Hardcore: %b. Commands: %b", new Object[] { getGameType().getName(), getGameType().getId(), isHardcore(), isAllowCommands() }));
/* 34 */     category.setDetail("Level weather", () -> String.format(Locale.ROOT, "Rain time: %d (now: %b), thunder time: %d (now: %b)", new Object[] { getRainTime(), isRaining(), getThunderTime(), isThundering() }));
/*    */   }
/*    */   
/*    */   String getLevelName();
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/storage/ServerLevelData.class
