...
/*    */   static {
/* 18 */     IDENTITY = ((stack, context) -> stack);
/*    */   }
/*    */ 
/*    */   
...
/*    */   
/* 31 */   public static final Codec<Holder<LootItemFunction>> CODEC = (Codec<Holder<LootItemFunction>>)RegistryFileCodec.create(Registries.ITEM_MODIFIER, ROOT_CODEC);
/*    */   
...
/* 76 */     return (LootItemFunctionType<T>)Registry.register(BuiltInRegistries.LOOT_FUNCTION_TYPE, Identifier.withDefaultNamespace(name), new LootItemFunctionType<>(codec));
/*    */   }
...
/*    */     BiFunction<ItemStack, LootContext, ItemStack> first, second;
/* 80 */     List<BiFunction<ItemStack, LootContext, ItemStack>> terms = List.copyOf(functions);
/* 81 */     switch (terms.size()) { case 0: 
/*    */       case 1:
/*    */       
/*    */       case 2:
/* 85 */         first = terms.get(0);
/* 86 */         second = terms.get(1);
/*    */       default:
/*    */         break; }
/*    */     
/*    */     return (itemStack, context) -> {
/*    */         for (BiFunction<ItemStack, LootContext, ItemStack> function : (Iterable<BiFunction<ItemStack, LootContext, ItemStack>>)terms)
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/storage/loot/functions/LootItemFunctions.class
