...
/*    */   static {
/* 14 */     CODEC = RecordCodecBuilder.mapCodec(i -> commonFields(i).apply((Applicative)i, ApplyExplosionDecay::new));
/*    */   } public static final com.mojang.serialization.MapCodec<ApplyExplosionDecay> CODEC;
...
/* 27 */     Float explosionRadius = (Float)context.getOptionalParameter(net.minecraft.world.level.storage.loot.parameters.LootContextParams.EXPLOSION_RADIUS);
/*    */     
/* 29 */     if (explosionRadius != null) {
/* 30 */       RandomSource random = context.getRandom();
/*    */       
/* 32 */       float probability = 1.0F / explosionRadius;
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/storage/loot/functions/ApplyExplosionDecay.class
