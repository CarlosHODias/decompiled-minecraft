...
/*    */   static {
/* 22 */     CODEC = RecordCodecBuilder.mapCodec(i -> commonFields(i).and(i.group((App)ComponentSerialization.CODEC.sizeLimitedListOf(256).fieldOf("lore").forGetter(()), (App)ListOperation.codec(256).forGetter(()), (App)LootContext.EntityTarget.CODEC.optionalFieldOf("entity").forGetter(()))).apply((Applicative)i, SetLoreFunction::new));
/*    */   }
/*    */ 
/*    */   
...
/* 46 */     return this.resolutionContext.<Set<ContextKey<?>>>map(target -> Set.of(target.contextParam())).orElseGet(Set::of);
/*    */   }
/*    */ 
/*    */   
/*    */   public ItemStack run(ItemStack itemStack, LootContext context) {
/* 51 */     itemStack.update(net.minecraft.core.component.DataComponents.LORE, ItemLore.EMPTY, oldLore -> new ItemLore(updateLore(context, context)));
/* 52 */     return itemStack;
/*    */   }
/*    */   
...
/* 57 */       return List.of();
/*    */     }
/* 59 */     UnaryOperator<Component> resolver = SetNameFunction.createResolver(context, this.resolutionContext.orElse(null));
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/storage/loot/functions/SetLoreFunction.class
