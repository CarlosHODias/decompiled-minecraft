...
/*  22 */     this(reporter, contextKeySet, Optional.of(resolver), Set.of());
/*     */   }
/*     */   
/*     */   public ValidationContext(ProblemReporter reporter, ContextKeySet contextKeySet) {
/*  26 */     this(reporter, contextKeySet, Optional.empty(), Set.of());
/*     */   }
/*     */   
...
/*  37 */     return new ValidationContext(this.reporter.forChild(subContext), this.contextKeySet, this.resolver, this.visitedElements);
/*     */   }
/*     */   
...
/*  42 */     return new ValidationContext(this.reporter.forChild(subContext), this.contextKeySet, this.resolver, (Set<ResourceKey<?>>)immutableSet);
/*     */   }
/*     */   
/*     */   public boolean hasVisitedElement(ResourceKey<?> element) {
/*  46 */     return this.visitedElements.contains(element);
/*     */   }
/*     */   
/*     */   public void reportProblem(ProblemReporter.Problem description) {
/*  50 */     this.reporter.report(description);
/*     */   }
/*     */   
...
/*  57 */       this.reporter.report(new ParametersNotProvidedProblem((Set<ContextKey<?>>)setView));
/*     */     }
/*     */   }
/*     */   
/*     */   public HolderGetter.Provider resolver() {
/*  62 */     return this.resolver.orElseThrow(() -> new UnsupportedOperationException("References not allowed"));
/*     */   }
/*     */   
/*     */   public boolean allowsReferences() {
/*  66 */     return this.resolver.isPresent();
/*     */   }
/*     */   
/*     */   public ValidationContext setContextKeySet(ContextKeySet contextKeySet) {
/*  70 */     return new ValidationContext(this.reporter, contextKeySet, this.resolver, this.visitedElements);
/*     */   }
/*     */   
/*     */   public ProblemReporter reporter() {
/*  74 */     return this.reporter;
/*     */   }
...
/*     */       //   0	8	1	o	Ljava/lang/Object; } public String description() {
/*  80 */       return "Parameters " + String.valueOf(this.notProvided) + " are not provided in this context";
/*     */     } }
...
/*     */       // Local variable table:
/*     */       //   start	length	slot	name	descriptor
/*     */       //   0	7	0	this	Lnet/minecraft/world/level/storage/loot/ValidationContext$ReferenceNotAllowedProblem; } public final int hashCode() { // Byte code:
/*     */       //   0: aload_0
...
/*     */       // Local variable table:
/*     */       //   start	length	slot	name	descriptor
/*     */       //   0	7	0	this	Lnet/minecraft/world/level/storage/loot/ValidationContext$ReferenceNotAllowedProblem; } public final boolean equals(Object o) { // Byte code:
/*     */       //   0: aload_0
/*     */       //   1: aload_1
...
/*  84 */       //   0	8	1	o	Ljava/lang/Object; } public ResourceKey<?> referenced() { return this.referenced; }
/*     */     
/*     */     public String description() {
/*  87 */       return "Reference to " + String.valueOf(this.referenced.identifier()) + " of type " + String.valueOf(this.referenced.registry()) + " was used, but references are not allowed";
/*     */     } }
...
/*     */       // Local variable table:
/*     */       //   start	length	slot	name	descriptor
/*     */       //   0	7	0	this	Lnet/minecraft/world/level/storage/loot/ValidationContext$RecursiveReferenceProblem; } public final int hashCode() { // Byte code:
/*     */       //   0: aload_0
...
/*     */       // Local variable table:
/*     */       //   start	length	slot	name	descriptor
/*     */       //   0	7	0	this	Lnet/minecraft/world/level/storage/loot/ValidationContext$RecursiveReferenceProblem; } public final boolean equals(Object o) { // Byte code:
/*     */       //   0: aload_0
/*     */       //   1: aload_1
...
/*  91 */       //   0	8	1	o	Ljava/lang/Object; } public ResourceKey<?> referenced() { return this.referenced; }
/*     */     
/*     */     public String description() {
...
/*     */     
/*     */     public String description() {
/* 101 */       return "Missing element " + String.valueOf(this.referenced.identifier()) + " of type " + String.valueOf(this.referenced.registry());
/*     */     } }
/*     */ 
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/storage/loot/ValidationContext.class
