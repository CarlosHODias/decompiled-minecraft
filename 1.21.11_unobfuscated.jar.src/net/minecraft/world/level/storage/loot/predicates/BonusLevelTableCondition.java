...
/*    */   public static final com.mojang.serialization.MapCodec<BonusLevelTableCondition> CODEC;
/*    */   
...
/*    */   
/*    */   static {
/* 23 */     CODEC = RecordCodecBuilder.mapCodec(i -> i.group((App)Enchantment.CODEC.fieldOf("enchantment").forGetter(BonusLevelTableCondition::enchantment), (App)net.minecraft.util.ExtraCodecs.nonEmptyList(Codec.FLOAT.listOf()).fieldOf("chances").forGetter(BonusLevelTableCondition::values)).apply((Applicative)i, BonusLevelTableCondition::new));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 35 */     return java.util.Set.of(LootContextParams.TOOL);
/*    */   }
/*    */ 
/*    */   
...
/*    */     
/* 42 */     int level = (tool != null) ? net.minecraft.world.item.enchantment.EnchantmentHelper.getItemEnchantmentLevel(this.enchantment, tool) : 0;
/* 43 */     float chance = (Float)this.values.get(Math.min(level, this.values.size() - 1));
...
/* 48 */     List<Float> chancesList = new java.util.ArrayList<>(chances.length);
/* 49 */     for (float chance : chances) {
/* 50 */       chancesList.add(chance);
/*    */     }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/storage/loot/predicates/BonusLevelTableCondition.class
