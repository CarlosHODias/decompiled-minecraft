...
/* 164 */     return Util.makeEnumMap(DyeColor.class, dye -> register(prefix + "/" + prefix));
/*     */   }
/*     */   
/*     */   private static ResourceKey<LootTable> register(String location) {
/* 168 */     return register(ResourceKey.create(Registries.LOOT_TABLE, Identifier.withDefaultNamespace(location)));
/*     */   }
/*     */   
...
/* 180 */     return IMMUTABLE_LOCATIONS;
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/storage/loot/BuiltInLootTables.class
