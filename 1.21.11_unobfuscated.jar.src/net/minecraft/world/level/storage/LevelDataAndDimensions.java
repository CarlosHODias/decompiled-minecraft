...
/*   */   private final net.minecraft.world.level.levelgen.WorldDimensions.Complete dimensions;
/*   */   
/* 5 */   public LevelDataAndDimensions(WorldData worldData, net.minecraft.world.level.levelgen.WorldDimensions.Complete dimensions) { this.worldData = worldData; this.dimensions = dimensions; } public final String toString() { // Byte code:
/*   */     //   0: aload_0
...
/* 5 */     //   0	8	1	o	Ljava/lang/Object; } public net.minecraft.world.level.levelgen.WorldDimensions.Complete dimensions() { return this.dimensions; }
/*   */    }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/storage/LevelDataAndDimensions.class
