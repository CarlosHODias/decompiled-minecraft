...
/*  63 */     getOrCreateNextSpawnData(level, random, pos).getEntityToSpawn().putString("id", BuiltInRegistries.ENTITY_TYPE.getKey(type).toString());
/*     */   }
/*     */   
/*     */   private boolean isNearPlayer(Level level, BlockPos pos) {
/*  67 */     return level.hasNearbyAlivePlayer(pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, this.requiredPlayerRange);
/*     */   }
/*     */   
...
/*  78 */       level.addParticle((ParticleOptions)ParticleTypes.SMOKE, xP, yP, zP, 0.0D, 0.0D, 0.0D);
/*  79 */       level.addParticle((ParticleOptions)ParticleTypes.FLAME, xP, yP, zP, 0.0D, 0.0D, 0.0D);
/*     */       
...
/*     */     } 
/*     */     
/* 201 */     this.spawnPotentials.getRandom(random).ifPresent(entry -> setNextSpawnData(level, level, pos));
/*     */     
...
/* 210 */       .ifPresent(nextSpawnData -> setNextSpawnData(level, level, pos));
/*     */     
/* 212 */     this
/* 213 */       .spawnPotentials = input.read("SpawnPotentials", SpawnData.LIST_CODEC).orElseGet(() -> WeightedList.of((this.nextSpawnData != null) ? this.nextSpawnData : new SpawnData()));
/*     */     
...
/*     */   }
/*     */   
/*     */   protected void setNextSpawnData(Level level, BlockPos pos, SpawnData nextSpawnData) {
/* 266 */     this.nextSpawnData = nextSpawnData;
/*     */   }
/*     */   
...
/*     */     }
/* 273 */     setNextSpawnData(level, pos, this.spawnPotentials.getRandom(random).orElseGet(SpawnData::new));
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/BaseSpawner.class
