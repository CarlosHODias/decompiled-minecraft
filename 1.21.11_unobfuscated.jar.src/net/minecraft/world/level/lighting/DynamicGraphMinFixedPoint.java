...
/*  82 */     return Math.min(Math.min(level, computedLevel), this.levelCount - 1);
/*     */   }
/*     */   
/*     */   protected void checkNode(long node) {
/*  86 */     checkEdge(node, node, this.levelCount - 1, false);
/*     */   }
/*     */   
...
/* 183 */     return (node == Long.MAX_VALUE);
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/lighting/DynamicGraphMinFixedPoint.class
