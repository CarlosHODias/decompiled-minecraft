...
/*  39 */       return key & (OUTER_MASK ^ 0xFFFFFFFFFFFFFFFFL);
/*     */     }
/*     */     
/*     */     static int getInnerKey(long key) {
/*  43 */       int innerX = (int)(key >>> X_OFFSET & 0x3L);
/*  44 */       int innerY = (int)(key >>> 0L & 0x3L);
...
/*  92 */         this.link[pos] = (this.last & 0xFFFFFFFFL) << 32L | 0xFFFFFFFFL;
/*  93 */         this.last = pos;
/*     */       } 
...
/* 197 */     return this.map.addBit(k);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean rem(long k) {
/* 202 */     return this.map.removeBit(k);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/lighting/SpatialLongSet.class
