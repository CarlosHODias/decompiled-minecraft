...
/*  22 */     this.levelHeightAccessor = (LevelHeightAccessor)chunkSource.getLevel();
...
/* 175 */     return (this.blockEngine == null || (this.blockEngine.storage.lightOnInColumn(sectionZeroNode) && (this.skyEngine == null || 
/* 176 */       this.skyEngine.storage.lightOnInColumn(sectionZeroNode))));
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/lighting/LevelLightEngine.class
