...
/*     */   }
/*     */   
/*     */   private ExplosionDamageCalculator makeDamageCalculator(Entity source) {
/*  68 */     return (source == null) ? EXPLOSION_DAMAGE_CALCULATOR : new EntityBasedExplosionDamageCalculator(source);
/*     */   }
/*     */   
...
/*  83 */     int hits = 0;
/*  84 */     int count = 0;
/*  85 */     for (double xx = 0.0D; xx <= 1.0D; xx += xs) {
/*  86 */       for (double yy = 0.0D; yy <= 1.0D; yy += ys) {
/*  87 */         for (double zz = 0.0D; zz <= 1.0D; zz += zs) {
...
/* 114 */     Set<BlockPos> toBlowSet = new HashSet<>();
/*     */     
/* 116 */     int size = 16;
...
/*     */               }
/*     */               
/* 148 */               Optional<Float> resistance = this.damageCalculator.getBlockExplosionResistance(this, (BlockGetter)this.level, pos, block, fluid);
/* 149 */               if (resistance.isPresent()) {
/* 150 */                 remainingPower -= ((Float)resistance.get() + 0.3F) * 0.3F;
/*     */               }
/*     */               
/* 153 */               if (remainingPower > 0.0F && this.damageCalculator.shouldBlockExplode(this, (BlockGetter)this.level, pos, block, remainingPower)) {
...
/*     */       } 
/*     */     } 
/* 166 */     return (List<BlockPos>)new ObjectArrayList(toBlowSet);
/*     */   }
/*     */   
...
/* 222 */     List<StackCollector> stacks = new ArrayList<>();
...
/* 230 */       Block.popResource((Level)this.level, stack.pos, stack.stack);
/*     */     }
/*     */   }
/*     */   
...
/* 237 */         this.level.setBlockAndUpdate(pos, BaseFireBlock.getState((BlockGetter)this.level, pos));
/*     */       }
/*     */     } 
/*     */   }
/*     */   
...
/* 328 */       return (Boolean)this.level.getGameRules().get(GameRules.MOB_GRIEFING);
/*     */     }
/*     */     
/* 331 */     return true;
/*     */   }
...
/* 336 */     boolean mobGriefingEnabled = (Boolean)this.level.getGameRules().get(GameRules.MOB_GRIEFING);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/ServerExplosion.class
