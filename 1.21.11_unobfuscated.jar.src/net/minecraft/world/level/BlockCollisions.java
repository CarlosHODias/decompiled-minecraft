...
/*  96 */       BlockState blockState = chunk.getBlockState((BlockPos)this.pos);
/*     */       
/*  98 */       if (this.onlySuffocatingBlocks && !blockState.isSuffocating(chunk, (BlockPos)this.pos)) {
/*     */         continue;
/*     */       }
/*     */       
...
/*     */       }
/*     */       
/* 109 */       VoxelShape blockShape = this.context.getCollisionShape(blockState, this.collisionGetter, (BlockPos)this.pos);
/*     */       
/* 111 */       if (blockShape == Shapes.block()) {
/* 112 */         if (this.box.intersects(x, y, z, x + 1.0D, y + 1.0D, z + 1.0D))
/* 113 */           return this.resultProvider.apply(this.pos, blockShape.move((Vec3i)this.pos)); 
/*     */         continue;
/*     */       } 
/* 116 */       VoxelShape shape = blockShape.move((Vec3i)this.pos);
/* 117 */       if (!shape.isEmpty() && Shapes.joinIsNotEmpty(shape, this.entityShape, BooleanOp.AND)) {
/* 118 */         return this.resultProvider.apply(this.pos, shape);
/*     */       }
/*     */     } 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/BlockCollisions.class
