...
/*  24 */     return getEntities(EntityTypeTest.forClass(baseClass), bb, selector);
/*     */   }
/*     */   
/*     */   List<? extends Player> players();
/*     */   
/*     */   default List<Entity> getEntities(Entity except, AABB bb) {
/*  30 */     return getEntities(except, bb, EntitySelector.NO_SPECTATORS);
/*     */   }
/*     */   
...
/*  49 */     return getEntitiesOfClass(baseClass, bb, EntitySelector.NO_SPECTATORS);
/*     */   }
/*     */ 
/*     */   
...
/*     */     }
/*     */     
/*  70 */     return (List<VoxelShape>)shapes.build();
/*     */   }
/*     */   
...
/*  92 */     return getNearestPlayer(source.getX(), source.getY(), source.getZ(), maxDist, false);
/*     */   }
/*     */   
...
/* 115 */       Player player = players().get(i);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/EntityGetter.class
