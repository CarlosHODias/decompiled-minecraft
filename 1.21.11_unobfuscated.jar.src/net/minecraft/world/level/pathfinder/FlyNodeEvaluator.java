...
/*  46 */       BlockState state = this.currentContext.getBlockState((BlockPos)reusableBlockPos);
/*  47 */       while (state.is(Blocks.WATER)) {
/*  48 */         startY++;
/*  49 */         reusableBlockPos.set(this.mob.getX(), startY, this.mob.getZ());
/*  50 */         state = this.currentContext.getBlockState((BlockPos)reusableBlockPos);
/*     */       } 
/*     */     } else {
...
/*  76 */     return getTargetNodeAt(x, y, z);
/*     */   }
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*     */   private boolean hasMalus(Node node) {
/* 220 */     return (node != null && node.costMalus >= 0.0F);
/*     */   }
/*     */   
/*     */   private boolean isOpen(Node node) {
/* 224 */     return (node != null && !node.closed);
/*     */   }
/*     */   
...
/* 249 */     return (PathType)this.pathTypeByPosCache.computeIfAbsent(BlockPos.asLong(x, y, z), key -> getPathTypeOfMob(this.currentContext, x, x, y, this.mob));
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/pathfinder/FlyNodeEvaluator.class
