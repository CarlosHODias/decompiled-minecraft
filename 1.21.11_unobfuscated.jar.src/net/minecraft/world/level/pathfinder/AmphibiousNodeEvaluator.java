...
/*  16 */     this.prefersShallowSwimming = prefersShallowSwimming;
/*     */   }
/*     */ 
/*     */   
...
/*  47 */     return getTargetNodeAt(x, y + 0.5D, z);
/*     */   }
/*     */ 
/*     */   
/*     */   public int getNeighbors(Node[] neighbors, Node pos) {
/*     */     int jumpSize;
/*  53 */     int numValidNeighbors = super.getNeighbors(neighbors, pos);
/*     */ 
/*     */     
...
/*     */   }
/*     */   
/*     */   private boolean isVerticalNeighborValid(Node verticalNode, Node pos) {
/*  90 */     return (isNeighborValid(verticalNode, pos) && verticalNode.type == PathType.WATER);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/pathfinder/AmphibiousNodeEvaluator.class
