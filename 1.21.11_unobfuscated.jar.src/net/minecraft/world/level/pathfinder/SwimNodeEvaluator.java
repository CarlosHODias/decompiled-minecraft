...
/*  45 */     return getTargetNodeAt(x, y, z);
/*     */   }
/*     */ 
/*     */   
...
/*  64 */       if (hasMalus(nodes.get(direction)) && hasMalus(nodes.get(secondDirection))) {
...
/*  75 */     return (node != null && !node.closed);
/*     */   }
/*     */   
/*     */   private static boolean hasMalus(Node node) {
/*  79 */     return (node != null && node.costMalus >= 0.0F);
/*     */   }
/*     */   
...
/* 103 */     return (PathType)this.pathTypesByPosCache.computeIfAbsent(BlockPos.asLong(x, y, z), k -> getPathType(this.currentContext, x, x, y));
/*     */   }
/*     */ 
/*     */   
/*     */   public PathType getPathType(PathfindingContext context, int x, int y, int z) {
/* 108 */     return getPathTypeOfMob(context, x, y, z, this.mob);
/*     */   }
/*     */ 
/*     */   
...
/* 117 */           BlockState blockState1 = context.getBlockState((BlockPos)pos.set(xx, yy, zz));
...
/*     */     } 
/*     */     
/* 129 */     BlockState blockState = context.getBlockState((BlockPos)pos);
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/pathfinder/SwimNodeEvaluator.class
