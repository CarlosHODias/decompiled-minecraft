...
/*  41 */     this.captureDebug = captureDebug;
/*     */   }
/*     */   
/*     */   public void setMaxVisitedNodes(int maxVisitedNodes) {
/*  45 */     this.maxVisitedNodes = maxVisitedNodes;
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/*  56 */     Map<Target, BlockPos> tos = (Map<Target, BlockPos>)targets.stream()
/*  57 */       .collect(Collectors.toMap(pos -> this.nodeEvaluator.getTarget(pos.getX(), pos.getY(), pos.getZ()), Function.identity()));
...
/*  83 */     Set<Node> closedSet = captureDebug ? new HashSet<>() : Set.<Node>of();
/*     */ 
/*     */     
/*  86 */     int count = 0;
/*     */     
...
/*     */     } 
/*     */     
/* 138 */     Optional<Path> optPath = !reachedTargets.isEmpty() ? 
/*     */ 
/*     */       
/* 141 */       reachedTargets.stream().map(target -> reconstructPath(targetMap.getBestNode(), (BlockPos)targetMap.get(targetMap), true)).min(Comparator.comparingInt(Path::getNodeCount)) : 
/*     */ 
/*     */       
/* 144 */       targets.stream().map(target -> reconstructPath(targetMap.getBestNode(), (BlockPos)targetMap.get(targetMap), false)).min(Comparator.<Path>comparingDouble(Path::getDistToTarget).thenComparingInt(Path::getNodeCount));
/*     */     
/* 146 */     profiler.pop();
/* 147 */     if (optPath.isEmpty()) {
/* 148 */       return null;
/*     */     }
/* 150 */     Path path = optPath.get();
/*     */     
/* 152 */     if (captureDebug) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/pathfinder/PathFinder.class
