...
/*  18 */     this.values = (T[])new Object[1 << bits];
/*  19 */     this.bits = bits;
/*  20 */     Validate.isTrue((paletteEntries.size() <= this.values.length), "Can't initialize LinearPalette of size %d with %d entries", new Object[] { this.values.length, paletteEntries.size() });
...
/*  34 */     return new LinearPalette<>(bits, paletteEntries);
/*     */   }
/*     */ 
/*     */   
...
/*  77 */       this.values[i] = (T)globalMap.byIdOrThrow(buffer.readVarInt());
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/chunk/LinearPalette.class
