...
/*   */ public final class RegionStorageInfo extends Record { private final String level;
/*   */   private final net.minecraft.resources.ResourceKey<net.minecraft.world.level.Level> dimension;
/*   */   private final String type;
/*   */   
/* 6 */   public RegionStorageInfo(String level, net.minecraft.resources.ResourceKey<net.minecraft.world.level.Level> dimension, String type) { this.level = level; this.dimension = dimension; this.type = type; } public final String toString() { // Byte code:
/*   */     //   0: aload_0
...
/* 6 */     //   0	8	1	o	Ljava/lang/Object; } public net.minecraft.resources.ResourceKey<net.minecraft.world.level.Level> dimension() { return this.dimension; } public String type() { return this.type; }
/*   */    public RegionStorageInfo withTypeSuffix(String suffix) {
/* 8 */     return new RegionStorageInfo(this.level, this.dimension, this.type + this.type);
/*   */   } }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/chunk/storage/RegionStorageInfo.class
