...
/* 107 */   private final ByteBuffer header = ByteBuffer.allocateDirect(8192);
/*     */   private final IntBuffer offsets;
/*     */   private final IntBuffer timestamps;
/*     */   @VisibleForTesting
/* 111 */   protected final RegionBitmap usedSectors = new RegionBitmap();
/*     */ 
/*     */   
/*     */   public RegionFile(RegionStorageInfo info, Path path, Path externalFileDir, boolean sync) throws IOException {
/* 115 */     this(info, path, externalFileDir, RegionFileVersion.getSelected(), sync);
/*     */   }
/*     */   
...
/* 144 */         LOGGER.warn("Region file {} has truncated header: {}", path, readHeaderBytes);
/*     */       }
/*     */       
...
/* 154 */             LOGGER.warn("Region file {} has invalid sector at index: {}; sector {} overlaps with header", new Object[] { path, i, sectorNumber });
/* 155 */             this.offsets.put(i, 0);
/* 156 */           } else if (numSectors == 0) {
/* 157 */             LOGGER.warn("Region file {} has an invalid sector at index: {}; size has to be > 0", path, i);
/* 158 */             this.offsets.put(i, 0);
/* 159 */           } else if (sectorNumber * 4096L > size) {
/* 160 */             LOGGER.warn("Region file {} has an invalid sector at index: {}; sector {} is out of bounds", new Object[] { path, i, sectorNumber });
...
/* 194 */       LOGGER.error("Chunk {} header is truncated: expected {} but read {}", new Object[] { pos, sectorsLength, buffer.remaining() });
/* 195 */       return null;
/*     */     } 
/*     */     
...
/* 217 */       LOGGER.error("Chunk {} stream is truncated: expected {} but read {}", new Object[] { pos, streamLength, buffer.remaining() });
/* 218 */       return null;
/*     */     } 
/*     */     
/* 221 */     if (streamLength < 0) {
/* 222 */       LOGGER.error("Declared size {} of chunk {} is negative", length, pos);
/* 223 */       return null;
/*     */     } 
/*     */     
...
/*     */     
/* 258 */     if (version == null) {
/* 259 */       LOGGER.error("Chunk {} has invalid chunk stream version {}", pos, versionId);
/* 260 */       return null;
/*     */     } 
...
/* 344 */     return new DataOutputStream(this.version.wrap(new ChunkBuffer(pos)));
/*     */   }
/*     */   
/*     */   public void flush() throws IOException {
/* 348 */     this.file.force(true);
/*     */   }
/*     */   
...
/*     */     int newSectorNumber;
/*     */     CommitOp commitOp;
/* 398 */     int offsetIndex = getOffsetIndex(pos);
...
/* 411 */       LOGGER.warn("Saving oversized chunk {} ({} bytes} to external file {}", new Object[] { pos, dataSize, externalChunkPath });
/* 412 */       sectorsNeeded = 1;
...
/* 443 */     Path tmpPath = Files.createTempFile(this.externalFileDir, "tmp", null, (FileAttribute<?>[])new FileAttribute[0]);
...
/* 457 */     return this.offsets.get(getOffsetIndex(pos));
/*     */   }
/*     */   
/*     */   public boolean hasChunk(ChunkPos pos) {
/* 461 */     return (getOffset(pos) != 0);
/*     */   }
/*     */   
/*     */   private static int getOffsetIndex(ChunkPos pos) {
/* 465 */     return pos.getRegionLocalX() + pos.getRegionLocalZ() * 32;
/*     */   }
/*     */ 
/*     */   
/*     */   public void close() throws IOException {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/chunk/storage/RegionFile.class
