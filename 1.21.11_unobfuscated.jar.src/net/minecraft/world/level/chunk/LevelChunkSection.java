...
/*  47 */     return this.states.get(sectionX, sectionY, sectionZ);
/*     */   }
/*     */   
/*     */   public FluidState getFluidState(int sectionX, int sectionY, int sectionZ) {
/*  51 */     return ((BlockState)this.states.get(sectionX, sectionY, sectionZ)).getFluidState();
/*     */   }
/*     */   
/*     */   public void acquire() {
/*  55 */     this.states.acquire();
/*     */   }
/*     */   
/*     */   public void release() {
/*  59 */     this.states.release();
/*     */   }
/*     */   
/*     */   public BlockState setBlockState(int sectionX, int sectionY, int sectionZ, BlockState state) {
/*  63 */     return setBlockState(sectionX, sectionY, sectionZ, state, true);
/*     */   }
/*     */   
...
/*  69 */       previous = this.states.getAndSet(sectionX, sectionY, sectionZ, state);
/*     */     } else {
/*  71 */       previous = this.states.getAndSetUnchecked(sectionX, sectionY, sectionZ, state);
/*     */     } 
...
/* 102 */     return (this.nonEmptyBlockCount == 0);
/*     */   }
/*     */   
/*     */   public boolean isRandomlyTicking() {
/* 106 */     return (isRandomlyTickingBlocks() || isRandomlyTickingFluids());
/*     */   }
/*     */   
/*     */   public boolean isRandomlyTickingBlocks() {
/* 110 */     return (this.tickingBlockCount > 0);
/*     */   }
/*     */   
/*     */   public boolean isRandomlyTickingFluids() {
/* 114 */     return (this.tickingFluidCount > 0);
/*     */   }
/*     */   
...
/* 152 */     return this.states;
/*     */   }
/*     */   
/*     */   public PalettedContainerRO<Holder<Biome>> getBiomes() {
/* 156 */     return this.biomes;
/*     */   }
/*     */   
...
/* 180 */     return 2 + this.states.getSerializedSize() + this.biomes.getSerializedSize();
/*     */   }
/*     */   
/*     */   public boolean maybeHas(Predicate<BlockState> predicate) {
/* 184 */     return this.states.maybeHas(predicate);
/*     */   }
/*     */   
/*     */   public Holder<Biome> getNoiseBiome(int quartX, int quartY, int quartZ) {
/* 188 */     return this.biomes.get(quartX, quartY, quartZ);
/*     */   }
/*     */   
...
/* 206 */     return new LevelChunkSection(this);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/chunk/LevelChunkSection.class
