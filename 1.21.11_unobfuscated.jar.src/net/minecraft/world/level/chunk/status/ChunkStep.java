...
/*     */   }
/*     */   
/*     */   public java.util.concurrent.CompletableFuture<ChunkAccess> apply(WorldGenContext context, net.minecraft.util.StaticCache2D<GenerationChunkHolder> cache, ChunkAccess chunk) {
/*  30 */     if (chunk.getPersistedStatus().isBefore(this.targetStatus)) {
/*  31 */       ProfiledDuration profiledDuration = net.minecraft.util.profiling.jfr.JvmProfiler.INSTANCE.onChunkGenerate(chunk.getPos(), context.level().dimension(), this.targetStatus.getName());
/*     */       
/*  33 */       return this.task.doWork(context, this, cache, chunk).thenApply(newCenterChunk -> completeChunkGeneration(profiledDuration, profiledDuration));
/*     */     } 
...
/*  83 */         java.util.Arrays.fill((Object[])this.directDependenciesByRadius, status);
/*     */       } 
...
/* 102 */       return new ChunkStep(this.status, new ChunkDependencies(com.google.common.collect.ImmutableList.copyOf((Object[])this.directDependenciesByRadius)), new ChunkDependencies(com.google.common.collect.ImmutableList.copyOf((Object[])buildAccumulatedDependencies())), this.blockStateWriteRadius, this.task);
/*     */     }
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/chunk/status/ChunkStep.class
