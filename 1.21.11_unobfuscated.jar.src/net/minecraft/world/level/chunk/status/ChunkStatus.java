...
/*     */   
/*     */   private static ChunkStatus register(String name, ChunkStatus parent, EnumSet<Heightmap.Types> heightmaps, ChunkType chunkType) {
/*  47 */     return (ChunkStatus)Registry.register((Registry)BuiltInRegistries.CHUNK_STATUS, name, new ChunkStatus(parent, heightmaps, chunkType));
/*     */   }
/*     */   private final ChunkType chunkType; private final EnumSet<Heightmap.Types> heightmapsAfter;
/*     */   public static List<ChunkStatus> getStatusList() {
/*  51 */     List<ChunkStatus> list = Lists.newArrayList();
...
/*  88 */     return (ChunkStatus)BuiltInRegistries.CHUNK_STATUS.getValue(Identifier.tryParse(key));
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/chunk/status/ChunkStatus.class
