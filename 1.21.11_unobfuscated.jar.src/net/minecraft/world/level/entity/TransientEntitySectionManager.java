...
/*  34 */           TransientEntitySectionManager.LOGGER.warn("Entity {} wasn't found in section {} (moving to {})", new Object[] { this.entity, SectionPos.of(this.currentSectionKey), newSectionPos });
/*     */         }
...
/*     */             section.getEntities().filter(()).forEach(this.callbacks::onTickingStart);
/*     */           } 
/*     */         });
/*     */   }
/*     */   
...
/*     */           if (previousStatus.isTicking()) {
/*     */             Objects.requireNonNull(this.callbacks);
/*     */             section.getEntities().filter(()).forEach(this.callbacks::onTickingEnd);
/*     */           } 
/*     */         });
/*     */   }
/*     */   
...
/* 145 */     return "" + this.entityStorage.count() + "," + this.entityStorage.count() + "," + 
/* 146 */       this.sectionStorage.count();
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/entity/TransientEntitySectionManager.class
