...
/* 198 */     HolderLookup.Provider builtIns = new RegistrySetBuilder()
/* 199 */       .add(Registries.DENSITY_FUNCTION, NoiseRouterData::bootstrap)
/* 200 */       .add(Registries.NOISE, NoiseData::bootstrap)
/* 201 */       .build((RegistryAccess)RegistryAccess.fromRegistryOfRegistries(BuiltInRegistries.REGISTRY));
/*     */     
/* 203 */     HolderLookup.RegistryLookup registryLookup = builtIns.lookupOrThrow(Registries.DENSITY_FUNCTION);
/* 204 */     DensityFunctions.Spline.Coordinate continents = new DensityFunctions.Spline.Coordinate((Holder)registryLookup.getOrThrow(NoiseRouterData.CONTINENTS));
/* 205 */     DensityFunctions.Spline.Coordinate erosion = new DensityFunctions.Spline.Coordinate((Holder)registryLookup.getOrThrow(NoiseRouterData.EROSION));
/* 206 */     DensityFunctions.Spline.Coordinate ridges = new DensityFunctions.Spline.Coordinate((Holder)registryLookup.getOrThrow(NoiseRouterData.RIDGES_FOLDED));
/*     */     
...
/*     */     
/* 210 */     CubicSpline<?, ?> erosionOffsetSpline = TerrainProvider.buildErosionOffsetSpline((BoundedFloatFunction)erosion, (BoundedFloatFunction)ridges, -0.15F, 0.0F, 0.0F, 0.1F, 0.0F, -0.03F, false, false, BoundedFloatFunction.IDENTITY);
...
/*     */ 
/*     */     
/* 219 */     CubicSpline<?, ?> overworldOffset = TerrainProvider.overworldOffset((BoundedFloatFunction)continents, (BoundedFloatFunction)erosion, (BoundedFloatFunction)ridges, false);
...
/* 523 */     return (temperatureIndex == 4) ? pickBadlandsBiome(humidityIndex, weirdness) : pickMiddleBiome(temperatureIndex, humidityIndex, weirdness);
/*     */   }
/*     */   
...
/* 527 */     return (temperatureIndex == 0) ? pickSlopeBiome(temperatureIndex, humidityIndex, weirdness) : pickMiddleBiomeOrBadlandsIfHot(temperatureIndex, humidityIndex, weirdness);
/*     */   }
/*     */   
...
/* 607 */     biomes.accept(Pair.of(Climate.parameters(temperature, humidity, continentalness, erosion, Climate.Parameter.span(0.2F, 0.9F), weirdness, offset), biome));
/*     */   }
/*     */   
...
/* 611 */     biomes.accept(Pair.of(Climate.parameters(temperature, humidity, continentalness, erosion, Climate.Parameter.point(1.1F), weirdness, offset), biome));
/*     */   }
/*     */   
...
/* 615 */     return (erosion.compute(context) < -0.22499999403953552D && depth.compute(context) > 0.8999999761581421D);
/*     */   }
/*     */   
...
/* 652 */     return getDebugStringForNoiseValue(erosion, this.erosions);
/*     */   }
/*     */   
/*     */   public String getDebugStringForTemperature(double temperature) {
/* 656 */     return getDebugStringForNoiseValue(temperature, this.temperatures);
/*     */   }
/*     */   
/*     */   public String getDebugStringForHumidity(double humidity) {
/* 660 */     return getDebugStringForNoiseValue(humidity, this.humidities);
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/biome/OverworldBiomeBuilder.class
