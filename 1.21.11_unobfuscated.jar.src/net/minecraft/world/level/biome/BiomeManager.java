...
/*  27 */     return Hashing.sha256().hashLong(seed).asLong();
/*     */   }
/*     */   
/*     */   public BiomeManager withDifferentSource(NoiseBiomeSource biomeSource) {
/*  31 */     return new BiomeManager(biomeSource, this.biomeZoomSeed);
/*     */   }
/*     */   
...
/*  77 */     int biomeZ = ((minI & 0x1) == 0) ? parentZ : (parentZ + 1);
/*     */     
...
/*  97 */     return this.noiseBiomeSource.getNoiseBiome(quartX, quartY, quartZ);
/*     */   }
/*     */   
...
/* 124 */     double uniform = Math.floorMod(rval >> 24L, 1024) / 1024.0D;
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/biome/BiomeManager.class
