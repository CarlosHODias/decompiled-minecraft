...
/*     */     
/*  83 */     for (BlockPos testPos : (Iterable<BlockPos>)BlockPos.betweenClosed(origin, origin.offset(dist - 1, dist - 1, dist - 1))) {
...
/* 102 */     return CacheBuilder.newBuilder().build(new BlockCacheLoader(level, loadChunks));
/*     */   }
/*     */   
...
/*     */     
/* 114 */     return origin.offset(
/* 115 */         upVector.getX() * -down + rightVector.getX() * right + forwardsVector.getX() * forwards, 
/* 116 */         upVector.getY() * -down + rightVector.getY() * right + forwardsVector.getY() * forwards, 
/* 117 */         upVector.getZ() * -down + rightVector.getZ() * right + forwardsVector.getZ() * forwards);
/*     */   }
/*     */   
...
/* 132 */       return new BlockInWorld(this.level, key, this.loadChunks);
/*     */     }
/*     */   }
/*     */   
...
/* 180 */       return (BlockInWorld)this.cache.getUnchecked(BlockPattern.translateAndRotate(this.frontTopLeft, getForwards(), getUp(), right, down, forwards));
/*     */     }
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/state/pattern/BlockPattern.class
