...
/*     */   static {
/*  66 */     FACING_HOPPER = EnumProperty.create("facing", Direction.class, direction -> (direction != Direction.UP));
/*  67 */   } public static final EnumProperty<Direction> HORIZONTAL_FACING = EnumProperty.create("facing", Direction.class, (Predicate<Direction>)Direction.Plane.HORIZONTAL);
...
/*     */   
/*  90 */   public static final EnumProperty<RailShape> RAIL_SHAPE = EnumProperty.create("shape", RailShape.class); static {
/*  91 */     RAIL_SHAPE_STRAIGHT = EnumProperty.create("shape", RailShape.class, railShape -> 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/state/properties/BlockStateProperties.class
