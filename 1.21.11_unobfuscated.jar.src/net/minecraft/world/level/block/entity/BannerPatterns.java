...
/*  54 */     return ResourceKey.create(Registries.BANNER_PATTERN, Identifier.withDefaultNamespace(id));
/*     */   }
/*     */   
...
/* 105 */     context.register(key, new BannerPattern(
/* 106 */           key.identifier(), "block.minecraft.banner." + 
/* 107 */           key.identifier().toShortLanguageKey()));
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/entity/BannerPatterns.class
