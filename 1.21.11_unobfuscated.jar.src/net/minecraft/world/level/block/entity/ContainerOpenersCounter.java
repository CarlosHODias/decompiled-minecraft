...
/* 35 */       level.gameEvent((Entity)entity, (Holder)GameEvent.CONTAINER_OPEN, pos);
...
/* 46 */       level.gameEvent((Entity)entity, (Holder)GameEvent.CONTAINER_CLOSE, pos);
...
/* 55 */     return (List<ContainerUser>)level.getEntities(null, searchBox, entity -> hasContainerOpen(pos, pos)).stream()
...
/* 81 */         level.gameEvent(null, (Holder)GameEvent.CONTAINER_OPEN, pos);
/* 82 */       } else if (!isOpen) {
/* 83 */         onClose(level, pos, blockState);
/* 84 */         level.gameEvent(null, (Holder)GameEvent.CONTAINER_CLOSE, pos);
/*    */       } 
...
/* 99 */     level.scheduleTick(blockPos, blockState.getBlock(), 5);
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/entity/ContainerOpenersCounter.class
