...
/*     */   
/*  62 */   private static final Set<Holder<MobEffect>> VALID_EFFECTS = (Set<Holder<MobEffect>>)BEACON_EFFECTS.stream().flatMap(Collection::stream).collect(Collectors.toSet());
/*     */   
...
/*  70 */   private static final Component DEFAULT_NAME = (Component)Component.translatable("container.beacon");
/*     */   
...
/*  91 */         switch (dataId) { case 0: case 1: case 2: default: break; }  return 
/*     */ 
/*     */ 
/*     */           
/*  95 */           0;
...
/*     */     };
/*     */   
/*     */   private static Holder<MobEffect> filterEffect(Holder<MobEffect> effect) {
/* 120 */     return VALID_EFFECTS.contains(effect) ? effect : null;
/*     */   }
/*     */   
/*     */   public BeaconBlockEntity(BlockPos worldPosition, BlockState blockState) {
/* 124 */     super(BlockEntityType.BEACON, worldPosition, blockState);
/*     */   }
...
/*     */     } 
/*     */     
/* 141 */     BeaconBeamOwner.Section lastBeamSection = entity.checkingBeamSections.isEmpty() ? null : entity.checkingBeamSections.get(entity.checkingBeamSections.size() - 1);
/*     */     
...
/*     */           
/* 203 */           for (ServerPlayer player : (Iterable<ServerPlayer>)level.getEntitiesOfClass(ServerPlayer.class, new AABB(x, y, z, x, (y - 4), z).inflate(10.0D, 5.0D, 10.0D))) {
...
/* 273 */     level.playSound(null, worldPosition, event, SoundSource.BLOCKS, 1.0F, 1.0F);
/*     */   }
/*     */ 
/*     */   
/*     */   public List<BeaconBeamOwner.Section> getBeamSections() {
/* 278 */     return (this.levels == 0) ? (List<BeaconBeamOwner.Section>)ImmutableList.of() : this.beamSections;
/*     */   }
/*     */ 
/*     */   
/*     */   public ClientboundBlockEntityDataPacket getUpdatePacket() {
/* 283 */     return ClientboundBlockEntityDataPacket.create(this);
/*     */   }
/*     */ 
/*     */   
/*     */   public CompoundTag getUpdateTag(HolderLookup.Provider registries) {
/* 288 */     return saveCustomOnly(registries);
/*     */   }
/*     */   
...
/*     */ 
/*     */   
/*     */   private static Holder<MobEffect> loadEffect(ValueInput input, String field) {
/* 299 */     Objects.requireNonNull(VALID_EFFECTS); return input.read(field, BuiltInRegistries.MOB_EFFECT.holderByNameCodec()).filter(VALID_EFFECTS::contains)
/* 300 */       .orElse(null);
/*     */   }
/*     */ 
/*     */   
...
/* 340 */       return (AbstractContainerMenu)new BeaconMenu(containerId, (Container)inventory, this.dataAccess, ContainerLevelAccess.create(this.level, getBlockPos()));
/*     */     }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/entity/BeaconBlockEntity.class
