...
/*    */ 
/*    */ public final class BannerPatternLayers extends Record implements net.minecraft.world.item.component.TooltipProvider {
...
/* 33 */   public static final StreamCodec<RegistryFriendlyByteBuf, BannerPatternLayers> STREAM_CODEC = Layer.STREAM_CODEC.apply(net.minecraft.network.codec.ByteBufCodecs.list()).map(BannerPatternLayers::new, BannerPatternLayers::layers);
/*    */   
/*    */   public BannerPatternLayers removeLast() {
/* 36 */     return new BannerPatternLayers(List.copyOf(this.layers.subList(0, this.layers.size() - 1)));
/*    */   }
/*    */ 
/*    */   
/*    */   public void addToTooltip(Item.TooltipContext context, Consumer<Component> consumer, net.minecraft.world.item.TooltipFlag flag, net.minecraft.core.component.DataComponentGetter components) {
/* 41 */     for (int i = 0; i < Math.min(layers().size(), 6); i++)
/* 42 */       consumer.accept(((Layer)layers().get(i)).description().withStyle(net.minecraft.ChatFormatting.GRAY)); 
/*    */   }
/*    */   public static final class Layer extends Record { private final Holder<BannerPattern> pattern; private final DyeColor color; public static final Codec<Layer> CODEC;
/*    */     
...
/*    */       // Local variable table:
/*    */       //   start	length	slot	name	descriptor
/* 46 */       //   0	7	0	this	Lnet/minecraft/world/level/block/entity/BannerPatternLayers$Layer; } public Holder<BannerPattern> pattern() { return this.pattern; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/* 46 */       //   0	8	1	o	Ljava/lang/Object; } public DyeColor color() { return this.color; } static {
/* 47 */       CODEC = RecordCodecBuilder.create(i -> i.group((App)BannerPattern.CODEC.fieldOf("pattern").forGetter(Layer::pattern), (App)DyeColor.CODEC.fieldOf("color").forGetter(Layer::color)).apply((Applicative)i, Layer::new));
/*    */     }
/*    */ 
/*    */ 
/*    */     
...
/*    */ 
/*    */     
/*    */     public net.minecraft.network.chat.MutableComponent description() {
/* 59 */       String prefix = ((BannerPattern)this.pattern.value()).translationKey();
/* 60 */       return Component.translatable(prefix + "." + prefix);
/*    */     } }
/*    */   public static class Builder { private final ImmutableList.Builder<BannerPatternLayers.Layer> layers;
/*    */     
/*    */     public Builder() {
/* 65 */       this.layers = ImmutableList.builder();
/*    */     }
/*    */ 
/*    */ 
/*    */     
...
/* 75 */         return this;
/*    */       } 
/* 77 */       return add((Holder<BannerPattern>)pattern.get(), color);
/*    */     }
/*    */     
/*    */     public Builder add(Holder<BannerPattern> pattern, DyeColor color) {
/* 81 */       return add(new BannerPatternLayers.Layer(pattern, color));
/*    */     }
/*    */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/entity/BannerPatternLayers.class
