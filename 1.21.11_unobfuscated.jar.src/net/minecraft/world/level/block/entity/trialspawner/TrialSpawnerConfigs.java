...
/*     */ 
/*     */   
/*     */   private static <T extends net.minecraft.world.entity.Entity> SpawnData spawnData(EntityType<T> type) {
/* 339 */     return customSpawnDataWithEquipment(type, tag -> {  }, null);
/*     */   }
/*     */   
/*     */   private static <T extends net.minecraft.world.entity.Entity> SpawnData customSpawnData(EntityType<T> type, Consumer<CompoundTag> tagModifier) {
/* 343 */     return customSpawnDataWithEquipment(type, tagModifier, null);
/*     */   }
/*     */   
/*     */   private static <T extends net.minecraft.world.entity.Entity> SpawnData spawnDataWithEquipment(EntityType<T> type, ResourceKey<LootTable> equipmentLootTable) {
/* 347 */     return customSpawnDataWithEquipment(type, tag -> {  }, equipmentLootTable);
/*     */   }
/*     */   
...
/* 354 */     Optional<EquipmentTable> table = Optional.<ResourceKey<LootTable>>ofNullable(equipmentLootTable).map(lootTable -> new EquipmentTable(lootTable, 0.0F));
...
/* 364 */     return ResourceKey.create(Registries.TRIAL_SPAWNER_CONFIG, Identifier.withDefaultNamespace(id));
/*     */   }
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/entity/trialspawner/TrialSpawnerConfigs.class
