...
/*  69 */     return ITEM_TO_POT_TEXTURE.get(item);
/*     */   }
/*     */   
/*     */   private static ResourceKey<DecoratedPotPattern> create(String id) {
/*  73 */     return ResourceKey.create(Registries.DECORATED_POT_PATTERN, Identifier.withDefaultNamespace(id));
/*     */   }
/*     */   
...
/* 105 */     return (DecoratedPotPattern)Registry.register(registry, id, new DecoratedPotPattern(Identifier.withDefaultNamespace(assetId)));
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/entity/DecoratedPotPatterns.class
