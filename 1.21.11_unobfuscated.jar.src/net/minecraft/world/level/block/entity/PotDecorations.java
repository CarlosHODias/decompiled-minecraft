...
/*    */ 
/*    */ public final class PotDecorations extends Record implements net.minecraft.world.item.component.TooltipProvider {
...
/*    */   
/* 27 */   public static final Codec<PotDecorations> CODEC = net.minecraft.core.registries.BuiltInRegistries.ITEM.byNameCodec().sizeLimitedListOf(4).xmap(PotDecorations::new, PotDecorations::ordered);
/* 28 */   public static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, PotDecorations> STREAM_CODEC = ByteBufCodecs.registry(Registries.ITEM).apply(ByteBufCodecs.list(4)).map(PotDecorations::new, PotDecorations::ordered);
/*    */   
/*    */   private PotDecorations(List<Item> items) {
/* 31 */     this(getItem(items, 0), getItem(items, 1), getItem(items, 2), getItem(items, 3));
/*    */   }
/*    */   
/*    */   public PotDecorations(Item back, Item left, Item right, Item front) {
/* 35 */     this(List.of(back, left, right, front));
/*    */   }
/*    */   
...
/*    */     }
/* 42 */     Item item = sherds.get(i);
/* 43 */     return (item == Items.BRICK) ? Optional.<Item>empty() : Optional.<Item>of(item);
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   public List<Item> ordered() {
/* 49 */     return Stream.<Optional>of(new Optional[] { this.back, this.left, this.right, this.front }).map(item -> (Item)item.orElse(Items.BRICK)).toList();
/*    */   }
/*    */ 
/*    */   
...
/* 65 */     consumer.accept(new net.minecraft.world.item.ItemStack((net.minecraft.world.level.ItemLike)side.orElse(Items.BRICK), 1).getHoverName().plainCopy().withStyle(net.minecraft.ChatFormatting.GRAY));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/entity/PotDecorations.class
