...
/* 24 */         level.playSound(null, pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, SoundEvents.ENDER_CHEST_CLOSE, SoundSource.BLOCKS, 0.5F, level.random.nextFloat() * 0.1F + 0.9F);
/*    */       }
/*    */ 
/*    */       
/*    */       protected void openerCountChanged(Level level, BlockPos pos, BlockState blockState, int previous, int current) {
/* 29 */         level.blockEvent(EnderChestBlockEntity.this.worldPosition, Blocks.ENDER_CHEST, 1, current);
/*    */       }
/*    */ 
/*    */       
/*    */       public boolean isOwnContainer(Player player) {
/* 34 */         return player.getEnderChestInventory().isActiveChest(EnderChestBlockEntity.this);
/*    */       }
/*    */     };
/*    */   
/*    */   public EnderChestBlockEntity(BlockPos worldPosition, BlockState blockState) {
/* 39 */     super(BlockEntityType.ENDER_CHEST, worldPosition, blockState);
/*    */   }
/*    */   
/*    */   public static void lidAnimateTick(Level level, BlockPos pos, BlockState state, EnderChestBlockEntity entity) {
/* 43 */     entity.chestLidController.tickLid();
/*    */   }
/*    */ 
/*    */   
...
/* 68 */     return Container.stillValidBlockEntity(this, player);
/*    */   }
/*    */   
...
/* 79 */     return this.chestLidController.getOpenness(a);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/entity/EnderChestBlockEntity.class
