...
/*     */   
/*     */   public static Identifier getKey(BlockEntityType<?> type) {
/*  27 */     return BuiltInRegistries.BLOCK_ENTITY_TYPE.getKey(type);
/*     */   }
/*     */   
...
/*  86 */     return (BlockEntityType<T>)Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, name, new BlockEntityType<>(factory, Set.of(validBlocks)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 104 */   private final Holder.Reference<BlockEntityType<?>> builtInRegistryHolder = BuiltInRegistries.BLOCK_ENTITY_TYPE.createIntrusiveHolder(this);
/*     */   
...
/* 112 */     return this.factory.create(worldPosition, blockState);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 119 */     return this.validBlocks.contains(state.getBlock());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 127 */     return this.builtInRegistryHolder;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 145 */     return OP_ONLY_CUSTOM_DATA.contains(this);
/*     */   }
/*     */   
/*     */   @FunctionalInterface
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/entity/BlockEntityType.class
