...
/* 29 */     if ((Boolean)level.environmentAttributes().getValue(net.minecraft.world.attribute.EnvironmentAttributes.WATER_EVAPORATES, pos)) {
...
/* 44 */     if (state.canOcclude() && blockState.isFaceSturdy((BlockGetter)level, relativePos, direction.getOpposite())) {
/*    */       return;
/*    */     }
/*    */     
...
/*    */     } 
/*    */     
/* 77 */     level.addParticle((ParticleOptions)net.minecraft.core.particles.ParticleTypes.DRIPPING_WATER, xx, yy, zz, 0.0D, 0.0D, 0.0D);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/WetSpongeBlock.class
