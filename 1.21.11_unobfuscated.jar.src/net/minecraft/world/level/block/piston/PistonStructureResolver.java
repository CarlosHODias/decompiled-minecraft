...
/*  62 */       BlockPos pos = this.toPush.get(i);
/*     */ 
/*     */       
...
/*  77 */     return (state.is(Blocks.SLIME_BLOCK) || state.is(Blocks.HONEY_BLOCK));
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 137 */     for (int j = 1;; j++) {
/* 138 */       BlockPos pos = start.relative(this.pushDirection, j);
/*     */       
...
/*     */ 
/*     */         
/* 148 */         for (int k = 0; k <= collisionPos + blocksAdded; k++) {
/* 149 */           BlockPos blockPos = this.toPush.get(k);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/piston/PistonStructureResolver.class
