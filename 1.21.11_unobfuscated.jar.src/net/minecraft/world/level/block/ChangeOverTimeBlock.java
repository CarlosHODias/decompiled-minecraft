...
/* 37 */     int olderCount = 0;
/* 38 */     for (BlockPos blockPos : (Iterable<BlockPos>)BlockPos.withinManhattan(pos, 4, 4, 4)) {
/* 39 */       int manhattanDistance = blockPos.distManhattan((Vec3i)pos);
...
/*    */         
/* 49 */         Enum<?> neighborAge = (Enum<?>)neighborBlock.getAge();
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/ChangeOverTimeBlock.class
