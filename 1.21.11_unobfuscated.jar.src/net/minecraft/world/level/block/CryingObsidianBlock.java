...
/* 35 */     if (state.canOcclude() && blockState.isFaceSturdy((net.minecraft.world.level.BlockGetter)level, relativePos, dir.getOpposite())) {
/*    */       return;
/*    */     }
/*    */     
...
/*    */     
/* 43 */     level.addParticle((net.minecraft.core.particles.ParticleOptions)net.minecraft.core.particles.ParticleTypes.DRIPPING_OBSIDIAN_TEAR, pos.getX() + xOffset, pos.getY() + yOffset, pos.getZ() + zOffset, 0.0D, 0.0D, 0.0D);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/CryingObsidianBlock.class
