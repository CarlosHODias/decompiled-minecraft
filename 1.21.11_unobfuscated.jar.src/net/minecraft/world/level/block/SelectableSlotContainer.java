...
/* 19 */     return getRelativeHitCoordinatesForBlockFace(hitResult, blockFacing)
/* 20 */       .<OptionalInt>map(hitCoords -> {
/*    */           int row = getSection(1.0F - hitCoords.y, getRows()), column = getSection(hitCoords.x, getColumns());
/*    */           
/*    */           return OptionalInt.of(column + row * getColumns());
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/SelectableSlotContainer.class
