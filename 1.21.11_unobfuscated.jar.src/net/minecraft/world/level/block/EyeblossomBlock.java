...
/*     */   public static final MapCodec<EyeblossomBlock> CODEC;
/*     */   
/*     */   static {
/*  31 */     CODEC = RecordCodecBuilder.mapCodec(i -> i.group((App)Codec.BOOL.fieldOf("open").forGetter(()), (App)propertiesCodec()).apply((Applicative)i, EyeblossomBlock::new));
/*     */   }
...
/*     */     
/*     */     public Block block() {
/*  62 */       return this.open ? Blocks.OPEN_EYEBLOSSOM : Blocks.CLOSED_EYEBLOSSOM;
/*     */     }
/*     */     
/*     */     public BlockState state() {
/*  66 */       return block().defaultBlockState();
/*     */     }
/*     */     
/*     */     public Type transform() {
/*  70 */       return fromBoolean(!this.open);
/*     */     }
/*     */     
...
/*  87 */       level.sendParticles((net.minecraft.core.particles.ParticleOptions)particle, start.x, start.y, start.z, 1, 0.0D, 0.0D, 0.0D, 0.0D);
/*     */     }
/*     */     
/*     */     public SoundEvent longSwitchSound() {
/*  91 */       return this.longSwitchSound;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 137 */     boolean shouldBeOpen = ((net.minecraft.util.TriState)level.environmentAttributes().getValue(net.minecraft.world.attribute.EnvironmentAttributes.EYEBLOSSOM_OPEN, pos)).toBoolean(this.type.open);
/* 138 */     if (shouldBeOpen == this.type.open) {
/* 139 */       return false;
/*     */     }
/* 141 */     Type newType = this.type.transform();
/* 142 */     level.setBlock(pos, newType.state(), 3);
/* 143 */     level.gameEvent((Holder)net.minecraft.world.level.gameevent.GameEvent.BLOCK_CHANGE, pos, net.minecraft.world.level.gameevent.GameEvent.Context.of(state));
...
/*     */             int delay = random.nextIntBetweenInclusive((int)(distance * 5.0D), (int)(distance * 10.0D));
...
/* 159 */       level.getDifficulty() != net.minecraft.world.Difficulty.PEACEFUL && entity instanceof Bee) {
...
/* 169 */     return new MobEffectInstance(MobEffects.POISON, 25);
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/EyeblossomBlock.class
