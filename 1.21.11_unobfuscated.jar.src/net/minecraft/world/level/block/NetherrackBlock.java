...
/*    */     }
/*    */     
/* 30 */     for (BlockPos blockPos : (Iterable<BlockPos>)BlockPos.betweenClosed(pos.offset(-1, -1, -1), pos.offset(1, 1, 1))) {
/* 31 */       if (level.getBlockState(blockPos).is(net.minecraft.tags.BlockTags.NYLIUM)) {
/* 32 */         return true;
/*    */       }
/*    */     } 
/* 35 */     return false;
...
/* 47 */     for (BlockPos blockPos : (Iterable<BlockPos>)BlockPos.betweenClosed(pos.offset(-1, -1, -1), pos.offset(1, 1, 1))) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/NetherrackBlock.class
