...
/*  62 */     return (entity instanceof net.minecraft.world.entity.LivingEntity || entity instanceof net.minecraft.world.entity.vehicle.minecart.AbstractMinecart || entity instanceof net.minecraft.world.entity.item.PrimedTnt || entity instanceof net.minecraft.world.entity.vehicle.boat.AbstractBoat);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 100 */     return deltaY / 0.9800000190734863D + 0.08D;
/*     */   }
/*     */   
/*     */   private static double getNewDeltaY(double deltaY) {
/* 104 */     return (deltaY - 0.08D) * 0.9800000190734863D;
/*     */   }
/*     */   
...
/* 160 */     showParticles(entity, 5);
/*     */   }
/*     */   
/*     */   public static void showJumpParticles(Entity entity) {
/* 164 */     showParticles(entity, 10);
/*     */   }
/*     */   
...
/*     */     {
/* 175 */       entity.level().addParticle((ParticleOptions)new BlockParticleOption(ParticleTypes.BLOCK, blockState), entity.getX(), entity.getY(), entity.getZ(), 0.0D, 0.0D, 0.0D);
/*     */     }
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/HoneyBlock.class
