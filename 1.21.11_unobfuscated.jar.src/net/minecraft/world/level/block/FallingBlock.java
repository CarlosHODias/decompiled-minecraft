...
/* 33 */     level.scheduleTick(pos, this, getDelayAfterPlace());
/*    */   }
/*    */ 
/*    */   
...
/*    */     }
/*    */     
/* 49 */     FallingBlockEntity entity = FallingBlockEntity.fall((Level)level, pos, state);
/* 50 */     falling(entity);
/*    */   }
/*    */ 
/*    */   
...
/* 62 */     return (state.isAir() || state.is(BlockTags.FIRE) || state.liquid() || state.canBeReplaced());
/*    */   }
/*    */ 
/*    */   
...
/* 71 */         ParticleUtils.spawnParticleBelow(level, pos, random, (ParticleOptions)new BlockParticleOption(ParticleTypes.FALLING_DUST, state)); 
/*    */     } 
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/FallingBlock.class
