...
/* 25 */     super(properties, net.minecraft.core.cauldron.CauldronInteraction.EMPTY);
/*    */   }
/*    */ 
/*    */   
...
/* 50 */       level.gameEvent(null, (Holder)GameEvent.BLOCK_CHANGE, pos);
...
/* 53 */       level.gameEvent(null, (Holder)GameEvent.BLOCK_CHANGE, pos);
/*    */     } 
/*    */   }
/*    */ 
/*    */   
...
/* 67 */       level.gameEvent((Holder)GameEvent.BLOCK_CHANGE, pos, GameEvent.Context.of(newState));
...
/* 72 */       level.gameEvent((Holder)GameEvent.BLOCK_CHANGE, pos, GameEvent.Context.of(newState));
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/block/CauldronBlock.class
