...
/*     */   
/*  15 */   public GameEvent(int notificationRadius) { this.notificationRadius = notificationRadius; } public final String toString() { // Byte code:
/*     */     //   0: aload_0
...
/*     */     //   0	7	0	this	Lnet/minecraft/world/level/gameevent/GameEvent; } public final int hashCode() { // Byte code:
/*     */     //   0: aload_0
...
/*     */   
/*  82 */   public static final Codec<Holder<GameEvent>> CODEC = (Codec<Holder<GameEvent>>)net.minecraft.resources.RegistryFixedCodec.create(Registries.GAME_EVENT);
/*     */   
/*     */   public static Holder<GameEvent> bootstrap(Registry<GameEvent> registry) {
/*  85 */     return (Holder<GameEvent>)BLOCK_ACTIVATE;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  95 */     return this.notificationRadius;
/*     */   }
/*     */   
/*     */   private static Holder.Reference<GameEvent> register(String name) {
/*  99 */     return register(name, 16);
/*     */   }
/*     */   
/*     */   private static Holder.Reference<GameEvent> register(String name, int notificationRadius) {
/* 103 */     return Registry.registerForHolder((Registry)net.minecraft.core.registries.BuiltInRegistries.GAME_EVENT, Identifier.withDefaultNamespace(name), new GameEvent(notificationRadius));
/*     */   }
...
/*     */      public static Context of(Entity sourceEntity) {
/* 108 */       return new Context(sourceEntity, null);
/*     */     }
/*     */     
/*     */     public static Context of(BlockState state) {
/* 112 */       return new Context(null, state);
/*     */     }
/*     */     
/*     */     public static Context of(Entity sourceEntity, BlockState state) {
/* 116 */       return new Context(sourceEntity, state);
/*     */     } }
/*     */ 
/*     */   
...
/* 137 */       return Double.compare(this.distanceToRecipient, other.distanceToRecipient);
/*     */     }
/*     */     
/*     */     public Holder<GameEvent> gameEvent() {
/* 141 */       return this.gameEvent;
/*     */     }
/*     */     
/*     */     public Vec3 source() {
...
/* 153 */       return this.recipient;
/*     */     }
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/gameevent/GameEvent.class
