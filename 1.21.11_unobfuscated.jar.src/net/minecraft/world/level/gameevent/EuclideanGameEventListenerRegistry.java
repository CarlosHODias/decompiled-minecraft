...
/*  20 */   private final java.util.Set<GameEventListener> listenersToRemove = Sets.newHashSet();
...
/*  90 */         GameEventListener listener = iterator.next();
...
/*  98 */           action.visit(listener, optionalPosition.get());
/*  99 */           applicable = true;
/*     */         } 
/*     */       } 
/*     */     } finally {
...
/* 119 */     Optional<Vec3> position = listener.getListenerSource().getPosition((Level)level);
/*     */     
/* 121 */     if (position.isEmpty()) {
/* 122 */       return Optional.empty();
/*     */     }
/*     */     
/* 125 */     double distanceFromOrigin = BlockPos.containing((Position)position.get()).distSqr((Vec3i)BlockPos.containing((Position)sourcePosition));
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/gameevent/EuclideanGameEventListenerRegistry.class
