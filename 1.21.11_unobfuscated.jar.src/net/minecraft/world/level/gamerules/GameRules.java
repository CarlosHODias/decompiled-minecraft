...
/*  22 */     return GameRuleMap.CODEC.xmap(map -> new GameRules(enabledFeatures, map), gameRules -> gameRules.rules);
/*     */   }
/*     */   
...
/*  93 */     this.rules = GameRuleMap.of(BuiltInRegistries.GAME_RULE.filterFeatures(enabledFeatures).listElements().map(Holder::value));
/*     */   }
/*     */   
...
/* 101 */     T value = this.rules.get(gameRule);
/* 102 */     if (value == null) {
...
/* 119 */     return new GameRules(enabledFeatures, this.rules);
/*     */   }
/*     */   
/*     */   public void setAll(GameRules other, MinecraftServer server) {
/* 123 */     setAll(other.rules, server);
/*     */   }
/*     */   
/*     */   public void setAll(GameRuleMap gameRulesMap, MinecraftServer server) {
/* 127 */     gameRulesMap.keySet().forEach(gameRule -> setFromOther(gameRulesMap, server, gameRulesMap));
/*     */   }
/*     */   
/*     */   private <T> void setFromOther(GameRuleMap gameRulesMap, GameRule<T> gameRule, MinecraftServer server) {
/* 131 */     set(gameRule, Objects.requireNonNull(gameRulesMap.get(gameRule)), server);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */         
/* 150 */         (ArgumentType<Boolean>)BoolArgumentType.bool(), (Codec<Boolean>)Codec.BOOL, defaultValue, 
/*     */ 
/*     */         
/* 153 */         FeatureFlagSet.of(), GameRuleTypeVisitor::visitBoolean, b -> b ? 1 : 0);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 160 */     return registerInteger(id, category, defaultValue, min, Integer.MAX_VALUE, FeatureFlagSet.of());
/*     */   }
/*     */   
/*     */   private static GameRule<Integer> registerInteger(String id, GameRuleCategory category, int defaultValue, int min, int max) {
/* 164 */     return registerInteger(id, category, defaultValue, min, max, FeatureFlagSet.of());
/*     */   }
/*     */   
...
/*     */ 
/*     */         
/* 172 */         (ArgumentType<Integer>)IntegerArgumentType.integer(min, max), 
/* 173 */         Codec.intRange(min, max), defaultValue, 
/* 174 */         requiredFeatures, GameRuleTypeVisitor::visitInteger, i -> i);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 192 */     return (GameRule<T>)Registry.register(BuiltInRegistries.GAME_RULE, id, new GameRule<>(category, typeHint, argumentType, visitorCaller, codec, commandResultFunction, defaultValue, requiredFeatures));
/*     */   }
/*     */   
...
/* 200 */     return gameRule.serialize(get(gameRule));
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/gamerules/GameRules.class
