...
/* 11 */     //   0	7	0	this	Lnet/minecraft/world/level/gamerules/GameRuleCategory; } public Identifier id() { return this.id; }
...
/* 12 */     //   0	8	1	o	Ljava/lang/Object; } private static final java.util.List<GameRuleCategory> SORT_ORDER = new ArrayList<>();
...
/* 26 */     return register(Identifier.withDefaultNamespace(name));
/*    */   }
/*    */   
...
/* 32 */       throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Category '%s' is already registered.", new Object[] { id }));
/*    */     }
...
/* 39 */     return Component.translatable(this.id.toLanguageKey("gamerule.category"));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/gamerules/GameRuleCategory.class
