...
/*    */   
/*    */   void shapeUpdate(Direction paramDirection, BlockState paramBlockState, BlockPos paramBlockPos1, BlockPos paramBlockPos2, @Block.UpdateFlags int paramInt1, int paramInt2);
/*    */   
...
/*    */       return;
/*    */     }
/* 40 */     BlockState newState = currentState.updateShape((LevelReader)level, (ScheduledTickAccess)level, pos, direction, neighborPos, neighborState, level.getRandom());
...
/*    */             try {
/*    */               return String.format(Locale.ROOT, "ID #%s (%s // %s)", new Object[] { BuiltInRegistries.BLOCK.getKey(changedBlock), changedBlock.getDescriptionId(), changedBlock.getClass().getCanonicalName() });
/* 54 */             } catch (Throwable ignored) {
/*    */               return "ID #" + String.valueOf(BuiltInRegistries.BLOCK.getKey(changedBlock));
/*    */             } 
/*    */           });
/*    */       
/* 59 */       CrashReportCategory.populateBlockDetails(category, (net.minecraft.world.level.LevelHeightAccessor)level, pos, state);
/*    */       
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/redstone/NeighborUpdater.class
