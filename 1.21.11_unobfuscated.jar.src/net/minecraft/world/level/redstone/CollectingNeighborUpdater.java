...
/*  23 */   private final ArrayDeque<NeighborUpdates> stack = new ArrayDeque<>();
/*  24 */   private final List<NeighborUpdates> addedThisLayer = new ArrayList<>();
...
/*     */   }
/*     */   
/*     */   public void setDebugListener(Consumer<BlockPos> debugListener) {
/*  35 */     this.debugListener = debugListener;
/*     */   }
/*     */ 
/*     */   
...
/*  40 */     addAndRun(pos, new ShapeUpdate(direction, neighborState, pos.immutable(), neighborPos.immutable(), updateFlags, updateLimit));
/*     */   }
/*     */ 
/*     */   
/*     */   public void neighborChanged(BlockPos pos, Block block, Orientation orientation) {
/*  45 */     addAndRun(pos, new SimpleNeighborUpdate(pos, block, orientation));
/*     */   }
/*     */ 
/*     */   
/*     */   public void neighborChanged(BlockState state, BlockPos pos, Block block, Orientation orientation, boolean movedByPiston) {
/*  50 */     addAndRun(pos, new FullNeighborUpdate(state, pos.immutable(), block, orientation, movedByPiston));
/*     */   }
/*     */ 
/*     */   
/*     */   public void updateNeighborsAtExceptFromFacing(BlockPos pos, Block block, Direction skipDirection, Orientation orientation) {
/*  55 */     addAndRun(pos, new MultiNeighborUpdate(pos.immutable(), block, orientation, skipDirection));
/*     */   }
/*     */   
...
/*  81 */           this.stack.push(this.addedThisLayer.get(i));
/*     */         }
/*  83 */         this.addedThisLayer.clear();
/*  84 */         NeighborUpdates nextUpdates = this.stack.peek();
...
/*     */     private final BlockPos pos; private final Block block; private final Orientation orientation;
...
/*     */       //   0	7	0	this	Lnet/minecraft/world/level/redstone/CollectingNeighborUpdater$SimpleNeighborUpdate;
/*     */     }
/* 108 */     SimpleNeighborUpdate(BlockPos pos, Block block, Orientation orientation) { this.pos = pos; this.block = block; this.orientation = orientation; } public final boolean equals(Object o) { // Byte code:
/*     */       //   0: aload_0
/*     */       //   1: aload_1
...
/* 118 */       output.accept(this.pos);
/*     */     } }
/*     */   static final class FullNeighborUpdate extends Record implements NeighborUpdates { private final BlockState state; private final BlockPos pos; private final Block block; private final Orientation orientation; private final boolean movedByPiston;
/*     */     
...
/*     */         } 
/*     */       } 
/*     */     } } private static final class ShapeUpdate extends Record implements NeighborUpdates { private final Direction direction; private final BlockState neighborState; private final BlockPos pos; private final BlockPos neighborPos; @Block.UpdateFlags
/*     */     private final int updateFlags; private final int updateLimit;
/* 183 */     private ShapeUpdate(Direction direction, BlockState neighborState, BlockPos pos, BlockPos neighborPos, @Block.UpdateFlags int updateFlags, int updateLimit) { this.direction = direction; this.neighborState = neighborState; this.pos = pos; this.neighborPos = neighborPos; this.updateFlags = updateFlags; this.updateLimit = updateLimit; } public final String toString() { // Byte code:
/*     */       //   0: aload_0
...
/* 183 */       //   0	8	1	o	Ljava/lang/Object; } public Direction direction() { return this.direction; } public BlockState neighborState() { return this.neighborState; } public BlockPos pos() { return this.pos; } public BlockPos neighborPos() { return this.neighborPos; } @Block.UpdateFlags public int updateFlags() { return this.updateFlags; } public int updateLimit() { return this.updateLimit; }
/*     */     
/*     */     public boolean runNext(Level level) {
/* 186 */       NeighborUpdater.executeShapeUpdate((LevelAccessor)level, this.direction, this.pos, this.neighborPos, this.neighborState, this.updateFlags, this.updateLimit);
/* 187 */       return false;
/*     */     }
/*     */ 
/*     */     
/*     */     public void forEachUpdatedPos(Consumer<BlockPos> output) {
/* 192 */       output.accept(this.pos);
/*     */     } }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/level/redstone/CollectingNeighborUpdater.class
