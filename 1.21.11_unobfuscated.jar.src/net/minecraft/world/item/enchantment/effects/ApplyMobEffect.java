...
/*    */   
/*    */   static {
/* 31 */     CODEC = RecordCodecBuilder.mapCodec(i -> i.group((App)net.minecraft.core.RegistryCodecs.homogeneousList(net.minecraft.core.registries.Registries.MOB_EFFECT).fieldOf("to_apply").forGetter(ApplyMobEffect::toApply), (App)LevelBasedValue.CODEC.fieldOf("min_duration").forGetter(ApplyMobEffect::minDuration), (App)LevelBasedValue.CODEC.fieldOf("max_duration").forGetter(ApplyMobEffect::maxDuration), (App)LevelBasedValue.CODEC.fieldOf("min_amplifier").forGetter(ApplyMobEffect::minAmplifier), (App)LevelBasedValue.CODEC.fieldOf("max_amplifier").forGetter(ApplyMobEffect::maxAmplifier)).apply((com.mojang.datafixers.kinds.Applicative)i, ApplyMobEffect::new));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 47 */         living.addEffect(new net.minecraft.world.effect.MobEffectInstance(selected.get(), ticks, amplifier));
/*    */       }  }
/*    */   
/*    */   }
/*    */ 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/enchantment/effects/ApplyMobEffect.class
