...
/*    */   
/*    */   static {
/* 23 */     CODEC = RecordCodecBuilder.mapCodec(i -> i.group((App)net.minecraft.core.RegistryCodecs.homogeneousList(Registries.ENCHANTMENT).fieldOf("enchantments").forGetter(EnchantmentsByCost::enchantments), (App)IntProvider.CODEC.fieldOf("cost").forGetter(EnchantmentsByCost::cost)).apply((Applicative)i, EnchantmentsByCost::new));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
/*    */   
/*    */   public void enchant(ItemStack item, net.minecraft.world.item.enchantment.ItemEnchantments.Mutable itemEnchantments, RandomSource random, net.minecraft.world.DifficultyInstance difficulty) {
/* 30 */     java.util.List<EnchantmentInstance> instances = net.minecraft.world.item.enchantment.EnchantmentHelper.selectEnchantment(random, item, this.cost.sample(random), this.enchantments.stream());
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/enchantment/providers/EnchantmentsByCost.class
