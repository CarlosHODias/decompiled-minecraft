...
/* 51 */           serverLevel.sendParticles((ParticleOptions)ParticleTypes.SPLASH, pos.getX() + level.random.nextDouble(), (pos.getY() + 1), pos.getZ() + level.random.nextDouble(), 1, 0.0D, 0.0D, 0.0D, 1.0D);
/*    */         }
/*    */       } 
/*    */       
/* 55 */       level.playSound(null, pos, SoundEvents.BOTTLE_EMPTY, SoundSource.BLOCKS, 1.0F, 1.0F);
/* 56 */       level.gameEvent(null, (Holder)net.minecraft.world.level.gameevent.GameEvent.FLUID_PLACE, pos);
/*    */       
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/PotionItem.class
