...
/*   50 */     return ResourceKey.create(Registries.CREATIVE_MODE_TAB, Identifier.withDefaultNamespace(id));
/*      */   }
/*      */   
...
/*      */             parameters.holders().lookup(Registries.PAINTING_VARIANT).ifPresent(());
...
/*      */             functionalBlocks.accept(Raid.getOminousBannerInstance((HolderGetter)parameters.holders().lookupOrThrow(Registries.BANNER_PATTERN)));
...
/*      */             
/*      */             for (CreativeModeTab tab : (Iterable<CreativeModeTab>)registry) {
...
/*      */             parameters.holders().lookup(Registries.INSTRUMENT).ifPresent(());
...
/*      */             parameters.holders().lookup(Registries.ENCHANTMENT).ifPresent(());
/* 2105 */           }).build());
...
/* 2275 */     Map<Pair<CreativeModeTab.Row, Integer>, String> positions = new HashMap<>();
/* 2276 */     for (ResourceKey<CreativeModeTab> tabKey : (Iterable<ResourceKey<CreativeModeTab>>)BuiltInRegistries.CREATIVE_MODE_TAB.registryKeySet()) {
...
/* 2279 */       String previous = positions.put(Pair.of(tab.row(), tab.column()), current);
...
/* 2295 */     potions.listElements()
/* 2296 */       .filter(potion -> ((Potion)potion.value()).isEnabled(enabledFeatures))
/* 2297 */       .map(potion -> PotionContents.createItemStack(item, (Holder)potion))
...
/* 2302 */     enchantments.listElements()
/* 2303 */       .map(enchantment -> EnchantmentHelper.createBook(new EnchantmentInstance((Holder)enchantment, ((Enchantment)enchantment.value()).getMaxLevel())))
...
/* 2308 */     enchantments.listElements()
...
/* 2314 */     instruments.get(instrumentTagKey).ifPresent(tag -> tag.stream().map(()).forEach(()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2349 */     RegistryOps<net.minecraft.nbt.Tag> ops = context.createSerializationContext((com.mojang.serialization.DynamicOps)NbtOps.INSTANCE);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/CreativeModeTabs.class
