...
/*     */   
/*     */   static {
/*  21 */     ARROW_ONLY = (itemStack -> itemStack.is(ItemTags.ARROWS));
/*  22 */     ARROW_OR_FIREWORK = ARROW_ONLY.or(itemStack -> itemStack.is(Items.FIREWORK_ROCKET));
/*     */   }
...
/*  49 */     float maxAngle = EnchantmentHelper.processProjectileSpread(level, weapon, (Entity)shooter, 0.0F);
...
/*  54 */       ItemStack projectile = projectiles.get(i);
/*     */       
...
/*  66 */             createProjectile((Level)level, shooter, weapon, projectile, isCrit), level, projectile, projectileEntity -> shootProjectile(shooter, targetOverride, shooter, index, power, uncertainty, angle));
/*     */ 
/*     */ 
/*     */ 
/*     */         
...
/*  85 */     Item item = projectile.getItem(); ArrowItem arrowItem1 = (ArrowItem)item, arrowItem = (item instanceof ArrowItem) ? arrowItem1 : (ArrowItem)Items.ARROW;
/*  86 */     AbstractArrow arrow = arrowItem.createArrow(level, projectile, shooter, weapon);
/*  87 */     if (isCrit) {
/*  88 */       arrow.setCritArrow(true);
/*     */     }
/*  90 */     return (Projectile)arrow;
/*     */   }
/*     */   
...
/*     */ 
/*     */     
/*  99 */     Level level = shooter.level(); ServerLevel serverLevel = (ServerLevel)level; int numProjectiles = (level instanceof ServerLevel) ? EnchantmentHelper.processProjectileCount(serverLevel, weapon, (Entity)shooter, 1) : 1;
/* 100 */     List<ItemStack> drawn = new ArrayList<>(numProjectiles);
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/ProjectileWeaponItem.class
