...
/* 28 */         itemStack.hurtAndBreak(dmg, (LivingEntity)player, hand.asEquipmentSlot());
/*    */       } 
...
/*    */       
/* 32 */       itemStack.causeUseVibration((Entity)player, GameEvent.ITEM_INTERACT_FINISH);
/*    */     } else {
...
/* 37 */         int lureSpeed = (int)(EnchantmentHelper.getFishingTimeReduction(serverLevel, itemStack, (Entity)player) * 20.0F);
/* 38 */         int luck = EnchantmentHelper.getFishingLuckBonus(serverLevel, itemStack, (Entity)player);
/* 39 */         Projectile.spawnProjectile((Projectile)new FishingHook(player, level, luck, lureSpeed), serverLevel, itemStack); }
/*    */       
/* 41 */       player.awardStat(Stats.ITEM_USED.get(this));
/*    */       
/* 43 */       itemStack.causeUseVibration((Entity)player, GameEvent.ITEM_INTERACT_START);
/*    */     } 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/FishingRodItem.class
