...
/* 30 */     List<ResourceKey<Recipe<?>>> recipeIds = (List<ResourceKey<Recipe<?>>>)itemStack.getOrDefault(DataComponents.RECIPES, List.of());
/*    */     
...
/* 40 */       List<RecipeHolder<?>> recipes = new ArrayList<>(recipeIds.size());
/*    */       
...
/* 45 */           recipes.add(recipe.get()); continue;
/*    */         } 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/KnowledgeBookItem.class
