...
/* 17 */     return DispenseConfig.DEFAULT;
/*    */   }
/*    */   
/*    */   default void shoot(Projectile projectile, double xd, double yd, double zd, float pow, float uncertainty) {
/* 21 */     projectile.shoot(xd, yd, zd, pow, uncertainty);
/*    */   } public static final class DispenseConfig extends Record {
/*    */     private final ProjectileItem.PositionFunction positionFunction; private final float uncertainty; private final float power; private final OptionalInt overrideDispenseEvent; public final String toString() {
/*    */       // Byte code:
/*    */       //   0: aload_0
...
/* 63 */         return new ProjectileItem.DispenseConfig(this.positionFunction, this.uncertainty, this.power, this.overrideDispenseEvent); } } } @FunctionalInterface public static interface PositionFunction { Position getDispensePosition(BlockSource param1BlockSource, Direction param1Direction); } public static class Builder { private ProjectileItem.PositionFunction positionFunction; private float uncertainty; public ProjectileItem.DispenseConfig build() { return new ProjectileItem.DispenseConfig(this.positionFunction, this.uncertainty, this.power, this.overrideDispenseEvent); }
/*    */ 
/*    */     
/*    */     private float power;
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/ProjectileItem.class
