...
/*    */     }
/*    */     
/* 46 */     List<ItemStack> firedProjectiles = draw(itemStack, projectile, (LivingEntity)player);
/* 47 */     if (level instanceof ServerLevel) { ServerLevel serverLevel = (ServerLevel)level; if (!firedProjectiles.isEmpty()) {
/* 48 */         shoot(serverLevel, (LivingEntity)player, player.getUsedItemHand(), itemStack, firedProjectiles, pow * 3.0F, 1.0F, (pow == 1.0F), null);
/*    */       } }
/*    */     
...
/* 58 */     projectileEntity.shootFromRotation((Entity)shooter, shooter.getXRot(), shooter.getYRot() + angle, 0.0F, power, uncertainty);
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/BowItem.class
