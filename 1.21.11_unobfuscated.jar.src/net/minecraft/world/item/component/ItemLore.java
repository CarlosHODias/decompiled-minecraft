...
/*    */   
/* 26 */   private static final Style LORE_STYLE = Style.EMPTY.withColor(ChatFormatting.DARK_PURPLE).withItalic(true);
/*    */   
...
/* 29 */   public static final StreamCodec<RegistryFriendlyByteBuf, ItemLore> STREAM_CODEC = ComponentSerialization.STREAM_CODEC.apply(net.minecraft.network.codec.ByteBufCodecs.list(256)).map(ItemLore::new, ItemLore::lines);
/*    */   
/*    */   public ItemLore(List<Component> lines) {
/* 32 */     this(lines, com.google.common.collect.Lists.transform(lines, component -> ComponentUtils.mergeStyles(component, LORE_STYLE)));
/*    */   }
/*    */   
...
/* 42 */     return new ItemLore(Util.copyAndAdd(this.lines, component));
/*    */   }
/*    */ 
/*    */   
/*    */   public void addToTooltip(net.minecraft.world.item.Item.TooltipContext context, Consumer<Component> consumer, net.minecraft.world.item.TooltipFlag flag, DataComponentGetter components) {
/* 47 */     this.styledLines.forEach(consumer);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/component/ItemLore.class
