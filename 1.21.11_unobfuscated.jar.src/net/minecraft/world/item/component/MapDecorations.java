...
/*    */   private final java.util.Map<String, Entry> decorations;
/*    */   
/* 11 */   public MapDecorations(java.util.Map<String, Entry> decorations) { this.decorations = decorations; } public final String toString() { // Byte code:
/*    */     //   0: aload_0
...
/* 11 */     //   0	7	0	this	Lnet/minecraft/world/item/component/MapDecorations; } public java.util.Map<String, Entry> decorations() { return this.decorations; } public final int hashCode() {
/*    */     // Byte code:
/*    */     //   0: aload_0
...
/* 15 */   } public static final MapDecorations EMPTY = new MapDecorations(java.util.Map.of());
/*    */   
/* 17 */   public static final Codec<MapDecorations> CODEC = Codec.unboundedMap((Codec)Codec.STRING, Entry.CODEC).xmap(MapDecorations::new, MapDecorations::decorations);
/*    */   
/*    */   public MapDecorations withDecoration(String id, Entry entry) {
/* 20 */     return new MapDecorations(net.minecraft.util.Util.copyAndPut(this.decorations, id, entry));
/*    */   }
/*    */   public static final class Entry extends Record { private final net.minecraft.core.Holder<MapDecorationType> type; private final double x; private final double z; private final float rotation; public static final Codec<Entry> CODEC;
/* 23 */     public Entry(net.minecraft.core.Holder<MapDecorationType> type, double x, double z, float rotation) { this.type = type; this.x = x; this.z = z; this.rotation = rotation; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable table:
/*    */       //   start	length	slot	name	descriptor
/* 23 */       //   0	7	0	this	Lnet/minecraft/world/item/component/MapDecorations$Entry; } public net.minecraft.core.Holder<MapDecorationType> type() { return this.type; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/component/MapDecorations.class
