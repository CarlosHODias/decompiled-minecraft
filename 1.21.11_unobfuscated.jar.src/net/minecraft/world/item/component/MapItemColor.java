...
/*  8 */     //   0	7	0	this	Lnet/minecraft/world/item/component/MapItemColor; } public int rgb() { return this.rgb; }
...
/*  9 */     //   0	8	1	o	Ljava/lang/Object; } public static final com.mojang.serialization.Codec<MapItemColor> CODEC = com.mojang.serialization.Codec.INT.xmap(MapItemColor::new, MapItemColor::rgb);
/* 10 */   public static final net.minecraft.network.codec.StreamCodec<io.netty.buffer.ByteBuf, MapItemColor> STREAM_CODEC = net.minecraft.network.codec.ByteBufCodecs.INT.map(MapItemColor::new, MapItemColor::rgb);
/*    */   
/* 12 */   public static final MapItemColor DEFAULT = new MapItemColor(4603950);
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/component/MapItemColor.class
