...
/*  31 */     //   0	7	0	this	Lnet/minecraft/world/item/component/BlocksAttacks; } public float blockDelaySeconds() { return this.blockDelaySeconds; } public final int hashCode() { // Byte code:
/*     */     //   0: aload_0
...
/*     */   
/*     */   static {
/*  40 */     CODEC = RecordCodecBuilder.create(i -> i.group((App)ExtraCodecs.NON_NEGATIVE_FLOAT.optionalFieldOf("block_delay_seconds", 0.0F).forGetter(BlocksAttacks::blockDelaySeconds), (App)ExtraCodecs.NON_NEGATIVE_FLOAT.optionalFieldOf("disable_cooldown_scale", 1.0F).forGetter(BlocksAttacks::disableCooldownScale), (App)DamageReduction.CODEC.listOf().optionalFieldOf("damage_reductions", List.of(new DamageReduction(90.0F, Optional.empty(), 0.0F, 1.0F))).forGetter(BlocksAttacks::damageReductions), (App)ItemDamageFunction.CODEC.optionalFieldOf("item_damage", ItemDamageFunction.DEFAULT).forGetter(BlocksAttacks::itemDamage), (App)TagKey.hashedCodec(Registries.DAMAGE_TYPE).optionalFieldOf("bypassed_by").forGetter(BlocksAttacks::bypassedBy), (App)SoundEvent.CODEC.optionalFieldOf("block_sound").forGetter(BlocksAttacks::blockSound), (App)SoundEvent.CODEC.optionalFieldOf("disabled_sound").forGetter(BlocksAttacks::disableSound)).apply((Applicative)i, BlocksAttacks::new));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  49 */   public static final StreamCodec<net.minecraft.network.RegistryFriendlyByteBuf, BlocksAttacks> STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.FLOAT, BlocksAttacks::blockDelaySeconds, ByteBufCodecs.FLOAT, BlocksAttacks::disableCooldownScale, 
/*     */ 
/*     */       
/*  52 */       DamageReduction.STREAM_CODEC.apply(ByteBufCodecs.list()), BlocksAttacks::damageReductions, ItemDamageFunction.STREAM_CODEC, BlocksAttacks::itemDamage, 
/*     */       
/*  54 */       TagKey.streamCodec(Registries.DAMAGE_TYPE).apply(ByteBufCodecs::optional), BlocksAttacks::bypassedBy, 
/*  55 */       SoundEvent.STREAM_CODEC.apply(ByteBufCodecs::optional), BlocksAttacks::blockSound, 
/*  56 */       SoundEvent.STREAM_CODEC.apply(ByteBufCodecs::optional), BlocksAttacks::disableSound, BlocksAttacks::new);
/*     */ 
/*     */ 
/*     */   
/*     */   public void onBlocked(ServerLevel level, LivingEntity user) {
/*  61 */     this.blockSound.ifPresent(sound -> level.playSound(null, user.getX(), user.getY(), user.getZ(), sound, user.getSoundSource(), 1.0F, 0.8F + level.random.nextFloat() * 0.4F));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void disable(ServerLevel level, LivingEntity user, float baseSeconds, net.minecraft.world.item.ItemStack blockingWith) {
...
/*  73 */       this.disableSound.ifPresent(sound -> level.playSound(null, user.getX(), user.getY(), user.getZ(), sound, user.getSoundSource(), 0.8F, 0.8F + level.random.nextFloat() * 0.4F));
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void hurtBlockingItem(net.minecraft.world.level.Level level, net.minecraft.world.item.ItemStack item, LivingEntity user, net.minecraft.world.InteractionHand hand, float damage) {
/*     */     Player player;
...
/*  86 */       player.awardStat(net.minecraft.stats.Stats.ITEM_USED.get(item.getItem()));
/*     */     }
/*     */     
...
/* 104 */     return Math.round(this.blockDelaySeconds * 20.0F);
/*     */   }
/*     */   
/*     */   public float resolveBlockedDamage(net.minecraft.world.damagesource.DamageSource source, float dealtDamage, double angle) {
...
/*     */     }
/* 112 */     return net.minecraft.util.Mth.clamp(blockedDamage, 0.0F, dealtDamage);
/*     */   }
/*     */   public static final class DamageReduction extends Record { private final float horizontalBlockingAngle; private final Optional<net.minecraft.core.HolderSet<DamageType>> type; private final float base; private final float factor; public static final Codec<DamageReduction> CODEC;
/* 115 */     public DamageReduction(float horizontalBlockingAngle, Optional<net.minecraft.core.HolderSet<DamageType>> type, float base, float factor) { this.horizontalBlockingAngle = horizontalBlockingAngle; this.type = type; this.base = base; this.factor = factor; } public final String toString() { // Byte code:
/*     */       //   0: aload_0
...
/* 115 */       //   0	8	1	o	Ljava/lang/Object; } public float horizontalBlockingAngle() { return this.horizontalBlockingAngle; } public Optional<net.minecraft.core.HolderSet<DamageType>> type() { return this.type; } public float base() { return this.base; } public float factor() { return this.factor; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/*     */     public float resolve(net.minecraft.world.damagesource.DamageSource source, float dealtDamage, double angle) {
/* 137 */       if (angle > (0.017453292F * this.horizontalBlockingAngle)) {
/* 138 */         return 0.0F;
/*     */       }
/*     */       
/* 141 */       if (this.type.isPresent() && !((net.minecraft.core.HolderSet)this.type.get()).contains(source.typeHolder())) {
/* 142 */         return 0.0F;
/*     */       }
/* 144 */       return net.minecraft.util.Mth.clamp(this.base + this.factor * dealtDamage, 0.0F, dealtDamage);
/*     */     } }
/*     */   public static final class ItemDamageFunction extends Record { private final float threshold; private final float base; private final float factor; public static final Codec<ItemDamageFunction> CODEC;
/*     */     
...
/* 148 */       //   0	8	1	o	Ljava/lang/Object; } public float threshold() { return this.threshold; } public float base() { return this.base; } public float factor() { return this.factor; } static {
...
/*     */ 
/*     */     
/* 154 */     public static final StreamCodec<io.netty.buffer.ByteBuf, ItemDamageFunction> STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.FLOAT, ItemDamageFunction::threshold, ByteBufCodecs.FLOAT, ItemDamageFunction::base, ByteBufCodecs.FLOAT, ItemDamageFunction::factor, ItemDamageFunction::new);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 165 */         return 0;
/*     */       }
/* 167 */       return net.minecraft.util.Mth.floor(this.base + this.factor * dealtDamage);
/*     */     } }
/*     */ 
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/component/BlocksAttacks.class
