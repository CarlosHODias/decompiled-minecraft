...
/* 39 */     return (second.is(first.getItem()) && 
/* 40 */       first.getCount() == 1 && second.getCount() == 1 && 
/* 41 */       first.has(DataComponents.MAX_DAMAGE) && second.has(DataComponents.MAX_DAMAGE) && 
/* 42 */       first.has(DataComponents.DAMAGE) && second.has(DataComponents.DAMAGE));
/*    */   }
/*    */ 
/*    */   
/*    */   public boolean matches(CraftingInput input, Level level) {
/* 47 */     return (getItemsToCombine(input) != null);
/*    */   }
/*    */ 
/*    */   
...
/*    */     
/* 67 */     ItemStack itemStack = new ItemStack((ItemLike)first.getItem());
/* 68 */     itemStack.set(DataComponents.MAX_DAMAGE, durability);
...
/* 73 */     EnchantmentHelper.updateEnchantments(itemStack, enchantments -> registries.lookupOrThrow(Registries.ENCHANTMENT).listElements().filter(()).forEach(()));
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* 87 */     return RecipeSerializer.REPAIR_ITEM;
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/crafting/RepairItemRecipe.class
