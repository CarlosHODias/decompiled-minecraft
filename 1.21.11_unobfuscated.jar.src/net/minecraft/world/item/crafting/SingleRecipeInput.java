...
/*    */   
/*  5 */   public SingleRecipeInput(net.minecraft.world.item.ItemStack item) { this.item = item; } public final String toString() { // Byte code:
/*    */     //   0: aload_0
...
/*  5 */     //   0	7	0	this	Lnet/minecraft/world/item/crafting/SingleRecipeInput; } public net.minecraft.world.item.ItemStack item() { return this.item; }
...
/*    */     //   0	8	1	o	Ljava/lang/Object; } public net.minecraft.world.item.ItemStack getItem(int index) {
/*  8 */     if (index != 0) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/crafting/SingleRecipeInput.class
