...
/* 18 */           Map.of('#', 
/* 19 */             Ingredient.of((ItemLike)Items.PAPER), 'x', 
/* 20 */             Ingredient.of((ItemLike)Items.FILLED_MAP)), new String[] { "###", "#x#", "###" }), new ItemStack((ItemLike)Items.MAP));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 76 */     return RecipeSerializer.MAP_EXTENDING;
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/crafting/MapExtendingRecipe.class
