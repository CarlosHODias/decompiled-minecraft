...
/* 19 */   private WeakReference<RecipeManager> cachedRecipeManager = new WeakReference<>(null);
/*    */   
...
/* 47 */       Arrays.fill((Object[])this.entries, null);
/*    */     } 
/*    */   }
/*    */   
/*    */   private Optional<RecipeHolder<CraftingRecipe>> compute(CraftingInput input, ServerLevel level) {
/* 52 */     Optional<RecipeHolder<CraftingRecipe>> recipe = level.recipeAccess().getRecipeFor(RecipeType.CRAFTING, input, (Level)level);
/* 53 */     insert(input, recipe.orElse(null));
/* 54 */     return recipe;
/*    */   }
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/crafting/RecipeCache.class
