...
/*  64 */         playInsertSound((Entity)player);
/*     */       } else {
/*  66 */         playInsertFailSound((Entity)player);
/*     */       } 
...
/*     */         } else {
/*  81 */           playRemoveOneSound((Entity)player);
/*     */         } 
/*     */       } 
...
/* 110 */         playInsertSound((Entity)player);
/*     */       } else {
/* 112 */         playInsertFailSound((Entity)player);
/*     */       } 
...
/* 123 */         if (removed != null) {
/* 124 */           playRemoveOneSound((Entity)player);
...
/* 146 */       playDropContentsSound(level, (Entity)player);
...
/* 213 */       player.drop(itemStack.get(), true);
/* 214 */       return true;
/*     */     } 
/* 216 */     return false;
/*     */   }
...
/* 222 */     if (removed != null) {
/* 223 */       playRemoveOneSound((Entity)player);
...
/*     */     }
/* 257 */     return Optional.<BundleContents>ofNullable((BundleContents)bundle.get(DataComponents.BUNDLE_CONTENTS)).map(net.minecraft.world.inventory.tooltip.BundleTooltip::new);
/*     */   }
/*     */ 
/*     */   
...
/* 300 */     entity.playSound(SoundEvents.BUNDLE_REMOVE_ONE, 0.8F, 0.8F + entity.level().getRandom().nextFloat() * 0.4F);
/*     */   }
/*     */   
/*     */   private static void playInsertSound(Entity entity) {
/* 304 */     entity.playSound(SoundEvents.BUNDLE_INSERT, 0.8F, 0.8F + entity.level().getRandom().nextFloat() * 0.4F);
/*     */   }
/*     */   
/*     */   private static void playInsertFailSound(Entity entity) {
/* 308 */     entity.playSound(SoundEvents.BUNDLE_INSERT_FAIL, 1.0F, 1.0F);
/*     */   }
/*     */   
/*     */   private static void playDropContentsSound(Level level, Entity entity) {
/* 312 */     level.playSound(null, entity.blockPosition(), SoundEvents.BUNDLE_DROP_CONTENTS, SoundSource.PLAYERS, 0.8F, 0.8F + entity.level().getRandom().nextFloat() * 0.4F);
/*     */   }
/*     */   
/*     */   private void broadcastChangesOnContainerMenu(Player player) {
/* 316 */     AbstractContainerMenu containerMenu = player.containerMenu;
/* 317 */     if (containerMenu != null)
/* 318 */       containerMenu.slotsChanged((Container)player.getInventory()); 
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/BundleItem.class
