...
/*    */       }
/* 55 */       HangingEntity entity = (HangingEntity)painting.get();
/* 56 */     } else if (this.type == EntityType.ITEM_FRAME) {
/* 57 */       ItemFrame itemFrame = new ItemFrame(level, blockPos, clickedFace);
...
/*    */     } 
/*    */     
/* 64 */     EntityType.createDefaultStackConfig(level, itemInHand, (LivingEntity)player).accept(glowItemFrame);
/*    */     
...
/* 80 */     return (!direction.getAxis().isVertical() && player.mayUseItemAt(blockPos, direction, itemStack));
/*    */   }
/*    */ 
/*    */   
/*    */   public void appendHoverText(ItemStack itemStack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> builder, TooltipFlag tooltipFlag) {
/* 85 */     if (this.type == EntityType.PAINTING && display.shows(DataComponents.PAINTING_VARIANT)) {
/* 86 */       Holder<PaintingVariant> variant = (Holder<PaintingVariant>)itemStack.get(DataComponents.PAINTING_VARIANT);
/* 87 */       if (variant != null) {
/* 88 */         ((PaintingVariant)variant.value()).title().ifPresent(builder);
/* 89 */         ((PaintingVariant)variant.value()).author().ifPresent(builder);
/* 90 */         builder.accept(Component.translatable("painting.dimensions", new Object[] { ((PaintingVariant)variant.value()).width(), ((PaintingVariant)variant.value()).height() }));
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/HangingEntityItem.class
