...
/* 33 */       Projectile.spawnProjectileFromRotation((source, l, itemStack) -> new WindCharge(player, level, player.position().x(), player.getEyePosition().y(), player.position().z()), serverLevel, stack, (LivingEntity)player, 0.0F, PROJECTILE_SHOOT_POWER, 1.0F); }
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* 44 */     stack.consume(1, (LivingEntity)player);
/*    */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/WindChargeItem.class
