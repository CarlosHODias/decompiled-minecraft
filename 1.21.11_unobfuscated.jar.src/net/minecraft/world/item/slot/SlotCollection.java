...
/* 18 */     return new Filtered(this, predicate);
/*    */   }
/*    */   
/*    */   default SlotCollection flatMap(Function<ItemStack, ? extends SlotCollection> mapper) {
/* 22 */     return new FlatMapped(this, mapper);
/*    */   }
/*    */   
/*    */   default SlotCollection limit(int limit) {
/* 26 */     return new Limited(this, limit);
/*    */   }
/*    */   
/*    */   static SlotCollection of(SlotAccess slotAccess) {
/* 30 */     return () -> Stream.of(slotAccess.get().copy());
/*    */   }
/*    */   
/*    */   static SlotCollection of(Collection<? extends SlotAccess> slots) {
/* 34 */     switch (slots.size()) { case 0: case 1: default: break; }  return () -> slots.stream().map(SlotAccess::get).map(ItemStack::copy);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 44 */     return () -> Stream.concat(first.itemCopies(), second.itemCopies());
/*    */   }
/*    */   
/*    */   static SlotCollection concat(List<? extends SlotCollection> terms) {
/* 48 */     switch (terms.size()) { case 0: case 1: case 2: default: break; }  return () -> terms.stream().flatMap(SlotCollection::itemCopies);
/*    */   } Stream<ItemStack> itemCopies(); public static final class Filtered extends Record implements SlotCollection {
/*    */     private final SlotCollection slots; private final Predicate<ItemStack> filter; public final String toString() {
/*    */       // Byte code:
/*    */       //   0: aload_0
...
/*    */       //   0	7	0	this	Lnet/minecraft/world/item/slot/SlotCollection$Filtered;
/*    */     }
/* 56 */     public Filtered(SlotCollection slots, Predicate<ItemStack> filter) { this.slots = slots; this.filter = filter; } public final boolean equals(Object o) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/* 59 */       return this.slots.itemCopies().filter(this.filter);
/*    */     }
/*    */ 
/*    */     
/*    */     public SlotCollection filter(Predicate<ItemStack> predicate) {
/* 64 */       return new Filtered(this.slots, this.filter.and(predicate));
/*    */     } }
/*    */   public static final class FlatMapped extends Record implements SlotCollection { private final SlotCollection slots; private final Function<ItemStack, ? extends SlotCollection> mapper;
/*    */     
...
/*    */     
/*    */     public Stream<ItemStack> itemCopies() {
/* 71 */       return this.slots.itemCopies().<SlotCollection>map(this.mapper)
...
/*    */     
/*    */     public Stream<ItemStack> itemCopies() {
/* 79 */       return this.slots.itemCopies().limit(this.limit);
/*    */     }
/*    */ 
/*    */     
/*    */     public SlotCollection limit(int limit) {
/* 84 */       return new Limited(this.slots, Math.min(this.limit, limit));
/*    */     } }
/*    */ 
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/slot/SlotCollection.class
