...
/* 26 */       Projectile.spawnProjectileFromRotation(ThrownExperienceBottle::new, serverLevel, itemStack, (LivingEntity)player, -20.0F, 0.7F, 1.0F); }
/*    */     
/* 28 */     player.awardStat(Stats.ITEM_USED.get(this));
/* 29 */     itemStack.consume(1, (LivingEntity)player);
/* 30 */     return (InteractionResult)InteractionResult.SUCCESS;
/*    */   }
/*    */ 
/*    */   
/*    */   public Projectile asProjectile(Level level, Position position, ItemStack itemStack, Direction direction) {
/* 35 */     return (Projectile)new ThrownExperienceBottle(level, position.x(), position.y(), position.z(), itemStack);
/*    */   }
/*    */ 
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/ExperienceBottleItem.class
