...
/*  62 */     int songId = level.registryAccess().lookupOrThrow(Registries.JUKEBOX_SONG).getId(this.song.value());
...
/*  74 */     level.gameEvent((Holder)GameEvent.JUKEBOX_STOP_PLAY, this.blockPos, GameEvent.Context.of(blockState));
...
/*  90 */       level.gameEvent((Holder)GameEvent.JUKEBOX_PLAY, this.blockPos, GameEvent.Context.of(blockState));
...
/* 103 */       Vec3 pos = Vec3.atBottomCenterOf((Vec3i)blockPos).add(0.0D, 1.2000000476837158D, 0.0D);
/* 104 */       float randomColor = level.getRandom().nextInt(4) / 24.0F;
/* 105 */       serverLevel.sendParticles((ParticleOptions)ParticleTypes.NOTE, pos.x(), pos.y(), pos.z(), 0, randomColor, 0.0D, 0.0D, 1.0D); }
/*     */   
/*     */   }
/*     */   
/*     */   @FunctionalInterface
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/JukeboxSongPlayer.class
