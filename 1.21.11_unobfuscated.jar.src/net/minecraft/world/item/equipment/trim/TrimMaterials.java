...
/* 48 */     return (material != null) ? material.unwrap(registries) : Optional.<Holder<TrimMaterial>>empty();
/*    */   }
/*    */   
...
/* 53 */     context.register(registryKey, new TrimMaterial(assets, (Component)mutableComponent));
/*    */   }
/*    */   
/*    */   private static ResourceKey<TrimMaterial> registryKey(String id) {
/* 57 */     return ResourceKey.create(Registries.TRIM_MATERIAL, Identifier.withDefaultNamespace(id));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/equipment/trim/TrimMaterials.class
