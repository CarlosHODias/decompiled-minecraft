...
/* 52 */     TrimPattern pattern = new TrimPattern(defaultAssetId(registryKey), (Component)Component.translatable(Util.makeDescriptionId("trim_pattern", registryKey.identifier())), false);
/* 53 */     context.register(registryKey, pattern);
/*    */   }
/*    */   
/*    */   private static ResourceKey<TrimPattern> registryKey(String id) {
/* 57 */     return ResourceKey.create(Registries.TRIM_PATTERN, Identifier.withDefaultNamespace(id));
/*    */   }
/*    */   
/*    */   public static Identifier defaultAssetId(ResourceKey<TrimPattern> registryKey) {
/* 61 */     return registryKey.identifier();
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/equipment/trim/TrimPatterns.class
