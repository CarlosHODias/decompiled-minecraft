...
/* 18 */     return (getCooldownPercent(item, 0.0F) > 0.0F);
/*    */   }
/*    */   
/*    */   public float getCooldownPercent(ItemStack item, float a) {
/* 22 */     Identifier group = getCooldownGroup(item);
/* 23 */     CooldownInstance cooldown = this.cooldowns.get(group);
/*    */     
/* 25 */     if (cooldown != null) {
...
/* 39 */         Map.Entry<Identifier, CooldownInstance> entry = iterator.next();
/* 40 */         if (((CooldownInstance)entry.getValue()).endTime <= this.tickCount) {
/* 41 */           iterator.remove();
/* 42 */           onCooldownEnded(entry.getKey());
/*    */         } 
/*    */       } 
/*    */     }
/*    */   }
...
/*    */     }
/* 54 */     return useCooldown.cooldownGroup().orElse(defaultItemGroup);
/*    */   }
/*    */   
/*    */   public void addCooldown(ItemStack item, int time) {
/* 58 */     addCooldown(getCooldownGroup(item), time);
/*    */   }
/*    */   
...
/*    */   } protected void onCooldownStarted(Identifier cooldownGroup, int duration) {} protected void onCooldownEnded(Identifier cooldownGroup) {} private static final class CooldownInstance extends Record {
/*    */     private final int startTime; private final int endTime;
...
/*    */       //   0	7	0	this	Lnet/minecraft/world/item/ItemCooldowns$CooldownInstance;
/*    */     }
/* 77 */     private CooldownInstance(int startTime, int endTime) { this.startTime = startTime; this.endTime = endTime; } public final boolean equals(Object o) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/* 77 */       //   0	8	1	o	Ljava/lang/Object; } public int startTime() { return this.startTime; } public int endTime() { return this.endTime; }
/*    */   
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/ItemCooldowns.class
