...
/* 34 */       level.gameEvent((Entity)user, (Holder)GameEvent.ENTITY_PLACE, pos);
/*    */     } 
/*    */   }
/*    */ 
/*    */   
/*    */   protected void playEmptySound(LivingEntity user, LevelAccessor level, BlockPos pos) {
/* 40 */     level.playSound((Entity)user, pos, this.emptySound, SoundSource.NEUTRAL, 1.0F, 1.0F);
/*    */   }
/*    */   
/*    */   private void spawn(ServerLevel level, ItemStack itemStack, BlockPos spawnPos) {
/* 44 */     Mob mob = (Mob)this.type.create(level, EntityType.createDefaultStackConfig((Level)level, itemStack, null), spawnPos, EntitySpawnReason.BUCKET, true, false);
/*    */     
...
/*    */     
/* 52 */     if (mob != null) {
/* 53 */       level.addFreshEntityWithPassengers((Entity)mob);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/MobBucketItem.class
