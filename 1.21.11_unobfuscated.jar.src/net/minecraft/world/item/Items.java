...
/*  379 */   public static final Item BRICKS = registerBlock(Blocks.BRICKS); public static final Item ACACIA_SHELF; public static final Item BAMBOO_SHELF; public static final Item BIRCH_SHELF; public static final Item CHERRY_SHELF; public static final Item CRIMSON_SHELF; public static final Item DARK_OAK_SHELF; public static final Item JUNGLE_SHELF; public static final Item MANGROVE_SHELF; public static final Item OAK_SHELF; public static final Item PALE_OAK_SHELF; public static final Item SPRUCE_SHELF; public static final Item WARPED_SHELF; static {
/*  380 */     ACACIA_SHELF = registerBlock(Blocks.ACACIA_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  381 */     BAMBOO_SHELF = registerBlock(Blocks.BAMBOO_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  382 */     BIRCH_SHELF = registerBlock(Blocks.BIRCH_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  383 */     CHERRY_SHELF = registerBlock(Blocks.CHERRY_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  384 */     CRIMSON_SHELF = registerBlock(Blocks.CRIMSON_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  385 */     DARK_OAK_SHELF = registerBlock(Blocks.DARK_OAK_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  386 */     JUNGLE_SHELF = registerBlock(Blocks.JUNGLE_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  387 */     MANGROVE_SHELF = registerBlock(Blocks.MANGROVE_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  388 */     OAK_SHELF = registerBlock(Blocks.OAK_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  389 */     PALE_OAK_SHELF = registerBlock(Blocks.PALE_OAK_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  390 */     SPRUCE_SHELF = registerBlock(Blocks.SPRUCE_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  391 */     WARPED_SHELF = registerBlock(Blocks.WARPED_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  392 */   } public static final Item BOOKSHELF = registerBlock(Blocks.BOOKSHELF); public static final Item CHISELED_BOOKSHELF; static {
/*  393 */     CHISELED_BOOKSHELF = registerBlock(Blocks.CHISELED_BOOKSHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  394 */   } public static final Item DECORATED_POT = registerBlock(Blocks.DECORATED_POT, new Item.Properties().<PotDecorations>component(DataComponents.POT_DECORATIONS, PotDecorations.EMPTY).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  395 */   public static final Item MOSSY_COBBLESTONE = registerBlock(Blocks.MOSSY_COBBLESTONE);
/*  396 */   public static final Item OBSIDIAN = registerBlock(Blocks.OBSIDIAN); public static final Item TORCH; static {
/*  397 */     TORCH = registerBlock(Blocks.TORCH, (b, p) -> new StandingAndWallBlockItem(b, Blocks.WALL_TORCH, Direction.DOWN, p));
...
/*  405 */   public static final Item CREAKING_HEART = registerBlock(Blocks.CREAKING_HEART); public static final Item CHEST; static {
/*  406 */     CHEST = registerBlock(Blocks.CHEST, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  407 */   } public static final Item CRAFTING_TABLE = registerBlock(Blocks.CRAFTING_TABLE);
/*  408 */   public static final Item FARMLAND = registerBlock(Blocks.FARMLAND); public static final Item FURNACE; static {
/*  409 */     FURNACE = registerBlock(Blocks.FURNACE, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
...
/*  431 */   public static final Item PUMPKIN = registerBlock(Blocks.PUMPKIN); public static final Item CARVED_PUMPKIN; static {
/*  432 */     CARVED_PUMPKIN = registerBlock(Blocks.CARVED_PUMPKIN, p -> Waypoint.addHideAttribute(p).component(DataComponents.EQUIPPABLE, Equippable.builder(EquipmentSlot.HEAD).setSwappable(false).setCameraOverlay(Identifier.withDefaultNamespace("misc/pumpkinblur")).build()));
...
/*  439 */   public static final Item SMOOTH_BASALT = registerBlock(Blocks.SMOOTH_BASALT); public static final Item SOUL_TORCH; public static final Item COPPER_TORCH; static {
/*  440 */     SOUL_TORCH = registerBlock(Blocks.SOUL_TORCH, (b, p) -> new StandingAndWallBlockItem(b, Blocks.SOUL_WALL_TORCH, Direction.DOWN, p));
/*  441 */     COPPER_TORCH = registerBlock(Blocks.COPPER_TORCH, (b, p) -> new StandingAndWallBlockItem(b, Blocks.COPPER_WALL_TORCH, Direction.DOWN, p));
...
/*  568 */   public static final Item BARRIER = registerBlock(Blocks.BARRIER, new Item.Properties().rarity(Rarity.EPIC)); public static final Item LIGHT; static {
/*  569 */     LIGHT = registerBlock(Blocks.LIGHT, p -> p.rarity(Rarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with((Property)LightBlock.LEVEL, 15)));
/*  570 */   } public static final Item HAY_BLOCK = registerBlock(Blocks.HAY_BLOCK); public static final Item WHITE_CARPET; public static final Item ORANGE_CARPET; public static final Item MAGENTA_CARPET; public static final Item LIGHT_BLUE_CARPET; public static final Item YELLOW_CARPET; public static final Item LIME_CARPET; public static final Item PINK_CARPET; public static final Item GRAY_CARPET; public static final Item LIGHT_GRAY_CARPET; public static final Item CYAN_CARPET; public static final Item PURPLE_CARPET; public static final Item BLUE_CARPET; public static final Item BROWN_CARPET; public static final Item GREEN_CARPET; public static final Item RED_CARPET; public static final Item BLACK_CARPET; static {
/*  571 */     WHITE_CARPET = registerBlock(Blocks.WHITE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.WHITE)));
/*  572 */     ORANGE_CARPET = registerBlock(Blocks.ORANGE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.ORANGE)));
/*  573 */     MAGENTA_CARPET = registerBlock(Blocks.MAGENTA_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.MAGENTA)));
/*  574 */     LIGHT_BLUE_CARPET = registerBlock(Blocks.LIGHT_BLUE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_BLUE)));
/*  575 */     YELLOW_CARPET = registerBlock(Blocks.YELLOW_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.YELLOW)));
/*  576 */     LIME_CARPET = registerBlock(Blocks.LIME_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIME)));
/*  577 */     PINK_CARPET = registerBlock(Blocks.PINK_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PINK)));
/*  578 */     GRAY_CARPET = registerBlock(Blocks.GRAY_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GRAY)));
/*  579 */     LIGHT_GRAY_CARPET = registerBlock(Blocks.LIGHT_GRAY_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_GRAY)));
/*  580 */     CYAN_CARPET = registerBlock(Blocks.CYAN_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.CYAN)));
/*  581 */     PURPLE_CARPET = registerBlock(Blocks.PURPLE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PURPLE)));
/*  582 */     BLUE_CARPET = registerBlock(Blocks.BLUE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLUE)));
/*  583 */     BROWN_CARPET = registerBlock(Blocks.BROWN_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BROWN)));
/*  584 */     GREEN_CARPET = registerBlock(Blocks.GREEN_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GREEN)));
/*  585 */     RED_CARPET = registerBlock(Blocks.RED_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.RED)));
/*  586 */     BLACK_CARPET = registerBlock(Blocks.BLACK_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLACK)));
...
/*  712 */   public static final Item TURTLE_EGG = registerBlock(Blocks.TURTLE_EGG); public static final Item SNIFFER_EGG; static {
/*  713 */     SNIFFER_EGG = registerBlock(Blocks.SNIFFER_EGG, p -> p.rarity(Rarity.UNCOMMON));
...
/*  734 */   public static final Item DEAD_TUBE_CORAL = registerBlock(Blocks.DEAD_TUBE_CORAL); public static final Item TUBE_CORAL_FAN; public static final Item BRAIN_CORAL_FAN; public static final Item BUBBLE_CORAL_FAN; public static final Item FIRE_CORAL_FAN; public static final Item HORN_CORAL_FAN; public static final Item DEAD_TUBE_CORAL_FAN; public static final Item DEAD_BRAIN_CORAL_FAN; public static final Item DEAD_BUBBLE_CORAL_FAN; public static final Item DEAD_FIRE_CORAL_FAN; public static final Item DEAD_HORN_CORAL_FAN; static {
/*  735 */     TUBE_CORAL_FAN = registerBlock(Blocks.TUBE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.TUBE_CORAL_WALL_FAN, Direction.DOWN, p));
/*  736 */     BRAIN_CORAL_FAN = registerBlock(Blocks.BRAIN_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.BRAIN_CORAL_WALL_FAN, Direction.DOWN, p));
/*  737 */     BUBBLE_CORAL_FAN = registerBlock(Blocks.BUBBLE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.BUBBLE_CORAL_WALL_FAN, Direction.DOWN, p));
/*  738 */     FIRE_CORAL_FAN = registerBlock(Blocks.FIRE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.FIRE_CORAL_WALL_FAN, Direction.DOWN, p));
/*  739 */     HORN_CORAL_FAN = registerBlock(Blocks.HORN_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.HORN_CORAL_WALL_FAN, Direction.DOWN, p));
/*  740 */     DEAD_TUBE_CORAL_FAN = registerBlock(Blocks.DEAD_TUBE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_TUBE_CORAL_WALL_FAN, Direction.DOWN, p));
/*  741 */     DEAD_BRAIN_CORAL_FAN = registerBlock(Blocks.DEAD_BRAIN_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_BRAIN_CORAL_WALL_FAN, Direction.DOWN, p));
/*  742 */     DEAD_BUBBLE_CORAL_FAN = registerBlock(Blocks.DEAD_BUBBLE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, Direction.DOWN, p));
/*  743 */     DEAD_FIRE_CORAL_FAN = registerBlock(Blocks.DEAD_FIRE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_FIRE_CORAL_WALL_FAN, Direction.DOWN, p));
/*  744 */     DEAD_HORN_CORAL_FAN = registerBlock(Blocks.DEAD_HORN_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_HORN_CORAL_WALL_FAN, Direction.DOWN, p));
...
/*      */ 
/*      */   
/*  791 */   public static final Item REDSTONE = registerItem("redstone", createBlockItemWithCustomItemName(Blocks.REDSTONE_WIRE), new Item.Properties().trimMaterial(TrimMaterials.REDSTONE)); public static final Item REDSTONE_TORCH; static {
/*  792 */     REDSTONE_TORCH = registerBlock(Blocks.REDSTONE_TORCH, (b, p) -> new StandingAndWallBlockItem(b, Blocks.REDSTONE_WALL_TORCH, Direction.DOWN, p));
...
/*  800 */   public static final Item OBSERVER = registerBlock(Blocks.OBSERVER); public static final Item HOPPER; public static final Item DISPENSER; public static final Item DROPPER; static {
/*  801 */     HOPPER = registerBlock(Blocks.HOPPER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  802 */     DISPENSER = registerBlock(Blocks.DISPENSER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*  803 */     DROPPER = registerBlock(Blocks.DROPPER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*      */   }
/*      */   
...
/*  820 */   public static final Item TRIPWIRE_HOOK = registerBlock(Blocks.TRIPWIRE_HOOK); public static final Item TRAPPED_CHEST; static {
/*  821 */     TRAPPED_CHEST = registerBlock(Blocks.TRAPPED_CHEST, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/*      */   }
/*      */   
...
/*  949 */   public static final Item BLACK_HARNESS = registerItem("black_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.BLACK))); public static final Item MINECART; public static final Item CHEST_MINECART; public static final Item FURNACE_MINECART; public static final Item TNT_MINECART; public static final Item HOPPER_MINECART; public static final Item CARROT_ON_A_STICK; public static final Item WARPED_FUNGUS_ON_A_STICK;
/*      */   static {
/*  951 */     MINECART = registerItem("minecart", p -> new MinecartItem(EntityType.MINECART, p), new Item.Properties().stacksTo(1));
/*  952 */     CHEST_MINECART = registerItem("chest_minecart", p -> new MinecartItem(EntityType.CHEST_MINECART, p), new Item.Properties().stacksTo(1));
/*  953 */     FURNACE_MINECART = registerItem("furnace_minecart", p -> new MinecartItem(EntityType.FURNACE_MINECART, p), new Item.Properties().stacksTo(1));
/*  954 */     TNT_MINECART = registerItem("tnt_minecart", p -> new MinecartItem(EntityType.TNT_MINECART, p), new Item.Properties().stacksTo(1));
/*  955 */     HOPPER_MINECART = registerItem("hopper_minecart", p -> new MinecartItem(EntityType.HOPPER_MINECART, p), new Item.Properties().stacksTo(1));
/*  956 */     CARROT_ON_A_STICK = registerItem("carrot_on_a_stick", p -> new FoodOnAStickItem(EntityType.PIG, 7, p), new Item.Properties().durability(25));
/*  957 */     WARPED_FUNGUS_ON_A_STICK = registerItem("warped_fungus_on_a_stick", p -> new FoodOnAStickItem(EntityType.STRIDER, 1, p), new Item.Properties().durability(100));
/*  958 */   } public static final Item PHANTOM_MEMBRANE = registerItem("phantom_membrane");
/*  959 */   public static final Item ELYTRA = registerItem("elytra", new Item.Properties().durability(432).rarity(Rarity.EPIC).<Unit>component(DataComponents.GLIDER, Unit.INSTANCE).<Equippable>component(DataComponents.EQUIPPABLE, Equippable.builder(EquipmentSlot.CHEST).setEquipSound(SoundEvents.ARMOR_EQUIP_ELYTRA).setAsset(EquipmentAssets.ELYTRA).setDamageOnHurt(false).build()).repairable(PHANTOM_MEMBRANE)); public static final Item OAK_BOAT; public static final Item OAK_CHEST_BOAT; public static final Item SPRUCE_BOAT; public static final Item SPRUCE_CHEST_BOAT; public static final Item BIRCH_BOAT; public static final Item BIRCH_CHEST_BOAT; public static final Item JUNGLE_BOAT; public static final Item JUNGLE_CHEST_BOAT; public static final Item ACACIA_BOAT; public static final Item ACACIA_CHEST_BOAT; public static final Item CHERRY_BOAT; public static final Item CHERRY_CHEST_BOAT; public static final Item DARK_OAK_BOAT; public static final Item DARK_OAK_CHEST_BOAT; public static final Item PALE_OAK_BOAT; public static final Item PALE_OAK_CHEST_BOAT; public static final Item MANGROVE_BOAT; public static final Item MANGROVE_CHEST_BOAT; public static final Item BAMBOO_RAFT; public static final Item BAMBOO_CHEST_RAFT; static {
/*  960 */     OAK_BOAT = registerItem("oak_boat", p -> new BoatItem(EntityType.OAK_BOAT, p), new Item.Properties().stacksTo(1));
/*  961 */     OAK_CHEST_BOAT = registerItem("oak_chest_boat", p -> new BoatItem(EntityType.OAK_CHEST_BOAT, p), new Item.Properties().stacksTo(1));
/*  962 */     SPRUCE_BOAT = registerItem("spruce_boat", p -> new BoatItem(EntityType.SPRUCE_BOAT, p), new Item.Properties().stacksTo(1));
/*  963 */     SPRUCE_CHEST_BOAT = registerItem("spruce_chest_boat", p -> new BoatItem(EntityType.SPRUCE_CHEST_BOAT, p), new Item.Properties().stacksTo(1));
/*  964 */     BIRCH_BOAT = registerItem("birch_boat", p -> new BoatItem(EntityType.BIRCH_BOAT, p), new Item.Properties().stacksTo(1));
/*  965 */     BIRCH_CHEST_BOAT = registerItem("birch_chest_boat", p -> new BoatItem(EntityType.BIRCH_CHEST_BOAT, p), new Item.Properties().stacksTo(1));
/*  966 */     JUNGLE_BOAT = registerItem("jungle_boat", p -> new BoatItem(EntityType.JUNGLE_BOAT, p), new Item.Properties().stacksTo(1));
/*  967 */     JUNGLE_CHEST_BOAT = registerItem("jungle_chest_boat", p -> new BoatItem(EntityType.JUNGLE_CHEST_BOAT, p), new Item.Properties().stacksTo(1));
/*  968 */     ACACIA_BOAT = registerItem("acacia_boat", p -> new BoatItem(EntityType.ACACIA_BOAT, p), new Item.Properties().stacksTo(1));
/*  969 */     ACACIA_CHEST_BOAT = registerItem("acacia_chest_boat", p -> new BoatItem(EntityType.ACACIA_CHEST_BOAT, p), new Item.Properties().stacksTo(1));
/*  970 */     CHERRY_BOAT = registerItem("cherry_boat", p -> new BoatItem(EntityType.CHERRY_BOAT, p), new Item.Properties().stacksTo(1));
/*  971 */     CHERRY_CHEST_BOAT = registerItem("cherry_chest_boat", p -> new BoatItem(EntityType.CHERRY_CHEST_BOAT, p), new Item.Properties().stacksTo(1));
/*  972 */     DARK_OAK_BOAT = registerItem("dark_oak_boat", p -> new BoatItem(EntityType.DARK_OAK_BOAT, p), new Item.Properties().stacksTo(1));
/*  973 */     DARK_OAK_CHEST_BOAT = registerItem("dark_oak_chest_boat", p -> new BoatItem(EntityType.DARK_OAK_CHEST_BOAT, p), new Item.Properties().stacksTo(1));
/*  974 */     PALE_OAK_BOAT = registerItem("pale_oak_boat", p -> new BoatItem(EntityType.PALE_OAK_BOAT, p), new Item.Properties().stacksTo(1));
/*  975 */     PALE_OAK_CHEST_BOAT = registerItem("pale_oak_chest_boat", p -> new BoatItem(EntityType.PALE_OAK_CHEST_BOAT, p), new Item.Properties().stacksTo(1));
/*  976 */     MANGROVE_BOAT = registerItem("mangrove_boat", p -> new BoatItem(EntityType.MANGROVE_BOAT, p), new Item.Properties().stacksTo(1));
/*  977 */     MANGROVE_CHEST_BOAT = registerItem("mangrove_chest_boat", p -> new BoatItem(EntityType.MANGROVE_CHEST_BOAT, p), new Item.Properties().stacksTo(1));
/*  978 */     BAMBOO_RAFT = registerItem("bamboo_raft", p -> new BoatItem(EntityType.BAMBOO_RAFT, p), new Item.Properties().stacksTo(1));
/*  979 */     BAMBOO_CHEST_RAFT = registerItem("bamboo_chest_raft", p -> new BoatItem(EntityType.BAMBOO_CHEST_RAFT, p), new Item.Properties().stacksTo(1));
/*      */   }
...
/*  983 */   public static final Item TEST_BLOCK = registerBlock(Blocks.TEST_BLOCK, GameMasterBlockItem::new, new Item.Properties().rarity(Rarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with((Property)TestBlock.MODE, (Comparable)TestBlockMode.START)));
...
/* 1009 */   public static final Item WOODEN_SWORD = registerItem("wooden_sword", new Item.Properties().sword(ToolMaterial.WOOD, 3.0F, -2.4F)); public static final Item WOODEN_SHOVEL; static {
/* 1010 */     WOODEN_SHOVEL = registerItem("wooden_shovel", p -> new ShovelItem(ToolMaterial.WOOD, 1.5F, -3.0F, p));
/* 1011 */   } public static final Item WOODEN_PICKAXE = registerItem("wooden_pickaxe", new Item.Properties().pickaxe(ToolMaterial.WOOD, 1.0F, -2.8F)); public static final Item WOODEN_AXE; public static final Item WOODEN_HOE; static {
/* 1012 */     WOODEN_AXE = registerItem("wooden_axe", p -> new AxeItem(ToolMaterial.WOOD, 6.0F, -3.2F, p));
/* 1013 */     WOODEN_HOE = registerItem("wooden_hoe", p -> new HoeItem(ToolMaterial.WOOD, 0.0F, -3.0F, p));
/* 1014 */   } public static final Item COPPER_SWORD = registerItem("copper_sword", new Item.Properties().sword(ToolMaterial.COPPER, 3.0F, -2.4F)); public static final Item COPPER_SHOVEL; static {
/* 1015 */     COPPER_SHOVEL = registerItem("copper_shovel", p -> new ShovelItem(ToolMaterial.COPPER, 1.5F, -3.0F, p));
/* 1016 */   } public static final Item COPPER_PICKAXE = registerItem("copper_pickaxe", new Item.Properties().pickaxe(ToolMaterial.COPPER, 1.0F, -2.8F)); public static final Item COPPER_AXE; public static final Item COPPER_HOE; static {
/* 1017 */     COPPER_AXE = registerItem("copper_axe", p -> new AxeItem(ToolMaterial.COPPER, 7.0F, -3.2F, p));
/* 1018 */     COPPER_HOE = registerItem("copper_hoe", p -> new HoeItem(ToolMaterial.COPPER, -1.0F, -2.0F, p));
/* 1019 */   } public static final Item STONE_SWORD = registerItem("stone_sword", new Item.Properties().sword(ToolMaterial.STONE, 3.0F, -2.4F)); public static final Item STONE_SHOVEL; static {
/* 1020 */     STONE_SHOVEL = registerItem("stone_shovel", p -> new ShovelItem(ToolMaterial.STONE, 1.5F, -3.0F, p));
/* 1021 */   } public static final Item STONE_PICKAXE = registerItem("stone_pickaxe", new Item.Properties().pickaxe(ToolMaterial.STONE, 1.0F, -2.8F)); public static final Item STONE_AXE; public static final Item STONE_HOE; static {
/* 1022 */     STONE_AXE = registerItem("stone_axe", p -> new AxeItem(ToolMaterial.STONE, 7.0F, -3.2F, p));
/* 1023 */     STONE_HOE = registerItem("stone_hoe", p -> new HoeItem(ToolMaterial.STONE, -1.0F, -2.0F, p));
/* 1024 */   } public static final Item GOLDEN_SWORD = registerItem("golden_sword", new Item.Properties().sword(ToolMaterial.GOLD, 3.0F, -2.4F)); public static final Item GOLDEN_SHOVEL; static {
/* 1025 */     GOLDEN_SHOVEL = registerItem("golden_shovel", p -> new ShovelItem(ToolMaterial.GOLD, 1.5F, -3.0F, p));
/* 1026 */   } public static final Item GOLDEN_PICKAXE = registerItem("golden_pickaxe", new Item.Properties().pickaxe(ToolMaterial.GOLD, 1.0F, -2.8F)); public static final Item GOLDEN_AXE; public static final Item GOLDEN_HOE; static {
/* 1027 */     GOLDEN_AXE = registerItem("golden_axe", p -> new AxeItem(ToolMaterial.GOLD, 6.0F, -3.0F, p));
/* 1028 */     GOLDEN_HOE = registerItem("golden_hoe", p -> new HoeItem(ToolMaterial.GOLD, 0.0F, -3.0F, p));
/* 1029 */   } public static final Item IRON_SWORD = registerItem("iron_sword", new Item.Properties().sword(ToolMaterial.IRON, 3.0F, -2.4F)); public static final Item IRON_SHOVEL; static {
/* 1030 */     IRON_SHOVEL = registerItem("iron_shovel", p -> new ShovelItem(ToolMaterial.IRON, 1.5F, -3.0F, p));
/* 1031 */   } public static final Item IRON_PICKAXE = registerItem("iron_pickaxe", new Item.Properties().pickaxe(ToolMaterial.IRON, 1.0F, -2.8F)); public static final Item IRON_AXE; public static final Item IRON_HOE; static {
/* 1032 */     IRON_AXE = registerItem("iron_axe", p -> new AxeItem(ToolMaterial.IRON, 6.0F, -3.1F, p));
/* 1033 */     IRON_HOE = registerItem("iron_hoe", p -> new HoeItem(ToolMaterial.IRON, -2.0F, -1.0F, p));
/* 1034 */   } public static final Item DIAMOND_SWORD = registerItem("diamond_sword", new Item.Properties().sword(ToolMaterial.DIAMOND, 3.0F, -2.4F)); public static final Item DIAMOND_SHOVEL; static {
/* 1035 */     DIAMOND_SHOVEL = registerItem("diamond_shovel", p -> new ShovelItem(ToolMaterial.DIAMOND, 1.5F, -3.0F, p));
/* 1036 */   } public static final Item DIAMOND_PICKAXE = registerItem("diamond_pickaxe", new Item.Properties().pickaxe(ToolMaterial.DIAMOND, 1.0F, -2.8F)); public static final Item DIAMOND_AXE; public static final Item DIAMOND_HOE; static {
/* 1037 */     DIAMOND_AXE = registerItem("diamond_axe", p -> new AxeItem(ToolMaterial.DIAMOND, 5.0F, -3.0F, p));
/* 1038 */     DIAMOND_HOE = registerItem("diamond_hoe", p -> new HoeItem(ToolMaterial.DIAMOND, -3.0F, 0.0F, p));
/* 1039 */   } public static final Item NETHERITE_SWORD = registerItem("netherite_sword", new Item.Properties().sword(ToolMaterial.NETHERITE, 3.0F, -2.4F).fireResistant()); public static final Item NETHERITE_SHOVEL; static {
/* 1040 */     NETHERITE_SHOVEL = registerItem("netherite_shovel", p -> new ShovelItem(ToolMaterial.NETHERITE, 1.5F, -3.0F, p), new Item.Properties().fireResistant());
/* 1041 */   } public static final Item NETHERITE_PICKAXE = registerItem("netherite_pickaxe", new Item.Properties().pickaxe(ToolMaterial.NETHERITE, 1.0F, -2.8F).fireResistant()); public static final Item NETHERITE_AXE; public static final Item NETHERITE_HOE; static {
/* 1042 */     NETHERITE_AXE = registerItem("netherite_axe", p -> new AxeItem(ToolMaterial.NETHERITE, 5.0F, -3.0F, p), new Item.Properties().fireResistant());
/* 1043 */     NETHERITE_HOE = registerItem("netherite_hoe", p -> new HoeItem(ToolMaterial.NETHERITE, -4.0F, 0.0F, p), new Item.Properties().fireResistant());
...
/* 1082 */   public static final Item COOKED_PORKCHOP = registerItem("cooked_porkchop", new Item.Properties().food(Foods.COOKED_PORKCHOP)); public static final Item PAINTING; static {
/* 1083 */     PAINTING = registerItem("painting", p -> new HangingEntityItem(EntityType.PAINTING, p));
/* 1084 */   } public static final Item GOLDEN_APPLE = registerItem("golden_apple", new Item.Properties().food(Foods.GOLDEN_APPLE, Consumables.GOLDEN_APPLE)); public static final Item OAK_SIGN; public static final Item SPRUCE_SIGN; public static final Item BIRCH_SIGN; public static final Item JUNGLE_SIGN; public static final Item ACACIA_SIGN; public static final Item CHERRY_SIGN; public static final Item DARK_OAK_SIGN; public static final Item PALE_OAK_SIGN; public static final Item MANGROVE_SIGN; public static final Item BAMBOO_SIGN; public static final Item CRIMSON_SIGN; public static final Item WARPED_SIGN; public static final Item OAK_HANGING_SIGN; public static final Item SPRUCE_HANGING_SIGN;
/* 1085 */   public static final Item ENCHANTED_GOLDEN_APPLE = registerItem("enchanted_golden_apple", new Item.Properties().rarity(Rarity.RARE).food(Foods.ENCHANTED_GOLDEN_APPLE, Consumables.ENCHANTED_GOLDEN_APPLE).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true)); public static final Item BIRCH_HANGING_SIGN; public static final Item JUNGLE_HANGING_SIGN; public static final Item ACACIA_HANGING_SIGN; public static final Item CHERRY_HANGING_SIGN; public static final Item DARK_OAK_HANGING_SIGN; public static final Item PALE_OAK_HANGING_SIGN; public static final Item MANGROVE_HANGING_SIGN; public static final Item BAMBOO_HANGING_SIGN; public static final Item CRIMSON_HANGING_SIGN; public static final Item WARPED_HANGING_SIGN; public static final Item BUCKET; public static final Item WATER_BUCKET; public static final Item LAVA_BUCKET; public static final Item POWDER_SNOW_BUCKET; static {
/* 1086 */     OAK_SIGN = registerBlock(Blocks.OAK_SIGN, (b, p) -> new SignItem(b, Blocks.OAK_WALL_SIGN, p), new Item.Properties().stacksTo(16));
/* 1087 */     SPRUCE_SIGN = registerBlock(Blocks.SPRUCE_SIGN, (b, p) -> new SignItem(b, Blocks.SPRUCE_WALL_SIGN, p), new Item.Properties().stacksTo(16));
/* 1088 */     BIRCH_SIGN = registerBlock(Blocks.BIRCH_SIGN, (b, p) -> new SignItem(b, Blocks.BIRCH_WALL_SIGN, p), new Item.Properties().stacksTo(16));
/* 1089 */     JUNGLE_SIGN = registerBlock(Blocks.JUNGLE_SIGN, (b, p) -> new SignItem(b, Blocks.JUNGLE_WALL_SIGN, p), new Item.Properties().stacksTo(16));
/* 1090 */     ACACIA_SIGN = registerBlock(Blocks.ACACIA_SIGN, (b, p) -> new SignItem(b, Blocks.ACACIA_WALL_SIGN, p), new Item.Properties().stacksTo(16));
/* 1091 */     CHERRY_SIGN = registerBlock(Blocks.CHERRY_SIGN, (b, p) -> new SignItem(b, Blocks.CHERRY_WALL_SIGN, p), new Item.Properties().stacksTo(16));
/* 1092 */     DARK_OAK_SIGN = registerBlock(Blocks.DARK_OAK_SIGN, (b, p) -> new SignItem(b, Blocks.DARK_OAK_WALL_SIGN, p), new Item.Properties().stacksTo(16));
/* 1093 */     PALE_OAK_SIGN = registerBlock(Blocks.PALE_OAK_SIGN, (b, p) -> new SignItem(b, Blocks.PALE_OAK_WALL_SIGN, p), new Item.Properties().stacksTo(16));
/* 1094 */     MANGROVE_SIGN = registerBlock(Blocks.MANGROVE_SIGN, (b, p) -> new SignItem(b, Blocks.MANGROVE_WALL_SIGN, p), new Item.Properties().stacksTo(16));
/* 1095 */     BAMBOO_SIGN = registerBlock(Blocks.BAMBOO_SIGN, (b, p) -> new SignItem(b, Blocks.BAMBOO_WALL_SIGN, p), new Item.Properties().stacksTo(16));
/* 1096 */     CRIMSON_SIGN = registerBlock(Blocks.CRIMSON_SIGN, (b, p) -> new SignItem(b, Blocks.CRIMSON_WALL_SIGN, p), new Item.Properties().stacksTo(16));
/* 1097 */     WARPED_SIGN = registerBlock(Blocks.WARPED_SIGN, (b, p) -> new SignItem(b, Blocks.WARPED_WALL_SIGN, p), new Item.Properties().stacksTo(16));
/* 1098 */     OAK_HANGING_SIGN = registerBlock(Blocks.OAK_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.OAK_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16));
/* 1099 */     SPRUCE_HANGING_SIGN = registerBlock(Blocks.SPRUCE_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.SPRUCE_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16));
/* 1100 */     BIRCH_HANGING_SIGN = registerBlock(Blocks.BIRCH_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.BIRCH_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16));
/* 1101 */     JUNGLE_HANGING_SIGN = registerBlock(Blocks.JUNGLE_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.JUNGLE_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16));
/* 1102 */     ACACIA_HANGING_SIGN = registerBlock(Blocks.ACACIA_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.ACACIA_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16));
/* 1103 */     CHERRY_HANGING_SIGN = registerBlock(Blocks.CHERRY_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.CHERRY_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16));
/* 1104 */     DARK_OAK_HANGING_SIGN = registerBlock(Blocks.DARK_OAK_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.DARK_OAK_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16));
/* 1105 */     PALE_OAK_HANGING_SIGN = registerBlock(Blocks.PALE_OAK_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.PALE_OAK_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16));
/* 1106 */     MANGROVE_HANGING_SIGN = registerBlock(Blocks.MANGROVE_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.MANGROVE_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16));
/* 1107 */     BAMBOO_HANGING_SIGN = registerBlock(Blocks.BAMBOO_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.BAMBOO_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16));
/* 1108 */     CRIMSON_HANGING_SIGN = registerBlock(Blocks.CRIMSON_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.CRIMSON_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16));
/* 1109 */     WARPED_HANGING_SIGN = registerBlock(Blocks.WARPED_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.WARPED_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16));
/* 1110 */     BUCKET = registerItem("bucket", p -> new BucketItem(Fluids.EMPTY, p), new Item.Properties().stacksTo(16));
/* 1111 */     WATER_BUCKET = registerItem("water_bucket", p -> new BucketItem((Fluid)Fluids.WATER, p), new Item.Properties().craftRemainder(BUCKET).stacksTo(1));
/* 1112 */     LAVA_BUCKET = registerItem("lava_bucket", p -> new BucketItem((Fluid)Fluids.LAVA, p), new Item.Properties().craftRemainder(BUCKET).stacksTo(1));
/* 1113 */     POWDER_SNOW_BUCKET = registerItem("powder_snow_bucket", p -> new SolidBucketItem(Blocks.POWDER_SNOW, SoundEvents.BUCKET_EMPTY_POWDER_SNOW, p), new Item.Properties().stacksTo(1).useItemDescriptionPrefix());
...
/* 1116 */   public static final Item MILK_BUCKET = registerItem("milk_bucket", new Item.Properties().craftRemainder(BUCKET).<Consumable>component(DataComponents.CONSUMABLE, Consumables.MILK_BUCKET).usingConvertsTo(BUCKET).stacksTo(1)); public static final Item PUFFERFISH_BUCKET; public static final Item SALMON_BUCKET; public static final Item COD_BUCKET; public static final Item TROPICAL_FISH_BUCKET; public static final Item AXOLOTL_BUCKET; public static final Item TADPOLE_BUCKET; static {
/* 1117 */     PUFFERFISH_BUCKET = registerItem("pufferfish_bucket", p -> new MobBucketItem(EntityType.PUFFERFISH, (Fluid)Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, p), new Item.Properties().stacksTo(1).<CustomData>component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.PUFFERFISH));
/* 1118 */     SALMON_BUCKET = registerItem("salmon_bucket", p -> new MobBucketItem(EntityType.SALMON, (Fluid)Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, p), new Item.Properties().stacksTo(1).<CustomData>component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.SALMON));
/* 1119 */     COD_BUCKET = registerItem("cod_bucket", p -> new MobBucketItem(EntityType.COD, (Fluid)Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, p), new Item.Properties().stacksTo(1).<CustomData>component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.COD));
/* 1120 */     TROPICAL_FISH_BUCKET = registerItem("tropical_fish_bucket", p -> new MobBucketItem(EntityType.TROPICAL_FISH, (Fluid)Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, p), new Item.Properties().stacksTo(1).<CustomData>component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.TROPICAL_FISH));
/* 1121 */     AXOLOTL_BUCKET = registerItem("axolotl_bucket", p -> new MobBucketItem(EntityType.AXOLOTL, (Fluid)Fluids.WATER, SoundEvents.BUCKET_EMPTY_AXOLOTL, p), new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
/* 1122 */     TADPOLE_BUCKET = registerItem("tadpole_bucket", p -> new MobBucketItem(EntityType.TADPOLE, (Fluid)Fluids.WATER, SoundEvents.BUCKET_EMPTY_TADPOLE, p), new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
...
/* 1163 */   public static final Item COCOA_BEANS = registerItem("cocoa_beans", createBlockItemWithCustomItemName(Blocks.COCOA)); public static final Item WHITE_DYE; public static final Item ORANGE_DYE; public static final Item MAGENTA_DYE; public static final Item LIGHT_BLUE_DYE; public static final Item YELLOW_DYE; public static final Item LIME_DYE; public static final Item PINK_DYE; public static final Item GRAY_DYE; public static final Item LIGHT_GRAY_DYE; public static final Item CYAN_DYE; public static final Item PURPLE_DYE; public static final Item BLUE_DYE; public static final Item BROWN_DYE; public static final Item GREEN_DYE; public static final Item RED_DYE; public static final Item BLACK_DYE; static {
/* 1164 */     WHITE_DYE = registerItem("white_dye", p -> new DyeItem(DyeColor.WHITE, p));
/* 1165 */     ORANGE_DYE = registerItem("orange_dye", p -> new DyeItem(DyeColor.ORANGE, p));
/* 1166 */     MAGENTA_DYE = registerItem("magenta_dye", p -> new DyeItem(DyeColor.MAGENTA, p));
/* 1167 */     LIGHT_BLUE_DYE = registerItem("light_blue_dye", p -> new DyeItem(DyeColor.LIGHT_BLUE, p));
/* 1168 */     YELLOW_DYE = registerItem("yellow_dye", p -> new DyeItem(DyeColor.YELLOW, p));
/* 1169 */     LIME_DYE = registerItem("lime_dye", p -> new DyeItem(DyeColor.LIME, p));
/* 1170 */     PINK_DYE = registerItem("pink_dye", p -> new DyeItem(DyeColor.PINK, p));
/* 1171 */     GRAY_DYE = registerItem("gray_dye", p -> new DyeItem(DyeColor.GRAY, p));
/* 1172 */     LIGHT_GRAY_DYE = registerItem("light_gray_dye", p -> new DyeItem(DyeColor.LIGHT_GRAY, p));
/* 1173 */     CYAN_DYE = registerItem("cyan_dye", p -> new DyeItem(DyeColor.CYAN, p));
/* 1174 */     PURPLE_DYE = registerItem("purple_dye", p -> new DyeItem(DyeColor.PURPLE, p));
/* 1175 */     BLUE_DYE = registerItem("blue_dye", p -> new DyeItem(DyeColor.BLUE, p));
/* 1176 */     BROWN_DYE = registerItem("brown_dye", p -> new DyeItem(DyeColor.BROWN, p));
/* 1177 */     GREEN_DYE = registerItem("green_dye", p -> new DyeItem(DyeColor.GREEN, p));
/* 1178 */     RED_DYE = registerItem("red_dye", p -> new DyeItem(DyeColor.RED, p));
/* 1179 */     BLACK_DYE = registerItem("black_dye", p -> new DyeItem(DyeColor.BLACK, p));
...
/* 1200 */   public static final Item COOKIE = registerItem("cookie", new Item.Properties().food(Foods.COOKIE)); public static final Item CRAFTER; static {
/* 1201 */     CRAFTER = registerBlock(Blocks.CRAFTER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/* 1202 */   } public static final Item FILLED_MAP = registerItem("filled_map", MapItem::new, new Item.Properties().<MapItemColor>component(DataComponents.MAP_COLOR, MapItemColor.DEFAULT).component(DataComponents.MAP_DECORATIONS, MapDecorations.EMPTY));
...
/* 1206 */   public static final Item PUMPKIN_SEEDS = registerItem(net.minecraft.references.Items.PUMPKIN_SEEDS, createBlockItemWithCustomItemName(Blocks.PUMPKIN_STEM));
/* 1207 */   public static final Item MELON_SEEDS = registerItem(net.minecraft.references.Items.MELON_SEEDS, createBlockItemWithCustomItemName(Blocks.MELON_STEM));
...
/* 1219 */   public static final Item POTION = registerItem("potion", PotionItem::new, new Item.Properties().stacksTo(1).<PotionContents>component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).<Consumable>component(DataComponents.CONSUMABLE, Consumables.DEFAULT_DRINK).usingConvertsTo(GLASS_BOTTLE));
...
/* 1223 */   public static final Item MAGMA_CREAM = registerItem("magma_cream"); public static final Item BREWING_STAND; static {
/* 1224 */     BREWING_STAND = registerBlock(Blocks.BREWING_STAND, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
...
/*      */   
/* 1344 */   public static final Item EXPERIENCE_BOTTLE = registerItem("experience_bottle", ExperienceBottleItem::new, new Item.Properties().rarity(Rarity.UNCOMMON).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true));
...
/* 1348 */   public static final Item WRITTEN_BOOK = registerItem("written_book", WrittenBookItem::new, new Item.Properties().stacksTo(16).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true));
/* 1349 */   public static final Item BREEZE_ROD = registerItem("breeze_rod");
/* 1350 */   public static final Item MACE = registerItem("mace", MaceItem::new, new Item.Properties().rarity(Rarity.EPIC).durability(500).<Tool>component(DataComponents.TOOL, MaceItem.createToolProperties()).repairable(BREEZE_ROD).attributes(MaceItem.createAttributes()).enchantable(15).component(DataComponents.WEAPON, new Weapon(1))); public static final Item ITEM_FRAME; public static final Item GLOW_ITEM_FRAME; static {
/* 1351 */     ITEM_FRAME = registerItem("item_frame", p -> new ItemFrameItem(EntityType.ITEM_FRAME, p));
/* 1352 */     GLOW_ITEM_FRAME = registerItem("glow_item_frame", p -> new ItemFrameItem(EntityType.GLOW_ITEM_FRAME, p));
...
/* 1359 */   public static final Item GOLDEN_CARROT = registerItem("golden_carrot", new Item.Properties().food(Foods.GOLDEN_CARROT)); public static final Item SKELETON_SKULL; public static final Item WITHER_SKELETON_SKULL; public static final Item PLAYER_HEAD; public static final Item ZOMBIE_HEAD; public static final Item CREEPER_HEAD; public static final Item DRAGON_HEAD; public static final Item PIGLIN_HEAD; static {
/* 1360 */     SKELETON_SKULL = registerBlock(Blocks.SKELETON_SKULL, (b, p) -> new StandingAndWallBlockItem(b, Blocks.SKELETON_WALL_SKULL, Direction.DOWN, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
/* 1361 */     WITHER_SKELETON_SKULL = registerBlock(Blocks.WITHER_SKELETON_SKULL, (b, p) -> new StandingAndWallBlockItem(b, Blocks.WITHER_SKELETON_WALL_SKULL, Direction.DOWN, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.RARE).equippableUnswappable(EquipmentSlot.HEAD));
/* 1362 */     PLAYER_HEAD = registerBlock(Blocks.PLAYER_HEAD, (b, p) -> new PlayerHeadItem(b, Blocks.PLAYER_WALL_HEAD, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
/* 1363 */     ZOMBIE_HEAD = registerBlock(Blocks.ZOMBIE_HEAD, (b, p) -> new StandingAndWallBlockItem(b, Blocks.ZOMBIE_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
/* 1364 */     CREEPER_HEAD = registerBlock(Blocks.CREEPER_HEAD, (b, p) -> new StandingAndWallBlockItem(b, Blocks.CREEPER_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
/* 1365 */     DRAGON_HEAD = registerBlock(Blocks.DRAGON_HEAD, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DRAGON_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.EPIC).equippableUnswappable(EquipmentSlot.HEAD));
/* 1366 */     PIGLIN_HEAD = registerBlock(Blocks.PIGLIN_HEAD, (b, p) -> new StandingAndWallBlockItem(b, Blocks.PIGLIN_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
/* 1367 */   } public static final Item NETHER_STAR = registerItem("nether_star", new Item.Properties().rarity(Rarity.RARE).<Boolean>component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true).component(DataComponents.DAMAGE_RESISTANT, new DamageResistant(DamageTypeTags.IS_EXPLOSION)));
...
/* 1371 */   public static final Item ENCHANTED_BOOK = registerItem("enchanted_book", new Item.Properties().stacksTo(1).rarity(Rarity.RARE).<ItemEnchantments>component(DataComponents.STORED_ENCHANTMENTS, ItemEnchantments.EMPTY).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true));
...
/* 1389 */   public static final Item NAME_TAG = registerItem("name_tag", NameTagItem::new); public static final Item COMMAND_BLOCK_MINECART; static {
/* 1390 */     COMMAND_BLOCK_MINECART = registerItem("command_block_minecart", p -> new MinecartItem(EntityType.COMMAND_BLOCK_MINECART, p), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC));
/* 1391 */   } public static final Item MUTTON = registerItem("mutton", new Item.Properties().food(Foods.MUTTON));
/* 1392 */   public static final Item COOKED_MUTTON = registerItem("cooked_mutton", new Item.Properties().food(Foods.COOKED_MUTTON)); public static final Item WHITE_BANNER; public static final Item ORANGE_BANNER; public static final Item MAGENTA_BANNER; public static final Item LIGHT_BLUE_BANNER; public static final Item YELLOW_BANNER; public static final Item LIME_BANNER; public static final Item PINK_BANNER; public static final Item GRAY_BANNER; public static final Item LIGHT_GRAY_BANNER; public static final Item CYAN_BANNER; public static final Item PURPLE_BANNER; public static final Item BLUE_BANNER; public static final Item BROWN_BANNER; public static final Item GREEN_BANNER; public static final Item RED_BANNER; public static final Item BLACK_BANNER; static {
/* 1393 */     WHITE_BANNER = registerBlock(Blocks.WHITE_BANNER, (b, p) -> new BannerItem(b, Blocks.WHITE_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1394 */     ORANGE_BANNER = registerBlock(Blocks.ORANGE_BANNER, (b, p) -> new BannerItem(b, Blocks.ORANGE_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1395 */     MAGENTA_BANNER = registerBlock(Blocks.MAGENTA_BANNER, (b, p) -> new BannerItem(b, Blocks.MAGENTA_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1396 */     LIGHT_BLUE_BANNER = registerBlock(Blocks.LIGHT_BLUE_BANNER, (b, p) -> new BannerItem(b, Blocks.LIGHT_BLUE_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1397 */     YELLOW_BANNER = registerBlock(Blocks.YELLOW_BANNER, (b, p) -> new BannerItem(b, Blocks.YELLOW_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1398 */     LIME_BANNER = registerBlock(Blocks.LIME_BANNER, (b, p) -> new BannerItem(b, Blocks.LIME_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1399 */     PINK_BANNER = registerBlock(Blocks.PINK_BANNER, (b, p) -> new BannerItem(b, Blocks.PINK_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1400 */     GRAY_BANNER = registerBlock(Blocks.GRAY_BANNER, (b, p) -> new BannerItem(b, Blocks.GRAY_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1401 */     LIGHT_GRAY_BANNER = registerBlock(Blocks.LIGHT_GRAY_BANNER, (b, p) -> new BannerItem(b, Blocks.LIGHT_GRAY_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1402 */     CYAN_BANNER = registerBlock(Blocks.CYAN_BANNER, (b, p) -> new BannerItem(b, Blocks.CYAN_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1403 */     PURPLE_BANNER = registerBlock(Blocks.PURPLE_BANNER, (b, p) -> new BannerItem(b, Blocks.PURPLE_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1404 */     BLUE_BANNER = registerBlock(Blocks.BLUE_BANNER, (b, p) -> new BannerItem(b, Blocks.BLUE_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1405 */     BROWN_BANNER = registerBlock(Blocks.BROWN_BANNER, (b, p) -> new BannerItem(b, Blocks.BROWN_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1406 */     GREEN_BANNER = registerBlock(Blocks.GREEN_BANNER, (b, p) -> new BannerItem(b, Blocks.GREEN_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1407 */     RED_BANNER = registerBlock(Blocks.RED_BANNER, (b, p) -> new BannerItem(b, Blocks.RED_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1408 */     BLACK_BANNER = registerBlock(Blocks.BLACK_BANNER, (b, p) -> new BannerItem(b, Blocks.BLACK_WALL_BANNER, p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
/* 1409 */   } public static final Item END_CRYSTAL = registerItem("end_crystal", EndCrystalItem::new, new Item.Properties().component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true));
...
/* 1420 */   public static final Item TIPPED_ARROW = registerItem("tipped_arrow", TippedArrowItem::new, new Item.Properties().<PotionContents>component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).component(DataComponents.POTION_DURATION_SCALE, 0.125F));
/* 1421 */   public static final Item LINGERING_POTION = registerItem("lingering_potion", LingeringPotionItem::new, new Item.Properties().stacksTo(1).<PotionContents>component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).component(DataComponents.POTION_DURATION_SCALE, 0.25F));
/* 1422 */   public static final Item SHIELD = registerItem("shield", ShieldItem::new, new Item.Properties().durability(336).<BannerPatternLayers>component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY).repairable(ItemTags.WOODEN_TOOL_MATERIALS).equippableUnswappable(EquipmentSlot.OFFHAND).<BlocksAttacks>component(DataComponents.BLOCKS_ATTACKS, new BlocksAttacks(0.25F, 1.0F, 
/*      */ 
/*      */           
...
/* 1446 */   public static final Item DEBUG_STICK = registerItem("debug_stick", DebugStickItem::new, new Item.Properties().stacksTo(1).rarity(Rarity.EPIC).<DebugStickState>component(DataComponents.DEBUG_STICK_STATE, DebugStickState.EMPTY).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true));
...
/* 1469 */   public static final Item TRIDENT = registerItem("trident", TridentItem::new, new Item.Properties().rarity(Rarity.RARE).durability(250).attributes(TridentItem.createAttributes()).<Tool>component(DataComponents.TOOL, TridentItem.createToolProperties()).enchantable(1).component(DataComponents.WEAPON, new Weapon(1)));
...
/* 1477 */   public static final Item CROSSBOW = registerItem("crossbow", CrossbowItem::new, new Item.Properties().stacksTo(1).durability(465).<ChargedProjectiles>component(DataComponents.CHARGED_PROJECTILES, ChargedProjectiles.EMPTY).enchantable(1));
/* 1478 */   public static final Item SUSPICIOUS_STEW = registerItem("suspicious_stew", new Item.Properties().stacksTo(1).food(Foods.SUSPICIOUS_STEW).<SuspiciousStewEffects>component(DataComponents.SUSPICIOUS_STEW_EFFECTS, SuspiciousStewEffects.EMPTY).usingConvertsTo(BOWL));
...
/* 1491 */   public static final Item COMPOSTER = registerBlock(Blocks.COMPOSTER); public static final Item BARREL; public static final Item SMOKER; public static final Item BLAST_FURNACE; static {
/* 1492 */     BARREL = registerBlock(Blocks.BARREL, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/* 1493 */     SMOKER = registerBlock(Blocks.SMOKER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/* 1494 */     BLAST_FURNACE = registerBlock(Blocks.BLAST_FURNACE, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
...
/* 1507 */   public static final Item GLOW_BERRIES = registerItem("glow_berries", createBlockItemWithCustomItemName(Blocks.CAVE_VINES), new Item.Properties().food(Foods.GLOW_BERRIES)); public static final Item CAMPFIRE; public static final Item SOUL_CAMPFIRE; static {
/* 1508 */     CAMPFIRE = registerBlock(Blocks.CAMPFIRE, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
/* 1509 */     SOUL_CAMPFIRE = registerBlock(Blocks.SOUL_CAMPFIRE, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
...
/* 1513 */   public static final Item BEE_NEST = registerBlock(Blocks.BEE_NEST, new Item.Properties().<Bees>component(DataComponents.BEES, Bees.EMPTY).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with((Property)BeehiveBlock.HONEY_LEVEL, 0)));
/* 1514 */   public static final Item BEEHIVE = registerBlock(Blocks.BEEHIVE, new Item.Properties().<Bees>component(DataComponents.BEES, Bees.EMPTY).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with((Property)BeehiveBlock.HONEY_LEVEL, 0)));
...
/*      */   
/* 1634 */   public static final Item COPPER_GOLEM_STATUE = registerBlock(Blocks.COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with((Property)CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
/* 1635 */   public static final Item EXPOSED_COPPER_GOLEM_STATUE = registerBlock(Blocks.EXPOSED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with((Property)CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
/* 1636 */   public static final Item WEATHERED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WEATHERED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with((Property)CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
/* 1637 */   public static final Item OXIDIZED_COPPER_GOLEM_STATUE = registerBlock(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with((Property)CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
/* 1638 */   public static final Item WAXED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with((Property)CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
/* 1639 */   public static final Item WAXED_EXPOSED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with((Property)CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
/* 1640 */   public static final Item WAXED_WEATHERED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with((Property)CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
/* 1641 */   public static final Item WAXED_OXIDIZED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with((Property)CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
/*      */   
...
/* 1647 */   public static final Item OMINOUS_BOTTLE = registerItem("ominous_bottle", new Item.Properties().rarity(Rarity.UNCOMMON).<Consumable>component(DataComponents.CONSUMABLE, Consumables.OMINOUS_BOTTLE).component(DataComponents.OMINOUS_BOTTLE_AMPLIFIER, new OminousBottleAmplifier(0)));
/*      */   
/*      */   private static Function<Item.Properties, Item> createBlockItemWithCustomItemName(Block block) {
/* 1650 */     return p -> new BlockItem(block, p.useItemDescriptionPrefix());
/*      */   }
/*      */   
/*      */   private static ResourceKey<Item> vanillaItemId(String name) {
/* 1654 */     return ResourceKey.create(Registries.ITEM, Identifier.withDefaultNamespace(name));
/*      */   }
/*      */   
/*      */   private static ResourceKey<Item> blockIdToItemId(ResourceKey<Block> blockName) {
/* 1658 */     return ResourceKey.create(Registries.ITEM, blockName.identifier());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1667 */     return registerItem(ResourceKey.create(Registries.ITEM, EntityType.getKey(type).withSuffix("_spawn_egg")), SpawnEggItem::new, new Item.Properties().spawnEgg(type));
/*      */   }
/*      */   
/*      */   public static Item registerBlock(Block block) {
/* 1671 */     return registerBlock(block, BlockItem::new);
/*      */   }
/*      */   
/*      */   public static Item registerBlock(Block block, Item.Properties properties) {
/* 1675 */     return registerBlock(block, BlockItem::new, properties);
/*      */   }
/*      */   
/*      */   public static Item registerBlock(Block block, UnaryOperator<Item.Properties> propertiesFunction) {
/* 1679 */     return registerBlock(block, (b, p) -> new BlockItem(b, propertiesFunction.apply(p)));
/*      */   }
/*      */ 
/*      */   
...
/* 1694 */     return registerBlock(block, itemFactory, new Item.Properties());
/*      */   }
/*      */   
...
/* 1698 */     return registerItem(blockIdToItemId(block.builtInRegistryHolder().key()), p -> (Item)itemFactory.apply(block, p), properties.useBlockDescriptionPrefix());
/*      */   }
/*      */   
/*      */   public static Item registerItem(String name, Function<Item.Properties, Item> itemFactory) {
/* 1702 */     return registerItem(vanillaItemId(name), itemFactory, new Item.Properties());
/*      */   }
/*      */   
/*      */   public static Item registerItem(String name, Function<Item.Properties, Item> itemFactory, Item.Properties properties) {
/* 1706 */     return registerItem(vanillaItemId(name), itemFactory, properties);
/*      */   }
/*      */   
/*      */   public static Item registerItem(String name, Item.Properties properties) {
/* 1710 */     return registerItem(vanillaItemId(name), Item::new, properties);
/*      */   }
/*      */   
/*      */   public static Item registerItem(String name) {
/* 1714 */     return registerItem(vanillaItemId(name), Item::new, new Item.Properties());
/*      */   }
/*      */   
/*      */   public static Item registerItem(ResourceKey<Item> key, Function<Item.Properties, Item> itemFactory) {
/* 1718 */     return registerItem(key, itemFactory, new Item.Properties());
/*      */   }
/*      */   
...
/* 1722 */     Item item = itemFactory.apply(properties.setId(key));
/* 1723 */     if (item instanceof BlockItem) { BlockItem blockItem = (BlockItem)item;
/* 1724 */       blockItem.registerBlocks(Item.BY_BLOCK, item); }
/*      */     
/* 1726 */     return (Item)Registry.register((Registry)BuiltInRegistries.ITEM, key, item);
/*      */   }
/*      */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/item/Items.class
