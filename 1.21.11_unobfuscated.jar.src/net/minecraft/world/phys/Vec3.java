...
/*     */   static {
/*  20 */     CODEC = Codec.DOUBLE.listOf().comapFlatMap(input -> Util.fixedSize(input, 3).map(()), pos -> List.of(pos.x(), pos.y(), pos.z()));
/*     */   }
/*     */   
...
/*  33 */         FriendlyByteBuf.writeVec3(output, value);
/*     */       }
/*     */     };
/*     */   
...
/*  46 */     return new Vec3(pos.getX(), pos.getY(), pos.getZ());
/*     */   }
/*     */   
/*     */   public static Vec3 atLowerCornerWithOffset(Vec3i pos, double x, double y, double z) {
/*  50 */     return new Vec3(pos.getX() + x, pos.getY() + y, pos.getZ() + z);
/*     */   }
/*     */   
/*     */   public static Vec3 atCenterOf(Vec3i pos) {
/*  54 */     return atLowerCornerWithOffset(pos, 0.5D, 0.5D, 0.5D);
/*     */   }
/*     */   
/*     */   public static Vec3 atBottomCenterOf(Vec3i pos) {
/*  58 */     return atLowerCornerWithOffset(pos, 0.5D, 0.0D, 0.5D);
/*     */   }
/*     */   
/*     */   public static Vec3 upFromBottomCenterOf(Vec3i pos, double yOffset) {
/*  62 */     return atLowerCornerWithOffset(pos, 0.5D, yOffset, 0.5D);
/*     */   }
/*     */   
...
/*  72 */     this(vec.x(), vec.y(), vec.z());
/*     */   }
/*     */   
/*     */   public Vec3(Vec3i vec) {
/*  76 */     this(vec.getX(), vec.getY(), vec.getZ());
/*     */   }
/*     */   
/*     */   public Vec3 vectorTo(Vec3 vec) {
/*  80 */     return new Vec3(vec.x - this.x, vec.y - this.y, vec.z - this.z);
/*     */   }
/*     */   
...
/*  92 */     return this.x * vec.x + this.y * vec.y + this.z * vec.z;
/*     */   }
/*     */   
/*     */   public Vec3 cross(Vec3 vec) {
/*  96 */     return new Vec3(this.y * vec.z - this.z * vec.y, this.z * vec.x - this.x * vec.z, this.x * vec.y - this.y * vec.x);
/*     */   }
/*     */   
/*     */   public Vec3 subtract(Vec3 vec) {
/* 100 */     return subtract(vec.x, vec.y, vec.z);
/*     */   }
/*     */   
/*     */   public Vec3 subtract(double value) {
/* 104 */     return subtract(value, value, value);
/*     */   }
/*     */   
/*     */   public Vec3 subtract(double x, double y, double z) {
/* 108 */     return add(-x, -y, -z);
/*     */   }
/*     */   
/*     */   public Vec3 add(double value) {
/* 112 */     return add(value, value, value);
/*     */   }
/*     */   
/*     */   public Vec3 add(Vec3 vec) {
/* 116 */     return add(vec.x, vec.y, vec.z);
/*     */   }
/*     */   
/*     */   public Vec3 add(double x, double y, double z) {
/* 120 */     return new Vec3(this.x + x, this.y + y, this.z + z);
/*     */   }
/*     */   
/*     */   public boolean closerThan(Position pos, double distance) {
/* 124 */     return (distanceToSqr(pos.x(), pos.y(), pos.z()) < distance * distance);
/*     */   }
/*     */   
...
/* 156 */     return multiply(scale, scale, scale);
/*     */   }
/*     */   
/*     */   public Vec3 reverse() {
/* 160 */     return scale(-1.0D);
/*     */   }
/*     */   
/*     */   public Vec3 multiply(Vec3 scale) {
/* 164 */     return multiply(scale.x, scale.y, scale.z);
/*     */   }
/*     */   
/*     */   public Vec3 multiply(double xScale, double yScale, double zScale) {
/* 168 */     return new Vec3(this.x * xScale, this.y * yScale, this.z * zScale);
/*     */   }
/*     */   
/*     */   public Vec3 horizontal() {
/* 172 */     return new Vec3(this.x, 0.0D, this.z);
/*     */   }
/*     */   
/*     */   public Vec3 offsetRandom(RandomSource random, float offset) {
/* 176 */     return add(((random.nextFloat() - 0.5F) * offset), ((random.nextFloat() - 0.5F) * offset), ((random.nextFloat() - 0.5F) * offset));
/*     */   }
/*     */   
/*     */   public Vec3 offsetRandomXZ(RandomSource random, float offset) {
/* 180 */     return add(((random.nextFloat() - 0.5F) * offset), 0.0D, ((random.nextFloat() - 0.5F) * offset));
/*     */   }
/*     */   
...
/* 188 */     return this.x * this.x + this.y * this.y + this.z * this.z;
/*     */   }
/*     */   
/*     */   public double horizontalDistance() {
/* 192 */     return Math.sqrt(this.x * this.x + this.z * this.z);
/*     */   }
/*     */   
/*     */   public double horizontalDistanceSqr() {
/* 196 */     return this.x * this.x + this.z * this.z;
/*     */   }
/*     */ 
/*     */   
...
/* 224 */     int result = (int)(temp ^ temp >>> 32L);
/* 225 */     temp = Double.doubleToLongBits(this.y);
/* 226 */     result = 31 * result + (int)(temp ^ temp >>> 32L);
/* 227 */     temp = Double.doubleToLongBits(this.z);
/* 228 */     result = 31 * result + (int)(temp ^ temp >>> 32L);
/* 229 */     return result;
/*     */   }
/*     */ 
/*     */   
/*     */   public String toString() {
/* 234 */     return "(" + this.x + ", " + this.y + ", " + this.z + ")";
/*     */   }
/*     */   
/*     */   public Vec3 lerp(Vec3 vec, double a) {
/* 238 */     return new Vec3(Mth.lerp(a, this.x, vec.x), Mth.lerp(a, this.y, vec.y), Mth.lerp(a, this.z, vec.z));
/*     */   }
/*     */   
...
/* 275 */     return new Vec3(-this.z, this.y, this.x);
/*     */   }
/*     */   
/*     */   public static Vec3 directionFromRotation(Vec2 rotation) {
/* 279 */     return directionFromRotation(rotation.x, rotation.y);
/*     */   }
/*     */ 
/*     */   
...
/* 306 */     return axis.choose(this.x, this.y, this.z);
/*     */   }
/*     */   
...
/* 318 */     return new Vec3(this.x + distance * 
/* 319 */         normal.getX(), this.y + distance * 
/* 320 */         normal.getY(), this.z + distance * 
/* 321 */         normal.getZ());
/*     */   }
/*     */ 
/*     */ 
...
/* 341 */     return new Vector3f((float)this.x, (float)this.y, (float)this.z);
/*     */   }
/*     */   
...
/* 368 */     return applyLocalCoordinatesToRotation(rotation(), direction);
/*     */   }
/*     */   
/*     */   public boolean isFinite() {
/* 372 */     return (Double.isFinite(this.x) && Double.isFinite(this.y) && Double.isFinite(this.z));
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/phys/Vec3.class
