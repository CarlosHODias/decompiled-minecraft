...
/*  64 */     return getCoords(axis).getDouble(i);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  74 */     return move(delta.x, delta.y, delta.z);
/*     */   }
/*     */   
/*     */   public VoxelShape move(Vec3i delta) {
/*  78 */     return move(delta.getX(), delta.getY(), delta.getZ());
/*     */   }
/*     */ 
/*     */   
...
/*     */           
/*  88 */           getCoords(Direction.Axis.X), dx), (DoubleList)new OffsetDoubleList(
/*  89 */           getCoords(Direction.Axis.Y), dy), (DoubleList)new OffsetDoubleList(
...
/*  96 */     forAllBoxes((x1, y1, z1, x2, y2, z2) -> result[0] = Shapes.joinUnoptimized(result[0], Shapes.box(x1, y1, z1, x2, y2, z2), BooleanOp.OR));
/*     */ 
/*     */     
/*  99 */     return result[0];
/*     */   }
...
/* 103 */     this.shape.forAllEdges((xi1, yi1, zi1, xi2, yi2, zi2) -> consumer.consume(get(Direction.Axis.X, consumer), get(Direction.Axis.Y, yi1), get(Direction.Axis.Z, zi1), get(Direction.Axis.X, xi2), get(Direction.Axis.Y, yi2), get(Direction.Axis.Z, zi2)), true);
/*     */   }
/*     */   
...
/* 151 */     return Mth.binarySearch(0, this.shape.getSize(axis) + 1, index -> (coord < get(coord, axis))) - 1;
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     MutableObject<Vec3> closest = new MutableObject();
/* 181 */     forAllBoxes((x1, y1, z1, x2, y2, z2) -> {
/*     */           double x = Mth.clamp(point.x(), x1, x2), y = Mth.clamp(point.y(), y1, y2), z = Mth.clamp(point.z(), z1, z2);
/*     */           
...
/*     */           }
/*     */         });
/* 190 */     return Optional.of(Objects.<Vec3>requireNonNull((Vec3)closest.get()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 202 */       VoxelShape voxelShape = this.faces[direction.ordinal()];
/* 203 */       if (voxelShape != null) {
/* 204 */         return voxelShape;
/*     */       }
/*     */     } else {
...
/* 250 */     return collideX(AxisCycle.between(axis, Direction.Axis.X), moving, distance);
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/phys/shapes/VoxelShape.class
