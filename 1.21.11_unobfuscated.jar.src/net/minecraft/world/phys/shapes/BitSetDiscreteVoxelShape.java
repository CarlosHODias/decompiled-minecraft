...
/*  72 */     return (x * this.ySize + y) * this.zSize + z;
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isFull(int x, int y, int z) {
/*  77 */     return this.storage.get(getIndex(x, y, z));
/*     */   }
/*     */   
...
/*  96 */     fillUpdateBounds(x, y, z, true);
/*     */   }
/*     */ 
/*     */   
...
/* 106 */     return axis.choose(this.xMin, this.yMin, this.zMin);
/*     */   }
/*     */ 
/*     */   
/*     */   public int lastFull(Direction.Axis axis) {
/* 111 */     return axis.choose(this.xMax, this.yMax, this.zMax);
/*     */   }
/*     */   
...
/*     */           boolean[] updatedSlice = { false };
/*     */ 
/*     */ 
/*     */ 
/*     */           
/*     */           yMerger.forMergedIndexes(());
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 229 */     this.storage.clear(getIndex(x, y, startZ), getIndex(x, y, endZ));
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/phys/shapes/BitSetDiscreteVoxelShape.class
