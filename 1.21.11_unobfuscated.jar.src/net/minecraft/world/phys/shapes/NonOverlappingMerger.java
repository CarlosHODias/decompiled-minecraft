...
/* 39 */     for (int j = 0; j < upperSize; j++) {
/* 40 */       if (!consumer.merge(lowerSize - 1, j, lowerSize + j)) {
/* 41 */         return false;
/*    */       }
/*    */     } 
/* 44 */     return true;
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/phys/shapes/NonOverlappingMerger.class
