...
/*  39 */     this(pos.getX(), pos.getY(), pos.getZ(), (pos.getX() + 1), (pos.getY() + 1), (pos.getZ() + 1));
/*     */   }
/*     */   
/*     */   public AABB(Vec3 begin, Vec3 end) {
/*  43 */     this(begin.x, begin.y, begin.z, end.x, end.y, end.z);
/*     */   }
/*     */   
/*     */   public static AABB of(BoundingBox box) {
/*  47 */     return new AABB(box.minX(), box.minY(), box.minZ(), (box.maxX() + 1), (box.maxY() + 1), (box.maxZ() + 1));
/*     */   }
/*     */   
/*     */   public static AABB unitCubeFromLowerCorner(Vec3 pos) {
/*  51 */     return new AABB(pos.x, pos.y, pos.z, pos.x + 1.0D, pos.y + 1.0D, pos.z + 1.0D);
/*     */   }
/*     */   
/*     */   public static AABB encapsulatingFullBlocks(BlockPos pos0, BlockPos pos1) {
/*  55 */     return new AABB(Math.min(pos0.getX(), pos1.getX()), Math.min(pos0.getY(), pos1.getY()), Math.min(pos0.getZ(), pos1.getZ()), (Math.max(pos0.getX(), pos1.getX()) + 1), (Math.max(pos0.getY(), pos1.getY()) + 1), (Math.max(pos0.getZ(), pos1.getZ()) + 1));
/*     */   }
/*     */   
/*     */   public AABB setMinX(double minX) {
/*  59 */     return new AABB(minX, this.minY, this.minZ, this.maxX, this.maxY, this.maxZ);
/*     */   }
/*     */   
/*     */   public AABB setMinY(double minY) {
/*  63 */     return new AABB(this.minX, minY, this.minZ, this.maxX, this.maxY, this.maxZ);
/*     */   }
/*     */   
/*     */   public AABB setMinZ(double minZ) {
/*  67 */     return new AABB(this.minX, this.minY, minZ, this.maxX, this.maxY, this.maxZ);
/*     */   }
/*     */   
/*     */   public AABB setMaxX(double maxX) {
/*  71 */     return new AABB(this.minX, this.minY, this.minZ, maxX, this.maxY, this.maxZ);
/*     */   }
/*     */   
/*     */   public AABB setMaxY(double maxY) {
/*  75 */     return new AABB(this.minX, this.minY, this.minZ, this.maxX, maxY, this.maxZ);
/*     */   }
/*     */   
/*     */   public AABB setMaxZ(double maxZ) {
/*  79 */     return new AABB(this.minX, this.minY, this.minZ, this.maxX, this.maxY, maxZ);
/*     */   }
/*     */   
/*     */   public double min(Direction.Axis axis) {
/*  83 */     return axis.choose(this.minX, this.minY, this.minZ);
/*     */   }
/*     */   
/*     */   public double max(Direction.Axis axis) {
/*  87 */     return axis.choose(this.maxX, this.maxY, this.maxZ);
/*     */   }
/*     */ 
/*     */   
...
/* 122 */     int result = (int)(temp ^ temp >>> 32L);
/* 123 */     temp = Double.doubleToLongBits(this.minY);
/* 124 */     result = 31 * result + (int)(temp ^ temp >>> 32L);
...
/* 130 */     result = 31 * result + (int)(temp ^ temp >>> 32L);
/* 131 */     temp = Double.doubleToLongBits(this.maxZ);
/* 132 */     result = 31 * result + (int)(temp ^ temp >>> 32L);
/* 133 */     return result;
/*     */   }
/*     */ 
/*     */ 
...
/* 172 */     return expandTowards(delta.x, delta.y, delta.z);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 228 */     return inflate(amountToAddInAllDirections, amountToAddInAllDirections, amountToAddInAllDirections);
/*     */   }
/*     */   
...
/* 254 */     return new AABB(this.minX + xa, this.minY + ya, this.minZ + za, this.maxX + xa, this.maxY + ya, this.maxZ + za);
/*     */   }
/*     */   
/*     */   public AABB move(BlockPos pos) {
/* 258 */     return new AABB(this.minX + pos.getX(), this.minY + pos.getY(), this.minZ + pos.getZ(), this.maxX + pos.getX(), this.maxY + pos.getY(), this.maxZ + pos.getZ());
/*     */   }
/*     */   
/*     */   public AABB move(Vec3 pos) {
/* 262 */     return move(pos.x, pos.y, pos.z);
/*     */   }
/*     */   
/*     */   public AABB move(Vector3f pos) {
/* 266 */     return move(pos.x, pos.y, pos.z);
/*     */   }
/*     */   
/*     */   public boolean intersects(AABB aabb) {
/* 270 */     return intersects(aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean intersects(double minX, double minY, double minZ, double maxX, double maxY, double maxZ) {
/* 275 */     return (this.minX < maxX && this.maxX > minX && this.minY < maxY && this.maxY > minY && this.minZ < maxZ && this.maxZ > minZ);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 284 */     return intersects(Math.min(min.x, max.x), Math.min(min.y, max.y), Math.min(min.z, max.z), Math.max(min.x, max.x), Math.max(min.y, max.y), Math.max(min.z, max.z));
/*     */   }
/*     */   
/*     */   public boolean intersects(BlockPos pos) {
/* 288 */     return intersects(pos.getX(), pos.getY(), pos.getZ(), (pos.getX() + 1), (pos.getY() + 1), (pos.getZ() + 1));
/*     */   }
/*     */   
/*     */   public boolean contains(Vec3 vec) {
/* 292 */     return contains(vec.x, vec.y, vec.z);
/*     */   }
/*     */   
/*     */   public boolean contains(double x, double y, double z) {
/* 296 */     return (x >= this.minX && x < this.maxX && y >= this.minY && y < this.maxY && z >= this.minZ && z < this.maxZ);
/*     */   }
/*     */   
...
/* 327 */     return inflate(-xSubstract, -ySubtract, -zSubtract);
/*     */   }
/*     */   
/*     */   public AABB deflate(double amount) {
/* 331 */     return inflate(-amount);
/*     */   }
/*     */   
/*     */   public Optional<Vec3> clip(Vec3 from, Vec3 to) {
/* 335 */     return clip(this.minX, this.minY, this.minZ, this.maxX, this.maxY, this.maxZ, from, to);
/*     */   }
/*     */   
...
/* 374 */     return getDirection(aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ, from, scaleReference, direction, dx, dy, dz);
/*     */   }
/*     */   
...
/* 471 */     return new AABB(center.x - sizeX / 2.0D, center.y - sizeY / 2.0D, center.z - sizeZ / 2.0D, center.x + sizeX / 2.0D, center.y + sizeY / 2.0D, center.z + sizeZ / 2.0D);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/world/phys/AABB.class
