...
/*    */   
/* 13 */   public float x() { return this.x; } public static final com.mojang.serialization.Codec<Rotations> CODEC; public final String toString() { // Byte code:
/*    */     //   0: aload_0
...
/*    */   
/*    */   static {
/* 18 */     CODEC = com.mojang.serialization.Codec.FLOAT.listOf().comapFlatMap(input -> Util.fixedSize(input, 3).map(()), rotations -> List.of(rotations.x(), rotations.y(), rotations.z()));
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/core/Rotations.class
