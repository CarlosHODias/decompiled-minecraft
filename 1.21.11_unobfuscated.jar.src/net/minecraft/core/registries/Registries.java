...
/* 301 */     return ResourceKey.create(DIMENSION, levelStem.identifier());
/*     */   }
/*     */   
/*     */   public static ResourceKey<LevelStem> levelToLevelStem(ResourceKey<Level> level) {
/* 305 */     return ResourceKey.create(LEVEL_STEM, level.identifier());
/*     */   }
/*     */   
/*     */   private static <T> ResourceKey<Registry<T>> createRegistryKey(String name) {
/* 309 */     return ResourceKey.createRegistryKey(Identifier.withDefaultNamespace(name));
/*     */   }
/*     */ 
/*     */   
/*     */   public static String elementsDirPath(ResourceKey<? extends Registry<?>> registryKey) {
/* 314 */     return registryKey.identifier().getPath();
/*     */   }
/*     */ 
/*     */   
/*     */   public static String tagsDirPath(ResourceKey<? extends Registry<?>> registryKey) {
/* 319 */     return "tags/" + registryKey.identifier().getPath();
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/core/registries/Registries.class
