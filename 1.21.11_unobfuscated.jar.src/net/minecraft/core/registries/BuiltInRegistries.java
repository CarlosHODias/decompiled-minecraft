...
/*     */   
/* 170 */   private static final WritableRegistry<WritableRegistry<?>> WRITABLE_REGISTRY = (WritableRegistry<WritableRegistry<?>>)new MappedRegistry(ResourceKey.createRegistryKey(Registries.ROOT_REGISTRY_NAME), Lifecycle.stable());
/*     */ 
/*     */ 
/*     */   
...
/*     */   
/* 272 */   public static final Registry<? extends Registry<?>> REGISTRY = (Registry)WRITABLE_REGISTRY;
/*     */   
/*     */   private static <T> Registry<T> registerSimple(ResourceKey<? extends Registry<T>> name, RegistryBootstrap<T> loader) {
/* 275 */     return (Registry<T>)internalRegister(name, new MappedRegistry(name, Lifecycle.stable(), false), loader);
/*     */   }
/*     */   
...
/* 279 */     return (Registry<T>)internalRegister(name, new MappedRegistry(name, Lifecycle.stable(), true), loader);
/*     */   }
/*     */   
...
/* 283 */     return (DefaultedRegistry<T>)internalRegister(name, new DefaultedMappedRegistry(defaultKey, name, Lifecycle.stable(), false), loader);
/*     */   }
/*     */   
...
/* 287 */     return (DefaultedRegistry<T>)internalRegister(name, new DefaultedMappedRegistry(defaultKey, name, Lifecycle.stable(), true), loader);
/*     */   }
/*     */ 
/*     */   
...
/* 294 */     LOADERS.put(key, () -> loader.run((Registry)registry));
/*     */     
...
/* 344 */     return ((WritableRegistry)registry).createRegistrationLookup();
/*     */   }
/*     */   
/*     */   private static void bindBootstrappedTagsToEmpty(Registry<?> registry) {
/* 348 */     ((MappedRegistry)registry).bindAllTagsToEmpty();
/*     */   }
/*     */   
/*     */   @FunctionalInterface
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/core/registries/BuiltInRegistries.class
