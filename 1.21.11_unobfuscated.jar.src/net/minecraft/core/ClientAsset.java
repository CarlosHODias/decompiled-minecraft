...
/*    */   }
/*    */   
/*    */   public static final class ResourceTexture extends Record implements Texture { private final Identifier id;
...
/*    */ 
/*    */     
/* 26 */     public static final com.mojang.serialization.Codec<ResourceTexture> CODEC = Identifier.CODEC.xmap(ResourceTexture::new, ResourceTexture::id);
/*    */     
/* 28 */     public static final com.mojang.serialization.MapCodec<ResourceTexture> DEFAULT_FIELD_CODEC = CODEC.fieldOf("asset_id");
/*    */     
/* 30 */     public static final net.minecraft.network.codec.StreamCodec<io.netty.buffer.ByteBuf, ResourceTexture> STREAM_CODEC = Identifier.STREAM_CODEC.map(ResourceTexture::new, ResourceTexture::id);
/*    */     
/*    */     public ResourceTexture(Identifier texture) {
/* 33 */       this(texture, 
/*    */           
/* 35 */           texture.withPath(path -> "textures/" + path + ".png"));
/*    */     } }
...
/* 46 */       return this.texturePath;
/*    */     } }
/*    */ 
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/core/ClientAsset.class
