...
/*     */   private final java.util.List<String> nuggets;
/*     */   
/*   7 */   public ReportType(String header, java.util.List<String> nuggets) { this.header = header; this.nuggets = nuggets; } public final String toString() { // Byte code:
/*     */     //   0: aload_0
...
/*   7 */     //   0	8	1	o	Ljava/lang/Object; } public java.util.List<String> nuggets() { return this.nuggets; }
/*   8 */    public static final ReportType CRASH = new ReportType("Minecraft Crash Report", 
/*     */       
/*  10 */       java.util.List.of(new String[] { 
...
/*     */       
/*  50 */       java.util.List.of(new String[] { 
...
/*     */       
/*  71 */       java.util.List.of("Don't mind me", "One day I will be a real crash!", "Booo! Haha, did I scare you?", "Help, I'm trapped in a report factory!", "Have I answered your question?", "No hugs here, sorry", "I Can't Believe It's Not A Crash Report!", "Where's the kaboom!?"));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*  85 */       java.util.List.of(new String[] { 
...
/*     */       
/* 110 */       java.util.List.of(new String[] { 
...
/*     */     try {
/* 131 */       return this.nuggets.get((int)(net.minecraft.util.Util.getNanos() % this.nuggets.size()));
/* 132 */     } catch (Throwable ignored) {
/* 133 */       return "Witty comment unavailable :(";
/*     */     } 
/*     */   }
/*     */   
/*     */   public void appendHeader(StringBuilder builder, java.util.List<String> extraComments) {
/* 138 */     builder.append("---- ");
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/ReportType.class
