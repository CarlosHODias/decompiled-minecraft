...
/*  8 */    private static final com.mojang.serialization.MapCodec<Criterion<?>> MAP_CODEC = net.minecraft.util.ExtraCodecs.dispatchOptionalValue("trigger", "conditions", CriteriaTriggers.CODEC, Criterion::trigger, Criterion::criterionCodec);
/*  9 */   public static final com.mojang.serialization.Codec<Criterion<?>> CODEC = MAP_CODEC.codec();
/*    */   
/*    */   private static <T extends CriterionTriggerInstance> com.mojang.serialization.Codec<Criterion<T>> criterionCodec(CriterionTrigger<T> trigger) {
/* 12 */     return trigger.codec().xmap(instance -> new Criterion<>(trigger, instance), Criterion::triggerInstance);
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/advancements/Criterion.class
