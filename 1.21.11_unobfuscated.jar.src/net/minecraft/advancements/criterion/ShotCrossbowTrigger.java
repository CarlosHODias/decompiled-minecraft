...
/* 35 */       return CriteriaTriggers.SHOT_CROSSBOW.createCriterion(new TriggerInstance(Optional.empty(), item));
/*    */     }
/*    */     
/*    */     public static Criterion<TriggerInstance> shotCrossbow(HolderGetter<Item> items, ItemLike itemlike) {
/* 39 */       return CriteriaTriggers.SHOT_CROSSBOW.createCriterion(new TriggerInstance(Optional.empty(), Optional.of(ItemPredicate.Builder.item().of(items, new ItemLike[] { itemlike }).build())));
/*    */     }
/*    */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/advancements/criterion/ShotCrossbowTrigger.class
