...
/*    */   
/*    */   static {
/* 19 */     CODEC = RecordCodecBuilder.create(i -> i.group((com.mojang.datafixers.kinds.App)net.minecraft.core.RegistryCodecs.homogeneousList(net.minecraft.core.registries.Registries.ENCHANTMENT).optionalFieldOf("enchantments").forGetter(EnchantmentPredicate::enchantments), (com.mojang.datafixers.kinds.App)MinMaxBounds.Ints.CODEC.optionalFieldOf("levels", MinMaxBounds.Ints.ANY).forGetter(EnchantmentPredicate::level)).apply((com.mojang.datafixers.kinds.Applicative)i, EnchantmentPredicate::new));
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   public EnchantmentPredicate(Holder<Enchantment> enchantment, MinMaxBounds.Ints level) {
/* 25 */     this((Optional)Optional.of(HolderSet.direct(new Holder[] { enchantment })), level);
/*    */   }
/*    */   
/*    */   public EnchantmentPredicate(HolderSet<Enchantment> enchantments, MinMaxBounds.Ints level) {
/* 29 */     this(Optional.of(enchantments), level);
/*    */   }
/*    */   
/*    */   public boolean containedIn(ItemEnchantments itemEnchantments) {
/* 33 */     if (this.enchantments.isPresent()) {
/*    */       
/* 35 */       for (Holder<Enchantment> enchantment : this.enchantments.get()) {
...
/*    */       
/* 43 */       for (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<Holder<Enchantment>> entry : (Iterable<it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<Holder<Enchantment>>>)itemEnchantments.entrySet()) {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/advancements/criterion/EnchantmentPredicate.class
