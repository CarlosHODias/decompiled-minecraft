...
/*  21 */     //   0	7	0	this	Lnet/minecraft/advancements/criterion/EntityEquipmentPredicate; } public Optional<ItemPredicate> head() { return this.head; } public final int hashCode() { // Byte code:
/*     */     //   0: aload_0
...
/*  21 */     //   0	8	1	o	Ljava/lang/Object; } public Optional<ItemPredicate> chest() { return this.chest; } public Optional<ItemPredicate> legs() { return this.legs; } public Optional<ItemPredicate> feet() { return this.feet; } public Optional<ItemPredicate> body() { return this.body; } public Optional<ItemPredicate> mainhand() { return this.mainhand; } public Optional<ItemPredicate> offhand() { return this.offhand; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public static EntityEquipmentPredicate captainPredicate(HolderGetter<net.minecraft.world.item.Item> items, HolderGetter<net.minecraft.world.level.block.entity.BannerPattern> patternGetter) {
/*  41 */     return Builder.equipment()
/*  42 */       .head(
/*  43 */         ItemPredicate.Builder.item()
/*  44 */         .of(items, new net.minecraft.world.level.ItemLike[] { (net.minecraft.world.level.ItemLike)net.minecraft.world.item.Items.WHITE_BANNER
/*  45 */           }).withComponents(
/*  46 */           DataComponentMatchers.Builder.components().exact(net.minecraft.core.component.DataComponentExactPredicate.someOf(
/*  47 */               net.minecraft.world.entity.raid.Raid.getOminousBannerInstance(patternGetter).getComponents(), new net.minecraft.core.component.DataComponentType[] { net.minecraft.core.component.DataComponents.BANNER_PATTERNS, net.minecraft.core.component.DataComponents.ITEM_NAME
/*     */ 
/*     */               
/*  50 */               })).build()))
/*     */       
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/advancements/criterion/EntityEquipmentPredicate.class
