...
/* 104 */       TreeNodePosition child = this.children.get(i);
/* 105 */       child.y += shift;
/* 106 */       child.mod += shift;
...
/* 142 */     TreeNodePosition vol = this.parent.children.get(0);
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/advancements/TreeNodePosition.class
