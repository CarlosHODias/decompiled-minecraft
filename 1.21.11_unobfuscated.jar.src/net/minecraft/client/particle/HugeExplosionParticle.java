...
/* 13 */     this.lifetime = 6 + this.random.nextInt(4);
/* 14 */     float col = this.random.nextFloat() * 0.6F + 0.4F;
/* 15 */     this.rCol = col;
/* 16 */     this.gCol = col;
/* 17 */     this.bCol = col;
/* 18 */     this.quadSize = 2.0F * (1.0F - (float)size * 0.5F);
/* 19 */     this.sprites = sprites;
...
/* 56 */       return new HugeExplosionParticle(level, x, y, z, xAux, this.sprites);
/*    */     }
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/client/particle/HugeExplosionParticle.class
