...
/*     */   private static final Map<Block, ChunkSectionLayer> TYPE_BY_BLOCK;
/*     */   private static final Map<net.minecraft.world.level.material.Fluid, ChunkSectionLayer> LAYER_BY_FLUID;
/*     */   private static boolean cutoutLeaves;
/*     */   
/*     */   static {
/*  21 */     TYPE_BY_BLOCK = (Map<Block, ChunkSectionLayer>)Util.make(Maps.newHashMap(), map -> {
...
/*     */         });
/* 380 */     LAYER_BY_FLUID = (Map<net.minecraft.world.level.material.Fluid, ChunkSectionLayer>)Util.make(Maps.newHashMap(), map -> {
...
/* 388 */     Block block = state.getBlock();
/* 389 */     if (block instanceof net.minecraft.world.level.block.LeavesBlock) {
/* 390 */       return cutoutLeaves ? ChunkSectionLayer.CUTOUT : ChunkSectionLayer.SOLID;
/*     */     }
/* 392 */     ChunkSectionLayer layer = TYPE_BY_BLOCK.get(block);
/* 393 */     if (layer != null) {
/* 394 */       return layer;
/*     */     }
/* 396 */     return ChunkSectionLayer.SOLID;
/*     */   }
/*     */   
/*     */   public static RenderType getMovingBlockRenderType(BlockState state) {
/* 400 */     Block block = state.getBlock();
/* 401 */     if (block instanceof net.minecraft.world.level.block.LeavesBlock) {
/* 402 */       return cutoutLeaves ? RenderTypes.cutoutMovingBlock() : RenderTypes.solidMovingBlock();
/*     */     }
/* 404 */     ChunkSectionLayer layer = TYPE_BY_BLOCK.get(block);
/* 405 */     if (layer != null) {
/* 406 */       switch (layer) { default: throw new MatchException(null, null);case SOLID: case CUTOUT: case TRANSLUCENT: case TRIPWIRE: break; }  return 
/*     */ 
/*     */ 
/*     */         
/* 410 */         RenderTypes.tripwireMovingBlock();
/*     */     } 
/*     */     
/* 413 */     return RenderTypes.solidMovingBlock();
/*     */   }
/*     */   
/*     */   public static RenderType getRenderType(BlockState state) {
/* 417 */     ChunkSectionLayer renderType = getChunkRenderType(state);
/* 418 */     if (renderType == ChunkSectionLayer.TRANSLUCENT) {
/* 419 */       return Sheets.translucentBlockItemSheet();
/*     */     }
/* 421 */     return Sheets.cutoutBlockSheet();
/*     */   }
/*     */   
/*     */   public static ChunkSectionLayer getRenderLayer(FluidState state) {
/* 425 */     ChunkSectionLayer layer = LAYER_BY_FLUID.get(state.getType());
/* 426 */     if (layer != null) {
/* 427 */       return layer;
/*     */     }
/* 429 */     return ChunkSectionLayer.SOLID;
/*     */   }
/*     */   
/*     */   public static void setCutoutLeaves(boolean cutoutLeaves) {
/* 433 */     ItemBlockRenderTypes.cutoutLeaves = cutoutLeaves;
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/client/renderer/ItemBlockRenderTypes.class
