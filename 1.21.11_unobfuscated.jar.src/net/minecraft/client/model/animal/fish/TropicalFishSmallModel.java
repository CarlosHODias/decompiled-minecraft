...
/* 46 */         .texOffs(2, 12).addBox(0.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, g), 
...
/* 51 */         .texOffs(10, -5).addBox(0.0F, -3.0F, 0.0F, 0.0F, 3.0F, 6.0F, g), 
/* 52 */         PartPose.offset(0.0F, 20.5F, -3.0F));
/*    */ 
/*    */     
/* 55 */     return LayerDefinition.create(mesh, 32, 32);
/*    */   }
/*    */ 
/*    */   
/*    */   public void setupAnim(TropicalFishRenderState state) {
/* 60 */     super.setupAnim(state);
/* 61 */     float amplitudeMultiplier = state.isInWater ? 1.0F : 1.5F;
/* 62 */     this.tail.yRot = -amplitudeMultiplier * 0.45F * Mth.sin((0.6F * state.ageInTicks));
/*    */   }
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/client/model/animal/fish/TropicalFishSmallModel.class
