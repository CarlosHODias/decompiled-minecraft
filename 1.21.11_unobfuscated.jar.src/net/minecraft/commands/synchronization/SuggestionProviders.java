...
/* 19 */   private static final Identifier ID_ASK_SERVER = Identifier.withDefaultNamespace("ask_server"); public static final SuggestionProvider<SharedSuggestionProvider> ASK_SERVER; public static final SuggestionProvider<SharedSuggestionProvider> AVAILABLE_SOUNDS; public static final SuggestionProvider<SharedSuggestionProvider> SUMMONABLE_ENTITIES;
/*    */   static {
/* 21 */     ASK_SERVER = register(ID_ASK_SERVER, (c, p) -> ((SharedSuggestionProvider)c.getSource()).customSuggestion(c));
/* 22 */     AVAILABLE_SOUNDS = register(Identifier.withDefaultNamespace("available_sounds"), (c, p) -> SharedSuggestionProvider.suggestResource(((SharedSuggestionProvider)c.getSource()).getAvailableSounds(), p));
/* 23 */     SUMMONABLE_ENTITIES = register(Identifier.withDefaultNamespace("summonable_entities"), (c, p) -> SharedSuggestionProvider.suggestResource(BuiltInRegistries.ENTITY_TYPE.stream().filter(()), p, EntityType::getKey, EntityType::getDescription));
/*    */   }
/*    */   
...
/* 27 */     SuggestionProvider<SharedSuggestionProvider> previous = PROVIDERS_BY_NAME.putIfAbsent(name, provider);
/* 28 */     if (previous != null) {
...
/*    */     }
/* 31 */     return (SuggestionProvider<S>)new RegisteredSuggestion(name, provider);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 38 */     return (SuggestionProvider)provider;
/*    */   }
/*    */   
/*    */   public static <S extends SharedSuggestionProvider> SuggestionProvider<S> getProvider(Identifier name) {
/* 42 */     return cast(PROVIDERS_BY_NAME.getOrDefault(name, ASK_SERVER));
/*    */   }
/*    */   
...
/* 55 */       return this.delegate.getSuggestions(context, builder);
/*    */     } }
/*    */ 
/*    */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/commands/synchronization/SuggestionProviders.class
