...
/*  51 */     info.serializeToJson((T)argumentType, result);
/*     */   }
/*     */   
...
/*  61 */     serializeArgumentCap(type, (ArgumentTypeInfo)template.type(), template);
/*  62 */     if (!type.isEmpty()) {
/*  63 */       result.add("properties", (JsonElement)type);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 116 */     Set<ArgumentType<?>> result = new HashSet<>();
/* 117 */     findUsedArgumentTypes(node, result, (Set<CommandNode<T>>)referenceOpenHashSet);
/* 118 */     return result;
/*     */   }
/*     */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/commands/synchronization/ArgumentUtils.class
