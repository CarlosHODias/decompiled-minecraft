...
/*  51 */     return ((EntitySelector)context.getArgument(name, EntitySelector.class)).findSingleEntity((CommandSourceStack)context.getSource());
/*     */   }
/*     */   
...
/*  67 */     return ((EntitySelector)context.getArgument(name, EntitySelector.class)).findEntities((CommandSourceStack)context.getSource());
/*     */   }
/*     */   
...
/*  71 */     return ((EntitySelector)context.getArgument(name, EntitySelector.class)).findPlayers((CommandSourceStack)context.getSource());
/*     */   }
/*     */   
...
/*  79 */     return ((EntitySelector)context.getArgument(name, EntitySelector.class)).findSinglePlayer((CommandSourceStack)context.getSource());
/*     */   }
/*     */   
...
/*  97 */     return parse(reader, true);
/*     */   }
/*     */ 
/*     */   
/*     */   public <S> EntitySelector parse(StringReader reader, S source) throws CommandSyntaxException {
/* 102 */     return parse(reader, EntitySelectorParser.allowSelectors(source));
/*     */   }
/*     */   
...
/*     */             SharedSuggestionProvider.suggest(suggestedNames, source);
/*     */           }); }
/*     */     
...
/* 166 */         return new EntityArgument(this.single, this.playersOnly);
/*     */       }
/*     */ 
/*     */       
/*     */       public ArgumentTypeInfo<EntityArgument, ?> type() {
/* 171 */         return EntityArgument.Info.this;
/*     */       }
/*     */     }
/*     */ 
/*     */     
...
/* 190 */       return new Template(((flags & 0x1) != 0), ((flags & 0x2) != 0));
/*     */     }
/*     */ 
/*     */     
...
/* 201 */       return new Template(argument.single, argument.playersOnly);
/*     */     }
/*     */   }
/*     */   
/*     */   public final class Template implements ArgumentTypeInfo.Template<EntityArgument> {
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/commands/arguments/EntityArgument.class
