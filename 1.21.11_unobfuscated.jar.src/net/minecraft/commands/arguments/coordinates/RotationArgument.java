...
/* 17 */   public static final SimpleCommandExceptionType ERROR_NOT_COMPLETE = new SimpleCommandExceptionType((Message)Component.translatable("argument.rotation.incomplete"));
/*    */   
/*    */   public static RotationArgument rotation() {
/* 20 */     return new RotationArgument();
/*    */   }
/*    */   
/*    */   public static Coordinates getRotation(CommandContext<CommandSourceStack> context, String name) {
/* 24 */     return (Coordinates)context.getArgument(name, Coordinates.class);
/*    */   }
/*    */ 
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/commands/arguments/coordinates/RotationArgument.class
