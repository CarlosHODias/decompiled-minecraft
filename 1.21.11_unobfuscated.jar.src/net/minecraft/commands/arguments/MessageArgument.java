...
/*     */ {
/*  30 */   private static final Collection<String> EXAMPLES = Arrays.asList(new String[] { "Hello world!", "foo", "@e", "Hello @p :)" }); private static final Dynamic2CommandExceptionType TOO_LONG;
/*     */   static {
/*  32 */     TOO_LONG = new Dynamic2CommandExceptionType((length, maxLength) -> Component.translatableEscape("argument.message.too_long", new Object[] { length, maxLength }));
/*     */   }
/*     */   public static MessageArgument message() {
/*  35 */     return new MessageArgument();
/*     */   }
/*     */   
...
/*  88 */     return Message.parseText(reader, true);
/*     */   }
/*     */ 
/*     */   
/*     */   public <S> Message parse(StringReader reader, S source) throws CommandSyntaxException {
/*  93 */     return Message.parseText(reader, EntitySelectorParser.allowSelectors(source));
/*     */   }
/*     */ 
/*     */   
...
/* 101 */     public Message(String text, MessageArgument.Part[] parts) { this.text = text; this.parts = parts; } public final String toString() { // Byte code:
/*     */       //   0: aload_0
...
/* 103 */       return toComponent(sender, sender.permissions().hasPermission(Permissions.COMMANDS_ENTITY_SELECTORS));
/*     */     }
/*     */     
...
/* 108 */         return (Component)Component.literal(this.text);
/*     */       }
/*     */       
...
/* 132 */         throw MessageArgument.TOO_LONG.create(reader.getRemainingLength(), 256);
/*     */       }
/*     */       
...
/*     */ 
/*     */       
/* 165 */       return new Message(text, result.<MessageArgument.Part>toArray(new MessageArgument.Part[0]));
/*     */     } }
...
/* 171 */       return EntitySelector.joinNames(this.selector.findEntities(sender));
/*     */     } }
/*     */ 
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/commands/arguments/MessageArgument.class
