...
/*     */   public static final Dynamic2CommandExceptionType ERROR_NO_MATCHES;
/*  29 */   private static final Collection<String> EXAMPLES = List.of("minecraft:*", "*:asset", "*");
/*     */   static {
/*  31 */     ERROR_NO_MATCHES = new Dynamic2CommandExceptionType((selector, registry) -> Component.translatableEscape("argument.resource_selector.not_found", new Object[] { selector, registry }));
/*     */   }
...
/*  38 */     this.registryLookup = (HolderLookup<T>)context.lookupOrThrow(registryKey);
/*     */   }
/*     */ 
/*     */   
...
/*  67 */     return (Identifier.isAllowedInIdentifier(character) || character == '*' || character == '?');
/*     */   }
/*     */   
...
/*  78 */     return FilenameUtils.wildcardMatch(key.toString(), pattern);
/*     */   }
/*     */   
...
/*  82 */     return new ResourceSelectorArgument<>(context, registry);
/*     */   }
/*     */ 
/*     */   
/*     */   public static <T> Collection<Holder.Reference<T>> getSelectedResources(CommandContext<CommandSourceStack> context, String name) {
/*  87 */     return (Collection<Holder.Reference<T>>)context.getArgument(name, Collection.class);
/*     */   }
/*     */ 
/*     */   
/*     */   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
/*  92 */     return SharedSuggestionProvider.listSuggestions(context, builder, this.registryKey, SharedSuggestionProvider.ElementSuggestionType.ELEMENTS);
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/*     */     public ArgumentTypeInfo<ResourceSelectorArgument<T>, ?> type() {
/*     */       return ResourceSelectorArgument.Info.this;
/*     */     }
/*     */   }
/*     */ }


/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/commands/arguments/ResourceSelectorArgument.class
