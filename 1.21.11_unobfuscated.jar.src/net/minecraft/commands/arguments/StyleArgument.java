...
/*    */   
/*    */   static {
/* 27 */     ERROR_INVALID_STYLE = new DynamicCommandExceptionType(message -> Component.translatableEscape("argument.style.invalid", new Object[] { message }));
/*    */   }
...
/* 33 */     super(TAG_PARSER.withCodec((DynamicOps)
/* 34 */           registries.createSerializationContext(OPS), TAG_PARSER, Style.Serializer.CODEC, ERROR_INVALID_STYLE));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 42 */     return (Style)context.getArgument(name, Style.class);
/*    */   }
/*    */   
/*    */   public static StyleArgument style(CommandBuildContext context) {
/* 46 */     return new StyleArgument((HolderLookup.Provider)context);
/*    */   }
/*    */ 
/*    */   
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/commands/arguments/StyleArgument.class
