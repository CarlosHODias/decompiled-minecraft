...
/* 24 */     P argument = this.arguments.get(this.index);
...
/* 33 */     switch (argumentCount) { case 0: break;
/*    */       case 1:
...
/* 40 */         context.queueNext(taskFactory.create(frame, arguments.get(1))); break;
/*    */       default:
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/commands/execution/tasks/ContinuationTask.class
