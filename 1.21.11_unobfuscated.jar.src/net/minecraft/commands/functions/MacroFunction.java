...
/*     */   
/*     */   static {
/*  33 */     DECIMAL_FORMAT = (DecimalFormat)Util.make(new DecimalFormat("#", DecimalFormatSymbols.getInstance(Locale.ROOT)), format -> format.setMaximumFractionDigits(15));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*  61 */     List<String> parameterValues = new ArrayList<>(this.parameters.size());
...
/*     */     } 
/*     */     
/*  70 */     InstantiatedFunction<T> cachedFunction = (InstantiatedFunction<T>)this.cache.getAndMoveToLast(parameterValues);
...
/*  98 */     indicesToSelect.forEach(index -> selectedValuesOutput.add(values.get(index)));
/*     */   }
/*     */   
...
/* 102 */     List<UnboundEntryAction<T>> newEntries = new ArrayList<>(this.entries.size());
/* 103 */     List<String> entryArguments = new ArrayList<>(values.size());
/*     */     
...
/* 122 */       this.compiledAction = compiledAction;
/*     */     }
/*     */ 
/*     */     
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/commands/functions/MacroFunction.class
