...
/*  55 */     return getOnlinePlayerNames();
/*     */   }
/*     */   
...
/*  69 */     return Collections.singleton(TextCoordinates.DEFAULT_GLOBAL);
/*     */   }
/*     */   
/*     */   default Collection<TextCoordinates> getAbsoluteCoordinates() {
/*  73 */     return Collections.singleton(TextCoordinates.DEFAULT_GLOBAL);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  89 */       return (this == TAGS || this == ALL);
/*     */     }
/*     */     
/*     */     public boolean shouldSuggestElements() {
/*  93 */       return (this == ELEMENTS || this == ALL);
/*     */     }
/*     */   }
/*     */   
...
/* 118 */       Identifier id = converter.apply(value);
/* 119 */       if (hasNamespace) {
...
/* 151 */     Objects.requireNonNull(values); return suggestResource(values::iterator, builder, prefix);
/*     */   }
/*     */   
...
/* 162 */     filterResources(values, contents, id, v -> builder.suggest(((Identifier)id.apply(v)).toString(), tooltip.apply(v)));
...
/* 167 */     Objects.requireNonNull(values); return suggestResource(values::iterator, builder);
/*     */   }
/*     */   
...
/* 171 */     Objects.requireNonNull(values); return suggestResource(values::iterator, builder, id, tooltip);
/*     */   }
/*     */   
...
/* 263 */       String name = toString.apply(value);
/* 264 */       if (matchesSubStr(lowerPrefix, name.toLowerCase(Locale.ROOT))) {
/* 265 */         builder.suggest(name, tooltip.apply(value));
/*     */       }
/*     */     } 
...
/* Location:              /home/carlos/.minecraft/versions/1.21.11_unobfuscated/1.21.11_unobfuscated.jar!/net/minecraft/commands/SharedSuggestionProvider.class
